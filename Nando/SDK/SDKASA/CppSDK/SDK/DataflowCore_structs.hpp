...
{
public:
	struct FVector4                               Value;                                             // 0x0000(0x0020)
};
...
public:
	...
	uint8                                         Pad_C9[0xCF];                                      // 0x00C9(0x00CF)
};
...
public:
	...
	struct FDataflowVectorTypes                   A;                                                 // 0x01A0(0x0020)
	struct FDataflowVectorTypes                   B;                                                 // 0x01C0(0x0020)
	struct FDataflowVectorTypes                   CrossProduct;                                      // 0x01E0(0x0020)
};
...
public:
	uint8                                         Pad_198[0x8];                                      // 0x0198(0x0008)
	struct FDataflowVectorTypes                   V;                                                 // 0x01A0(0x0020)
	struct FDataflowNumericTypes                  SquaredLength;                                     // 0x01C0(0x0008)
...
public:
	...
	struct FDataflowNumericTypes                  Result;                                            // 0x01A0(0x0008)
};
...
{
public:
	struct FDataflowAnyType                       Value;                                             // 0x0198(0x0001)
...
{
public:
	struct FDataflowAnyType                       TrueValue;                                         // 0x0198(0x0001)
	struct FDataflowAnyType                       FalseValue;                                        // 0x0199(0x0001)
	bool                                          bCondition;                                        // 0x019A(0x0001)
	struct FDataflowAnyType                       Result;                                            // 0x019B(0x0001)
...
public:
	...
	struct FDataflowNumericTypes                  Result;                                            // 0x01A8(0x0008)
};
...
{
public:
	struct FDataflowNumericTypes                  Fallback;                                          // 0x01B0(0x0008)
};
...
{
public:
	TArray<struct FDataflowAnyType>               Inputs;                                            // 0x0198(0x0010)
	int32                                         SelectedIndex;                                     // 0x01A8(0x0004)
	struct FDataflowAnyType                       Result;                                            // 0x01AC(0x0001)
...
{
public:
	struct FDataflowStringConvertibleTypes        Value;                                             // 0x0198(0x0010)
};
...
{
public:
	struct FDataflowNumericTypes                  Fallback;                                          // 0x01A8(0x0008)
};
...
{
public:
	struct FDataflowNumericTypes                  base;                                              // 0x01A8(0x0008)
};
...
{
public:
	EDataflowMathConstantsEnum                    Constant;                                          // 0x0198(0x0001)
	uint8                                         Pad_199[0x7];                                      // 0x0199(0x0007)
	struct FDataflowNumericTypes                  Result;                                            // 0x01A0(0x0008)
};
...
{
public:
	struct FDataflowNumericTypes                  X;                                                 // 0x0198(0x0008)
	struct FDataflowNumericTypes                  Y;                                                 // 0x01A0(0x0008)
	uint8                                         Pad_1A8[0x8];                                      // 0x01A8(0x0008)
	struct FDataflowVectorTypes                   Vector2D;                                          // 0x01B0(0x0020)
};
...
public:
	struct FDataflowNumericTypes                  X;                                                 // 0x0198(0x0008)
	struct FDataflowNumericTypes                  Y;                                                 // 0x01A0(0x0008)
	struct FDataflowNumericTypes                  Z;                                                 // 0x01A8(0x0008)
	struct FDataflowVectorTypes                   Vector3d;                                          // 0x01B0(0x0020)
};
...
public:
	...
	struct FDataflowNumericTypes                  Y;                                                 // 0x01A0(0x0008)
	struct FDataflowNumericTypes                  Z;                                                 // 0x01A8(0x0008)
	struct FDataflowNumericTypes                  W;                                                 // 0x01B0(0x0008)
	uint8                                         Pad_1B8[0x8];                                      // 0x01B8(0x0008)
	struct FDataflowVectorTypes                   Vector4d;                                          // 0x01C0(0x0020)
};
...
public:
	uint8                                         Pad_198[0x8];                                      // 0x0198(0x0008)
	struct FDataflowVectorTypes                   V;                                                 // 0x01A0(0x0020)
	struct FDataflowNumericTypes                  X;                                                 // 0x01C0(0x0008)
	struct FDataflowNumericTypes                  Y;                                                 // 0x01C8(0x0008)
	struct FDataflowNumericTypes                  Z;                                                 // 0x01D0(0x0008)
	struct FDataflowNumericTypes                  W;                                                 // 0x01D8(0x0008)
};
...
public:
	...
	struct FDataflowVectorTypes                   A;                                                 // 0x01A0(0x0020)
	struct FDataflowVectorTypes                   B;                                                 // 0x01C0(0x0020)
	struct FDataflowVectorTypes                   V;                                                 // 0x01E0(0x0020)
};
...
public:
	...
	struct FDataflowVectorTypes                   A;                                                 // 0x01A0(0x0020)
	struct FDataflowVectorTypes                   B;                                                 // 0x01C0(0x0020)
	struct FDataflowNumericTypes                  DotProduct;                                        // 0x01E0(0x0008)
...
public:
	uint8                                         Pad_198[0x8];                                      // 0x0198(0x0008)
	struct FDataflowVectorTypes                   V;                                                 // 0x01A0(0x0020)
	struct FDataflowNumericTypes                  Length;                                            // 0x01C0(0x0008)
	uint8                                         Pad_1C8[0x8];                                      // 0x01C8(0x0008)
};
...
public:
	...
	struct FDataflowVectorTypes                   A;                                                 // 0x01A0(0x0020)
	struct FDataflowVectorTypes                   B;                                                 // 0x01C0(0x0020)
	struct FDataflowNumericTypes                  Distance;                                          // 0x01E0(0x0008)
	uint8                                         Pad_1E8[0x8];                                      // 0x01E8(0x0008)
};
...
public:
	uint8                                         Pad_198[0x8];                                      // 0x0198(0x0008)
	struct FDataflowVectorTypes                   V;                                                 // 0x01A0(0x0020)
	struct FDataflowNumericTypes                  Scale;                                             // 0x01C0(0x0008)
	uint8                                         Pad_1C8[0x8];                                      // 0x01C8(0x0008)
	struct FDataflowVectorTypes                   Scaled;                                            // 0x01D0(0x0020)
};
...
public:
	uint8                                         Pad_198[0x8];                                      // 0x0198(0x0008)
	struct FDataflowVectorTypes                   V;                                                 // 0x01A0(0x0020)
	struct FDataflowVectorTypes                   Normalized;                                        // 0x01C0(0x0020)
};
...
{
public:
	class FName                                   Key;                                               // 0x0198(0x0008)
	class FString                                 Default;                                           // 0x01A0(0x0010)
	bool                                          IsOverriden;                                       // 0x01B0(0x0001)
...
{
public:
	struct FLinearColor                           NodeTitleColor;                                    // 0x0000(0x0010)
	struct FLinearColor                           NodeBodyTintColor;                                 // 0x0010(0x0010)
};
