...
{
public:
	class USplineComponent*                       ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	class UCineCameraComponent*                   ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	TArray<struct FNamedFilmbackPreset>           ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FNamedLensPreset>               ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	class FString                                 InPresetName;                                      // 0x0000(0x0010)
};
...
{
public:
	struct FPlateCropSettings                     NewCropSettings;                                   // 0x0000(0x0004)
};
...
{
public:
	float                                         NewCurrentAperture;                                // 0x0000(0x0004)
};
...
{
public:
	float                                         InFocalLength;                                     // 0x0000(0x0004)
};
...
{
public:
	float                                         NewCustomNearClippingPlane;                        // 0x0000(0x0004)
};
...
{
public:
	struct FCameraFilmbackSettings                NewFilmback;                                       // 0x0000(0x0014)
};
...
{
public:
	struct FCameraFocusSettings                   NewFocusSettings;                                  // 0x0000(0x0060)
};
...
{
public:
	struct FCameraLensSettings                    NewLensSettings;                                   // 0x0000(0x001C)
};
...
{
public:
	class UCineCameraSettings*                    ReturnValue;                                       // 0x0000(0x0008)
};
...
public:
	...
	struct FPlateCropSettings                     CropSettings;                                      // 0x0010(0x0004)
...
public:
	class FString                                 PresetName;                                        // 0x0000(0x0010)
	struct FCameraFilmbackSettings                FilmbackSettings;                                  // 0x0010(0x0014)
...
public:
	class FString                                 PresetName;                                        // 0x0000(0x0010)
	struct FCameraLensSettings                    LensSettings;                                      // 0x0010(0x001C)
...
{
public:
	TArray<struct FNamedPlateCropPreset>          InCropPresets;                                     // 0x0000(0x0010)
};
...
{
public:
	class FString                                 InDefaultCropPresetName;                           // 0x0000(0x0010)
};
...
{
public:
	class FString                                 InDefaultFilmbackPreset;                           // 0x0000(0x0010)
};
...
{
public:
	float                                         InDefaultLensFocalLength;                          // 0x0000(0x0004)
};
...
{
public:
	float                                         InDefaultLensFStop;                                // 0x0000(0x0004)
};
...
{
public:
	class FString                                 InDefaultLensPresetName;                           // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FNamedFilmbackPreset>           InFilmbackPresets;                                 // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FNamedLensPreset>               InLensPresets;                                     // 0x0000(0x0010)
};
