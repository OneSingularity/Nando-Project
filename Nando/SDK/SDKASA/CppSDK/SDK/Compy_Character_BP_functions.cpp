...
#include "Compy_Character_BP_classes.hpp"
#include "Compy_Character_BP_parameters.hpp"
...
bool ACompy_Character_BP_C::BlueprintCanAttack(int32 AttackIndex, float Distance, float AttackRangeOffset, class AActor* OtherTarget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Compy_Character_BP_C", "BlueprintCanAttack");

	Params::Compy_Character_BP_C_BlueprintCanAttack Parms{};
