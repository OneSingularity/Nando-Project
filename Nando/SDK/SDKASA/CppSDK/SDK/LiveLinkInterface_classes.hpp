...
{
public:
	TMap<class FName, class FName>                BoneNameMap;                                       // 0x0028(0x0050)
...
public:
	...
	struct FLiveLinkSourceBufferManagementSettings BufferSettings;                                   // 0x0030(0x0060)
	class FString                                 ConnectionString;                                  // 0x0090(0x0010)
	TSubclassOf<class ULiveLinkSourceFactory>     Factory;                                           // 0x00A0(0x0008)
	struct FLiveLinkSubjectName                   ParentSubject;                                     // 0x00A8(0x0008)
...
{
public:
	struct FLiveLinkCurveConversionSettings       CurveConversionSettings;                           // 0x00B0(0x0050)
...
{
public:
	int32                                         DefaultSourceFrameBufferSize;                      // 0x0028(0x0004)
...
{
public:
	bool                                          bRebroadcastSubjectsByDefault;                     // 0x0028(0x0001)
	bool                                          bAllowEditingRebroadcastProperty;                  // 0x0029(0x0001)
...
public:
	...
	class ULiveLinkSubjectRemapper*               Remapper;                                          // 0x0050(0x0008)
	TSubclassOf<class ULiveLinkRole>              Role;                                              // 0x0058(0x0008)
	struct FFrameRate                             FrameRate;                                         // 0x0060(0x0008)
	bool                                          bAllowModifyingRebroadcast;                        // 0x0068(0x0001)
	bool                                          bRebroadcastSubject;                               // 0x0069(0x0001)
	uint8                                         Pad_6A[0x2];                                       // 0x006A(0x0002)
	class FName                                   OriginalSourceName;                                // 0x006C(0x0008)
	struct FLiveLinkSubjectKey                    Key;                                               // 0x0074(0x0018)
	uint8                                         Pad_8C[0xC];                                       // 0x008C(0x000C)
...
public:
	...
	TSubclassOf<class ULiveLinkRole>              Role;                                              // 0x0030(0x0008)
	TArray<struct FLiveLinkSubjectName>           Subjects;                                          // 0x0038(0x0010)
