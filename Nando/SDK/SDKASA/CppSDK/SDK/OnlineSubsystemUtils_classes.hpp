...
{
public:
	TMulticastInlineDelegate<void()>              OnSuccess;                                         // 0x0030(0x0010)
	TMulticastInlineDelegate<void()>              OnFailure;                                         // 0x0040(0x0010)
...
{
public:
	TMulticastInlineDelegate<void(const class FString& WrittenAchievementName, float WrittenProgress, int32 WrittenUserTag)> OnWriteSuccess; // 0x0030(0x0010)
	TMulticastInlineDelegate<void(const class FString& WrittenAchievementName, float WrittenProgress, int32 WrittenUserTag)> OnWriteFailure; // 0x0040(0x0010)
	TMulticastInlineDelegate<void(class FName WrittenAchievementName, float WrittenProgress, int32 WrittenUserTag)> OnSuccess; // 0x0050(0x0010)
	TMulticastInlineDelegate<void(class FName WrittenAchievementName, float WrittenProgress, int32 WrittenUserTag)> OnFailure; // 0x0060(0x0010)
	uint8                                         Pad_70[0x38];                                      // 0x0070(0x0038)
...
{
public:
	TMulticastInlineDelegate<void(int32 ErrorCode)> OnSuccess;                                       // 0x0030(0x0010)
	TMulticastInlineDelegate<void(int32 ErrorCode)> OnFailure;                                       // 0x0040(0x0010)
...
public:
	TMulticastInlineDelegate<void()>              OnSuccess;                                         // 0x0030(0x0010)
	TMulticastInlineDelegate<void()>              OnFailure;                                         // 0x0040(0x0010)
	uint8                                         Pad_50[0x48];                                      // 0x0050(0x0048)
...
{
public:
	TMulticastInlineDelegate<void(const TArray<struct FBlueprintSessionResult>& Results)> OnSuccess; // 0x0030(0x0010)
	TMulticastInlineDelegate<void(const TArray<struct FBlueprintSessionResult>& Results)> OnFailure; // 0x0040(0x0010)
	uint8                                         Pad_50[0x40];                                      // 0x0050(0x0040)
...
{
public:
	TMulticastInlineDelegate<void(const class FString& MatchID)> OnSuccess;                          // 0x0030(0x0010)
	TMulticastInlineDelegate<void(const class FString& MatchID)> OnFailure;                          // 0x0040(0x0010)
	uint8                                         Pad_50[0x38];                                      // 0x0050(0x0038)
...
{
public:
	TMulticastInlineDelegate<void(EInAppPurchaseStatus PurchaseStatus, const TArray<struct FInAppPurchaseReceiptInfo2>& InAppPurchaseReceipts)> OnSuccess; // 0x0028(0x0010)
	TMulticastInlineDelegate<void(EInAppPurchaseStatus PurchaseStatus, const TArray<struct FInAppPurchaseReceiptInfo2>& InAppPurchaseReceipts)> OnFailure; // 0x0038(0x0010)
...
{
public:
	TMulticastInlineDelegate<void(EInAppPurchaseStatus PurchaseStatus, const struct FInAppPurchaseReceiptInfo2& InAppPurchaseReceipt)> OnSuccess; // 0x0028(0x0010)
	TMulticastInlineDelegate<void(EInAppPurchaseStatus PurchaseStatus, const struct FInAppPurchaseReceiptInfo2& InAppPurchaseReceipt)> OnFailure; // 0x0038(0x0010)
...
{
public:
	TMulticastInlineDelegate<void(const TArray<struct FOnlineProxyStoreOffer>& InAppOfferInformation)> OnSuccess; // 0x0028(0x0010)
	TMulticastInlineDelegate<void(const TArray<struct FOnlineProxyStoreOffer>& InAppOfferInformation)> OnFailure; // 0x0038(0x0010)
...
{
public:
	TMulticastInlineDelegate<void(EInAppPurchaseStatus PurchaseStatus, const TArray<struct FInAppPurchaseRestoreInfo2>& InAppPurchaseRestoreInfo)> OnSuccess; // 0x0028(0x0010)
	TMulticastInlineDelegate<void(EInAppPurchaseStatus PurchaseStatus, const TArray<struct FInAppPurchaseRestoreInfo2>& InAppPurchaseRestoreInfo)> OnFailure; // 0x0038(0x0010)
	uint8                                         Pad_48[0x68];                                      // 0x0048(0x0068)
...
{
public:
	uint8                                         Pad_1F18[0xB4];                                    // 0x1F18(0x00B4)
	float                                         SocketErrorDisconnectDelay;                        // 0x1FCC(0x0004)
	uint8                                         Pad_1FD0[0x18];                                    // 0x1FD0(0x0018)
...
{
public:
	uint8                                         LogPortUnreach : 1;                                // 0x08B0(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         AllowPlayerPortUnreach : 1;                        // 0x08B0(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bExitOnBindFailure : 1;                            // 0x08B0(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         Pad_8B1[0x3];                                      // 0x08B1(0x0003)
	uint32                                        MaxPortCountToTry;                                 // 0x08B4(0x0004)
	uint8                                         Pad_8B8[0x4];                                      // 0x08B8(0x0004)
	uint32                                        ServerDesiredSocketReceiveBufferBytes;             // 0x08BC(0x0004)
	uint32                                        ServerDesiredSocketSendBufferBytes;                // 0x08C0(0x0004)
	uint32                                        ClientDesiredSocketReceiveBufferBytes;             // 0x08C4(0x0004)
	uint32                                        ClientDesiredSocketSendBufferBytes;                // 0x08C8(0x0004)
	uint8                                         Pad_8CC[0x4];                                      // 0x08CC(0x0004)
	double                                        MaxSecondsInReceive;                               // 0x08D0(0x0008)
	int32                                         NbPacketsBetweenReceiveTimeTest;                   // 0x08D8(0x0004)
	float                                         ResolutionConnectionTimeout;                       // 0x08DC(0x0004)
	uint8                                         Pad_8E0[0x80];                                     // 0x08E0(0x0080)
...
public:
	TMulticastInlineDelegate<void()>              OnSuccess;                                         // 0x0030(0x0010)
	TMulticastInlineDelegate<void()>              OnFailure;                                         // 0x0040(0x0010)
	uint8                                         Pad_50[0x148];                                     // 0x0050(0x0148)
...
{
public:
	TMulticastInlineDelegate<void(class FName SessionName)> OnSuccess;                               // 0x0028(0x0010)
	TMulticastInlineDelegate<void(class FName SessionName)> OnFailure;                               // 0x0038(0x0010)
	uint8                                         Pad_48[0x20];                                      // 0x0048(0x0020)
...
{
public:
	TMulticastInlineDelegate<void(int32 LeaderboardValue)> OnSuccess;                                // 0x0028(0x0010)
	TMulticastInlineDelegate<void(int32 LeaderboardValue)> OnFailure;                                // 0x0038(0x0010)
	uint8                                         Pad_48[0x58];                                      // 0x0048(0x0058)
...
{
public:
	TMulticastInlineDelegate<void(class APlayerController* PlayerController)> OnSuccess;             // 0x0030(0x0010)
	TMulticastInlineDelegate<void(class APlayerController* PlayerController)> OnFailure;             // 0x0040(0x0010)
	uint8                                         Pad_50[0x18];                                      // 0x0050(0x0018)
...
public:
	...
	float                                         BeaconConnectionInitialTimeout;                    // 0x0498(0x0004)
	float                                         BeaconConnectionTimeout;                           // 0x049C(0x0004)
	class UNetDriver*                             NetDriver;                                         // 0x04A0(0x0008)
	uint8                                         Pad_4A8[0x18];                                     // 0x04A8(0x0018)
...
{
public:
	class AOnlineBeaconHostObject*                BeaconOwner;                                       // 0x04C0(0x0008)
	class UNetConnection*                         BeaconConnection;                                  // 0x04C8(0x0008)
	EBeaconConnectionState                        ConnectionState;                                   // 0x04D0(0x0001)
	uint8                                         Pad_4D1[0x4F];                                     // 0x04D1(0x004F)
...
{
public:
	int32                                         ListenPort;                                        // 0x04C0(0x0004)
	bool                                          bReuseAddressAndPort;                              // 0x04C4(0x0001)
	bool                                          bAuthRequired;                                     // 0x04C5(0x0001)
	uint8                                         Pad_4C6[0x2];                                      // 0x04C6(0x0002)
	uint32                                        MaxAuthTokenSize;                                  // 0x04C8(0x0004)
	uint8                                         Pad_4CC[0x54];                                     // 0x04CC(0x0054)
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x0520(0x0010)
	uint8                                         Pad_530[0xA0];                                     // 0x0530(0x00A0)
...
{
public:
	class FString                                 BeaconTypeName;                                    // 0x0490(0x0010)
	TSubclassOf<class AOnlineBeaconClient>        ClientBeaconActorClass;                            // 0x04A0(0x0008)
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x04A8(0x0010)
...
{
public:
	TMap<class FName, class FName>                MappedUniqueNetIdTypes;                            // 0x0028(0x0050)
	TArray<class FName>                           CompatibleUniqueNetIdTypes;                        // 0x0078(0x0010)
	class FName                                   VoiceSubsystemNameOverride;                        // 0x0088(0x0008)
	uint8                                         Pad_90[0xF8];                                      // 0x0090(0x00F8)
	bool                                          bOnlineServicesCompatibilityEnabled;               // 0x0188(0x0001)
	uint8                                         Pad_189[0x7];                                      // 0x0189(0x0007)
	class UOnlineEngineInterface*                 OnlineServicesCompatibilityInterface;              // 0x0190(0x0008)
...
public:
	...
	TArray<struct FOnlineAccountStoredCredentials> Logins;                                           // 0x0040(0x0010)
...
{
public:
	uint8                                         Pad_28[0x1B0];                                     // 0x0028(0x01B0)
...
{
public:
	uint8                                         Pad_520[0x30];                                     // 0x0520(0x0030)
	class FString                                 DestSessionId;                                     // 0x0550(0x0010)
	struct FPartyReservation                      PendingReservation;                                // 0x0560(0x0058)
	EClientRequestType                            RequestType;                                       // 0x05B8(0x0001)
	bool                                          bPendingReservationSent;                           // 0x05B9(0x0001)
	bool                                          bCancelReservation;                                // 0x05BA(0x0001)
	uint8                                         Pad_5BB[0x2D];                                     // 0x05BB(0x002D)
...
{
public:
	class UPartyBeaconState*                      State;                                             // 0x04B8(0x0008)
	uint8                                         Pad_4C0[0x60];                                     // 0x04C0(0x0060)
	bool                                          bLogoutOnSessionTimeout;                           // 0x0520(0x0001)
	bool                                          bIsValidationStrRequired;                          // 0x0521(0x0001)
	uint8                                         Pad_522[0x2];                                      // 0x0522(0x0002)
	float                                         SessionTimeoutSecs;                                // 0x0524(0x0004)
	float                                         TravelSessionTimeoutSecs;                          // 0x0528(0x0004)
...
{
public:
	class FName                                   SessionName;                                       // 0x0028(0x0008)
	int32                                         NumConsumedReservations;                           // 0x0030(0x0004)
	int32                                         MaxReservations;                                   // 0x0034(0x0004)
	int32                                         NumTeams;                                          // 0x0038(0x0004)
	int32                                         NumPlayersPerTeam;                                 // 0x003C(0x0004)
	class FName                                   TeamAssignmentMethod;                              // 0x0040(0x0008)
	int32                                         ReservedHostTeamNum;                               // 0x0048(0x0004)
	int32                                         ForceTeamNum;                                      // 0x004C(0x0004)
	bool                                          bRestrictCrossConsole;                             // 0x0050(0x0001)
	uint8                                         Pad_51[0x7];                                       // 0x0051(0x0007)
	TArray<class FString>                         PlatformCrossplayRestrictions;                     // 0x0058(0x0010)
	TArray<struct FPartyBeaconCrossplayPlatformMapping> PlatformTypeMapping;                         // 0x0068(0x0010)
	bool                                          bEnableRemovalRequests;                            // 0x0078(0x0001)
	bool                                          bRespectCompetitiveIntegrity;                      // 0x0079(0x0001)
	uint8                                         Pad_7A[0x6];                                       // 0x007A(0x0006)
	TArray<struct FPartyReservation>              Reservations;                                      // 0x0080(0x0010)
...
public:
	uint8                                         Pad_520[0x30];                                     // 0x0520(0x0030)
	class FString                                 DestSessionId;                                     // 0x0550(0x0010)
	struct FSpectatorReservation                  PendingReservation;                                // 0x0560(0x0088)
	ESpectatorClientRequestType                   RequestType;                                       // 0x05E8(0x0001)
	bool                                          bPendingReservationSent;                           // 0x05E9(0x0001)
	bool                                          bCancelReservation;                                // 0x05EA(0x0001)
	uint8                                         Pad_5EB[0x2D];                                     // 0x05EB(0x002D)
...
{
public:
	class USpectatorBeaconState*                  State;                                             // 0x04B8(0x0008)
	uint8                                         Pad_4C0[0x60];                                     // 0x04C0(0x0060)
	bool                                          bLogoutOnSessionTimeout;                           // 0x0520(0x0001)
	bool                                          bIsValidationStrRequired;                          // 0x0521(0x0001)
	uint8                                         Pad_522[0x2];                                      // 0x0522(0x0002)
...
public:
	...
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
	TArray<struct FSpectatorReservation>          Reservations;                                      // 0x0040(0x0010)
	uint8                                         Pad_50[0x10];                                      // 0x0050(0x0010)
...
{
public:
	uint8                                         Pad_8E0[0x60];                                     // 0x08E0(0x0060)
...
{
public:
	uint8                                         Pad_28[0x158];                                     // 0x0028(0x0158)
