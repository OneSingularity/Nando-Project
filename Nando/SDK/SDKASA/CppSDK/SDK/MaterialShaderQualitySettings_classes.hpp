...
{
public:
	struct FMaterialQualityOverrides              QualityOverrides[0x4];                             // 0x0028(0x0008)
...
{
public:
	TMap<class FName, class UShaderPlatformQualitySettings*> ForwardSettingMap;                      // 0x0028(0x0050)
