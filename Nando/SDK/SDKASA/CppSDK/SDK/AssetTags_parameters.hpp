...
{
public:
	class FName                                   AssetPathName;                                     // 0x0000(0x0008)
...
public:
	...
	TArray<class FName>                           ReturnValue;                                       // 0x0068(0x0010)
};
...
{
public:
	const class UObject*                          AssetPtr;                                          // 0x0000(0x0008)
	TArray<class FName>                           ReturnValue;                                       // 0x0008(0x0010)
};
...
public:
	...
	TArray<class FName>                           ReturnValue;                                       // 0x0020(0x0010)
};
