...
public:
	...
	struct FRotator                               RootRotOffset;                                     // 0x06C8(0x0018)
	struct FVector                                RootLocOffset;                                     // 0x06E0(0x0018)
	double                                        AimOffsetAlpha;                                    // 0x06F8(0x0008)
	TMulticastInlineDelegate<void()>              NewEventDispatcher;                                // 0x0700(0x0010)
	struct FRotator                               RootRotOffset_Interpolated;                        // 0x0710(0x0018)
	class UAnimSequenceBase*                      Sequence;                                          // 0x0728(0x0008)
	float                                         Start_Position;                                    // 0x0730(0x0004)
	bool                                          ResetAnimSwitch;                                   // 0x0734(0x0001)
