...
public:
	...
	bool                                          bPreDialogReset;                                   // 0x0001(0x0001)
	struct FInterchangePipelinePropertyStatePerContext BasicLayoutStates;                            // 0x0002(0x0001)
	struct FInterchangePipelinePropertyStatePerContext ImportStates;                                 // 0x0003(0x0001)
	struct FInterchangePipelinePropertyStatePerContext ReimportStates;                               // 0x0004(0x0001)
};
