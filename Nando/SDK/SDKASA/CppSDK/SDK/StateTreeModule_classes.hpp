...
{
public:
	bool                                          bAutoStartDebuggerTracesOnNonEditorTargets;        // 0x0038(0x0001)
...
public:
	...
	class UStateTree*                             CachedFrameStateTree;                              // 0x0040(0x0008)
...
{
public:
	uint8                                         Pad_50[0x1];                                       // 0x0050(0x0001)
	uint8                                         bShouldStateChangeOnReselect : 1;                  // 0x0051(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         BitPad_51_1 : 1;                                   // 0x0051(0x0001)
	uint8                                         bShouldCallTickOnlyOnEvents : 1;                   // 0x0051(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bShouldCopyBoundPropertiesOnTick : 1;              // 0x0051(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bShouldCopyBoundPropertiesOnExitState : 1;         // 0x0051(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
...
{
public:
	uint32                                        LastCompiledEditorDataHash;                        // 0x0030(0x0004)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)
	class UStateTreeSchema*                       Schema;                                            // 0x0038(0x0008)
	TArray<struct FCompactStateTreeState>         States;                                            // 0x0040(0x0010)
	TArray<struct FCompactStateTransition>        Transitions;                                       // 0x0050(0x0010)
	struct FInstancedStructContainer              Nodes;                                             // 0x0060(0x0010)
	struct FStateTreeInstanceData                 DefaultInstanceData;                               // 0x0070(0x0010)
	struct FStateTreeInstanceData                 SharedInstanceData;                                // 0x0080(0x0010)
	uint8                                         Pad_90[0x18];                                      // 0x0090(0x0018)
	TArray<struct FStateTreeExternalDataDesc>     ContextDataDescs;                                  // 0x00A8(0x0010)
	struct FStateTreePropertyBindings             PropertyBindings;                                  // 0x00B8(0x0078)
	TArray<struct FStateTreeStateIdToHandle>      IDToStateMappings;                                 // 0x0130(0x0010)
	TArray<struct FStateTreeNodeIdToIndex>        IDToNodeMappings;                                  // 0x0140(0x0010)
	TArray<struct FStateTreeTransitionIdToIndex>  IDToTransitionMappings;                            // 0x0150(0x0010)
	struct FInstancedPropertyBag                  Parameters;                                        // 0x0160(0x0010)
	uint16                                        NumContextData;                                    // 0x0170(0x0002)
	uint16                                        NumGlobalInstanceData;                             // 0x0172(0x0002)
	uint16                                        EvaluatorsBegin;                                   // 0x0174(0x0002)
	uint16                                        EvaluatorsNum;                                     // 0x0176(0x0002)
	uint16                                        GlobalTasksBegin;                                  // 0x0178(0x0002)
	uint16                                        GlobalTasksNum;                                    // 0x017A(0x0002)
	bool                                          bHasGlobalTransitionTasks;                         // 0x017C(0x0001)
	uint8                                         Pad_17D[0x3];                                      // 0x017D(0x0003)
	TArray<struct FStateTreeExternalDataDesc>     ExternalDataDescs;                                 // 0x0180(0x0010)
