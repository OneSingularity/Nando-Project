...
{
public:
	class FName                                   InCacheName;                                       // 0x0000(0x0008)
...
{
public:
	class UChaosCacheCollection*                  InCacheCollection;                                 // 0x0000(0x0008)
};
...
{
public:
	float                                         InStartTime;                                       // 0x0000(0x0004)
};
...
{
public:
	class UPrimitiveComponent*                    InComponent;                                       // 0x0000(0x0008)
};
