...
struct FSimDebugVisFragment final : public FMassFragment
{
public:
...
{
public:
	EMassEntityDebugShape                         Shape;                                             // 0x0000(0x0001)
};
...
public:
	class UStaticMesh*                            Mesh;                                              // 0x0008(0x0008)
	class UMaterialInterface*                     MaterialOverride;                                  // 0x0010(0x0008)
	uint32                                        VisualNearCullDistance;                            // 0x0018(0x0004)
	uint32                                        VisualFarCullDistance;                             // 0x001C(0x0004)
