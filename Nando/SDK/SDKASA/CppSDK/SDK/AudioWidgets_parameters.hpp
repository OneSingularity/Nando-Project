...
{
public:
	TArray<struct FMeterChannelInfo>              InMeterChannelInfo;                                // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FMeterChannelInfo>              ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	bool                                          bInUsesStep;                                       // 0x0000(0x0001)
};
...
{
public:
	float                                         InSliderValue;                                     // 0x0000(0x0004)
...
{
public:
	float                                         OutputValue;                                       // 0x0000(0x0004)
	float                                         ReturnValue;                                       // 0x0004(0x0004)
};
...
{
public:
	struct FVector2D                              InHandStartEndRatio;                               // 0x0000(0x0010)
};
...
{
public:
	struct FVector2D                              InOutputRange;                                     // 0x0000(0x0010)
};
...
{
public:
	bool                                          bShowLabelOnlyOnHover;                             // 0x0000(0x0001)
};
...
{
public:
	bool                                          bShowUnitsText;                                    // 0x0000(0x0001)
};
...
{
public:
	float                                         InThickness;                                       // 0x0000(0x0004)
};
...
{
public:
	struct FSlateColor                            InColor;                                           // 0x0000(0x0014)
};
...
{
public:
	class FText                                   Units;                                             // 0x0000(0x0010)
};
...
{
public:
	bool                                          bIsReadOnly;                                       // 0x0000(0x0001)
};
...
{
public:
	EAudioRadialSliderLayout                      InLayout;                                          // 0x0000(0x0001)
};
