...
{
public:
	TMulticastInlineDelegate<void()>              OnExecution;                                       // 0x0030(0x0010)
...
{
public:
	TMulticastInlineDelegate<void(class UThreadAsyncExecLoopUnsafely* LoopHandle)> OnLoopBody;       // 0x0058(0x0010)
	TMulticastInlineDelegate<void()>              OnCompleted;                                       // 0x0068(0x0010)
...
public:
	...
	TMulticastInlineDelegate<void()>              OnExecution;                                       // 0x0070(0x0010)
...
public:
	...
	TMulticastInlineDelegate<void()>              OnExecution;                                       // 0x0060(0x0010)
	TMulticastInlineDelegate<void()>              OnCompleted;                                       // 0x0070(0x0010)
...
{
public:
	uint8                                         Pad_58[0x30];                                      // 0x0058(0x0030)
...
{
public:
	TMulticastInlineDelegate<void(float DeltaSeconds, class UThreadAsyncExecTick* TickHandle)> OnExecution; // 0x0088(0x0010)
	TMulticastInlineDelegate<void()>              OnTickEnd;                                         // 0x0098(0x0010)
	TMulticastInlineDelegate<void()>              OnCompleted;                                       // 0x00A8(0x0010)
...
public:
	...
	TMulticastInlineDelegate<void(int32 Index, float DeltaSeconds, class UThreadAsyncExecTickForLoop* TickHandle)> OnExecution; // 0x0098(0x0010)
	TMulticastInlineDelegate<void()>              OnTickEnd;                                         // 0x00A8(0x0010)
	TMulticastInlineDelegate<void()>              OnCompleted;                                       // 0x00B8(0x0010)
...
public:
	uint8                                         Pad_58[0x8];                                       // 0x0058(0x0008)
	TMulticastInlineDelegate<void(float DeltaSeconds, class UThreadAsyncExecTickUnsafely* TickHandle)> OnTick; // 0x0060(0x0010)
	TMulticastInlineDelegate<void()>              OnCompleted;                                       // 0x0070(0x0010)
...
{
public:
	uint8                                         Pad_30[0x78];                                      // 0x0030(0x0078)
...
public:
	...
	class UThreadNodeSubsystem*                   ThreadNodeSubsystem;                               // 0x0050(0x0008)
