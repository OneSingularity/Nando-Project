...
{
public:
	TMap<TSubclassOf<class ULiveLinkRole>, TSubclassOf<class ULiveLinkControllerBase>> DefaultControllerForRole; // 0x0028(0x0050)
	bool                                          bUpdateSubjectsImmediatelyInPIE;                   // 0x0078(0x0001)
...
{
public:
	struct FComponentReference                    ComponentPicker;                                   // 0x0028(0x0028)
...
{
public:
	struct FLiveLinkTransformControllerData       TransformData;                                     // 0x0068(0x0006)
	uint8                                         Pad_6E[0x2];                                       // 0x006E(0x0002)
	struct FTransform                             OffsetTransform;                                   // 0x0070(0x0060)
	uint8                                         Pad_D0[0x60];                                      // 0x00D0(0x0060)
...
{
public:
	struct FLiveLinkSubjectRepresentation         SubjectRepresentation;                             // 0x00D0(0x0010)
	TMap<TSubclassOf<class ULiveLinkRole>, class ULiveLinkControllerBase*> ControllerMap;            // 0x00E0(0x0050)
	bool                                          bUpdateInEditor;                                   // 0x0130(0x0001)
	uint8                                         Pad_131[0x7];                                      // 0x0131(0x0007)
	TMulticastInlineDelegate<void(float DeltaTime)> OnLiveLinkUpdated;                               // 0x0138(0x0010)
	TMulticastInlineDelegate<void()>              OnControllerMapUpdatedDelegate;                    // 0x0148(0x0010)
	bool                                          bDisableEvaluateLiveLinkWhenSpawnable;             // 0x0158(0x0001)
	bool                                          bEvaluateLiveLink;                                 // 0x0159(0x0001)
	bool                                          bUpdateInPreviewEditor;                            // 0x015A(0x0001)
	uint8                                         Pad_15B[0x1D];                                     // 0x015B(0x001D)
