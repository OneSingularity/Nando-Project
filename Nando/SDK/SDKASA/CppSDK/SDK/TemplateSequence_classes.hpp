...
public:
	...
	TSoftClassPtr<class UClass>                   BoundActorClass;                                   // 0x0070(0x0028)
	TMap<struct FGuid, class FName>               BoundActorComponents;                              // 0x0098(0x0050)
	class UBlueprint*                             DirectorBlueprint;                                 // 0x00E8(0x0008)
...
public:
	...
	uint8                                         bConstrainAspectRatio : 1;                         // 0x002C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	...
	float                                         PostProcessBlendWeight;                            // 0x0860(0x0004)
	struct FCameraFilmbackSettings                Filmback;                                          // 0x0864(0x0014)
	struct FCameraLensSettings                    LensSettings;                                      // 0x0878(0x001C)
	uint8                                         Pad_894[0x4];                                      // 0x0894(0x0004)
	struct FCameraFocusSettings                   FocusSettings;                                     // 0x0898(0x0060)
	float                                         CurrentFocalLength;                                // 0x08F8(0x0004)
	float                                         CurrentAperture;                                   // 0x08FC(0x0004)
	float                                         CurrentFocusDistance;                              // 0x0900(0x0004)
	uint8                                         Pad_904[0x7C];                                     // 0x0904(0x007C)
...
{
public:
	uint8                                         Pad_28[0x260];                                     // 0x0028(0x0260)
	class UObject*                                BoundObjectOverride;                               // 0x0288(0x0008)
	class UMovieSceneSequence*                    Sequence;                                          // 0x0290(0x0008)
	struct FMovieSceneRootEvaluationTemplateInstance RootTemplateInstance;                           // 0x0298(0x0020)
	uint8                                         Pad_2B8[0x70];                                     // 0x02B8(0x0070)
...
{
public:
	TArray<struct FTemplateSectionPropertyScale>  PropertyScales;                                    // 0x07E0(0x0010)
...
public:
	...
	uint8                                         Pad_58[0x20];                                      // 0x0058(0x0020)
...
{
public:
	uint8                                         Pad_40[0x70];                                      // 0x0040(0x0070)
...
public:
	...
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x0498(0x0028)
	class UTemplateSequencePlayer*                SequencePlayer;                                    // 0x04C0(0x0008)
	struct FSoftObjectPath                        TemplateSequence;                                  // 0x04C8(0x0020)
	struct FTemplateSequenceBindingOverrideData   BindingOverride;                                   // 0x04E8(0x000C)
