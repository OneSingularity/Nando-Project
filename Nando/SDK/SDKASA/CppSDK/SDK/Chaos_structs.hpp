...
struct FClosestPhysicsObjectResult final
{
public:
...
{
public:
	int32                                         PositionIterations;                                // 0x0000(0x0004)
	int32                                         VelocityIterations;                                // 0x0004(0x0004)
	int32                                         ProjectionIterations;                              // 0x0008(0x0004)
	...
	struct FSolverCollisionFilterSettings         CollisionFilterSettings;                           // 0x0028(0x0010)
	bool                                          bGenerateBreakData;                                // 0x0038(0x0001)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)
	struct FSolverBreakingFilterSettings          BreakingFilterSettings;                            // 0x003C(0x0010)
	bool                                          bGenerateTrailingData;                             // 0x004C(0x0001)
	uint8                                         Pad_4D[0x3];                                       // 0x004D(0x0003)
	struct FSolverTrailingFilterSettings          TrailingFilterSettings;                            // 0x0050(0x0010)
	int32                                         Iterations;                                        // 0x0060(0x0004)
	int32                                         PushOutIterations;                                 // 0x0064(0x0004)
...
public:
	...
	struct FVector                                AccumulatedImpulse;                                // 0x0018(0x0018)
	struct FVector                                Normal;                                            // 0x0030(0x0018)
	struct FVector                                Velocity1;                                         // 0x0048(0x0018)
	struct FVector                                Velocity2;                                         // 0x0060(0x0018)
	struct FVector                                AngularVelocity1;                                  // 0x0078(0x0018)
	struct FVector                                AngularVelocity2;                                  // 0x0090(0x0018)
	float                                         Mass1;                                             // 0x00A8(0x0004)
	float                                         Mass2;                                             // 0x00AC(0x0004)
	int32                                         ParticleIndex;                                     // 0x00B0(0x0004)
	int32                                         LevelsetIndex;                                     // 0x00B4(0x0004)
	int32                                         ParticleIndexMesh;                                 // 0x00B8(0x0004)
	int32                                         LevelsetIndexMesh;                                 // 0x00BC(0x0004)
};
...
public:
	...
	int32                                         ParticleIndexMesh;                                 // 0x0050(0x0004)
...
public:
	...
	TArray<int32>                                 TransformIndices;                                  // 0x0010(0x0010)
	TArray<int32>                                 PreviousTransformIndices;                          // 0x0020(0x0010)
	TArray<bool>                                  DisabledFlags;                                     // 0x0030(0x0010)
	TArray<struct FSolverCollisionData>           Collisions;                                        // 0x0040(0x0010)
	TArray<struct FSolverBreakingData>            Breakings;                                         // 0x0050(0x0010)
	TSet<struct FSolverTrailingData>              Trailings;                                         // 0x0060(0x0050)
...
{
public:
	TArray<struct FRecordedFrame>                 Records;                                           // 0x0000(0x0010)
};
