...
struct FLiveLinkSourceHandle final
{
public:
...
{
public:
	TArray<class FName>                           PropertyNames;                                     // 0x0000(0x0010)
};
...
{
public:
	TArray<class FName>                           BoneNames;                                         // 0x0010(0x0010)
	TArray<int32>                                 BoneParents;                                       // 0x0020(0x0010)
};
...
{
public:
	TMap<class FName, class FString>              StringMetaData;                                    // 0x0000(0x0050)
...
{
public:
	struct FLiveLinkWorldTime                     WorldTime;                                         // 0x0000(0x0010)
	struct FLiveLinkMetaData                      MetaData;                                          // 0x0010(0x0060)
...
{
public:
	TArray<struct FTransform>                     Transforms;                                        // 0x00A0(0x0010)
};
...
{
public:
	struct FLiveLinkBaseStaticData                StaticData;                                        // 0x0008(0x0010)
	struct FLiveLinkBaseFrameData                 FrameData;                                         // 0x0018(0x00A0)
};
...
{
public:
	struct FTransform                             Transform;                                         // 0x00A0(0x0060)
};
...
public:
	...
	uint8                                         Pad_115[0xB];                                      // 0x0115(0x000B)
};
...
{
public:
	struct FLiveLinkCameraStaticData              StaticData;                                        // 0x0008(0x0028)
	struct FLiveLinkCameraFrameData               FrameData;                                         // 0x0030(0x0120)
};
...
{
public:
	struct FLiveLinkGamepadInputDeviceStaticData  StaticData;                                        // 0x0008(0x0010)
	struct FLiveLinkGamepadInputDeviceFrameData   FrameData;                                         // 0x0018(0x0120)
};
...
public:
	...
	struct FColor                                 LightColor;                                        // 0x0108(0x0004)
	...
	uint8                                         Pad_124[0xC];                                      // 0x0124(0x000C)
};
...
{
public:
	struct FLiveLinkLightStaticData               StaticData;                                        // 0x0008(0x0028)
	struct FLiveLinkLightFrameData                FrameData;                                         // 0x0030(0x0130)
};
...
public:
	...
	class FText                                   SourceType;                                        // 0x0018(0x0010)
};
...
{
public:
	struct FGuid                                  Source;                                            // 0x0000(0x0010)
	struct FLiveLinkSubjectName                   SubjectName;                                       // 0x0010(0x0008)
};
...
public:
	...
	TSubclassOf<class ULiveLinkRole>              Role;                                              // 0x0018(0x0008)
...
public:
	...
	TArray<int32>                                 BoneParents;                                       // 0x0010(0x0010)
};
...
{
public:
	struct FLiveLinkSubjectName                   Subject;                                           // 0x0000(0x0008)
...
{
public:
	struct FLiveLinkTransformStaticData           StaticData;                                        // 0x0008(0x0018)
	struct FLiveLinkTransformFrameData            FrameData;                                         // 0x0020(0x0100)
};
...
{
public:
	TMap<class FString, struct FSoftObjectPath>   CurveConversionAssetMap;                           // 0x0000(0x0050)
};
...
public:
	...
	int32                                         SnapshotIndex;                                     // 0x0008(0x0004)
	int32                                         NumberOfBufferAtSnapshot;                          // 0x000C(0x0004)
};
...
public:
	...
	struct FFrameNumber                           FrameOffset;                                       // 0x0008(0x0004)
};
...
public:
	...
	struct FQualifiedFrameTime                    SceneTime;                                         // 0x0008(0x0010)
};
...
{
public:
	int32                                         Seconds;                                           // 0x0000(0x0004)
	int32                                         Frames;                                            // 0x0004(0x0004)
...
public:
	...
	TArray<struct FLiveLinkCurveElement>          CurveElements;                                     // 0x0010(0x0010)
...
public:
	TMap<class FName, class FString>              StringMetaData;                                    // 0x0000(0x0050)
	struct FTimecode                              SceneTimecode;                                     // 0x0050(0x0018)
	struct FFrameRate                             SceneFramerate;                                    // 0x0068(0x0008)
};

// ScriptStruct LiveLinkInterface.CachedSubjectFrame
// 0x0160 (0x0160 - 0x0000)
struct FCachedSubjectFrame final
{
public:
	uint8                                         Pad_0[0x160];                                      // 0x0000(0x0160)
};

// ScriptStruct LiveLinkInterface.LiveLinkTransform
// 0x0020 (0x0020 - 0x0000)
struct FLiveLinkTransform final
{
public:
