...
{
public:
	TMap<class FString, class FString>            MetaData;                                          // 0x0028(0x0050)
...
{
public:
	struct FExpressionInput                       Coordinates;                                       // 0x00B0(0x0028)
	struct FExpressionInput                       A;                                                 // 0x00D8(0x0028)
	struct FExpressionInput                       B;                                                 // 0x0100(0x0028)
	struct FExpressionInput                       C;                                                 // 0x0128(0x0028)
	struct FExpressionInput                       D;                                                 // 0x0150(0x0028)
	uint8                                         ConstCoordinate;                                   // 0x0178(0x0001)
...
{
public:
	uint8                                         Pad_30[0x1A8];                                     // 0x0030(0x01A8)
...
public:
	...
	bool                                          bKeepFbxNamespace;                                 // 0x002B(0x0001)
...
public:
	...
	class UInterchangeFbxTranslatorSettings*      CacheFbxTranslatorSettings;                        // 0x0058(0x0008)
...
{
public:
	uint8                                         Pad_38[0x258];                                     // 0x0038(0x0258)
...
{
public:
	struct FExpressionInput                       A;                                                 // 0x00B0(0x0028)
	struct FExpressionInput                       B;                                                 // 0x00D8(0x0028)
	struct FExpressionInput                       C;                                                 // 0x0100(0x0028)
...
public:
	...
	struct FExpressionInput                       B;                                                 // 0x00D8(0x0028)
	struct FExpressionInput                       C;                                                 // 0x0100(0x0028)
	struct FExpressionInput                       D;                                                 // 0x0128(0x0028)
...
public:
	struct FExpressionInput                       A;                                                 // 0x00B0(0x0028)
	struct FExpressionInput                       B;                                                 // 0x00D8(0x0028)
	struct FExpressionInput                       Alpha;                                             // 0x0100(0x0028)
...
{
public:
	struct FExpressionInput                       position;                                          // 0x00B0(0x0028)
	struct FExpressionInput                       Amplitude;                                         // 0x00D8(0x0028)
	float                                         ConstAmplitude;                                    // 0x0100(0x0004)
	uint8                                         Pad_104[0x4];                                      // 0x0104(0x0004)
	struct FExpressionInput                       Octaves;                                           // 0x0108(0x0028)
	int32                                         ConstOctaves;                                      // 0x0130(0x0004)
	uint8                                         Pad_134[0x4];                                      // 0x0134(0x0004)
	struct FExpressionInput                       Lacunarity;                                        // 0x0138(0x0028)
	float                                         ConstLacunarity;                                   // 0x0160(0x0004)
	uint8                                         Pad_164[0x4];                                      // 0x0164(0x0004)
	struct FExpressionInput                       Diminish;                                          // 0x0168(0x0028)
	float                                         ConstDiminish;                                     // 0x0190(0x0004)
	float                                         Scale;                                             // 0x0194(0x0004)
	bool                                          bTurbulence;                                       // 0x0198(0x0001)
	uint8                                         Pad_199[0x3];                                      // 0x0199(0x0003)
	int32                                         Levels;                                            // 0x019C(0x0004)
...
{
public:
	struct FExpressionInput                       Input;                                             // 0x00B0(0x0028)
	struct FLinearColor                           LuminanceFactors;                                  // 0x00D8(0x0010)
...
public:
	struct FExpressionInput                       Coordinates;                                       // 0x00B0(0x0028)
	struct FExpressionInput                       Pivot;                                             // 0x00D8(0x0028)
	struct FExpressionInput                       Scale;                                             // 0x0100(0x0028)
	struct FExpressionInput                       Offset;                                            // 0x0128(0x0028)
	struct FExpressionInput                       RotationAngle;                                     // 0x0150(0x0028)
	float                                         ConstRotationAngle;                                // 0x0178(0x0004)
	uint8                                         ConstCoordinate;                                   // 0x017C(0x0001)
...
public:
	...
	struct FExpressionInput                       A;                                                 // 0x00D8(0x0028)
	struct FExpressionInput                       B;                                                 // 0x0100(0x0028)
	uint8                                         ConstCoordinate;                                   // 0x0128(0x0001)
...
public:
	struct FExpressionInput                       Input;                                             // 0x00B0(0x0028)
	struct FExpressionInput                       InputLow;                                          // 0x00D8(0x0028)
	struct FExpressionInput                       InputHigh;                                         // 0x0100(0x0028)
	struct FExpressionInput                       TargetLow;                                         // 0x0128(0x0028)
	struct FExpressionInput                       TargetHigh;                                        // 0x0150(0x0028)
...
public:
	struct FExpressionInput                       Input;                                             // 0x00B0(0x0028)
	struct FExpressionInput                       RotationAngle;                                     // 0x00D8(0x0028)
...
public:
	...
	struct FExpressionInput                       A;                                                 // 0x00D8(0x0028)
	struct FExpressionInput                       B;                                                 // 0x0100(0x0028)
	struct FExpressionInput                       Center;                                            // 0x0128(0x0028)
	float                                         ConstCenter;                                       // 0x0150(0x0004)
	uint8                                         ConstCoordinate;                                   // 0x0154(0x0001)
...
public:
	struct FExpressionInput                       Input;                                             // 0x00B0(0x0028)
	class FString                                 Channels;                                          // 0x00D8(0x0010)
...
{
public:
	int32                                         GeometryPurpose;                                   // 0x0028(0x0004)
	class FName                                   RenderContext;                                     // 0x002C(0x0008)
	class FName                                   MaterialPurpose;                                   // 0x0034(0x0008)
	EUsdInterpolationType                         InterpolationType;                                 // 0x003C(0x0001)
	bool                                          bOverrideStageOptions;                             // 0x003D(0x0001)
	uint8                                         Pad_3E[0x2];                                       // 0x003E(0x0002)
	struct FUsdStageOptions                       StageOptions;                                      // 0x0040(0x0008)
...
public:
	...
	class UInterchangeUsdTranslatorSettings*      TranslatorSettings;                                // 0x0060(0x0008)
