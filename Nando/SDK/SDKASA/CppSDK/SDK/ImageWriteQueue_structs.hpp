...
struct FImageWriteOptions final
{
public:
	EDesiredImageFormat                           Format;                                            // 0x0000(0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	TDelegate<void(bool bSuccess)>                OnComplete;                                        // 0x0004(0x0010)
	int32                                         CompressionQuality;                                // 0x0014(0x0004)
	bool                                          bOverwriteFile;                                    // 0x0018(0x0001)
	bool                                          bAsync;                                            // 0x0019(0x0001)
	uint8                                         Pad_1A[0x46];                                      // 0x001A(0x0046)
};
