...
public:
	...
	uint8                                         Pad_D2[0x1E];                                      // 0x00D2(0x001E)
	struct FTransform                             SharedTransform;                                   // 0x00F0(0x0060)
	struct FTransform                             InitialSharedTransform;                            // 0x0150(0x0060)
...
{
public:
	uint8                                         Pad_1B0[0x10];                                     // 0x01B0(0x0010)
...
public:
	...
	struct FLinearColor                           Color;                                             // 0x0628(0x0010)
	float                                         HoverSizeMultiplier;                               // 0x0638(0x0004)
	float                                         PixelHitDistanceThreshold;                         // 0x063C(0x0004)
	uint8                                         Pad_640[0x8];                                      // 0x0640(0x0008)
	class UGizmoViewContext*                      GizmoViewContext;                                  // 0x0648(0x0008)
	uint8                                         Pad_650[0x8];                                      // 0x0650(0x0008)
...
{
public:
	bool                                          bIsSelectableInEditor;                             // 0x0490(0x0001)
...
{
public:
	struct FVector2D                              Value;                                             // 0x0048(0x0010)
	struct FGizmoVec2ParameterChange              LastChange;                                        // 0x0058(0x0020)
...
{
public:
	uint8                                         Pad_48[0x88];                                      // 0x0048(0x0088)
	TScriptInterface<class IGizmoAxisSource>      AxisSource;                                        // 0x00D0(0x0010)
	TScriptInterface<class IGizmoTransformSource> TransformSource;                                   // 0x00E0(0x0010)
	float                                         Parameter;                                         // 0x00F0(0x0004)
	struct FGizmoFloatParameterChange             LastChange;                                        // 0x00F4(0x0008)
	uint8                                         Pad_FC[0x4];                                       // 0x00FC(0x0004)
	struct FVector                                CurTranslationAxis;                                // 0x0100(0x0018)
	struct FVector                                CurTranslationOrigin;                              // 0x0118(0x0018)
	struct FTransform                             InitialTransform;                                  // 0x0130(0x0060)
...
{
public:
	uint8                                         Pad_48[0xC8];                                      // 0x0048(0x00C8)
	TScriptInterface<class IGizmoAxisSource>      AxisSource;                                        // 0x0110(0x0010)
	TScriptInterface<class IGizmoTransformSource> TransformSource;                                   // 0x0120(0x0010)
	struct FVector2D                              Parameter;                                         // 0x0130(0x0010)
	struct FGizmoVec2ParameterChange              LastChange;                                        // 0x0140(0x0020)
	struct FVector                                CurTranslationOrigin;                              // 0x0160(0x0018)
	struct FVector                                CurTranslationNormal;                              // 0x0178(0x0018)
	struct FVector                                CurTranslationAxisX;                               // 0x0190(0x0018)
	struct FVector                                CurTranslationAxisY;                               // 0x01A8(0x0018)
	struct FTransform                             InitialTransform;                                  // 0x01C0(0x0060)
...
public:
	...
	struct FGizmoFloatParameterChange             LastChange;                                        // 0x00F4(0x0008)
	uint8                                         Pad_FC[0x4];                                       // 0x00FC(0x0004)
	struct FVector                                CurRotationAxis;                                   // 0x0100(0x0018)
	struct FVector                                CurRotationOrigin;                                 // 0x0118(0x0018)
	struct FTransform                             InitialTransform;                                  // 0x0130(0x0060)
...
public:
	...
	TScriptInterface<class IGizmoAxisSource>      AxisSource;                                        // 0x00D0(0x0010)
	TScriptInterface<class IGizmoTransformSource> TransformSource;                                   // 0x00E0(0x0010)
	float                                         ScaleMultiplier;                                   // 0x00F0(0x0004)
	uint8                                         Pad_F4[0x4];                                       // 0x00F4(0x0004)
	struct FVector2D                              Parameter;                                         // 0x00F8(0x0010)
	struct FGizmoVec2ParameterChange              LastChange;                                        // 0x0108(0x0020)
	struct FVector                                CurScaleOrigin;                                    // 0x0128(0x0018)
	struct FVector                                CurScaleNormal;                                    // 0x0140(0x0018)
	struct FVector                                CurScaleAxisX;                                     // 0x0158(0x0018)
	struct FVector                                CurScaleAxisY;                                     // 0x0170(0x0018)
	uint8                                         Pad_188[0x8];                                      // 0x0188(0x0008)
	struct FTransform                             InitialTransform;                                  // 0x0190(0x0060)
...
public:
	...
	TScriptInterface<class IGizmoTransformSource> TransformSource;                                   // 0x00E0(0x0010)
	float                                         ScaleMultiplier;                                   // 0x00F0(0x0004)
	bool                                          bClampToZero;                                      // 0x00F4(0x0001)
	uint8                                         Pad_F5[0x3];                                       // 0x00F5(0x0003)
	float                                         Parameter;                                         // 0x00F8(0x0004)
	struct FGizmoFloatParameterChange             LastChange;                                        // 0x00FC(0x0008)
	uint8                                         Pad_104[0x4];                                      // 0x0104(0x0004)
	struct FVector                                CurScaleAxis;                                      // 0x0108(0x0018)
	struct FVector                                CurScaleOrigin;                                    // 0x0120(0x0018)
	uint8                                         Pad_138[0x8];                                      // 0x0138(0x0008)
	struct FTransform                             InitialTransform;                                  // 0x0140(0x0060)
...
{
public:
	uint8                                         Pad_48[0x108];                                     // 0x0048(0x0108)
	TScriptInterface<class IGizmoAxisSource>      AxisSource;                                        // 0x0150(0x0010)
	TScriptInterface<class IGizmoTransformSource> TransformSource;                                   // 0x0160(0x0010)
	float                                         ScaleMultiplier;                                   // 0x0170(0x0004)
	bool                                          bUseEqualScaling;                                  // 0x0174(0x0001)
	bool                                          bClampToZero;                                      // 0x0175(0x0001)
	uint8                                         Pad_176[0x2];                                      // 0x0176(0x0002)
	struct FVector2D                              Parameter;                                         // 0x0178(0x0010)
	struct FGizmoVec2ParameterChange              LastChange;                                        // 0x0188(0x0020)
	struct FVector                                CurScaleOrigin;                                    // 0x01A8(0x0018)
	struct FVector                                CurScaleNormal;                                    // 0x01C0(0x0018)
	struct FVector                                CurScaleAxisX;                                     // 0x01D8(0x0018)
	struct FVector                                CurScaleAxisY;                                     // 0x01F0(0x0018)
	uint8                                         Pad_208[0x8];                                      // 0x0208(0x0008)
	struct FTransform                             InitialTransform;                                  // 0x0210(0x0060)
...
public:
	...
	TScriptInterface<class IGizmoClickTarget>     HitTarget;                                         // 0x0060(0x0010)
	class USingleClickInputBehavior*              ClickBehavior;                                     // 0x0070(0x0008)
...
{
public:
	uint8                                         Pad_710[0x8];                                      // 0x0710(0x0008)
	class UGizmoViewContext*                      GizmoViewContext;                                  // 0x0718(0x0008)
	class UPrimitiveComponent*                    SubstituteInteractionComponent;                    // 0x0720(0x0008)
	class UMaterialInterface*                     HoverOverrideMaterial;                             // 0x0728(0x0008)
	uint8                                         Pad_730[0x20];                                     // 0x0730(0x0020)
...
{
public:
	uint8                                         Pad_80[0xA0];                                      // 0x0080(0x00A0)
	bool                                          bUpdateModifiersDuringDrag;                        // 0x0120(0x0001)
	uint8                                         Pad_121[0x1F];                                     // 0x0121(0x001F)
...
{
public:
	uint8                                         Pad_140[0x140];                                    // 0x0140(0x0140)
...
public:
	...
	uint8                                         Pad_C1[0x6F];                                      // 0x00C1(0x006F)
...
{
public:
	uint8                                         Pad_130[0xD0];                                     // 0x0130(0x00D0)
...
{
public:
	uint8                                         Pad_30[0x68];                                      // 0x0030(0x0068)
...
{
public:
	uint8                                         Pad_30[0xE0];                                      // 0x0030(0x00E0)
...
{
public:
	uint8                                         Pad_E0[0x140];                                     // 0x00E0(0x0140)
...
{
public:
	uint8                                         Pad_80[0xB0];                                      // 0x0080(0x00B0)
...
{
public:
	uint8                                         Pad_80[0xF0];                                      // 0x0080(0x00F0)
...
public:
	...
	TScriptInterface<class IGizmoAxisSource>      AxisSource;                                        // 0x0048(0x0010)
	TScriptInterface<class IGizmoFloatParameterSource> AngleSource;                                  // 0x0058(0x0010)
	TScriptInterface<class IGizmoClickTarget>     HitTarget;                                         // 0x0068(0x0010)
	TScriptInterface<class IGizmoStateTarget>     StateTarget;                                       // 0x0078(0x0010)
	class UClickDragInputBehavior*                MouseBehavior;                                     // 0x0088(0x0008)
	uint8                                         Pad_90[0x80];                                      // 0x0090(0x0080)
	bool                                          bInInteraction;                                    // 0x0110(0x0001)
	uint8                                         Pad_111[0x7];                                      // 0x0111(0x0007)
	struct FVector                                RotationOrigin;                                    // 0x0118(0x0018)
	struct FVector                                RotationAxis;                                      // 0x0130(0x0018)
	struct FVector                                RotationPlaneX;                                    // 0x0148(0x0018)
	struct FVector                                RotationPlaneY;                                    // 0x0160(0x0018)
	struct FVector                                InteractionStartPoint;                             // 0x0178(0x0018)
	struct FVector                                InteractionCurPoint;                               // 0x0190(0x0018)
	float                                         InteractionStartAngle;                             // 0x01A8(0x0004)
	float                                         InteractionCurAngle;                               // 0x01AC(0x0004)
	uint8                                         Pad_1B0[0x20];                                     // 0x01B0(0x0020)
...
public:
	uint8                                         Pad_38[0x10];                                      // 0x0038(0x0010)
	TScriptInterface<class IGizmoAxisSource>      AxisSource;                                        // 0x0048(0x0010)
	TScriptInterface<class IGizmoFloatParameterSource> ParameterSource;                              // 0x0058(0x0010)
	class UGizmoViewContext*                      GizmoViewContext;                                  // 0x0068(0x0008)
	TScriptInterface<class IGizmoClickTarget>     HitTarget;                                         // 0x0070(0x0010)
	TScriptInterface<class IGizmoStateTarget>     StateTarget;                                       // 0x0080(0x0010)
	class UClickDragInputBehavior*                MouseBehavior;                                     // 0x0090(0x0008)
	bool                                          bEnableSignedAxis;                                 // 0x0098(0x0001)
	uint8                                         Pad_99[0x88];                                      // 0x0099(0x0088)
	bool                                          bInInteraction;                                    // 0x0121(0x0001)
	uint8                                         Pad_122[0x6];                                      // 0x0122(0x0006)
	struct FVector                                InteractionOrigin;                                 // 0x0128(0x0018)
	struct FVector                                InteractionAxis;                                   // 0x0140(0x0018)
	struct FVector                                InteractionStartPoint;                             // 0x0158(0x0018)
	struct FVector                                InteractionCurPoint;                               // 0x0170(0x0018)
	...
	uint8                                         Pad_194[0x2C];                                     // 0x0194(0x002C)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	struct FVector                                Origin;                                            // 0x0030(0x0018)
	struct FVector                                Direction;                                         // 0x0048(0x0018)
...
public:
	...
	struct FVector                                Origin;                                            // 0x0030(0x0018)
	struct FVector                                Direction;                                         // 0x0048(0x0018)
	struct FVector                                TangentX;                                          // 0x0060(0x0018)
	struct FVector                                TangentY;                                          // 0x0078(0x0018)
...
public:
	...
	float                                         BrushStrength;                                     // 0x0044(0x0004)
	struct FVector                                BrushPosition;                                     // 0x0048(0x0018)
	struct FVector                                BrushNormal;                                       // 0x0060(0x0018)
	bool                                          bDrawIndicatorLines;                               // 0x0078(0x0001)
	bool                                          bDrawRadiusCircle;                                 // 0x0079(0x0001)
	bool                                          bScaleNormalByStrength;                            // 0x007A(0x0001)
	uint8                                         Pad_7B[0x1];                                       // 0x007B(0x0001)
	int32                                         SampleStepCount;                                   // 0x007C(0x0004)
	struct FLinearColor                           LineColor;                                         // 0x0080(0x0010)
	...
	struct FLinearColor                           SecondaryLineColor;                                // 0x009C(0x0010)
...
{
public:
	class UPrimitiveComponent*                    TranslateX;                                        // 0x0498(0x0008)
	class UPrimitiveComponent*                    TranslateY;                                        // 0x04A0(0x0008)
	class UPrimitiveComponent*                    TranslateZ;                                        // 0x04A8(0x0008)
	class UPrimitiveComponent*                    TranslateYZ;                                       // 0x04B0(0x0008)
	class UPrimitiveComponent*                    TranslateXZ;                                       // 0x04B8(0x0008)
	class UPrimitiveComponent*                    TranslateXY;                                       // 0x04C0(0x0008)
	class UPrimitiveComponent*                    RotateX;                                           // 0x04C8(0x0008)
	class UPrimitiveComponent*                    RotateY;                                           // 0x04D0(0x0008)
	class UPrimitiveComponent*                    RotateZ;                                           // 0x04D8(0x0008)
	class UPrimitiveComponent*                    RotationSphere;                                    // 0x04E0(0x0008)
	class UPrimitiveComponent*                    UniformScale;                                      // 0x04E8(0x0008)
	class UPrimitiveComponent*                    AxisScaleX;                                        // 0x04F0(0x0008)
	class UPrimitiveComponent*                    AxisScaleY;                                        // 0x04F8(0x0008)
	class UPrimitiveComponent*                    AxisScaleZ;                                        // 0x0500(0x0008)
	class UPrimitiveComponent*                    PlaneScaleYZ;                                      // 0x0508(0x0008)
	class UPrimitiveComponent*                    PlaneScaleXZ;                                      // 0x0510(0x0008)
	class UPrimitiveComponent*                    PlaneScaleXY;                                      // 0x0518(0x0008)
...
public:
	...
	struct FVector                                ExplicitGridSize;                                  // 0x0048(0x0018)
	bool                                          bRotationGridSizeIsExplicit;                       // 0x0060(0x0001)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)
	struct FRotator                               ExplicitRotationGridSize;                          // 0x0068(0x0018)
	bool                                          bSnapToWorldRotGrid;                               // 0x0080(0x0001)
	bool                                          bSnapToScaleGrid;                                  // 0x0081(0x0001)
	bool                                          bUseContextCoordinateSystem;                       // 0x0082(0x0001)
	EToolContextCoordinateSystem                  CurrentCoordinateSystem;                           // 0x0083(0x0001)
	bool                                          bUseContextGizmoMode;                              // 0x0084(0x0001)
	EToolContextTransformGizmoMode                ActiveGizmoMode;                                   // 0x0085(0x0001)
	uint8                                         Pad_86[0x12A];                                     // 0x0086(0x012A)
	...
	uint8                                         Pad_260[0x150];                                    // 0x0260(0x0150)
...
{
public:
	struct FVector                                Direction;                                         // 0x0658(0x0018)
	float                                         Gap;                                               // 0x0670(0x0004)
	float                                         Length;                                            // 0x0674(0x0004)
	float                                         Thickness;                                         // 0x0678(0x0004)
...
{
public:
	struct FVector                                Origin;                                            // 0x0658(0x0018)
	struct FQuat                                  Rotation;                                          // 0x0670(0x0020)
	struct FVector                                Dimensions;                                        // 0x0690(0x0018)
	float                                         LineThickness;                                     // 0x06A8(0x0004)
	bool                                          bRemoveHiddenLines;                                // 0x06AC(0x0001)
	bool                                          bEnableAxisFlip;                                   // 0x06AD(0x0001)
...
{
public:
	struct FVector                                Normal;                                            // 0x0658(0x0018)
	float                                         Radius;                                            // 0x0670(0x0004)
	float                                         Thickness;                                         // 0x0674(0x0004)
	int32                                         NumSides;                                          // 0x0678(0x0004)
	bool                                          bViewAligned;                                      // 0x067C(0x0001)
	bool                                          bDrawFullCircle;                                   // 0x067D(0x0001)
	bool                                          bOnlyAllowFrontFacingHits;                         // 0x067E(0x0001)
...
public:
	...
	uint32                                        PartIdentifier;                                    // 0x0030(0x0004)
	struct FGizmoElementMeshRenderStateAttributes MeshRenderAttributes;                              // 0x0034(0x0060)
	...
	struct FVector                                ViewDependentAxis;                                 // 0x00A0(0x0018)
	...
	struct FVector                                ViewAlignAxis;                                     // 0x00C8(0x0018)
	struct FVector                                ViewAlignNormal;                                   // 0x00E0(0x0018)
...
{
public:
	struct FGizmoElementLineRenderStateAttributes LineRenderAttributes;                              // 0x0108(0x003C)
...
{
public:
	struct FVector                                Center;                                            // 0x0158(0x0018)
	struct FVector                                Axis0;                                             // 0x0170(0x0018)
	struct FVector                                Axis1;                                             // 0x0188(0x0018)
	double                                        Radius;                                            // 0x01A0(0x0008)
	int32                                         NumSegments;                                       // 0x01A8(0x0004)
...
public:
	...
	struct FVector                                base;                                              // 0x0128(0x0018)
	struct FVector                                Direction;                                         // 0x0140(0x0018)
	struct FVector                                SideDirection;                                     // 0x0158(0x0018)
	float                                         BodyLength;                                        // 0x0170(0x0004)
	float                                         BodyRadius;                                        // 0x0174(0x0004)
	float                                         HeadLength;                                        // 0x0178(0x0004)
	float                                         HeadRadius;                                        // 0x017C(0x0004)
	int32                                         NumSides;                                          // 0x0180(0x0004)
...
{
public:
	struct FVector                                Center;                                            // 0x0108(0x0018)
	struct FVector                                Dimensions;                                        // 0x0120(0x0018)
	struct FVector                                UpDirection;                                       // 0x0138(0x0018)
	struct FVector                                SideDirection;                                     // 0x0150(0x0018)
...
{
public:
	struct FVector                                Origin;                                            // 0x0108(0x0018)
	struct FVector                                Direction;                                         // 0x0120(0x0018)
	float                                         Height;                                            // 0x0138(0x0004)
	float                                         Radius;                                            // 0x013C(0x0004)
	int32                                         NumSides;                                          // 0x0140(0x0004)
...
{
public:
	struct FVector                                base;                                              // 0x0108(0x0018)
	struct FVector                                Direction;                                         // 0x0120(0x0018)
	float                                         Height;                                            // 0x0138(0x0004)
	float                                         Radius;                                            // 0x013C(0x0004)
	int32                                         NumSides;                                          // 0x0140(0x0004)
...
// 0x0068 (0x0090 - 0x0028)
class UGizmoElementHitTarget final : public UObject
{
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
...
// 0x0068 (0x0090 - 0x0028)
class UGizmoElementHitMultiTarget final : public UObject
{
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	class UGizmoElementBase*                      GizmoElement;                                      // 0x0030(0x0008)
...
{
public:
	TArray<struct FVector>                        Vertices;                                          // 0x0158(0x0010)
	struct FVector                                base;                                              // 0x0168(0x0018)
	struct FVector                                UpDirection;                                       // 0x0180(0x0018)
	struct FVector                                SideDirection;                                     // 0x0198(0x0018)
	bool                                          bDrawLineStrip;                                    // 0x01B0(0x0001)
	uint8                                         Pad_1B1[0x17];                                     // 0x01B1(0x0017)
...
public:
	...
	struct FVector                                UpDirection;                                       // 0x0178(0x0018)
	struct FVector                                SideDirection;                                     // 0x0190(0x0018)
...
public:
	double                                        InnerRadius;                                       // 0x01C8(0x0008)
	int32                                         NumInnerSlices;                                    // 0x01D0(0x0004)
...
{
public:
	TArray<struct FVector>                        Vertices;                                          // 0x0108(0x0010)
	struct FVector                                base;                                              // 0x0118(0x0018)
	struct FVector                                UpDirection;                                       // 0x0130(0x0018)
	struct FVector                                SideDirection;                                     // 0x0148(0x0018)
...
public:
	struct FVector                                Normal;                                            // 0x0658(0x0018)
	float                                         HandleSize;                                        // 0x0670(0x0004)
	float                                         Thickness;                                         // 0x0674(0x0004)
	struct FVector                                Direction;                                         // 0x0678(0x0018)
	float                                         Length;                                            // 0x0690(0x0004)
	bool                                          bImageScale;                                       // 0x0694(0x0001)
	uint8                                         Pad_695[0xB];                                      // 0x0695(0x000B)
...
{
public:
	struct FVector                                DirectionX;                                        // 0x0658(0x0018)
	struct FVector                                DirectionY;                                        // 0x0670(0x0018)
	bool                                          bOrientYAccordingToCamera;                         // 0x0688(0x0001)
	uint8                                         Pad_689[0x3];                                      // 0x0689(0x0003)
	float                                         OffsetX;                                           // 0x068C(0x0004)
	float                                         OffsetY;                                           // 0x0690(0x0004)
	float                                         LengthX;                                           // 0x0694(0x0004)
	float                                         LengthY;                                           // 0x0698(0x0004)
	float                                         Thickness;                                         // 0x069C(0x0004)
	uint8                                         SegmentFlags;                                      // 0x06A0(0x0001)
	uint8                                         Pad_6A1[0xF];                                      // 0x06A1(0x000F)
...
{
public:
	uint8                                         Pad_28[0x1B8];                                     // 0x0028(0x01B8)
...
class UGizmoComponentHitTarget final : public UObject
{
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	class UPrimitiveComponent*                    Component;                                         // 0x0030(0x0008)
	uint8                                         Pad_38[0xC8];                                      // 0x0038(0x00C8)
...
{
public:
	class UGizmoLineHandleComponent*              UpIntervalComponent;                               // 0x0498(0x0008)
	class UGizmoLineHandleComponent*              DownIntervalComponent;                             // 0x04A0(0x0008)
	class UGizmoLineHandleComponent*              ForwardIntervalComponent;                          // 0x04A8(0x0008)
...
{
public:
	uint8                                         Pad_28[0x98];                                      // 0x0028(0x0098)
...
class UIntervalGizmo final : public UInteractiveGizmo
{
public:
	class UGizmoTransformChangeStateTarget*       StateTarget;                                       // 0x0038(0x0008)
	uint8                                         Pad_40[0x58];                                      // 0x0040(0x0058)
	...
	uint8                                         Pad_E8[0x118];                                     // 0x00E8(0x0118)
...
{
public:
	TScriptInterface<class IGizmoFloatParameterSource> FloatParameterSource;                         // 0x0048(0x0010)
...
public:
	uint8                                         Pad_38[0x10];                                      // 0x0038(0x0010)
	TScriptInterface<class IGizmoAxisSource>      AxisSource;                                        // 0x0048(0x0010)
	TScriptInterface<class IGizmoVec2ParameterSource> ParameterSource;                               // 0x0058(0x0010)
	TScriptInterface<class IGizmoClickTarget>     HitTarget;                                         // 0x0068(0x0010)
	TScriptInterface<class IGizmoStateTarget>     StateTarget;                                       // 0x0078(0x0010)
	class UClickDragInputBehavior*                MouseBehavior;                                     // 0x0088(0x0008)
	...
	uint8                                         Pad_93[0x8D];                                      // 0x0093(0x008D)
	bool                                          bInInteraction;                                    // 0x0120(0x0001)
	uint8                                         Pad_121[0x7];                                      // 0x0121(0x0007)
	struct FVector                                InteractionOrigin;                                 // 0x0128(0x0018)
	struct FVector                                InteractionNormal;                                 // 0x0140(0x0018)
	struct FVector                                InteractionAxisX;                                  // 0x0158(0x0018)
	struct FVector                                InteractionAxisY;                                  // 0x0170(0x0018)
	struct FVector                                InteractionStartPoint;                             // 0x0188(0x0018)
	struct FVector                                InteractionCurPoint;                               // 0x01A0(0x0018)
	struct FVector2D                              InteractionStartParameter;                         // 0x01B8(0x0010)
	struct FVector2D                              InteractionCurParameter;                           // 0x01C8(0x0010)
	struct FVector2D                              ParameterSigns;                                    // 0x01D8(0x0010)
	uint8                                         Pad_1E8[0xC8];                                     // 0x01E8(0x00C8)
...
{
public:
	uint8                                         Pad_3B0[0x90];                                     // 0x03B0(0x0090)
...
class UScalableSphereGizmo final : public UInteractiveGizmo
{
public:
	uint8                                         Pad_38[0x48];                                      // 0x0038(0x0048)
	float                                         HitErrorThreshold;                                 // 0x0080(0x0004)
	uint8                                         Pad_84[0x4];                                       // 0x0084(0x0004)
	class FText                                   TransactionDescription;                            // 0x0088(0x0010)
	...
	struct FVector                                ActiveAxis;                                        // 0x00A8(0x0018)
	struct FVector                                DragStartWorldPosition;                            // 0x00C0(0x0018)
	struct FVector                                DragCurrentPositionProjected;                      // 0x00D8(0x0018)
...
{
public:
	uint8                                         Pad_80[0x50];                                      // 0x0080(0x0050)
...
{
public:
	uint8                                         Pad_28[0x88];                                      // 0x0028(0x0088)
...
public:
	uint8                                         Pad_28[0x20];                                      // 0x0028(0x0020)
	TScriptInterface<class IToolContextTransactionProvider> TransactionManager;                      // 0x0048(0x0010)
...
class UGizmoTransformChangeStateTarget final : public UObject
{
public:
	uint8                                         Pad_28[0x20];                                      // 0x0028(0x0020)
	TScriptInterface<class IToolContextTransactionProvider> TransactionManager;                      // 0x0048(0x0010)
...
class UGizmoScaledTransformSource final : public UGizmoBaseTransformSource
{
public:
	TScriptInterface<class IGizmoTransformSource> ChildTransformSource;                              // 0x0048(0x0010)
	uint8                                         Pad_58[0x88];                                      // 0x0058(0x0088)
...
{
public:
	TScriptInterface<class IGizmoTransformSource> ScaledTransformSource;                             // 0x0048(0x0010)
	TScriptInterface<class IGizmoTransformSource> UnscaledTransformSource;                           // 0x0058(0x0010)
...
public:
	...
	TMap<class FString, class UInteractiveToolPropertySet*> CachedPropertiesMap;                     // 0x0038(0x0050)
	bool                                          bIsPropertySetEnabled;                             // 0x0088(0x0001)
	uint8                                         Pad_89[0x1F];                                      // 0x0089(0x001F)
...
public:
	...
	uint8                                         Pad_78[0x20];                                      // 0x0078(0x0020)
...
{
public:
	uint8                                         Pad_A8[0x50];                                      // 0x00A8(0x0050)
...
public:
	...
	struct FBrushStampData                        LastBrushStamp;                                    // 0x0110(0x0148)
	uint8                                         Pad_258[0x10];                                     // 0x0258(0x0010)
	TSoftClassPtr<class UClass>                   PropertyClass;                                     // 0x0268(0x0028)
	class UBrushStampIndicator*                   BrushStampIndicator;                               // 0x0290(0x0008)
	uint8                                         Pad_298[0x10];                                     // 0x0298(0x0010)
...
{
public:
	TArray<struct FBehaviorInfo>                  Behaviors;                                         // 0x0028(0x0010)
...
public:
	...
	uint8                                         Pad_40[0x150];                                     // 0x0040(0x0150)
...
public:
	...
	uint8                                         Pad_68[0x98];                                      // 0x0068(0x0098)
	TMap<class FString, class UInteractiveToolBuilder*> ToolBuilders;                                // 0x0100(0x0050)
	uint8                                         Pad_150[0x60];                                     // 0x0150(0x0060)
...
public:
	...
	uint8                                         Pad_80[0x280];                                     // 0x0080(0x0280)
	TSoftClassPtr<class UClass>                   ToolManagerClass;                                  // 0x0300(0x0028)
...
{
public:
	TArray<int32>                                 Vertices;                                          // 0x0040(0x0010)
	TArray<int32>                                 Edges;                                             // 0x0050(0x0010)
	TArray<int32>                                 Faces;                                             // 0x0060(0x0010)
	TArray<int32>                                 Groups;                                            // 0x0070(0x0010)
