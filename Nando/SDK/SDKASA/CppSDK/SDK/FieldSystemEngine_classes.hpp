...
{
public:
	class UFieldSystemComponent*                  FieldSystemComponent;                              // 0x0490(0x0008)
...
{
public:
	class UFieldSystem*                           FieldSystem;                                       // 0x0620(0x0008)
	bool                                          bIsWorldField;                                     // 0x0628(0x0001)
	bool                                          bIsChaosField;                                     // 0x0629(0x0001)
	uint8                                         Pad_62A[0x6];                                      // 0x062A(0x0006)
	TArray<TSoftObjectPtr<class AChaosSolverActor>> SupportedSolvers;                                // 0x0630(0x0010)
	struct FFieldObjectCommands                   ConstructionCommands;                              // 0x0640(0x0030)
	struct FFieldObjectCommands                   BufferCommands;                                    // 0x0670(0x0030)
	uint8                                         Pad_6A0[0x50];                                     // 0x06A0(0x0050)
...
{
public:
	int32                                         Iterations;                                        // 0x00D0(0x0004)
...
{
public:
	EFieldResolutionType                          ResolutionType;                                    // 0x00D0(0x0001)
...
{
public:
	EFieldFilterType                              FilterType;                                        // 0x00D0(0x0001)
	EFieldObjectType                              ObjectType;                                        // 0x00D1(0x0001)
	EFieldPositionType                            PositionType;                                      // 0x00D2(0x0001)
...
public:
	...
	uint8                                         Pad_D4[0x4];                                       // 0x00D4(0x0004)
	struct FVector                                position;                                          // 0x00D8(0x0018)
	int32                                         InteriorValue;                                     // 0x00F0(0x0004)
	int32                                         ExteriorValue;                                     // 0x00F4(0x0004)
	ESetMaskConditionType                         SetMaskCondition;                                  // 0x00F8(0x0001)
...
public:
	...
	EWaveFunctionType                             Function;                                          // 0x00F8(0x0001)
	EFieldFalloffType                             Falloff;                                           // 0x00F9(0x0001)
...
public:
	float                                         Magnitude;                                         // 0x00D0(0x0004)
	float                                         MinRange;                                          // 0x00D4(0x0004)
	float                                         MaxRange;                                          // 0x00D8(0x0004)
	float                                         Default;                                           // 0x00DC(0x0004)
	float                                         Radius;                                            // 0x00E0(0x0004)
	uint8                                         Pad_E4[0x4];                                       // 0x00E4(0x0004)
	struct FVector                                position;                                          // 0x00E8(0x0018)
	EFieldFalloffType                             Falloff;                                           // 0x0100(0x0001)
...
public:
	...
	uint8                                         Pad_E4[0x4];                                       // 0x00E4(0x0004)
	struct FVector                                position;                                          // 0x00E8(0x0018)
	struct FVector                                Normal;                                            // 0x0100(0x0018)
	EFieldFalloffType                             Falloff;                                           // 0x0118(0x0001)
...
public:
	...
	float                                         MaxRange;                                          // 0x00D8(0x0004)
	float                                         Default;                                           // 0x00DC(0x0004)
	struct FTransform                             Transform;                                         // 0x00E0(0x0060)
	EFieldFalloffType                             Falloff;                                           // 0x0140(0x0001)
...
{
public:
	float                                         MinRange;                                          // 0x00D0(0x0004)
	float                                         MaxRange;                                          // 0x00D4(0x0004)
...
public:
	float                                         Magnitude;                                         // 0x00D0(0x0004)
	uint8                                         Pad_D4[0x4];                                       // 0x00D4(0x0004)
	struct FVector                                Direction;                                         // 0x00D8(0x0018)
...
public:
	float                                         Magnitude;                                         // 0x00D0(0x0004)
	uint8                                         Pad_D4[0x4];                                       // 0x00D4(0x0004)
	class UFieldNodeBase*                         RightField;                                        // 0x00D8(0x0008)
	class UFieldNodeBase*                         LeftField;                                         // 0x00E0(0x0008)
	EFieldOperationType                           Operation;                                         // 0x00E8(0x0001)
...
{
public:
	class UFieldNodeFloat*                        FloatField;                                        // 0x00D0(0x0008)
...
{
public:
	class UFieldNodeInt*                          IntField;                                          // 0x00D0(0x0008)
...
{
public:
	class UFieldNodeBase*                         Culling;                                           // 0x00D0(0x0008)
	class UFieldNodeBase*                         Field;                                             // 0x00D8(0x0008)
	EFieldCullingOperationType                    Operation;                                         // 0x00E0(0x0001)
