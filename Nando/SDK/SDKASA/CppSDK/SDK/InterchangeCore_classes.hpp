...
{
public:
	class FString                                 Filename;                                          // 0x0028(0x0010)
...
public:
	...
	class FString                                 ContentImportPath;                                 // 0x0038(0x0010)
	struct FSoftObjectPath                        ReimportLevel;                                     // 0x0048(0x0020)
	uint8                                         Pad_68[0x3];                                       // 0x0068(0x0003)
	bool                                          bFromReimportOrOverride;                           // 0x006B(0x0001)
	uint8                                         Pad_6C[0x4];                                       // 0x006C(0x0004)
	class UInterchangeResultsContainer*           Results;                                           // 0x0070(0x0008)
	TMap<class FName, struct FInterchangePipelinePropertyStates> PropertiesStates;                   // 0x0078(0x0050)
	uint8                                         Pad_C8[0x80];                                      // 0x00C8(0x0080)
...
{
public:
	class FString                                 SourceAssetName;                                   // 0x0028(0x0010)
	class FString                                 DestinationAssetName;                              // 0x0038(0x0010)
	class FString                                 AssetFriendlyName;                                 // 0x0048(0x0010)
	TSubclassOf<class UObject>                    AssetType;                                         // 0x0058(0x0008)
	class FString                                 InterchangeKey;                                    // 0x0060(0x0010)
...
{
public:
	class FText                                   Text;                                              // 0x0070(0x0010)
...
{
public:
	TMap<class FString, class UInterchangeBaseNode*> Nodes;                                          // 0x0028(0x0050)
	uint8                                         Pad_78[0x50];                                      // 0x0078(0x0050)
...
{
public:
	uint8                                         Pad_60[0xF0];                                      // 0x0060(0x00F0)
...
{
public:
	uint8                                         Pad_60[0xF8];                                      // 0x0060(0x00F8)
