...
public:
	...
	TSoftObjectPtr<class UObject>                 TypeObject;                                        // 0x0008(0x0028)
};
...
public:
	...
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0008(0x0030)
};
...
public:
	...
	TArray<class FName>                           DimensionNames;                                    // 0x0008(0x0010)
	int32                                         Multiplier;                                        // 0x0018(0x0004)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	class FString                                 Expression;                                        // 0x0020(0x0010)
	TArray<class FName>                           LevelNames;                                        // 0x0030(0x0010)
};
...
{
public:
	struct FOptimusValidatedName                  Name;                                              // 0x0000(0x0008)
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0008(0x0030)
	struct FOptimusDataDomain                     DataDomain;                                        // 0x0038(0x0040)
	bool                                          bSupportAtomicIfCompatibleDataType;                // 0x0078(0x0001)
	bool                                          bSupportRead;                                      // 0x0079(0x0001)
...
{
public:
	TArray<struct FOptimusParameterBinding>       InnerArray;                                        // 0x0000(0x0010)
};
...
{
public:
	class FName                                   NodePath;                                          // 0x0000(0x0008)
	class FName                                   GroupName;                                         // 0x0008(0x0008)
	class FName                                   ConstantName;                                      // 0x0010(0x0008)
};
...
{
public:
	struct FOptimusConstantIdentifier             ReferencedConstant;                                // 0x0000(0x0018)
	class FString                                 Expression;                                        // 0x0018(0x0010)
};
...
{
public:
	struct FOptimusConstantIdentifier             Identifier;                                        // 0x0000(0x0018)
	struct FOptimusConstantDefinition             Definition;                                        // 0x0018(0x0028)
	int32                                         ComponentBindingIndex;                             // 0x0040(0x0004)
	EOptimusConstantType                          Type;                                              // 0x0044(0x0004)
};
...
{
public:
	int32                                         KernelIndex;                                       // 0x0000(0x0004)
	EOptimusConstantType                          Type;                                              // 0x0004(0x0004)
	int32                                         ConstantIndex;                                     // 0x0008(0x0004)
};
...
{
public:
	TArray<struct FOptimusConstant>               InputConstants;                                    // 0x0000(0x0010)
	TArray<struct FOptimusConstant>               OutputConstants;                                   // 0x0010(0x0010)
	TMap<class FName, int32>                      GroupNameToBindingIndex;                           // 0x0020(0x0050)
};
...
{
public:
	TArray<struct FOptimusKernelConstantContainer> KernelContainers;                                 // 0x0000(0x0010)
};
...
{
public:
	class FString                                 Declarations;                                      // 0x0000(0x0010)
	class FString                                 ShaderText;                                        // 0x0010(0x0010)
};
...
{
public:
	EOptimusValueType                             Type;                                              // 0x0000(0x0001)
...
{
public:
	struct FInstancedPropertyBag                  Value;                                             // 0x0000(0x0010)
};
...
{
public:
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0000(0x0030)
	EOptimusValueUsage                            ValueUsage;                                        // 0x0030(0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
	struct FOptimusValueContainerStruct           Value;                                             // 0x0038(0x0010)
	struct FShaderValueContainer                  ShaderValue;                                       // 0x0048(0x0020)
};
...
{
public:
	TMap<class FName, struct FOptimusValueIdentifier> PinNameToValueIdMap;                           // 0x0000(0x0050)
};
...
{
public:
	TSoftObjectPtr<class UOptimusDeformer>        DeformerGraph;                                     // 0x0018(0x0028)
};
...
{
public:
	EOptimusDeformerExecutionPhase                ExecutionPhase;                                    // 0x0018(0x0001)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)
	int32                                         ExecutionGroup;                                    // 0x001C(0x0004)
	bool                                          DeformChildComponents;                             // 0x0020(0x0001)
	uint8                                         Pad_21[0x3];                                       // 0x0021(0x0003)
	class FName                                   ExcludeChildComponentsWithTag;                     // 0x0024(0x0008)
...
{
public:
	struct FGuid                                  DeformerInstanceGuid;                              // 0x01F0(0x0010)
};
...
{
public:
	TArray<int32>                                 Value;                                             // 0x0018(0x0010)
};
...
{
public:
	struct FIntPoint                              Value;                                             // 0x0018(0x0008)
};
...
{
public:
	TArray<struct FIntPoint>                      Value;                                             // 0x0018(0x0010)
};
...
{
public:
	struct FIntVector                             Value;                                             // 0x0018(0x000C)
...
{
public:
	TArray<struct FIntVector>                     Value;                                             // 0x0018(0x0010)
};
...
{
public:
	struct FIntVector4                            Value;                                             // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FIntVector4>                    Value;                                             // 0x0018(0x0010)
};
...
{
public:
	TArray<double>                                Value;                                             // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FVector2D>                      Value;                                             // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FVector>                        Value;                                             // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FVector4>                       Value;                                             // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FLinearColor>                   Value;                                             // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FQuat>                          Value;                                             // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FRotator>                       Value;                                             // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FTransform>                     Value;                                             // 0x0018(0x0010)
};
...
{
public:
	class FName                                   Value;                                             // 0x0018(0x0008)
};
...
{
public:
	TArray<class FName>                           Value;                                             // 0x0018(0x0010)
};
...
{
public:
	uint8                                         Pad_18[0x28];                                      // 0x0018(0x0028)
};
...
{
public:
	uint8                                         Pad_18[0x20];                                      // 0x0018(0x0020)
};
...
{
public:
	uint8                                         Pad_18[0x90];                                      // 0x0018(0x0090)
};
...
{
public:
	uint8                                         Pad_18[0xA0];                                      // 0x0018(0x00A0)
};
...
struct FOptimusNodeGraphAction_AddGraph final : public FOptimusAction
{
public:
	uint8                                         Pad_18[0x78];                                      // 0x0018(0x0078)
};
...
{
public:
	uint8                                         Pad_18[0x40];                                      // 0x0018(0x0040)
};
...
struct FOptimusNodeGraphAction_AddNode final : public FOptimusAction
{
public:
	uint8                                         Pad_18[0x88];                                      // 0x0018(0x0088)
};

// ScriptStruct OptimusCore.OptimusNodeGraphAction_DuplicateNode
// 0x0098 (0x00B0 - 0x0018)
struct FOptimusNodeGraphAction_DuplicateNode final : public FOptimusAction
{
public:
	uint8                                         Pad_18[0x98];                                      // 0x0018(0x0098)
};
...
{
public:
	uint8                                         Pad_18[0x48];                                      // 0x0018(0x0048)
};
...
{
public:
	uint8                                         Pad_18[0x38];                                      // 0x0018(0x0038)
};
...
{
public:
	uint8                                         Pad_18[0x60];                                      // 0x0018(0x0060)
};
...
public:
	...
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0010(0x0030)
	struct FOptimusValueContainerStruct           DefaultValueStruct;                                // 0x0040(0x0010)
	class FString                                 HlslId;                                            // 0x0050(0x0010)
	class FName                                   PinName;                                           // 0x0060(0x0008)
};
...
{
public:
	TArray<struct FOptimusAnimAttributeBufferDescription> InnerArray;                                // 0x0000(0x0010)
};
...
public:
	...
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0018(0x0030)
	struct FOptimusValueContainerStruct           DefaultValueStruct;                                // 0x0048(0x0010)
	class FString                                 HlslId;                                            // 0x0058(0x0010)
	class FName                                   PinName;                                           // 0x0068(0x0008)
	class UOptimusValueContainer*                 DefaultValue;                                      // 0x0070(0x0008)
};
...
{
public:
	TArray<struct FOptimusAnimAttributeDescription> InnerArray;                                      // 0x0000(0x0010)
};
...
public:
	...
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	int32                                         MaxLineCount;                                      // 0x0004(0x0004)
	int32                                         MaxTriangleCount;                                  // 0x0008(0x0004)
	int32                                         MaxCharacterCount;                                 // 0x000C(0x0004)
	int32                                         FontSize;                                          // 0x0010(0x0004)
};
...
public:
	class FString                                 Name;                                              // 0x0000(0x0010)
	struct FShaderValueTypeHandle                 ValueType;                                         // 0x0010(0x0008)
	struct FOptimusValueIdentifier                ValueId;                                           // 0x0018(0x000C)
	int32                                         Offset;                                            // 0x0024(0x0004)
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	TArray<uint8>                                 Value;                                             // 0x0030(0x0010)
	struct FShaderValueContainer                  ShaderValue;                                       // 0x0040(0x0020)
	TSoftObjectPtr<class UObject>                 SourceObject;                                      // 0x0060(0x0028)
};
...
{
public:
	class FName                                   BindingName;                                       // 0x0000(0x0008)
	TSubclassOf<class UOptimusComponentSource>    ComponentType;                                     // 0x0008(0x0008)
};
...
{
public:
	struct FOptimusValidatedName                  GroupName;                                         // 0x0000(0x0008)
	struct FOptimusParameterBindingArray          BindingArray;                                      // 0x0008(0x0010)
};
...
{
public:
	class FName                                   VariableName;                                      // 0x0000(0x0008)
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0008(0x0030)
	class FString                                 DefaultValue;                                      // 0x0038(0x0010)
};
...
{
public:
	TArray<class FName>                           InputPinPath;                                      // 0x0000(0x0010)
	TArray<class FName>                           OutputPinPath;                                     // 0x0010(0x0010)
};
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FOptimusParameterBindingArray          Bindings;                                          // 0x0008(0x0010)
};
...
{
public:
	class FName                                   ResourceName;                                      // 0x0000(0x0008)
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0008(0x0030)
	struct FOptimusDataDomain                     DataDomain;                                        // 0x0038(0x0040)
};
...
public:
	...
	struct FShaderValueTypeHandle                 ShaderValueType;                                   // 0x0018(0x0008)
	int32                                         ShaderValueSize;                                   // 0x0020(0x0004)
	class FName                                   TypeCategory;                                      // 0x0024(0x0008)
	TWeakObjectPtr<class UObject>                 TypeObject;                                        // 0x002C(0x0008)
	bool                                          bHasCustomPinColor;                                // 0x0034(0x0001)
	uint8                                         Pad_35[0x3];                                       // 0x0035(0x0003)
	struct FLinearColor                           CustomPinColor;                                    // 0x0038(0x0010)
	EOptimusDataTypeUsageFlags                    UsageFlags;                                        // 0x0048(0x0001)
	EOptimusDataTypeFlags                         TypeFlags;                                         // 0x0049(0x0001)
...
public:
	...
	class FName                                   GraphName;                                         // 0x0004(0x0008)
...
public:
	...
	struct FComputeGraphInstance                  ComputeGraphInstance;                              // 0x0018(0x0018)
};
...
{
public:
	class FName                                   ProviderName;                                      // 0x0000(0x0008)
	class FName                                   ComponentName;                                     // 0x0008(0x0008)
};
...
public:
	...
	class FName                                   Name;                                              // 0x0004(0x0008)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	class FString                                 Expression;                                        // 0x0010(0x0010)
};
...
{
public:
	TSoftObjectPtr<class UOptimusFunctionNodeGraph> GraphPath;                                       // 0x0000(0x0028)
	class FName                                   FunctionName;                                      // 0x0028(0x0008)
	class FName                                   Category;                                          // 0x0030(0x0008)
};
...
{
public:
	TArray<struct FOptimusFunctionNodeGraphHeader> Headers;                                          // 0x0000(0x0010)
};
...
{
public:
	TSet<TSoftObjectPtr<class UOptimusNode_FunctionReference>> Nodes;                                // 0x0000(0x0050)
};
...
{
public:
	TMap<struct FSoftObjectPath, struct FOptimusFunctionReferenceNodeSet> FunctionReferences;        // 0x0000(0x0050)
};
