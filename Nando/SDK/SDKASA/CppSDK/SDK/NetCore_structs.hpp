...
public:
	...
	class FString                                 StateName;                                         // 0x0008(0x0010)
};
...
{
public:
	int32                                         ReplicationID;                                     // 0x0000(0x0004)
	int32                                         ReplicationKey;                                    // 0x0004(0x0004)
	int32                                         MostRecentArrayReplicationKey;                     // 0x0008(0x0004)
};
...
{
public:
	uint8                                         Pad_0[0x54];                                       // 0x0000(0x0054)
	int32                                         ArrayReplicationKey;                               // 0x0054(0x0004)
	uint8                                         Pad_58[0xA8];                                      // 0x0058(0x00A8)
...
public:
	...
	int16                                         CooloffTime;                                       // 0x001A(0x0002)
	int16                                         AutoEscalateTime;                                  // 0x001C(0x0002)
	int8                                          HighestTimePeriod;                                 // 0x001E(0x0001)
	uint8                                         Pad_1F[0x1];                                       // 0x001F(0x0001)
	TArray<int8>                                  AllTimePeriods;                                    // 0x0020(0x0010)
};
...
public:
	...
	uint8                                         Pad_31[0x1];                                       // 0x0031(0x0001)
	int16                                         EscalateQuotaFaultsPerPeriod;                      // 0x0032(0x0002)
	int8                                          EscalateQuotaFaultPercentPerPeriod;                // 0x0034(0x0001)
	uint8                                         Pad_35[0x1];                                       // 0x0035(0x0001)
	int16                                         DescalateQuotaFaultsPerPeriod;                     // 0x0036(0x0002)
	int8                                          DescalateQuotaFaultPercentPerPeriod;               // 0x0038(0x0001)
	int8                                          EscalateQuotaTimePeriod;                           // 0x0039(0x0001)
