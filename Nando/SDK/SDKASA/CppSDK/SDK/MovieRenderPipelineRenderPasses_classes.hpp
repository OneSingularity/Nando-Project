...
{
public:
	uint8                                         bOverride_ShowFlags : 1;                           // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	class UMovieGraphShowFlags*                   ShowFlags;                                         // 0x00B0(0x0008)
...
{
public:
	uint8                                         bOverride_SpatialSampleCount : 1;                  // 0x00C8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_AntiAliasingMethod : 1;                  // 0x00C8(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_bDisableToneCurve : 1;                   // 0x00C8(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverride_bAllowOCIO : 1;                          // 0x00C8(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bOverride_ViewModeIndex : 1;                       // 0x00C8(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bOverride_bWriteAllSamples : 1;                    // 0x00C8(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bOverride_AdditionalPostProcessMaterials : 1;      // 0x00C8(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         Pad_C9[0x3];                                       // 0x00C9(0x0003)
	int32                                         SpatialSampleCount;                                // 0x00CC(0x0004)
	EAntiAliasingMethod                           AntiAliasingMethod;                                // 0x00D0(0x0001)
	bool                                          bWriteAllSamples;                                  // 0x00D1(0x0001)
	bool                                          bDisableToneCurve;                                 // 0x00D2(0x0001)
	bool                                          bAllowOCIO;                                        // 0x00D3(0x0001)
	EViewModeIndex                                ViewModeIndex;                                     // 0x00D4(0x0001)
	uint8                                         Pad_D5[0x3];                                       // 0x00D5(0x0003)
	TArray<struct FMoviePipelinePostProcessPass>  AdditionalPostProcessMaterials;                    // 0x00D8(0x0010)
...
{
public:
	uint8                                         bOverride_OCIOConfiguration : 1;                   // 0x00C0(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_OCIOContext : 1;                         // 0x00C0(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_C1[0x7];                                       // 0x00C1(0x0007)
	struct FOpenColorIODisplayConfiguration       OCIOConfiguration;                                 // 0x00C8(0x0088)
	TMap<class FString, class FString>            OCIOContext;                                       // 0x0150(0x0050)
	uint8                                         Pad_1A0[0x20];                                     // 0x01A0(0x0020)
...
{
public:
	uint8                                         bOverride_Compression : 1;                         // 0x01C0(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	EEXRCompressionFormat                         Compression;                                       // 0x01C1(0x0001)
...
public:
	uint8                                         bOverride_SpatialSampleCount : 1;                  // 0x00C8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_bEnableReferenceMotionBlur : 1;          // 0x00C8(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_bEnableDenoiser : 1;                     // 0x00C8(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverride_DenoiserType : 1;                        // 0x00C8(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bOverride_FrameCount : 1;                          // 0x00C8(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bOverride_bDisableToneCurve : 1;                   // 0x00C8(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bOverride_bAllowOCIO : 1;                          // 0x00C8(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bOverride_bLightingComponents_IncludeEmissive : 1; // 0x00C8(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
	uint8                                         bOverride_bLightingComponents_IncludeDiffuse : 1;  // 0x00C9(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_bLightingComponents_IncludeIndirectDiffuse : 1; // 0x00C9(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_bLightingComponents_IncludeSpecular : 1; // 0x00C9(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverride_bLightingComponents_IncludeIndirectSpecular : 1; // 0x00C9(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bOverride_bLightingComponents_IncludeVolume : 1;   // 0x00C9(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bOverride_bLightingComponents_IncludeIndirectVolume : 1; // 0x00C9(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bOverride_bWriteAllSamples : 1;                    // 0x00C9(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bOverride_AdditionalPostProcessMaterials : 1;      // 0x00C9(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
	uint8                                         Pad_CA[0x2];                                       // 0x00CA(0x0002)
	int32                                         SpatialSampleCount;                                // 0x00CC(0x0004)
	bool                                          bEnableReferenceMotionBlur;                        // 0x00D0(0x0001)
	bool                                          bEnableDenoiser;                                   // 0x00D1(0x0001)
	EMovieGraphPathTracerDenoiserType             DenoiserType;                                      // 0x00D2(0x0001)
	uint8                                         Pad_D3[0x1];                                       // 0x00D3(0x0001)
	int32                                         FrameCount;                                        // 0x00D4(0x0004)
	bool                                          bWriteAllSamples;                                  // 0x00D8(0x0001)
	bool                                          bDisableToneCurve;                                 // 0x00D9(0x0001)
	bool                                          bAllowOCIO;                                        // 0x00DA(0x0001)
	bool                                          bLightingComponents_IncludeEmissive;               // 0x00DB(0x0001)
	bool                                          bLightingComponents_IncludeDiffuse;                // 0x00DC(0x0001)
	bool                                          bLightingComponents_IncludeIndirectDiffuse;        // 0x00DD(0x0001)
	bool                                          bLightingComponents_IncludeSpecular;               // 0x00DE(0x0001)
	bool                                          bLightingComponents_IncludeIndirectSpecular;       // 0x00DF(0x0001)
	bool                                          bLightingComponents_IncludeVolume;                 // 0x00E0(0x0001)
	bool                                          bLightingComponents_IncludeIndirectVolume;         // 0x00E1(0x0001)
	uint8                                         Pad_E2[0x6];                                       // 0x00E2(0x0006)
	TArray<struct FMoviePipelinePostProcessPass>  AdditionalPostProcessMaterials;                    // 0x00E8(0x0010)
...
{
public:
	uint8                                         Pad_48[0x130];                                     // 0x0048(0x0130)
...
public:
	...
	TArray<struct FMoviePipelinePostProcessPass>  AdditionalPostProcessMaterials;                    // 0x0180(0x0010)
	bool                                          bRenderMainPass;                                   // 0x0190(0x0001)
	bool                                          bAddDefaultLayer;                                  // 0x0191(0x0001)
	uint8                                         Pad_192[0x6];                                      // 0x0192(0x0006)
	TArray<struct FActorLayer>                    ActorLayers;                                       // 0x0198(0x0010)
	TArray<struct FSoftObjectPath>                DataLayers;                                        // 0x01A8(0x0010)
	TArray<class UMaterialInterface*>             ActivePostProcessMaterials;                        // 0x01B8(0x0010)
	TSet<class UMaterialInterface*>               ActiveHighPrecisionPostProcessMaterials;           // 0x01C8(0x0050)
	class UMaterialInterface*                     StencilLayerMaterial;                              // 0x0218(0x0008)
	uint8                                         Pad_220[0x58];                                     // 0x0220(0x0058)
...
{
public:
	bool                                          bReferenceMotionBlur;                              // 0x0278(0x0001)
...
public:
	...
	uint8                                         Pad_58[0x60];                                      // 0x0058(0x0060)
