...
public:
	...
	TArray<class FString>                         ScriptTags;                                        // 0x0040(0x0010)
	TArray<class UMovieGraphPin*>                 InputPins;                                         // 0x0050(0x0010)
	TArray<class UMovieGraphPin*>                 OutputPins;                                        // 0x0060(0x0010)
	struct FInstancedPropertyBag                  DynamicProperties;                                 // 0x0070(0x0010)
	TArray<struct FMovieGraphPropertyInfo>        ExposedPropertyInfo;                               // 0x0080(0x0010)
	uint8                                         bIsDisabled : 1;                                   // 0x0090(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_91[0x3];                                       // 0x0091(0x0003)
	struct FGuid                                  Guid;                                              // 0x0094(0x0010)
...
{
public:
	uint8                                         bOverride_ConsoleVariablePreset : 1;               // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	TScriptInterface<class IMovieSceneConsoleVariableTrackInterface> ConsoleVariablePreset;          // 0x00B0(0x0010)
...
{
public:
	uint8                                         bOverride_FileNameFormat : 1;                      // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	class FString                                 FileNameFormat;                                    // 0x00B0(0x0010)
...
{
public:
	uint8                                         Pad_C0[0x10];                                      // 0x00C0(0x0010)
...
{
public:
	uint8                                         bOverride_bCompositeOntoFinalImage : 1;            // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	bool                                          bCompositeOntoFinalImage;                          // 0x00A9(0x0001)
	uint8                                         Pad_AA[0x76];                                      // 0x00AA(0x0076)
...
{
public:
	uint8                                         bOverride_BurnInClass : 1;                         // 0x0120(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_121[0x7];                                      // 0x0121(0x0007)
	struct FSoftClassPath                         BurnInClass;                                       // 0x0128(0x0020)
	TMap<TSubclassOf<class UObject>, class UMovieGraphBurnInWidget*> BurnInWidgetInstances;          // 0x0148(0x0050)
...
{
public:
	uint8                                         bOverride_ShutterTiming : 1;                       // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_OverscanPercentage : 1;                  // 0x00A8(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_bRenderAllCameras : 1;                   // 0x00A8(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	EMoviePipelineShutterTiming                   ShutterTiming;                                     // 0x00A9(0x0001)
	uint8                                         Pad_AA[0x2];                                       // 0x00AA(0x0002)
	float                                         OverscanPercentage;                                // 0x00AC(0x0004)
	bool                                          bRenderAllCameras;                                 // 0x00B0(0x0001)
...
{
public:
	uint8                                         bOverride_Collection : 1;                          // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	class UMovieGraphCollection*                  Collection;                                        // 0x00B0(0x0008)
...
public:
	...
	uint8                                         bOverride_FileNameFormat : 1;                      // 0x00B0(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_bDeleteSourceFiles : 1;                  // 0x00B0(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_bSkipEncodeOnRenderCanceled : 1;         // 0x00B0(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverride_VideoCodec : 1;                          // 0x00B0(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bOverride_AudioCodec : 1;                          // 0x00B0(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bOverride_OutputFileExtension : 1;                 // 0x00B0(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bOverride_CommandLineFormat : 1;                   // 0x00B0(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bOverride_VideoInputStringFormat : 1;              // 0x00B0(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
	uint8                                         bOverride_AudioInputStringFormat : 1;              // 0x00B1(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_EncodeSettings : 1;                      // 0x00B1(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_bRetainInputTextFiles : 1;               // 0x00B1(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         Pad_B2[0x6];                                       // 0x00B2(0x0006)
	class FString                                 FileNameFormat;                                    // 0x00B8(0x0010)
	bool                                          bDeleteSourceFiles;                                // 0x00C8(0x0001)
	bool                                          bSkipEncodeOnRenderCanceled;                       // 0x00C9(0x0001)
	uint8                                         Pad_CA[0x6];                                       // 0x00CA(0x0006)
	class FString                                 VideoCodec;                                        // 0x00D0(0x0010)
	class FString                                 AudioCodec;                                        // 0x00E0(0x0010)
	class FString                                 OutputFileExtension;                               // 0x00F0(0x0010)
	class FString                                 CommandLineFormat;                                 // 0x0100(0x0010)
	class FString                                 VideoInputStringFormat;                            // 0x0110(0x0010)
	class FString                                 AudioInputStringFormat;                            // 0x0120(0x0010)
	class FString                                 EncodeSettings;                                    // 0x0130(0x0010)
	bool                                          bRetainInputTextFiles;                             // 0x0140(0x0001)
...
public:
	...
	struct FInstancedPropertyBag                  Value;                                             // 0x0030(0x0010)
...
{
public:
	class FString                                 Description;                                       // 0x0040(0x0010)
	class FString                                 Name_0;                                            // 0x0050(0x0010)
	struct FGuid                                  Guid;                                              // 0x0060(0x0010)
...
{
public:
	class FString                                 Category;                                          // 0x0078(0x0010)
...
{
public:
	TMap<class FName, struct FMovieGraphEvaluatedBranchConfig> BranchConfigMapping;                  // 0x0028(0x0050)
...
{
public:
	struct FMovieGraphTimeStepData                CurrentTimeStepData;                               // 0x0028(0x0078)
	uint8                                         Pad_A0[0xE0];                                      // 0x00A0(0x00E0)
...
{
public:
	uint8                                         bOverride_bCaptureFramesWithRenderDoc : 1;         // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_bCaptureUnrealInsightsTrace : 1;         // 0x00A8(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_UnrealInsightsTraceFileNameFormat : 1;   // 0x00A8(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	bool                                          bCaptureFramesWithRenderDoc;                       // 0x00A9(0x0001)
	bool                                          bCaptureUnrealInsightsTrace;                       // 0x00AA(0x0001)
	uint8                                         Pad_AB[0x5];                                       // 0x00AB(0x0005)
	class FString                                 UnrealInsightsTraceFileNameFormat;                 // 0x00B0(0x0010)
...
public:
	...
	uint8                                         Pad_38[0x1D8];                                     // 0x0038(0x01D8)
...
{
public:
	uint8                                         bOverride_Script : 1;                              // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	struct FSoftClassPath                         Script;                                            // 0x00B0(0x0020)
...
{
public:
	uint8                                         bOverride_GameModeOverride : 1;                    // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_SoftGameModeOverride : 1;                // 0x00A8(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_ScalabilityQualityLevel : 1;             // 0x00A8(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverride_bDisableTextureStreaming : 1;            // 0x00A8(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bOverride_bDisableLODs : 1;                        // 0x00A8(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bOverride_bDisableHLODs : 1;                       // 0x00A8(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bOverride_bFlushLevelStreaming : 1;                // 0x00A8(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bOverride_bFlushAssetCompiler : 1;                 // 0x00A8(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
	uint8                                         bOverride_bFlushShaderCompiler : 1;                // 0x00A9(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_bFlushGrassStreaming : 1;                // 0x00A9(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_bFlushStreamingManagers : 1;             // 0x00A9(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverride_VirtualTextureFeedbackFactor : 1;        // 0x00A9(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         Pad_AA[0x6];                                       // 0x00AA(0x0006)
	TSubclassOf<class AGameModeBase>              GameModeOverride;                                  // 0x00B0(0x0008)
	TSoftClassPtr<class UClass>                   SoftGameModeOverride;                              // 0x00B8(0x0028)
	EMovieGraphScalabilityQualityLevel            ScalabilityQualityLevel;                           // 0x00E0(0x0001)
	bool                                          bDisableTextureStreaming;                          // 0x00E1(0x0001)
	bool                                          bDisableLODs;                                      // 0x00E2(0x0001)
	bool                                          bDisableHLODs;                                     // 0x00E3(0x0001)
	bool                                          bFlushLevelStreaming;                              // 0x00E4(0x0001)
	bool                                          bFlushAssetCompiler;                               // 0x00E5(0x0001)
	bool                                          bFlushShaderCompiler;                              // 0x00E6(0x0001)
	bool                                          bFlushGrassStreaming;                              // 0x00E7(0x0001)
	bool                                          bFlushStreamingManagers;                           // 0x00E8(0x0001)
	uint8                                         Pad_E9[0x3];                                       // 0x00E9(0x0003)
	int32                                         VirtualTextureFeedbackFactor;                      // 0x00EC(0x0004)
...
{
public:
	uint8                                         bOverride_OutputDirectory : 1;                     // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_OutputResolution : 1;                    // 0x00A8(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_OutputFrameRate : 1;                     // 0x00A8(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverride_bOverwriteExistingOutput : 1;            // 0x00A8(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bOverride_ZeroPadFrameNumbers : 1;                 // 0x00A8(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bOverride_FrameNumberOffset : 1;                   // 0x00A8(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bOverride_HandleFrameCount : 1;                    // 0x00A8(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bOverride_CustomPlaybackRangeStartFrame : 1;       // 0x00A8(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
	uint8                                         bOverride_CustomPlaybackRangeEndFrame : 1;         // 0x00A9(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_CustomTimecodeStart : 1;                 // 0x00A9(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_bDropFrameTimecode : 1;                  // 0x00A9(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverride_VersioningSettings : 1;                  // 0x00A9(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bOverride_bFlushDiskWritesPerShot : 1;             // 0x00A9(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         Pad_AA[0x6];                                       // 0x00AA(0x0006)
	struct FDirectoryPath                         OutputDirectory;                                   // 0x00B0(0x0010)
	struct FMovieGraphNamedResolution             OutputResolution;                                  // 0x00C0(0x0020)
	struct FFrameRate                             OutputFrameRate;                                   // 0x00E0(0x0008)
	bool                                          bOverwriteExistingOutput;                          // 0x00E8(0x0001)
	uint8                                         Pad_E9[0x3];                                       // 0x00E9(0x0003)
	int32                                         ZeroPadFrameNumbers;                               // 0x00EC(0x0004)
	int32                                         FrameNumberOffset;                                 // 0x00F0(0x0004)
	int32                                         HandleFrameCount;                                  // 0x00F4(0x0004)
	int32                                         CustomPlaybackRangeStartFrame;                     // 0x00F8(0x0004)
	int32                                         CustomPlaybackRangeEndFrame;                       // 0x00FC(0x0004)
	struct FTimecode                              CustomTimecodeStart;                               // 0x0100(0x0018)
	bool                                          bDropFrameTimecode;                                // 0x0118(0x0001)
	uint8                                         Pad_119[0x3];                                      // 0x0119(0x0003)
	struct FMovieGraphVersioningSettings          VersioningSettings;                                // 0x011C(0x0008)
	bool                                          bFlushDiskWritesPerShot;                           // 0x0124(0x0001)
...
{
public:
	uint8                                         bOverride_ModifierName : 1;                        // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	class FString                                 ModifierName;                                      // 0x00B0(0x0010)
	uint8                                         bOverride_Collections : 1;                         // 0x00C0(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_ModifiersContainer : 1;                  // 0x00C0(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_DisabledCollections : 1;                 // 0x00C0(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         Pad_C1[0x7];                                       // 0x00C1(0x0007)
	TArray<class FName>                           Collections;                                       // 0x00C8(0x0010)
	class UMovieGraphMergeableModifierContainer*  ModifiersContainer;                                // 0x00D8(0x0008)
	TSet<class FName>                             DisabledCollections;                               // 0x00E0(0x0050)
...
public:
	...
	struct FMovieGraphPinProperties               Properties;                                        // 0x0030(0x0020)
...
{
public:
	TMulticastInlineDelegate<void(const struct FMoviePipelineOutputData& Results)> OnMoviePipelineWorkFinishedDelegate; // 0x0028(0x0010)
	TMulticastInlineDelegate<void(const struct FMoviePipelineOutputData& Results)> OnMoviePipelineShotWorkFinishedDelegate; // 0x0038(0x0010)
	uint8                                         Pad_48[0x30];                                      // 0x0048(0x0030)
...
public:
	...
	TMap<class UMovieGraphConfig*, class UMovieGraphConfig*> DuplicatedGraphs;                       // 0x00C8(0x0050)
	TArray<class UMoviePipelineExecutorShot*>     ActiveShotList;                                    // 0x0118(0x0010)
	TSubclassOf<class UMovieGraphRenderPreviewWidget> PreviewWidgetClassToUse;                       // 0x0128(0x0008)
	class UMovieGraphRenderPreviewWidget*         PreviewWidget;                                     // 0x0130(0x0008)
	TArray<class UMovieGraphScriptBase*>          CurrentScriptInstances;                            // 0x0138(0x0010)
	TSet<class UMovieGraphFileOutputNode*>        OutputNodesDataSentTo;                             // 0x0148(0x0050)
	uint8                                         Pad_198[0x68];                                     // 0x0198(0x0068)
	class UMovieGraphEngineTimeStep*              CustomEngineTimeStep;                              // 0x0200(0x0008)
	class UEngineCustomTimeStep*                  PrevCustomEngineTimeStep;                          // 0x0208(0x0008)
	uint8                                         Pad_210[0x58];                                     // 0x0210(0x0058)
...
{
public:
	TArray<struct FMovieGraphNamedResolution>     DefaultNamedResolutions;                           // 0x0038(0x0010)
...
{
public:
	TSubclassOf<class UMovieGraphSettingNode>     NodeType;                                          // 0x00A8(0x0008)
...
{
public:
	uint8                                         bOverride_LayerName : 1;                           // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	class FString                                 LayerName;                                         // 0x00B0(0x0010)
...
{
public:
	TArray<TSoftObjectPtr<class AActor>>          ActorsToMatch;                                     // 0x0030(0x0010)
...
{
public:
	class FString                                 TagsToMatch;                                       // 0x0030(0x0010)
...
{
public:
	class FString                                 WildcardSearch;                                    // 0x0030(0x0010)
...
{
public:
	TArray<TSubclassOf<class UObject>>            ActorTypes;                                        // 0x0030(0x0010)
...
public:
	...
	TArray<TSubclassOf<class UObject>>            ComponentTypes;                                    // 0x0040(0x0010)
...
{
public:
	TArray<class FName>                           FolderPaths;                                       // 0x0030(0x0010)
...
{
public:
	TArray<TSoftObjectPtr<class UWorld>>          Sublevels;                                         // 0x0030(0x0010)
...
{
public:
	TArray<class FName>                           LayerNames;                                        // 0x0030(0x0010)
...
{
public:
	TArray<TSoftObjectPtr<class UDataLayerAsset>> DataLayers;                                        // 0x0030(0x0010)
...
{
public:
	bool                                          bIsSpawnable;                                      // 0x0030(0x0001)
...
public:
	...
	TSet<class AActor*>                           QueryResult;                                       // 0x0050(0x0050)
	TSet<class AActor*>                           EvaluationResult;                                  // 0x00A0(0x0050)
...
{
public:
	class FString                                 CollectionName;                                    // 0x0028(0x0010)
...
public:
	...
	uint8                                         bOverride_Material : 1;                            // 0x0088(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_89[0x7];                                       // 0x0089(0x0007)
	TSoftObjectPtr<class UMaterialInterface>      Material;                                          // 0x0090(0x0028)
...
public:
	...
	uint8                                         bOverride_bIsHidden : 1;                           // 0x0048(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_bCastsShadows : 1;                       // 0x0048(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_bCastShadowWhileHidden : 1;              // 0x0048(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverride_bAffectIndirectLightingWhileHidden : 1;  // 0x0048(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bOverride_bHoldout : 1;                            // 0x0048(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bIsHidden : 1;                                     // 0x0048(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bCastsShadows : 1;                                 // 0x0048(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bCastShadowWhileHidden : 1;                        // 0x0048(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
	uint8                                         bAffectIndirectLightingWhileHidden : 1;            // 0x0049(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bHoldout : 1;                                      // 0x0049(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
{
public:
	class FName                                   RenderLayerName;                                   // 0x0028(0x0008)
	TArray<class UMovieGraphCollectionModifier*>  Modifiers;                                         // 0x0030(0x0010)
...
{
public:
	uint8                                         bOverride_SamplingMethodClass : 1;                 // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_TemporalSampleCount : 1;                 // 0x00A8(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	struct FSoftClassPath                         SamplingMethodClass;                               // 0x00B0(0x0020)
	int32                                         TemporalSampleCount;                               // 0x00D0(0x0004)
...
{
public:
	class UMovieGraphValueContainer*              SelectOptions;                                     // 0x00A8(0x0008)
	class UMovieGraphValueContainer*              SelectedOption;                                    // 0x00B0(0x0008)
...
{
public:
	uint8                                         bOverride_Name : 1;                                // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_Value : 1;                               // 0x00A8(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	class FString                                 Name_0;                                            // 0x00B0(0x0010)
	float                                         Value;                                             // 0x00C0(0x0004)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	TArray<struct FMovieGraphMetadataAttribute>   MetadataAttributes;                                // 0x0030(0x0010)
...
{
public:
	uint8                                         bOverride_MetadataAttributeCollection : 1;         // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	class UMovieGraphMetadataAttributeCollection* MetadataAttributeCollection;                       // 0x00B0(0x0008)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	TArray<class FString>                         AddStartCommands;                                  // 0x0030(0x0010)
	TArray<class FString>                         AddEndCommands;                                    // 0x0040(0x0010)
	TArray<class FString>                         RemoveStartCommands;                               // 0x0050(0x0010)
	TArray<class FString>                         RemoveEndCommands;                                 // 0x0060(0x0010)
...
{
public:
	uint8                                         bOverride_ConsoleCommands : 1;                     // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	class UMovieGraphStartEndConsoleCommands*     ConsoleCommands;                                   // 0x00B0(0x0008)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	TSet<uint32>                                  OverriddenShowFlags;                               // 0x0030(0x0050)
	TMap<uint32, bool>                            ShowFlagEnableState;                               // 0x0080(0x0050)
...
{
public:
	TSoftObjectPtr<class UMovieGraphConfig>       SubgraphAsset;                                     // 0x00A8(0x0028)
...
{
public:
	class UMovieGraphVariable*                    GraphVariable;                                     // 0x00A8(0x0008)
	struct FMovieGraphPinProperties               OutputPin;                                         // 0x00B0(0x0020)
...
{
public:
	uint8                                         bOverride_NumWarmUpFrames : 1;                     // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_bEmulateMotionBlur : 1;                  // 0x00A8(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_A9[0x3];                                       // 0x00A9(0x0003)
	int32                                         NumWarmUpFrames;                                   // 0x00AC(0x0004)
	bool                                          bEmulateMotionBlur;                                // 0x00B0(0x0001)
	uint8                                         Pad_B1[0x7];                                       // 0x00B1(0x0007)
...
{
public:
	struct FInstancedPropertyBag                  Value;                                             // 0x0028(0x0010)
	TSoftObjectPtr<class UMovieGraphConfig>       GraphPreset;                                       // 0x0038(0x0028)
...
public:
	...
	int32                                         BurleySampleCount;                                 // 0x0058(0x0004)
	bool                                          bAllocateHistoryPerTile;                           // 0x005C(0x0001)
	uint8                                         Pad_5D[0xB];                                       // 0x005D(0x000B)
...
public:
	...
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
	class FString                                 AdditionalCommandLineArguments;                    // 0x0040(0x0010)
	class FString                                 InheritedCommandLineArguments;                     // 0x0050(0x0010)
	int32                                         InitialDelayFrameCount;                            // 0x0060(0x0004)
...
{
public:
	class FText                                   CategoryText;                                      // 0x0048(0x0010)
...
{
public:
	class UMoviePipelineCustomTimeStep*           CustomTimeStep;                                    // 0x0078(0x0008)
	uint8                                         Pad_80[0x10];                                      // 0x0080(0x0010)
	class UEngineCustomTimeStep*                  CachedPrevCustomTimeStep;                          // 0x0090(0x0008)
	class ULevelSequence*                         TargetSequence;                                    // 0x0098(0x0008)
	class ALevelSequenceActor*                    LevelSequenceActor;                                // 0x00A0(0x0008)
	class UMovieRenderDebugWidget*                DebugWidget;                                       // 0x00A8(0x0008)
	class UTexture*                               PreviewTexture;                                    // 0x00B0(0x0008)
	uint8                                         Pad_B8[0x258];                                     // 0x00B8(0x0258)
	class UMoviePipelineExecutorJob*              CurrentJob;                                        // 0x0310(0x0008)
	uint8                                         Pad_318[0x138];                                    // 0x0318(0x0138)
...
{
public:
	int32                                         SpatialSampleCount;                                // 0x0048(0x0004)
	int32                                         TemporalSampleCount;                               // 0x004C(0x0004)
	bool                                          bOverrideAntiAliasing;                             // 0x0050(0x0001)
	EAntiAliasingMethod                           AntiAliasingMethod;                                // 0x0051(0x0001)
	uint8                                         Pad_52[0x2];                                       // 0x0052(0x0002)
	int32                                         RenderWarmUpCount;                                 // 0x0054(0x0004)
	bool                                          bUseCameraCutForWarmUp;                            // 0x0058(0x0001)
	uint8                                         Pad_59[0x3];                                       // 0x0059(0x0003)
	int32                                         EngineWarmUpCount;                                 // 0x005C(0x0004)
...
public:
	...
	bool                                          bOverrideCameraOverscan;                           // 0x0049(0x0001)
...
{
public:
	struct FOpenColorIODisplayConfiguration       OCIOConfiguration;                                 // 0x0048(0x0088)
...
{
public:
	class FString                                 FileNameFormatOverride;                            // 0x0048(0x0010)
	EMoviePipelineEncodeQuality                   Quality;                                           // 0x0058(0x0001)
	uint8                                         Pad_59[0x7];                                       // 0x0059(0x0007)
	class FString                                 AdditionalCommandLineArgs;                         // 0x0060(0x0010)
	...
	uint8                                         Pad_73[0x15];                                      // 0x0073(0x0015)
...
{
public:
	class FString                                 ExecutablePath;                                    // 0x0038(0x0010)
	class FText                                   CodecHelpText;                                     // 0x0048(0x0010)
	class FString                                 VideoCodec;                                        // 0x0058(0x0010)
	class FString                                 AudioCodec;                                        // 0x0068(0x0010)
	class FString                                 OutputFileExtension;                               // 0x0078(0x0010)
	class FString                                 CommandLineFormat;                                 // 0x0088(0x0010)
	class FString                                 VideoInputStringFormat;                            // 0x0098(0x0010)
	class FString                                 AudioInputStringFormat;                            // 0x00A8(0x0010)
	class FString                                 EncodeSettings_Low;                                // 0x00B8(0x0010)
	class FString                                 EncodeSettings_Med;                                // 0x00C8(0x0010)
	class FString                                 EncodeSettings_High;                               // 0x00D8(0x0010)
	class FString                                 EncodeSettings_Epic;                               // 0x00E8(0x0010)
...
public:
	...
	TSoftObjectPtr<class UMoviePipelineConfigBase> ConfigOrigin;                                     // 0x0048(0x0028)
...
public:
	...
	uint8                                         Pad_4A[0x2];                                       // 0x004A(0x0002)
	int32                                         CaptureFrame;                                      // 0x004C(0x0004)
...
{
public:
	TMulticastInlineDelegate<void(class UMoviePipelineExecutorBase* PipelineExecutor, bool bSuccess)> OnExecutorFinishedDelegate; // 0x0028(0x0010)
	uint8                                         Pad_38[0x18];                                      // 0x0038(0x0018)
	TMulticastInlineDelegate<void(class UMoviePipelineExecutorBase* PipelineExecutor, class UMoviePipeline* PipelineWithError, bool bIsFatal, class FText ErrorText)> OnExecutorErroredDelegate; // 0x0050(0x0010)
	uint8                                         Pad_60[0x20];                                      // 0x0060(0x0020)
	TMulticastInlineDelegate<void(const class FString& Message)> SocketMessageRecievedDelegate;      // 0x0080(0x0010)
	TMulticastInlineDelegate<void(int32 RequestIndex, int32 ResponseCode, const class FString& Message)> HTTPResponseRecievedDelegate; // 0x0090(0x0010)
	TSubclassOf<class UMovieRenderDebugWidget>    DebugWidgetClass;                                  // 0x00A0(0x0008)
	uint8                                         Pad_A8[0x10];                                      // 0x00A8(0x0010)
	class FString                                 UserData;                                          // 0x00B8(0x0010)
	TSubclassOf<class UMoviePipeline>             TargetPipelineClass;                               // 0x00C8(0x0008)
	uint8                                         Pad_D0[0x48];                                      // 0x00D0(0x0048)
...
public:
	...
	class FString                                 FileNameFormatOverride;                            // 0x0050(0x0010)
	EFCPXMLExportDataSource                       DataSource;                                        // 0x0060(0x0001)
	uint8                                         Pad_61[0x1F];                                      // 0x0061(0x001F)
...
{
public:
	TSubclassOf<class AGameModeBase>              GameModeOverride;                                  // 0x0048(0x0008)
	TSoftClassPtr<class UClass>                   SoftGameModeOverride;                              // 0x0050(0x0028)
	bool                                          bCinematicQualitySettings;                         // 0x0078(0x0001)
	EMoviePipelineTextureStreamingMethod          TextureStreaming;                                  // 0x0079(0x0001)
	bool                                          bUseLODZero;                                       // 0x007A(0x0001)
	bool                                          bDisableHLODs;                                     // 0x007B(0x0001)
	bool                                          bUseHighQualityShadows;                            // 0x007C(0x0001)
	uint8                                         Pad_7D[0x3];                                       // 0x007D(0x0003)
	int32                                         ShadowDistanceScale;                               // 0x0080(0x0004)
	float                                         ShadowRadiusThreshold;                             // 0x0084(0x0004)
	bool                                          bOverrideViewDistanceScale;                        // 0x0088(0x0001)
	uint8                                         Pad_89[0x3];                                       // 0x0089(0x0003)
	int32                                         ViewDistanceScale;                                 // 0x008C(0x0004)
	bool                                          bFlushGrassStreaming;                              // 0x0090(0x0001)
	bool                                          bFlushStreamingManagers;                           // 0x0091(0x0001)
	bool                                          bOverrideVirtualTextureFeedbackFactor;             // 0x0092(0x0001)
	uint8                                         Pad_93[0x1];                                       // 0x0093(0x0001)
	int32                                         VirtualTextureFeedbackFactor;                      // 0x0094(0x0004)
...
public:
	...
	uint8                                         Pad_128[0x18];                                     // 0x0128(0x0018)
...
public:
	...
	uint8                                         Pad_141[0x3F];                                     // 0x0141(0x003F)
...
{
public:
	struct FDirectoryPath                         OutputDirectory;                                   // 0x0048(0x0010)
	class FString                                 FileNameFormat;                                    // 0x0058(0x0010)
	struct FIntPoint                              OutputResolution;                                  // 0x0068(0x0008)
	bool                                          bUseCustomFrameRate;                               // 0x0070(0x0001)
	uint8                                         Pad_71[0x3];                                       // 0x0071(0x0003)
	struct FFrameRate                             OutputFrameRate;                                   // 0x0074(0x0008)
	uint8                                         Pad_7C[0x4];                                       // 0x007C(0x0004)
	bool                                          bOverrideExistingOutput;                           // 0x0080(0x0001)
	uint8                                         Pad_81[0x3];                                       // 0x0081(0x0003)
	int32                                         HandleFrameCount;                                  // 0x0084(0x0004)
	int32                                         OutputFrameStep;                                   // 0x0088(0x0004)
	bool                                          bUseCustomPlaybackRange;                           // 0x008C(0x0001)
	uint8                                         Pad_8D[0x3];                                       // 0x008D(0x0003)
	int32                                         CustomStartFrame;                                  // 0x0090(0x0004)
	int32                                         CustomEndFrame;                                    // 0x0094(0x0004)
	int32                                         VersionNumber;                                     // 0x0098(0x0004)
	bool                                          bAutoVersion;                                      // 0x009C(0x0001)
	uint8                                         Pad_9D[0x3];                                       // 0x009D(0x0003)
	int32                                         ZeroPadFrameNumbers;                               // 0x00A0(0x0004)
	int32                                         FrameNumberOffset;                                 // 0x00A4(0x0004)
...
{
public:
	TMap<class FString, class UMoviePipelineShotConfig*> PerShotConfigMapping;                       // 0x0078(0x0050)
...
{
public:
	TSubclassOf<class UMoviePipelinePythonHostExecutor> ExecutorClass;                               // 0x0118(0x0008)
...
public:
	...
	class FString                                 OuterName;                                         // 0x0030(0x0010)
	class FString                                 InnerName;                                         // 0x0040(0x0010)
	TArray<struct FMoviePipelineSidecarCamera>    SidecarCameras;                                    // 0x0050(0x0010)
	uint8                                         Pad_60[0x18];                                      // 0x0060(0x0018)
	TArray<struct FMoviePipelineConsoleVariableEntry> ConsoleVariableOverrides;                      // 0x0078(0x0010)
	uint8                                         Pad_88[0xC8];                                      // 0x0088(0x00C8)
	float                                         progress;                                          // 0x0150(0x0004)
	uint8                                         Pad_154[0x4];                                      // 0x0154(0x0004)
	class FString                                 StatusMessage;                                     // 0x0158(0x0010)
	class UMoviePipelineShotConfig*               ShotOverrideConfig;                                // 0x0168(0x0008)
	TSoftObjectPtr<class UMoviePipelineShotConfig> ShotOverridePresetOrigin;                         // 0x0170(0x0028)
	TSoftObjectPtr<class UMovieGraphConfig>       GraphPreset;                                       // 0x0198(0x0028)
	TArray<class UMovieJobVariableAssignmentContainer*> GraphVariableAssignments;                    // 0x01C0(0x0010)
	TArray<class UMovieJobVariableAssignmentContainer*> PrimaryGraphVariableAssignments;             // 0x01D0(0x0010)
...
{
public:
	class FString                                 JobName;                                           // 0x0028(0x0010)
	struct FSoftObjectPath                        Sequence;                                          // 0x0038(0x0020)
	struct FSoftObjectPath                        Map;                                               // 0x0058(0x0020)
	class FString                                 Author;                                            // 0x0078(0x0010)
	class FString                                 Comment;                                           // 0x0088(0x0010)
	TArray<class UMoviePipelineExecutorShot*>     ShotInfo;                                          // 0x0098(0x0010)
	class FString                                 UserData;                                          // 0x00A8(0x0010)
	uint8                                         Pad_B8[0x18];                                      // 0x00B8(0x0018)
	TArray<struct FMoviePipelineConsoleVariableEntry> ConsoleVariableOverrides;                      // 0x00D0(0x0010)
	class FString                                 StatusMessage;                                     // 0x00E0(0x0010)
	float                                         StatusProgress;                                    // 0x00F0(0x0004)
	bool                                          bIsConsumed;                                       // 0x00F4(0x0001)
	uint8                                         Pad_F5[0x3];                                       // 0x00F5(0x0003)
	class UMoviePipelinePrimaryConfig*            Configuration;                                     // 0x00F8(0x0008)
	TSoftObjectPtr<class UMoviePipelinePrimaryConfig> PresetOrigin;                                  // 0x0100(0x0028)
	bool                                          bEnabled;                                          // 0x0128(0x0001)
	uint8                                         Pad_129[0x7];                                      // 0x0129(0x0007)
	TSoftObjectPtr<class UMovieGraphConfig>       GraphPreset;                                       // 0x0130(0x0028)
	TArray<class UMovieJobVariableAssignmentContainer*> GraphVariableAssignments;                    // 0x0158(0x0010)
...
public:
	...
	TSoftObjectPtr<class UMoviePipelineQueue>     QueueOrigin;                                       // 0x0038(0x0028)
...
{
public:
	TMulticastInlineDelegate<void(const struct FMoviePipelineOutputData& Results)> OnRenderFinished; // 0x0030(0x0010)
