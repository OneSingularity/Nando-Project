...
{
public:
	TWeakObjectPtr<class UWorld>                  World;                                             // 0x0000(0x0008)
	TArray<TWeakObjectPtr<class UTickableConstraint>> Constraints;                                   // 0x0008(0x0010)
...
{
public:
	struct FMovieSceneConstraintChannel           ActiveChannel;                                     // 0x0000(0x0108)
