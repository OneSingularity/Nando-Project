...
public:
	...
	uint8                                         bDestroyOnSystemFinish : 1;                        // 0x0498(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
{
public:
	class FName                                   CompressionType;                                   // 0x0028(0x0008)
	TArray<struct FNDIRenderTargetVolumeSimCacheFrame> Frames;                                       // 0x0030(0x0010)
...
{
public:
	class FText                                   DisplayName;                                       // 0x0028(0x0010)
	class FText                                   Description;                                       // 0x0038(0x0010)
	TArray<struct FNiagaraAssetTagDefinition>     TagDefinitions;                                    // 0x0048(0x0010)
	bool                                          bDisplayTagsAsFlatList;                            // 0x0058(0x0001)
	uint8                                         Pad_59[0x3];                                       // 0x0059(0x0003)
	int32                                         SortOrder;                                         // 0x005C(0x0004)
...
public:
	...
	uint8                                         bUseLUT : 1;                                       // 0x005C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bExposeCurve : 1;                                  // 0x005C(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_5D[0x3];                                       // 0x005D(0x0003)
	class FName                                   ExposedName;                                       // 0x0060(0x0008)
...
{
public:
	struct FRichCurve                             RedCurve;                                          // 0x0070(0x0080)
	struct FRichCurve                             GreenCurve;                                        // 0x00F0(0x0080)
	struct FRichCurve                             BlueCurve;                                         // 0x0170(0x0080)
	struct FRichCurve                             AlphaCurve;                                        // 0x01F0(0x0080)
...
{
public:
	TSoftObjectPtr<class AActor>                  SoftSourceActor;                                   // 0x0038(0x0028)
	struct FNiagaraUserParameterBinding           SplineUserParameter;                               // 0x0060(0x0020)
	bool                                          bUseLUT;                                           // 0x0080(0x0001)
	uint8                                         Pad_81[0x3];                                       // 0x0081(0x0003)
	int32                                         NumLUTSteps;                                       // 0x0084(0x0004)
	uint8                                         Pad_88[0x50];                                      // 0x0088(0x0050)
...
public:
	...
	uint8                                         Pad_40[0x20];                                      // 0x0040(0x0020)
...
{
public:
	TArray<struct FNiagaraDataChannelVariable>    ChannelVariables;                                  // 0x0028(0x0010)
	bool                                          bKeepPreviousFrameData;                            // 0x0038(0x0001)
	bool                                          bEnforceTickGroupReadWriteOrder;                   // 0x0039(0x0001)
	ETickingGroup                                 FinalWriteTickGroup;                               // 0x003A(0x0001)
	uint8                                         Pad_3B[0x1D];                                      // 0x003B(0x001D)
...
{
public:
	struct FRichCurve                             XCurve;                                            // 0x0070(0x0080)
	struct FRichCurve                             YCurve;                                            // 0x00F0(0x0080)
...
{
public:
	ENiagraDataChannel_IslandMode                 Mode;                                              // 0x0058(0x0001)
	uint8                                         Pad_59[0x7];                                       // 0x0059(0x0007)
	struct FVector                                InitialExtents;                                    // 0x0060(0x0018)
	struct FVector                                MaxExtents;                                        // 0x0078(0x0018)
	struct FVector                                PerElementExtents;                                 // 0x0090(0x0018)
	TArray<TSoftObjectPtr<class UNiagaraSystem>>  Systems;                                           // 0x00A8(0x0010)
	int32                                         IslandPoolSize;                                    // 0x00B8(0x0004)
	struct FNDCIslandDebugDrawSettings            DebugDrawSettings;                                 // 0x00BC(0x0004)
	TArray<class UNiagaraSystem*>                 SystemsInternal;                                   // 0x00C0(0x0010)
...
{
public:
	TArray<int32>                                 ActiveIslands;                                     // 0x0060(0x0010)
	TArray<int32>                                 FreeIslands;                                       // 0x0070(0x0010)
	TArray<struct FNDCIsland>                     IslandPool;                                        // 0x0080(0x0010)
...
public:
	...
	TSoftObjectPtr<class AActor>                  SoftSourceActor;                                   // 0x0048(0x0028)
	TArray<class FName>                           ComponentTags;                                     // 0x0070(0x0010)
	class USkeletalMeshComponent*                 SourceComponent;                                   // 0x0080(0x0008)
	struct FNiagaraUserParameterBinding           MeshUserParameter;                                 // 0x0088(0x0020)
	ENDISkeletalMesh_SkinningMode                 SkinningMode;                                      // 0x00A8(0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	TArray<class FName>                           SamplingRegions;                                   // 0x00B0(0x0010)
	int32                                         WholeMeshLOD;                                      // 0x00C0(0x0004)
	uint8                                         Pad_C4[0x4];                                       // 0x00C4(0x0004)
	TArray<class FName>                           FilteredBones;                                     // 0x00C8(0x0010)
	TArray<class FName>                           FilteredSockets;                                   // 0x00D8(0x0010)
	class FName                                   ExcludeBoneName;                                   // 0x00E8(0x0008)
	uint8                                         bExcludeBone : 1;                                  // 0x00F0(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_F1[0x3];                                       // 0x00F1(0x0003)
	int32                                         UvSetIndex;                                        // 0x00F4(0x0004)
...
public:
	...
	struct FNDIDataChannelCompiledData            CompiledData;                                      // 0x0048(0x0070)
...
{
public:
	TArray<struct FNDIDataChannelWriteSimCacheFrame> FrameData;                                      // 0x0028(0x0010)
	struct FSoftObjectPath                        DataChannelReference;                              // 0x0038(0x0020)
	class UNiagaraDataInterfaceDataChannelWrite*  DataInterface;                                     // 0x0058(0x0008)
...
public:
	...
	uint32                                        AllocationCount;                                   // 0x0044(0x0004)
	...
	struct FNDIDataChannelWriteCompiledData       CompiledData;                                      // 0x0058(0x00B8)
...
public:
	...
	struct FIntVector                             NumCells;                                          // 0x003C(0x000C)
	float                                         CellSize;                                          // 0x0048(0x0004)
	int32                                         NumCellsMaxAxis;                                   // 0x004C(0x0004)
	ESetResolutionMethod                          SetResolutionMethod;                               // 0x0050(0x0004)
	uint8                                         Pad_54[0x4];                                       // 0x0054(0x0004)
	struct FVector                                WorldBBoxSize;                                     // 0x0058(0x0018)
...
{
public:
	uint32                                        MaxNeighborsPerCell;                               // 0x0070(0x0004)
...
{
public:
	uint8                                         Pad_28[0x20];                                      // 0x0028(0x0020)
...
public:
	...
	struct FSoftObjectPath                        DefaultEffectType;                                 // 0x0048(0x0020)
	bool                                          bAllowCreateActorFromSystemWithNoEffectType;       // 0x0068(0x0001)
	uint8                                         Pad_69[0x3];                                       // 0x0069(0x0003)
	struct FLinearColor                           PositionPinTypeColor;                              // 0x006C(0x0010)
	ENiagaraStripScriptByteCodeOption             ByteCodeStripOption;                               // 0x007C(0x0001)
	uint8                                         Pad_7D[0x3];                                       // 0x007D(0x0003)
	TArray<class FText>                           QualityLevels;                                     // 0x0080(0x0010)
	TMap<class FString, class FText>              ComponentRendererWarningsPerClass;                 // 0x0090(0x0050)
	ETextureRenderTargetFormat                    DefaultRenderTargetFormat;                         // 0x00E0(0x0001)
	ENiagaraGpuBufferFormat                       DefaultGridFormat;                                 // 0x00E1(0x0001)
	ENiagaraDefaultRendererMotionVectorSetting    DefaultRendererMotionVectorSetting;                // 0x00E2(0x0001)
	ENiagaraDefaultRendererPixelCoverageMode      DefaultPixelCoverageMode;                          // 0x00E3(0x0001)
	ENiagaraDefaultSortPrecision                  DefaultSortPrecision;                              // 0x00E4(0x0001)
	ENiagaraDefaultGpuTranslucentLatency          DefaultGpuTranslucentLatency;                      // 0x00E5(0x0001)
	uint8                                         Pad_E6[0x2];                                       // 0x00E6(0x0002)
	float                                         DefaultLightInverseExposureBlend;                  // 0x00E8(0x0004)
	bool                                          NDISkelMesh_SupportReadingDeformedGeometry;        // 0x00EC(0x0001)
	bool                                          NDISkelMesh_Support16BitIndexWeight;               // 0x00ED(0x0001)
	ENDISkelMesh_GpuMaxInfluences                 NDISkelMesh_GpuMaxInfluences;                      // 0x00EE(0x0001)
	ENDISkelMesh_GpuUniformSamplingFormat         NDISkelMesh_GpuUniformSamplingFormat;              // 0x00EF(0x0001)
	ENDISkelMesh_AdjacencyTriangleIndexFormat     NDISkelMesh_AdjacencyTriangleIndexFormat;          // 0x00F0(0x0001)
	bool                                          NDIStaticMesh_AllowDistanceFields;                 // 0x00F1(0x0001)
	uint8                                         Pad_F2[0x6];                                       // 0x00F2(0x0006)
	TArray<ENDICollisionQuery_AsyncGpuTraceProvider> NDICollisionQuery_AsyncGpuTraceProviderOrder;   // 0x00F8(0x0010)
	class FString                                 SimCacheAuxiliaryFileBasePath;                     // 0x0108(0x0010)
	int64                                         SimCacheMaxCPUMemoryVolumetrics;                   // 0x0118(0x0008)
	TArray<struct FNiagaraPlatformSetRedirect>    PlatformSetRedirects;                              // 0x0120(0x0010)
...
public:
	struct FRichCurve                             XCurve;                                            // 0x0070(0x0080)
	struct FRichCurve                             YCurve;                                            // 0x00F0(0x0080)
	struct FRichCurve                             ZCurve;                                            // 0x0170(0x0080)
...
{
public:
	TArray<struct FNiagaraSimCacheDebugDataFrame> Frames;                                            // 0x0028(0x0010)
...
public:
	uint8                                         Pad_28[0x10];                                      // 0x0028(0x0010)
	class FString                                 UniqueEmitterName;                                 // 0x0038(0x0010)
	TSubclassOf<class UObject>                    EmitterTemplateClass;                              // 0x0048(0x0008)
	uint8                                         bDeterministic : 1;                                // 0x0050(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_51[0x3];                                       // 0x0051(0x0003)
	uint32                                        AllowedFeatureMask;                                // 0x0054(0x0004)
	int32                                         RandomSeed;                                        // 0x0058(0x0004)
	uint8                                         Pad_5C[0x4];                                       // 0x005C(0x0004)
	struct FBox                                   FixedBounds;                                       // 0x0060(0x0038)
	struct FNiagaraEmitterStateData               EmitterState;                                      // 0x0098(0x0070)
	TArray<struct FNiagaraStatelessSpawnInfo>     SpawnInfos;                                        // 0x0108(0x0010)
	TArray<class UNiagaraStatelessModule*>        modules;                                           // 0x0118(0x0010)
	TArray<class UNiagaraRendererProperties*>     RendererProperties;                                // 0x0128(0x0010)
	struct FNiagaraPlatformSet                    Platforms;                                         // 0x0138(0x0030)
	struct FNiagaraEmitterScalabilityOverrides    ScalabilityOverrides;                              // 0x0168(0x0010)
	struct FNiagaraDataSetCompiledData            ParticleDataSetCompiledData;                       // 0x0178(0x0048)
	TArray<int32>                                 ComponentOffsets;                                  // 0x01C0(0x0010)
	TArray<class UNiagaraParameterCollection*>    CachedParameterCollectionReferences;               // 0x01D0(0x0010)
...
{
public:
	int32                                         Size;                                              // 0x0038(0x0004)
	ETextureRenderTargetFormat                    OverrideRenderTargetFormat;                        // 0x003C(0x0001)
	ETextureFilter                                OverrideRenderTargetFilter;                        // 0x003D(0x0001)
	uint8                                         bInheritUserParameterSettings : 1;                 // 0x003E(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverrideFormat : 1;                               // 0x003E(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_3F[0x1];                                       // 0x003F(0x0001)
	struct FNiagaraUserParameterBinding           RenderTargetUserParameter;                         // 0x0040(0x0020)
...
{
public:
	uint8                                         bModuleEnabled : 1;                                // 0x0028(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
{
public:
	struct FNiagaraDistributionRangeVector3       AccelerationDistribution;                          // 0x0030(0x0030)
	ENiagaraCoordinateSpace                       CoordinateSpace;                                   // 0x0060(0x0004)
...
public:
	...
	struct FNiagaraDistributionRangeVector3       LinearVelocityDistribution;                        // 0x0038(0x0030)
	float                                         LinearVelocityScale;                               // 0x0068(0x0004)
	uint8                                         Pad_6C[0x4];                                       // 0x006C(0x0004)
	struct FNiagaraDistributionRangeFloat         ConeVelocityDistribution;                          // 0x0070(0x0020)
	struct FRotator                               ConeRotation;                                      // 0x0090(0x0018)
	float                                         ConeAngle;                                         // 0x00A8(0x0004)
	float                                         InnerCone;                                         // 0x00AC(0x0004)
	struct FNiagaraDistributionRangeFloat         PointVelocityDistribution;                         // 0x00B0(0x0020)
	struct FVector3f                              PointOrigin;                                       // 0x00D0(0x000C)
	...
	ENiagaraCoordinateSpace                       CoordinateSpace;                                   // 0x00E4(0x0004)
...
{
public:
	struct FNiagaraDistributionFloat              CameraOffsetDistribution;                          // 0x0030(0x0030)
...
public:
	...
	struct FNiagaraUserParameterBinding           TextureUserParameter;                              // 0x0040(0x0020)
...
{
public:
	struct FNiagaraDistributionRangeFloat         DragDistribution;                                  // 0x0030(0x0020)
...
{
public:
	uint8                                         bParameter0Enabled : 1;                            // 0x0030(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bParameter1Enabled : 1;                            // 0x0030(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bParameter2Enabled : 1;                            // 0x0030(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bParameter3Enabled : 1;                            // 0x0030(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
	struct FNiagaraStatelessDynamicParameterSet   Parameter0;                                        // 0x0038(0x00C8)
	struct FNiagaraStatelessDynamicParameterSet   Parameter1;                                        // 0x0100(0x00C8)
	struct FNiagaraStatelessDynamicParameterSet   Parameter2;                                        // 0x01C8(0x00C8)
	struct FNiagaraStatelessDynamicParameterSet   Parameter3;                                        // 0x0290(0x00C8)
...
{
public:
	struct FNiagaraDistributionRangeVector3       GravityDistribution;                               // 0x0030(0x0030)
...
{
public:
	struct FNiagaraDistributionRangeFloat         LifetimeDistribution;                              // 0x0030(0x0020)
	struct FNiagaraDistributionRangeColor         ColorDistribution;                                 // 0x0050(0x0038)
	struct FNiagaraDistributionRangeFloat         MassDistribution;                                  // 0x0088(0x0020)
	struct FNiagaraDistributionRangeVector2       SpriteSizeDistribution;                            // 0x00A8(0x0028)
	struct FNiagaraDistributionRangeFloat         SpriteRotationDistribution;                        // 0x00D0(0x0020)
	struct FNiagaraDistributionRangeVector3       MeshScaleDistribution;                             // 0x00F0(0x0030)
	bool                                          bWriteRibbonWidth;                                 // 0x0120(0x0001)
	uint8                                         Pad_121[0x7];                                      // 0x0121(0x0007)
	struct FNiagaraDistributionRangeFloat         RibbonWidthDistribution;                           // 0x0128(0x0020)
	struct FNiagaraDistributionPosition           InitialPositionDistribution;                       // 0x0148(0x0030)
...
public:
	...
	struct FTransform                             DesiredRelativeTransform;                          // 0x04B0(0x0060)
	float                                         BaseAuthoredFOV;                                   // 0x0510(0x0004)
	uint8                                         bAllowMultipleInstances : 1;                       // 0x0514(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bResetWhenRetriggered : 1;                         // 0x0514(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_515[0x3];                                      // 0x0515(0x0003)
	TArray<TSubclassOf<class AActor>>             EmittersToTreatAsSame;                             // 0x0518(0x0010)
	class APlayerCameraManager*                   OwningCameraManager;                               // 0x0528(0x0008)
...
{
public:
	ENSMInitialMeshOrientationMode                MeshOrientationMode;                               // 0x0030(0x0004)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)
	struct FNiagaraDistributionRangeVector3       OrientationVector;                                 // 0x0038(0x0030)
	struct FNiagaraDistributionRangeVector3       MeshAxisToOrient;                                  // 0x0068(0x0030)
	struct FNiagaraDistributionRangeVector3       Rotation;                                          // 0x0098(0x0030)
...
{
public:
	struct FNiagaraDistributionRangeInt           MeshIndex;                                         // 0x0030(0x0018)
...
{
public:
	class FName                                   Param;                                             // 0x0028(0x0008)
	int32                                         Count;                                             // 0x0030(0x0004)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)
...
{
public:
	struct FVector2D                              min_0;                                             // 0x0038(0x0010)
	struct FVector2D                              max_0;                                             // 0x0048(0x0010)
...
{
public:
	struct FNiagaraDistributionRangeVector3       RotationRateDistribution;                          // 0x0030(0x0030)
...
public:
	...
	ENiagaraGpuSyncMode                           GpuSyncMode;                                       // 0x0048(0x0001)
	uint8                                         Pad_49[0x3];                                       // 0x0049(0x0003)
	int32                                         MaxElements;                                       // 0x004C(0x0004)
...
{
public:
	struct FNiagaraDistributionColor              ScaleDistribution;                                 // 0x0030(0x0030)
...
{
public:
	struct FNiagaraDistributionVector3            ScaleDistribution;                                 // 0x0030(0x0030)
	struct FNiagaraParameterBindingWithValue      ScaleCurveRange;                                   // 0x0060(0x0020)
...
{
public:
	class UNiagaraSystem*                         System;                                            // 0x0490(0x0008)
	ENiagaraPreviewGridResetMode                  ResetMode;                                         // 0x0498(0x0001)
	uint8                                         Pad_499[0x7];                                      // 0x0499(0x0007)
	class UNiagaraPreviewAxis*                    PreviewAxisX;                                      // 0x04A0(0x0008)
	class UNiagaraPreviewAxis*                    PreviewAxisY;                                      // 0x04A8(0x0008)
	TSubclassOf<class ANiagaraPreviewBase>        PreviewClass;                                      // 0x04B0(0x0008)
	float                                         SpacingX;                                          // 0x04B8(0x0004)
	float                                         SpacingY;                                          // 0x04BC(0x0004)
	int32                                         NumX;                                              // 0x04C0(0x0004)
	int32                                         NumY;                                              // 0x04C4(0x0004)
	TArray<class UChildActorComponent*>           PreviewComponents;                                 // 0x04C8(0x0010)
	uint8                                         Pad_4D8[0x8];                                      // 0x04D8(0x0008)
...
{
public:
	struct FNiagaraDistributionRangeFloat         VelocityThreshold;                                 // 0x0030(0x0020)
	struct FNiagaraDistributionRangeVector3       MinScaleFactor;                                    // 0x0050(0x0030)
	struct FNiagaraDistributionRangeVector3       MaxScaleFactor;                                    // 0x0080(0x0030)
	bool                                          bSampleScaleFactorByCurve;                         // 0x00B0(0x0001)
	uint8                                         Pad_B1[0x7];                                       // 0x00B1(0x0007)
	struct FNiagaraDistributionFloat              SampleFactorCurve;                                 // 0x00B8(0x0030)
...
{
public:
	struct FNiagaraDistributionVector2            ScaleDistribution;                                 // 0x0030(0x0030)
	struct FNiagaraParameterBindingWithValue      ScaleCurveRange;                                   // 0x0060(0x0020)
...
public:
	struct FNiagaraDistributionRangeFloat         VelocityThreshold;                                 // 0x0030(0x0020)
	struct FNiagaraDistributionRangeVector2       MinScaleFactor;                                    // 0x0050(0x0028)
	struct FNiagaraDistributionRangeVector2       MaxScaleFactor;                                    // 0x0078(0x0028)
	bool                                          bSampleScaleFactorByCurve;                         // 0x00A0(0x0001)
	uint8                                         Pad_A1[0x7];                                       // 0x00A1(0x0007)
	struct FNiagaraDistributionFloat              SampleFactorCurve;                                 // 0x00A8(0x0030)
...
{
public:
	struct FGuid                                  CacheGuid;                                         // 0x0028(0x0010)
	TSoftObjectPtr<class UNiagaraSystem>          SoftNiagaraSystem;                                 // 0x0038(0x0028)
	float                                         StartSeconds;                                      // 0x0060(0x0004)
	float                                         DurationSeconds;                                   // 0x0064(0x0004)
	struct FNiagaraSimCacheCreateParameters       CreateParameters;                                  // 0x0068(0x0058)
	bool                                          bNeedsReadComponentMappingRecache;                 // 0x00C0(0x0001)
	uint8                                         Pad_C1[0x7];                                       // 0x00C1(0x0007)
	struct FNiagaraSimCacheLayout                 CacheLayout;                                       // 0x00C8(0x00C8)
	TArray<struct FNiagaraSimCacheFrame>          CacheFrames;                                       // 0x0190(0x0010)
	TMap<struct FNiagaraVariableBase, class UObject*> DataInterfaceStorage;                          // 0x01A0(0x0050)
	class UNiagaraSimCacheDebugData*              DebugData;                                         // 0x01F0(0x0008)
	uint8                                         Pad_1F8[0x18];                                     // 0x01F8(0x0018)
...
public:
	...
	struct FVector3f                              SpriteFacing;                                      // 0x0034(0x000C)
	struct FVector3f                              SpriteAlignment;                                   // 0x0040(0x000C)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)
...
public:
	...
	struct FGuid                                  ExposedVersion;                                    // 0x0030(0x0010)
	bool                                          bVersioningEnabled;                                // 0x0040(0x0001)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)
	TArray<struct FVersionedNiagaraEmitterData>   VersionData;                                       // 0x0048(0x0010)
	uint8                                         Pad_58[0x8];                                       // 0x0058(0x0008)
	class FString                                 UniqueEmitterName;                                 // 0x0060(0x0010)
...
{
public:
	struct FNiagaraDistributionRangeFloat         RotationRateDistribution;                          // 0x0030(0x0020)
...
public:
	...
	int32                                         StartFrameRangeOverride;                           // 0x0038(0x0004)
	int32                                         EndFrameRangeOverride;                             // 0x003C(0x0004)
...
public:
	...
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)
	int32                                         LocalPlayerIndex;                                  // 0x003C(0x0004)
	TLazyObjectPtr<class AActor>                  SourceActor;                                       // 0x0040(0x0018)
	struct FNiagaraUserParameterBinding           ActorOrComponentParameter;                         // 0x0058(0x0020)
...
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)
	struct FVector4                               min_0;                                             // 0x0040(0x0020)
	struct FVector4                               max_0;                                             // 0x0060(0x0020)
...
{
public:
	int32                                         MaxTracesPerParticle;                              // 0x0038(0x0004)
	int32                                         MaxRetraces;                                       // 0x003C(0x0004)
	ENDICollisionQuery_AsyncGpuTraceProvider      TraceProvider;                                     // 0x0040(0x0001)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)
...
{
public:
	struct FNiagaraDataInterfaceEmitterBinding    EmitterBinding;                                    // 0x0038(0x000C)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)
...
{
public:
	uint32                                        OverrideMaxLineInstances;                          // 0x0038(0x0004)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
...
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)
	TArray<struct FNiagaraDynamicMeshSection>     Sections;                                          // 0x0040(0x0010)
	TArray<struct FNiagaraDynamicMeshMaterial>    Materials;                                         // 0x0050(0x0010)
	int32                                         NumVertices;                                       // 0x0060(0x0004)
	int32                                         NumTexCoords;                                      // 0x0064(0x0004)
	...
	struct FBox                                   DefaultBounds;                                     // 0x0070(0x0038)
...
{
public:
	class FName                                   NameSpace;                                         // 0x0028(0x0008)
	TArray<struct FNiagaraVariable>               Parameters;                                        // 0x0030(0x0010)
	...
	struct FGuid                                  CompileId;                                         // 0x0050(0x0010)
	uint8                                         Pad_60[0x8];                                       // 0x0060(0x0008)
...
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)
	struct FIntPoint                              Size;                                              // 0x0040(0x0008)
	ENiagaraMipMapGeneration                      MipMapGeneration;                                  // 0x0048(0x0001)
	ENiagaraMipMapGenerationType                  MipMapGenerationType;                              // 0x0049(0x0001)
	ETextureRenderTargetFormat                    OverrideRenderTargetFormat;                        // 0x004A(0x0001)
	ETextureFilter                                OverrideRenderTargetFilter;                        // 0x004B(0x0001)
	uint8                                         bInheritUserParameterSettings : 1;                 // 0x004C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverrideFormat : 1;                               // 0x004C(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_4D[0x3];                                       // 0x004D(0x0003)
	struct FNiagaraUserParameterBinding           RenderTargetUserParameter;                         // 0x0050(0x0020)
	uint8                                         Pad_70[0x50];                                      // 0x0070(0x0050)
...
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)
	int32                                         DefaultNumElements;                                // 0x0040(0x0004)
	ENiagaraGpuSyncMode                           GpuSyncMode;                                       // 0x0044(0x0001)
...
{
public:
	TArray<struct FNDIMemoryBufferSimCacheDataFrame> FrameData;                                      // 0x0028(0x0010)
	TArray<uint32>                                BufferData;                                        // 0x0038(0x0010)
...
public:
	...
	TSoftObjectPtr<class AActor>                  SoftSourceActor;                                   // 0x0040(0x0028)
	struct FNiagaraUserParameterBinding           MeshUserParameter;                                 // 0x0068(0x0020)
...
{
public:
	TArray<class FName>                           ActorTags;                                         // 0x0038(0x0010)
	TArray<class FName>                           ComponentTags;                                     // 0x0048(0x0010)
	TArray<TSoftObjectPtr<class AActor>>          SourceActors;                                      // 0x0058(0x0010)
	...
	int32                                         MaxNumPrimitives;                                  // 0x0070(0x0004)
	uint8                                         Pad_74[0x4];                                       // 0x0074(0x0004)
...
public:
	...
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
	struct FNiagaraUserParameterBinding           SceneCaptureUserParameter;                         // 0x0040(0x0020)
	...
	struct FVector                                AutoMoveOffsetLocation;                            // 0x0068(0x0018)
	ENDISceneCapture2DOffsetMode                  AutoMoveOffsetRotationMode;                        // 0x0080(0x0001)
	uint8                                         Pad_81[0x7];                                       // 0x0081(0x0007)
	struct FRotator                               AutoMoveOffsetRotation;                            // 0x0088(0x0018)
	ESceneCaptureSource                           ManagedCaptureSource;                              // 0x00A0(0x0001)
	uint8                                         Pad_A1[0x3];                                       // 0x00A1(0x0003)
	struct FIntPoint                              ManagedTextureSize;                                // 0x00A4(0x0008)
	ETextureRenderTargetFormat                    ManagedTextureFormat;                              // 0x00AC(0x0001)
	ECameraProjectionMode                         ManagedProjectionType;                             // 0x00AD(0x0001)
	...
	TMap<uint64, class USceneCaptureComponent2D*> ManagedCaptureComponents;                          // 0x00D8(0x0050)
...
{
public:
	struct FNiagaraUserParameterBinding           SimCacheBinding;                                   // 0x0038(0x0020)
	class UNiagaraSimCache*                       SimCache;                                          // 0x0058(0x0008)
	class FName                                   EmitterBinding;                                    // 0x0060(0x0008)
...
{
public:
	int32                                         min_0;                                             // 0x0038(0x0004)
	int32                                         max_0;                                             // 0x003C(0x0004)
...
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)
	ENiagaraGpuSyncMode                           GpuSyncMode;                                       // 0x0040(0x0001)
	uint8                                         Pad_41[0x3];                                       // 0x0041(0x0003)
	int32                                         InitialValue;                                      // 0x0044(0x0004)
...
{
public:
	TArray<int32>                                 Values;                                            // 0x0028(0x0010)
...
{
public:
	ENDISocketReaderSourceMode                    SourceMode;                                        // 0x0038(0x0001)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
	TArray<class FName>                           FilteredSockets;                                   // 0x0040(0x0010)
	TLazyObjectPtr<class AActor>                  SourceActor;                                       // 0x0050(0x0018)
	class UObject*                                SourceAsset;                                       // 0x0068(0x0008)
	TSubclassOf<class UObject>                    AttachComponentClass;                              // 0x0070(0x0008)
	class FName                                   AttachComponentTag;                                // 0x0078(0x0008)
	struct FNiagaraUserParameterBinding           ObjectParameterBinding;                            // 0x0080(0x0020)
	bool                                          bUpdateSocketsPerFrame;                            // 0x00A0(0x0001)
	bool                                          bRequireCurrentFrameData;                          // 0x00A1(0x0001)
...
public:
	...
	struct FNDIStaticMeshSectionFilter            SectionFilter;                                     // 0x0078(0x0010)
	...
	int32                                         LODIndex;                                          // 0x008C(0x0004)
	struct FNiagaraUserParameterBinding           LODIndexUserParameter;                             // 0x0090(0x0020)
	struct FNiagaraUserParameterBinding           MeshParameterBinding;                              // 0x00B0(0x0020)
	int32                                         InstanceIndex;                                     // 0x00D0(0x0004)
...
public:
	...
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
	struct FNiagaraUserParameterBinding           UObjectParameterBinding;                           // 0x0040(0x0020)
	TArray<struct FNiagaraUObjectPropertyReaderRemap> PropertyRemap;                                 // 0x0060(0x0010)
	TSoftObjectPtr<class AActor>                  SourceActor;                                       // 0x0070(0x0028)
	TSubclassOf<class UObject>                    SourceActorComponentClass;                         // 0x0098(0x0008)
...
{
public:
	ENiagaraSystemSpawnSectionStartBehavior       SectionStartBehavior;                              // 0x00F8(0x0004)
	ENiagaraSystemSpawnSectionEvaluateBehavior    SectionEvaluateBehavior;                           // 0x00FC(0x0004)
	ENiagaraSystemSpawnSectionEndBehavior         SectionEndBehavior;                                // 0x0100(0x0004)
	ENiagaraAgeUpdateMode                         AgeUpdateMode;                                     // 0x0104(0x0001)
	bool                                          bAllowScalability;                                 // 0x0105(0x0001)
...
{
public:
	struct FNiagaraVariable                       Parameter;                                         // 0x0108(0x0020)
...
public:
	uint8                                         Pad_128[0x8];                                      // 0x0128(0x0008)
	int32                                         ChannelsUsed;                                      // 0x0130(0x0004)
...
{
public:
	class FString                                 OutputName;                                        // 0x0028(0x0010)
...
{
public:
	class FString                                 SimCacheAssetPathFormat;                           // 0x0038(0x0010)
	struct FNiagaraSimCacheCreateParameters       CreateParameters;                                  // 0x0048(0x0058)
...
{
public:
	struct FNiagaraBakerTextureSource             SourceBinding;                                     // 0x0038(0x0018)
	struct FNiagaraParameterBinding               VolumeWorldSpaceSizeBinding;                       // 0x0050(0x000C)
	uint8                                         Pad_5C[0x4];                                       // 0x005C(0x0004)
	class FString                                 SparseVolumeTextureAssetPathFormat;                // 0x0060(0x0010)
...
public:
	struct FNiagaraBakerTextureSource             SourceBinding;                                     // 0x0038(0x0018)
	uint8                                         bGenerateAtlas : 1;                                // 0x0050(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bGenerateFrames : 1;                               // 0x0050(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bExportFrames : 1;                                 // 0x0050(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bSetTextureAddressX : 1;                           // 0x0050(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bSetTextureAddressY : 1;                           // 0x0050(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         Pad_51[0x3];                                       // 0x0051(0x0003)
	struct FIntPoint                              FrameSize;                                         // 0x0054(0x0008)
	struct FIntPoint                              AtlasTextureSize;                                  // 0x005C(0x0008)
	uint8                                         Pad_64[0x8];                                       // 0x0064(0x0008)
	ETextureAddress                               TextureAddressX;                                   // 0x006C(0x0001)
	ETextureAddress                               TextureAddressY;                                   // 0x006D(0x0001)
	uint8                                         Pad_6E[0x2];                                       // 0x006E(0x0002)
	class FString                                 AtlasAssetPathFormat;                              // 0x0070(0x0010)
	class FString                                 FramesAssetPathFormat;                             // 0x0080(0x0010)
	class FString                                 FramesExportPathFormat;                            // 0x0090(0x0010)
...
public:
	...
	class FString                                 AtlasAssetPathFormat;                              // 0x0058(0x0010)
	class FString                                 FramesAssetPathFormat;                             // 0x0068(0x0010)
	class FString                                 FramesExportPathFormat;                            // 0x0078(0x0010)
...
public:
	...
	int32                                         FramesPerSecond;                                   // 0x0030(0x0004)
	uint8                                         bLockToSimulationFrameRate : 1;                    // 0x0034(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bPreviewLooping : 1;                               // 0x0034(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_35[0x3];                                       // 0x0035(0x0003)
	struct FIntPoint                              FramesPerDimension;                                // 0x0038(0x0008)
	TArray<class UNiagaraBakerOutput*>            Outputs;                                           // 0x0040(0x0010)
	TArray<struct FNiagaraBakerCameraSettings>    CameraSettings;                                    // 0x0050(0x0010)
	int32                                         CurrentCameraIndex;                                // 0x0060(0x0004)
	class FName                                   BakeQualityLevel;                                  // 0x0064(0x0008)
	uint8                                         bRenderComponentOnly : 1;                          // 0x006C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_6D[0x3];                                       // 0x006D(0x0003)
	TArray<struct FNiagaraBakerTextureSettings>   OutputTextures;                                    // 0x0070(0x0010)
	ENiagaraBakerViewMode                         CameraViewportMode;                                // 0x0080(0x0004)
	uint8                                         Pad_84[0x4];                                       // 0x0084(0x0004)
	struct FVector                                CameraViewportLocation[0x7];                       // 0x0088(0x0018)
	struct FRotator                               CameraViewportRotation[0x7];                       // 0x0130(0x0018)
	float                                         CameraOrbitDistance;                               // 0x01D8(0x0004)
	float                                         CameraFOV;                                         // 0x01DC(0x0004)
	float                                         CameraOrthoWidth;                                  // 0x01E0(0x0004)
	uint8                                         bUseCameraAspectRatio : 1;                         // 0x01E4(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
{
public:
	class UNiagaraSystem*                         Asset;                                             // 0x0620(0x0008)
	ENiagaraTickBehavior                          TickBehavior;                                      // 0x0628(0x0001)
	uint8                                         Pad_629[0x3];                                      // 0x0629(0x0003)
	int32                                         RandomSeedOffset;                                  // 0x062C(0x0004)
	struct FNiagaraUserRedirectionParameterStore  OverrideParameters;                                // 0x0630(0x00D8)
	uint8                                         BitPad_708_0 : 1;                                  // 0x0708(0x0001)
	uint8                                         bEnableGpuComputeDebug : 1;                        // 0x0708(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverrideWarmupSettings : 1;                       // 0x0708(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bAutoManageNiagaraHiddenState : 1;                 // 0x0708(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         Pad_709[0x3];                                      // 0x0709(0x0003)
	int32                                         WarmupTickCount;                                   // 0x070C(0x0004)
	float                                         WarmupTickDelta;                                   // 0x0710(0x0004)
	uint8                                         Pad_714[0x34];                                     // 0x0714(0x0034)
	uint8                                         bAutoDestroy : 1;                                  // 0x0748(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bRenderingEnabled : 1;                             // 0x0748(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bAutoManageAttachment : 1;                         // 0x0748(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bAutoAttachWeldSimulatedBodies : 1;                // 0x0748(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         Pad_749[0x3];                                      // 0x0749(0x0003)
	float                                         MaxTimeBeforeForceUpdateTransform;                 // 0x074C(0x0004)
	uint8                                         Pad_750[0x1];                                      // 0x0750(0x0001)
	ENiagaraOcclusionQueryMode                    OcclusionQueryMode;                                // 0x0751(0x0001)
	uint8                                         Pad_752[0x6];                                      // 0x0752(0x0006)
	TMulticastInlineDelegate<void(class UNiagaraComponent* PSystem)> OnSystemFinished;               // 0x0758(0x0010)
	TWeakObjectPtr<class USceneComponent>         AutoAttachParent;                                  // 0x0768(0x0008)
	class FName                                   AutoAttachSocketName;                              // 0x0770(0x0008)
	EAttachmentRule                               AutoAttachLocationRule;                            // 0x0778(0x0001)
	EAttachmentRule                               AutoAttachRotationRule;                            // 0x0779(0x0001)
	EAttachmentRule                               AutoAttachScaleRule;                               // 0x077A(0x0001)
	uint8                                         Pad_77B[0x9];                                      // 0x077B(0x0009)
	uint8                                         BitPad_784_0 : 4;                                  // 0x0784(0x0001)
	uint8                                         bAllowScalability : 1;                             // 0x0784(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         Pad_785[0xEB];                                     // 0x0785(0x00EB)
	class UNiagaraSimCache*                       SimCache;                                          // 0x0870(0x0008)
	class UNiagaraCullProxyComponent*             CullProxy;                                         // 0x0878(0x0008)
...
{
public:
	struct FNiagaraPlatformSet                    Platforms;                                         // 0x0028(0x0030)
	int32                                         SortOrderHint;                                     // 0x0058(0x0004)
	ENiagaraRendererMotionVectorSetting           MotionVectorSetting;                               // 0x005C(0x0001)
	bool                                          bIsEnabled;                                        // 0x005D(0x0001)
	bool                                          bAllowInCullProxies;                               // 0x005E(0x0001)
	uint8                                         Pad_5F[0x1];                                       // 0x005F(0x0001)
	struct FNiagaraVariableAttributeBinding       RendererEnabledBinding;                            // 0x0060(0x0038)
	struct FGuid                                  OuterEmitterVersion;                               // 0x0098(0x0010)
	uint8                                         Pad_A8[0x10];                                      // 0x00A8(0x0010)
...
{
public:
	TSubclassOf<class USceneComponent>            ComponentType;                                     // 0x00B8(0x0008)
	uint32                                        ComponentCountLimit;                               // 0x00C0(0x0004)
	uint8                                         Pad_C4[0x4];                                       // 0x00C4(0x0004)
	struct FNiagaraVariableAttributeBinding       EnabledBinding;                                    // 0x00C8(0x0038)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x0100(0x0038)
	bool                                          bAssignComponentsOnParticleID;                     // 0x0138(0x0001)
	bool                                          bCreateComponentFirstParticleFrame;                // 0x0139(0x0001)
	bool                                          bOnlyActivateNewlyAquiredComponents;               // 0x013A(0x0001)
	uint8                                         Pad_13B[0x1];                                      // 0x013B(0x0001)
	int32                                         RendererVisibility;                                // 0x013C(0x0004)
	class USceneComponent*                        TemplateComponent;                                 // 0x0140(0x0008)
	TArray<struct FNiagaraComponentPropertyBinding> PropertyBindings;                                // 0x0148(0x0010)
	uint8                                         Pad_158[0x58];                                     // 0x0158(0x0058)
...
{
public:
	TArray<struct FNiagaraCulledComponentInfo>    Instances;                                         // 0x0880(0x0010)
...
{
public:
	TArray<struct FNDIArraySimCacheDataFrame>     CpuFrameData;                                      // 0x0028(0x0010)
	TArray<struct FNDIArraySimCacheDataFrame>     GpuFrameData;                                      // 0x0038(0x0010)
	TArray<uint8>                                 BufferData;                                        // 0x0048(0x0010)
...
{
public:
	TArray<struct FVector2f>                      InternalFloatData;                                 // 0x0050(0x0010)
...
{
public:
	TArray<struct FVector3f>                      InternalFloatData;                                 // 0x0050(0x0010)
...
{
public:
	TArray<struct FNiagaraPosition>               PositionData;                                      // 0x0050(0x0010)
...
{
public:
	TArray<struct FVector4f>                      InternalFloatData;                                 // 0x0050(0x0010)
...
{
public:
	TArray<struct FLinearColor>                   ColorData;                                         // 0x0050(0x0010)
...
{
public:
	TArray<struct FQuat4f>                        InternalQuatData;                                  // 0x0050(0x0010)
...
{
public:
	TArray<struct FMatrix44f>                     InternalMatrixData;                                // 0x0050(0x0010)
...
{
public:
	TArray<int32>                                 IntData;                                           // 0x0050(0x0010)
...
{
public:
	TArray<uint8>                                 InternalIntData;                                   // 0x0050(0x0010)
...
{
public:
	TArray<struct FNiagaraID>                     IntData;                                           // 0x0050(0x0010)
...
public:
	class USoundSubmix*                           Submix;                                            // 0x0038(0x0008)
	int32                                         Resolution;                                        // 0x0040(0x0004)
...
public:
	...
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
	struct FSoundAttenuationSettings              AttenuationSettings;                               // 0x0040(0x03D0)
...
public:
	...
	TArray<class FName>                           ParameterNames;                                    // 0x0050(0x0010)
	struct FNiagaraUserParameterBinding           ConfigurationUserParameter;                        // 0x0060(0x0020)
	bool                                          bLimitPlaysPerTick;                                // 0x0080(0x0001)
	uint8                                         Pad_81[0x3];                                       // 0x0081(0x0003)
	int32                                         MaxPlaysPerTick;                                   // 0x0084(0x0004)
...
{
public:
	class FName                                   AuxSceneTextureName;                               // 0x0038(0x0008)
...
{
public:
	int32                                         PlayerControllerIndex;                             // 0x0038(0x0004)
...
{
public:
	uint32                                        Seed;                                              // 0x0038(0x0004)
	uint8                                         Pad_3C[0xC];                                       // 0x003C(0x000C)
...
{
public:
	struct FRichCurve                             Curve;                                             // 0x0070(0x0080)
...
{
public:
	struct FNiagaraUserParameterBinding           CallbackHandlerParameter;                          // 0x0038(0x0020)
	ENDIExport_GPUAllocationMode                  GPUAllocationMode;                                 // 0x0058(0x0001)
	uint8                                         Pad_59[0x3];                                       // 0x0059(0x0003)
	int32                                         GPUAllocationFixedSize;                            // 0x005C(0x0004)
...
public:
	bool                                          ClearBeforeNonIterationStage;                      // 0x0038(0x0001)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)
	int32                                         NumCellsX;                                         // 0x003C(0x0004)
	int32                                         NumCellsY;                                         // 0x0040(0x0004)
	int32                                         NumCellsMaxAxis;                                   // 0x0044(0x0004)
	int32                                         NumAttributes;                                     // 0x0048(0x0004)
	bool                                          SetGridFromMaxAxis;                                // 0x004C(0x0001)
	uint8                                         Pad_4D[0x3];                                       // 0x004D(0x0003)
	struct FVector2D                              WorldBBoxSize;                                     // 0x0050(0x0010)
...
{
public:
	struct FNiagaraUserParameterBinding           RenderTargetUserParameter;                         // 0x0060(0x0020)
	ENiagaraGpuBufferFormat                       OverrideBufferFormat;                              // 0x0080(0x0001)
	uint8                                         bOverrideFormat : 1;                               // 0x0081(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_82[0x56];                                      // 0x0082(0x0056)
	TMap<uint64, class UTextureRenderTarget2DArray*> ManagedRenderTargets;                           // 0x00D8(0x0050)
...
{
public:
	class FString                                 EmitterName;                                       // 0x0128(0x0010)
	class FString                                 DIName;                                            // 0x0138(0x0010)
...
{
public:
	int32                                         NumAttributes;                                     // 0x0070(0x0004)
	uint8                                         Pad_74[0x4];                                       // 0x0074(0x0004)
	struct FNiagaraUserParameterBinding           RenderTargetUserParameter;                         // 0x0078(0x0020)
	ENiagaraGpuBufferFormat                       OverrideBufferFormat;                              // 0x0098(0x0001)
	uint8                                         bOverrideFormat : 1;                               // 0x0099(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_9A[0x56];                                      // 0x009A(0x0056)
...
{
public:
	class FString                                 EmitterName;                                       // 0x00F0(0x0010)
	class FString                                 DIName;                                            // 0x0100(0x0010)
...
{
public:
	struct FIntPoint                              Size;                                              // 0x0038(0x0008)
	struct FNiagaraUserParameterBinding           RenderTargetUserParameter;                         // 0x0040(0x0020)
...
{
public:
	struct FNiagaraPlatformSet                    Platforms;                                         // 0x0038(0x0030)
...
public:
	...
	int32                                         ResetValue;                                        // 0x0078(0x0004)
...
{
public:
	struct FIntVector                             Size;                                              // 0x0038(0x000C)
	ETextureRenderTargetFormat                    OverrideRenderTargetFormat;                        // 0x0044(0x0001)
	ETextureFilter                                OverrideRenderTargetFilter;                        // 0x0045(0x0001)
	uint8                                         bInheritUserParameterSettings : 1;                 // 0x0046(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverrideFormat : 1;                               // 0x0046(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_47[0x1];                                       // 0x0047(0x0001)
	struct FNiagaraUserParameterBinding           RenderTargetUserParameter;                         // 0x0048(0x0020)
...
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)
	struct FIntVector                             Size;                                              // 0x0040(0x000C)
	ETextureRenderTargetFormat                    OverrideRenderTargetFormat;                        // 0x004C(0x0001)
	ETextureFilter                                OverrideRenderTargetFilter;                        // 0x004D(0x0001)
	uint8                                         bInheritUserParameterSettings : 1;                 // 0x004E(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverrideFormat : 1;                               // 0x004E(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
public:
	...
	struct FNiagaraUserParameterBinding           SparseVolumeTextureUserParameter;                  // 0x0040(0x0020)
	bool                                          BlockingStreamingRequests;                         // 0x0060(0x0001)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)
...
public:
	...
	struct FRichCurve                             YCurve;                                            // 0x00F0(0x0080)
	struct FRichCurve                             ZCurve;                                            // 0x0170(0x0080)
	struct FRichCurve                             WCurve;                                            // 0x01F0(0x0080)
...
public:
	uint8                                         Pad_28[0x20];                                      // 0x0028(0x0020)
	struct FNiagaraDebugHUDSettingsData           Data;                                              // 0x0048(0x0240)
...
{
public:
	class UMaterialInterface*                     Material;                                          // 0x00B8(0x0008)
	struct FNiagaraParameterBinding               MaterialParameterBinding;                          // 0x00C0(0x000C)
	ENiagaraRendererSourceDataMode                SourceMode;                                        // 0x00CC(0x0001)
	uint8                                         Pad_CD[0x3];                                       // 0x00CD(0x0003)
	int32                                         RendererVisibility;                                // 0x00D0(0x0004)
	float                                         DecalScreenSizeFade;                               // 0x00D4(0x0004)
	struct FNiagaraVariableAttributeBinding       PositionBinding;                                   // 0x00D8(0x0038)
	struct FNiagaraVariableAttributeBinding       DecalOrientationBinding;                           // 0x0110(0x0038)
	struct FNiagaraVariableAttributeBinding       DecalSizeBinding;                                  // 0x0148(0x0038)
	struct FNiagaraVariableAttributeBinding       DecalFadeBinding;                                  // 0x0180(0x0038)
	struct FNiagaraVariableAttributeBinding       DecalSortOrderBinding;                             // 0x01B8(0x0038)
	struct FNiagaraVariableAttributeBinding       DecalColorBinding;                                 // 0x01F0(0x0038)
	struct FNiagaraVariableAttributeBinding       DecalVisibleBinding;                               // 0x0228(0x0038)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x0260(0x0038)
	struct FNiagaraRendererMaterialParameters     MaterialParameters;                                // 0x0298(0x0050)
	uint8                                         Pad_2E8[0x38];                                     // 0x02E8(0x0038)
...
public:
	...
	TArray<struct FNiagaraSystemScalabilitySettings> DetailLevelScalabilitySettings;                 // 0x0040(0x0010)
	struct FNiagaraSystemScalabilitySettingsArray SystemScalabilitySettings;                         // 0x0050(0x0010)
	struct FNiagaraEmitterScalabilitySettingsArray EmitterScalabilitySettings;                       // 0x0060(0x0010)
	uint8                                         Pad_70[0x8];                                       // 0x0070(0x0008)
	class UNiagaraBaselineController*             PerformanceBaselineController;                     // 0x0078(0x0008)
	struct FNiagaraPerfBaselineStats              PerfBaselineStats;                                 // 0x0080(0x0010)
	struct FGuid                                  PerfBaselineVersion;                               // 0x0090(0x0010)
...
{
public:
	uint32                                        NumParticles;                                      // 0x0028(0x0004)
...
{
public:
	ENiagaraRendererSourceDataMode                SourceMode;                                        // 0x00B8(0x0001)
	uint8                                         Pad_B9[0x3];                                       // 0x00B9(0x0003)
	uint8                                         bUseInverseSquaredFalloff : 1;                     // 0x00BC(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bAffectsTranslucency : 1;                          // 0x00BC(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bAlphaScalesBrightness : 1;                        // 0x00BC(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverrideInverseExposureBlend : 1;                 // 0x00BC(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bCastSampledLightShadows : 1;                      // 0x00BC(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         Pad_BD[0x3];                                       // 0x00BD(0x0003)
	float                                         RadiusScale;                                       // 0x00C0(0x0004)
	float                                         DefaultExponent;                                   // 0x00C4(0x0004)
	float                                         SpecularScale;                                     // 0x00C8(0x0004)
	float                                         DiffuseScale;                                      // 0x00CC(0x0004)
	struct FVector3f                              ColorAdd;                                          // 0x00D0(0x000C)
	float                                         InverseExposureBlend;                              // 0x00DC(0x0004)
	int32                                         RendererVisibility;                                // 0x00E0(0x0004)
	uint8                                         Pad_E4[0x4];                                       // 0x00E4(0x0004)
	struct FNiagaraVariableAttributeBinding       LightRenderingEnabledBinding;                      // 0x00E8(0x0038)
	struct FNiagaraVariableAttributeBinding       SampledLightShadowsEnabledBinding;                 // 0x0120(0x0038)
	struct FNiagaraVariableAttributeBinding       LightExponentBinding;                              // 0x0158(0x0038)
	struct FNiagaraVariableAttributeBinding       PositionBinding;                                   // 0x0190(0x0038)
	struct FNiagaraVariableAttributeBinding       ColorBinding;                                      // 0x01C8(0x0038)
	struct FNiagaraVariableAttributeBinding       RadiusBinding;                                     // 0x0200(0x0038)
	struct FNiagaraVariableAttributeBinding       VolumetricScatteringBinding;                       // 0x0238(0x0038)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x0270(0x0038)
	struct FNiagaraVariableAttributeBinding       SpecularScaleBinding;                              // 0x02A8(0x0038)
	struct FNiagaraVariableAttributeBinding       DiffuseScaleBinding;                               // 0x02E0(0x0038)
	uint8                                         Pad_318[0x48];                                     // 0x0318(0x0048)
...
{
public:
	TArray<struct FNiagaraMeshRendererMeshProperties> Meshes;                                        // 0x00B8(0x0010)
	ENiagaraRendererSourceDataMode                SourceMode;                                        // 0x00C8(0x0001)
	ENiagaraSortMode                              SortMode;                                          // 0x00C9(0x0001)
	ENiagaraRendererSortPrecision                 SortPrecision;                                     // 0x00CA(0x0001)
	ENiagaraRendererGpuTranslucentLatency         GpuTranslucentLatency;                             // 0x00CB(0x0001)
	uint8                                         bOverrideMaterials : 1;                            // 0x00CC(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bUseHeterogeneousVolumes : 1;                      // 0x00CC(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bSortOnlyWhenTranslucent : 1;                      // 0x00CC(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bSubImageBlend : 1;                                // 0x00CC(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bEnableFrustumCulling : 1;                         // 0x00CC(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bEnableCameraDistanceCulling : 1;                  // 0x00CC(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bEnableMeshFlipbook : 1;                           // 0x00CC(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bLockedAxisEnable : 1;                             // 0x00CC(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
	uint8                                         Pad_CD[0x3];                                       // 0x00CD(0x0003)
	uint8                                         bCastShadows : 1;                                  // 0x00D0(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_D1[0x7];                                       // 0x00D1(0x0007)
	TArray<struct FNiagaraMeshMaterialOverride>   OverrideMaterials;                                 // 0x00D8(0x0010)
	TArray<struct FNiagaraMeshMICOverride>        MICOverrideMaterials;                              // 0x00E8(0x0010)
	struct FVector2D                              SubImageSize;                                      // 0x00F8(0x0010)
	struct FVector                                LockedAxis;                                        // 0x0108(0x0018)
	struct FVector                                MeshBoundsScale;                                   // 0x0120(0x0018)
	ENiagaraMeshFacingMode                        FacingMode;                                        // 0x0138(0x0001)
	ENiagaraMeshLockedAxisSpace                   LockedAxisSpace;                                   // 0x0139(0x0001)
	uint8                                         Pad_13A[0x2];                                      // 0x013A(0x0002)
	float                                         MinCameraDistance;                                 // 0x013C(0x0004)
	float                                         MaxCameraDistance;                                 // 0x0140(0x0004)
	uint32                                        RendererVisibility;                                // 0x0144(0x0004)
	struct FNiagaraVariableAttributeBinding       PositionBinding;                                   // 0x0148(0x0038)
	struct FNiagaraVariableAttributeBinding       ColorBinding;                                      // 0x0180(0x0038)
	struct FNiagaraVariableAttributeBinding       VelocityBinding;                                   // 0x01B8(0x0038)
	struct FNiagaraVariableAttributeBinding       MeshOrientationBinding;                            // 0x01F0(0x0038)
	struct FNiagaraVariableAttributeBinding       ScaleBinding;                                      // 0x0228(0x0038)
	struct FNiagaraVariableAttributeBinding       SubImageIndexBinding;                              // 0x0260(0x0038)
	struct FNiagaraVariableAttributeBinding       DynamicMaterialBinding;                            // 0x0298(0x0038)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial1Binding;                           // 0x02D0(0x0038)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial2Binding;                           // 0x0308(0x0038)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial3Binding;                           // 0x0340(0x0038)
	struct FNiagaraVariableAttributeBinding       MaterialRandomBinding;                             // 0x0378(0x0038)
	struct FNiagaraVariableAttributeBinding       CustomSortingBinding;                              // 0x03B0(0x0038)
	struct FNiagaraVariableAttributeBinding       NormalizedAgeBinding;                              // 0x03E8(0x0038)
	struct FNiagaraVariableAttributeBinding       CameraOffsetBinding;                               // 0x0420(0x0038)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x0458(0x0038)
	struct FNiagaraVariableAttributeBinding       MeshIndexBinding;                                  // 0x0490(0x0038)
	struct FNiagaraRendererMaterialParameters     MaterialParameters;                                // 0x04C8(0x0050)
	struct FNiagaraVariableAttributeBinding       PrevPositionBinding;                               // 0x0518(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevScaleBinding;                                  // 0x0550(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevMeshOrientationBinding;                        // 0x0588(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevCameraOffsetBinding;                           // 0x05C0(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevVelocityBinding;                               // 0x05F8(0x0038)
	uint32                                        MaterialParamValidMask;                            // 0x0630(0x0004)
	uint8                                         Pad_634[0x54];                                     // 0x0634(0x0054)
...
public:
	...
	TArray<struct FNiagaraVariable>               OverridenParameters;                               // 0x0030(0x0010)
	struct FNiagaraParameterStore                 ParameterStorage;                                  // 0x0040(0x0088)
	class UMaterialParameterCollectionInstance*   SourceMaterialCollectionInstance;                  // 0x00C8(0x0008)
	uint8                                         Pad_D0[0x28];                                      // 0x00D0(0x0028)
...
public:
	...
	TSoftObjectPtr<class UNiagaraSystem>          System;                                            // 0x0040(0x0028)
...
{
public:
	int32                                         NumInstances;                                      // 0x0068(0x0004)
	uint8                                         Pad_6C[0x4];                                       // 0x006C(0x0004)
...
{
public:
	class UNiagaraBaselineController*             Controller;                                        // 0x0490(0x0008)
	class UTextRenderComponent*                   Label;                                             // 0x0498(0x0008)
...
{
public:
	float                                         min_0;                                             // 0x0038(0x0004)
	float                                         max_0;                                             // 0x003C(0x0004)
...
{
public:
	struct FVector                                min_0;                                             // 0x0038(0x0018)
	struct FVector                                max_0;                                             // 0x0050(0x0018)
...
{
public:
	struct FLinearColor                           min_0;                                             // 0x0038(0x0010)
	struct FLinearColor                           max_0;                                             // 0x0048(0x0010)
...
public:
	class UMaterialInterface*                     Material;                                          // 0x00B8(0x0008)
	struct FNiagaraUserParameterBinding           MaterialUserParamBinding;                          // 0x00C0(0x0020)
	struct FNiagaraRibbonUVSettings               UV0Settings;                                       // 0x00E0(0x0028)
	struct FNiagaraRibbonUVSettings               UV1Settings;                                       // 0x0108(0x0028)
	ENiagaraRibbonFacingMode                      FacingMode;                                        // 0x0130(0x0001)
	uint8                                         Pad_131[0x3];                                      // 0x0131(0x0003)
	int32                                         MaxNumRibbons;                                     // 0x0134(0x0004)
	ENiagaraRibbonDrawDirection                   DrawDirection;                                     // 0x0138(0x0001)
	ENiagaraRibbonShapeMode                       Shape;                                             // 0x0139(0x0001)
	uint8                                         bEnableAccurateGeometry : 1;                       // 0x013A(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bUseMaterialBackfaceCulling : 1;                   // 0x013A(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bUseGeometryNormals : 1;                           // 0x013A(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bUseGPUInit : 1;                                   // 0x013A(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bUseConstantFactor : 1;                            // 0x013A(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bScreenSpaceTessellation : 1;                      // 0x013A(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bLinkOrderUseUniqueID : 1;                         // 0x013A(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bCastShadows : 1;                                  // 0x013A(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
	uint8                                         Pad_13B[0x1];                                      // 0x013B(0x0001)
	int32                                         WidthSegmentationCount;                            // 0x013C(0x0004)
	int32                                         MultiPlaneCount;                                   // 0x0140(0x0004)
	int32                                         TubeSubdivisions;                                  // 0x0144(0x0004)
	TArray<struct FNiagaraRibbonShapeCustomVertex> CustomVertices;                                   // 0x0148(0x0010)
	ENiagaraRibbonTessellationMode                TessellationMode;                                  // 0x0158(0x0001)
	uint8                                         Pad_159[0x3];                                      // 0x0159(0x0003)
	float                                         CurveTension;                                      // 0x015C(0x0004)
	int32                                         TessellationFactor;                                // 0x0160(0x0004)
	float                                         TessellationAngle;                                 // 0x0164(0x0004)
	struct FNiagaraVariableAttributeBinding       PositionBinding;                                   // 0x0168(0x0038)
	struct FNiagaraVariableAttributeBinding       ColorBinding;                                      // 0x01A0(0x0038)
	struct FNiagaraVariableAttributeBinding       VelocityBinding;                                   // 0x01D8(0x0038)
	struct FNiagaraVariableAttributeBinding       NormalizedAgeBinding;                              // 0x0210(0x0038)
	struct FNiagaraVariableAttributeBinding       RibbonTwistBinding;                                // 0x0248(0x0038)
	struct FNiagaraVariableAttributeBinding       RibbonWidthBinding;                                // 0x0280(0x0038)
	struct FNiagaraVariableAttributeBinding       RibbonFacingBinding;                               // 0x02B8(0x0038)
	struct FNiagaraVariableAttributeBinding       RibbonIdBinding;                                   // 0x02F0(0x0038)
	struct FNiagaraVariableAttributeBinding       RibbonLinkOrderBinding;                            // 0x0328(0x0038)
	struct FNiagaraVariableAttributeBinding       MaterialRandomBinding;                             // 0x0360(0x0038)
	struct FNiagaraVariableAttributeBinding       DynamicMaterialBinding;                            // 0x0398(0x0038)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial1Binding;                           // 0x03D0(0x0038)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial2Binding;                           // 0x0408(0x0038)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial3Binding;                           // 0x0440(0x0038)
	struct FNiagaraVariableAttributeBinding       RibbonUVDistance;                                  // 0x0478(0x0038)
	struct FNiagaraVariableAttributeBinding       U0OverrideBinding;                                 // 0x04B0(0x0038)
	struct FNiagaraVariableAttributeBinding       V0RangeOverrideBinding;                            // 0x04E8(0x0038)
	struct FNiagaraVariableAttributeBinding       U1OverrideBinding;                                 // 0x0520(0x0038)
	struct FNiagaraVariableAttributeBinding       V1RangeOverrideBinding;                            // 0x0558(0x0038)
	struct FNiagaraRendererMaterialParameters     MaterialParameters;                                // 0x0590(0x0050)
	struct FNiagaraVariableAttributeBinding       PrevPositionBinding;                               // 0x05E0(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevRibbonWidthBinding;                            // 0x0618(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevRibbonFacingBinding;                           // 0x0650(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevRibbonTwistBinding;                            // 0x0688(0x0038)
	uint32                                        MaterialParamValidMask;                            // 0x06C0(0x0004)
	uint8                                         Pad_6C4[0x9C];                                     // 0x06C4(0x009C)
...
public:
	...
	struct FGuid                                  UsageId;                                           // 0x0034(0x0010)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)
	struct FNiagaraParameterStore                 RapidIterationParameters;                          // 0x0048(0x0088)
	struct FNiagaraScriptExecutionParameterStore  ScriptExecutionParamStore;                         // 0x00D0(0x0090)
	TArray<struct FNiagaraBoundParameter>         ScriptExecutionBoundParameters;                    // 0x0160(0x0010)
	struct FNiagaraVMExecutableDataId             CachedScriptVMId;                                  // 0x0170(0x0058)
	uint8                                         Pad_1C8[0x10];                                     // 0x01C8(0x0010)
	struct FNiagaraVMExecutableData               CachedScriptVM;                                    // 0x01D8(0x01A0)
	TArray<class UNiagaraParameterCollection*>    CachedParameterCollectionReferences;               // 0x0378(0x0010)
	TArray<struct FNiagaraScriptResolvedDataInterfaceInfo> ResolvedDataInterfaces;                   // 0x0388(0x0010)
	TArray<struct FNiagaraResolvedUserDataInterfaceBinding> ResolvedUserDataInterfaceBindings;       // 0x0398(0x0010)
	TArray<struct FNiagaraResolvedUObjectInfo>    ResolvedUObjectInfos;                              // 0x03A8(0x0010)
...
public:
	...
	TMulticastInlineDelegate<void(bool bSuccess)> CaptureComplete;                                   // 0x0040(0x0010)
	uint8                                         Pad_50[0xE0];                                      // 0x0050(0x00E0)
...
public:
	...
	class FName                                   SimulationStageName;                               // 0x0030(0x0008)
	uint8                                         bEnabled : 1;                                      // 0x0038(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
...
{
public:
	struct FNiagaraVariableAttributeBinding       EnabledBinding;                                    // 0x0040(0x0038)
	ENiagaraIterationSource                       IterationSource;                                   // 0x0078(0x0001)
	uint8                                         Pad_79[0x7];                                       // 0x0079(0x0007)
	struct FNiagaraParameterBindingWithValue      NumIterations;                                     // 0x0080(0x0020)
	ENiagaraSimStageExecuteBehavior               ExecuteBehavior;                                   // 0x00A0(0x0001)
	uint8                                         Pad_A1[0x3];                                       // 0x00A1(0x0003)
	uint8                                         bDisablePartialParticleUpdate : 1;                 // 0x00A4(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_A5[0x3];                                       // 0x00A5(0x0003)
	struct FNiagaraVariableDataInterfaceBinding   DataInterface;                                     // 0x00A8(0x0020)
	uint8                                         bParticleIterationStateEnabled : 1;                // 0x00C8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_C9[0x7];                                       // 0x00C9(0x0007)
	struct FNiagaraVariableAttributeBinding       ParticleIterationStateBinding;                     // 0x00D0(0x0038)
	struct FIntPoint                              ParticleIterationStateRange;                       // 0x0108(0x0008)
	uint8                                         bGpuDispatchForceLinear : 1;                       // 0x0110(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverrideGpuDispatchNumThreads : 1;                // 0x0110(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_111[0x7];                                      // 0x0111(0x0007)
	struct FNiagaraParameterBindingWithValue      OverrideGpuDispatchNumThreadsX;                    // 0x0118(0x0020)
	struct FNiagaraParameterBindingWithValue      OverrideGpuDispatchNumThreadsY;                    // 0x0138(0x0020)
	struct FNiagaraParameterBindingWithValue      OverrideGpuDispatchNumThreadsZ;                    // 0x0158(0x0020)
	...
	struct FNiagaraParameterBindingWithValue      ElementCountX;                                     // 0x0180(0x0020)
	struct FNiagaraParameterBindingWithValue      ElementCountY;                                     // 0x01A0(0x0020)
	struct FNiagaraParameterBindingWithValue      ElementCountZ;                                     // 0x01C0(0x0020)
...
public:
	...
	ENiagaraSpriteAlignment                       Alignment;                                         // 0x00E1(0x0001)
	ENiagaraSpriteFacingMode                      FacingMode;                                        // 0x00E2(0x0001)
	ENiagaraSortMode                              SortMode;                                          // 0x00E3(0x0001)
	float                                         MacroUVRadius;                                     // 0x00E4(0x0004)
	struct FVector2D                              PivotInUVSpace;                                    // 0x00E8(0x0010)
	struct FVector2D                              SubImageSize;                                      // 0x00F8(0x0010)
	uint8                                         bSubImageBlend : 1;                                // 0x0108(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bRemoveHMDRollInVR : 1;                            // 0x0108(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bSortOnlyWhenTranslucent : 1;                      // 0x0108(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bEnableCameraDistanceCulling : 1;                  // 0x0108(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bCastShadows : 1;                                  // 0x0108(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	ENiagaraRendererSortPrecision                 SortPrecision;                                     // 0x0109(0x0001)
	ENiagaraRendererGpuTranslucentLatency         GpuTranslucentLatency;                             // 0x010A(0x0001)
	ENiagaraRendererPixelCoverageMode             PixelCoverageMode;                                 // 0x010B(0x0001)
	float                                         PixelCoverageBlend;                                // 0x010C(0x0004)
	float                                         MinFacingCameraBlendDistance;                      // 0x0110(0x0004)
	float                                         MaxFacingCameraBlendDistance;                      // 0x0114(0x0004)
	float                                         MinCameraDistance;                                 // 0x0118(0x0004)
	float                                         MaxCameraDistance;                                 // 0x011C(0x0004)
	uint32                                        RendererVisibility;                                // 0x0120(0x0004)
	uint8                                         Pad_124[0x4];                                      // 0x0124(0x0004)
	struct FNiagaraVariableAttributeBinding       PositionBinding;                                   // 0x0128(0x0038)
	struct FNiagaraVariableAttributeBinding       ColorBinding;                                      // 0x0160(0x0038)
	struct FNiagaraVariableAttributeBinding       VelocityBinding;                                   // 0x0198(0x0038)
	struct FNiagaraVariableAttributeBinding       SpriteRotationBinding;                             // 0x01D0(0x0038)
	struct FNiagaraVariableAttributeBinding       SpriteSizeBinding;                                 // 0x0208(0x0038)
	struct FNiagaraVariableAttributeBinding       SpriteFacingBinding;                               // 0x0240(0x0038)
	struct FNiagaraVariableAttributeBinding       SpriteAlignmentBinding;                            // 0x0278(0x0038)
	struct FNiagaraVariableAttributeBinding       SubImageIndexBinding;                              // 0x02B0(0x0038)
	struct FNiagaraVariableAttributeBinding       DynamicMaterialBinding;                            // 0x02E8(0x0038)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial1Binding;                           // 0x0320(0x0038)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial2Binding;                           // 0x0358(0x0038)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial3Binding;                           // 0x0390(0x0038)
	struct FNiagaraVariableAttributeBinding       CameraOffsetBinding;                               // 0x03C8(0x0038)
	struct FNiagaraVariableAttributeBinding       UVScaleBinding;                                    // 0x0400(0x0038)
	struct FNiagaraVariableAttributeBinding       PivotOffsetBinding;                                // 0x0438(0x0038)
	struct FNiagaraVariableAttributeBinding       MaterialRandomBinding;                             // 0x0470(0x0038)
	struct FNiagaraVariableAttributeBinding       CustomSortingBinding;                              // 0x04A8(0x0038)
	struct FNiagaraVariableAttributeBinding       NormalizedAgeBinding;                              // 0x04E0(0x0038)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x0518(0x0038)
	struct FNiagaraRendererMaterialParameters     MaterialParameters;                                // 0x0550(0x0050)
	struct FNiagaraVariableAttributeBinding       PrevPositionBinding;                               // 0x05A0(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevVelocityBinding;                               // 0x05D8(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevSpriteRotationBinding;                         // 0x0610(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevSpriteSizeBinding;                             // 0x0648(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevSpriteFacingBinding;                           // 0x0680(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevSpriteAlignmentBinding;                        // 0x06B8(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevCameraOffsetBinding;                           // 0x06F0(0x0038)
	struct FNiagaraVariableAttributeBinding       PrevPivotOffsetBinding;                            // 0x0728(0x0038)
	uint32                                        MaterialParamValidMask;                            // 0x0760(0x0004)
	uint8                                         Pad_764[0x64];                                     // 0x0764(0x0064)
...
{
public:
	uint8                                         bSupportLargeWorldCoordinates : 1;                 // 0x0050(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverrideCastShadow : 1;                           // 0x0050(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverrideReceivesDecals : 1;                       // 0x0050(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverrideRenderCustomDepth : 1;                    // 0x0050(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bOverrideCustomDepthStencilValue : 1;              // 0x0050(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bOverrideCustomDepthStencilWriteMask : 1;          // 0x0050(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bOverrideTranslucencySortPriority : 1;             // 0x0050(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bOverrideTranslucencySortDistanceOffset : 1;       // 0x0050(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
	uint8                                         bCastShadow : 1;                                   // 0x0051(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bReceivesDecals : 1;                               // 0x0051(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bRenderCustomDepth : 1;                            // 0x0051(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bDisableExperimentalVM : 1;                        // 0x0051(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bInitialOwnerVelocityFromActor : 1;                // 0x0051(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	ERendererStencilMask                          CustomDepthStencilWriteMask;                       // 0x0052(0x0001)
	uint8                                         Pad_53[0x1];                                       // 0x0053(0x0001)
	int32                                         CustomDepthStencilValue;                           // 0x0054(0x0004)
	int32                                         TranslucencySortPriority;                          // 0x0058(0x0004)
	float                                         TranslucencySortDistanceOffset;                    // 0x005C(0x0004)
	uint8                                         bDumpDebugSystemInfo : 1;                          // 0x0060(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bDumpDebugEmitterInfo : 1;                         // 0x0060(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         BitPad_60_2 : 1;                                   // 0x0060(0x0001)
	uint8                                         bRequireCurrentFrameData : 1;                      // 0x0060(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bOverrideScalabilitySettings : 1;                  // 0x0060(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         BitPad_60_5 : 3;                                   // 0x0060(0x0001)
	uint8                                         Pad_61[0x3];                                       // 0x0061(0x0003)
	uint8                                         bFixedBounds : 1;                                  // 0x0064(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_65[0x3];                                       // 0x0065(0x0003)
	class UNiagaraEffectType*                     EffectType;                                        // 0x0068(0x0008)
	uint8                                         bOverrideAllowCullingForLocalPlayers : 1;          // 0x0070(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bAllowCullingForLocalPlayersOverride : 1;          // 0x0070(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_71[0x7];                                       // 0x0071(0x0007)
	struct FNiagaraSystemScalabilityOverrides     SystemScalabilityOverrides;                        // 0x0078(0x0010)
	struct FNiagaraPlatformSet                    Platforms;                                         // 0x0088(0x0030)
	TArray<struct FNiagaraEmitterHandle>          EmitterHandles;                                    // 0x00B8(0x0010)
	...
	struct FNiagaraSystemCompiledData             SystemCompiledData;                                // 0x00F8(0x0240)
	struct FNiagaraUserRedirectionParameterStore  ExposedParameters;                                 // 0x0338(0x00D8)
	struct FBox                                   FixedBounds;                                       // 0x0410(0x0038)
	bool                                          bNeedsGPUContextInitForDataInterfaces;             // 0x0448(0x0001)
	bool                                          bDeterminism;                                      // 0x0449(0x0001)
	bool                                          bFixedTickDelta;                                   // 0x044A(0x0001)
	uint8                                         Pad_44B[0x1];                                      // 0x044B(0x0001)
	int32                                         RandomSeed;                                        // 0x044C(0x0004)
	float                                         WarmupTime;                                        // 0x0450(0x0004)
	int32                                         WarmupTickCount;                                   // 0x0454(0x0004)
	float                                         WarmupTickDelta;                                   // 0x0458(0x0004)
	float                                         FixedTickDeltaTime;                                // 0x045C(0x0004)
	uint8                                         Pad_460[0x98];                                     // 0x0460(0x0098)
	uint8                                         BitPad_4F8_0 : 6;                                  // 0x04F8(0x0001)
	uint8                                         bAllowSystemStateFastPath : 1;                     // 0x04F8(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bSystemStateFastPathEnabled : 1;                   // 0x04F8(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
	uint8                                         Pad_4F9[0xF];                                      // 0x04F9(0x000F)
	struct FNiagaraSystemStateData                SystemStateData;                                   // 0x0508(0x0050)
...
public:
	...
	int32                                         RendererVisibility;                                // 0x00D0(0x0004)
	float                                         StepFactor;                                        // 0x00D4(0x0004)
	float                                         LightingDownsampleFactor;                          // 0x00D8(0x0004)
	float                                         ShadowStepFactor;                                  // 0x00DC(0x0004)
	float                                         ShadowBiasFactor;                                  // 0x00E0(0x0004)
	uint8                                         Pad_E4[0xAC];                                      // 0x00E4(0x00AC)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x0190(0x0038)
	struct FNiagaraVariableAttributeBinding       VolumeResolutionMaxAxisBinding;                    // 0x01C8(0x0038)
	struct FNiagaraVariableAttributeBinding       VolumeWorldSpaceSizeBinding;                       // 0x0200(0x0038)
	struct FNiagaraRendererMaterialParameters     MaterialParameters;                                // 0x0238(0x0050)
	uint8                                         Pad_288[0x28];                                     // 0x0288(0x0028)
...
{
public:
	class FString                                 FilePath;                                          // 0x0028(0x0010)
	EVolumeCacheType                              CacheType;                                         // 0x0038(0x0001)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)
	struct FIntVector                             Resolution;                                        // 0x003C(0x000C)
	int32                                         FrameRangeStart;                                   // 0x0048(0x0004)
	int32                                         FrameRangeEnd;                                     // 0x004C(0x0004)
