...
public:
	...
	class FText                                   ConsoleHint;                                       // 0x0008(0x0010)
};
...
{
public:
	uint16                                        First;                                             // 0x0000(0x0002)
	uint16                                        Last;                                              // 0x0002(0x0002)
};
...
public:
	...
	uint8                                         bShift : 1;                                        // 0x0018(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bCtrl : 1;                                         // 0x0018(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bAlt : 1;                                          // 0x0018(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bCmd : 1;                                          // 0x0018(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
...
{
public:
	struct FVector2D                              Minimum;                                           // 0x0000(0x0010)
	struct FVector2D                              Maximum;                                           // 0x0010(0x0010)
};
...
{
public:
	TArray<struct FCharRange>                     Ranges;                                            // 0x0000(0x0010)
};
...
{
public:
	EInputPreProcessorType                        Type;                                              // 0x0000(0x0001)
...
{
public:
	TArray<class FName>                           Names;                                             // 0x0000(0x0010)
};
...
public:
	...
	TMap<class FName, struct FCustomizedToolMenuEntry> Entries;                                      // 0x0008(0x0050)
	TMap<class FName, struct FCustomizedToolMenuSection> Sections;                                   // 0x0058(0x0050)
	TArray<class FName>                           SuppressExtenders;                                 // 0x00A8(0x0010)
	uint8                                         Pad_B8[0xE8];                                      // 0x00B8(0x00E8)
};
...
{
public:
	TMap<class FName, struct FCustomizedToolMenuNameArray> EntryOrder;                               // 0x01A0(0x0050)
	TArray<class FName>                           SectionOrder;                                      // 0x01F0(0x0010)
};
