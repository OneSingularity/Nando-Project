...
#include "DinoAttackState_Spindles_MinigunAOE_classes.hpp"
#include "DinoAttackState_Spindles_MinigunAOE_parameters.hpp"
...
void UDinoAttackState_Spindles_MinigunAOE_C::OnEndEvent()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("DinoAttackState_Spindles_MinigunAOE_C", "OnEndEvent");
...
void UDinoAttackState_Spindles_MinigunAOE_C::OnBeginEvent(class UPrimalAIState* InParentState)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("DinoAttackState_Spindles_MinigunAOE_C", "OnBeginEvent");

	Params::DinoAttackState_Spindles_MinigunAOE_C_OnBeginEvent Parms{};
...
void UDinoAttackState_Spindles_MinigunAOE_C::IsDebugMode(bool* Ret)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("DinoAttackState_Spindles_MinigunAOE_C", "IsDebugMode");

	Params::DinoAttackState_Spindles_MinigunAOE_C_IsDebugMode Parms{};
...
void UDinoAttackState_Spindles_MinigunAOE_C::GetDamageForSpine(class APrimalCharacter* Target, double* Damage)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DinoAttackState_Spindles_MinigunAOE_C", "GetDamageForSpine");

	Params::DinoAttackState_Spindles_MinigunAOE_C_GetDamageForSpine Parms{};
...
void UDinoAttackState_Spindles_MinigunAOE_C::Get_Spine_Start_and_End_Position(struct FVector* Start, struct FVector* End, struct FVector* VFXStart, struct FVector* VFXEnd)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("DinoAttackState_Spindles_MinigunAOE_C", "Get Spine Start and End Position");

	Params::DinoAttackState_Spindles_MinigunAOE_C_Get_Spine_Start_and_End_Position Parms{};
...
void UDinoAttackState_Spindles_MinigunAOE_C::FireRandomSpines()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("DinoAttackState_Spindles_MinigunAOE_C", "FireRandomSpines");
...
void UDinoAttackState_Spindles_MinigunAOE_C::FireGuaranteedSpines()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("DinoAttackState_Spindles_MinigunAOE_C", "FireGuaranteedSpines");
...
void UDinoAttackState_Spindles_MinigunAOE_C::FireGuaranteedHitSpine()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("DinoAttackState_Spindles_MinigunAOE_C", "FireGuaranteedHitSpine");
...
void UDinoAttackState_Spindles_MinigunAOE_C::ExecuteUbergraph_DinoAttackState_Spindles_MinigunAOE(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DinoAttackState_Spindles_MinigunAOE_C", "ExecuteUbergraph_DinoAttackState_Spindles_MinigunAOE");

	Params::DinoAttackState_Spindles_MinigunAOE_C_ExecuteUbergraph_DinoAttackState_Spindles_MinigunAOE Parms{};
...
bool UDinoAttackState_Spindles_MinigunAOE_C::BPShouldEndAttack()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("DinoAttackState_Spindles_MinigunAOE_C", "BPShouldEndAttack");

	Params::DinoAttackState_Spindles_MinigunAOE_C_BPShouldEndAttack Parms{};
...
bool UDinoAttackState_Spindles_MinigunAOE_C::BPCanAttack(float Distance, float AttackRangeOffset, class AActor* OtherTarget)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("DinoAttackState_Spindles_MinigunAOE_C", "BPCanAttack");

	Params::DinoAttackState_Spindles_MinigunAOE_C_BPCanAttack Parms{};
