...
{
public:
	struct FStateTreeReference                    StateTreeRef;                                      // 0x0070(0x0028)
	struct FStateTreeInstanceData                 InstanceData;                                      // 0x0098(0x0010)
	struct FGameplayTag                           InjectionTag;                                      // 0x00A8(0x0008)
...
public:
	...
	struct FStateTreeReference                    StateTreeRef;                                      // 0x0078(0x0028)
	struct FStateTreeInstanceData                 InstanceData;                                      // 0x00A0(0x0010)
	float                                         Interval;                                          // 0x00B0(0x0004)
	float                                         RandomDeviation;                                   // 0x00B4(0x0004)
...
{
public:
	uint8                                         Pad_128[0x10];                                     // 0x0128(0x0010)
	TMulticastInlineDelegate<void(EStateTreeRunStatus StateTreeRunStatus)> OnStateTreeRunStatusChanged; // 0x0138(0x0010)
	struct FStateTreeReference                    StateTreeRef;                                      // 0x0148(0x0028)
	struct FStateTreeReferenceOverrides           LinkedStateTreeOverrides;                          // 0x0170(0x0010)
	bool                                          bStartLogicAutomatically;                          // 0x0180(0x0001)
	uint8                                         Pad_181[0x7];                                      // 0x0181(0x0007)
	struct FStateTreeInstanceData                 InstanceData;                                      // 0x0188(0x0010)
...
{
public:
	TSubclassOf<class AActor>                     ContextActorClass;                                 // 0x0028(0x0008)
	struct FStateTreeExternalDataDesc             ContextActorDataDesc;                              // 0x0030(0x0018)
	TArray<struct FStateTreeExternalDataDesc>     ContextDataDescs;                                  // 0x0048(0x0010)
...
{
public:
	TSubclassOf<class AAIController>              AIControllerClass;                                 // 0x0058(0x0008)
