...
public:
	...
	bool                                          bUseCustomRange;                                   // 0x0010(0x0001)
...
{
public:
	float                                         Frame;                                             // 0x0000(0x0004)
	float                                         PrevFrame;                                         // 0x0004(0x0004)
};
...
public:
	...
	float                                         StartFrame;                                        // 0x0008(0x0004)
	float                                         EndFrame;                                          // 0x000C(0x0004)
};
