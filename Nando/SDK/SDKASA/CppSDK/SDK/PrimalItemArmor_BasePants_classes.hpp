...
{
public:
	class USoundBase*                             SoundOverrideProneStart;                           // 0x0B90(0x0008)
	class USoundBase*                             SoundOverrideProneEnd;                             // 0x0B98(0x0008)
	class USoundBase*                             SoundOverrideProneStep;                            // 0x0BA0(0x0008)
	class USoundBase*                             SoundOverrideCrouchStart;                          // 0x0BA8(0x0008)
	class USoundBase*                             SoundOverrideCrouchEnd;                            // 0x0BB0(0x0008)
