...
{
public:
	struct FGeometryScriptSimpleCollision         SimpleCollision;                                   // 0x0000(0x0080)
	struct FGeometryScriptConvexHullApproximationOptions ApproximateOptions;                         // 0x0080(0x000C)
	bool                                          bHasApproximated;                                  // 0x008C(0x0001)
	uint8                                         Pad_8D[0x3];                                       // 0x008D(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0090(0x0008)
};
...
{
public:
	struct FGeometryScriptSimpleCollision         CollisionToUpdate;                                 // 0x0000(0x0080)
	struct FGeometryScriptSimpleCollision         AppendCollision;                                   // 0x0080(0x0080)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0100(0x0008)
};
...
{
public:
	TArray<struct FGeometryScriptSimpleCollision> SimpleCollisionArray;                              // 0x0000(0x0010)
	struct FGeometryScriptSimpleCollision         SimpleCollision;                                   // 0x0010(0x0080)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0090(0x0008)
};
...
{
public:
	const class UDynamicMesh*                     TargetMesh;                                        // 0x0000(0x0008)
	struct FNavigableConvexDecompositionOptions   Options;                                           // 0x0008(0x0038)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0040(0x0008)
	struct FGeometryScriptSimpleCollision         ReturnValue;                                       // 0x0048(0x0080)
};
...
{
public:
	struct FGeometryScriptDynamicMeshBVH          MeshBVH;                                           // 0x0000(0x0020)
	struct FComputeNegativeSpaceOptions           NegativeSpaceOptions;                              // 0x0020(0x0028)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0048(0x0008)
	struct FGeometryScriptSphereCovering          ReturnValue;                                       // 0x0050(0x0010)
};
...
{
public:
	struct FGeometryScriptSphereCovering          SphereCovering;                                    // 0x0000(0x0010)
	TArray<struct FSphere>                        ReturnValue;                                       // 0x0010(0x0010)
};
...
{
public:
	TArray<struct FSphere>                        Spheres;                                           // 0x0000(0x0010)
	struct FGeometryScriptSphereCovering          ReturnValue;                                       // 0x0010(0x0010)
};
...
{
public:
	class UDynamicMesh*                           FromDynamicMesh;                                   // 0x0000(0x0008)
	struct FGeometryScriptCollisionFromMeshOptions Options;                                          // 0x0008(0x0030)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0038(0x0008)
	struct FGeometryScriptSimpleCollision         ReturnValue;                                       // 0x0040(0x0080)
};
...
public:
	...
	class UGeometryScriptDebug*                   Debug;                                             // 0x0008(0x0008)
	struct FGeometryScriptSimpleCollision         ReturnValue;                                       // 0x0010(0x0080)
};
...
public:
	struct FGeometryScriptSimpleCollision         SimpleCollision;                                   // 0x0000(0x0080)
	int32                                         ReturnValue;                                       // 0x0080(0x0004)
...
public:
	struct FGeometryScriptSimpleCollision         SimpleCollision;                                   // 0x0000(0x0080)
	struct FGeometryScriptMergeSimpleCollisionOptions MergeOptions;                                  // 0x0080(0x0070)
	bool                                          bHasMerged;                                        // 0x00F0(0x0001)
	uint8                                         Pad_F1[0x7];                                       // 0x00F1(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00F8(0x0008)
	struct FGeometryScriptSimpleCollision         ReturnValue;                                       // 0x0100(0x0080)
};
...
{
public:
	class UDynamicMeshComponent*                  Component;                                         // 0x0000(0x0008)
	bool                                          bEmitTransaction;                                  // 0x0008(0x0001)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0010(0x0008)
};
...
public:
	class UDynamicMesh*                           FromDynamicMesh;                                   // 0x0000(0x0008)
	class UDynamicMeshComponent*                  ToDynamicMeshComponent;                            // 0x0008(0x0008)
	struct FGeometryScriptCollisionFromMeshOptions Options;                                          // 0x0010(0x0030)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0040(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0048(0x0008)
};
...
public:
	struct FGeometryScriptSimpleCollision         SimpleCollision;                                   // 0x0000(0x0080)
	class UDynamicMeshComponent*                  DynamicMeshComponent;                              // 0x0080(0x0008)
	struct FGeometryScriptSetSimpleCollisionOptions Options;                                         // 0x0088(0x0001)
...
public:
	struct FGeometryScriptSimpleCollision         SimpleCollision;                                   // 0x0000(0x0080)
	class UStaticMesh*                            StaticMesh;                                        // 0x0080(0x0008)
	struct FGeometryScriptSetSimpleCollisionOptions Options;                                         // 0x0088(0x0001)
	struct FGeometryScriptSetStaticMeshCollisionOptions StaticMeshCollisionOptions;                  // 0x0089(0x0001)
...
{
public:
	class UStaticMesh*                            StaticMeshAsset;                                   // 0x0000(0x0008)
	class UPrimitiveComponent*                    SourceComponent;                                   // 0x0008(0x0008)
	struct FGeometryScriptSetSimpleCollisionOptions Options;                                         // 0x0010(0x0001)
	struct FGeometryScriptSetStaticMeshCollisionOptions StaticMeshCollisionOptions;                  // 0x0011(0x0001)
	uint8                                         Pad_12[0x6];                                       // 0x0012(0x0006)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
};
...
public:
	class UDynamicMesh*                           FromDynamicMesh;                                   // 0x0000(0x0008)
	class UStaticMesh*                            ToStaticMeshAsset;                                 // 0x0008(0x0008)
	struct FGeometryScriptCollisionFromMeshOptions Options;                                          // 0x0010(0x0030)
	struct FGeometryScriptSetStaticMeshCollisionOptions StaticMeshCollisionOptions;                  // 0x0040(0x0001)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0048(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0050(0x0008)
};
...
public:
	class UStaticMesh*                            StaticMeshAsset;                                   // 0x0000(0x0008)
	class UStaticMesh*                            StaticMeshCollisionAsset;                          // 0x0008(0x0008)
	bool                                          bEmitTransaction;                                  // 0x0010(0x0001)
	bool                                          bMarkCollisionAsCustomized;                        // 0x0011(0x0001)
	uint8                                         Pad_12[0x6];                                       // 0x0012(0x0006)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
...
public:
	struct FGeometryScriptSimpleCollision         SimpleCollision;                                   // 0x0000(0x0080)
	struct FGeometryScriptConvexHullSimplificationOptions SimplifyOptions;                           // 0x0080(0x0010)
	bool                                          bHasSimplified;                                    // 0x0090(0x0001)
	uint8                                         Pad_91[0x7];                                       // 0x0091(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0098(0x0008)
};
...
public:
	struct FGeometryScriptSimpleCollision         SimpleCollision;                                   // 0x0000(0x0080)
	struct FTransform                             Transform;                                         // 0x0080(0x0060)
	struct FGeometryScriptTransformCollisionOptions TransformOptions;                                // 0x00E0(0x0002)
	bool                                          bSuccess;                                          // 0x00E2(0x0001)
	uint8                                         Pad_E3[0x5];                                       // 0x00E3(0x0005)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00E8(0x0008)
	struct FGeometryScriptSimpleCollision         ReturnValue;                                       // 0x00F0(0x0080)
};
...
{
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	class UDynamicMesh*                           CopyToMesh;                                        // 0x0008(0x0008)
	class UDynamicMesh*                           CopyToMeshOut;                                     // 0x0010(0x0008)
	struct FGeometryScriptConvexDecompositionOptions Options;                                        // 0x0018(0x0028)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0040(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0048(0x0008)
};
...
public:
	...
	class UDynamicMesh*                           CopyToMesh;                                        // 0x0008(0x0008)
	class UDynamicMesh*                           CopyToMeshOut;                                     // 0x0010(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0018(0x0010)
	struct FGeometryScriptConvexHullOptions       Options;                                           // 0x0028(0x000C)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0038(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0040(0x0008)
};
...
public:
	...
	struct FTransform                             ProjectionFrame;                                   // 0x0020(0x0060)
	struct FGeometryScriptSweptHullOptions        Options;                                           // 0x0080(0x0018)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0098(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00A0(0x0008)
...
{
public:
	struct FGeometryScriptColorList               ColorList;                                         // 0x0000(0x0010)
	struct FLinearColor                           ClearColor;                                        // 0x0010(0x0010)
};
...
{
public:
	struct FGeometryScriptIndexList               IndexList;                                         // 0x0000(0x0018)
	int32                                         ClearValue;                                        // 0x0018(0x0004)
...
{
public:
	struct FGeometryScriptScalarList              ScalarList;                                        // 0x0000(0x0010)
	double                                        ClearValue;                                        // 0x0010(0x0008)
};
...
{
public:
	struct FGeometryScriptUVList                  UVList;                                            // 0x0000(0x0010)
	struct FVector2D                              ClearUV;                                           // 0x0010(0x0010)
};
...
{
public:
	struct FGeometryScriptVectorList              VectorList;                                        // 0x0000(0x0010)
	struct FVector                                ClearValue;                                        // 0x0010(0x0018)
};
...
{
public:
	TArray<struct FLinearColor>                   ColorArray;                                        // 0x0000(0x0010)
	struct FGeometryScriptColorList               ColorList;                                         // 0x0010(0x0010)
};
...
{
public:
	TArray<int32>                                 IndexArray;                                        // 0x0000(0x0010)
	struct FGeometryScriptIndexList               IndexList;                                         // 0x0010(0x0018)
	EGeometryScriptIndexType                      IndexType;                                         // 0x0028(0x0001)
...
{
public:
	TArray<double>                                VectorArray;                                       // 0x0000(0x0010)
	struct FGeometryScriptScalarList              ScalarList;                                        // 0x0010(0x0010)
};
...
{
public:
	TArray<struct FIntVector>                     TriangleArray;                                     // 0x0000(0x0010)
	struct FGeometryScriptTriangleList            TriangleList;                                      // 0x0010(0x0010)
};
...
{
public:
	TArray<struct FVector2D>                      UVArray;                                           // 0x0000(0x0010)
	struct FGeometryScriptUVList                  UVList;                                            // 0x0010(0x0010)
};
...
{
public:
	TArray<struct FVector>                        VectorArray;                                       // 0x0000(0x0010)
	struct FGeometryScriptVectorList              VectorList;                                        // 0x0010(0x0010)
};
...
public:
	struct FGeometryScriptColorList               ColorList;                                         // 0x0000(0x0010)
	TArray<struct FLinearColor>                   ColorArray;                                        // 0x0010(0x0010)
};
...
public:
	struct FGeometryScriptIndexList               IndexList;                                         // 0x0000(0x0018)
	TArray<int32>                                 IndexArray;                                        // 0x0018(0x0010)
};
...
public:
	struct FGeometryScriptScalarList              ScalarList;                                        // 0x0000(0x0010)
	TArray<double>                                ScalarArray;                                       // 0x0010(0x0010)
};
...
{
public:
	struct FGeometryScriptTriangleList            TriangleList;                                      // 0x0000(0x0010)
	TArray<struct FIntVector>                     TriangleArray;                                     // 0x0010(0x0010)
};
...
public:
	struct FGeometryScriptUVList                  UVList;                                            // 0x0000(0x0010)
	TArray<struct FVector2D>                      UVArray;                                           // 0x0010(0x0010)
};
...
public:
	struct FGeometryScriptVectorList              VectorList;                                        // 0x0000(0x0010)
	TArray<struct FVector>                        VectorArray;                                       // 0x0010(0x0010)
};
...
public:
	struct FGeometryScriptColorList               ColorList;                                         // 0x0000(0x0010)
	struct FGeometryScriptColorList               DuplicateList;                                     // 0x0010(0x0010)
};
...
public:
	struct FGeometryScriptIndexList               IndexList;                                         // 0x0000(0x0018)
	struct FGeometryScriptIndexList               DuplicateList;                                     // 0x0018(0x0018)
};
...
public:
	struct FGeometryScriptScalarList              ScalarList;                                        // 0x0000(0x0010)
	struct FGeometryScriptScalarList              DuplicateList;                                     // 0x0010(0x0010)
};
...
public:
	struct FGeometryScriptUVList                  UVList;                                            // 0x0000(0x0010)
	struct FGeometryScriptUVList                  DuplicateList;                                     // 0x0010(0x0010)
};
...
public:
	struct FGeometryScriptVectorList              VectorList;                                        // 0x0000(0x0010)
	struct FGeometryScriptVectorList              DuplicateList;                                     // 0x0010(0x0010)
};
...
public:
	struct FGeometryScriptColorList               ColorList;                                         // 0x0000(0x0010)
	struct FGeometryScriptScalarList              ScalarList;                                        // 0x0010(0x0010)
	int32                                         ChannelIndex;                                      // 0x0020(0x0004)
...
public:
	struct FGeometryScriptColorList               ColorList;                                         // 0x0000(0x0010)
	struct FGeometryScriptVectorList              VectorList;                                        // 0x0010(0x0010)
	int32                                         XChannelIndex;                                     // 0x0020(0x0004)
	int32                                         YChannelIndex;                                     // 0x0024(0x0004)
	int32                                         ZChannelIndex;                                     // 0x0028(0x0004)
...
public:
	...
	bool                                          bIsValidIndex;                                     // 0x0014(0x0001)
	uint8                                         Pad_15[0x3];                                       // 0x0015(0x0003)
	struct FLinearColor                           ReturnValue;                                       // 0x0018(0x0010)
};
...
public:
	...
	bool                                          bIsValidIndex;                                     // 0x001C(0x0001)
...
public:
	struct FGeometryScriptTriangleList            TriangleList;                                      // 0x0000(0x0010)
	int32                                         Triangle;                                          // 0x0010(0x0004)
	bool                                          bIsValidTriangle;                                  // 0x0014(0x0001)
	uint8                                         Pad_15[0x3];                                       // 0x0015(0x0003)
	struct FIntVector                             ReturnValue;                                       // 0x0018(0x000C)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
};
...
public:
	struct FGeometryScriptColorList               ColorList;                                         // 0x0000(0x0010)
	int32                                         Index_0;                                           // 0x0010(0x0004)
	struct FLinearColor                           NewColor;                                          // 0x0014(0x0010)
	bool                                          bIsValidIndex;                                     // 0x0024(0x0001)
...
public:
	struct FGeometryScriptIndexList               IndexList;                                         // 0x0000(0x0018)
	int32                                         Index_0;                                           // 0x0018(0x0004)
	int32                                         NewValue;                                          // 0x001C(0x0004)
	bool                                          bIsValidIndex;                                     // 0x0020(0x0001)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)
};
...
public:
	...
	int32                                         Index_0;                                           // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	struct FVector2D                              NewUV;                                             // 0x0018(0x0010)
	bool                                          bIsValidIndex;                                     // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
};
...
public:
	...
	int32                                         Index_0;                                           // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	struct FVector                                NewValue;                                          // 0x0018(0x0018)
	bool                                          bIsValidIndex;                                     // 0x0030(0x0001)
...
public:
	class UStaticMesh*                            StaticMeshAsset;                                   // 0x0000(0x0008)
	struct FGeometryScriptMeshReadLOD             RequestedLOD;                                      // 0x0008(0x0008)
	EGeometryScriptSearchOutcomePins              Outcome;                                           // 0x0010(0x0001)
...
{
public:
	TArray<class UMaterialInterface*>             MaterialList;                                      // 0x0000(0x0010)
	TArray<class FName>                           MaterialSlotNames;                                 // 0x0010(0x0010)
	TMap<class FName, class UMaterialInterface*>  ReturnValue;                                       // 0x0020(0x0050)
};
...
{
public:
	TMap<class FName, class UMaterialInterface*>  MaterialMap;                                       // 0x0000(0x0050)
	TArray<class UMaterialInterface*>             MaterialList;                                      // 0x0050(0x0010)
	TArray<class FName>                           MaterialSlotNames;                                 // 0x0060(0x0010)
};
...
{
public:
	class USkeletalMesh*                          FromSkeletalMeshAsset;                             // 0x0000(0x0008)
	class UDynamicMesh*                           ToDynamicMesh;                                     // 0x0008(0x0008)
	struct FGeometryScriptCopyMeshFromAssetOptions AssetOptions;                                     // 0x0010(0x0004)
	struct FGeometryScriptMeshReadLOD             RequestedLOD;                                      // 0x0014(0x0008)
	EGeometryScriptOutcomePins                    Outcome;                                           // 0x001C(0x0001)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0020(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
{
public:
	class UStaticMesh*                            FromStaticMeshAsset;                               // 0x0000(0x0008)
	class UDynamicMesh*                           ToDynamicMesh;                                     // 0x0008(0x0008)
	struct FGeometryScriptCopyMeshFromAssetOptions AssetOptions;                                     // 0x0010(0x0004)
	struct FGeometryScriptMeshReadLOD             RequestedLOD;                                      // 0x0014(0x0008)
	EGeometryScriptOutcomePins                    Outcome;                                           // 0x001C(0x0001)
...
public:
	...
	struct FGeometryScriptMeshReadLOD             RequestedLOD;                                      // 0x0014(0x0008)
	EGeometryScriptOutcomePins                    Outcome;                                           // 0x001C(0x0001)
	bool                                          bUseSectionMaterials;                              // 0x001D(0x0001)
...
public:
	class UDynamicMesh*                           FromDynamicMesh;                                   // 0x0000(0x0008)
	class USkeletalMesh*                          ToSkeletalMeshAsset;                               // 0x0008(0x0008)
	struct FGeometryScriptCopyMeshToAssetOptions  Options;                                           // 0x0010(0x0080)
	struct FGeometryScriptMeshWriteLOD            TargetLod;                                         // 0x0090(0x0008)
	EGeometryScriptOutcomePins                    Outcome;                                           // 0x0098(0x0001)
	uint8                                         Pad_99[0x7];                                       // 0x0099(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00A0(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00A8(0x0008)
};
...
public:
	...
	struct FGeometryScriptMeshWriteLOD            TargetLod;                                         // 0x0090(0x0008)
	EGeometryScriptOutcomePins                    Outcome;                                           // 0x0098(0x0001)
	bool                                          bUseSectionMaterials;                              // 0x0099(0x0001)
...
{
public:
	class UDynamicMesh*                           FromMorphTarget;                                   // 0x0000(0x0008)
	class USkeletalMesh*                          ToSkeletalMeshAsset;                               // 0x0008(0x0008)
	class FName                                   MorphTargetName;                                   // 0x0010(0x0008)
	struct FGeometryScriptCopyMorphTargetToAssetOptions Options;                                     // 0x0018(0x0003)
	uint8                                         Pad_1B[0x1];                                       // 0x001B(0x0001)
	struct FGeometryScriptMeshWriteLOD            TargetLod;                                         // 0x001C(0x0008)
	EGeometryScriptOutcomePins                    Outcome;                                           // 0x0024(0x0001)
	uint8                                         Pad_25[0x3];                                       // 0x0025(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           FromDynamicMesh;                                   // 0x0000(0x0008)
	class USkeletalMesh*                          ToSkeletalMeshAsset;                               // 0x0008(0x0008)
	class FName                                   TargetProfileName;                                 // 0x0010(0x0008)
	class FName                                   SourceProfileName;                                 // 0x0018(0x0008)
	struct FGeometryScriptCopySkinWeightProfileToAssetOptions Options;                               // 0x0020(0x0003)
	uint8                                         Pad_23[0x1];                                       // 0x0023(0x0001)
	struct FGeometryScriptMeshWriteLOD            TargetLod;                                         // 0x0024(0x0008)
	EGeometryScriptOutcomePins                    Outcome;                                           // 0x002C(0x0001)
	uint8                                         Pad_2D[0x3];                                       // 0x002D(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class USkeletalMesh*                          FromSkeletalMeshAsset;                             // 0x0000(0x0008)
	struct FGeometryScriptMeshReadLOD             RequestedLOD;                                      // 0x0008(0x0008)
	TArray<class UMaterialInterface*>             MaterialList;                                      // 0x0010(0x0010)
	TArray<int32>                                 MaterialIndex;                                     // 0x0020(0x0010)
	TArray<class FName>                           MaterialSlotNames;                                 // 0x0030(0x0010)
	EGeometryScriptOutcomePins                    Outcome;                                           // 0x0040(0x0001)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0048(0x0008)
};
...
{
public:
	const class USkeletalMesh*                    FromSkeletalMeshAsset;                             // 0x0000(0x0008)
	TArray<class UMaterialInterface*>             MaterialList;                                      // 0x0008(0x0010)
	TArray<class FName>                           MaterialSlotNames;                                 // 0x0018(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
};
...
{
public:
	const class UStaticMesh*                      FromStaticMeshAsset;                               // 0x0000(0x0008)
	TArray<class UMaterialInterface*>             MaterialList;                                      // 0x0008(0x0010)
	TArray<class FName>                           MaterialSlotNames;                                 // 0x0018(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
};
...
public:
	class UStaticMesh*                            StaticMeshAsset;                                   // 0x0000(0x0008)
	EGeometryScriptLODType                        LODType;                                           // 0x0008(0x0001)
...
public:
	...
	struct FGeometryScriptBakeTargetMeshOptions   TargetOptions;                                     // 0x0070(0x0004)
	uint8                                         Pad_74[0x4];                                       // 0x0074(0x0004)
	class UDynamicMesh*                           SourceMesh;                                        // 0x0078(0x0008)
	struct FTransform                             SourceTransform;                                   // 0x0080(0x0060)
	struct FGeometryScriptBakeSourceMeshOptions   SourceOptions;                                     // 0x00E0(0x0010)
	TArray<struct FGeometryScriptBakeTypeOptions> BakeTypes;                                         // 0x00F0(0x0010)
	struct FGeometryScriptBakeTextureOptions      BakeOptions;                                       // 0x0100(0x0020)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0120(0x0008)
	TArray<class UTexture2D*>                     ReturnValue;                                       // 0x0128(0x0010)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             TargetLocalToWorld;                                // 0x0010(0x0060)
	struct FGeometryScriptBakeTargetMeshOptions   TargetOptions;                                     // 0x0070(0x0004)
	uint8                                         Pad_74[0x4];                                       // 0x0074(0x0004)
	TArray<class AActor*>                         SourceActors;                                      // 0x0078(0x0010)
	struct FGeometryScriptBakeRenderCaptureOptions BakeOptions;                                      // 0x0088(0x0040)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00C8(0x0008)
	struct FGeometryScriptRenderCaptureTextures   ReturnValue;                                       // 0x00D0(0x0090)
};
...
public:
	...
	struct FTransform                             SourceTransform;                                   // 0x0080(0x0060)
	struct FGeometryScriptBakeSourceMeshOptions   SourceOptions;                                     // 0x00E0(0x0010)
	struct FGeometryScriptBakeOutputType          BakeTypes;                                         // 0x00F0(0x0080)
	struct FGeometryScriptBakeVertexOptions       BakeOptions;                                       // 0x0170(0x000C)
	uint8                                         Pad_17C[0x4];                                      // 0x017C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0180(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0188(0x0008)
};
...
{
public:
	EGeometryScriptBakeResolution                 BakeResolution;                                    // 0x0000(0x0001)
...
{
public:
	int32                                         OcclusionRays;                                     // 0x0000(0x0004)
	float                                         MaxDistance;                                       // 0x0004(0x0004)
	float                                         SpreadAngle;                                       // 0x0008(0x0004)
	float                                         BiasAngle;                                         // 0x000C(0x0004)
	struct FGeometryScriptBakeTypeOptions         ReturnValue;                                       // 0x0010(0x0018)
};
...
public:
	...
	float                                         MaxDistance;                                       // 0x0004(0x0004)
	float                                         SpreadAngle;                                       // 0x0008(0x0004)
	EGeometryScriptBakeNormalSpace                NormalSpace;                                       // 0x000C(0x0001)
...
public:
	...
	struct FGeometryScriptBakeTypeOptions         ReturnValue;                                       // 0x0008(0x0018)
};
...
{
public:
	EGeometryScriptBakeCurvatureTypeMode          CurvatureType;                                     // 0x0000(0x0001)
	EGeometryScriptBakeCurvatureColorMode         ColorMapping;                                      // 0x0001(0x0001)
	uint8                                         Pad_2[0x2];                                        // 0x0002(0x0002)
	float                                         ColorRangeMultiplier;                              // 0x0004(0x0004)
	float                                         MinRangeMultiplier;                                // 0x0008(0x0004)
	EGeometryScriptBakeCurvatureClampMode         Clamping;                                          // 0x000C(0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
	struct FGeometryScriptBakeTypeOptions         ReturnValue;                                       // 0x0010(0x0018)
};
...
{
public:
	struct FGeometryScriptBakeTypeOptions         ReturnValue;                                       // 0x0000(0x0018)
};
...
{
public:
	TArray<class UTexture2D*>                     MaterialIDSourceTextures;                          // 0x0000(0x0010)
	int32                                         SourceUVLayer;                                     // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	struct FGeometryScriptBakeTypeOptions         ReturnValue;                                       // 0x0018(0x0018)
};
...
{
public:
	class UTexture2D*                             SourceTexture;                                     // 0x0000(0x0008)
	int32                                         SourceUVLayer;                                     // 0x0008(0x0004)
...
{
public:
	int32                                         SourceUVLayer;                                     // 0x0000(0x0004)
	float                                         WireframeThickness;                                // 0x0004(0x0004)
	struct FLinearColor                           WireframeColor;                                    // 0x0008(0x0010)
	struct FLinearColor                           ShellColor;                                        // 0x0018(0x0010)
	struct FLinearColor                           BackgroundColor;                                   // 0x0028(0x0010)
	struct FGeometryScriptBakeTypeOptions         ReturnValue;                                       // 0x0038(0x0018)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptTriangleList            NewTrianglesList;                                  // 0x0008(0x0010)
	struct FGeometryScriptIndexList               NewIndicesList;                                    // 0x0018(0x0018)
	int32                                         NewTriangleGroupID;                                // 0x0030(0x0004)
	bool                                          bDeferChangeNotifications;                         // 0x0034(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FIntVector                             NewTriangle;                                       // 0x0008(0x000C)
	int32                                         NewTriangleIndex;                                  // 0x0014(0x0004)
	int32                                         NewTriangleGroupID;                                // 0x0018(0x0004)
	bool                                          bDeferChangeNotifications;                         // 0x001C(0x0001)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0020(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FVector                                NewPosition;                                       // 0x0008(0x0018)
	int32                                         NewVertexIndex;                                    // 0x0020(0x0004)
	bool                                          bDeferChangeNotifications;                         // 0x0024(0x0001)
	uint8                                         Pad_25[0x3];                                       // 0x0025(0x0003)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptVectorList              NewPositionsList;                                  // 0x0008(0x0010)
	struct FGeometryScriptIndexList               NewIndicesList;                                    // 0x0018(0x0018)
	bool                                          bDeferChangeNotifications;                         // 0x0030(0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptSimpleMeshBuffers       Buffers;                                           // 0x0008(0x00D0)
	struct FGeometryScriptIndexList               NewTriangleIndicesList;                            // 0x00D8(0x0018)
	int32                                         MaterialID;                                        // 0x00F0(0x0004)
	bool                                          bDeferChangeNotifications;                         // 0x00F4(0x0001)
	uint8                                         Pad_F5[0x3];                                       // 0x00F5(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00F8(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0100(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	class UDynamicMesh*                           AppendMesh_0;                                      // 0x0008(0x0008)
	struct FTransform                             AppendTransform;                                   // 0x0010(0x0060)
	bool                                          bDeferChangeNotifications;                         // 0x0070(0x0001)
	struct FGeometryScriptAppendMeshOptions       AppendOptions;                                     // 0x0071(0x0001)
	uint8                                         Pad_72[0x6];                                       // 0x0072(0x0006)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0078(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0080(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	class UDynamicMesh*                           AppendMesh;                                        // 0x0008(0x0008)
	struct FTransform                             AppendTransform;                                   // 0x0010(0x0060)
	int32                                         RepeatCount;                                       // 0x0070(0x0004)
	bool                                          bApplyTransformToFirstInstance;                    // 0x0074(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x0075(0x0001)
	struct FGeometryScriptAppendMeshOptions       AppendOptions;                                     // 0x0076(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	TArray<class UMaterialInterface*>             TargetMeshMaterialList;                            // 0x0008(0x0010)
	class UDynamicMesh*                           AppendMesh;                                        // 0x0018(0x0008)
	TArray<class UMaterialInterface*>             AppendMeshMaterialList;                            // 0x0020(0x0010)
	TArray<class UMaterialInterface*>             ResultMeshMaterialList;                            // 0x0030(0x0010)
	struct FTransform                             AppendTransform;                                   // 0x0040(0x0060)
	int32                                         RepeatCount;                                       // 0x00A0(0x0004)
	bool                                          bApplyTransformToFirstInstance;                    // 0x00A4(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x00A5(0x0001)
	struct FGeometryScriptAppendMeshOptions       AppendOptions;                                     // 0x00A6(0x0001)
	bool                                          bCompactAppendedMaterials;                         // 0x00A7(0x0001)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00A8(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00B0(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	class UDynamicMesh*                           AppendMesh;                                        // 0x0008(0x0008)
	TArray<struct FTransform>                     AppendTransforms;                                  // 0x0010(0x0010)
	struct FTransform                             ConstantTransform;                                 // 0x0020(0x0060)
	bool                                          bConstantTransformIsRelative;                      // 0x0080(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x0081(0x0001)
	struct FGeometryScriptAppendMeshOptions       AppendOptions;                                     // 0x0082(0x0001)
	uint8                                         Pad_83[0x5];                                       // 0x0083(0x0005)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
...
public:
	...
	TArray<class UMaterialInterface*>             AppendMeshMaterialList;                            // 0x0020(0x0010)
	TArray<class UMaterialInterface*>             ResultMeshMaterialList;                            // 0x0030(0x0010)
	TArray<struct FTransform>                     AppendTransforms;                                  // 0x0040(0x0010)
	struct FTransform                             ConstantTransform;                                 // 0x0050(0x0060)
	bool                                          bConstantTransformIsRelative;                      // 0x00B0(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x00B1(0x0001)
	struct FGeometryScriptAppendMeshOptions       AppendOptions;                                     // 0x00B2(0x0001)
	bool                                          bCompactAppendedMaterials;                         // 0x00B3(0x0001)
	uint8                                         Pad_B4[0x4];                                       // 0x00B4(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00B8(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00C0(0x0008)
...
public:
	...
	TArray<class UMaterialInterface*>             ResultMeshMaterialList;                            // 0x0030(0x0010)
	struct FTransform                             AppendTransform;                                   // 0x0040(0x0060)
	bool                                          bDeferChangeNotifications;                         // 0x00A0(0x0001)
	struct FGeometryScriptAppendMeshOptions       AppendOptions;                                     // 0x00A1(0x0001)
	bool                                          bCompactAppendedMaterials;                         // 0x00A2(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	int32                                         NumDeleted;                                        // 0x0018(0x0004)
	bool                                          bDeferChangeNotifications;                         // 0x001C(0x0001)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         TriangleID;                                        // 0x0008(0x0004)
	bool                                          bWasTriangleDeleted;                               // 0x000C(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x000D(0x0001)
	uint8                                         Pad_E[0x2];                                        // 0x000E(0x0002)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0010(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptIndexList               TriangleList;                                      // 0x0008(0x0018)
	int32                                         NumDeleted;                                        // 0x0020(0x0004)
	bool                                          bDeferChangeNotifications;                         // 0x0024(0x0001)
	uint8                                         Pad_25[0x3];                                       // 0x0025(0x0003)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         VertexID;                                          // 0x0008(0x0004)
	bool                                          bWasVertexDeleted;                                 // 0x000C(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x000D(0x0001)
	uint8                                         Pad_E[0x2];                                        // 0x000E(0x0002)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0010(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptIndexList               VertexList;                                        // 0x0008(0x0018)
	int32                                         NumDeleted;                                        // 0x0020(0x0004)
	bool                                          bDeferChangeNotifications;                         // 0x0024(0x0001)
	uint8                                         Pad_25[0x3];                                       // 0x0025(0x0003)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	bool                                          bDeferChangeNotifications;                         // 0x0008(0x0001)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0010(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptVectorList              PositionList;                                      // 0x0008(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	...
	int32                                         VertexID;                                          // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FVector                                NewPosition;                                       // 0x0010(0x0018)
	bool                                          bIsValidVertex;                                    // 0x0028(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x0029(0x0001)
...
{
public:
	TArray<struct FGeometryScriptBoneWeight>      BoneWeightsA;                                      // 0x0000(0x0010)
	TArray<struct FGeometryScriptBoneWeight>      BoneWeightsB;                                      // 0x0010(0x0010)
	float                                         Alpha;                                             // 0x0020(0x0004)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	TArray<struct FGeometryScriptBoneWeight>      Result;                                            // 0x0028(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	class USkeleton*                              Skeleton;                                          // 0x0008(0x0008)
	struct FGeometryScriptSmoothBoneWeightsOptions Options;                                          // 0x0010(0x0010)
	struct FGeometryScriptBoneWeightProfile       Profile;                                           // 0x0020(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
{
public:
	class UDynamicMesh*                           SourceMesh;                                        // 0x0000(0x0008)
	class UDynamicMesh*                           TargetMesh;                                        // 0x0008(0x0008)
	struct FGeometryScriptCopyBonesFromMeshOptions Options;                                          // 0x0010(0x0002)
	uint8                                         Pad_12[0x6];                                       // 0x0012(0x0006)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
{
public:
	class USkeleton*                              SourceSkeleton;                                    // 0x0000(0x0008)
	class UDynamicMesh*                           TargetMesh;                                        // 0x0008(0x0008)
	struct FGeometryScriptCopyBonesFromMeshOptions Options;                                          // 0x0010(0x0002)
	uint8                                         Pad_12[0x6];                                       // 0x0012(0x0006)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	TArray<struct FGeometryScriptBoneInfo>        BonesInfo;                                         // 0x0008(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	...
	bool                                          bRecursive;                                        // 0x0010(0x0001)
	bool                                          bIsValidBoneName;                                  // 0x0011(0x0001)
	uint8                                         Pad_12[0x6];                                       // 0x0012(0x0006)
	TArray<struct FGeometryScriptBoneInfo>        ChildrenInfo;                                      // 0x0018(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	class FName                                   BoneName;                                          // 0x0008(0x0008)
	bool                                          bIsValidBoneName;                                  // 0x0010(0x0001)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)
	int32                                         BoneIndex;                                         // 0x0014(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	...
	struct FGeometryScriptBoneInfo                BoneInfo;                                          // 0x0020(0x00E0)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0100(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0108(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         VertexID;                                          // 0x0008(0x0004)
	struct FGeometryScriptBoneWeight              BoneWeight;                                        // 0x000C(0x0008)
	bool                                          bHasValidBoneWeights;                              // 0x0014(0x0001)
	uint8                                         Pad_15[0x3];                                       // 0x0015(0x0003)
	struct FGeometryScriptBoneWeightProfile       Profile;                                           // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	bool                                          bHasBoneWeights;                                   // 0x0008(0x0001)
	uint8                                         Pad_9[0x3];                                        // 0x0009(0x0003)
	int32                                         MaxBoneIndex;                                      // 0x000C(0x0004)
	struct FGeometryScriptBoneWeightProfile       Profile;                                           // 0x0010(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	...
	int32                                         VertexID;                                          // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	TArray<struct FGeometryScriptBoneWeight>      BoneWeights;                                       // 0x0010(0x0010)
	bool                                          bHasValidBoneWeights;                              // 0x0020(0x0001)
	uint8                                         Pad_21[0x3];                                       // 0x0021(0x0003)
	struct FGeometryScriptBoneWeightProfile       Profile;                                           // 0x0024(0x0008)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	bool                                          bProfileExisted;                                   // 0x0008(0x0001)
	uint8                                         Pad_9[0x3];                                        // 0x0009(0x0003)
	struct FGeometryScriptBoneWeightProfile       TargetProfile;                                     // 0x000C(0x0008)
	struct FGeometryScriptBoneWeightProfile       SourceProfile;                                     // 0x0014(0x0008)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	bool                                          bProfileExisted;                                   // 0x0008(0x0001)
	bool                                          bReplaceExistingProfile;                           // 0x0009(0x0001)
	uint8                                         Pad_A[0x2];                                        // 0x000A(0x0002)
	struct FGeometryScriptBoneWeightProfile       Profile;                                           // 0x000C(0x0008)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	TArray<class FName>                           BonesToPrune;                                      // 0x0008(0x0010)
	struct FGeometryScriptPruneBoneWeightsOptions Options;                                           // 0x0018(0x0002)
	uint8                                         Pad_1A[0x2];                                       // 0x001A(0x0002)
	struct FGeometryScriptBoneWeightProfile       Profile;                                           // 0x001C(0x0008)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	TArray<struct FGeometryScriptBoneWeight>      BoneWeights;                                       // 0x0008(0x0010)
	struct FGeometryScriptBoneWeightProfile       Profile;                                           // 0x0018(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0020(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	TArray<struct FGeometryScriptBoneWeight>      BoneWeights;                                       // 0x0010(0x0010)
	bool                                          bIsValidVertexID;                                  // 0x0020(0x0001)
	uint8                                         Pad_21[0x3];                                       // 0x0021(0x0003)
	struct FGeometryScriptBoneWeightProfile       Profile;                                           // 0x0024(0x0008)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
...
public:
	class UDynamicMesh*                           SourceMesh;                                        // 0x0000(0x0008)
	class UDynamicMesh*                           TargetMesh;                                        // 0x0008(0x0008)
	struct FGeometryScriptTransferBoneWeightsOptions Options;                                        // 0x0010(0x0040)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0050(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0060(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0068(0x0008)
};
...
public:
	...
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             TargetTransform;                                   // 0x0010(0x0060)
	class UDynamicMesh*                           ToolMesh;                                          // 0x0070(0x0008)
	uint8                                         Pad_78[0x8];                                       // 0x0078(0x0008)
	struct FTransform                             ToolTransform;                                     // 0x0080(0x0060)
	EGeometryScriptBooleanOperation               Operation;                                         // 0x00E0(0x0001)
	uint8                                         Pad_E1[0x3];                                       // 0x00E1(0x0003)
	struct FGeometryScriptMeshBooleanOptions      Options;                                           // 0x00E4(0x000C)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00F0(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00F8(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             MirrorFrame;                                       // 0x0010(0x0060)
	struct FGeometryScriptMeshMirrorOptions       Options;                                           // 0x0070(0x0003)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             CutFrame;                                          // 0x0010(0x0060)
	struct FGeometryScriptMeshPlaneCutOptions     Options;                                           // 0x0070(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0080(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0088(0x0008)
};
...
public:
	...
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             CutFrame;                                          // 0x0010(0x0060)
	struct FGeometryScriptMeshPlaneSliceOptions   Options;                                           // 0x0070(0x0014)
	uint8                                         Pad_84[0x4];                                       // 0x0084(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelfUnionOptions    Options;                                           // 0x0008(0x000C)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	...
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             TargetTransform;                                   // 0x0010(0x0060)
	class UDynamicMesh*                           OtherMesh;                                         // 0x0070(0x0008)
	uint8                                         Pad_78[0x8];                                       // 0x0078(0x0008)
	struct FTransform                             OtherTransform;                                    // 0x0080(0x0060)
	bool                                          bIsIntersecting;                                   // 0x00E0(0x0001)
	uint8                                         Pad_E1[0x7];                                       // 0x00E1(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00E8(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00F0(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	class UDynamicMesh*                           OtherMesh;                                         // 0x0008(0x0008)
	struct FGeometryScriptIsSameMeshOptions       Options;                                           // 0x0010(0x000C)
	bool                                          bIsSameMesh;                                       // 0x001C(0x0001)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)
	struct FGeometryScriptMeshDifferenceInfo      DifferenceInfo;                                    // 0x0020(0x0028)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0048(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0050(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	class UDynamicMesh*                           OtherMesh;                                         // 0x0008(0x0008)
	struct FGeometryScriptMeasureMeshDistanceOptions Options;                                        // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
	double                                        MaxDistance;                                       // 0x0018(0x0008)
	double                                        MinDistance;                                       // 0x0020(0x0008)
	double                                        AverageDistance;                                   // 0x0028(0x0008)
	double                                        RootMeanSqrDeviation;                              // 0x0030(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0038(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0040(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	class UDynamicMesh*                           StoreToSubmesh;                                    // 0x0008(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0010(0x0010)
	class UDynamicMesh*                           StoreToSubmeshOut;                                 // 0x0020(0x0008)
	bool                                          bAppendToExisting;                                 // 0x0028(0x0001)
	bool                                          bPreserveGroupIDs;                                 // 0x0029(0x0001)
	uint8                                         Pad_2A[0x6];                                       // 0x002A(0x0006)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
{
public:
	class UDynamicMesh*                           CopyFromMesh;                                      // 0x0000(0x0008)
	class UDynamicMesh*                           CopyToMesh;                                        // 0x0008(0x0008)
	class UDynamicMesh*                           CopyToMeshOut;                                     // 0x0010(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	class UDynamicMesh*                           StoreToSubmesh;                                    // 0x0008(0x0008)
	struct FGeometryScriptIndexList               TriangleList;                                      // 0x0010(0x0018)
	class UDynamicMesh*                           StoreToSubmeshOut;                                 // 0x0028(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	TArray<class UDynamicMesh*>                   ComponentMeshes;                                   // 0x0008(0x0010)
	class UDynamicMeshPool*                       MeshPool;                                          // 0x0018(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0020(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	TArray<class UDynamicMesh*>                   ComponentMeshes;                                   // 0x0008(0x0010)
	TArray<int32>                                 ComponentMaterialIDs;                              // 0x0018(0x0010)
	class UDynamicMeshPool*                       MeshPool;                                          // 0x0028(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptGroupLayer              GroupLayer;                                        // 0x0008(0x0008)
	TArray<class UDynamicMesh*>                   ComponentMeshes;                                   // 0x0010(0x0010)
	TArray<int32>                                 ComponentPolygroups;                               // 0x0020(0x0010)
	class UDynamicMeshPool*                       MeshPool;                                          // 0x0030(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0038(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0040(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptBendWarpOptions         Options;                                           // 0x0008(0x000C)
	uint8                                         Pad_14[0xC];                                       // 0x0014(0x000C)
	struct FTransform                             BendOrientation;                                   // 0x0020(0x0060)
	float                                         BendAngle;                                         // 0x0080(0x0004)
	float                                         BendExtent;                                        // 0x0084(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FGeometryScriptVectorList              VectorList;                                        // 0x0018(0x0010)
	float                                         Magnitude;                                         // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	...
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0010(0x0010)
	struct FGeometryScriptDisplaceFromTextureOptions Options;                                        // 0x0020(0x0038)
	int32                                         UVLayer;                                           // 0x0058(0x0004)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptFlareWarpOptions        Options;                                           // 0x0008(0x000C)
	uint8                                         Pad_14[0xC];                                       // 0x0014(0x000C)
	struct FTransform                             FlareOrientation;                                  // 0x0020(0x0060)
	float                                         FlarePercentX;                                     // 0x0080(0x0004)
	float                                         FlarePercentY;                                     // 0x0084(0x0004)
	float                                         FlareExtent;                                       // 0x0088(0x0004)
	uint8                                         Pad_8C[0x4];                                       // 0x008C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0090(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0098(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FGeometryScriptIterativeMeshSmoothingOptions Options;                                     // 0x0018(0x000C)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             WarpOrientation;                                   // 0x0010(0x0060)
	EGeometryScriptMathWarpType                   WarpType;                                          // 0x0070(0x0001)
	uint8                                         Pad_71[0x3];                                       // 0x0071(0x0003)
	struct FGeometryScriptMathWarpOptions         Options;                                           // 0x0074(0x000C)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0080(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0088(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FGeometryScriptPerlinNoiseOptions      Options;                                           // 0x0018(0x0030)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0048(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0050(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptTwistWarpOptions        Options;                                           // 0x0008(0x000C)
	uint8                                         Pad_14[0xC];                                       // 0x0014(0x000C)
	struct FTransform                             TwistOrientation;                                  // 0x0020(0x0060)
	float                                         TwistAngle;                                        // 0x0080(0x0004)
	float                                         TwistExtent;                                       // 0x0084(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
};
...
public:
	...
	int32                                         StartTriangleID;                                   // 0x0020(0x0004)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	struct FVector                                StartBaryCoords;                                   // 0x0028(0x0018)
	float                                         MaxPathLength;                                     // 0x0040(0x0004)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)
	struct FGeometryScriptPolyPath                SurfacePath;                                       // 0x0048(0x0018)
	bool                                          bFoundErrors;                                      // 0x0060(0x0001)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0068(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0070(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         StartTriangleID;                                   // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FVector                                StartBaryCoords;                                   // 0x0010(0x0018)
	int32                                         EndTriangleID;                                     // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	struct FVector                                EndBaryCoords;                                     // 0x0030(0x0018)
	struct FGeometryScriptPolyPath                ShortestPath;                                      // 0x0048(0x0018)
	bool                                          bFoundErrors;                                      // 0x0060(0x0001)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0068(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0070(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         StartVertexID;                                     // 0x0008(0x0004)
	int32                                         EndVertexID;                                       // 0x000C(0x0004)
	struct FGeometryScriptIndexList               VertexIDList;                                      // 0x0010(0x0018)
	bool                                          bFoundErrors;                                      // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         ClearValue;                                        // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0010(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	TArray<class UMaterialInterface*>             SourceMaterialList;                                // 0x0008(0x0010)
	TArray<class UMaterialInterface*>             CompactedMaterialList;                             // 0x0018(0x0010)
	bool                                          bRemoveDuplicateMaterials;                         // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         MaterialID;                                        // 0x0008(0x0004)
	int32                                         NumDeleted;                                        // 0x000C(0x0004)
	bool                                          bDeferChangeNotifications;                         // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptIndexList               MaterialIDList;                                    // 0x0008(0x0018)
	bool                                          bHasMaterialIDs;                                   // 0x0020(0x0001)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptIndexList               TriangleIDList;                                    // 0x0008(0x0018)
	struct FGeometryScriptIndexList               MaterialIDList;                                    // 0x0020(0x0018)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0038(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0040(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	bool                                          bHasMaterialIDs;                                   // 0x0008(0x0001)
	uint8                                         Pad_9[0x3];                                        // 0x0009(0x0003)
	int32                                         ReturnValue;                                       // 0x000C(0x0004)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         TriangleID;                                        // 0x0008(0x0004)
	bool                                          bIsValidTriangle;                                  // 0x000C(0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
	int32                                         ReturnValue;                                       // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
};
...
public:
	...
	int32                                         MaterialID;                                        // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FGeometryScriptIndexList               TriangleIDList;                                    // 0x0010(0x0018)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	TArray<class UMaterialInterface*>             TargetMeshMaterials;                               // 0x0008(0x0010)
	TArray<class UMaterialInterface*>             RequiredMaterials;                                 // 0x0018(0x0010)
	TArray<class UMaterialInterface*>             CombinedMaterials;                                 // 0x0028(0x0010)
	int32                                         RemapInvalidMaterialID;                            // 0x0038(0x0004)
	bool                                          bCompactDuplicateMaterials;                        // 0x003C(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         FromMaterialID;                                    // 0x0008(0x0004)
	int32                                         ToMaterialID;                                      // 0x000C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0010(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	TArray<class UMaterialInterface*>             FromMaterialList;                                  // 0x0008(0x0010)
	TArray<class UMaterialInterface*>             ToMaterialList;                                    // 0x0018(0x0010)
	int32                                         MissingMaterialID;                                 // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptIndexList               TriangleMaterialIDList;                            // 0x0008(0x0018)
	bool                                          bDeferChangeNotifications;                         // 0x0020(0x0001)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	int32                                         MaterialID;                                        // 0x0018(0x0004)
	bool                                          bDeferChangeNotifications;                         // 0x001C(0x0001)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0020(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptIndexList               TriangleIDList;                                    // 0x0008(0x0018)
	int32                                         MaterialID;                                        // 0x0020(0x0004)
	bool                                          bDeferChangeNotifications;                         // 0x0024(0x0001)
	uint8                                         Pad_25[0x3];                                       // 0x0025(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptGroupLayer              GroupLayer;                                        // 0x0008(0x0008)
	int32                                         PolygroupID;                                       // 0x0010(0x0004)
	int32                                         MaterialID;                                        // 0x0014(0x0004)
	bool                                          bIsValidPolygroupID;                               // 0x0018(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x0019(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         TriangleID;                                        // 0x0008(0x0004)
	int32                                         MaterialID;                                        // 0x000C(0x0004)
	bool                                          bIsValidTriangle;                                  // 0x0010(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x0011(0x0001)
	uint8                                         Pad_12[0x6];                                       // 0x0012(0x0006)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FGeometryScriptMeshBevelSelectionOptions BevelOptions;                                    // 0x0018(0x0014)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	EGeometryScriptMeshBevelSelectionMode         BevelMode;                                         // 0x0018(0x0001)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)
	struct FGeometryScriptMeshBevelSelectionOptions BevelOptions;                                    // 0x001C(0x0014)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	bool                                          bAllowBowtiesInOutput;                             // 0x0018(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FGeometryScriptMeshSelection           NewTriangles;                                      // 0x0018(0x0010)
	struct FGeometryScriptMeshEditPolygroupOptions GroupOptions;                                     // 0x0028(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshExtrudeOptions      Options;                                           // 0x0008(0x0028)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshInsetOutsetFacesOptions Options;                                       // 0x0008(0x0020)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0028(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0038(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0040(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshLinearExtrudeOptions Options;                                          // 0x0008(0x0038)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0040(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0050(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0058(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshOffsetOptions       Options;                                           // 0x0008(0x0018)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0020(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshOffsetFacesOptions  Options;                                           // 0x0008(0x0018)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0020(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FGeometryScriptMeshBevelOptions        Options;                                           // 0x0010(0x00C0)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00D0(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00D8(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptSplitNormalsOptions     SplitOptions;                                      // 0x0008(0x0014)
	struct FGeometryScriptCalculateNormalsOptions CalculateOptions;                                  // 0x001C(0x0002)
	uint8                                         Pad_1E[0x2];                                       // 0x001E(0x0002)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0020(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptTangentsOptions         Options;                                           // 0x0008(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0010(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	bool                                          bHasTangents;                                      // 0x0008(0x0001)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0010(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptVectorList              NormalList;                                        // 0x0008(0x0010)
	bool                                          bIsValidNormalSet;                                 // 0x0018(0x0001)
	bool                                          bHasVertexIDGaps;                                  // 0x0019(0x0001)
	bool                                          bAverageSplitVertexValues;                         // 0x001A(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptVectorList              TangentXList;                                      // 0x0008(0x0010)
	struct FGeometryScriptVectorList              TangentYList;                                      // 0x0018(0x0010)
	bool                                          bIsValidTangentSet;                                // 0x0028(0x0001)
	bool                                          bHasVertexIDGaps;                                  // 0x0029(0x0001)
	bool                                          bAverageSplitVertexValues;                         // 0x002A(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptCalculateNormalsOptions CalculateOptions;                                  // 0x0008(0x0002)
	bool                                          bDeferChangeNotifications;                         // 0x000A(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FGeometryScriptCalculateNormalsOptions CalculateOptions;                                  // 0x0018(0x0002)
	bool                                          bDeferChangeNotifications;                         // 0x001A(0x0001)
	uint8                                         Pad_1B[0x5];                                       // 0x001B(0x0005)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0020(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptVectorList              VertexNormalList;                                  // 0x0008(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	...
	int32                                         TriangleID;                                        // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FGeometryScriptTriangle                Normals;                                           // 0x0010(0x0048)
	bool                                          bIsValidTriangle;                                  // 0x0058(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x0059(0x0001)
	uint8                                         Pad_5A[0x6];                                       // 0x005A(0x0006)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0060(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	bool                                          bSplit;                                            // 0x0018(0x0001)
	bool                                          bRecalculateNormals;                               // 0x0019(0x0001)
	struct FGeometryScriptCalculateNormalsOptions CalculateOptions;                                  // 0x001A(0x0002)
	bool                                          bDeferChangeNotifications;                         // 0x001C(0x0001)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0020(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         VertexID;                                          // 0x0008(0x0004)
	bool                                          bUpdateNormal;                                     // 0x000C(0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
	struct FVector                                NewNormal;                                         // 0x0010(0x0018)
	bool                                          bUpdateTangents;                                   // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	struct FVector                                NewTangentX;                                       // 0x0030(0x0018)
	struct FVector                                NewTangentY;                                       // 0x0048(0x0018)
	bool                                          bIsValidVertex;                                    // 0x0060(0x0001)
	bool                                          bMergeSplitValues;                                 // 0x0061(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x0062(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptGroupLayer              GroupLayer;                                        // 0x0008(0x0008)
	int32                                         ClearValue;                                        // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptGroupLayer              GroupLayer;                                        // 0x0008(0x0008)
	float                                         CreaseAngle;                                       // 0x0010(0x0004)
	int32                                         MinGroupSize;                                      // 0x0014(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptGroupLayer              GroupLayer;                                        // 0x0008(0x0008)
	bool                                          bRespectUVSeams;                                   // 0x0010(0x0001)
	bool                                          bRespectHardNormals;                               // 0x0011(0x0001)
	uint8                                         Pad_12[0x6];                                       // 0x0012(0x0006)
	double                                        QuadAdjacencyWeight;                               // 0x0018(0x0008)
	double                                        QuadMetricClamp;                                   // 0x0020(0x0008)
	int32                                         MaxSearchRounds;                                   // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptGroupLayer              FromGroupLayer;                                    // 0x0008(0x0008)
	struct FGeometryScriptGroupLayer              ToGroupLayer;                                      // 0x0010(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	...
	struct FGeometryScriptGroupLayer              GroupLayer;                                        // 0x0008(0x0008)
	int32                                         PolygroupID;                                       // 0x0010(0x0004)
	int32                                         NumDeleted;                                        // 0x0014(0x0004)
	bool                                          bDeferChangeNotifications;                         // 0x0018(0x0001)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0020(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptGroupLayer              GroupLayer;                                        // 0x0008(0x0008)
	struct FGeometryScriptIndexList               PolygroupIDsOut;                                   // 0x0010(0x0018)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptGroupLayer              GroupLayer;                                        // 0x0008(0x0008)
	int32                                         TriangleID;                                        // 0x0010(0x0004)
	bool                                          bIsValidTriangle;                                  // 0x0014(0x0001)
	uint8                                         Pad_15[0x3];                                       // 0x0015(0x0003)
	int32                                         ReturnValue;                                       // 0x0018(0x0004)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
...
public:
	...
	int32                                         PolygroupID;                                       // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	struct FGeometryScriptIndexList               TriangleIDsOut;                                    // 0x0018(0x0018)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	...
	struct FGeometryScriptGroupLayer              GroupLayer;                                        // 0x0008(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0010(0x0010)
	int32                                         SetPolygroupIDOut;                                 // 0x0020(0x0004)
	int32                                         SetPolygroupID;                                    // 0x0024(0x0004)
	bool                                          bGenerateNewPolygroup;                             // 0x0028(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x0029(0x0001)
	uint8                                         Pad_2A[0x6];                                       // 0x002A(0x0006)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
{
public:
	class UDynamicMeshPool*                       ReturnValue;                                       // 0x0000(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	struct FBox                                   Box;                                               // 0x0070(0x0038)
	int32                                         StepsX;                                            // 0x00A8(0x0004)
	int32                                         StepsY;                                            // 0x00AC(0x0004)
	int32                                         StepsZ;                                            // 0x00B0(0x0004)
	uint8                                         Pad_B4[0x4];                                       // 0x00B4(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00B8(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00C0(0x0008)
	uint8                                         Pad_C8[0x8];                                       // 0x00C8(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptSimpleCollision         SimpleCollision;                                   // 0x0008(0x0080)
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0088(0x0008)
	struct FTransform                             Transform;                                         // 0x0090(0x0060)
	struct FBox                                   Box;                                               // 0x00F0(0x0038)
	int32                                         StepsX;                                            // 0x0128(0x0004)
	int32                                         StepsY;                                            // 0x012C(0x0004)
	int32                                         StepsZ;                                            // 0x0130(0x0004)
	uint8                                         Pad_134[0x4];                                      // 0x0134(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0138(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0140(0x0008)
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	float                                         DimensionX;                                        // 0x0070(0x0004)
	float                                         DimensionY;                                        // 0x0074(0x0004)
	float                                         DimensionZ;                                        // 0x0078(0x0004)
	int32                                         StepsX;                                            // 0x007C(0x0004)
	int32                                         StepsY;                                            // 0x0080(0x0004)
	int32                                         StepsZ;                                            // 0x0084(0x0004)
	EGeometryScriptPrimitiveOriginMode            Origin;                                            // 0x0088(0x0001)
	uint8                                         Pad_89[0x7];                                       // 0x0089(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0090(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0098(0x0008)
};
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0088(0x0008)
	struct FTransform                             Transform;                                         // 0x0090(0x0060)
	float                                         DimensionX;                                        // 0x00F0(0x0004)
	float                                         DimensionY;                                        // 0x00F4(0x0004)
	float                                         DimensionZ;                                        // 0x00F8(0x0004)
	int32                                         StepsX;                                            // 0x00FC(0x0004)
	int32                                         StepsY;                                            // 0x0100(0x0004)
	int32                                         StepsZ;                                            // 0x0104(0x0004)
	EGeometryScriptPrimitiveOriginMode            Origin;                                            // 0x0108(0x0001)
	uint8                                         Pad_109[0x7];                                      // 0x0109(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0110(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0118(0x0008)
};
...
public:
	...
	float                                         LineLength;                                        // 0x0074(0x0004)
	int32                                         HemisphereSteps;                                   // 0x0078(0x0004)
	int32                                         CircleSteps;                                       // 0x007C(0x0004)
	int32                                         SegmentSteps;                                      // 0x0080(0x0004)
	EGeometryScriptPrimitiveOriginMode            Origin;                                            // 0x0084(0x0001)
...
public:
	...
	float                                         LineLength;                                        // 0x00F4(0x0004)
	int32                                         HemisphereSteps;                                   // 0x00F8(0x0004)
	int32                                         CircleSteps;                                       // 0x00FC(0x0004)
	int32                                         SegmentSteps;                                      // 0x0100(0x0004)
	EGeometryScriptPrimitiveOriginMode            Origin;                                            // 0x0104(0x0001)
	uint8                                         Pad_105[0x3];                                      // 0x0105(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0108(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0110(0x0008)
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	float                                         BaseRadius;                                        // 0x0070(0x0004)
	float                                         TopRadius;                                         // 0x0074(0x0004)
	float                                         Height;                                            // 0x0078(0x0004)
	int32                                         RadialSteps;                                       // 0x007C(0x0004)
	int32                                         HeightSteps;                                       // 0x0080(0x0004)
	bool                                          bCapped;                                           // 0x0084(0x0001)
	EGeometryScriptPrimitiveOriginMode            Origin;                                            // 0x0085(0x0001)
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	float                                         StepWidth;                                         // 0x0070(0x0004)
	float                                         StepHeight;                                        // 0x0074(0x0004)
	float                                         InnerRadius;                                       // 0x0078(0x0004)
	float                                         CurveAngle;                                        // 0x007C(0x0004)
	int32                                         NumSteps;                                          // 0x0080(0x0004)
	bool                                          bFloating;                                         // 0x0084(0x0001)
	uint8                                         Pad_85[0x3];                                       // 0x0085(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
...
public:
	...
	int32                                         RadialSteps;                                       // 0x0078(0x0004)
	int32                                         HeightSteps;                                       // 0x007C(0x0004)
	bool                                          bCapped;                                           // 0x0080(0x0001)
	EGeometryScriptPrimitiveOriginMode            Origin;                                            // 0x0081(0x0001)
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	TArray<struct FVector2D>                      VertexPositions;                                   // 0x0070(0x0010)
	TArray<struct FIntPoint>                      ConstrainedEdges;                                  // 0x0080(0x0010)
	struct FGeometryScriptConstrainedDelaunayTriangulationOptions TriangulationOptions;              // 0x0090(0x0003)
	uint8                                         Pad_93[0x5];                                       // 0x0093(0x0005)
	TArray<int32>                                 PositionsToVertexIDs;                              // 0x0098(0x0010)
	bool                                          bHasDuplicateVertices;                             // 0x00A8(0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00B0(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00B8(0x0008)
};
...
public:
	...
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	float                                         Radius;                                            // 0x0070(0x0004)
	int32                                         AngleSteps;                                        // 0x0074(0x0004)
	int32                                         SpokeSteps;                                        // 0x0078(0x0004)
	float                                         startAngle;                                        // 0x007C(0x0004)
	float                                         endAngle;                                          // 0x0080(0x0004)
	float                                         HoleRadius;                                        // 0x0084(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
};
...
public:
	...
	float                                         StepWidth;                                         // 0x0070(0x0004)
	float                                         StepHeight;                                        // 0x0074(0x0004)
	float                                         StepDepth;                                         // 0x0078(0x0004)
	int32                                         NumSteps;                                          // 0x007C(0x0004)
	bool                                          bFloating;                                         // 0x0080(0x0001)
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	struct FGeometryScriptGeneralPolygonList      PolygonList;                                       // 0x0070(0x0010)
	struct FGeometryScriptPolygonsTriangulationOptions TriangulationOptions;                         // 0x0080(0x0001)
	bool                                          bTriangulationError;                               // 0x0081(0x0001)
	uint8                                         Pad_82[0x6];                                       // 0x0082(0x0006)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
...
public:
	...
	float                                         DimensionX;                                        // 0x0070(0x0004)
	float                                         DimensionY;                                        // 0x0074(0x0004)
	int32                                         StepsWidth;                                        // 0x0078(0x0004)
	int32                                         StepsHeight;                                       // 0x007C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0080(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0088(0x0008)
};
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	TArray<struct FVector2D>                      PathVertices;                                      // 0x0070(0x0010)
	struct FGeometryScriptRevolveOptions          RevolveOptions;                                    // 0x0080(0x0014)
	int32                                         Steps;                                             // 0x0094(0x0004)
	bool                                          bCapped;                                           // 0x0098(0x0001)
	uint8                                         Pad_99[0x7];                                       // 0x0099(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00A0(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00A8(0x0008)
};
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	TArray<struct FVector2D>                      PolygonVertices;                                   // 0x0070(0x0010)
	struct FGeometryScriptRevolveOptions          RevolveOptions;                                    // 0x0080(0x0014)
	float                                         Radius;                                            // 0x0094(0x0004)
	int32                                         Steps;                                             // 0x0098(0x0004)
...
public:
	...
	float                                         DimensionX;                                        // 0x0070(0x0004)
	float                                         DimensionY;                                        // 0x0074(0x0004)
	float                                         CornerRadius;                                      // 0x0078(0x0004)
	int32                                         StepsWidth;                                        // 0x007C(0x0004)
	int32                                         StepsHeight;                                       // 0x0080(0x0004)
	int32                                         StepsRound;                                        // 0x0084(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
};
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	struct FGeometryScriptSimpleCollision         SimpleCollision;                                   // 0x0070(0x0080)
	struct FGeometryScriptSimpleCollisionTriangulationOptions TriangulationOptions;                  // 0x00F0(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0100(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0108(0x0008)
};
...
public:
	...
	int32                                         HeightSteps;                                       // 0x0084(0x0004)
	bool                                          bCapped;                                           // 0x0088(0x0001)
	EGeometryScriptPrimitiveOriginMode            Origin;                                            // 0x0089(0x0001)
	uint8                                         Pad_8A[0x6];                                       // 0x008A(0x0006)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0090(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0098(0x0008)
};
...
public:
	...
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	TArray<struct FVector2D>                      PolygonVertices;                                   // 0x0070(0x0010)
	TArray<struct FVector>                        SweepPath;                                         // 0x0080(0x0010)
	bool                                          bLoop;                                             // 0x0090(0x0001)
	bool                                          bCapped;                                           // 0x0091(0x0001)
	uint8                                         Pad_92[0x2];                                       // 0x0092(0x0002)
	float                                         StartScale;                                        // 0x0094(0x0004)
	float                                         EndScale;                                          // 0x0098(0x0004)
	float                                         RotationAngleDeg;                                  // 0x009C(0x0004)
	float                                         MiterLimit;                                        // 0x00A0(0x0004)
...
public:
	...
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	float                                         Radius;                                            // 0x0070(0x0004)
	int32                                         StepsX;                                            // 0x0074(0x0004)
	int32                                         StepsY;                                            // 0x0078(0x0004)
	int32                                         StepsZ;                                            // 0x007C(0x0004)
	EGeometryScriptPrimitiveOriginMode            Origin;                                            // 0x0080(0x0001)
	uint8                                         Pad_81[0x7];                                       // 0x0081(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
...
public:
	...
	struct FTransform                             Transform;                                         // 0x0090(0x0060)
	float                                         Radius;                                            // 0x00F0(0x0004)
	int32                                         StepsX;                                            // 0x00F4(0x0004)
	int32                                         StepsY;                                            // 0x00F8(0x0004)
	int32                                         StepsZ;                                            // 0x00FC(0x0004)
	EGeometryScriptPrimitiveOriginMode            Origin;                                            // 0x0100(0x0001)
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	struct FGeometryScriptSphereCovering          SphereCovering;                                    // 0x0070(0x0010)
	int32                                         StepsX;                                            // 0x0080(0x0004)
	int32                                         StepsY;                                            // 0x0084(0x0004)
	int32                                         StepsZ;                                            // 0x0088(0x0004)
	uint8                                         Pad_8C[0x4];                                       // 0x008C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0090(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0098(0x0008)
};
...
public:
	...
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	float                                         Radius;                                            // 0x0070(0x0004)
	int32                                         StepsPhi;                                          // 0x0074(0x0004)
	int32                                         StepsTheta;                                        // 0x0078(0x0004)
	EGeometryScriptPrimitiveOriginMode            Origin;                                            // 0x007C(0x0001)
...
public:
	...
	struct FTransform                             Transform;                                         // 0x0090(0x0060)
	float                                         Radius;                                            // 0x00F0(0x0004)
	int32                                         StepsPhi;                                          // 0x00F4(0x0004)
	int32                                         StepsTheta;                                        // 0x00F8(0x0004)
	EGeometryScriptPrimitiveOriginMode            Origin;                                            // 0x00FC(0x0001)
...
public:
	...
	float                                         Radius;                                            // 0x0094(0x0004)
	int32                                         Steps;                                             // 0x0098(0x0004)
	float                                         RisePerRevolution;                                 // 0x009C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00A0(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00A8(0x0008)
};
...
public:
	...
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	TArray<struct FVector2D>                      PolygonVertices;                                   // 0x0070(0x0010)
	TArray<struct FTransform>                     SweepPath;                                         // 0x0080(0x0010)
	bool                                          bLoop;                                             // 0x0090(0x0001)
	bool                                          bCapped;                                           // 0x0091(0x0001)
	uint8                                         Pad_92[0x2];                                       // 0x0092(0x0002)
	float                                         StartScale;                                        // 0x0094(0x0004)
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	TArray<struct FVector2D>                      PolylineVertices;                                  // 0x0070(0x0010)
	TArray<struct FTransform>                     SweepPath;                                         // 0x0080(0x0010)
	TArray<float>                                 PolylineTexParamU;                                 // 0x0090(0x0010)
	TArray<float>                                 SweepPathTexParamV;                                // 0x00A0(0x0010)
	bool                                          bLoop;                                             // 0x00B0(0x0001)
	uint8                                         Pad_B1[0x3];                                       // 0x00B1(0x0003)
	float                                         StartScale;                                        // 0x00B4(0x0004)
	float                                         EndScale;                                          // 0x00B8(0x0004)
	float                                         RotationAngleDeg;                                  // 0x00BC(0x0004)
	float                                         MiterLimit;                                        // 0x00C0(0x0004)
	uint8                                         Pad_C4[0x4];                                       // 0x00C4(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00C8(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00D0(0x0008)
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	struct FGeometryScriptRevolveOptions          RevolveOptions;                                    // 0x0070(0x0014)
	float                                         MajorRadius;                                       // 0x0084(0x0004)
	float                                         MinorRadius;                                       // 0x0088(0x0004)
	int32                                         MajorSteps;                                        // 0x008C(0x0004)
	int32                                         MinorSteps;                                        // 0x0090(0x0004)
	EGeometryScriptPrimitiveOriginMode            Origin;                                            // 0x0094(0x0001)
...
public:
	...
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	TArray<struct FVector2D>                      PolygonVertices;                                   // 0x0070(0x0010)
	bool                                          bAllowSelfIntersections;                           // 0x0080(0x0001)
	uint8                                         Pad_81[0x7];                                       // 0x0081(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	TArray<struct FVector>                        PolygonVertices3D;                                 // 0x0070(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0080(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0088(0x0008)
};
...
public:
	...
	struct FGeometryScriptPrimitiveOptions        PrimitiveOptions;                                  // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	TArray<struct FVector2D>                      VoronoiSites;                                      // 0x0070(0x0010)
	struct FGeometryScriptVoronoiOptions          VoronoiOptions;                                    // 0x0080(0x0058)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00D8(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00E0(0x0008)
...
{
public:
	int32                                         NumVertices;                                       // 0x0000(0x0004)
	int32                                         Start;                                             // 0x0004(0x0004)
	TArray<struct FIntPoint>                      ReturnValue;                                       // 0x0008(0x0010)
};
...
public:
	...
	struct FVector                                Vertex1;                                           // 0x0028(0x0018)
	struct FVector                                Vertex2;                                           // 0x0040(0x0018)
	struct FVector                                Vertex3;                                           // 0x0058(0x0018)
	struct FVector                                BarycentricCoords;                                 // 0x0070(0x0018)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0088(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	int32                                         VertexID;                                          // 0x000C(0x0004)
	TArray<int32>                                 ElementIDs;                                        // 0x0010(0x0010)
	TArray<struct FVector2D>                      ElementUVs;                                        // 0x0020(0x0010)
	bool                                          bHaveValidUVs;                                     // 0x0030(0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptIndexList               TriangleIDList;                                    // 0x0008(0x0018)
	bool                                          bHasTriangleIDGaps;                                // 0x0020(0x0001)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptTriangleList            TriangleList;                                      // 0x0008(0x0010)
	bool                                          bSkipGaps;                                         // 0x0018(0x0001)
	bool                                          bHasTriangleIDGaps;                                // 0x0019(0x0001)
	uint8                                         Pad_1A[0x6];                                       // 0x001A(0x0006)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	bool                                          bHaveValidUVs;                                     // 0x000C(0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
	struct FGeometryScriptIndexList               ElementIDs;                                        // 0x0010(0x0018)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptIndexList               VertexIDList;                                      // 0x0008(0x0018)
	bool                                          bHasVertexIDGaps;                                  // 0x0020(0x0001)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptIndexList               EdgeIDs;                                           // 0x0008(0x0018)
	struct FGeometryScriptVectorList              Start;                                             // 0x0020(0x0010)
	struct FGeometryScriptVectorList              End;                                               // 0x0030(0x0010)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0040(0x0008)
};
...
public:
	...
	int32                                         TriangleID;                                        // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FVector                                BarycentricCoords;                                 // 0x0010(0x0018)
	bool                                          bTriHasValidNormals;                               // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	struct FVector                                InterpolatedNormal;                                // 0x0030(0x0018)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0048(0x0008)
};
...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FVector                                BarycentricCoords;                                 // 0x0010(0x0018)
	bool                                          bTriHasValidElements;                              // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	struct FVector                                InterpolatedNormal;                                // 0x0030(0x0018)
	struct FVector                                InterpolatedTangent;                               // 0x0048(0x0018)
	struct FVector                                InterpolatedBiTangent;                             // 0x0060(0x0018)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0078(0x0008)
};
...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FVector                                BarycentricCoords;                                 // 0x0010(0x0018)
	bool                                          bIsValidTriangle;                                  // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	struct FVector                                InterpolatedPosition;                              // 0x0030(0x0018)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0048(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	int32                                         TriangleID;                                        // 0x000C(0x0004)
	struct FVector                                BarycentricCoords;                                 // 0x0010(0x0018)
	bool                                          bTriHasValidUVs;                                   // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	struct FVector2D                              InterpolatedUV;                                    // 0x0030(0x0010)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0040(0x0008)
};
...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FVector                                BarycentricCoords;                                 // 0x0010(0x0018)
	struct FLinearColor                           DefaultColor;                                      // 0x0028(0x0010)
	bool                                          bTriHasValidVertexColors;                          // 0x0038(0x0001)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)
	struct FLinearColor                           InterpolatedColor;                                 // 0x003C(0x0010)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         UVChannel;                                         // 0x0008(0x0004)
	bool                                          bIsValidUVChannel;                                 // 0x000C(0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	float                                         SurfaceArea;                                       // 0x0008(0x0004)
...
public:
	...
	float                                         SurfaceArea;                                       // 0x0008(0x0004)
	float                                         Volume;                                            // 0x000C(0x0004)
	struct FVector                                CenterOfMass;                                      // 0x0010(0x0018)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	bool                                          bAmbiguousTopologyFound;                           // 0x0008(0x0001)
	uint8                                         Pad_9[0x3];                                        // 0x0009(0x0003)
	int32                                         ReturnValue;                                       // 0x000C(0x0004)
};
...
public:
	...
	bool                                          bIsValidTriangle;                                  // 0x000C(0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
	struct FIntVector                             ReturnValue;                                       // 0x0010(0x000C)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
};
...
public:
	...
	int32                                         TriangleID;                                        // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FVector                                Normal1;                                           // 0x0010(0x0018)
	struct FVector                                Normal2;                                           // 0x0028(0x0018)
	struct FVector                                Normal3;                                           // 0x0040(0x0018)
	bool                                          bTriHasValidNormals;                               // 0x0058(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         TriangleID;                                        // 0x0008(0x0004)
	bool                                          bTriHasValidElements;                              // 0x000C(0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
	struct FGeometryScriptTriangle                Normals;                                           // 0x0010(0x0048)
	struct FGeometryScriptTriangle                Tangents;                                          // 0x0058(0x0048)
	struct FGeometryScriptTriangle                BiTangents;                                        // 0x00A0(0x0048)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00E8(0x0008)
};
...
public:
	...
	bool                                          bIsValidTriangle;                                  // 0x000C(0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
	struct FVector                                Vertex1;                                           // 0x0010(0x0018)
	struct FVector                                Vertex2;                                           // 0x0028(0x0018)
	struct FVector                                Vertex3;                                           // 0x0040(0x0018)
};
...
public:
	...
	struct FVector2D                              UV3;                                               // 0x0030(0x0010)
	bool                                          bHaveValidUVs;                                     // 0x0040(0x0001)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         TriangleID;                                        // 0x0008(0x0004)
	struct FLinearColor                           Color1;                                            // 0x000C(0x0010)
	struct FLinearColor                           Color2;                                            // 0x001C(0x0010)
	struct FLinearColor                           Color3;                                            // 0x002C(0x0010)
	bool                                          bTriHasValidVertexColors;                          // 0x003C(0x0001)
	uint8                                         Pad_3D[0x3];                                       // 0x003D(0x0003)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0040(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	bool                                          bIsValidUVSet;                                     // 0x000C(0x0001)
	bool                                          bUVSetIsEmpty;                                     // 0x000D(0x0001)
	uint8                                         Pad_E[0x2];                                        // 0x000E(0x0002)
	struct FBox2D                                 ReturnValue;                                       // 0x0010(0x0028)
};
...
public:
	...
	int32                                         VertexID;                                          // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	TArray<int32>                                 Vertices;                                          // 0x0010(0x0010)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         VertexID;                                          // 0x0008(0x0004)
	bool                                          bIsValidVertex;                                    // 0x000C(0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
	struct FVector                                ReturnValue;                                       // 0x0010(0x0018)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptRemeshOptions           RemeshOptions;                                     // 0x0008(0x001C)
	struct FGeometryScriptUniformRemeshOptions    UniformOptions;                                    // 0x0024(0x000C)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptFillHolesOptions        FillOptions;                                       // 0x0008(0x0002)
	uint8                                         Pad_A[0x2];                                        // 0x000A(0x0002)
	int32                                         NumFilledHoles;                                    // 0x000C(0x0004)
	int32                                         NumFailedHoleFills;                                // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptRemoveHiddenTrianglesOptions Options;                                      // 0x0008(0x001C)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptRemoveSmallComponentOptions Options;                                       // 0x0008(0x000C)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptDegenerateTriangleOptions Options;                                         // 0x0008(0x0020)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptResolveTJunctionOptions ResolveOptions;                                    // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0010(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptSnapBoundariesOptions   SnapOptions;                                       // 0x0008(0x000C)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	bool                                          bMeshBowties;                                      // 0x0008(0x0001)
	bool                                          bAttributeBowties;                                 // 0x0009(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptWeldEdgesOptions        WeldOptions;                                       // 0x0008(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0010(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshPointSamplingOptions Options;                                          // 0x0008(0x0018)
	struct FGeometryScriptNonUniformPointSamplingOptions NonUniformOptions;                          // 0x0020(0x0018)
	TArray<struct FTransform>                     Samples;                                           // 0x0038(0x0010)
	TArray<double>                                SampleRadii;                                       // 0x0048(0x0010)
	struct FGeometryScriptIndexList               TriangleIDs;                                       // 0x0058(0x0018)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0070(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0078(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshPointSamplingOptions Options;                                          // 0x0008(0x0018)
	TArray<struct FTransform>                     Samples;                                           // 0x0020(0x0010)
	struct FGeometryScriptIndexList               TriangleIDs;                                       // 0x0030(0x0018)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0048(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0050(0x0008)
};
...
public:
	...
	struct FGeometryScriptRenderCaptureCamerasForBoxOptions Options;                                 // 0x0048(0x0028)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0070(0x0008)
};
...
{
public:
	TArray<struct FTransform>                     Samples;                                           // 0x0000(0x0010)
	TArray<class AActor*>                         Actors;                                            // 0x0010(0x0010)
	TArray<struct FGeometryScriptRenderCaptureCamera> Cameras;                                       // 0x0020(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
};
...
public:
	...
	struct FGeometryScriptMeshPointSamplingOptions Options;                                          // 0x0008(0x0018)
	struct FGeometryScriptNonUniformPointSamplingOptions NonUniformOptions;                          // 0x0020(0x0018)
	struct FGeometryScriptScalarList              VertexWeights;                                     // 0x0038(0x0010)
	TArray<struct FTransform>                     Samples;                                           // 0x0048(0x0010)
	TArray<double>                                SampleRadii;                                       // 0x0058(0x0010)
	struct FGeometryScriptIndexList               TriangleIDs;                                       // 0x0068(0x0018)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0080(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0088(0x0008)
};
...
{
public:
	struct FGeometryScriptMeshSelection           SelectionA;                                        // 0x0000(0x0010)
	struct FGeometryScriptMeshSelection           SelectionB;                                        // 0x0010(0x0010)
	struct FGeometryScriptMeshSelection           ResultSelection;                                   // 0x0020(0x0010)
	EGeometryScriptCombineSelectionMode           CombineMode;                                       // 0x0030(0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	TArray<int32>                                 IndexArray;                                        // 0x0008(0x0010)
	EGeometryScriptMeshSelectionType              SelectionType;                                     // 0x0018(0x0001)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0020(0x0010)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptIndexList               IndexList;                                         // 0x0008(0x0018)
	EGeometryScriptMeshSelectionType              SelectionType;                                     // 0x0020(0x0001)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0028(0x0010)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	TSet<int32>                                   IndexSet;                                          // 0x0008(0x0050)
	EGeometryScriptMeshSelectionType              SelectionType;                                     // 0x0058(0x0001)
	uint8                                         Pad_59[0x7];                                       // 0x0059(0x0007)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0060(0x0010)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0070(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           FromSelection;                                     // 0x0008(0x0010)
	struct FGeometryScriptMeshSelection           ToSelection;                                       // 0x0018(0x0010)
	EGeometryScriptMeshSelectionType              NewType;                                           // 0x0028(0x0001)
	bool                                          bAllowPartialInclusion;                            // 0x0029(0x0001)
	uint8                                         Pad_2A[0x6];                                       // 0x002A(0x0006)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	...
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	TArray<int32>                                 IndexArray;                                        // 0x0018(0x0010)
	EGeometryScriptMeshSelectionType              SelectionType;                                     // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FGeometryScriptIndexList               IndexList;                                         // 0x0018(0x0018)
	EGeometryScriptIndexType                      ResultListType;                                    // 0x0030(0x0001)
	EGeometryScriptIndexType                      ConvertToType;                                     // 0x0031(0x0001)
...
{
public:
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0000(0x0010)
	bool                                          bDisable;                                          // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FGeometryScriptMeshSelection           NewSelection;                                      // 0x0018(0x0010)
	int32                                         Iterations;                                        // 0x0028(0x0004)
	bool                                          bContract;                                         // 0x002C(0x0001)
	bool                                          bOnlyExpandToFaceNeighbours;                       // 0x002D(0x0001)
...
public:
	...
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FGeometryScriptMeshSelection           NewSelection;                                      // 0x0018(0x0010)
	EGeometryScriptTopologyConnectionType         ConnectionType;                                    // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0000(0x0010)
	EGeometryScriptMeshSelectionType              SelectionType;                                     // 0x0010(0x0001)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)
	int32                                         NumSelected;                                       // 0x0014(0x0004)
};
...
public:
	...
	EGeometryScriptMeshSelectionType              SelectionType;                                     // 0x0018(0x0001)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)
	int32                                         NumSelected;                                       // 0x001C(0x0004)
};
...
public:
	...
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FGeometryScriptMeshSelection           NewSelection;                                      // 0x0018(0x0010)
	bool                                          bOnlyToConnected;                                  // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	...
	double                                        MaxAngleDeg;                                       // 0x0030(0x0008)
	EGeometryScriptMeshSelectionType              SelectionType;                                     // 0x0038(0x0001)
	bool                                          bInvert;                                           // 0x0039(0x0001)
	uint8                                         Pad_3A[0x2];                                       // 0x003A(0x0002)
	int32                                         MinNumTrianglePoints;                              // 0x003C(0x0004)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0040(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FBox                                   Box;                                               // 0x0018(0x0038)
	EGeometryScriptMeshSelectionType              SelectionType;                                     // 0x0050(0x0001)
	bool                                          bInvert;                                           // 0x0051(0x0001)
	uint8                                         Pad_52[0x2];                                       // 0x0052(0x0002)
	int32                                         MinNumTrianglePoints;                              // 0x0054(0x0004)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0058(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	class UDynamicMesh*                           SelectionMesh;                                     // 0x0008(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0010(0x0010)
	struct FTransform                             SelectionMeshTransform;                            // 0x0020(0x0060)
	EGeometryScriptMeshSelectionType              SelectionType;                                     // 0x0080(0x0001)
	bool                                          bInvert;                                           // 0x0081(0x0001)
	uint8                                         Pad_82[0x6];                                       // 0x0082(0x0006)
	double                                        ShellDistance;                                     // 0x0088(0x0008)
	double                                        WindingThreshold;                                  // 0x0090(0x0008)
	int32                                         MinNumTrianglePoints;                              // 0x0098(0x0004)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00A0(0x0008)
	uint8                                         Pad_A8[0x8];                                       // 0x00A8(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FVector                                SphereOrigin;                                      // 0x0018(0x0018)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FVector                                PlaneOrigin;                                       // 0x0018(0x0018)
	struct FVector                                PlaneNormal;                                       // 0x0030(0x0018)
	EGeometryScriptMeshSelectionType              SelectionType;                                     // 0x0048(0x0001)
	bool                                          bInvert;                                           // 0x0049(0x0001)
	uint8                                         Pad_4A[0x2];                                       // 0x004A(0x0002)
	int32                                         MinNumTrianglePoints;                              // 0x004C(0x0004)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0050(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	double                                        MinAngleDeg;                                       // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FGeometryScriptMeshSelection           BoundarySelection;                                 // 0x0018(0x0010)
	bool                                          bExcludeMeshBoundaryEdges;                         // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	TArray<struct FGeometryScriptIndexList>       IndexLoops;                                        // 0x0018(0x0010)
	TArray<struct FGeometryScriptPolyPath>        PathLoops;                                         // 0x0028(0x0010)
	int32                                         NumLoops;                                          // 0x0038(0x0004)
	bool                                          bFoundErrors;                                      // 0x003C(0x0001)
	uint8                                         Pad_3D[0x3];                                       // 0x003D(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0040(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0048(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FBox                                   SelectionBounds;                                   // 0x0018(0x0038)
	bool                                          bIsEmpty;                                          // 0x0050(0x0001)
	uint8                                         Pad_51[0x7];                                       // 0x0051(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0058(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0060(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptPlanarSimplifyOptions   Options;                                           // 0x0008(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0010(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptPolygroupSimplifyOptions Options;                                          // 0x0008(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	float                                         Tolerance;                                         // 0x0008(0x0004)
	struct FGeometryScriptSimplifyMeshOptions     Options;                                           // 0x000C(0x0007)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         TriangleCount;                                     // 0x0008(0x0004)
	struct FGeometryScriptSimplifyMeshOptions     Options;                                           // 0x000C(0x0007)
	uint8                                         Pad_13[0x5];                                       // 0x0013(0x0005)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         vertexcount;                                       // 0x0008(0x0004)
	struct FGeometryScriptSimplifyMeshOptions     Options;                                           // 0x000C(0x0007)
	uint8                                         Pad_13[0x5];                                       // 0x0013(0x0005)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptDynamicMeshBVH          OutputBVH;                                         // 0x0008(0x0020)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptDynamicMeshBVH          QueryBVH;                                          // 0x0008(0x0020)
	struct FVector                                QueryPoint;                                        // 0x0028(0x0018)
	struct FGeometryScriptSpatialQueryOptions     Options;                                           // 0x0040(0x000C)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)
	struct FGeometryScriptTrianglePoint           NearestResult;                                     // 0x0050(0x0038)
	EGeometryScriptSearchOutcomePins              Outcome;                                           // 0x0088(0x0001)
	uint8                                         Pad_89[0x7];                                       // 0x0089(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0090(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0098(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptDynamicMeshBVH          QueryBVH;                                          // 0x0008(0x0020)
	struct FVector                                RayOrigin;                                         // 0x0028(0x0018)
	struct FVector                                RayDirection;                                      // 0x0040(0x0018)
	struct FGeometryScriptSpatialQueryOptions     Options;                                           // 0x0058(0x000C)
	uint8                                         Pad_64[0x4];                                       // 0x0064(0x0004)
	struct FGeometryScriptRayHitResult            HitResult;                                         // 0x0068(0x0040)
	EGeometryScriptSearchOutcomePins              Outcome;                                           // 0x00A8(0x0001)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x00B0(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00B8(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptDynamicMeshBVH          TestBVH;                                           // 0x0008(0x0020)
...
public:
	...
	struct FVector                                QueryPoint;                                        // 0x0028(0x0018)
	struct FGeometryScriptSpatialQueryOptions     Options;                                           // 0x0040(0x000C)
	bool                                          bIsInside;                                         // 0x004C(0x0001)
	EGeometryScriptContainmentOutcomePins         Outcome;                                           // 0x004D(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptDynamicMeshBVH          UpdateBVH;                                         // 0x0008(0x0020)
	bool                                          bOnlyIfInvalid;                                    // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
{
public:
	struct FGeometryScriptDynamicMeshBVH          ResetBVH_0;                                        // 0x0000(0x0020)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptDynamicMeshBVH          QueryBVH;                                          // 0x0008(0x0020)
	struct FBox                                   QueryBox;                                          // 0x0028(0x0038)
	struct FGeometryScriptSpatialQueryOptions     Options;                                           // 0x0060(0x000C)
	uint8                                         Pad_6C[0x4];                                       // 0x006C(0x0004)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0070(0x0010)
	EGeometryScriptMeshSelectionType              SelectionType;                                     // 0x0080(0x0001)
	uint8                                         Pad_81[0x3];                                       // 0x0081(0x0003)
	int32                                         MinNumTrianglePoints;                              // 0x0084(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptPNTessellateOptions     Options;                                           // 0x0008(0x0001)
	uint8                                         Pad_9[0x3];                                        // 0x0009(0x0003)
	int32                                         TessellationLevel;                                 // 0x000C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0010(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FGeometryScriptSelectiveTessellateOptions Options;                                        // 0x0018(0x0002)
	uint8                                         Pad_1A[0x2];                                       // 0x001A(0x0002)
	int32                                         TessellationLevel;                                 // 0x001C(0x0004)
	ESelectiveTessellatePatternType               PatternType;                                       // 0x0020(0x0001)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         TessellationLevel;                                 // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0010(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	...
	struct FVector                                RotationOrigin;                                    // 0x0020(0x0018)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0038(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0040(0x0008)
};
...
public:
	...
	struct FVector                                RotationOrigin;                                    // 0x0030(0x0018)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0048(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0050(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FVector                                Scale;                                             // 0x0008(0x0018)
	struct FVector                                ScaleOrigin;                                       // 0x0020(0x0018)
	bool                                          bFixOrientationForNegativeScale;                   // 0x0038(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FVector                                Scale;                                             // 0x0018(0x0018)
	struct FVector                                ScaleOrigin;                                       // 0x0030(0x0018)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0048(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0050(0x0008)
};
...
public:
	...
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	bool                                          bFixOrientationForNegativeScale;                   // 0x0070(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FVector                                Translation;                                       // 0x0008(0x0018)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0020(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	struct FVector                                Translation;                                       // 0x0018(0x0018)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FVector                                PivotLocation;                                     // 0x0008(0x0018)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0020(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	...
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FVector2D                              NewUVPosition;                                     // 0x0010(0x0010)
	int32                                         NewUVElementID;                                    // 0x0020(0x0004)
	bool                                          bIsValidUVSet;                                     // 0x0024(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x0025(0x0001)
...
public:
	...
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FGeometryScriptUVTexelDensityOptions   Options;                                           // 0x0010(0x0068)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0078(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	struct FGeometryScriptPatchBuilderOptions     Options;                                           // 0x000C(0x0034)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0040(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0048(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	struct FGeometryScriptXAtlasOptions           Options;                                           // 0x000C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0010(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FVector                                CenterPoint;                                       // 0x0008(0x0018)
	int32                                         CenterPointTriangleID;                             // 0x0020(0x0004)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	TArray<int32>                                 VertexIDs;                                         // 0x0028(0x0010)
	TArray<struct FVector2D>                      VertexUVs;                                         // 0x0038(0x0010)
	double                                        Radius;                                            // 0x0048(0x0008)
	bool                                          bUseInterpolatedNormal;                            // 0x0050(0x0001)
	uint8                                         Pad_51[0x7];                                       // 0x0051(0x0007)
	struct FVector                                TangentYDirection;                                 // 0x0058(0x0018)
	double                                        UVRotationDeg;                                     // 0x0070(0x0008)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0078(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0080(0x0008)
};
...
{
public:
	class UDynamicMesh*                           CopyFromUVMesh;                                    // 0x0000(0x0008)
	int32                                         ToUVSetIndex;                                      // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	class UDynamicMesh*                           CopyToMesh;                                        // 0x0010(0x0008)
	class UDynamicMesh*                           CopyToMeshOut;                                     // 0x0018(0x0008)
	bool                                          bFoundTopologyErrors;                              // 0x0020(0x0001)
	bool                                          bIsValidUVSet;                                     // 0x0021(0x0001)
	bool                                          bOnlyUVPositions;                                  // 0x0022(0x0001)
...
public:
	...
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	class UDynamicMesh*                           CopyToUVMesh;                                      // 0x0010(0x0008)
	class UDynamicMesh*                           CopyToUVMeshOut;                                   // 0x0018(0x0008)
	bool                                          bInvalidTopology;                                  // 0x0020(0x0001)
	bool                                          bIsValidUVSet;                                     // 0x0021(0x0001)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         FromUVSet;                                         // 0x0008(0x0004)
	int32                                         ToUVSet;                                           // 0x000C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0010(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FGeometryScriptUVList                  UVList;                                            // 0x0010(0x0010)
	bool                                          bIsValidUVSet;                                     // 0x0020(0x0001)
	bool                                          bHasVertexIDGaps;                                  // 0x0021(0x0001)
	bool                                          bHasSplitUVs;                                      // 0x0022(0x0001)
	uint8                                         Pad_23[0x5];                                       // 0x0023(0x0005)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
};
...
public:
	...
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	int32                                         TriangleID;                                        // 0x000C(0x0004)
	struct FIntVector                             TriangleUVElements;                                // 0x0010(0x000C)
	bool                                          bHaveValidUVs;                                     // 0x001C(0x0001)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	int32                                         ElementID;                                         // 0x000C(0x0004)
	struct FVector2D                              UVPosition;                                        // 0x0010(0x0010)
	bool                                          bIsValidElementID;                                 // 0x0020(0x0001)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0010(0x0010)
	double                                        MeshArea;                                          // 0x0020(0x0008)
	double                                        UVArea;                                            // 0x0028(0x0008)
	struct FBox                                   MeshBounds;                                        // 0x0030(0x0038)
	struct FBox2D                                 UVBounds;                                          // 0x0068(0x0028)
	bool                                          bIsValidUVSet;                                     // 0x0090(0x0001)
	bool                                          bFoundUnsetUVs;                                    // 0x0091(0x0001)
	bool                                          bOnlyIncludeValidUVTris;                           // 0x0092(0x0001)
	uint8                                         Pad_93[0x5];                                       // 0x0093(0x0005)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0098(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00A0(0x0008)
};
...
public:
	...
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FGeometryScriptLayoutUVsOptions        LayoutOptions;                                     // 0x0010(0x0078)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0088(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0098(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x00A0(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	struct FGeometryScriptRecomputeUVsOptions     Options;                                           // 0x000C(0x001C)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0028(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0038(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0040(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	struct FGeometryScriptRepackUVsOptions        RepackOptions;                                     // 0x000C(0x0008)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	float                                         RotationAngle;                                     // 0x000C(0x0004)
	struct FVector2D                              RotationOrigin;                                    // 0x0010(0x0010)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0020(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	...
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FVector2D                              Scale;                                             // 0x0010(0x0010)
	struct FVector2D                              ScaleOrigin;                                       // 0x0020(0x0010)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0030(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0040(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0048(0x0008)
};
...
public:
	...
	int32                                         TriangleID;                                        // 0x000C(0x0004)
	struct FIntVector                             TriangleUVElements;                                // 0x0010(0x000C)
	bool                                          bIsValidTriangle;                                  // 0x001C(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x001D(0x0001)
	uint8                                         Pad_1E[0x2];                                       // 0x001E(0x0002)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	...
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	int32                                         TriangleID;                                        // 0x000C(0x0004)
	struct FGeometryScriptUVTriangle              UVs;                                               // 0x0010(0x0030)
	bool                                          bIsValidTriangle;                                  // 0x0040(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x0041(0x0001)
...
public:
	...
	struct FVector2D                              NewUVPosition;                                     // 0x0010(0x0010)
	bool                                          bIsValidElementID;                                 // 0x0020(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x0021(0x0001)
	uint8                                         Pad_22[0x6];                                       // 0x0022(0x0006)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	...
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FTransform                             BoxTransform;                                      // 0x0010(0x0060)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0070(0x0010)
	int32                                         MinIslandTriCount;                                 // 0x0080(0x0004)
	uint8                                         Pad_84[0x4];                                       // 0x0084(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
...
public:
	...
	int32                                         UvSetIndex;                                        // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FTransform                             CylinderTransform;                                 // 0x0010(0x0060)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0070(0x0010)
	float                                         SplitAngle;                                        // 0x0080(0x0004)
	uint8                                         Pad_84[0x4];                                       // 0x0084(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0010(0x0010)
	bool                                          bInsertSeams;                                      // 0x0020(0x0001)
	bool                                          bDeferChangeNotifications;                         // 0x0021(0x0001)
	uint8                                         Pad_22[0x6];                                       // 0x0022(0x0006)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0028(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0030(0x0008)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMeshSelection           Selection;                                         // 0x0008(0x0010)
	int32                                         NumIterations;                                     // 0x0018(0x0004)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	double                                        Strength;                                          // 0x0020(0x0008)
	EGeometryScriptBlurColorMode                  BlurMode;                                          // 0x0028(0x0001)
	struct FGeometryScriptBlurMeshVertexColorsOptions Options;                                       // 0x0029(0x0004)
	uint8                                         Pad_2D[0x3];                                       // 0x002D(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptColorList               ColorList;                                         // 0x0008(0x0010)
	bool                                          bIsValidColorSet;                                  // 0x0018(0x0001)
	bool                                          bHasVertexIDGaps;                                  // 0x0019(0x0001)
	bool                                          bBlendSplitVertexValues;                           // 0x001A(0x0001)
	uint8                                         Pad_1B[0x5];                                       // 0x001B(0x0005)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	...
	struct FGeometryScriptColorFlags              Flags_0;                                           // 0x0018(0x0004)
	bool                                          bClearExisting;                                    // 0x001C(0x0001)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0020(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptColorList               VertexColorList;                                   // 0x0008(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0018(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0020(0x0008)
};
...
public:
	...
	struct FGeometryScriptColorFlags              Flags_0;                                           // 0x0028(0x0004)
	bool                                          bCreateColorSeam;                                  // 0x002C(0x0001)
	uint8                                         Pad_2D[0x3];                                       // 0x002D(0x0003)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptMorphologyOptions       Options;                                           // 0x0008(0x0024)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0000(0x0008)
	struct FGeometryScriptSolidifyOptions         Options;                                           // 0x0008(0x0028)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0030(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0038(0x0008)
};
...
{
public:
	TArray<struct FVector>                        Points;                                            // 0x0000(0x0010)
	struct FGeometryScriptPointPriorityOptions    Options;                                           // 0x0010(0x0018)
	struct FGeometryScriptIndexList               DownsampledIndices;                                // 0x0028(0x0018)
	int32                                         KeepNumPoints;                                     // 0x0040(0x0004)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0048(0x0008)
};
...
{
public:
	TArray<struct FVector>                        PointsIn3D;                                        // 0x0000(0x0010)
	TArray<struct FVector2D>                      PointsIn2D;                                        // 0x0010(0x0010)
	struct FGeometryScriptPointFlatteningOptions  Options;                                           // 0x0020(0x0070)
};
...
{
public:
	TArray<struct FVector>                        AllPoints;                                         // 0x0000(0x0010)
	struct FGeometryScriptIndexList               Indices;                                           // 0x0010(0x0018)
	TArray<struct FVector>                        SelectedPoints;                                    // 0x0028(0x0010)
};
...
public:
	TArray<struct FVector>                        Points;                                            // 0x0000(0x0010)
	struct FGeometryScriptPointClusteringOptions  Options;                                           // 0x0010(0x0020)
	TArray<struct FGeometryScriptIndexList>       ClusterIDToLists;                                  // 0x0030(0x0010)
};
...
public:
	TArray<struct FVector>                        Points;                                            // 0x0000(0x0010)
	struct FGeometryScriptPointClusteringOptions  Options;                                           // 0x0010(0x0020)
	TArray<int32>                                 PointClusterIndices;                               // 0x0030(0x0010)
};
...
public:
	TArray<struct FVector>                        Points;                                            // 0x0000(0x0010)
	double                                        ExpandBy;                                          // 0x0010(0x0008)
	struct FBox                                   ReturnValue;                                       // 0x0018(0x0038)
};
...
public:
	...
	EGeometryScriptCoordinateSpace                Space;                                             // 0x0030(0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
};
...
public:
	TArray<struct FTransform>                     Transforms;                                        // 0x0000(0x0010)
	TArray<struct FVector>                        Points;                                            // 0x0010(0x0010)
};
...
{
public:
	TArray<struct FVector2D>                      PointsIn2D;                                        // 0x0000(0x0010)
	TArray<struct FVector>                        PointsIn3D;                                        // 0x0010(0x0010)
	struct FGeometryScriptPointFlatteningOptions  Options;                                           // 0x0020(0x0070)
	double                                        Height;                                            // 0x0090(0x0008)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
};
...
{
public:
	struct FGeometryScriptSimplePolygon           Polygon;                                           // 0x0000(0x0010)
	struct FVector2D                              position;                                          // 0x0010(0x0010)
	int32                                         ReturnValue;                                       // 0x0020(0x0004)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
};
...
{
public:
	TArray<struct FVector2D>                      PathVertices;                                      // 0x0000(0x0010)
	struct FGeometryScriptSimplePolygon           ReturnValue;                                       // 0x0010(0x0010)
};
...
{
public:
	TArray<struct FVector>                        PathVertices;                                      // 0x0000(0x0010)
	struct FGeometryScriptSimplePolygon           ReturnValue;                                       // 0x0010(0x0010)
};
...
{
public:
	const class USplineComponent*                 Spline;                                            // 0x0000(0x0008)
	struct FGeometryScriptSimplePolygon           Polygon;                                           // 0x0008(0x0010)
	struct FGeometryScriptSplineSamplingOptions   SamplingOptions;                                   // 0x0018(0x0014)
	EGeometryScriptAxis                           DropAxis;                                          // 0x002C(0x0001)
	uint8                                         Pad_2D[0x3];                                       // 0x002D(0x0003)
};
...
public:
	struct FGeometryScriptSimplePolygon           Polygon;                                           // 0x0000(0x0010)
	int32                                         VertexIndex;                                       // 0x0010(0x0004)
	bool                                          bPolygonIsEmpty;                                   // 0x0014(0x0001)
	uint8                                         Pad_15[0x3];                                       // 0x0015(0x0003)
	struct FVector2D                              ReturnValue;                                       // 0x0018(0x0010)
};
...
public:
	...
	int32                                         VertexIndex;                                       // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	struct FVector2D                              position;                                          // 0x0018(0x0010)
	bool                                          bPolygonIsEmpty;                                   // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
};
...
{
public:
	struct FGeometryScriptGeneralPolygonList      PolygonList;                                       // 0x0000(0x0010)
	struct FGeometryScriptSimplePolygon           OuterPolygon;                                      // 0x0010(0x0010)
	TArray<struct FGeometryScriptSimplePolygon>   HolePolygons;                                      // 0x0020(0x0010)
	bool                                          bFixHoleOrientations;                              // 0x0030(0x0001)
...
public:
	struct FGeometryScriptGeneralPolygonList      PolygonList;                                       // 0x0000(0x0010)
	struct FGeometryScriptGeneralPolygonList      PolygonsToAppend;                                  // 0x0010(0x0010)
};
...
{
public:
	TArray<struct FGeometryScriptSimplePolygon>   OuterPolygons;                                     // 0x0000(0x0010)
	struct FGeometryScriptGeneralPolygonList      ReturnValue;                                       // 0x0010(0x0010)
};
...
{
public:
	struct FGeometryScriptSimplePolygon           OuterPolygon;                                      // 0x0000(0x0010)
	TArray<struct FGeometryScriptSimplePolygon>   HolePolygons;                                      // 0x0010(0x0010)
	bool                                          bFixHoleOrientations;                              // 0x0020(0x0001)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)
	struct FGeometryScriptGeneralPolygonList      ReturnValue;                                       // 0x0028(0x0010)
};
...
{
public:
	TArray<struct FGeometryScriptPolyPath>        PolyPaths;                                         // 0x0000(0x0010)
	struct FGeometryScriptOpenPathOffsetOptions   OffsetOptions;                                     // 0x0010(0x0028)
	double                                        Offset;                                            // 0x0038(0x0008)
	bool                                          bOperationSuccess;                                 // 0x0040(0x0001)
	bool                                          bCopyInputOnFailure;                               // 0x0041(0x0001)
	uint8                                         Pad_42[0x6];                                       // 0x0042(0x0006)
	struct FGeometryScriptGeneralPolygonList      ReturnValue;                                       // 0x0048(0x0010)
};
...
{
public:
	TArray<struct FVector2D>                      Path;                                              // 0x0000(0x0010)
	struct FGeometryScriptOpenPathOffsetOptions   OffsetOptions;                                     // 0x0010(0x0028)
	double                                        Offset;                                            // 0x0038(0x0008)
	bool                                          bOperationSuccess;                                 // 0x0040(0x0001)
	bool                                          bCopyInputOnFailure;                               // 0x0041(0x0001)
...
public:
	struct FGeometryScriptGeneralPolygonList      PolygonList;                                       // 0x0000(0x0010)
	bool                                          bValidIndex;                                       // 0x0010(0x0001)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)
	int32                                         PolygonIndex;                                      // 0x0014(0x0004)
	double                                        ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	...
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)
	int32                                         PolygonIndex;                                      // 0x0014(0x0004)
	struct FBox2D                                 ReturnValue;                                       // 0x0018(0x0028)
};
...
public:
	struct FGeometryScriptGeneralPolygonList      PolygonList;                                       // 0x0000(0x0010)
	bool                                          bIsValidVertex;                                    // 0x0010(0x0001)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)
	int32                                         VertexIndex;                                       // 0x0014(0x0004)
	int32                                         PolygonIndex;                                      // 0x0018(0x0004)
	int32                                         HoleIndex;                                         // 0x001C(0x0004)
...
public:
	struct FGeometryScriptGeneralPolygonList      PolygonList;                                       // 0x0000(0x0010)
	bool                                          bValidIndices;                                     // 0x0010(0x0001)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)
	int32                                         PolygonIndex;                                      // 0x0014(0x0004)
	int32                                         HoleIndex;                                         // 0x0018(0x0004)
	int32                                         ReturnValue;                                       // 0x001C(0x0004)
};
...
public:
	struct FGeometryScriptGeneralPolygonList      PolygonList;                                       // 0x0000(0x0010)
	TArray<struct FVector2D>                      OutVertices;                                       // 0x0010(0x0010)
	bool                                          bValidIndices;                                     // 0x0020(0x0001)
	uint8                                         Pad_21[0x3];                                       // 0x0021(0x0003)
	int32                                         PolygonIndex;                                      // 0x0024(0x0004)
	int32                                         HoleIndex;                                         // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
};
...
public:
	...
	int32                                         HoleIndex;                                         // 0x0018(0x0004)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	struct FGeometryScriptSimplePolygon           ReturnValue;                                       // 0x0020(0x0010)
};
...
public:
	struct FGeometryScriptGeneralPolygonList      PolygonList;                                       // 0x0000(0x0010)
	struct FGeometryScriptGeneralPolygonList      PolygonsToSubtract;                                // 0x0010(0x0010)
	struct FGeometryScriptGeneralPolygonList      ReturnValue;                                       // 0x0020(0x0010)
};
...
public:
	struct FGeometryScriptGeneralPolygonList      PolygonList;                                       // 0x0000(0x0010)
	struct FGeometryScriptGeneralPolygonList      PolygonsToExclusiveOr;                             // 0x0010(0x0010)
	struct FGeometryScriptGeneralPolygonList      ReturnValue;                                       // 0x0020(0x0010)
};
...
public:
	struct FGeometryScriptGeneralPolygonList      PolygonList;                                       // 0x0000(0x0010)
	struct FGeometryScriptGeneralPolygonList      PolygonsToIntersect;                               // 0x0010(0x0010)
	struct FGeometryScriptGeneralPolygonList      ReturnValue;                                       // 0x0020(0x0010)
};
...
public:
	struct FGeometryScriptGeneralPolygonList      PolygonList;                                       // 0x0000(0x0010)
	struct FGeometryScriptPolygonOffsetOptions    OffsetOptions;                                     // 0x0010(0x0028)
	double                                        Offset;                                            // 0x0038(0x0008)
	bool                                          bOperationSuccess;                                 // 0x0040(0x0001)
	bool                                          bCopyInputOnFailure;                               // 0x0041(0x0001)
	uint8                                         Pad_42[0x6];                                       // 0x0042(0x0006)
...
public:
	struct FGeometryScriptGeneralPolygonList      PolygonList;                                       // 0x0000(0x0010)
	struct FGeometryScriptPolygonOffsetOptions    OffsetOptions;                                     // 0x0010(0x0028)
	double                                        FirstOffset;                                       // 0x0038(0x0008)
	double                                        SecondOffset;                                      // 0x0040(0x0008)
	bool                                          bOperationSuccess;                                 // 0x0048(0x0001)
	bool                                          bCopyInputOnFailure;                               // 0x0049(0x0001)
	uint8                                         Pad_4A[0x6];                                       // 0x004A(0x0006)
	struct FGeometryScriptGeneralPolygonList      ReturnValue;                                       // 0x0050(0x0010)
};
...
public:
	struct FGeometryScriptGeneralPolygonList      PolygonList;                                       // 0x0000(0x0010)
	bool                                          bCopyInputOnFailure;                               // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
	struct FGeometryScriptGeneralPolygonList      ReturnValue;                                       // 0x0018(0x0010)
};
...
public:
	TArray<struct FVector2D>                      PathVertices;                                      // 0x0000(0x0010)
	struct FGeometryScriptPolyPath                ReturnValue;                                       // 0x0010(0x0018)
};
...
{
public:
	struct FGeometryScriptPolyPath                PolyPath;                                          // 0x0000(0x0018)
...
public:
	struct FGeometryScriptPolyPath                PolyPath;                                          // 0x0000(0x0018)
	TArray<struct FVector2D>                      ReturnValue;                                       // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FVector2D>                      VertexArray;                                       // 0x0000(0x0010)
	struct FGeometryScriptPolyPath                PolyPath;                                          // 0x0010(0x0018)
};
...
{
public:
	TArray<struct FVector>                        VertexArray;                                       // 0x0000(0x0010)
	struct FGeometryScriptPolyPath                PolyPath;                                          // 0x0010(0x0018)
};
...
public:
	struct FGeometryScriptPolyPath                PolyPath;                                          // 0x0000(0x0018)
	TArray<struct FVector>                        VertexArray;                                       // 0x0018(0x0010)
};
...
public:
	struct FGeometryScriptPolyPath                PolyPath;                                          // 0x0000(0x0018)
	TArray<struct FVector2D>                      VertexArray;                                       // 0x0018(0x0010)
};
...
public:
	const class USplineComponent*                 Spline;                                            // 0x0000(0x0008)
	struct FGeometryScriptPolyPath                PolyPath;                                          // 0x0008(0x0018)
	struct FGeometryScriptSplineSamplingOptions   SamplingOptions;                                   // 0x0020(0x0014)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)
};
...
{
public:
	struct FVector2D                              Center;                                            // 0x0000(0x0010)
	float                                         Radius;                                            // 0x0010(0x0004)
	int32                                         NumPoints;                                         // 0x0014(0x0004)
	float                                         startAngle;                                        // 0x0018(0x0004)
	float                                         endAngle;                                          // 0x001C(0x0004)
	struct FGeometryScriptPolyPath                ReturnValue;                                       // 0x0020(0x0018)
};
...
public:
	...
	int32                                         NumPoints;                                         // 0x0064(0x0004)
	float                                         startAngle;                                        // 0x0068(0x0004)
	float                                         endAngle;                                          // 0x006C(0x0004)
	struct FGeometryScriptPolyPath                ReturnValue;                                       // 0x0070(0x0018)
	uint8                                         Pad_88[0x8];                                       // 0x0088(0x0008)
};
...
public:
	...
	float                                         Radius;                                            // 0x0010(0x0004)
	int32                                         NumPoints;                                         // 0x0014(0x0004)
	struct FGeometryScriptPolyPath                ReturnValue;                                       // 0x0018(0x0018)
};
...
public:
	...
	float                                         Radius;                                            // 0x0060(0x0004)
	int32                                         NumPoints;                                         // 0x0064(0x0004)
	struct FGeometryScriptPolyPath                ReturnValue;                                       // 0x0068(0x0018)
};
...
public:
	struct FGeometryScriptPolyPath                PolyPath;                                          // 0x0000(0x0018)
	EGeometryScriptAxis                           DropAxis;                                          // 0x0018(0x0001)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)
	struct FGeometryScriptPolyPath                ReturnValue;                                       // 0x0020(0x0018)
};
...
public:
	struct FGeometryScriptPolyPath                PolyPath;                                          // 0x0000(0x0018)
	struct FVector                                Point;                                             // 0x0018(0x0018)
	int32                                         ReturnValue;                                       // 0x0030(0x0004)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)
};
...
public:
	const class USplineComponent*                 Spline;                                            // 0x0000(0x0008)
	TArray<struct FTransform>                     Frames;                                            // 0x0008(0x0010)
	TArray<double>                                FrameTimes;                                        // 0x0018(0x0010)
	struct FGeometryScriptSplineSamplingOptions   SamplingOptions;                                   // 0x0028(0x0014)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
	struct FTransform                             RelativeTransform;                                 // 0x0040(0x0060)
	bool                                          bIncludeScale;                                     // 0x00A0(0x0001)
	bool                                          ReturnValue;                                       // 0x00A1(0x0001)
...
public:
	...
	class UDynamicMesh*                           ToDynamicMesh;                                     // 0x0008(0x0008)
	bool                                          bTransformToWorld;                                 // 0x0010(0x0001)
	uint8                                         Pad_11[0xF];                                       // 0x0011(0x000F)
	struct FTransform                             LocalToWorld;                                      // 0x0020(0x0060)
	EGeometryScriptOutcomePins                    Outcome;                                           // 0x0080(0x0001)
	bool                                          bUseComplexCollision;                              // 0x0081(0x0001)
	uint8                                         Pad_82[0x2];                                       // 0x0082(0x0002)
	int32                                         SphereResolution;                                  // 0x0084(0x0004)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0088(0x0008)
	class UDynamicMesh*                           ReturnValue;                                       // 0x0090(0x0008)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
};
...
public:
	...
	class UDynamicMesh*                           ToDynamicMesh;                                     // 0x0008(0x0008)
	struct FGeometryScriptCopyMeshFromComponentOptions Options;                                      // 0x0010(0x000C)
	bool                                          bTransformToWorld;                                 // 0x001C(0x0001)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)
	struct FTransform                             LocalToWorld;                                      // 0x0020(0x0060)
	EGeometryScriptOutcomePins                    Outcome;                                           // 0x0080(0x0001)
	uint8                                         Pad_81[0x7];                                       // 0x0081(0x0007)
...
{
public:
	TArray<class UDynamicMesh*>                   SourceMeshes;                                      // 0x0000(0x0010)
	TArray<struct FTransform>                     SourceMeshTransforms;                              // 0x0010(0x0010)
	TArray<bool>                                  OutMeshIsHidden;                                   // 0x0020(0x0010)
	TArray<class UDynamicMesh*>                   TransparentMeshes;                                 // 0x0030(0x0010)
	TArray<struct FTransform>                     TransparentMeshTransforms;                         // 0x0040(0x0010)
	TArray<bool>                                  OutTransparentMeshIsHidden;                        // 0x0050(0x0010)
	TArray<class UDynamicMesh*>                   OccludeMeshes;                                     // 0x0060(0x0010)
	TArray<struct FTransform>                     OccludeMeshTransforms;                             // 0x0070(0x0010)
	struct FGeometryScriptDetermineMeshOcclusionOptions OcclusionOptions;                            // 0x0080(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0090(0x0008)
};
...
public:
	struct FTransform                             Transform;                                         // 0x0000(0x0060)
	EGeometryScriptAxis                           Axis;                                              // 0x0060(0x0001)
	uint8                                         Pad_61[0xF];                                       // 0x0061(0x000F)
	struct FPlane                                 ReturnValue;                                       // 0x0070(0x0020)
};
...
public:
	...
	EGeometryScriptAxis                           Axis;                                              // 0x0060(0x0001)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)
	struct FRay                                   ReturnValue;                                       // 0x0068(0x0030)
	uint8                                         Pad_98[0x8];                                       // 0x0098(0x0008)
};
...
public:
	...
	EGeometryScriptAxis                           Axis;                                              // 0x0060(0x0001)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)
	struct FVector                                ReturnValue;                                       // 0x0068(0x0018)
};
...
public:
	...
	struct FVector                                ZAxis;                                             // 0x0018(0x0018)
	struct FVector                                TangentAxis;                                       // 0x0030(0x0018)
	bool                                          bTangentIsX;                                       // 0x0048(0x0001)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)
	struct FTransform                             ReturnValue;                                       // 0x0050(0x0060)
};
...
{
public:
	struct FRay                                   Ray;                                               // 0x0000(0x0030)
	struct FBox                                   Box;                                               // 0x0030(0x0038)
	double                                        HitDistance;                                       // 0x0068(0x0008)
...
public:
	struct FRay                                   Ray;                                               // 0x0000(0x0030)
	struct FVector                                LineOrigin;                                        // 0x0030(0x0018)
	struct FVector                                LineDirection;                                     // 0x0048(0x0018)
	double                                        RayParameter;                                      // 0x0060(0x0008)
	struct FVector                                RayPoint;                                          // 0x0068(0x0018)
	double                                        LineParameter;                                     // 0x0080(0x0008)
	struct FVector                                LinePoint;                                         // 0x0088(0x0018)
	double                                        ReturnValue;                                       // 0x00A0(0x0008)
};
...
public:
	struct FRay                                   Ray;                                               // 0x0000(0x0030)
	struct FVector                                Point;                                             // 0x0030(0x0018)
	double                                        ReturnValue;                                       // 0x0048(0x0008)
};
...
public:
	struct FRay                                   Ray;                                               // 0x0000(0x0030)
	struct FPlane                                 Plane;                                             // 0x0030(0x0020)
	double                                        HitDistance;                                       // 0x0050(0x0008)
...
public:
	struct FRay                                   Ray;                                               // 0x0000(0x0030)
	struct FVector                                SegStartPoint;                                     // 0x0030(0x0018)
	struct FVector                                SegEndPoint;                                       // 0x0048(0x0018)
	double                                        RayParameter;                                      // 0x0060(0x0008)
	struct FVector                                RayPoint;                                          // 0x0068(0x0018)
	struct FVector                                SegPoint;                                          // 0x0080(0x0018)
	double                                        ReturnValue;                                       // 0x0098(0x0008)
};
...
public:
	struct FRay                                   Ray;                                               // 0x0000(0x0030)
	struct FVector                                SphereCenter;                                      // 0x0030(0x0018)
	double                                        SphereRadius;                                      // 0x0048(0x0008)
	double                                        Distance1;                                         // 0x0050(0x0008)
	double                                        Distance2;                                         // 0x0058(0x0008)
...
public:
	struct FRay                                   Ray;                                               // 0x0000(0x0030)
	double                                        StartDistance;                                     // 0x0030(0x0008)
	double                                        EndDistance;                                       // 0x0038(0x0008)
	struct FVector                                StartPoint;                                        // 0x0040(0x0018)
	struct FVector                                Endpoint;                                          // 0x0058(0x0018)
};
...
public:
	...
	bool                                          bInvert;                                           // 0x0090(0x0001)
	uint8                                         Pad_91[0x7];                                       // 0x0091(0x0007)
	struct FRay                                   ReturnValue;                                       // 0x0098(0x0030)
	uint8                                         Pad_C8[0x8];                                       // 0x00C8(0x0008)
};
...
public:
	...
	struct FVector                                Direction;                                         // 0x0018(0x0018)
	bool                                          bDirectionIsNormalized;                            // 0x0030(0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
	struct FRay                                   ReturnValue;                                       // 0x0038(0x0030)
};
...
public:
	...
	struct FRay                                   ReturnValue;                                       // 0x0030(0x0030)
};
...
{
public:
	struct FBox                                   Box1;                                              // 0x0000(0x0038)
	struct FBox                                   Box2;                                              // 0x0038(0x0038)
	bool                                          bIsIntersecting;                                   // 0x0070(0x0001)
	uint8                                         Pad_71[0x7];                                       // 0x0071(0x0007)
	struct FBox                                   ReturnValue;                                       // 0x0078(0x0038)
};
...
public:
	...
	struct FVector                                Point;                                             // 0x0038(0x0018)
	bool                                          bIsInside;                                         // 0x0050(0x0001)
	uint8                                         Pad_51[0x7];                                       // 0x0051(0x0007)
	struct FVector                                ReturnValue;                                       // 0x0058(0x0018)
};
...
public:
	struct FBox                                   Box;                                               // 0x0000(0x0038)
	struct FVector                                Center;                                            // 0x0038(0x0018)
	struct FVector                                Dimensions;                                        // 0x0050(0x0018)
};
...
public:
	struct FBox                                   Box;                                               // 0x0000(0x0038)
	int32                                         CornerIndex;                                       // 0x0038(0x0004)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
...
public:
	struct FBox                                   Box;                                               // 0x0000(0x0038)
	int32                                         FaceIndex;                                         // 0x0038(0x0004)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
	struct FVector                                FaceNormal;                                        // 0x0040(0x0018)
	struct FVector                                ReturnValue;                                       // 0x0058(0x0018)
};
...
public:
	struct FBox                                   Box;                                               // 0x0000(0x0038)
	struct FVector                                Point;                                             // 0x0038(0x0018)
	double                                        ReturnValue;                                       // 0x0050(0x0008)
};
...
public:
	struct FBox                                   Box;                                               // 0x0000(0x0038)
	double                                        Volume;                                            // 0x0038(0x0008)
	double                                        SurfaceArea;                                       // 0x0040(0x0008)
};
...
public:
	struct FBox                                   Box;                                               // 0x0000(0x0038)
	struct FVector                                ExpandBy;                                          // 0x0038(0x0018)
	struct FBox                                   ReturnValue;                                       // 0x0050(0x0038)
};
...
public:
	...
	struct FBox                                   ReturnValue;                                       // 0x00A0(0x0038)
	uint8                                         Pad_D8[0x8];                                       // 0x00D8(0x0008)
};
...
public:
	...
	struct FVector                                Extents;                                           // 0x0018(0x0018)
	struct FBox                                   ReturnValue;                                       // 0x0030(0x0038)
};
...
public:
	struct FVector                                Center;                                            // 0x0000(0x0018)
	struct FVector                                Dimensions;                                        // 0x0018(0x0018)
	struct FBox                                   ReturnValue;                                       // 0x0030(0x0038)
};
...
public:
	struct FBox                                   Box;                                               // 0x0000(0x0038)
	struct FVector                                SphereCenter;                                      // 0x0038(0x0018)
	double                                        SphereRadius;                                      // 0x0050(0x0008)
	bool                                          ReturnValue;                                       // 0x0058(0x0001)
	uint8                                         Pad_59[0x7];                                       // 0x0059(0x0007)
};
...
public:
	struct FBox                                   Box;                                               // 0x0000(0x0038)
	struct FVector                                Point;                                             // 0x0038(0x0018)
	bool                                          bConsiderOnBoxAsInside;                            // 0x0050(0x0001)
	bool                                          ReturnValue;                                       // 0x0051(0x0001)
...
public:
	...
	struct FGeometryScriptSampleTextureOptions    SampleOptions;                                     // 0x0018(0x0028)
	struct FGeometryScriptColorList               ColorList;                                         // 0x0040(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0050(0x0008)
};
...
public:
	struct FGeometryScriptUVList                  UVList;                                            // 0x0000(0x0010)
	class UTextureRenderTarget2D*                 Texture;                                           // 0x0010(0x0008)
	struct FGeometryScriptSampleTextureOptions    SampleOptions;                                     // 0x0018(0x0028)
	struct FGeometryScriptColorList               ColorList;                                         // 0x0040(0x0010)
	class UGeometryScriptDebug*                   Debug;                                             // 0x0050(0x0008)
};
...
{
public:
	double                                        Constant;                                          // 0x0000(0x0008)
	struct FGeometryScriptScalarList              ScalarList;                                        // 0x0008(0x0010)
	struct FGeometryScriptScalarList              ReturnValue;                                       // 0x0018(0x0010)
};
...
public:
	double                                        Constant;                                          // 0x0000(0x0008)
	struct FGeometryScriptVectorList              VectorList;                                        // 0x0008(0x0010)
	struct FGeometryScriptVectorList              ReturnValue;                                       // 0x0018(0x0010)
};
...
{
public:
	struct FGeometryScriptScalarList              ScalarListA;                                       // 0x0000(0x0010)
	struct FGeometryScriptScalarList              ScalarListB;                                       // 0x0010(0x0010)
	double                                        ConstantA;                                         // 0x0020(0x0008)
	double                                        ConstantB;                                         // 0x0028(0x0008)
	struct FGeometryScriptScalarList              ReturnValue;                                       // 0x0030(0x0010)
};
...
public:
	struct FGeometryScriptScalarList              ScalarList;                                        // 0x0000(0x0010)
	double                                        Numerator;                                         // 0x0010(0x0008)
	double                                        SetOnFailure;                                      // 0x0018(0x0008)
	double                                        Epsilon;                                           // 0x0020(0x0008)
	struct FGeometryScriptScalarList              ReturnValue;                                       // 0x0028(0x0010)
};
...
public:
	struct FGeometryScriptScalarList              ScalarListA;                                       // 0x0000(0x0010)
	struct FGeometryScriptScalarList              ScalarListB;                                       // 0x0010(0x0010)
	double                                        ConstantMultiplier;                                // 0x0020(0x0008)
	struct FGeometryScriptScalarList              ReturnValue;                                       // 0x0028(0x0010)
};
...
public:
	struct FGeometryScriptScalarList              ScalarList;                                        // 0x0000(0x0010)
	struct FGeometryScriptVectorList              VectorList;                                        // 0x0010(0x0010)
	double                                        ScalarMultiplier;                                  // 0x0020(0x0008)
	struct FGeometryScriptVectorList              ReturnValue;                                       // 0x0028(0x0010)
};
...
{
public:
	struct FGeometryScriptVectorList              VectorListA;                                       // 0x0000(0x0010)
	struct FGeometryScriptVectorList              VectorListB;                                       // 0x0010(0x0010)
	double                                        ConstantA;                                         // 0x0020(0x0008)
	double                                        ConstantB;                                         // 0x0028(0x0008)
	struct FGeometryScriptVectorList              ReturnValue;                                       // 0x0030(0x0010)
};
...
public:
	struct FGeometryScriptVectorList              VectorListA;                                       // 0x0000(0x0010)
	struct FGeometryScriptVectorList              VectorListB;                                       // 0x0010(0x0010)
	struct FGeometryScriptVectorList              ReturnValue;                                       // 0x0020(0x0010)
};
...
public:
	struct FGeometryScriptVectorList              VectorListA;                                       // 0x0000(0x0010)
	struct FGeometryScriptVectorList              VectorListB;                                       // 0x0010(0x0010)
	struct FGeometryScriptScalarList              ReturnValue;                                       // 0x0020(0x0010)
};
...
public:
	struct FGeometryScriptVectorList              VectorList;                                        // 0x0000(0x0010)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	bool                                          bAsPosition;                                       // 0x0070(0x0001)
...
public:
	struct FGeometryScriptVectorList              VectorList;                                        // 0x0000(0x0010)
	struct FGeometryScriptScalarList              ReturnValue;                                       // 0x0010(0x0010)
};
...
public:
	struct FGeometryScriptVectorList              VectorList;                                        // 0x0000(0x0010)
	struct FVector                                SetOnFailure;                                      // 0x0010(0x0018)
};
...
public:
	struct FGeometryScriptVectorList              VectorList;                                        // 0x0000(0x0010)
	struct FPlane                                 Plane;                                             // 0x0010(0x0020)
};
...
public:
	struct FGeometryScriptVectorList              VectorList;                                        // 0x0000(0x0010)
	double                                        ConstantX;                                         // 0x0010(0x0008)
	double                                        ConstantY;                                         // 0x0018(0x0008)
	double                                        ConstantZ;                                         // 0x0020(0x0008)
	struct FGeometryScriptScalarList              ReturnValue;                                       // 0x0028(0x0010)
};
...
public:
	const class UDynamicMesh*                     TargetMesh;                                        // 0x0000(0x0008)
	class UVolumeTexture*                         VolumeTexture;                                     // 0x0008(0x0008)
	struct FComputeDistanceFieldSettings          DistanceSettings;                                  // 0x0010(0x001C)
	struct FDistanceFieldToTextureSettings        TextureSettings;                                   // 0x002C(0x0008)
	bool                                          ReturnValue;                                       // 0x0034(0x0001)
	uint8                                         Pad_35[0x3];                                       // 0x0035(0x0003)
};
