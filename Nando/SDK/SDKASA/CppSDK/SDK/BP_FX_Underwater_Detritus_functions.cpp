...
#include "BP_FX_Underwater_Detritus_classes.hpp"
#include "BP_FX_Underwater_Detritus_parameters.hpp"
...
void ABP_FX_Underwater_Detritus_C::Update_Niagara_Collection()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "Update Niagara Collection");
...
void ABP_FX_Underwater_Detritus_C::Try_Spawn_Emitter(bool* Sucess)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "Try Spawn Emitter");

	Params::BP_FX_Underwater_Detritus_C_Try_Spawn_Emitter Parms{};
...
void ABP_FX_Underwater_Detritus_C::SpawnEnvEffect(const struct FSTR_DynamicEnvEffectSettings& DynamicEffectSettings, const struct FVector& Location)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "SpawnEnvEffect");

	Params::BP_FX_Underwater_Detritus_C_SpawnEnvEffect Parms{};
...
void ABP_FX_Underwater_Detritus_C::SetupEmitterPools()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "SetupEmitterPools");
...
void ABP_FX_Underwater_Detritus_C::Setup_Emitter_Data()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "Setup Emitter Data");
...
void ABP_FX_Underwater_Detritus_C::SetSystemParamaters(class UFXSystemComponent* System, const struct FSTR_DynamicEnvEffectCustomParameters& EffectParameters)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "SetSystemParamaters");

	Params::BP_FX_Underwater_Detritus_C_SetSystemParamaters Parms{};
...
void ABP_FX_Underwater_Detritus_C::ReceiveBeginPlay()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "ReceiveBeginPlay");
...
void ABP_FX_Underwater_Detritus_C::PlayerSourceLocation(bool* ValidCamera, struct FVector* Location)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "PlayerSourceLocation");

	Params::BP_FX_Underwater_Detritus_C_PlayerSourceLocation Parms{};
...
void ABP_FX_Underwater_Detritus_C::IsEnabled(bool* TRUE_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "IsEnabled");

	Params::BP_FX_Underwater_Detritus_C_IsEnabled Parms{};
...
void ABP_FX_Underwater_Detritus_C::GetTraceOffsetsAroundPlayer(bool* Valid, struct FVector* Start, struct FVector* End)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "GetTraceOffsetsAroundPlayer");

	Params::BP_FX_Underwater_Detritus_C_GetTraceOffsetsAroundPlayer Parms{};
...
void ABP_FX_Underwater_Detritus_C::GetParticleForSurface(EPhysicalSurface Phys_Mat, bool Underwater, bool* Valid, struct FSTR_DynamicEnvEffectSettings* Effect)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "GetParticleForSurface");

	Params::BP_FX_Underwater_Detritus_C_GetParticleForSurface Parms{};
...
void ABP_FX_Underwater_Detritus_C::ExecuteUbergraph_BP_FX_Underwater_Detritus(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "ExecuteUbergraph_BP_FX_Underwater_Detritus");

	Params::BP_FX_Underwater_Detritus_C_ExecuteUbergraph_BP_FX_Underwater_Detritus Parms{};
...
void ABP_FX_Underwater_Detritus_C::CullSystemsAtDistance()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "CullSystemsAtDistance");
...
void ABP_FX_Underwater_Detritus_C::CheckEmitterPools(int32* Used, int32* max_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "CheckEmitterPools");

	Params::BP_FX_Underwater_Detritus_C_CheckEmitterPools Parms{};
...
void ABP_FX_Underwater_Detritus_C::CheckEmitterPool(const E_EmitterPool& Pool, bool* RoomLeft)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "CheckEmitterPool");

	Params::BP_FX_Underwater_Detritus_C_CheckEmitterPool Parms{};
...
void ABP_FX_Underwater_Detritus_C::AdjustEmitterCount(bool Add, E_EmitterPool EffectSettings)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_FX_Underwater_Detritus_C", "AdjustEmitterCount");

	Params::BP_FX_Underwater_Detritus_C_AdjustEmitterCount Parms{};
