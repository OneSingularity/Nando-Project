...
{
public:
	class UDynamicMesh*                           ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	EDynamicMeshComponentColorOverrideMode        NewMode;                                           // 0x0000(0x0001)
};
...
{
public:
	struct FColor                                 NewColor;                                          // 0x0000(0x0004)
};
...
{
public:
	EDynamicMeshComponentDistanceFieldMode        NewDistFieldMode;                                  // 0x0000(0x0001)
};
...
{
public:
	bool                                          bSetEnabled;                                       // 0x0000(0x0001)
};
...
{
public:
	EDynamicMeshDrawPath                          NewDrawPath;                                       // 0x0000(0x0001)
};
...
{
public:
	bool                                          bSetVisible;                                       // 0x0000(0x0001)
};
...
{
public:
	EDynamicMeshVertexColorTransformMode          NewMode;                                           // 0x0000(0x0001)
};
...
{
public:
	EDynamicMeshComponentColorOverrideMode        ReturnValue;                                       // 0x0000(0x0001)
};
...
{
public:
	EDynamicMeshComponentDistanceFieldMode        ReturnValue;                                       // 0x0000(0x0001)
};
...
{
public:
	EDynamicMeshDrawPath                          ReturnValue;                                       // 0x0000(0x0001)
};
...
{
public:
	EDynamicMeshVertexColorTransformMode          ReturnValue;                                       // 0x0000(0x0001)
};
...
{
public:
	TArray<class UMaterialInterface*>             NewMaterialSet;                                    // 0x0000(0x0010)
	bool                                          bDeleteExtraSlots;                                 // 0x0010(0x0001)
...
{
public:
	bool                                          bPositions;                                        // 0x0000(0x0001)
	bool                                          bNormals;                                          // 0x0001(0x0001)
	bool                                          bUVs;                                              // 0x0002(0x0001)
	bool                                          bColors;                                           // 0x0003(0x0001)
};
...
{
public:
	bool                                          bInAllowsGeometrySelection;                        // 0x0000(0x0001)
};
...
public:
	bool                                          bEnabled;                                          // 0x0000(0x0001)
	bool                                          bImmediateUpdate;                                  // 0x0001(0x0001)
};
...
{
public:
	EDynamicMeshComponentTangentsMode             NewTangentsType;                                   // 0x0000(0x0001)
};
...
{
public:
	bool                                          bOnlyIfPending;                                    // 0x0000(0x0001)
};
...
{
public:
	bool                                          bCreateIfMissing;                                  // 0x0000(0x0001)
	bool                                          bDeleteExtraSlots;                                 // 0x0001(0x0001)
...
{
public:
	EDynamicMeshComponentTangentsMode             ReturnValue;                                       // 0x0000(0x0001)
};
...
{
public:
	class UDynamicMesh*                           Mesh;                                              // 0x0000(0x0008)
...
{
public:
	class UDynamicMeshComponent*                  ReturnValue;                                       // 0x0000(0x0008)
};
