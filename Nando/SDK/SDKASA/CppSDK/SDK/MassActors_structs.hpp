...
struct FMassActorSpawnRequest final
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)
	TSubclassOf<class AActor>                     Template;                                          // 0x0008(0x0008)
	uint8                                         Pad_10[0x90];                                      // 0x0010(0x0090)
...
struct FMassGuidFragment final : public FObjectWrapperFragment
{
public:
...
struct FCapsuleComponentWrapperFragment final : public FObjectWrapperFragment
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)
};
...
// 0x0008 (0x0008 - 0x0000)
struct FCharacterMovementComponentWrapperFragment final : public FObjectWrapperFragment
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)
};
...
// 0x0008 (0x0008 - 0x0000)
struct FMassSceneComponentWrapperFragment final : public FObjectWrapperFragment
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)
};
...
// 0x0008 (0x0008 - 0x0000)
struct FDataFragment_BehaviorTreeComponentWrapper final : public FObjectWrapperFragment
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)
};
