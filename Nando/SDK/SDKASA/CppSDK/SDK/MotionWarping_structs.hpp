...
public:
	...
	class FName                                   BoneName;                                          // 0x0040(0x0008)
	bool                                          bFollowComponent;                                  // 0x0048(0x0001)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)
	struct FVector                                LocationOffset;                                    // 0x0050(0x0018)
	struct FRotator                               RotationOffset;                                    // 0x0068(0x0018)
};
...
{
public:
	TArray<struct FTransform>                     BoneTransformTrack;                                // 0x0000(0x0010)
	TArray<struct FVector>                        DeltaTranslationTrack;                             // 0x0010(0x0010)
	TArray<struct FRotator>                       DeltaRotationTrack;                                // 0x0020(0x0010)
	struct FVector                                TotalTranslation;                                  // 0x0030(0x0018)
	struct FRotator                               TotalRotation;                                     // 0x0048(0x0018)
};
...
{
public:
	TArray<struct FMotionDeltaTrack>              Tracks;                                            // 0x0000(0x0010)
};
