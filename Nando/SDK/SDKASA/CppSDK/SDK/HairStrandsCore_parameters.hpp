...
{
public:
	TArray<int32>                                 ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsCardsSourceDescription> ReturnValue;                                    // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsInterpolation>       ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsLOD>                 ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsMaterial>            ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsMeshesSourceDescription> ReturnValue;                                   // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsPhysics>             ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsRendering>           ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsCardsSourceDescription> In;                                             // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsInterpolation>       In;                                                // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsLOD>                 In;                                                // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsMaterial>            In;                                                // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsMeshesSourceDescription> In;                                            // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsPhysics>             In;                                                // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FHairGroupsRendering>           In;                                                // 0x0000(0x0010)
};
...
{
public:
	EGroomInterpolationType                       In;                                                // 0x0000(0x0001)
};
...
{
public:
	class USkeletalMesh*                          In;                                                // 0x0000(0x0008)
};
...
{
public:
	EGroomInterpolationType                       ReturnValue;                                       // 0x0000(0x0001)
};
...
{
public:
	class UGroomAsset*                            InGroom;                                           // 0x0000(0x0008)
};
...
{
public:
	EGroomBindingMeshType                         InGroomBindingType;                                // 0x0000(0x0001)
};
...
{
public:
	TArray<struct FGoomBindingGroupInfo>          InGroupInfos;                                      // 0x0000(0x0010)
};
...
{
public:
	int32                                         InMatchingSection;                                 // 0x0000(0x0004)
};
...
{
public:
	int32                                         InNumInterpolationPoints;                          // 0x0000(0x0004)
};
...
{
public:
	class UGeometryCache*                         InGeometryCache;                                   // 0x0000(0x0008)
};
...
{
public:
	class UGroomAsset*                            ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	EGroomBindingMeshType                         ReturnValue;                                       // 0x0000(0x0001)
};
...
{
public:
	TArray<struct FGoomBindingGroupInfo>          ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	class UGeometryCache*                         ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	class UGroomAsset*                            GroomAsset;                                        // 0x0000(0x0008)
	class UGeometryCache*                         GeometryCache;                                     // 0x0008(0x0008)
	int32                                         NumInterpolationPoints;                            // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	class UGeometryCache*                         SourceGeometryCacheForTransfer;                    // 0x0018(0x0008)
	int32                                         MatchingSection;                                   // 0x0020(0x0004)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	class UGroomBindingAsset*                     ReturnValue;                                       // 0x0028(0x0008)
};
...
{
public:
	class FString                                 DesiredPackagePath;                                // 0x0000(0x0010)
	class UGroomAsset*                            GroomAsset;                                        // 0x0010(0x0008)
	class UGeometryCache*                         GeometryCache;                                     // 0x0018(0x0008)
	int32                                         NumInterpolationPoints;                            // 0x0020(0x0004)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	class UGeometryCache*                         SourceGeometryCacheForTransfer;                    // 0x0028(0x0008)
	int32                                         MatchingSection;                                   // 0x0030(0x0004)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)
	class UGroomBindingAsset*                     ReturnValue;                                       // 0x0038(0x0008)
};
...
{
public:
	class UGroomAsset*                            InGroomAsset;                                      // 0x0000(0x0008)
	class USkeletalMesh*                          InSkeletalMesh;                                    // 0x0008(0x0008)
	int32                                         InNumInterpolationPoints;                          // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	class USkeletalMesh*                          InSourceSkeletalMeshForTransfer;                   // 0x0018(0x0008)
	int32                                         InMatchingSection;                                 // 0x0020(0x0004)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	class UGroomBindingAsset*                     ReturnValue;                                       // 0x0028(0x0008)
};
...
public:
	...
	class UGroomAsset*                            InGroomAsset;                                      // 0x0010(0x0008)
	class USkeletalMesh*                          InSkeletalMesh;                                    // 0x0018(0x0008)
	int32                                         InNumInterpolationPoints;                          // 0x0020(0x0004)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	class USkeletalMesh*                          InSourceSkeletalMeshForTransfer;                   // 0x0028(0x0008)
	int32                                         InMatchingSection;                                 // 0x0030(0x0004)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)
	class UGroomBindingAsset*                     ReturnValue;                                       // 0x0038(0x0008)
};
...
{
public:
	int32                                         GroupIndex;                                        // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	class UNiagaraComponent*                      ReturnValue;                                       // 0x0008(0x0008)
};
...
{
public:
	class UGroomBindingAsset*                     InBinding;                                         // 0x0000(0x0008)
};
...
{
public:
	bool                                          bInEnableSimulation;                               // 0x0000(0x0001)
};
...
{
public:
	class UGroomAsset*                            Asset;                                             // 0x0000(0x0008)
};
...
{
public:
	class UGroomCache*                            InGroomCache;                                      // 0x0000(0x0008)
};
...
{
public:
	class UMeshDeformer*                          InMeshDeformer;                                    // 0x0000(0x0008)
};
...
{
public:
	class UPhysicsAsset*                          InPhysicsAsset;                                    // 0x0000(0x0008)
};
