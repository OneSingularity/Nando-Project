...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame;                                    // 0x0B90(0x0008)
	class UPrimalItem*                            SelfObj;                                           // 0x0B98(0x0008)
	TSoftClassPtr<class UClass>                   MyTekArmorBuff;                                    // 0x0BA0(0x0028)
	int32                                         MaxAmmo;                                           // 0x0BC8(0x0004)
	bool                                          bInfiniteAmmo;                                     // 0x0BCC(0x0001)
	uint8                                         Pad_BCD[0x3];                                      // 0x0BCD(0x0003)
	TArray<struct FMapSpecificTekArmorBuffs>      MapSpecificTekArmorBuffs;                          // 0x0BD0(0x0010)
	class UClass*                                 CachedResolvedTekArmorBuff;                        // 0x0BE0(0x0008)
	bool                                          bTekBuffDirty;                                     // 0x0BE8(0x0001)
