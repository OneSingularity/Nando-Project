...
{
public:
	TArray<uint8>                                 CookedCompressedBytes;                             // 0x0028(0x0010)
	TArray<uint64>                                CookedAnimSequenceMappings;                        // 0x0038(0x0010)
	uint8                                         Pad_48[0xD8];                                      // 0x0048(0x00D8)
	uint32                                        MaxStreamRequestSizeKB;                            // 0x0120(0x0004)
	EACLVisualFidelity                            DefaultVisualFidelity;                             // 0x0124(0x0001)
