...
public:
	...
	TArray<struct FLinearColor>                   ColorArray;                                        // 0x01A8(0x0010)
	bool                                          bNormalizeInput;                                   // 0x01B8(0x0001)
	uint8                                         Pad_1B9[0x3];                                      // 0x01B9(0x0003)
	struct FLinearColor                           Color;                                             // 0x01BC(0x0010)
...
{
public:
	int32                                         Index;                                             // 0x0198(0x0004)
	uint8                                         Pad_19C[0x4];                                      // 0x019C(0x0004)
	TArray<float>                                 FloatArray;                                        // 0x01A0(0x0010)
	float                                         FloatValue;                                        // 0x01B0(0x0004)
...
{
public:
	float                                         float_0;                                           // 0x0198(0x0004)
	float                                         ReturnValue;                                       // 0x019C(0x0004)
};
...
{
public:
	EFloatArrayToIntArrayFunctionEnum             Function;                                          // 0x0198(0x0001)
	uint8                                         Pad_199[0x7];                                      // 0x0199(0x0007)
	TArray<float>                                 FloatArray;                                        // 0x01A0(0x0010)
	TArray<int32>                                 IntArray;                                          // 0x01B0(0x0010)
};
...
public:
	...
	struct FDataflowSphereCovering                SphereCovering;                                    // 0x0248(0x0020)
	int32                                         ConvexCount;                                       // 0x0268(0x0004)
	uint8                                         Pad_26C[0x4];                                      // 0x026C(0x0004)
	double                                        ErrorTolerance;                                    // 0x0270(0x0008)
	bool                                          bPreferExternalCollisionShapes;                    // 0x0278(0x0001)
	EAllowConvexMergeMethod                       AllowMerges;                                       // 0x0279(0x0001)
	uint8                                         Pad_27A[0x6];                                      // 0x027A(0x0006)
	struct FDataflowTransformSelection            OptionalSelectionFilter;                           // 0x0280(0x0020)
	bool                                          bProtectNegativeSpace;                             // 0x02A0(0x0001)
	ENegativeSpaceSampleMethodDataflowEnum        SampleMethod;                                      // 0x02A1(0x0001)
	bool                                          bRequireSearchSampleCoverage;                      // 0x02A2(0x0001)
	bool                                          bOnlyConnectedToHull;                              // 0x02A3(0x0001)
	int32                                         TargetNumSamples;                                  // 0x02A4(0x0004)
	double                                        MinSampleSpacing;                                  // 0x02A8(0x0008)
	double                                        NegativeSpaceTolerance;                            // 0x02B0(0x0008)
	double                                        MinRadius;                                         // 0x02B8(0x0008)
};
...
public:
	int32                                         Index;                                             // 0x0198(0x0004)
	uint8                                         Pad_19C[0x4];                                      // 0x019C(0x0004)
	TArray<struct FVector>                        Points;                                            // 0x01A0(0x0010)
	struct FVector                                Point;                                             // 0x01B0(0x0018)
};
...
{
public:
	float                                         base;                                              // 0x0198(0x0004)
	float                                         exp;                                               // 0x019C(0x0004)
	float                                         ReturnValue;                                       // 0x01A0(0x0004)
...
public:
	TArray<float>                                 FloatArray;                                        // 0x0198(0x0010)
	TArray<int32>                                 IntArray;                                          // 0x01A8(0x0010)
	TArray<struct FVector>                        Points;                                            // 0x01B8(0x0010)
	TArray<struct FVector3f>                      Vector3fArray;                                     // 0x01C8(0x0010)
	int32                                         NumElements;                                       // 0x01D8(0x0004)
...
{
public:
	TArray<bool>                                  BoolAttributeData;                                 // 0x0198(0x0010)
	struct FDataflowFaceSelection                 FaceSelection;                                     // 0x01A8(0x0020)
};
...
{
public:
	struct FVector                                Vector;                                            // 0x0198(0x0018)
	float                                         Scale;                                             // 0x01B0(0x0004)
	uint8                                         Pad_1B4[0x4];                                      // 0x01B4(0x0004)
	struct FVector                                ScaledVector;                                      // 0x01B8(0x0018)
};
...
public:
	TArray<float>                                 FloatArray;                                        // 0x0198(0x0010)
	ECompareOperation1Enum                        Operation;                                         // 0x01A8(0x0001)
	uint8                                         Pad_1A9[0x3];                                      // 0x01A9(0x0003)
	float                                         threshold;                                         // 0x01AC(0x0004)
	struct FDataflowVertexSelection               VertexSelection;                                   // 0x01B0(0x0020)
};
...
{
public:
	TArray<float>                                 InFloatArray;                                      // 0x0198(0x0010)
	struct FDataflowVertexSelection               Selection;                                         // 0x01A8(0x0020)
	float                                         MinRange;                                          // 0x01C8(0x0004)
	float                                         MaxRange;                                          // 0x01CC(0x0004)
	TArray<float>                                 OutFloatArray;                                     // 0x01D0(0x0010)
};
...
{
public:
	TArray<struct FVector>                        InVectorArray;                                     // 0x0198(0x0010)
	struct FDataflowVertexSelection               Selection;                                         // 0x01A8(0x0020)
	float                                         Magnitude;                                         // 0x01C8(0x0004)
	uint8                                         Pad_1CC[0x4];                                      // 0x01CC(0x0004)
	TArray<struct FVector>                        OutVectorArray;                                    // 0x01D0(0x0010)
};
...
{
public:
	EClusterSizeMethodEnum                        ClusterSizeMethod;                                 // 0x0198(0x0001)
	uint8                                         Pad_199[0x3];                                      // 0x0199(0x0003)
	int32                                         ClusterSites;                                      // 0x019C(0x0004)
	float                                         ClusterFraction;                                   // 0x01A0(0x0004)
	float                                         SiteSize;                                          // 0x01A4(0x0004)
	int32                                         ClusterGridWidth;                                  // 0x01A8(0x0004)
	int32                                         ClusterGridDepth;                                  // 0x01AC(0x0004)
	int32                                         ClusterGridHeight;                                 // 0x01B0(0x0004)
	int32                                         DriftIterations;                                   // 0x01B4(0x0004)
	float                                         MinimumSize;                                       // 0x01B8(0x0004)
	bool                                          bPreferConvexity;                                  // 0x01BC(0x0001)
	uint8                                         Pad_1BD[0x3];                                      // 0x01BD(0x0003)
	float                                         ConcavityTolerance;                                // 0x01C0(0x0004)
	bool                                          AutoCluster;                                       // 0x01C4(0x0001)
	bool                                          EnforceSiteParameters;                             // 0x01C5(0x0001)
	bool                                          AvoidIsolated;                                     // 0x01C6(0x0001)
	uint8                                         Pad_1C7[0x1];                                      // 0x01C7(0x0001)
	struct FManagedArrayCollection                Collection;                                        // 0x01C8(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0278(0x0020)
};
...
{
public:
	TArray<int32>                                 InArray1;                                          // 0x0198(0x0010)
	TArray<int32>                                 InArray2;                                          // 0x01A8(0x0010)
	TArray<int32>                                 OutArray;                                          // 0x01B8(0x0010)
};
...
public:
	struct FVector                                Vector;                                            // 0x0198(0x0018)
	float                                         ReturnValue;                                       // 0x01B0(0x0004)
	uint8                                         Pad_1B4[0x4];                                      // 0x01B4(0x0004)
};
...
public:
	int32                                         Index;                                             // 0x0198(0x0004)
	bool                                          bPreserveOrder;                                    // 0x019C(0x0001)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0248(0x0020)
	bool                                          AddSamplesForCollision;                            // 0x0268(0x0001)
	uint8                                         Pad_269[0x3];                                      // 0x0269(0x0003)
	float                                         CollisionSampleSpacing;                            // 0x026C(0x0004)
};
...
public:
	TArray<float>                                 FloatArray;                                        // 0x0198(0x0010)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x01A8(0x0020)
	EStatisticsOperationEnum                      OperationName;                                     // 0x01C8(0x0001)
	uint8                                         Pad_1C9[0x3];                                      // 0x01C9(0x0003)
	float                                         Value;                                             // 0x01CC(0x0004)
	TArray<int32>                                 Indices;                                           // 0x01D0(0x0010)
};
...
public:
	TArray<float>                                 FloatArray;                                        // 0x0198(0x0010)
	float                                         RandomRangeMin;                                    // 0x01A8(0x0004)
	float                                         RandomRangeMax;                                    // 0x01AC(0x0004)
	int32                                         RandomSeed;                                        // 0x01B0(0x0004)
	uint8                                         Pad_1B4[0x4];                                      // 0x01B4(0x0004)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	TArray<class UMaterial*>                      Materials;                                         // 0x0248(0x0010)
	TArray<class UMaterialInterface*>             MaterialInstances;                                 // 0x0258(0x0010)
	TArray<struct FGeometryCollectionAutoInstanceMesh> InstancedMeshes;                              // 0x0268(0x0010)
};
...
{
public:
	bool                                          bDeterministic;                                    // 0x0198(0x0001)
	uint8                                         Pad_199[0x3];                                      // 0x0199(0x0003)
	float                                         RandomSeed;                                        // 0x019C(0x0004)
	float                                         min_0;                                             // 0x01A0(0x0004)
	float                                         max_0;                                             // 0x01A4(0x0004)
	float                                         ReturnValue;                                       // 0x01A8(0x0004)
...
{
public:
	class UGeometryCollection*                    Asset;                                             // 0x0198(0x0008)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            OptionalTransformSelection;                        // 0x0248(0x0020)
};
...
public:
	class UGeometryCollection*                    Asset;                                             // 0x0198(0x0008)
	TArray<struct FGeometryCollectionSource>      Sources;                                           // 0x01A0(0x0010)
};
...
{
public:
	TArray<struct FGeometryCollectionSource>      Sources;                                           // 0x0198(0x0010)
	struct FManagedArrayCollection                Collection;                                        // 0x01A8(0x00B0)
	TArray<class UMaterial*>                      Materials;                                         // 0x0258(0x0010)
	TArray<class UMaterialInterface*>             MaterialInstances;                                 // 0x0268(0x0010)
	TArray<struct FGeometryCollectionAutoInstanceMesh> InstancedMeshes;                              // 0x0278(0x0010)
};
...
{
public:
	class UGeometryCollection*                    GeometryCollection;                                // 0x0198(0x0008)
	struct FManagedArrayCollection                Collection;                                        // 0x01A0(0x00B0)
	TArray<class UMaterial*>                      Materials;                                         // 0x0250(0x0010)
	TArray<class UMaterialInterface*>             MaterialInstances;                                 // 0x0260(0x0010)
	TArray<struct FGeometryCollectionAutoInstanceMesh> InstancedMeshes;                              // 0x0270(0x0010)
};
...
public:
	...
	class FString                                 String;                                            // 0x01A8(0x0010)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FBox                                   BoundingBox;                                       // 0x0248(0x0038)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0280(0x0020)
	struct FTransform                             Transform;                                         // 0x02A0(0x0060)
	class UStaticMesh*                            CuttingStaticMesh;                                 // 0x0300(0x0008)
	bool                                          bUseHiRes;                                         // 0x0308(0x0001)
	uint8                                         Pad_309[0x3];                                      // 0x0309(0x0003)
	int32                                         LODLevel;                                          // 0x030C(0x0004)
	EMeshCutterCutDistribution                    CutDistribution;                                   // 0x0310(0x0001)
	uint8                                         Pad_311[0x3];                                      // 0x0311(0x0003)
	int32                                         NumberToScatter;                                   // 0x0314(0x0004)
	int32                                         GridX;                                             // 0x0318(0x0004)
	int32                                         GridY;                                             // 0x031C(0x0004)
	int32                                         GridZ;                                             // 0x0320(0x0004)
	float                                         Variability;                                       // 0x0324(0x0004)
	float                                         MinScaleFactor;                                    // 0x0328(0x0004)
	float                                         MaxScaleFactor;                                    // 0x032C(0x0004)
	bool                                          bRandomOrientation;                                // 0x0330(0x0001)
	uint8                                         Pad_331[0x3];                                      // 0x0331(0x0003)
	float                                         RollRange;                                         // 0x0334(0x0004)
	float                                         PitchRange;                                        // 0x0338(0x0004)
	float                                         YawRange;                                          // 0x033C(0x0004)
	int32                                         RandomSeed;                                        // 0x0340(0x0004)
	float                                         ChanceToFracture;                                  // 0x0344(0x0004)
	bool                                          SplitIslands;                                      // 0x0348(0x0001)
	bool                                          AddSamplesForCollision;                            // 0x0349(0x0001)
	uint8                                         Pad_34A[0x2];                                      // 0x034A(0x0002)
	float                                         CollisionSampleSpacing;                            // 0x034C(0x0004)
	struct FDataflowTransformSelection            NewGeometryTransformSelection;                     // 0x0350(0x0020)
};
...
{
public:
	class UBlueprint*                             Blueprint;                                         // 0x0198(0x0008)
	bool                                          bSplitComponents;                                  // 0x01A0(0x0001)
...
{
public:
	TArray<struct FVector3f>                      SamplePositions;                                   // 0x0198(0x0010)
	struct FDataflowVertexSelection               SampleIndices;                                     // 0x01A8(0x0020)
	struct FSphere                                Sphere;                                            // 0x01C8(0x0020)
	struct FVector                                Translation;                                       // 0x01E8(0x0018)
	float                                         Magnitude;                                         // 0x0200(0x0004)
	float                                         MinRange;                                          // 0x0204(0x0004)
	float                                         MaxRange;                                          // 0x0208(0x0004)
	float                                         Default;                                           // 0x020C(0x0004)
	EDataflowFieldFalloffType                     FalloffType;                                       // 0x0210(0x0001)
	uint8                                         Pad_211[0x7];                                      // 0x0211(0x0007)
	TArray<float>                                 FieldFloatResult;                                  // 0x0218(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x0228(0x0010)
	struct FDataflowVertexSelection               FieldSelectionMask;                                // 0x0238(0x0020)
	int32                                         NumSamplePositions;                                // 0x0258(0x0004)
...
{
public:
	struct FVector                                VectorA;                                           // 0x0198(0x0018)
	struct FVector                                VectorB;                                           // 0x01B0(0x0018)
	struct FVector                                ReturnValue;                                       // 0x01C8(0x0018)
};
...
public:
	TArray<struct FVector3f>                      SamplePositions;                                   // 0x0198(0x0010)
	struct FDataflowVertexSelection               SampleIndices;                                     // 0x01A8(0x0020)
	struct FBox                                   Box;                                               // 0x01C8(0x0038)
	struct FTransform                             Transform;                                         // 0x0200(0x0060)
	float                                         Magnitude;                                         // 0x0260(0x0004)
	float                                         MinRange;                                          // 0x0264(0x0004)
	float                                         MaxRange;                                          // 0x0268(0x0004)
	float                                         Default;                                           // 0x026C(0x0004)
	EDataflowFieldFalloffType                     FalloffType;                                       // 0x0270(0x0001)
	uint8                                         Pad_271[0x7];                                      // 0x0271(0x0007)
	TArray<float>                                 FieldFloatResult;                                  // 0x0278(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x0288(0x0010)
	struct FDataflowVertexSelection               FieldSelectionMask;                                // 0x0298(0x0020)
	int32                                         NumSamplePositions;                                // 0x02B8(0x0004)
...
public:
	TArray<struct FVector3f>                      SamplePositions;                                   // 0x0198(0x0010)
	struct FDataflowVertexSelection               SampleIndices;                                     // 0x01A8(0x0020)
	struct FVector                                position;                                          // 0x01C8(0x0018)
	struct FVector                                Normal;                                            // 0x01E0(0x0018)
	float                                         Distance;                                          // 0x01F8(0x0004)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	struct FVector                                Translation;                                       // 0x0200(0x0018)
	float                                         Magnitude;                                         // 0x0218(0x0004)
	float                                         MinRange;                                          // 0x021C(0x0004)
	float                                         MaxRange;                                          // 0x0220(0x0004)
	float                                         Default;                                           // 0x0224(0x0004)
	EDataflowFieldFalloffType                     FalloffType;                                       // 0x0228(0x0001)
	uint8                                         Pad_229[0x7];                                      // 0x0229(0x0007)
	TArray<float>                                 FieldFloatResult;                                  // 0x0230(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x0240(0x0010)
	struct FDataflowVertexSelection               FieldSelectionMask;                                // 0x0250(0x0020)
	int32                                         NumSamplePositions;                                // 0x0270(0x0004)
...
{
public:
	struct FVector                                Center;                                            // 0x0198(0x0018)
	float                                         Radius;                                            // 0x01B0(0x0004)
	uint8                                         Pad_1B4[0x4];                                      // 0x01B4(0x0004)
	struct FSphere                                Sphere;                                            // 0x01B8(0x0020)
};
...
public:
	...
	struct FSphere                                Sphere;                                            // 0x01C8(0x0020)
	struct FVector                                Translation;                                       // 0x01E8(0x0018)
	int32                                         InteriorValue;                                     // 0x0200(0x0004)
	int32                                         ExteriorValue;                                     // 0x0204(0x0004)
	EDataflowSetMaskConditionType                 SetMaskConditionType;                              // 0x0208(0x0001)
	uint8                                         Pad_209[0x7];                                      // 0x0209(0x0007)
	TArray<int32>                                 FieldIntResult;                                    // 0x0210(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x0220(0x0010)
	int32                                         NumSamplePositions;                                // 0x0230(0x0004)
...
public:
	...
	float                                         Magnitude;                                         // 0x01C8(0x0004)
	uint8                                         Pad_1CC[0x4];                                      // 0x01CC(0x0004)
	TArray<float>                                 FieldFloatResult;                                  // 0x01D0(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x01E0(0x0010)
	int32                                         NumSamplePositions;                                // 0x01F0(0x0004)
...
public:
	float                                         float_0;                                           // 0x0198(0x0004)
	float                                         min_0;                                             // 0x019C(0x0004)
	float                                         max_0;                                             // 0x01A0(0x0004)
	float                                         ReturnValue;                                       // 0x01A4(0x0004)
};
...
public:
	...
	float                                         Magnitude;                                         // 0x01C8(0x0004)
	uint8                                         Pad_1CC[0x4];                                      // 0x01CC(0x0004)
	struct FVector                                Direction;                                         // 0x01D0(0x0018)
	TArray<struct FVector>                        FieldVectorResult;                                 // 0x01E8(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x01F8(0x0010)
	int32                                         NumSamplePositions;                                // 0x0208(0x0004)
...
public:
	...
	float                                         Magnitude;                                         // 0x01C8(0x0004)
	uint8                                         Pad_1CC[0x4];                                      // 0x01CC(0x0004)
	struct FVector                                position;                                          // 0x01D0(0x0018)
	TArray<struct FVector>                        FieldVectorResult;                                 // 0x01E8(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x01F8(0x0010)
	int32                                         NumSamplePositions;                                // 0x0208(0x0004)
	uint8                                         Pad_20C[0x4];                                      // 0x020C(0x0004)
...
public:
	...
	struct FTransform                             MeshTransform;                                     // 0x01A0(0x0060)
	bool                                          bSetInternalFromMaterialIndex;                     // 0x0200(0x0001)
	bool                                          bSplitComponents;                                  // 0x0201(0x0001)
	uint8                                         Pad_202[0x6];                                      // 0x0202(0x0006)
	struct FManagedArrayCollection                Collection;                                        // 0x0208(0x00B0)
	TArray<class UMaterial*>                      Materials;                                         // 0x02B8(0x0010)
	TArray<class UMaterialInterface*>             MaterialInstances;                                 // 0x02C8(0x0010)
	TArray<struct FGeometryCollectionAutoInstanceMesh> InstancedMeshes;                              // 0x02D8(0x0010)
...
{
public:
	float                                         X;                                                 // 0x0198(0x0004)
	float                                         Y;                                                 // 0x019C(0x0004)
	float                                         Z;                                                 // 0x01A0(0x0004)
	uint8                                         Pad_1A4[0x4];                                      // 0x01A4(0x0004)
	struct FVector                                Vector;                                            // 0x01A8(0x0018)
};
...
public:
	...
	float                                         Magnitude;                                         // 0x01C8(0x0004)
	uint8                                         Pad_1CC[0x4];                                      // 0x01CC(0x0004)
	TArray<struct FVector>                        FieldVectorResult;                                 // 0x01D0(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x01E0(0x0010)
	int32                                         NumSamplePositions;                                // 0x01F0(0x0004)
	uint8                                         Pad_1F4[0x4];                                      // 0x01F4(0x0004)
};
...
public:
	...
	float                                         MinRange;                                          // 0x01C8(0x0004)
	float                                         MaxRange;                                          // 0x01CC(0x0004)
	struct FTransform                             Transform;                                         // 0x01D0(0x0060)
	TArray<float>                                 FieldFloatResult;                                  // 0x0230(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x0240(0x0010)
	int32                                         NumSamplePositions;                                // 0x0250(0x0004)
	uint8                                         Pad_254[0xC];                                      // 0x0254(0x000C)
};
...
public:
	...
	uint8                                         Pad_199[0x3];                                      // 0x0199(0x0003)
	float                                         RandomSeed;                                        // 0x019C(0x0004)
	struct FVector                                ConeDirection;                                     // 0x01A0(0x0018)
	float                                         ConeHalfAngle;                                     // 0x01B8(0x0004)
	uint8                                         Pad_1BC[0x4];                                      // 0x01BC(0x0004)
	struct FVector                                ReturnValue;                                       // 0x01C0(0x0018)
};
...
public:
	TArray<struct FVector3f>                      SamplePositions;                                   // 0x0198(0x0010)
	struct FDataflowVertexSelection               SampleIndices;                                     // 0x01A8(0x0020)
	int32                                         Magnitude;                                         // 0x01C8(0x0004)
	uint8                                         Pad_1CC[0x4];                                      // 0x01CC(0x0004)
	TArray<int32>                                 FieldIntResult;                                    // 0x01D0(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x01E0(0x0010)
	int32                                         NumSamplePositions;                                // 0x01F0(0x0004)
	uint8                                         Pad_1F4[0x4];                                      // 0x01F4(0x0004)
};
...
public:
	...
	struct FVector                                position;                                          // 0x01D0(0x0018)
	struct FVector                                Translation;                                       // 0x01E8(0x0018)
	float                                         Wavelength;                                        // 0x0200(0x0004)
	float                                         Period;                                            // 0x0204(0x0004)
	EDataflowWaveFunctionType                     FunctionType;                                      // 0x0208(0x0001)
	EDataflowFieldFalloffType                     FalloffType;                                       // 0x0209(0x0001)
	uint8                                         Pad_20A[0x6];                                      // 0x020A(0x0006)
	TArray<float>                                 FieldFloatResult;                                  // 0x0210(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x0220(0x0010)
	int32                                         NumSamplePositions;                                // 0x0230(0x0004)
	uint8                                         Pad_234[0x4];                                      // 0x0234(0x0004)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            OptionalSelectionFilter;                           // 0x0248(0x0020)
	EConvexHullSimplifyMethod                     SimplifyMethod;                                    // 0x0268(0x0004)
	float                                         SimplificationAngleThreshold;                      // 0x026C(0x0004)
	float                                         SimplificationDistanceThreshold;                   // 0x0270(0x0004)
	int32                                         MinTargetTriangleCount;                            // 0x0274(0x0004)
	bool                                          bUseExistingVertices;                              // 0x0278(0x0001)
...
{
public:
	float                                         FloatA;                                            // 0x0198(0x0004)
	float                                         FloatB;                                            // 0x019C(0x0004)
	float                                         ReturnValue;                                       // 0x01A0(0x0004)
	uint8                                         Pad_1A4[0x4];                                      // 0x01A4(0x0004)
};
...
{
public:
	TArray<float>                                 FieldFloatLeft;                                    // 0x0198(0x0010)
	TArray<int32>                                 FieldRemapLeft;                                    // 0x01A8(0x0010)
	TArray<float>                                 FieldFloatRight;                                   // 0x01B8(0x0010)
	TArray<int32>                                 FieldRemapRight;                                   // 0x01C8(0x0010)
	float                                         Magnitude;                                         // 0x01D8(0x0004)
	EDataflowFloatFieldOperationType              Operation;                                         // 0x01DC(0x0001)
	bool                                          bSwapInputs;                                       // 0x01DD(0x0001)
	uint8                                         Pad_1DE[0x2];                                      // 0x01DE(0x0002)
	TArray<float>                                 FieldFloatResult;                                  // 0x01E0(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x01F0(0x0010)
};
...
{
public:
	TArray<float>                                 FieldFloat;                                        // 0x0198(0x0010)
	TArray<int32>                                 FieldFloatRemap;                                   // 0x01A8(0x0010)
	TArray<struct FVector>                        FieldVectorLeft;                                   // 0x01B8(0x0010)
	TArray<int32>                                 FieldRemapLeft;                                    // 0x01C8(0x0010)
	TArray<struct FVector>                        FieldVectorRight;                                  // 0x01D8(0x0010)
	TArray<int32>                                 FieldRemapRight;                                   // 0x01E8(0x0010)
	float                                         Magnitude;                                         // 0x01F8(0x0004)
	EDataflowVectorFieldOperationType             Operation;                                         // 0x01FC(0x0001)
	bool                                          bSwapVectorInputs;                                 // 0x01FD(0x0001)
	uint8                                         Pad_1FE[0x2];                                      // 0x01FE(0x0002)
	TArray<struct FVector>                        FieldVectorResult;                                 // 0x0200(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x0210(0x0010)
};
...
{
public:
	float                                         Y;                                                 // 0x0198(0x0004)
	float                                         X;                                                 // 0x019C(0x0004)
	float                                         ReturnValue;                                       // 0x01A0(0x0004)
	uint8                                         Pad_1A4[0x4];                                      // 0x01A4(0x0004)
};
...
{
public:
	TArray<float>                                 FieldFloatInput;                                   // 0x0198(0x0010)
	TArray<int32>                                 FieldRemap;                                        // 0x01A8(0x0010)
	int32                                         NumSamplePositions;                                // 0x01B8(0x0004)
	float                                         Default;                                           // 0x01BC(0x0004)
	TArray<float>                                 FieldFloatResult;                                  // 0x01C0(0x0010)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowFaceSelection                 FaceSelection;                                     // 0x0248(0x0020)
	TArray<class UMaterial*>                      Materials;                                         // 0x0268(0x0010)
	class UMaterial*                              OutsideMaterial;                                   // 0x0278(0x0008)
	class UMaterial*                              InsideMaterial;                                    // 0x0280(0x0008)
	bool                                          bAssignOutsideMaterial;                            // 0x0288(0x0001)
	bool                                          bAssignInsideMaterial;                             // 0x0289(0x0001)
...
public:
	...
	struct FDataflowFaceSelection                 FaceSelection;                                     // 0x0248(0x0020)
	TArray<class UMaterial*>                      Materials;                                         // 0x0268(0x0010)
	int32                                         OutsideMaterialIdx;                                // 0x0278(0x0004)
	int32                                         InsideMaterialIdx;                                 // 0x027C(0x0004)
	bool                                          bAssignOutsideMaterial;                            // 0x0280(0x0001)
	bool                                          bAssignInsideMaterial;                             // 0x0281(0x0001)
...
public:
	TArray<class UMaterial*>                      Materials;                                         // 0x0198(0x0010)
	class UMaterial*                              Material;                                          // 0x01A8(0x0008)
	int32                                         MaterialIdx;                                       // 0x01B0(0x0004)
	uint8                                         Pad_1B4[0x4];                                      // 0x01B4(0x0004)
};
...
public:
	TArray<class UMaterial*>                      Materials;                                         // 0x0198(0x0010)
	class UMaterial*                              Material;                                          // 0x01A8(0x0008)
	ESetMaterialOperationTypeEnum                 Operation;                                         // 0x01B0(0x0001)
	uint8                                         Pad_1B1[0x3];                                      // 0x01B1(0x0003)
	int32                                         MaterialIdx;                                       // 0x01B4(0x0004)
};
...
{
public:
	class UMaterial*                              InMaterial;                                        // 0x0198(0x0008)
	class UMaterial*                              Material;                                          // 0x01A0(0x0008)
};
...
public:
	...
	struct FManagedArrayCollection                Collection;                                        // 0x01A0(0x00B0)
	bool                                          bImportTransformOnly;                              // 0x0250(0x0001)
...
public:
	...
	int32                                         MaxHullsPerGeometry;                               // 0x000C(0x0004)
	float                                         MinThicknessTolerance;                             // 0x0010(0x0004)
	int32                                         NumAdditionalSplits;                               // 0x0014(0x0004)
};
...
{
public:
	float                                         MinSizeToDecompose;                                // 0x0198(0x0004)
	float                                         MaxGeoToHullVolumeRatioToDecompose;                // 0x019C(0x0004)
	float                                         ErrorTolerance;                                    // 0x01A0(0x0004)
	int32                                         MaxHullsPerGeometry;                               // 0x01A4(0x0004)
	float                                         MinThicknessTolerance;                             // 0x01A8(0x0004)
	int32                                         NumAdditionalSplits;                               // 0x01AC(0x0004)
	struct FDataflowConvexDecompositionSettings   DecompositionSettings;                             // 0x01B0(0x0018)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            OptionalSelectionFilter;                           // 0x0248(0x0020)
	EGenerateConvexMethod                         GenerateMethod;                                    // 0x0268(0x0001)
	uint8                                         Pad_269[0x3];                                      // 0x0269(0x0003)
	float                                         IntersectIfComputedIsSmallerByFactor;              // 0x026C(0x0004)
	float                                         MinExternalVolumeToIntersect;                      // 0x0270(0x0004)
	bool                                          bComputeIntersectionsBeforeHull;                   // 0x0274(0x0001)
	uint8                                         Pad_275[0x3];                                      // 0x0275(0x0003)
	float                                         SimplificationDistanceThreshold;                   // 0x0278(0x0004)
	struct FDataflowConvexDecompositionSettings   ConvexDecompositionSettings;                       // 0x027C(0x0018)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	float                                         CanExceedFraction;                                 // 0x0248(0x0004)
	float                                         SimplificationDistanceThreshold;                   // 0x024C(0x0004)
	EConvexOverlapRemovalMethodEnum               OverlapRemovalMethod;                              // 0x0250(0x0001)
	uint8                                         Pad_251[0x3];                                      // 0x0251(0x0003)
	float                                         OverlapRemovalShrinkPercent;                       // 0x0254(0x0004)
	float                                         CanRemoveFraction;                                 // 0x0258(0x0004)
	uint8                                         Pad_25C[0x4];                                      // 0x025C(0x0004)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowSphereCovering                SphereCovering;                                    // 0x0248(0x0020)
	int32                                         MaxConvexCount;                                    // 0x0268(0x0004)
	uint8                                         Pad_26C[0x4];                                      // 0x026C(0x0004)
	double                                        ErrorTolerance;                                    // 0x0270(0x0008)
	struct FDataflowTransformSelection            OptionalSelectionFilter;                           // 0x0278(0x0020)
	bool                                          bProtectNegativeSpace;                             // 0x0298(0x0001)
	bool                                          bComputeNegativeSpacePerBone;                      // 0x0299(0x0001)
	ENegativeSpaceSampleMethodDataflowEnum        SampleMethod;                                      // 0x029A(0x0001)
	bool                                          bRequireSearchSampleCoverage;                      // 0x029B(0x0001)
	bool                                          bOnlyConnectedToHull;                              // 0x029C(0x0001)
	uint8                                         Pad_29D[0x3];                                      // 0x029D(0x0003)
	int32                                         TargetNumSamples;                                  // 0x02A0(0x0004)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0248(0x0020)
	float                                         Volume;                                            // 0x0268(0x0004)
	bool                                          bSumChildrenForClustersWithoutHulls;               // 0x026C(0x0001)
	bool                                          bVolumeOfUnion;                                    // 0x026D(0x0001)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0248(0x0020)
	EFixTinyGeoMergeType                          MergeType;                                         // 0x0268(0x0001)
	bool                                          bOnFractureLevel;                                  // 0x0269(0x0001)
	bool                                          bOnlyClusters;                                     // 0x026A(0x0001)
	bool                                          bOnlySameParent;                                   // 0x026B(0x0001)
	bool                                          bFractureLevelIsAll;                               // 0x026C(0x0001)
	EFixTinyGeoNeighborSelectionMethod            NeighborSelection;                                 // 0x026D(0x0001)
	bool                                          bOnlyToConnected;                                  // 0x026E(0x0001)
	EFixTinyGeoUseBoneSelection                   UseBoneSelection;                                  // 0x026F(0x0001)
	EFixTinyGeoGeometrySelectionMethod            SelectionMethod;                                   // 0x0270(0x0001)
	uint8                                         Pad_271[0x3];                                      // 0x0271(0x0003)
	float                                         MinVolumeCubeRoot;                                 // 0x0274(0x0004)
	float                                         RelativeVolume;                                    // 0x0278(0x0004)
	bool                                          AddSamplesForCollision;                            // 0x027C(0x0001)
	uint8                                         Pad_27D[0x3];                                      // 0x027D(0x0003)
	float                                         CollisionSampleSpacing;                            // 0x0280(0x0004)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0248(0x0020)
	bool                                          bOnlyTangents;                                     // 0x0268(0x0001)
	bool                                          bRecomputeSharpEdges;                              // 0x0269(0x0001)
	uint8                                         Pad_26A[0x2];                                      // 0x026A(0x0002)
	float                                         SharpEdgeAngleThreshold;                           // 0x026C(0x0004)
	bool                                          bOnlyInternalSurfaces;                             // 0x0270(0x0001)
	uint8                                         Pad_271[0x7];                                      // 0x0271(0x0007)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	bool                                          bRemoveUnreferencedGeometry;                       // 0x0248(0x0001)
	bool                                          bRemoveClustersOfOne;                              // 0x0249(0x0001)
	bool                                          bRemoveDanglingClusters;                           // 0x024A(0x0001)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0248(0x0020)
	EClusterNeighborSelectionMethodEnum           NeighborSelectionMethod;                           // 0x0268(0x0001)
	uint8                                         Pad_269[0x3];                                      // 0x0269(0x0003)
	float                                         MinVolumeCubeRoot;                                 // 0x026C(0x0004)
	bool                                          bOnlyToConnected;                                  // 0x0270(0x0001)
	bool                                          bOnlySameParent;                                   // 0x0271(0x0001)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0248(0x0020)
	int32                                         Iterations;                                        // 0x0268(0x0004)
	uint8                                         Pad_26C[0x4];                                      // 0x026C(0x0004)
};
...
public:
	struct FVector                                Vector;                                            // 0x0198(0x0018)
	class FString                                 String;                                            // 0x01B0(0x0010)
};
...
public:
	float                                         float_0;                                           // 0x0198(0x0004)
	uint8                                         Pad_19C[0x4];                                      // 0x019C(0x0004)
	class FString                                 String;                                            // 0x01A0(0x0010)
};
...
{
public:
	EFloatToIntFunctionEnum                       Function;                                          // 0x0198(0x0001)
	uint8                                         Pad_199[0x3];                                      // 0x0199(0x0003)
	float                                         float_0;                                           // 0x019C(0x0004)
	int32                                         int_0;                                             // 0x01A0(0x0004)
	uint8                                         Pad_1A4[0x4];                                      // 0x01A4(0x0004)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            OptionalSelectionFilter;                           // 0x0248(0x0020)
	class UDynamicMesh*                           Mesh;                                              // 0x0268(0x0008)
};
...
{
public:
	struct FDataflowSphereCovering                SphereCovering;                                    // 0x0198(0x0020)
	int32                                         VerticesAlongEachSide;                             // 0x01B8(0x0004)
	uint8                                         Pad_1BC[0x4];                                      // 0x01BC(0x0004)
	class UDynamicMesh*                           Mesh;                                              // 0x01C0(0x0008)
};
...
public:
	struct FDataflowSphereCovering                SphereCovering;                                    // 0x0198(0x0020)
	int32                                         NumSpheres;                                        // 0x01B8(0x0004)
	uint8                                         Pad_1BC[0x4];                                      // 0x01BC(0x0004)
};
...
{
public:
	class UDynamicMesh*                           Mesh;                                              // 0x0198(0x0008)
	bool                                          bInvertFaces;                                      // 0x01A0(0x0001)
	uint8                                         Pad_1A1[0x7];                                      // 0x01A1(0x0007)
	class FString                                 StringOBJ;                                         // 0x01A8(0x0010)
};
...
{
public:
	class FString                                 FilePath;                                          // 0x0198(0x0010)
	class FString                                 FileContents;                                      // 0x01A8(0x0010)
};
...
{
public:
	EVisibiltyOptionsEnum                         Visibility;                                        // 0x0198(0x0001)
	uint8                                         Pad_199[0x7];                                      // 0x0199(0x0007)
	struct FManagedArrayCollection                Collection;                                        // 0x01A0(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0250(0x0020)
	struct FDataflowFaceSelection                 FaceSelection;                                     // 0x0270(0x0020)
};
...
{
public:
	int32                                         MinNumberOfPoints;                                 // 0x0198(0x0004)
	int32                                         MaxNumberOfPoints;                                 // 0x019C(0x0004)
	float                                         RandomSeed;                                        // 0x01A0(0x0004)
	uint8                                         Pad_1A4[0x4];                                      // 0x01A4(0x0004)
	struct FBox                                   BoundingBox;                                       // 0x01A8(0x0038)
	TArray<struct FVector>                        Points;                                            // 0x01E0(0x0010)
};
...
public:
	int32                                         MinNumberOfPoints;                                 // 0x0198(0x0004)
	int32                                         MaxNumberOfPoints;                                 // 0x019C(0x0004)
	int32                                         RandomSeed;                                        // 0x01A0(0x0004)
	uint8                                         Pad_1A4[0x4];                                      // 0x01A4(0x0004)
	struct FBox                                   BoundingBox;                                       // 0x01A8(0x0038)
	TArray<struct FVector>                        Points;                                            // 0x01E0(0x0010)
};
...
public:
	struct FVector                                Center;                                            // 0x0198(0x0018)
	struct FVector                                Normal;                                            // 0x01B0(0x0018)
	float                                         Radius;                                            // 0x01C8(0x0004)
	int32                                         AngularSteps;                                      // 0x01CC(0x0004)
	int32                                         RadialSteps;                                       // 0x01D0(0x0004)
	float                                         AngleOffset;                                       // 0x01D4(0x0004)
	float                                         Variability;                                       // 0x01D8(0x0004)
	float                                         RandomSeed;                                        // 0x01DC(0x0004)
	TArray<struct FVector>                        Points;                                            // 0x01E0(0x0010)
};
...
{
public:
	struct FBox                                   BoundingBox;                                       // 0x0198(0x0038)
	struct FVector                                Center;                                            // 0x01D0(0x0018)
	struct FVector                                Normal;                                            // 0x01E8(0x0018)
	int32                                         RandomSeed;                                        // 0x0200(0x0004)
	int32                                         AngularSteps;                                      // 0x0204(0x0004)
	float                                         AngleOffset;                                       // 0x0208(0x0004)
	float                                         AngularNoise;                                      // 0x020C(0x0004)
	float                                         Radius;                                            // 0x0210(0x0004)
	int32                                         RadialSteps;                                       // 0x0214(0x0004)
	float                                         RadialStepExponent;                                // 0x0218(0x0004)
	float                                         RadialMinStep;                                     // 0x021C(0x0004)
	float                                         RadialNoise;                                       // 0x0220(0x0004)
	float                                         RadialVariability;                                 // 0x0224(0x0004)
	float                                         AngularVariability;                                // 0x0228(0x0004)
	float                                         AxialVariability;                                  // 0x022C(0x0004)
	TArray<struct FVector>                        Points;                                            // 0x0230(0x0010)
};
...
{
public:
	int32                                         NumberOfPointsInX;                                 // 0x0198(0x0004)
	int32                                         NumberOfPointsInY;                                 // 0x019C(0x0004)
	int32                                         NumberOfPointsInZ;                                 // 0x01A0(0x0004)
	int32                                         RandomSeed;                                        // 0x01A4(0x0004)
	float                                         MaxRandomDisplacementX;                            // 0x01A8(0x0004)
	float                                         MaxRandomDisplacementY;                            // 0x01AC(0x0004)
	float                                         MaxRandomDisplacementZ;                            // 0x01B0(0x0004)
	uint8                                         Pad_1B4[0x4];                                      // 0x01B4(0x0004)
	struct FBox                                   BoundingBox;                                       // 0x01B8(0x0038)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	TArray<struct FVector>                        Points;                                            // 0x0248(0x0010)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0258(0x0020)
	float                                         RandomSeed;                                        // 0x0278(0x0004)
	float                                         ChanceToFracture;                                  // 0x027C(0x0004)
	bool                                          GroupFracture;                                     // 0x0280(0x0001)
	uint8                                         Pad_281[0x3];                                      // 0x0281(0x0003)
	float                                         Grout;                                             // 0x0284(0x0004)
	float                                         Amplitude;                                         // 0x0288(0x0004)
	float                                         Frequency;                                         // 0x028C(0x0004)
	float                                         Persistence;                                       // 0x0290(0x0004)
	float                                         Lacunarity;                                        // 0x0294(0x0004)
	int32                                         OctaveNumber;                                      // 0x0298(0x0004)
	float                                         PointSpacing;                                      // 0x029C(0x0004)
	bool                                          AddSamplesForCollision;                            // 0x02A0(0x0001)
	uint8                                         Pad_2A1[0x3];                                      // 0x02A1(0x0003)
	float                                         CollisionSampleSpacing;                            // 0x02A4(0x0004)
};
...
public:
	...
	int32                                         RandomSeed;                                        // 0x02E0(0x0004)
	float                                         ChanceToFracture;                                  // 0x02E4(0x0004)
	bool                                          SplitIslands;                                      // 0x02E8(0x0001)
	uint8                                         Pad_2E9[0x3];                                      // 0x02E9(0x0003)
	float                                         Grout;                                             // 0x02EC(0x0004)
	float                                         Amplitude;                                         // 0x02F0(0x0004)
	float                                         Frequency;                                         // 0x02F4(0x0004)
	float                                         Persistence;                                       // 0x02F8(0x0004)
	float                                         Lacunarity;                                        // 0x02FC(0x0004)
	int32                                         OctaveNumber;                                      // 0x0300(0x0004)
	float                                         PointSpacing;                                      // 0x0304(0x0004)
	bool                                          AddSamplesForCollision;                            // 0x0308(0x0001)
	uint8                                         Pad_309[0x3];                                      // 0x0309(0x0003)
	float                                         CollisionSampleSpacing;                            // 0x030C(0x0004)
	struct FDataflowTransformSelection            NewGeometryTransformSelection;                     // 0x0310(0x0020)
};
...
public:
	...
	struct FBox                                   BoundingBox;                                       // 0x0248(0x0038)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0280(0x0020)
	int32                                         NumPlanes;                                         // 0x02A0(0x0004)
	float                                         RandomSeed;                                        // 0x02A4(0x0004)
	float                                         Grout;                                             // 0x02A8(0x0004)
	float                                         Amplitude;                                         // 0x02AC(0x0004)
	float                                         Frequency;                                         // 0x02B0(0x0004)
	float                                         Persistence;                                       // 0x02B4(0x0004)
	float                                         Lacunarity;                                        // 0x02B8(0x0004)
	int32                                         OctaveNumber;                                      // 0x02BC(0x0004)
	float                                         PointSpacing;                                      // 0x02C0(0x0004)
	bool                                          AddSamplesForCollision;                            // 0x02C4(0x0001)
	uint8                                         Pad_2C5[0x3];                                      // 0x02C5(0x0003)
	float                                         CollisionSampleSpacing;                            // 0x02C8(0x0004)
...
public:
	...
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0280(0x0020)
	struct FTransform                             Transform;                                         // 0x02A0(0x0060)
	int32                                         NumPlanes;                                         // 0x0300(0x0004)
	int32                                         RandomSeed;                                        // 0x0304(0x0004)
	float                                         ChanceToFracture;                                  // 0x0308(0x0004)
	bool                                          SplitIslands;                                      // 0x030C(0x0001)
	uint8                                         Pad_30D[0x3];                                      // 0x030D(0x0003)
	float                                         Grout;                                             // 0x0310(0x0004)
	float                                         Amplitude;                                         // 0x0314(0x0004)
	float                                         Frequency;                                         // 0x0318(0x0004)
	float                                         Persistence;                                       // 0x031C(0x0004)
	float                                         Lacunarity;                                        // 0x0320(0x0004)
	int32                                         OctaveNumber;                                      // 0x0324(0x0004)
	float                                         PointSpacing;                                      // 0x0328(0x0004)
	bool                                          AddSamplesForCollision;                            // 0x032C(0x0001)
	uint8                                         Pad_32D[0x3];                                      // 0x032D(0x0003)
	float                                         CollisionSampleSpacing;                            // 0x0330(0x0004)
	uint8                                         Pad_334[0x4];                                      // 0x0334(0x0004)
	struct FDataflowTransformSelection            NewGeometryTransformSelection;                     // 0x0338(0x0020)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	float                                         UniformScale;                                      // 0x0248(0x0004)
	uint8                                         Pad_24C[0x4];                                      // 0x024C(0x0004)
	struct FVector                                Scale;                                             // 0x0250(0x0018)
};
...
public:
	...
	struct FBox                                   BoundingBox;                                       // 0x0248(0x0038)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0280(0x0020)
	int32                                         SlicesX;                                           // 0x02A0(0x0004)
	int32                                         SlicesY;                                           // 0x02A4(0x0004)
	int32                                         SlicesZ;                                           // 0x02A8(0x0004)
	float                                         SliceAngleVariation;                               // 0x02AC(0x0004)
	float                                         SliceOffsetVariation;                              // 0x02B0(0x0004)
	int32                                         RandomSeed;                                        // 0x02B4(0x0004)
	float                                         ChanceToFracture;                                  // 0x02B8(0x0004)
	bool                                          SplitIslands;                                      // 0x02BC(0x0001)
	uint8                                         Pad_2BD[0x3];                                      // 0x02BD(0x0003)
	float                                         Grout;                                             // 0x02C0(0x0004)
	float                                         Amplitude;                                         // 0x02C4(0x0004)
	float                                         Frequency;                                         // 0x02C8(0x0004)
	float                                         Persistence;                                       // 0x02CC(0x0004)
	float                                         Lacunarity;                                        // 0x02D0(0x0004)
	int32                                         OctaveNumber;                                      // 0x02D4(0x0004)
	float                                         PointSpacing;                                      // 0x02D8(0x0004)
	bool                                          AddSamplesForCollision;                            // 0x02DC(0x0001)
	uint8                                         Pad_2DD[0x3];                                      // 0x02DD(0x0003)
	float                                         CollisionSampleSpacing;                            // 0x02E0(0x0004)
	uint8                                         Pad_2E4[0x4];                                      // 0x02E4(0x0004)
	struct FDataflowTransformSelection            NewGeometryTransformSelection;                     // 0x02E8(0x0020)
};
...
public:
	...
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0280(0x0020)
	struct FTransform                             Transform;                                         // 0x02A0(0x0060)
	EFractureBrickBondEnum                        Bond;                                              // 0x0300(0x0001)
	uint8                                         Pad_301[0x3];                                      // 0x0301(0x0003)
	float                                         BrickLength;                                       // 0x0304(0x0004)
	float                                         BrickHeight;                                       // 0x0308(0x0004)
	float                                         BrickDepth;                                        // 0x030C(0x0004)
	int32                                         RandomSeed;                                        // 0x0310(0x0004)
	float                                         ChanceToFracture;                                  // 0x0314(0x0004)
	bool                                          SplitIslands;                                      // 0x0318(0x0001)
	uint8                                         Pad_319[0x3];                                      // 0x0319(0x0003)
	float                                         Grout;                                             // 0x031C(0x0004)
	float                                         Amplitude;                                         // 0x0320(0x0004)
	float                                         Frequency;                                         // 0x0324(0x0004)
	float                                         Persistence;                                       // 0x0328(0x0004)
	float                                         Lacunarity;                                        // 0x032C(0x0004)
	int32                                         OctaveNumber;                                      // 0x0330(0x0004)
	float                                         PointSpacing;                                      // 0x0334(0x0004)
	bool                                          AddSamplesForCollision;                            // 0x0338(0x0001)
	uint8                                         Pad_339[0x3];                                      // 0x0339(0x0003)
	float                                         CollisionSampleSpacing;                            // 0x033C(0x0004)
	struct FDataflowTransformSelection            NewGeometryTransformSelection;                     // 0x0340(0x0020)
};
...
{
public:
	class FString                                 Value;                                             // 0x0198(0x0010)
	class FString                                 String;                                            // 0x01A8(0x0010)
};
...
{
public:
	TArray<struct FVector>                        Point;                                             // 0x0198(0x0010)
	TArray<struct FVector>                        Points;                                            // 0x01A8(0x0010)
};
...
{
public:
	EMakeBoxDataTypeEnum                          DataType;                                          // 0x0198(0x0001)
	uint8                                         Pad_199[0x7];                                      // 0x0199(0x0007)
	struct FVector                                min_0;                                             // 0x01A0(0x0018)
	struct FVector                                max_0;                                             // 0x01B8(0x0018)
	struct FVector                                Center;                                            // 0x01D0(0x0018)
	struct FVector                                Size;                                              // 0x01E8(0x0018)
	struct FBox                                   Box;                                               // 0x0200(0x0038)
};
...
{
public:
	bool                                          Value;                                             // 0x0198(0x0001)
	bool                                          Bool;                                              // 0x0199(0x0001)
...
{
public:
	struct FVector                                InTranslation;                                     // 0x0198(0x0018)
	struct FVector                                InRotation;                                        // 0x01B0(0x0018)
	struct FVector                                InScale;                                           // 0x01C8(0x0018)
	struct FTransform                             OutTransform;                                      // 0x01E0(0x0060)
};
...
public:
	...
	float                                         Y;                                                 // 0x019C(0x0004)
	float                                         Z;                                                 // 0x01A0(0x0004)
	float                                         W;                                                 // 0x01A4(0x0004)
	uint8                                         Pad_1A8[0x8];                                      // 0x01A8(0x0008)
	struct FQuat                                  Quaternion;                                        // 0x01B0(0x0020)
};
...
{
public:
	int32                                         NumElements;                                       // 0x0198(0x0004)
	float                                         Value;                                             // 0x019C(0x0004)
	TArray<float>                                 FloatArray;                                        // 0x01A0(0x0010)
};
...
{
public:
	float                                         Dividend;                                          // 0x0198(0x0004)
	float                                         Divisor;                                           // 0x019C(0x0004)
	float                                         Remainder;                                         // 0x01A0(0x0004)
	int32                                         ReturnValue;                                       // 0x01A4(0x0004)
};
...
public:
	float                                         float_0;                                           // 0x0198(0x0004)
	float                                         OldMin;                                            // 0x019C(0x0004)
	float                                         OldMax;                                            // 0x01A0(0x0004)
	float                                         NewMin;                                            // 0x01A4(0x0004)
	float                                         NewMax;                                            // 0x01A8(0x0004)
	float                                         ReturnValue;                                       // 0x01AC(0x0004)
};
...
public:
	float                                         A;                                                 // 0x0198(0x0004)
	float                                         B;                                                 // 0x019C(0x0004)
	float                                         Alpha;                                             // 0x01A0(0x0004)
	float                                         ReturnValue;                                       // 0x01A4(0x0004)
};
...
public:
	float                                         float_0;                                           // 0x0198(0x0004)
	float                                         RangeMin;                                          // 0x019C(0x0004)
	float                                         RangeMax;                                          // 0x01A0(0x0004)
	float                                         ReturnValue;                                       // 0x01A4(0x0004)
};
...
public:
	struct FVector                                VectorA;                                           // 0x0198(0x0018)
	struct FVector                                VectorB;                                           // 0x01B0(0x0018)
	float                                         ReturnValue;                                       // 0x01C8(0x0004)
	uint8                                         Pad_1CC[0x4];                                      // 0x01CC(0x0004)
};
...
{
public:
	struct FVector                                PointA;                                            // 0x0198(0x0018)
	struct FVector                                PointB;                                            // 0x01B0(0x0018)
	float                                         ReturnValue;                                       // 0x01C8(0x0004)
	uint8                                         Pad_1CC[0x4];                                      // 0x01CC(0x0004)
};
...
public:
	float                                         float_0;                                           // 0x0198(0x0004)
	bool                                          ReturnValue;                                       // 0x019C(0x0001)
	uint8                                         Pad_19D[0x3];                                      // 0x019D(0x0003)
};
...
public:
	...
	uint8                                         Pad_199[0x3];                                      // 0x0199(0x0003)
	float                                         RandomSeed;                                        // 0x019C(0x0004)
	struct FVector                                ReturnValue;                                       // 0x01A0(0x0018)
};
...
{
public:
	float                                         Radians;                                           // 0x0198(0x0004)
	float                                         Degrees;                                           // 0x019C(0x0004)
};
...
{
public:
	float                                         Degrees;                                           // 0x0198(0x0004)
	float                                         Radians;                                           // 0x019C(0x0004)
};
...
{
public:
	EMathConstantsEnum                            Constant;                                          // 0x0198(0x0001)
	uint8                                         Pad_199[0x3];                                      // 0x0199(0x0003)
	float                                         ReturnValue;                                       // 0x019C(0x0004)
};
...
public:
	float                                         A;                                                 // 0x0198(0x0004)
	float                                         B;                                                 // 0x019C(0x0004)
	float                                         C;                                                 // 0x01A0(0x0004)
	float                                         D;                                                 // 0x01A4(0x0004)
	class FString                                 Expression;                                        // 0x01A8(0x0010)
...
{
public:
	struct FDataflowNumericTypes                  A;                                                 // 0x0198(0x0008)
	struct FDataflowNumericTypes                  B;                                                 // 0x01A0(0x0008)
	struct FDataflowNumericTypes                  C;                                                 // 0x01A8(0x0008)
	struct FDataflowNumericTypes                  D;                                                 // 0x01B0(0x0008)
	class FString                                 Expression;                                        // 0x01B8(0x0010)
	struct FDataflowNumericTypes                  ReturnValue;                                       // 0x01C8(0x0008)
};
...
{
public:
	TArray<struct FVector>                        Points;                                            // 0x0198(0x0010)
	class UDynamicMesh*                           Mesh;                                              // 0x01A8(0x0008)
	int32                                         TriangleCount;                                     // 0x01B0(0x0004)
	uint8                                         Pad_1B4[0x4];                                      // 0x01B4(0x0004)
};
...
{
public:
	struct FBox                                   Box;                                               // 0x0198(0x0038)
	class UDynamicMesh*                           Mesh;                                              // 0x01D0(0x0008)
	int32                                         TriangleCount;                                     // 0x01D8(0x0004)
	uint8                                         Pad_1DC[0x4];                                      // 0x01DC(0x0004)
};
...
public:
	class UDynamicMesh*                           Mesh;                                              // 0x0198(0x0008)
	class FString                                 InfoString;                                        // 0x01A0(0x0010)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	bool                                          bCenterPivot;                                      // 0x0248(0x0001)
	uint8                                         Pad_249[0x7];                                      // 0x0249(0x0007)
	class UDynamicMesh*                           Mesh;                                              // 0x0250(0x0008)
};
...
public:
	class UStaticMesh*                            StaticMesh;                                        // 0x0198(0x0008)
	bool                                          bUseHiRes;                                         // 0x01A0(0x0001)
	uint8                                         Pad_1A1[0x3];                                      // 0x01A1(0x0003)
	int32                                         LODLevel;                                          // 0x01A4(0x0004)
	class UDynamicMesh*                           Mesh;                                              // 0x01A8(0x0008)
};
...
{
public:
	class UDynamicMesh*                           Mesh1;                                             // 0x0198(0x0008)
	class UDynamicMesh*                           Mesh2;                                             // 0x01A0(0x0008)
	class UDynamicMesh*                           Mesh;                                              // 0x01A8(0x0008)
};
...
{
public:
	EMeshBooleanOperationEnum                     Operation;                                         // 0x0198(0x0001)
	uint8                                         Pad_199[0x7];                                      // 0x0199(0x0007)
	class UDynamicMesh*                           Mesh1;                                             // 0x01A0(0x0008)
	class UDynamicMesh*                           Mesh2;                                             // 0x01A8(0x0008)
	class UDynamicMesh*                           Mesh;                                              // 0x01B0(0x0008)
};
...
public:
	TArray<struct FVector>                        Points;                                            // 0x0198(0x0010)
	class UDynamicMesh*                           MeshToCopy;                                        // 0x01A8(0x0008)
	float                                         Scale;                                             // 0x01B0(0x0004)
	uint8                                         Pad_1B4[0x4];                                      // 0x01B4(0x0004)
...
public:
	class UDynamicMesh*                           Mesh;                                              // 0x0198(0x0008)
	int32                                         vertexcount;                                       // 0x01A0(0x0004)
	int32                                         EdgeCount;                                         // 0x01A4(0x0004)
	int32                                         TriangleCount;                                     // 0x01A8(0x0004)
	uint8                                         Pad_1AC[0x4];                                      // 0x01AC(0x0004)
};
...
{
public:
	class UGeometryCollection*                    CollectionAsset;                                   // 0x0198(0x0008)
	struct FManagedArrayCollection                Collection;                                        // 0x01A0(0x00B0)
};
...
{
public:
	struct FManagedArrayCollection                Collection1;                                       // 0x0198(0x00B0)
	struct FManagedArrayCollection                Collection2;                                       // 0x0248(0x00B0)
	TArray<class FString>                         GeometryGroupGuidsOut1;                            // 0x02F8(0x0010)
	TArray<class FString>                         GeometryGroupGuidsOut2;                            // 0x0308(0x0010)
};
...
{
public:
	bool                                          bPrintToScreen;                                    // 0x0198(0x0001)
	bool                                          bPrintToLog;                                       // 0x0199(0x0001)
	uint8                                         Pad_19A[0x2];                                      // 0x019A(0x0002)
	struct FColor                                 Color;                                             // 0x019C(0x0004)
	float                                         Duration;                                          // 0x01A0(0x0004)
	uint8                                         Pad_1A4[0x4];                                      // 0x01A4(0x0004)
	class FString                                 String;                                            // 0x01A8(0x0010)
};
...
{
public:
	bool                                          bPrintToLog;                                       // 0x0198(0x0001)
	uint8                                         Pad_199[0x7];                                      // 0x0199(0x0007)
	class FString                                 String;                                            // 0x01A0(0x0010)
};
...
{
public:
	TArray<struct FBox>                           Boxes;                                             // 0x0198(0x0010)
	TArray<float>                                 Lengths;                                           // 0x01A8(0x0010)
	EBoxLengthMeasurementMethod                   MeasurementMethod;                                 // 0x01B8(0x0001)
...
public:
	struct FBox                                   BoundingBox;                                       // 0x0198(0x0038)
	struct FVector                                min_0;                                             // 0x01D0(0x0018)
	struct FVector                                max_0;                                             // 0x01E8(0x0018)
	struct FVector                                Center;                                            // 0x0200(0x0018)
	struct FVector                                HalfExtents;                                       // 0x0218(0x0018)
	float                                         Volume;                                            // 0x0230(0x0004)
	uint8                                         Pad_234[0x4];                                      // 0x0234(0x0004)
};
...
public:
	struct FVector                                Vector;                                            // 0x0198(0x0018)
	float                                         X;                                                 // 0x01B0(0x0004)
	float                                         Y;                                                 // 0x01B4(0x0004)
	float                                         Z;                                                 // 0x01B8(0x0004)
	uint8                                         Pad_1BC[0x4];                                      // 0x01BC(0x0004)
};
...
{
public:
	class FString                                 String1;                                           // 0x0198(0x0010)
	class FString                                 String2;                                           // 0x01A8(0x0010)
	class FString                                 String;                                            // 0x01B8(0x0010)
};
...
{
public:
	class FString                                 String;                                            // 0x0198(0x0010)
	int32                                         Hash;                                              // 0x01A8(0x0004)
	uint8                                         Pad_1AC[0x4];                                      // 0x01AC(0x0004)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0248(0x0020)
	TArray<struct FBox>                           BoundingBoxes;                                     // 0x0268(0x0010)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0248(0x0020)
	TArray<struct FVector>                        Centroids;                                         // 0x0268(0x0010)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FVector                                Translate;                                         // 0x0248(0x0018)
	ERotationOrderEnum                            RotationOrder;                                     // 0x0260(0x0001)
	uint8                                         Pad_261[0x7];                                      // 0x0261(0x0007)
	struct FVector                                Rotate;                                            // 0x0268(0x0018)
	struct FVector                                Scale;                                             // 0x0280(0x0018)
	float                                         UniformScale;                                      // 0x0298(0x0004)
	uint8                                         Pad_29C[0x4];                                      // 0x029C(0x0004)
	struct FVector                                RotatePivot;                                       // 0x02A0(0x0018)
	struct FVector                                ScalePivot;                                        // 0x02B8(0x0018)
	bool                                          bInvertTransformation;                             // 0x02D0(0x0001)
...
public:
	class UDynamicMesh*                           Mesh;                                              // 0x0198(0x0008)
	struct FVector                                Translate;                                         // 0x01A0(0x0018)
	ERotationOrderEnum                            RotationOrder;                                     // 0x01B8(0x0001)
	uint8                                         Pad_1B9[0x7];                                      // 0x01B9(0x0007)
	struct FVector                                Rotate;                                            // 0x01C0(0x0018)
	struct FVector                                Scale;                                             // 0x01D8(0x0018)
	float                                         UniformScale;                                      // 0x01F0(0x0004)
	uint8                                         Pad_1F4[0x4];                                      // 0x01F4(0x0004)
	struct FVector                                RotatePivot;                                       // 0x01F8(0x0018)
	struct FVector                                ScalePivot;                                        // 0x0210(0x0018)
	bool                                          bInvertTransformation;                             // 0x0228(0x0001)
	uint8                                         Pad_229[0x7];                                      // 0x0229(0x0007)
};
...
{
public:
	ECompareOperationEnum                         Operation;                                         // 0x0198(0x0001)
	uint8                                         Pad_199[0x3];                                      // 0x0199(0x0003)
	int32                                         IntA;                                              // 0x019C(0x0004)
	int32                                         IntB;                                              // 0x01A0(0x0004)
	bool                                          Result;                                            // 0x01A4(0x0001)
...
public:
	ECompareOperationEnum                         Operation;                                         // 0x0198(0x0001)
	uint8                                         Pad_199[0x3];                                      // 0x0199(0x0003)
	float                                         FloatA;                                            // 0x019C(0x0004)
	float                                         FloatB;                                            // 0x01A0(0x0004)
	bool                                          Result;                                            // 0x01A4(0x0001)
	uint8                                         Pad_1A5[0x3];                                      // 0x01A5(0x0003)
};
...
{
public:
	class UDynamicMesh*                           MeshA;                                             // 0x0198(0x0008)
	class UDynamicMesh*                           MeshB;                                             // 0x01A0(0x0008)
	bool                                          bCondition;                                        // 0x01A8(0x0001)
...
{
public:
	struct FManagedArrayCollection                TrueCollection;                                    // 0x0198(0x00B0)
	struct FManagedArrayCollection                FalseCollection;                                   // 0x0248(0x00B0)
	bool                                          bCondition;                                        // 0x02F8(0x0001)
	uint8                                         Pad_2F9[0x7];                                      // 0x02F9(0x0007)
	struct FManagedArrayCollection                ChosenCollection;                                  // 0x0300(0x00B0)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	class FString                                 String;                                            // 0x0248(0x0010)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0248(0x0020)
	bool                                          bEnabledRemoval;                                   // 0x0268(0x0001)
	uint8                                         Pad_269[0x3];                                      // 0x0269(0x0003)
	struct FVector2f                              PostBreakTimer;                                    // 0x026C(0x0008)
	struct FVector2f                              RemovalTimer;                                      // 0x0274(0x0008)
	bool                                          bClusterCrumbling;                                 // 0x027C(0x0001)
	uint8                                         Pad_27D[0x3];                                      // 0x027D(0x0003)
};
...
{
public:
	EAnchorStateEnum                              AnchorState;                                       // 0x0198(0x0001)
	bool                                          bSetNotSelectedBonesToOppositeState;               // 0x0199(0x0001)
	uint8                                         Pad_19A[0x6];                                      // 0x019A(0x0006)
	struct FManagedArrayCollection                Collection;                                        // 0x01A0(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0250(0x0020)
};
...
{
public:
	EProximityMethodEnum                          ProximityMethod;                                   // 0x0198(0x0001)
	uint8                                         Pad_199[0x3];                                      // 0x0199(0x0003)
	float                                         DistanceThreshold;                                 // 0x019C(0x0004)
	float                                         ContactThreshold;                                  // 0x01A0(0x0004)
	EProximityContactFilteringMethodEnum          FilterContactMethod;                               // 0x01A4(0x0001)
	bool                                          bUseAsConnectionGraph;                             // 0x01A5(0x0001)
	EConnectionContactAreaMethodEnum              ContactAreaMethod;                                 // 0x01A6(0x0001)
	bool                                          bRecomputeConvexHulls;                             // 0x01A7(0x0001)
	struct FManagedArrayCollection                Collection;                                        // 0x01A8(0x00B0)
};
...
public:
	...
	struct FTransform                             Transform;                                         // 0x0250(0x0060)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	EStandardGroupNameEnum                        GroupName;                                         // 0x0248(0x0001)
	uint8                                         Pad_249[0x7];                                      // 0x0249(0x0007)
	class FString                                 CustomGroupName;                                   // 0x0250(0x0010)
	class FString                                 AttrName;                                          // 0x0260(0x0010)
	ECustomAttributeTypeEnum                      CustomAttributeType;                               // 0x0270(0x0001)
	uint8                                         Pad_271[0x3];                                      // 0x0271(0x0003)
	int32                                         NumElements;                                       // 0x0274(0x0004)
};
...
public:
	...
	uint8                                         Pad_249[0x7];                                      // 0x0249(0x0007)
	class FString                                 CustomGroupName;                                   // 0x0250(0x0010)
	int32                                         NumElements;                                       // 0x0260(0x0004)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FCollectionAttributeKey                AttributeKey;                                      // 0x0248(0x0020)
	EStandardGroupNameEnum                        GroupName;                                         // 0x0268(0x0001)
	uint8                                         Pad_269[0x7];                                      // 0x0269(0x0007)
	class FString                                 CustomGroupName;                                   // 0x0270(0x0010)
	class FString                                 AttrName;                                          // 0x0280(0x0010)
	TArray<bool>                                  BoolAttributeData;                                 // 0x0290(0x0010)
	TArray<float>                                 FloatAttributeData;                                // 0x02A0(0x0010)
	TArray<double>                                DoubleAttributeData;                               // 0x02B0(0x0010)
	TArray<int32>                                 Int32AttributeData;                                // 0x02C0(0x0010)
	TArray<class FString>                         StringAttributeData;                               // 0x02D0(0x0010)
	TArray<struct FVector3f>                      Vector3fAttributeData;                             // 0x02E0(0x0010)
	TArray<struct FVector3d>                      Vector3dAttributeData;                             // 0x02F0(0x0010)
	TArray<struct FLinearColor>                   LinearColorAttributeData;                          // 0x0300(0x0010)
};
...
{
public:
	struct FDataflowVertexSelection               VertexSelection;                                   // 0x0198(0x0020)
	TArray<int32>                                 VertexList;                                        // 0x01B8(0x0010)
};
...
public:
	...
	struct FTransform                             InLeftTransform;                                   // 0x01A0(0x0060)
	struct FTransform                             InRightTransform;                                  // 0x0200(0x0060)
	struct FTransform                             OutTransform;                                      // 0x0260(0x0060)
};
...
public:
	uint8                                         Pad_198[0x8];                                      // 0x0198(0x0008)
	struct FTransform                             InTransform;                                       // 0x01A0(0x0060)
	struct FTransform                             OutTransform;                                      // 0x0200(0x0060)
};
...
{
public:
	int32                                         A;                                                 // 0x0198(0x0004)
	int32                                         B;                                                 // 0x019C(0x0004)
	bool                                          bCondition;                                        // 0x01A0(0x0001)
	uint8                                         Pad_1A1[0x3];                                      // 0x01A1(0x0003)
	int32                                         ReturnValue;                                       // 0x01A4(0x0004)
};
...
{
public:
	float                                         float_0;                                           // 0x01B8(0x0004)
	float                                         FloatDefault;                                      // 0x01BC(0x0004)
};
...
{
public:
	int32                                         int_0;                                             // 0x01B8(0x0004)
	int32                                         IntDefault;                                        // 0x01BC(0x0004)
};
...
{
public:
	bool                                          Bool;                                              // 0x01B8(0x0001)
	bool                                          BoolDefault;                                       // 0x01B9(0x0001)
...
public:
	class FString                                 String;                                            // 0x01B8(0x0010)
	class FString                                 StringDefault;                                     // 0x01C8(0x0010)
};
...
{
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0198(0x0008)
	float                                         SamplingRadius;                                    // 0x01A0(0x0004)
	int32                                         MaxNumSamples;                                     // 0x01A4(0x0004)
	float                                         SubSampleDensity;                                  // 0x01A8(0x0004)
	int32                                         RandomSeed;                                        // 0x01AC(0x0004)
	TArray<struct FVector>                        SamplePoints;                                      // 0x01B0(0x0010)
	TArray<int32>                                 SampleTriangleIDs;                                 // 0x01C0(0x0010)
	TArray<struct FVector>                        SampleBarycentricCoords;                           // 0x01D0(0x0010)
	int32                                         NumSamplePoints;                                   // 0x01E0(0x0004)
...
public:
	...
	float                                         SubSampleDensity;                                  // 0x01A8(0x0004)
	int32                                         RandomSeed;                                        // 0x01AC(0x0004)
	float                                         MaxSamplingRadius;                                 // 0x01B0(0x0004)
	ENonUniformSamplingDistributionMode           SizeDistribution;                                  // 0x01B4(0x0001)
	uint8                                         Pad_1B5[0x3];                                      // 0x01B5(0x0003)
	float                                         SizeDistributionPower;                             // 0x01B8(0x0004)
	uint8                                         Pad_1BC[0x4];                                      // 0x01BC(0x0004)
	TArray<struct FVector>                        SamplePoints;                                      // 0x01C0(0x0010)
	TArray<float>                                 SampleRadii;                                       // 0x01D0(0x0010)
	TArray<int32>                                 SampleTriangleIDs;                                 // 0x01E0(0x0010)
	TArray<struct FVector>                        SampleBarycentricCoords;                           // 0x01F0(0x0010)
	int32                                         NumSamplePoints;                                   // 0x0200(0x0004)
...
public:
	class UDynamicMesh*                           TargetMesh;                                        // 0x0198(0x0008)
	TArray<float>                                 VertexWeights;                                     // 0x01A0(0x0010)
	float                                         SamplingRadius;                                    // 0x01B0(0x0004)
	int32                                         MaxNumSamples;                                     // 0x01B4(0x0004)
	float                                         SubSampleDensity;                                  // 0x01B8(0x0004)
	int32                                         RandomSeed;                                        // 0x01BC(0x0004)
	float                                         MaxSamplingRadius;                                 // 0x01C0(0x0004)
	ENonUniformSamplingDistributionMode           SizeDistribution;                                  // 0x01C4(0x0001)
	uint8                                         Pad_1C5[0x3];                                      // 0x01C5(0x0003)
	float                                         SizeDistributionPower;                             // 0x01C8(0x0004)
	ENonUniformSamplingWeightMode                 WeightMode;                                        // 0x01CC(0x0001)
	bool                                          bInvertWeights;                                    // 0x01CD(0x0001)
	uint8                                         Pad_1CE[0x2];                                      // 0x01CE(0x0002)
	TArray<struct FVector>                        SamplePoints;                                      // 0x01D0(0x0010)
	TArray<float>                                 SampleRadii;                                       // 0x01E0(0x0010)
	TArray<int32>                                 SampleTriangleIDs;                                 // 0x01F0(0x0010)
	TArray<struct FVector>                        SampleBarycentricCoords;                           // 0x0200(0x0010)
	int32                                         NumSamplePoints;                                   // 0x0210(0x0004)
...
{
public:
	ESetOperationEnum                             Operation;                                         // 0x0198(0x0001)
	uint8                                         Pad_199[0x7];                                      // 0x0199(0x0007)
	struct FDataflowTransformSelection            TransformSelectionA;                               // 0x01A0(0x0020)
	struct FDataflowTransformSelection            TransformSelectionB;                               // 0x01C0(0x0020)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x01E0(0x0020)
};
...
{
public:
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0198(0x0020)
	struct FManagedArrayCollection                Collection;                                        // 0x01B8(0x00B0)
	class FString                                 String;                                            // 0x0268(0x0010)
};
...
public:
	...
	uint8                                         Pad_199[0x3];                                      // 0x0199(0x0003)
	float                                         RandomSeed;                                        // 0x019C(0x0004)
	float                                         RandomThreshold;                                   // 0x01A0(0x0004)
	uint8                                         Pad_1A4[0x4];                                      // 0x01A4(0x0004)
	struct FManagedArrayCollection                Collection;                                        // 0x01A8(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0258(0x0020)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	class FString                                 BoneIndicies;                                      // 0x0248(0x0010)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0258(0x0020)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	TArray<int32>                                 BoneIndices;                                       // 0x0248(0x0010)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0258(0x0020)
};
...
public:
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0198(0x0020)
	int32                                         Percentage;                                        // 0x01B8(0x0004)
	bool                                          bDeterministic;                                    // 0x01BC(0x0001)
	uint8                                         Pad_1BD[0x3];                                      // 0x01BD(0x0003)
	float                                         RandomSeed;                                        // 0x01C0(0x0004)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	int32                                         TargetLevel;                                       // 0x0248(0x0004)
	bool                                          bSkipEmbedded;                                     // 0x024C(0x0001)
...
public:
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0198(0x0020)
	struct FManagedArrayCollection                Collection;                                        // 0x01B8(0x00B0)
	bool                                          bAllowContactInParentLevels;                       // 0x0268(0x0001)
	uint8                                         Pad_269[0x7];                                      // 0x0269(0x0007)
};
...
{
public:
	TArray<float>                                 Values;                                            // 0x0198(0x0010)
	float                                         min_0;                                             // 0x01A8(0x0004)
	float                                         max_0;                                             // 0x01AC(0x0004)
	ERangeSettingEnum                             RangeSetting;                                      // 0x01B0(0x0001)
	bool                                          bInclusive;                                        // 0x01B1(0x0001)
	uint8                                         Pad_1B2[0x6];                                      // 0x01B2(0x0006)
	TArray<int32>                                 Indices;                                           // 0x01B8(0x0010)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	float                                         SizeMin;                                           // 0x0248(0x0004)
	float                                         SizeMax;                                           // 0x024C(0x0004)
	ERangeSettingEnum                             RangeSetting;                                      // 0x0250(0x0001)
	bool                                          bInclusive;                                        // 0x0251(0x0001)
	bool                                          bUseRelativeSize;                                  // 0x0252(0x0001)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	float                                         VolumeMin;                                         // 0x0248(0x0004)
	float                                         VolumeMax;                                         // 0x024C(0x0004)
	ERangeSettingEnum                             RangeSetting;                                      // 0x0250(0x0001)
	bool                                          bInclusive;                                        // 0x0251(0x0001)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FBox                                   Box;                                               // 0x0248(0x0038)
	struct FTransform                             Transform;                                         // 0x0280(0x0060)
	ESelectSubjectTypeEnum                        Type;                                              // 0x02E0(0x0001)
	bool                                          bAllVerticesMustContainedInBox;                    // 0x02E1(0x0001)
	uint8                                         Pad_2E2[0x6];                                      // 0x02E2(0x0006)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x02E8(0x0020)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FSphere                                Sphere;                                            // 0x0248(0x0020)
	uint8                                         Pad_268[0x8];                                      // 0x0268(0x0008)
	struct FTransform                             Transform;                                         // 0x0270(0x0060)
	ESelectSubjectTypeEnum                        Type;                                              // 0x02D0(0x0001)
	bool                                          bAllVerticesMustContainedInSphere;                 // 0x02D1(0x0001)
	uint8                                         Pad_2D2[0x6];                                      // 0x02D2(0x0006)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x02D8(0x0020)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	class FString                                 GroupName;                                         // 0x0248(0x0010)
	class FString                                 AttrName;                                          // 0x0258(0x0010)
	float                                         min_0;                                             // 0x0268(0x0004)
	float                                         max_0;                                             // 0x026C(0x0004)
	ERangeSettingEnum                             RangeSetting;                                      // 0x0270(0x0001)
	bool                                          bInclusive;                                        // 0x0271(0x0001)
	uint8                                         Pad_272[0x6];                                      // 0x0272(0x0006)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0278(0x0020)
};
...
public:
	...
	class FString                                 GroupName;                                         // 0x0248(0x0010)
	class FString                                 AttrName;                                          // 0x0258(0x0010)
	int32                                         min_0;                                             // 0x0268(0x0004)
	int32                                         max_0;                                             // 0x026C(0x0004)
	ERangeSettingEnum                             RangeSetting;                                      // 0x0270(0x0001)
	bool                                          bInclusive;                                        // 0x0271(0x0001)
	uint8                                         Pad_272[0x6];                                      // 0x0272(0x0006)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0278(0x0020)
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	class FString                                 VertexIndicies;                                    // 0x0248(0x0010)
	struct FDataflowVertexSelection               VertexSelection;                                   // 0x0258(0x0020)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	class FString                                 FaceIndicies;                                      // 0x0248(0x0010)
	struct FDataflowFaceSelection                 FaceSelection;                                     // 0x0258(0x0020)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x0248(0x0020)
	struct FDataflowFaceSelection                 FaceSelection;                                     // 0x0268(0x0020)
	struct FDataflowVertexSelection               VertexSelection;                                   // 0x0288(0x0020)
	bool                                          bAllElementsMustBeSelected;                        // 0x02A8(0x0001)
...
{
public:
	struct FDataflowFaceSelection                 FaceSelection;                                     // 0x0198(0x0020)
};
...
public:
	ESetOperationEnum                             Operation;                                         // 0x0198(0x0001)
	uint8                                         Pad_199[0x7];                                      // 0x0199(0x0007)
	struct FDataflowVertexSelection               VertexSelectionA;                                  // 0x01A0(0x0020)
	struct FDataflowVertexSelection               VertexSelectionB;                                  // 0x01C0(0x0020)
	struct FDataflowVertexSelection               VertexSelection;                                   // 0x01E0(0x0020)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FCollectionAttributeKey                AttributeKey;                                      // 0x0248(0x0020)
	ESelectionByAttrGroup                         Group;                                             // 0x0268(0x0001)
	uint8                                         Pad_269[0x7];                                      // 0x0269(0x0007)
	class FString                                 Attribute;                                         // 0x0270(0x0010)
	ESelectionByAttrOperation                     Operation;                                         // 0x0280(0x0001)
	uint8                                         Pad_281[0x7];                                      // 0x0281(0x0007)
	class FString                                 Value;                                             // 0x0288(0x0010)
	struct FDataflowVertexSelection               VertexSelection;                                   // 0x0298(0x0020)
	struct FDataflowFaceSelection                 FaceSelection;                                     // 0x02B8(0x0020)
	struct FDataflowTransformSelection            TransformSelection;                                // 0x02D8(0x0020)
	struct FDataflowGeometrySelection             GeometrySelection;                                 // 0x02F8(0x0020)
	struct FDataflowMaterialSelection             MaterialSelection;                                 // 0x0318(0x0020)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	class FString                                 GeometryIndices;                                   // 0x0248(0x0010)
	struct FDataflowGeometrySelection             GeometrySelection;                                 // 0x0258(0x0020)
	struct FDataflowVertexSelection               VertexSelection;                                   // 0x0278(0x0020)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FManagedArrayCollection                FromCollection;                                    // 0x0248(0x00B0)
	struct FCollectionAttributeKey                AttributeKey;                                      // 0x02F8(0x0020)
	EDataflowTransferVertexAttributeNodeBoundingVolume BoundingVolumeType;                           // 0x0318(0x0001)
	EDataflowTransferVertexAttributeNodeSourceScale SourceScale;                                     // 0x0319(0x0001)
	EDataflowTransferVertexAttributeNodeFalloff   Falloff;                                           // 0x031A(0x0001)
	uint8                                         Pad_31B[0x1];                                      // 0x031B(0x0001)
	float                                         FalloffThreshold;                                  // 0x031C(0x0004)
	float                                         EdgeMultiplier;                                    // 0x0320(0x0004)
	float                                         BoundMultiplier;                                   // 0x0324(0x0004)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FManagedArrayCollection                FromCollection;                                    // 0x0248(0x00B0)
	EDataflowTransferVertexAttributeNodeBoundingVolume BoundingVolumeType;                           // 0x02F8(0x0001)
	EDataflowTransferVertexAttributeNodeSourceScale SourceScale;                                     // 0x02F9(0x0001)
	EDataflowTransferVertexAttributeNodeFalloff   Falloff;                                           // 0x02FA(0x0001)
	uint8                                         Pad_2FB[0x1];                                      // 0x02FB(0x0001)
	float                                         FalloffThreshold;                                  // 0x02FC(0x0004)
	float                                         EdgeMultiplier;                                    // 0x0300(0x0004)
	float                                         BoundMultiplier;                                   // 0x0304(0x0004)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowVertexSelection               VertexSelection;                                   // 0x0248(0x0020)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	TArray<int32>                                 BoundaryIndicesOut;                                // 0x0248(0x0010)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FCollectionAttributeKey                AttributeKey;                                      // 0x0248(0x0020)
	float                                         SelectionThreshold;                                // 0x0268(0x0004)
	uint8                                         Pad_26C[0x4];                                      // 0x026C(0x0004)
	TArray<int32>                                 VertexIndices;                                     // 0x0270(0x0010)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	uint8                                         Pad_248[0x8];                                      // 0x0248(0x0008)
	struct FTransform                             TransformIn;                                       // 0x0250(0x0060)
	struct FTransform                             LocalTransform;                                    // 0x02B0(0x0060)
	class FString                                 GroupName;                                         // 0x0310(0x0010)
	class FString                                 AttributeName;                                     // 0x0320(0x0010)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	TArray<float>                                 FloatArray;                                        // 0x0248(0x0010)
	bool                                          bNormalizeInput;                                   // 0x0258(0x0001)
	uint8                                         Pad_259[0x3];                                      // 0x0259(0x0003)
	struct FLinearColor                           Color;                                             // 0x025C(0x0010)
	uint8                                         Pad_26C[0x4];                                      // 0x026C(0x0004)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	TArray<int32>                                 VertexIndicesIn;                                   // 0x0248(0x0010)
	struct FLinearColor                           SelectedColor;                                     // 0x0258(0x0010)
};
...
public:
	struct FManagedArrayCollection                Collection;                                        // 0x0198(0x00B0)
	struct FDataflowVertexSelection               VertexSelection;                                   // 0x0248(0x0020)
	struct FLinearColor                           SelectedColor;                                     // 0x0268(0x0010)
};
