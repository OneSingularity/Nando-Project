...
public:
	...
	struct FInstancedStruct                       Value;                                             // 0x0010(0x0010)
};
...
public:
	class FString                                 Key;                                               // 0x0000(0x0010)
	class FString                                 DefaultText;                                       // 0x0010(0x0010)
	TArray<struct FLocalizableMessageParameterEntry> Substitutions;                                  // 0x0020(0x0010)
};
...
{
public:
	struct FLocalizableMessage                    Value;                                             // 0x0000(0x0030)
};
