...
{
public:
	EZoneShapePolygonRoutingType                  NewType;                                           // 0x0000(0x0001)
};
...
{
public:
	EFZoneShapeType                               Type;                                              // 0x0000(0x0001)
};
...
{
public:
	struct FZoneGraphTagMask                      NewTags;                                           // 0x0000(0x0004)
};
...
{
public:
	EFZoneShapeType                               ReturnValue;                                       // 0x0000(0x0001)
};
...
{
public:
	struct FZoneGraphTagMask                      ReturnValue;                                       // 0x0000(0x0004)
};
