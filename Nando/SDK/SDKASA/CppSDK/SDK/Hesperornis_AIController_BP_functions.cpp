...
#include "Hesperornis_AIController_BP_classes.hpp"
#include "Hesperornis_AIController_BP_parameters.hpp"
...
float AHesperornis_AIController_BP_C::BPGetTargetingDesire(class AActor* ForTarget, float ForTargetingDesireValue)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Hesperornis_AIController_BP_C", "BPGetTargetingDesire");

	Params::Hesperornis_AIController_BP_C_BPGetTargetingDesire Parms{};
