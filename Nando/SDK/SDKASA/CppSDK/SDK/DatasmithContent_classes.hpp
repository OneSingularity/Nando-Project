...
{
public:
	TSet<class FName>                             Layers;                                            // 0x0030(0x0050)
	TSet<class FName>                             Tags;                                              // 0x0080(0x0050)
...
{
public:
	EComponentMobility                            Mobility;                                          // 0x0490(0x0001)
	EDatasmithAreaLightActorType                  LightType;                                         // 0x0491(0x0001)
	EDatasmithAreaLightActorShape                 LightShape;                                        // 0x0492(0x0001)
	uint8                                         Pad_493[0x5];                                      // 0x0493(0x0005)
	struct FVector2D                              Dimensions;                                        // 0x0498(0x0010)
	float                                         Intensity;                                         // 0x04A8(0x0004)
	ELightUnits                                   IntensityUnits;                                    // 0x04AC(0x0001)
	uint8                                         Pad_4AD[0x3];                                      // 0x04AD(0x0003)
	struct FLinearColor                           Color;                                             // 0x04B0(0x0010)
	float                                         Temperature;                                       // 0x04C0(0x0004)
	uint8                                         Pad_4C4[0x4];                                      // 0x04C4(0x0004)
	class UTextureLightProfile*                   IESTexture;                                        // 0x04C8(0x0008)
	bool                                          bUseIESBrightness;                                 // 0x04D0(0x0001)
	uint8                                         Pad_4D1[0x3];                                      // 0x04D1(0x0003)
	float                                         IESBrightnessScale;                                // 0x04D4(0x0004)
	struct FRotator                               Rotation;                                          // 0x04D8(0x0018)
	float                                         SourceRadius;                                      // 0x04F0(0x0004)
	float                                         SourceLength;                                      // 0x04F4(0x0004)
	float                                         AttenuationRadius;                                 // 0x04F8(0x0004)
	float                                         SpotlightInnerAngle;                               // 0x04FC(0x0004)
	float                                         SpotlightOuterAngle;                               // 0x0500(0x0004)
...
public:
	...
	struct FVector2D                              Dimensions;                                        // 0x0038(0x0010)
	...
	TSoftObjectPtr<class UTextureLightProfile>    IESTexture;                                        // 0x0068(0x0028)
	bool                                          bUseIESBrightness;                                 // 0x0090(0x0001)
	uint8                                         Pad_91[0x3];                                       // 0x0091(0x0003)
	float                                         IESBrightnessScale;                                // 0x0094(0x0004)
	struct FRotator                               Rotation;                                          // 0x0098(0x0018)
...
{
public:
	class FString                                 Generator;                                         // 0x0028(0x0010)
	float                                         Version;                                           // 0x0038(0x0004)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
	class FString                                 Author;                                            // 0x0040(0x0010)
	class FString                                 License;                                           // 0x0050(0x0010)
	class FString                                 Source;                                            // 0x0060(0x0010)
...
{
public:
	class FString                                 SourceMeshName;                                    // 0x0028(0x0010)
...
public:
	...
	class FString                                 TexturesDir;                                       // 0x0030(0x0010)
	uint8                                         IntermediateSerialization;                         // 0x0040(0x0001)
...
{
public:
	TMap<class FName, class FString>              MetaData;                                          // 0x0028(0x0050)
...
{
public:
	int32                                         SortOrder;                                         // 0x0030(0x0004)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)
	struct FVector                                DecalSize;                                         // 0x0038(0x0018)
...
{
public:
	TArray<class ULevelSequence*>                 ImportedSequences;                                 // 0x0490(0x0010)
...
{
public:
	struct FDatasmithTessellationOptions          Options;                                           // 0x0028(0x0020)
...
public:
	...
	struct FDatasmithImportBaseOptions            BaseOptions;                                       // 0x0030(0x0014)
	struct FDatasmithReimportOptions              ReimportOptions;                                   // 0x0044(0x0002)
	uint8                                         Pad_46[0x2];                                       // 0x0046(0x0002)
	class FString                                 Filename;                                          // 0x0048(0x0010)
	class FString                                 FilePath;                                          // 0x0058(0x0010)
	class FString                                 SourceUri;                                         // 0x0068(0x0010)
...
public:
	...
	int32                                         StaticLightingLOD;                                 // 0x0038(0x0004)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
...
{
public:
	uint8                                         bVisible : 1;                                      // 0x0030(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         BitPad_30_1 : 7;                                   // 0x0030(0x0001)
	uint8                                         Pad_31[0x3];                                       // 0x0031(0x0003)
	uint8                                         CastShadows : 1;                                   // 0x0034(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bUseTemperature : 1;                               // 0x0034(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bUseIESBrightness : 1;                             // 0x0034(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	...
	struct FLinearColor                           LightColor;                                        // 0x0044(0x0010)
...
{
public:
	TSoftObjectPtr<class UMaterialInterface>      ParentMaterial;                                    // 0x0030(0x0028)
	TMap<class FName, float>                      ScalarParameterValues;                             // 0x0058(0x0050)
	TMap<class FName, struct FLinearColor>        VectorParameterValues;                             // 0x00A8(0x0050)
	TMap<class FName, TSoftObjectPtr<class UTexture>> TextureParameterValues;                        // 0x00F8(0x0050)
...
public:
	...
	uint8                                         bEnabled : 1;                                      // 0x0070(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bUnbound : 1;                                      // 0x0070(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
{
public:
	class UDatasmithScene*                        Scene;                                             // 0x0490(0x0008)
	TMap<class FName, TSoftObjectPtr<class AActor>> RelatedActors;                                   // 0x0498(0x0050)
...
public:
	...
	EComponentMobility                            Mobility;                                          // 0x0090(0x0001)
	uint8                                         Pad_91[0x7];                                       // 0x0091(0x0007)
	TSoftObjectPtr<class USceneComponent>         AttachParent;                                      // 0x0098(0x0028)
	bool                                          bVisible;                                          // 0x00C0(0x0001)
	bool                                          bCastShadow;                                       // 0x00C1(0x0001)
	uint8                                         Pad_C2[0x6];                                       // 0x00C2(0x0006)
	TSet<class FName>                             Tags;                                              // 0x00C8(0x0050)
...
public:
	...
	uint8                                         Pad_31[0x3];                                       // 0x0031(0x0003)
	int32                                         CubemapResolution;                                 // 0x0034(0x0004)
...
{
public:
	struct FDatasmithMeshSectionInfoMapTemplate   SectionInfoMap;                                    // 0x0030(0x0050)
	int32                                         LightMapCoordinateIndex;                           // 0x0080(0x0004)
	int32                                         LightMapResolution;                                // 0x0084(0x0004)
	TArray<struct FDatasmithMeshBuildSettingsTemplate> BuildSettings;                                // 0x0088(0x0010)
	TArray<struct FDatasmithStaticMaterialTemplate> StaticMaterials;                                 // 0x0098(0x0010)
