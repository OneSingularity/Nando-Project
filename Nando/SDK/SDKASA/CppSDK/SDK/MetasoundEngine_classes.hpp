...
public:
	...
	TArray<struct FMetasoundFrontendClassName>    AutoUpdateDenylist;                                // 0x0040(0x0010)
	TArray<struct FDefaultMetaSoundAssetAutoUpdateSettings> AutoUpdateAssetDenylist;                 // 0x0050(0x0010)
	bool                                          bAutoUpdateLogWarningOnDroppedConnection;          // 0x0060(0x0001)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)
	TArray<struct FDirectoryPath>                 DirectoriesToRegister;                             // 0x0068(0x0010)
	int32                                         DenyListCacheChangeID;                             // 0x0078(0x0004)
	class FName                                   TargetPageName;                                    // 0x007C(0x0008)
	struct FMetaSoundPageSettings                 DefaultPageSettings;                               // 0x0084(0x0018)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)
	TArray<struct FMetaSoundPageSettings>         PageSettings;                                      // 0x00A0(0x0010)
	TArray<struct FMetaSoundQualitySettings>      QualitySettings;                                   // 0x00B0(0x0010)
...
public:
	...
	struct FMetasoundFrontendDocument             RootMetaSoundDocument;                             // 0x0070(0x0190)
	TSet<class FString>                           ReferencedAssetClassKeys;                          // 0x0200(0x0050)
	TSet<class UObject*>                          ReferencedAssetClassObjects;                       // 0x0250(0x0050)
	TSet<struct FSoftObjectPath>                  ReferenceAssetClassCache;                          // 0x02A0(0x0050)
	struct FGuid                                  AssetClassID;                                      // 0x02F0(0x0010)
	uint8                                         Pad_300[0x8];                                      // 0x0300(0x0008)
...
{
public:
	struct FMetaSoundFrontendDocumentBuilder      Builder;                                           // 0x0028(0x0048)
...
{
public:
	uint8                                         Pad_90[0x28];                                      // 0x0090(0x0028)
...
{
public:
	TMap<class FName, class UMetaSoundBuilderBase*> NamedBuilders;                                   // 0x0030(0x0050)
...
class UMetaSoundSource final : public USoundWaveProcedural
{
public:
	uint8                                         Pad_450[0x48];                                     // 0x0450(0x0048)
	struct FMetasoundFrontendDocument             RootMetaSoundDocument;                             // 0x0498(0x0190)
	TSet<class FString>                           ReferencedAssetClassKeys;                          // 0x0628(0x0050)
	TSet<class UObject*>                          ReferencedAssetClassObjects;                       // 0x0678(0x0050)
	TSet<struct FSoftObjectPath>                  ReferenceAssetClassCache;                          // 0x06C8(0x0050)
	EMetaSoundOutputAudioFormat                   OutputFormat;                                      // 0x0718(0x0001)
	uint8                                         Pad_719[0x3];                                      // 0x0719(0x0003)
	struct FGuid                                  AssetClassID;                                      // 0x071C(0x0010)
	uint8                                         Pad_72C[0xF4];                                     // 0x072C(0x00F4)
