...
public:
	...
	uint16                                        Index;                                             // 0x0002(0x0002)
	struct FStateTreeStateHandle                  StateHandle;                                       // 0x0004(0x0002)
};
...
public:
	...
	struct FStateTreeIndex16                      BindingsBatch;                                     // 0x0010(0x0002)
	struct FStateTreeIndex16                      InstanceTemplateIndex;                             // 0x0012(0x0002)
	struct FStateTreeDataHandle                   InstanceDataHandle;                                // 0x0014(0x0006)
...
// 0x0010 (0x0010 - 0x0000)
struct FStateTreeStructRef final
{
public:
...
{
public:
	struct FStateTreeDataHandle                   DataHandle;                                        // 0x0000(0x0006)
};
...
public:
	...
	class FName                                   Name;                                              // 0x0008(0x0008)
	struct FStateTreeExternalDataHandle           Handle;                                            // 0x0010(0x0006)
	EStateTreeExternalDataRequirement             Requirement;                                       // 0x0016(0x0001)
...
{
public:
	struct FStateTreeStateHandle                  SourceState;                                       // 0x0000(0x0002)
	uint8                                         Pad_2[0x6];                                        // 0x0002(0x0006)
	class UStateTree*                             SourceStateTree;                                   // 0x0008(0x0008)
	struct FStateTreeStateHandle                  SourceRootState;                                   // 0x0010(0x0002)
	struct FStateTreeStateHandle                  TargetState;                                       // 0x0012(0x0002)
...
{
public:
	struct FStateTreeStateHandle                  States[0x8];                                       // 0x0000(0x0002)
	uint8                                         NumStates;                                         // 0x0010(0x0001)
	uint8                                         Pad_11[0x1];                                       // 0x0011(0x0001)
};

// ScriptStruct StateTreeModule.StateTreeTransitionSource
// 0x0008 (0x0008 - 0x0000)
struct FStateTreeTransitionSource final
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)
};
...
// 0x0010 (0x0010 - 0x0000)
struct FStateTreeSharedEvent final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)
};
...
public:
	...
	struct FStateTreeIndex16                      TransitionIndex;                                   // 0x0008(0x0002)
	uint8                                         Pad_A[0x2];                                        // 0x000A(0x0002)
	float                                         TimeLeft;                                          // 0x000C(0x0004)
	struct FStateTreeSharedEvent                  CapturedEvent;                                     // 0x0010(0x0010)
	uint32                                        CapturedEventHash;                                 // 0x0020(0x0004)
...
public:
	class UStateTree*                             StateTree;                                         // 0x0000(0x0008)
	struct FStateTreeStateHandle                  RootState;                                         // 0x0008(0x0002)
	struct FStateTreeActiveStates                 ActiveStates;                                      // 0x000A(0x0012)
	struct FStateTreeIndex16                      ExternalDataBaseIndex;                             // 0x001C(0x0002)
	struct FStateTreeIndex16                      GlobalInstanceIndexBase;                           // 0x001E(0x0002)
	struct FStateTreeIndex16                      ActiveInstanceIndexBase;                           // 0x0020(0x0002)
	struct FStateTreeDataHandle                   StateParameterDataHandle;                          // 0x0022(0x0006)
	struct FStateTreeDataHandle                   GlobalParameterDataHandle;                         // 0x0028(0x0006)
	uint8                                         Pad_2E[0x1];                                       // 0x002E(0x0001)
	uint8                                         bIsGlobalFrame : 1;                                // 0x002F(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
};
...
{
public:
	TArray<struct FStateTreeExecutionFrame>       ActiveFrames;                                      // 0x0000(0x0010)
	TArray<struct FStateTreeTransitionDelayedState> DelayedTransitions;                              // 0x0010(0x0010)
	struct FStateTreeIndex16                      EnterStateFailedFrameIndex;                        // 0x0020(0x0002)
	struct FStateTreeIndex16                      EnterStateFailedTaskIndex;                         // 0x0022(0x0002)
	...
	struct FStateTreeIndex16                      CompletedFrameIndex;                               // 0x0028(0x0002)
	struct FStateTreeStateHandle                  CompletedStateHandle;                              // 0x002A(0x0002)
	uint16                                        StateChangeCount;                                  // 0x002C(0x0002)
	uint8                                         Pad_2E[0x2];                                       // 0x002E(0x0002)
	struct FRandomStream                          RandomStream;                                      // 0x0030(0x0008)
};
...
{
public:
	TArray<struct FStateTreeExecutionFrame>       NextActiveFrames;                                  // 0x0000(0x0010)
	uint8                                         Pad_10[0x10];                                      // 0x0010(0x0010)
	EStateTreeRunStatus                           CurrentRunStatus;                                  // 0x0020(0x0001)
	uint8                                         Pad_21[0x1];                                       // 0x0021(0x0001)
	struct FStateTreeStateHandle                  SourceState;                                       // 0x0022(0x0002)
	struct FStateTreeStateHandle                  TargetState;                                       // 0x0024(0x0002)
	struct FStateTreeStateHandle                  CurrentState;                                      // 0x0026(0x0002)
	EStateTreeStateChangeType                     ChangeType;                                        // 0x0028(0x0001)
	EStateTreeTransitionPriority                  Priority;                                          // 0x0029(0x0001)
	uint8                                         Pad_2A[0x6];                                       // 0x002A(0x0006)
	class UStateTree*                             SourceStateTree;                                   // 0x0030(0x0008)
	struct FStateTreeStateHandle                  SourceRootState;                                   // 0x0038(0x0002)
...
public:
	...
	struct FStateTreeStateHandle                  RootState;                                         // 0x0008(0x0002)
	struct FStateTreeActiveStates                 ActiveStates;                                      // 0x000A(0x0012)
	uint8                                         bIsGlobalFrame : 1;                                // 0x001C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_1D[0xB];                                       // 0x001D(0x000B)
};
...
public:
	...
	struct FInstancedStruct                       Payload;                                           // 0x0008(0x0010)
	class FName                                   Origin;                                            // 0x0018(0x0008)
};
...
{
public:
	TArray<struct FRecordedStateTreeExecutionFrame> NextActiveFrames;                                // 0x0000(0x0010)
	TArray<struct FStateTreeEvent>                NextActiveFrameEvents;                             // 0x0010(0x0010)
	struct FStateTreeStateHandle                  SourceState;                                       // 0x0020(0x0002)
	struct FStateTreeStateHandle                  TargetState;                                       // 0x0022(0x0002)
	EStateTreeTransitionPriority                  Priority;                                          // 0x0024(0x0001)
	uint8                                         Pad_25[0x3];                                       // 0x0025(0x0003)
	class UStateTree*                             SourceStateTree;                                   // 0x0028(0x0008)
	struct FStateTreeStateHandle                  SourceRootState;                                   // 0x0030(0x0002)
...
{
public:
	float                                         Input;                                             // 0x0000(0x0004)
	float                                         Result;                                            // 0x0004(0x0004)
};
...
public:
	...
	struct FFloatInterval                         Result;                                            // 0x0008(0x0008)
};
...
{
public:
	int32                                         Left;                                              // 0x0000(0x0004)
	int32                                         Right;                                             // 0x0004(0x0004)
...
{
public:
	int32                                         Input;                                             // 0x0000(0x0004)
	int32                                         Result;                                            // 0x0004(0x0004)
};
...
{
public:
	struct FStateTreeIndex16                      RefAccessIndex;                                    // 0x0000(0x0002)
};
...
{
public:
	EStateTreePropertyRefType                     RefType;                                           // 0x0002(0x0001)
	uint8                                         bIsRefToArray : 1;                                 // 0x0003(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bIsOptional : 1;                                   // 0x0003(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	class UObject*                                TypeObject;                                        // 0x0008(0x0008)
};
...
{
public:
	struct FStateTreeReference                    StateTree;                                         // 0x0000(0x0028)
	struct FStateTreeInstanceData                 TreeInstanceData;                                  // 0x0028(0x0010)
	class UStateTree*                             RunningStateTree;                                  // 0x0038(0x0008)
};
...
{
public:
	uint8                                         BitPad_20_0 : 6;                                   // 0x0020(0x0001)
	uint8                                         bTaskEnabled : 1;                                  // 0x0020(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	EStateTreeTransitionPriority                  TransitionHandlingPriority;                        // 0x0021(0x0001)
...
{
public:
	struct FGameplayTag                           StateTreeOverrideTag;                              // 0x0028(0x0008)
};
...
{
public:
	EStateTreeExpressionOperand                   Operand;                                           // 0x0020(0x0001)
	int8                                          DeltaIndent;                                       // 0x0021(0x0001)
	EStateTreeConditionEvaluationMode             EvaluationMode;                                    // 0x0022(0x0001)
...
{
public:
	TSubclassOf<class UStateTreeConditionBlueprintBase> ConditionClass;                              // 0x0028(0x0008)
};
...
{
public:
	TSubclassOf<class UStateTreeConsiderationBlueprintBase> ConsiderationClass;                      // 0x0028(0x0008)
};
...
{
public:
	TSubclassOf<class UStateTreeEvaluatorBlueprintBase> EvaluatorClass;                              // 0x0020(0x0008)
};
...
{
public:
	TSubclassOf<class UStateTreeTaskBlueprintBase> TaskClass;                                        // 0x0028(0x0008)
};
...
{
public:
	class UScriptStruct*                          PayloadStruct;                                     // 0x0000(0x0008)
...
{
public:
	uint16                                        Duration;                                          // 0x0000(0x0002)
	uint16                                        RandomVariance;                                    // 0x0002(0x0002)
};
...
{
public:
	struct FCompactEventDesc                      RequiredEvent;                                     // 0x0000(0x0010)
	uint16                                        ConditionsBegin;                                   // 0x0010(0x0002)
	struct FStateTreeStateHandle                  State;                                             // 0x0012(0x0002)
	struct FStateTreeRandomTimeDuration           Delay;                                             // 0x0014(0x0004)
	EStateTreeTransitionTrigger                   Trigger;                                           // 0x0018(0x0001)
	EStateTreeTransitionPriority                  Priority;                                          // 0x0019(0x0001)
	EStateTreeSelectionFallback                   Fallback;                                          // 0x001A(0x0001)
	uint8                                         ConditionsNum;                                     // 0x001B(0x0001)
	uint8                                         bTransitionEnabled : 1;                            // 0x001C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bConsumeEventOnSelect : 1;                         // 0x001C(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
{
public:
	bool                                          bInvert;                                           // 0x0028(0x0001)
	EGenericAICheck                               Operator;                                          // 0x0029(0x0001)
	uint8                                         Pad_2A[0x6];                                       // 0x002A(0x0006)
};
...
public:
	...
	struct FStateTreeIndex16                      Index;                                             // 0x0010(0x0002)
...
{
public:
	struct FStateTreeAnyEnum                      Left;                                              // 0x0000(0x0010)
	struct FStateTreeAnyEnum                      Right;                                             // 0x0010(0x0010)
};
...
{
public:
	struct FVector                                Source;                                            // 0x0000(0x0018)
	struct FVector                                Target;                                            // 0x0018(0x0018)
...
{
public:
	EGameplayContainerMatchType                   MatchType;                                         // 0x0028(0x0001)
	bool                                          bExactMatch;                                       // 0x0029(0x0001)
	bool                                          bInvert;                                           // 0x002A(0x0001)
...
{
public:
	struct FRuntimeFloatCurve                     CurveInfo;                                         // 0x0000(0x0088)
};
...
public:
	float                                         Input;                                             // 0x0000(0x0004)
	struct FFloatInterval                         Interval;                                          // 0x0004(0x0008)
};
...
{
public:
	struct FStateTreeConsiderationResponseCurve   ResponseCurve;                                     // 0x0028(0x0088)
};
...
{
public:
	TArray<struct FStateTreeEnumValueScorePair>   Data;                                              // 0x0000(0x0010)
};
...
{
public:
	struct FStateTreeAnyEnum                      Input;                                             // 0x0000(0x0010)
};
...
{
public:
	struct FStateTreeEnumValueScorePairs          EnumValueScorePairs;                               // 0x0028(0x0010)
};
...
{
public:
	TArray<struct FStateTreeSharedEvent>          SharedEvents;                                      // 0x0000(0x0010)
};
...
public:
	class UStateTree*                             StateTree;                                         // 0x0000(0x0008)
	struct FStateTreeStateHandle                  RootState;                                         // 0x0008(0x0002)
	struct FStateTreeDataHandle                   DataHandle;                                        // 0x000A(0x0006)
	struct FStateTreeIndex16                      OwnerNodeIndex;                                    // 0x0010(0x0002)
	uint8                                         Pad_12[0x6];                                       // 0x0012(0x0006)
	struct FInstancedStruct                       Instance;                                          // 0x0018(0x0010)
};
...
{
public:
	struct FInstancedStructContainer              InstanceStructs;                                   // 0x0000(0x0010)
	struct FStateTreeExecutionState               ExecutionState;                                    // 0x0010(0x0038)
	TArray<struct FStateTreeTemporaryInstanceData> TemporaryInstances;                               // 0x0048(0x0010)
	uint8                                         Pad_58[0x18];                                      // 0x0058(0x0018)
	TArray<struct FStateTreeTransitionRequest>    TransitionRequests;                                // 0x0070(0x0010)
	struct FInstancedPropertyBag                  GlobalParameters;                                  // 0x0080(0x0010)
};
...
public:
	class UStruct*                                Struct;                                            // 0x0000(0x0008)
	class FName                                   Name;                                              // 0x0008(0x0008)
	struct FStateTreeDataHandle                   DataHandle;                                        // 0x0010(0x0006)
	EStateTreeBindableStructSource                DataSource;                                        // 0x0016(0x0001)
	uint8                                         Pad_17[0x1];                                       // 0x0017(0x0001)
};
...
{
public:
	TArray<struct FStateTreePropertyPathSegment>  Segments;                                          // 0x0000(0x0010)
};
...
{
public:
	struct FGuid                                  StructID;                                          // 0x0000(0x0010)
	TArray<class FString>                         Path;                                              // 0x0010(0x0010)
};
...
{
public:
	struct FStateTreePropertyPath                 SourcePropertyPath;                                // 0x0000(0x0010)
	struct FStateTreePropertyPath                 TargetPropertyPath;                                // 0x0010(0x0010)
	struct FStateTreeDataHandle                   SourceDataHandle;                                  // 0x0020(0x0006)
...
public:
	struct FStateTreePropertyPath                 SourcePropertyPath;                                // 0x0000(0x0010)
	struct FStateTreeDataHandle                   SourceDataHandle;                                  // 0x0010(0x0006)
...
public:
	class FName                                   Name;                                              // 0x0000(0x0008)
	struct FStateTreeIndex16                      ArrayIndex;                                        // 0x0008(0x0002)
	struct FStateTreeIndex16                      NextIndex;                                         // 0x000A(0x0002)
	EStateTreePropertyAccessType                  Type;                                              // 0x000C(0x0001)
...
{
public:
	struct FStateTreePropertySegment              SourcePath;                                        // 0x0000(0x0010)
	struct FStateTreePropertySegment              TargetPath;                                        // 0x0010(0x0010)
	struct FStateTreeIndex16                      SourceStructIndex;                                 // 0x0020(0x0002)
	EStateTreePropertyCopyType                    CopyType;                                          // 0x0022(0x0001)
...
{
public:
	struct FStateTreeIndex16                      ArrayIndex;                                        // 0x0000(0x0002)
	uint16                                        Offset;                                            // 0x0002(0x0002)
	struct FStateTreeIndex16                      NextIndex;                                         // 0x0004(0x0002)
...
{
public:
	struct FStateTreePropertyIndirection          SourceIndirection;                                 // 0x0000(0x0018)
	struct FStateTreePropertyIndirection          TargetIndirection;                                 // 0x0018(0x0018)
	uint8                                         Pad_30[0x10];                                      // 0x0030(0x0010)
	class UStruct*                                SourceStructType;                                  // 0x0040(0x0008)
	int32                                         CopySize;                                          // 0x0048(0x0004)
	struct FStateTreeDataHandle                   SourceDataHandle;                                  // 0x004C(0x0006)
	EStateTreePropertyCopyType                    Type;                                              // 0x0052(0x0001)
	uint8                                         Pad_53[0x1];                                       // 0x0053(0x0001)
	struct FStateTreeIndex16                      SourceStructIndex;                                 // 0x0054(0x0002)
...
{
public:
	struct FStateTreeBindableStructDesc           TargetStruct;                                      // 0x0000(0x0018)
	struct FStateTreeIndex16                      BindingsBegin;                                     // 0x0018(0x0002)
	struct FStateTreeIndex16                      BindingsEnd;                                       // 0x001A(0x0002)
	struct FStateTreeIndex16                      PropertyFunctionsBegin;                            // 0x001C(0x0002)
	struct FStateTreeIndex16                      PropertyFunctionsEnd;                              // 0x001E(0x0002)
};
...
public:
	...
	struct FStateTreeDataHandle                   SourceDataHandle;                                  // 0x0028(0x0006)
	uint8                                         Pad_2E[0x2];                                       // 0x002E(0x0002)
};
...
{
public:
	TArray<struct FStateTreeBindableStructDesc>   SourceStructs;                                     // 0x0000(0x0010)
	TArray<struct FStateTreePropertyCopyBatch>    CopyBatches;                                       // 0x0010(0x0010)
	TArray<struct FStateTreePropertyPathBinding>  PropertyPathBindings;                              // 0x0020(0x0010)
	TArray<struct FStateTreePropertyCopy>         PropertyCopies;                                    // 0x0030(0x0010)
	TArray<struct FStateTreePropertyRefPath>      PropertyReferencePaths;                            // 0x0040(0x0010)
	TArray<struct FStateTreePropertyAccess>       PropertyAccesses;                                  // 0x0050(0x0010)
	TArray<struct FStateTreePropertyIndirection>  PropertyIndirections;                              // 0x0060(0x0010)
...
{
public:
	struct FGameplayTag                           StateTag;                                          // 0x0000(0x0008)
	struct FStateTreeReference                    StateTreeReference;                                // 0x0008(0x0028)
};
...
{
public:
	TArray<struct FStateTreeReferenceOverrideItem> OverrideItems;                                    // 0x0000(0x0010)
};
...
{
public:
	struct FCompactEventDesc                      RequiredEventToEnter;                              // 0x0000(0x0010)
	class FName                                   Name;                                              // 0x0010(0x0008)
	struct FGameplayTag                           Tag;                                               // 0x0018(0x0008)
	class UStateTree*                             LinkedAsset;                                       // 0x0020(0x0008)
	struct FStateTreeStateHandle                  LinkedState;                                       // 0x0028(0x0002)
	struct FStateTreeStateHandle                  Parent;                                            // 0x002A(0x0002)
	uint16                                        ChildrenBegin;                                     // 0x002C(0x0002)
	uint16                                        ChildrenEnd;                                       // 0x002E(0x0002)
	uint16                                        EnterConditionsBegin;                              // 0x0030(0x0002)
	uint16                                        UtilityConsiderationsBegin;                        // 0x0032(0x0002)
	uint16                                        TransitionsBegin;                                  // 0x0034(0x0002)
	uint16                                        TasksBegin;                                        // 0x0036(0x0002)
	struct FStateTreeIndex16                      ParameterTemplateIndex;                            // 0x0038(0x0002)
	struct FStateTreeDataHandle                   ParameterDataHandle;                               // 0x003A(0x0006)
	struct FStateTreeIndex16                      ParameterBindingsBatch;                            // 0x0040(0x0002)
	struct FStateTreeIndex16                      EventDataIndex;                                    // 0x0042(0x0002)
	uint8                                         EnterConditionsNum;                                // 0x0044(0x0001)
	uint8                                         UtilityConsiderationsNum;                          // 0x0045(0x0001)
	uint8                                         TransitionsNum;                                    // 0x0046(0x0001)
	uint8                                         TasksNum;                                          // 0x0047(0x0001)
	uint8                                         InstanceDataNum;                                   // 0x0048(0x0001)
	uint8                                         Depth;                                             // 0x0049(0x0001)
	EStateTreeStateType                           Type;                                              // 0x004A(0x0001)
	EStateTreeStateSelectionBehavior              SelectionBehavior;                                 // 0x004B(0x0001)
	uint8                                         bHasTransitionTasks : 1;                           // 0x004C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bHasStateChangeConditions : 1;                     // 0x004C(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bCheckPrerequisitesWhenActivatingChildDirectly : 1; // 0x004C(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         Pad_4D[0x3];                                       // 0x004D(0x0003)
	float                                         Weight;                                            // 0x0050(0x0004)
	uint8                                         bEnabled : 1;                                      // 0x0054(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bConsumeEventOnSelect : 1;                         // 0x0054(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
public:
	struct FGuid                                  ID;                                                // 0x0000(0x0010)
	struct FStateTreeStateHandle                  Handle;                                            // 0x0010(0x0002)
	uint8                                         Pad_12[0x2];                                       // 0x0012(0x0002)
};
...
{
public:
	struct FStateTreeStateHandle                  StateHandle;                                       // 0x0000(0x0002)
};
...
{
public:
	class FString                                 Text;                                              // 0x0028(0x0010)
	struct FColor                                 TextColor;                                         // 0x0038(0x0004)
	float                                         FontScale;                                         // 0x003C(0x0004)
	struct FVector                                Offset;                                            // 0x0040(0x0018)
