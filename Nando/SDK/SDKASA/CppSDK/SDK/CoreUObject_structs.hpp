...
public:
	...
	struct FVector                                OutVal;                                            // 0x0008(0x0018)
	struct FVector                                ArriveTangent;                                     // 0x0020(0x0018)
	struct FVector                                LeaveTangent;                                      // 0x0038(0x0018)
	EInterpCurveMode                              InterpMode;                                        // 0x0050(0x0001)
...
public:
	...
	class FName                                   AssetName;                                         // 0x0008(0x0008)
};
...
{
public:
	struct FTopLevelAssetPath                     AssetPath;                                         // 0x0000(0x0010)
	class FString                                 SubPathString;                                     // 0x0010(0x0010)
};
...
{
public:
	TArray<class FName>                           PackageNames;                                      // 0x0000(0x0010)
	TArray<class FName>                           PackagePaths;                                      // 0x0010(0x0010)
	TArray<struct FSoftObjectPath>                SoftObjectPaths;                                   // 0x0020(0x0010)
	TArray<class FName>                           ClassNames;                                        // 0x0030(0x0010)
	TArray<struct FTopLevelAssetPath>             ClassPaths;                                        // 0x0040(0x0010)
	uint8                                         Pad_50[0x50];                                      // 0x0050(0x0050)
	TSet<class FName>                             RecursiveClassesExclusionSet;                      // 0x00A0(0x0050)
	TSet<struct FTopLevelAssetPath>               RecursiveClassPathsExclusionSet;                   // 0x00F0(0x0050)
	bool                                          bRecursivePaths;                                   // 0x0140(0x0001)
	bool                                          bRecursiveClasses;                                 // 0x0141(0x0001)
	bool                                          bIncludeOnlyOnDiskAssets;                          // 0x0142(0x0001)
	uint8                                         Pad_143[0xD];                                      // 0x0143(0x000D)
};
...
public:
	float                                         InVal;                                             // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FVector2D                              OutVal;                                            // 0x0008(0x0010)
	struct FVector2D                              ArriveTangent;                                     // 0x0018(0x0010)
	struct FVector2D                              LeaveTangent;                                      // 0x0028(0x0010)
	EInterpCurveMode                              InterpMode;                                        // 0x0038(0x0001)
...
public:
	...
	struct FQuat                                  OutVal;                                            // 0x0010(0x0020)
	struct FQuat                                  ArriveTangent;                                     // 0x0030(0x0020)
	struct FQuat                                  LeaveTangent;                                      // 0x0050(0x0020)
	EInterpCurveMode                              InterpMode;                                        // 0x0070(0x0001)
...
public:
	float                                         InVal;                                             // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FTwoVectors                            OutVal;                                            // 0x0008(0x0030)
	struct FTwoVectors                            ArriveTangent;                                     // 0x0038(0x0030)
	struct FTwoVectors                            LeaveTangent;                                      // 0x0068(0x0030)
	EInterpCurveMode                              InterpMode;                                        // 0x0098(0x0001)
...
{
public:
	class FName                                   BundleName;                                        // 0x0000(0x0008)
	TArray<struct FTopLevelAssetPath>             AssetPaths;                                        // 0x0008(0x0010)
};
...
{
public:
	TArray<struct FAssetBundleEntry>              Bundles;                                           // 0x0000(0x0010)
};
...
public:
	class FName                                   PackageName;                                       // 0x0000(0x0008)
	class FName                                   PackagePath;                                       // 0x0008(0x0008)
	class FName                                   AssetName;                                         // 0x0010(0x0008)
	class FName                                   AssetClass;                                        // 0x0018(0x0008)
	struct FTopLevelAssetPath                     AssetClassPath;                                    // 0x0020(0x0010)
...
{
public:
	int64                                         X;                                                 // 0x0000(0x0008)
	int64                                         Y;                                                 // 0x0008(0x0008)
};
...
{
public:
	struct FUint64Point                           min_0;                                             // 0x0000(0x0010)
	struct FUint64Point                           max_0;                                             // 0x0010(0x0010)
};
...
public:
	...
	class FString                                 Context;                                           // 0x0018(0x0010)
	struct FGuid                                  Artifact;                                          // 0x0028(0x0010)
};
...
public:
	...
	class FString                                 Filename;                                          // 0x0038(0x0010)
	int32                                         LineNumber;                                        // 0x0048(0x0004)
...
public:
	...
	class FName                                   PrimaryAssetName;                                  // 0x0008(0x0008)
};
...
{
public:
	struct FVector                                min_0;                                             // 0x0000(0x0018)
	struct FVector                                max_0;                                             // 0x0018(0x0018)
...
{
public:
	uint32                                        X;                                                 // 0x0000(0x0004)
	uint32                                        Y;                                                 // 0x0004(0x0004)
	uint32                                        Z;                                                 // 0x0008(0x0004)
	uint32                                        W;                                                 // 0x000C(0x0004)
};
...
{
public:
	struct FVector2D                              min_0;                                             // 0x0000(0x0010)
	struct FVector2D                              max_0;                                             // 0x0010(0x0010)
...
{
public:
	struct FVector2f                              min_0;                                             // 0x0000(0x0008)
	struct FVector2f                              max_0;                                             // 0x0008(0x0008)
...
{
public:
	struct FVector3d                              min_0;                                             // 0x0000(0x0018)
	struct FVector3d                              max_0;                                             // 0x0018(0x0018)
	bool                                          IsValid;                                           // 0x0030(0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
};
...
{
public:
	struct FVector3f                              Origin;                                            // 0x0000(0x000C)
	struct FVector3f                              Direction;                                         // 0x000C(0x000C)
};
...
{
public:
	struct FVector3f                              min_0;                                             // 0x0000(0x000C)
	struct FVector3f                              max_0;                                             // 0x000C(0x000C)
...
{
public:
	struct FVector3d                              Origin;                                            // 0x0000(0x0018)
	struct FVector3d                              BoxExtent;                                         // 0x0018(0x0018)
	double                                        SphereRadius;                                      // 0x0030(0x0008)
};
...
public:
	struct FVector3f                              Origin;                                            // 0x0000(0x000C)
	struct FVector3f                              BoxExtent;                                         // 0x000C(0x000C)
...
{
public:
	uint8                                         B;                                                 // 0x0000(0x0001)
	uint8                                         G;                                                 // 0x0001(0x0001)
	uint8                                         R;                                                 // 0x0002(0x0001)
	uint8                                         A;                                                 // 0x0003(0x0001)
};
...
{
public:
	struct FDoubleRangeBound                      LowerBound;                                        // 0x0000(0x0010)
	struct FDoubleRangeBound                      UpperBound;                                        // 0x0010(0x0010)
};
...
{
public:
	class FString                                 FilePath;                                          // 0x0000(0x0010)
};
...
public:
	ERangeBoundTypes                              Type;                                              // 0x0000(0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	struct FFrameNumber                           Value;                                             // 0x0004(0x0004)
};
...
{
public:
	struct FFrameNumberRangeBound                 LowerBound;                                        // 0x0000(0x0008)
	struct FFrameNumberRangeBound                 UpperBound;                                        // 0x0008(0x0008)
};
...
{
public:
	int32                                         Numerator;                                         // 0x0000(0x0004)
	int32                                         Denominator;                                       // 0x0004(0x0004)
};
...
{
public:
	int32                                         InternalId;                                        // 0x0000(0x0004)
};
...
{
public:
	struct FInt32Point                            min_0;                                             // 0x0000(0x0008)
	struct FInt32Point                            max_0;                                             // 0x0008(0x0008)
};
...
{
public:
	struct FInt64Point                            min_0;                                             // 0x0000(0x0010)
	struct FInt64Point                            max_0;                                             // 0x0010(0x0010)
};
...
{
public:
	TFieldPath<class FMapProperty>                Property;                                          // 0x0000(0x0020)
};

// ScriptStruct CoreUObject.ConstSharedStruct
// 0x0010 (0x0010 - 0x0000)
struct FConstSharedStruct final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)
};
...
{
public:
	struct FQuat4d                                Rotation;                                          // 0x0000(0x0020)
	struct FVector3d                              Translation;                                       // 0x0020(0x0018)
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)
	struct FVector3d                              Scale3D;                                           // 0x0040(0x0018)
...
{
public:
	struct FIntPoint                              min_0;                                             // 0x0000(0x0008)
	struct FIntPoint                              max_0;                                             // 0x0008(0x0008)
};
...
{
public:
	int32                                         U;                                                 // 0x0000(0x0004)
	int32                                         V;                                                 // 0x0004(0x0004)
	int32                                         W;                                                 // 0x0008(0x0004)
};
...
{
public:
	struct FPlane                                 XPlane;                                            // 0x0000(0x0020)
	struct FPlane                                 YPlane;                                            // 0x0020(0x0020)
	struct FPlane                                 ZPlane;                                            // 0x0040(0x0020)
	struct FPlane                                 WPlane;                                            // 0x0060(0x0020)
};

// ScriptStruct CoreUObject.Plane4d
// 0x0008 (0x0020 - 0x0018)
struct FPlane4d final : public FVector3d
{
public:
	double                                        W;                                                 // 0x0018(0x0008)
};
...
{
public:
	struct FPlane4d                               XPlane;                                            // 0x0000(0x0020)
	struct FPlane4d                               YPlane;                                            // 0x0020(0x0020)
	struct FPlane4d                               ZPlane;                                            // 0x0040(0x0020)
	struct FPlane4d                               WPlane;                                            // 0x0060(0x0020)
};

// ScriptStruct CoreUObject.Plane4f
// 0x0004 (0x0010 - 0x000C)
struct FPlane4f final : public FVector3f
{
public:
	float                                         W;                                                 // 0x000C(0x0004)
};
...
{
public:
	struct FPlane4f                               XPlane;                                            // 0x0000(0x0010)
	struct FPlane4f                               YPlane;                                            // 0x0010(0x0010)
	struct FPlane4f                               ZPlane;                                            // 0x0020(0x0010)
	struct FPlane4f                               WPlane;                                            // 0x0030(0x0010)
};
...
public:
	...
	struct FVector                                AxisX;                                             // 0x0018(0x0018)
	struct FVector                                AxisY;                                             // 0x0030(0x0018)
	struct FVector                                AxisZ;                                             // 0x0048(0x0018)
...
{
public:
	uint8                                         X;                                                 // 0x0000(0x0001)
	uint8                                         Y;                                                 // 0x0001(0x0001)
	uint8                                         Z;                                                 // 0x0002(0x0001)
	uint8                                         W;                                                 // 0x0003(0x0001)
};
...
{
public:
	int32                                         XY;                                                // 0x0000(0x0004)
	int32                                         ZW;                                                // 0x0004(0x0004)
};
...
{
public:
	struct FPlatformUserId                        OwningPlatformUser;                                // 0x0000(0x0004)
...
public:
	...
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)
	class FString                                 NativeCulture;                                     // 0x0008(0x0010)
	class FString                                 NameSpace;                                         // 0x0018(0x0010)
	class FString                                 Key;                                               // 0x0028(0x0010)
	class FString                                 NativeString;                                      // 0x0038(0x0010)
	TMap<class FString, class FString>            LocalizedStrings;                                  // 0x0048(0x0050)
	bool                                          bIsMinimalPatch;                                   // 0x0098(0x0001)
	uint8                                         Pad_99[0x7];                                       // 0x0099(0x0007)
	class FText                                   CachedText;                                        // 0x00A0(0x0010)
};

// ScriptStruct CoreUObject.PrimalPODVariant
// 0x0010 (0x0010 - 0x0000)
struct FPrimalPODVariant final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)
};
...
struct FPrimalPropertyBag final
{
public:
...
{
public:
	struct FFrameTime                             Time;                                              // 0x0000(0x0008)
	struct FFrameRate                             Rate;                                              // 0x0008(0x0008)
};
...
{
public:
	int32                                         InitialSeed;                                       // 0x0000(0x0004)
	int32                                         Seed;                                              // 0x0004(0x0004)
};
...
public:
	struct FVector3d                              Origin;                                            // 0x0000(0x0018)
	struct FVector3d                              Direction;                                         // 0x0018(0x0018)
};
...
{
public:
	struct FVector3d                              Center;                                            // 0x0000(0x0018)
	double                                        W;                                                 // 0x0018(0x0008)
};
...
{
public:
	class FString                                 Template;                                          // 0x0000(0x0010)
};
...
public:
	...
	TSoftObjectPtr<class UObject>                 SoftObjectPointer;                                 // 0x0008(0x0028)
	struct FSoftObjectPath                        SoftObjectPath;                                    // 0x0030(0x0020)
...
{
public:
	struct FFrameRate                             Default;                                           // 0x0000(0x0008)
};
...
public:
	...
	int32                                         Frames;                                            // 0x000C(0x0004)
	float                                         SubFrame;                                          // 0x0010(0x0004)
	bool                                          bDropFrameFormat;                                  // 0x0014(0x0001)
...
public:
	...
	struct FVector                                Translation;                                       // 0x0020(0x0018)
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)
	struct FVector                                Scale3D;                                           // 0x0040(0x0018)
	uint8                                         Pad_58[0x8];                                       // 0x0058(0x0008)
};
...
{
public:
	struct FQuat4f                                Rotation;                                          // 0x0000(0x0010)
	struct FVector3f                              Translation;                                       // 0x0010(0x000C)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	struct FVector3f                              Scale3D;                                           // 0x0020(0x000C)
...
{
public:
	struct FUint32Point                           min_0;                                             // 0x0000(0x0008)
	struct FUint32Point                           max_0;                                             // 0x0008(0x0008)
};
...
{
public:
	uint64                                        X;                                                 // 0x0000(0x0008)
	uint64                                        Y;                                                 // 0x0008(0x0008)
	uint64                                        Z;                                                 // 0x0010(0x0008)
};
...
{
public:
	struct FUintPoint                             min_0;                                             // 0x0000(0x0008)
	struct FUintPoint                             max_0;                                             // 0x0008(0x0008)
};
...
public:
	...
	int32                                         C;                                                 // 0x0008(0x0004)
	int32                                         D;                                                 // 0x000C(0x0004)
	ETestInstanceDataObjectBird                   Bird;                                              // 0x0010(0x0001)
	ETestInstanceDataObjectGrain                  Grain;                                             // 0x0011(0x0001)
	ETestInstanceDataObjectFruit                  Fruit;                                             // 0x0012(0x0001)
	uint8                                         Pad_13[0x1];                                       // 0x0013(0x0001)
	ETestInstanceDataObjectDirection              Direction;                                         // 0x0014(0x0002)
	ETestInstanceDataObjectFullFlags              FullFlags;                                         // 0x0016(0x0001)
	ETestInstanceDataObjectGrain                  GrainFromEnumClass;                                // 0x0017(0x0001)
	ETestInstanceDataObjectFruit                  FruitFromNamespace;                                // 0x0018(0x0001)
	ETestInstanceDataObjectGrain                  GrainTypeChange;                                   // 0x0019(0x0001)
	ETestInstanceDataObjectFruit                  FruitTypeChange;                                   // 0x001A(0x0001)
	ETestInstanceDataObjectGrain                  GrainTypeAndPropertyChange;                        // 0x001B(0x0001)
	ETestInstanceDataObjectFruit                  FruitTypeAndPropertyChange;                        // 0x001C(0x0001)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)
	struct FTestInstanceDataObjectPoint           Point;                                             // 0x0020(0x0010)
};
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	int64                                         C;                                                 // 0x0008(0x0008)
	int32                                         D;                                                 // 0x0010(0x0004)
	int32                                         E;                                                 // 0x0014(0x0004)
	ETestInstanceDataObjectBird                   Bird;                                              // 0x0018(0x0001)
	ETestInstanceDataObjectGrainAlternate         Grain;                                             // 0x0019(0x0001)
	ETestInstanceDataObjectFruitAlternate         Fruit;                                             // 0x001A(0x0001)
	uint8                                         Pad_1B[0x1];                                       // 0x001B(0x0001)
	ETestInstanceDataObjectDirectionAlternate     Direction;                                         // 0x001C(0x0002)
	ETestInstanceDataObjectGrainAlternateEnumClass GrainFromEnumClass;                               // 0x001E(0x0001)
	ETestInstanceDataObjectFruitAlternateNamespace FruitFromNamespace;                               // 0x001F(0x0001)
	ETestInstanceDataObjectGrainAlternate         GrainTypeChange;                                   // 0x0020(0x0001)
	ETestInstanceDataObjectFruitAlternate         FruitTypeChange;                                   // 0x0021(0x0001)
	ETestInstanceDataObjectGrainAlternateEnumClass GrainTypeAndPropertyChange;                       // 0x0022(0x0001)
	ETestInstanceDataObjectFruitAlternateNamespace FruitTypeAndPropertyChange;                       // 0x0023(0x0001)
	ETestInstanceDataObjectGrainAlternate         DeletedGrain;                                      // 0x0024(0x0001)
	ETestInstanceDataObjectFruitAlternate         DeletedFruit;                                      // 0x0025(0x0001)
	ETestInstanceDataObjectDirectionAlternate     DeletedDirection;                                  // 0x0026(0x0002)
	struct FTestInstanceDataObjectPointAlternate  Point;                                             // 0x0028(0x000C)
...
{
public:
	class FName                                   Path;                                              // 0x0000(0x0008)
...
{
public:
	struct FOverriddenPropertyNodeID              NodeID;                                            // 0x0000(0x0010)
	EOverriddenPropertyOperation                  Operation;                                         // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
	TMap<struct FOverriddenPropertyNodeID, struct FOverriddenPropertyNodeID> SubPropertyNodeKeys;    // 0x0018(0x0050)
};
...
public:
	...
	TSet<struct FOverriddenPropertyNode>          OverriddenPropertyNodes;                           // 0x0008(0x0050)
	uint8                                         Pad_58[0x8];                                       // 0x0058(0x0008)
};

// ScriptStruct CoreUObject.PropertyTextFName
// 0x0018 (0x0018 - 0x0000)
struct FPropertyTextFName final
{
public:
...
// 0x0020 (0x0020 - 0x0000)
struct FPropertyTextString final
{
public:
...
// 0x0010 (0x0010 - 0x0000)
struct FInstancedStructContainer final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)
};
...
public:
	...
	struct FPropertyBagContainerTypes             ContainerTypes;                                    // 0x0021(0x0003)
...
{
public:
	TMap<class FName, class FString>              ObjectMetaData;                                    // 0x0000(0x0050)
};
...
{
public:
	TMap<class FName, class FString>              FieldMetaData;                                     // 0x0000(0x0050)
};
...
{
public:
	struct FObjectCookedMetaDataStore             ObjectMetaData;                                    // 0x0000(0x0050)
	TMap<class FName, struct FFieldCookedMetaDataStore> PropertiesMetaData;                          // 0x0050(0x0050)
};
...
public:
	class FString                                 Path;                                              // 0x0000(0x0010)
	TFieldPath<class FMapProperty>                Property;                                          // 0x0010(0x0020)
};
...
{
public:
	class UFunction*                              Func;                                              // 0x0000(0x0008)
	bool                                          bIsInstanceMember;                                 // 0x0008(0x0001)
	bool                                          bIsFallible;                                       // 0x0009(0x0001)
...
{
public:
	TMap<int32, struct FVerseClassVarAccessor>    Getters;                                           // 0x0000(0x0050)
	TMap<int32, struct FVerseClassVarAccessor>    Setters;                                           // 0x0050(0x0050)
};
