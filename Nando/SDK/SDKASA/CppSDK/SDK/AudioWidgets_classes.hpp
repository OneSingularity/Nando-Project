...
{
public:
	struct FAudioMaterialButtonStyle              WidgetStyle;                                       // 0x0200(0x0088)
	TMulticastInlineDelegate<void(bool bIsPressed)> OnButtonPressedChangedEvent;                     // 0x0288(0x0010)
	bool                                          bIsPressed;                                        // 0x0298(0x0001)
	uint8                                         Pad_299[0x17];                                     // 0x0299(0x0017)
...
{
public:
	struct FAudioMaterialEnvelopeStyle            WidgetStyle;                                       // 0x0200(0x0048)
	struct FAudioMaterialEnvelopeSettings         EnvelopeSettings;                                  // 0x0248(0x0024)
	uint8                                         Pad_26C[0x14];                                     // 0x026C(0x0014)
...
{
public:
	struct FAudioMaterialKnobStyle                WidgetStyle;                                       // 0x0200(0x01C0)
	TMulticastInlineDelegate<void(float Value)>   OnKnobValueChanged;                                // 0x03C0(0x0010)
	float                                         Value;                                             // 0x03D0(0x0004)
	float                                         TuneSpeed;                                         // 0x03D4(0x0004)
	float                                         FineTuneSpeed;                                     // 0x03D8(0x0004)
	bool                                          bLocked;                                           // 0x03DC(0x0001)
	bool                                          bMouseUsesStep;                                    // 0x03DD(0x0001)
	uint8                                         Pad_3DE[0x2];                                      // 0x03DE(0x0002)
	float                                         StepSize;                                          // 0x03E0(0x0004)
	uint8                                         Pad_3E4[0x1C];                                     // 0x03E4(0x001C)
...
{
public:
	struct FAudioMaterialMeterStyle               WidgetStyle;                                       // 0x0200(0x00F0)
	EOrientation                                  Orientation;                                       // 0x02F0(0x0001)
	uint8                                         Pad_2F1[0x3];                                      // 0x02F1(0x0003)
	TDelegate<void()>                             MeterChannelInfoDelegate;                          // 0x02F4(0x0010)
	uint8                                         Pad_304[0x14];                                     // 0x0304(0x0014)
	TArray<struct FMeterChannelInfo>              MeterChannelInfo;                                  // 0x0318(0x0010)
...
{
public:
	struct FAudioMaterialSliderStyle              WidgetStyle;                                       // 0x0200(0x0150)
	TMulticastInlineDelegate<void(float Value)>   OnValueChanged;                                    // 0x0350(0x0010)
	float                                         Value;                                             // 0x0360(0x0004)
	EOrientation                                  Orientation;                                       // 0x0364(0x0001)
	uint8                                         Pad_365[0x3];                                      // 0x0365(0x0003)
	float                                         TuneSpeed;                                         // 0x0368(0x0004)
	float                                         FineTuneSpeed;                                     // 0x036C(0x0004)
	bool                                          bLocked;                                           // 0x0370(0x0001)
	bool                                          bMouseUsesStep;                                    // 0x0371(0x0001)
	uint8                                         Pad_372[0x2];                                      // 0x0372(0x0002)
	float                                         StepSize;                                          // 0x0374(0x0004)
	uint8                                         Pad_378[0x18];                                     // 0x0378(0x0018)
...
{
public:
	struct FAudioMaterialKnobStyle                KnobStyle;                                         // 0x0030(0x01C0)
...
{
public:
	struct FAudioMaterialMeterStyle               MeterStyle;                                        // 0x0030(0x00F0)
...
{
public:
	struct FAudioMaterialButtonStyle              ButtonStyle;                                       // 0x0030(0x0088)
...
{
public:
	struct FAudioMaterialSliderStyle              SliderStyle;                                       // 0x0030(0x0150)
...
{
public:
	TArray<struct FMeterChannelInfo>              MeterChannelInfo;                                  // 0x0200(0x0010)
	TDelegate<void()>                             MeterChannelInfoDelegate;                          // 0x0210(0x0010)
	struct FAudioMeterStyle                       WidgetStyle;                                       // 0x0220(0x0430)
	EOrientation                                  Orientation;                                       // 0x0650(0x0001)
	uint8                                         Pad_651[0x3];                                      // 0x0651(0x0003)
	struct FLinearColor                           BackgroundColor;                                   // 0x0654(0x0010)
	struct FLinearColor                           MeterBackgroundColor;                              // 0x0664(0x0010)
	struct FLinearColor                           MeterValueColor;                                   // 0x0674(0x0010)
	struct FLinearColor                           MeterPeakColor;                                    // 0x0684(0x0010)
	struct FLinearColor                           MeterClippingColor;                                // 0x0694(0x0010)
	struct FLinearColor                           MeterScaleColor;                                   // 0x06A4(0x0010)
	struct FLinearColor                           MeterScaleLabelColor;                              // 0x06B4(0x0010)
	uint8                                         Pad_6C4[0x1C];                                     // 0x06C4(0x001C)
...
{
public:
	struct FAudioOscilloscopePanelStyle           OscilloscopeStyle;                                 // 0x0200(0x0440)
	class UAudioBus*                              AudioBus;                                          // 0x0640(0x0008)
	float                                         MaxTimeWindowMs;                                   // 0x0648(0x0004)
	float                                         TimeWindowMs;                                      // 0x064C(0x0004)
	float                                         AnalysisPeriodMs;                                  // 0x0650(0x0004)
	bool                                          bShowTimeGrid;                                     // 0x0654(0x0001)
	EXAxisLabelsUnit                              TimeGridLabelsUnit;                                // 0x0655(0x0001)
	bool                                          bShowAmplitudeGrid;                                // 0x0656(0x0001)
	bool                                          bShowAmplitudeLabels;                              // 0x0657(0x0001)
	EYAxisLabelsUnit                              AmplitudeGridLabelsUnit;                           // 0x0658(0x0001)
	EAudioOscilloscopeTriggerMode                 TriggerMode;                                       // 0x0659(0x0001)
	uint8                                         Pad_65A[0x2];                                      // 0x065A(0x0002)
	float                                         TriggerThreshold;                                  // 0x065C(0x0004)
	EAudioPanelLayoutType                         PanelLayoutType;                                   // 0x0660(0x0001)
	uint8                                         Pad_661[0x3];                                      // 0x0661(0x0003)
	int32                                         ChannelToAnalyze;                                  // 0x0664(0x0004)
	uint8                                         Pad_668[0x58];                                     // 0x0668(0x0058)
...
public:
	...
	EAudioRadialSliderLayout                      WidgetLayout;                                      // 0x0214(0x0001)
	uint8                                         Pad_215[0x3];                                      // 0x0215(0x0003)
	struct FLinearColor                           CenterBackgroundColor;                             // 0x0218(0x0010)
	struct FLinearColor                           SliderProgressColor;                               // 0x0228(0x0010)
	struct FLinearColor                           SliderBarColor;                                    // 0x0238(0x0010)
	struct FVector2D                              HandStartEndRatio;                                 // 0x0248(0x0010)
	class FText                                   UnitsText;                                         // 0x0258(0x0010)
	struct FLinearColor                           TextLabelBackgroundColor;                          // 0x0268(0x0010)
	bool                                          ShowLabelOnlyOnHover;                              // 0x0278(0x0001)
	bool                                          ShowUnitsText;                                     // 0x0279(0x0001)
	bool                                          IsUnitsTextReadOnly;                               // 0x027A(0x0001)
	bool                                          IsValueTextReadOnly;                               // 0x027B(0x0001)
	float                                         SliderThickness;                                   // 0x027C(0x0004)
	struct FVector2D                              OutputRange;                                       // 0x0280(0x0010)
	TMulticastInlineDelegate<void(float Value)>   OnValueChanged;                                    // 0x0290(0x0010)
	uint8                                         Pad_2A0[0x150];                                    // 0x02A0(0x0150)
...
public:
	...
	class FText                                   UnitsText;                                         // 0x0208(0x0010)
	struct FLinearColor                           TextLabelBackgroundColor;                          // 0x0218(0x0010)
	TDelegate<void()>                             TextLabelBackgroundColorDelegate;                  // 0x0228(0x0010)
	bool                                          ShowLabelOnlyOnHover;                              // 0x0238(0x0001)
	bool                                          ShowUnitsText;                                     // 0x0239(0x0001)
	bool                                          IsUnitsTextReadOnly;                               // 0x023A(0x0001)
	bool                                          IsValueTextReadOnly;                               // 0x023B(0x0001)
	TDelegate<void()>                             ValueDelegate;                                     // 0x023C(0x0010)
	struct FLinearColor                           SliderBackgroundColor;                             // 0x024C(0x0010)
	TDelegate<void()>                             SliderBackgroundColorDelegate;                     // 0x025C(0x0010)
	struct FLinearColor                           SliderBarColor;                                    // 0x026C(0x0010)
	TDelegate<void()>                             SliderBarColorDelegate;                            // 0x027C(0x0010)
	struct FLinearColor                           SliderThumbColor;                                  // 0x028C(0x0010)
	TDelegate<void()>                             SliderThumbColorDelegate;                          // 0x029C(0x0010)
	struct FLinearColor                           WidgetBackgroundColor;                             // 0x02AC(0x0010)
	TDelegate<void()>                             WidgetBackgroundColorDelegate;                     // 0x02BC(0x0010)
	EOrientation                                  Orientation;                                       // 0x02CC(0x0001)
	uint8                                         Pad_2CD[0x3];                                      // 0x02CD(0x0003)
	TMulticastInlineDelegate<void(float Value)>   OnValueChanged;                                    // 0x02D0(0x0010)
	uint8                                         Pad_2E0[0x660];                                    // 0x02E0(0x0660)
...
{
public:
	TWeakObjectPtr<class UCurveFloat>             LinToOutputCurve;                                  // 0x0940(0x0008)
	TWeakObjectPtr<class UCurveFloat>             OutputToLinCurve;                                  // 0x0948(0x0008)
...
{
public:
	struct FVector2D                              OutputRange;                                       // 0x0940(0x0010)
...
{
public:
	struct FAudioVectorscopePanelStyle            VectorscopeStyle;                                  // 0x0200(0x01A0)
	class UAudioBus*                              AudioBus;                                          // 0x03A0(0x0008)
	bool                                          bShowGrid;                                         // 0x03A8(0x0001)
	uint8                                         Pad_3A9[0x3];                                      // 0x03A9(0x0003)
	int32                                         GridDivisions;                                     // 0x03AC(0x0004)
	float                                         MaxDisplayPersistenceMs;                           // 0x03B0(0x0004)
	float                                         DisplayPersistenceMs;                              // 0x03B4(0x0004)
	float                                         Scale;                                             // 0x03B8(0x0004)
	EAudioPanelLayoutType                         PanelLayoutType;                                   // 0x03BC(0x0001)
	uint8                                         Pad_3BD[0x53];                                     // 0x03BD(0x0053)
