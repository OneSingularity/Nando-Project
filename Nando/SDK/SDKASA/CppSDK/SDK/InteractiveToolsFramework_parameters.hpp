...
{
public:
	bool                                          bHoveringIn;                                       // 0x0000(0x0001)
};
...
{
public:
	struct FVector                                TangentXOut;                                       // 0x0000(0x0018)
	struct FVector                                TangentYOut;                                       // 0x0018(0x0018)
};
...
{
public:
	bool                                          bInteracting;                                      // 0x0000(0x0001)
};
...
{
public:
	bool                                          bHittable;                                         // 0x0000(0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	uint32                                        InPartIdentifier;                                  // 0x0004(0x0004)
};
...
{
public:
	struct FVector2D                              NewValue;                                          // 0x0000(0x0010)
};
