...
{
public:
	TSoftObjectPtr<class USkeletalMesh>           SkeletalMesh;                                      // 0x0030(0x0028)
	int32                                         SkeletalLODIndex;                                  // 0x0058(0x0004)
	uint8                                         Pad_5C[0x4];                                       // 0x005C(0x0004)
	TSoftObjectPtr<class UStaticMesh>             StaticMesh;                                        // 0x0060(0x0028)
	int32                                         StaticLODIndex;                                    // 0x0088(0x0004)
	int32                                         UVChannel;                                         // 0x008C(0x0004)
	int32                                         NumDriverTriangles;                                // 0x0090(0x0004)
	float                                         Sigma;                                             // 0x0094(0x0004)
	int32                                         MaxHeight;                                         // 0x0098(0x0004)
	int32                                         MaxWidth;                                          // 0x009C(0x0004)
	bool                                          bEnforcePowerOfTwo;                                // 0x00A0(0x0001)
	EAnimToTexturePrecision                       Precision;                                         // 0x00A1(0x0001)
	EAnimToTextureMode                            Mode;                                              // 0x00A2(0x0001)
	uint8                                         Pad_A3[0x5];                                       // 0x00A3(0x0005)
	TSoftObjectPtr<class UTexture2D>              VertexPositionTexture;                             // 0x00A8(0x0028)
	TSoftObjectPtr<class UTexture2D>              VertexNormalTexture;                               // 0x00D0(0x0028)
	TSoftObjectPtr<class UTexture2D>              BonePositionTexture;                               // 0x00F8(0x0028)
	TSoftObjectPtr<class UTexture2D>              BoneRotationTexture;                               // 0x0120(0x0028)
	TSoftObjectPtr<class UTexture2D>              BoneWeightTexture;                                 // 0x0148(0x0028)
	struct FTransform                             RootTransform;                                     // 0x0170(0x0060)
	class FName                                   AttachToSocket;                                    // 0x01D0(0x0008)
	float                                         SampleRate;                                        // 0x01D8(0x0004)
	uint8                                         Pad_1DC[0x4];                                      // 0x01DC(0x0004)
	TArray<struct FAnimToTextureAnimSequenceInfo> AnimSequences;                                     // 0x01E0(0x0010)
	bool                                          bAutoPlay;                                         // 0x01F0(0x0001)
	uint8                                         Pad_1F1[0x3];                                      // 0x01F1(0x0003)
	int32                                         animationIndex;                                    // 0x01F4(0x0004)
	int32                                         Frame;                                             // 0x01F8(0x0004)
	EAnimToTextureNumBoneInfluences               NumBoneInfluences;                                 // 0x01FC(0x0001)
	uint8                                         Pad_1FD[0x3];                                      // 0x01FD(0x0003)
	int32                                         NumFrames;                                         // 0x0200(0x0004)
	int32                                         NumBones;                                          // 0x0204(0x0004)
	int32                                         VertexRowsPerFrame;                                // 0x0208(0x0004)
	struct FVector3f                              VertexMinBBox;                                     // 0x020C(0x000C)
	struct FVector3f                              VertexSizeBBox;                                    // 0x0218(0x000C)
	int32                                         BoneWeightRowsPerFrame;                            // 0x0224(0x0004)
	int32                                         BoneRowsPerFrame;                                  // 0x0228(0x0004)
	struct FVector3f                              BoneMinBBox;                                       // 0x022C(0x000C)
	struct FVector3f                              BoneSizeBBox;                                      // 0x0238(0x000C)
	uint8                                         Pad_244[0x4];                                      // 0x0244(0x0004)
	TArray<struct FAnimToTextureAnimInfo>         Animations;                                        // 0x0248(0x0010)
