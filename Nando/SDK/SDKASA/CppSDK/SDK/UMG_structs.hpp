...
public:
	...
	struct FMargin                                Offsets;                                           // 0x0020(0x0010)
	struct FVector2D                              Alignment;                                         // 0x0030(0x0010)
	int32                                         ZOrder;                                            // 0x0040(0x0004)
...
public:
	...
	struct FVector2D                              Shear;                                             // 0x0020(0x0010)
...
{
public:
	uint8                                         bOverride_TextShapingMethod : 1;                   // 0x0000(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_TextFlowDirection : 1;                   // 0x0000(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
public:
	...
	TWeakObjectPtr<class UWidget>                 WidgetPtr;                                         // 0x0008(0x0008)
};
...
{
public:
	class UWidgetAnimation*                       WidgetAnimation;                                   // 0x0000(0x0008)
	uint8                                         Pad_8[0x30];                                       // 0x0008(0x0030)
};
...
{
public:
	class FName                                   TargetName;                                        // 0x0000(0x0008)
	class UUIComponent*                           Component;                                         // 0x0008(0x0008)
};
...
public:
	...
	TDelegate<void(EUINavigation Navigation)>     CustomDelegate;                                    // 0x0014(0x0010)
};
...
public:
	class FName                                   WidgetName;                                        // 0x0000(0x0008)
	class FName                                   SlotWidgetName;                                    // 0x0008(0x0008)
	struct FGuid                                  AnimationGuid;                                     // 0x0010(0x0010)
...
public:
	...
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	class FName                                   AnimationToBind;                                   // 0x0004(0x0008)
	class FName                                   FunctionNameToBind;                                // 0x000C(0x0008)
	class FName                                   UserTag;                                           // 0x0014(0x0008)
};
...
// 0x0008 (0x0008 - 0x0000)
struct FWidgetStateBitfield final
{
public:
...
public:
	...
	uint8                                         Pad_20[0x68];                                      // 0x0020(0x0068)
};
...
{
public:
	struct FMargin                                Offsets;                                           // 0x0000(0x0010)
	struct FAnchors                               Anchors;                                           // 0x0010(0x0020)
	struct FVector2D                              Alignment;                                         // 0x0030(0x0010)
};
...
{
public:
	ESlatePostRT                                  BufferToUpdate;                                    // 0x0000(0x0001)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)
	class USlatePostBufferProcessorUpdater*       PostParamUpdater;                                  // 0x0008(0x0008)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FSlateBrush                            Brush;                                             // 0x0010(0x00B0)
};
...
public:
	...
	struct FVector2f                              UV0;                                               // 0x000C(0x0008)
	struct FVector2f                              UV1;                                               // 0x0014(0x0008)
	struct FVector2f                              UV2;                                               // 0x001C(0x0008)
	struct FVector2f                              UV3;                                               // 0x0024(0x0008)
	struct FVector2f                              UV4;                                               // 0x002C(0x0008)
	struct FVector2f                              UV5;                                               // 0x0034(0x0008)
};
...
{
public:
	class FString                                 ObjectName;                                        // 0x0000(0x0010)
	class FName                                   PropertyName;                                      // 0x0010(0x0008)
	class FName                                   FunctionName;                                      // 0x0018(0x0008)
	struct FDynamicPropertyPath                   SourcePath;                                        // 0x0020(0x0038)
