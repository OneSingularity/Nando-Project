...
{
public:
	TArray<struct FCameraRigAssetReference>       CameraRigReferences;                               // 0x0038(0x0010)
...
{
public:
	struct FCameraRigInputSlotParameters          InputSlotParameters;                               // 0x0038(0x0002)
	uint8                                         Pad_3A[0x6];                                       // 0x003A(0x0006)
	struct FCameraParameterClamping               clamp;                                             // 0x0040(0x0018)
	struct FCameraParameterNormalization          Normalize;                                         // 0x0058(0x0010)
	EBuiltInDoubleCameraVariable                  BuiltInVariable;                                   // 0x0068(0x0004)
	uint8                                         Pad_6C[0x4];                                       // 0x006C(0x0004)
	struct FDoubleCameraVariableReference         CustomVariable;                                    // 0x0070(0x0008)
	struct FCameraVariableID                      TransientVariableID;                               // 0x0078(0x0004)
	struct FCameraVariableID                      VariableID;                                        // 0x007C(0x0004)
...
public:
	struct FCameraRigInputSlotParameters          InputSlotParameters;                               // 0x0038(0x0002)
	uint8                                         Pad_3A[0x6];                                       // 0x003A(0x0006)
	struct FCameraParameterClamping               ClampX;                                            // 0x0040(0x0018)
	struct FCameraParameterClamping               ClampY;                                            // 0x0058(0x0018)
	struct FCameraParameterNormalization          NormalizeX;                                        // 0x0070(0x0010)
	struct FCameraParameterNormalization          NormalizeY;                                        // 0x0080(0x0010)
	EBuiltInVector2dCameraVariable                BuiltInVariable;                                   // 0x0090(0x0004)
	uint8                                         Pad_94[0x4];                                       // 0x0094(0x0004)
	struct FVector2dCameraVariableReference       CustomVariable;                                    // 0x0098(0x0008)
	struct FCameraVariableID                      TransientVariableID;                               // 0x00A0(0x0004)
	struct FCameraVariableID                      VariableID;                                        // 0x00A4(0x0004)
...
{
public:
	struct FGuid                                  Guid;                                              // 0x0028(0x0010)
...
{
public:
	TArray<struct FCameraRigProxyTableEntry>      Entries;                                           // 0x0028(0x0010)
...
{
public:
	TArray<class UInputAction*>                   AxisActions;                                       // 0x00A8(0x0010)
	struct FBooleanCameraParameter                RevertAxisX;                                       // 0x00B8(0x0010)
	struct FBooleanCameraParameter                RevertAxisY;                                       // 0x00C8(0x0010)
	struct FVector2dCameraParameter               Multiplier;                                        // 0x00D8(0x0018)
...
{
public:
	ECameraBlendStackType                         BlendStackType;                                    // 0x0038(0x0004)
...
{
public:
	class UBlendCameraNode*                       Blend;                                             // 0x0038(0x0008)
	class UCameraNode*                            RootNode;                                          // 0x0040(0x0008)
...
public:
	...
	class UCameraDirector*                        CameraDirector;                                    // 0x0048(0x0008)
	TArray<class UCameraRigAsset*>                CameraRigs;                                        // 0x0050(0x0010)
	TArray<class UCameraRigTransition*>           EnterTransitions;                                  // 0x0060(0x0010)
	TArray<class UCameraRigTransition*>           ExitTransitions;                                   // 0x0070(0x0010)
	ECameraBuildStatus                            BuildStatus;                                       // 0x0080(0x0001)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	class UCameraNode*                            Target;                                            // 0x0030(0x0008)
	class FName                                   TargetPropertyName;                                // 0x0038(0x0008)
	class FString                                 InterfaceParameterName;                            // 0x0040(0x0010)
	struct FGuid                                  Guid;                                              // 0x0050(0x0010)
	class UCameraVariableAsset*                   PrivateVariable;                                   // 0x0060(0x0008)
...
public:
	uint8                                         Pad_28[0x20];                                      // 0x0028(0x0020)
	class UCameraNode*                            RootNode;                                          // 0x0048(0x0008)
	struct FGameplayTagContainer                  GameplayTags;                                      // 0x0050(0x0020)
	struct FCameraRigInterface                    Interface;                                         // 0x0070(0x0020)
	TArray<class UCameraRigTransition*>           EnterTransitions;                                  // 0x0090(0x0010)
	TArray<class UCameraRigTransition*>           ExitTransitions;                                   // 0x00A0(0x0010)
	ECameraRigInitialOrientation                  InitialOrientation;                                // 0x00B0(0x0004)
	uint8                                         Pad_B4[0x4];                                       // 0x00B4(0x0004)
	struct FCameraRigAllocationInfo               AllocationInfo;                                    // 0x00B8(0x0028)
	ECameraBuildStatus                            BuildStatus;                                       // 0x00E0(0x0001)
	uint8                                         Pad_E1[0x3];                                       // 0x00E1(0x0003)
	struct FGuid                                  Guid;                                              // 0x00E4(0x0010)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	TArray<class UCameraRigTransitionCondition*>  Conditions;                                        // 0x0030(0x0010)
	class UBlendCameraNode*                       Blend;                                             // 0x0040(0x0008)
	ECameraRigInitialOrientation                  InitialOrientation;                                // 0x0048(0x0004)
	bool                                          bOverrideInitialOrientation;                       // 0x004C(0x0001)
	bool                                          bAllowCameraRigMerging;                            // 0x004D(0x0001)
...
{
public:
	bool                                          bAutoReset;                                        // 0x0028(0x0001)
	bool                                          bIsPrivate;                                        // 0x0029(0x0001)
	bool                                          bIsInput;                                          // 0x002A(0x0001)
	uint8                                         Pad_2B[0x1];                                       // 0x002B(0x0001)
	struct FGuid                                  Guid;                                              // 0x002C(0x0010)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
...
{
public:
	bool                                          bDefaultValue;                                     // 0x0040(0x0001)
...
{
public:
	int32                                         DefaultValue;                                      // 0x0040(0x0004)
...
{
public:
	float                                         DefaultValue;                                      // 0x0040(0x0004)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)
...
{
public:
	double                                        DefaultValue;                                      // 0x0040(0x0008)
...
{
public:
	struct FVector2f                              DefaultValue;                                      // 0x0040(0x0008)
...
{
public:
	struct FVector2D                              DefaultValue;                                      // 0x0040(0x0010)
...
{
public:
	struct FVector3f                              DefaultValue;                                      // 0x0040(0x000C)
...
{
public:
	struct FVector3d                              DefaultValue;                                      // 0x0040(0x0018)
...
{
public:
	struct FVector4f                              DefaultValue;                                      // 0x0040(0x0010)
...
{
public:
	struct FVector4d                              DefaultValue;                                      // 0x0040(0x0020)
...
{
public:
	struct FRotator3f                             DefaultValue;                                      // 0x0040(0x000C)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)
...
{
public:
	struct FRotator3d                             DefaultValue;                                      // 0x0040(0x0018)
...
{
public:
	struct FTransform3f                           DefaultValue;                                      // 0x0040(0x0030)
...
{
public:
	struct FTransform3d                           DefaultValue;                                      // 0x0040(0x0060)
...
{
public:
	TArray<class UCameraVariableAsset*>           Variables;                                         // 0x0028(0x0010)
...
{
public:
	class UBlendStackCameraNode*                  BaseLayer;                                         // 0x0038(0x0008)
	class UBlendStackCameraNode*                  MainLayer;                                         // 0x0040(0x0008)
	class UBlendStackCameraNode*                  GlobalLayer;                                       // 0x0048(0x0008)
	class UBlendStackCameraNode*                  VisualLayer;                                       // 0x0050(0x0008)
...
{
public:
	TSubclassOf<class UBlueprintCameraDirectorEvaluator> CameraDirectorEvaluatorClass;               // 0x0028(0x0008)
	class UCameraRigProxyTable*                   CameraRigProxyTable;                               // 0x0030(0x0008)
...
{
public:
	TArray<struct FStateTreeExternalDataDesc>     ContextDataDescs;                                  // 0x0028(0x0010)
...
{
public:
	class UCameraRigAsset*                        CameraRig;                                         // 0x0028(0x0008)
...
{
public:
	struct FStateTreeReference                    StateTreeReference;                                // 0x0028(0x0028)
	class UCameraRigProxyTable*                   CameraRigProxyTable;                               // 0x0050(0x0008)
...
{
public:
	uint8                                         Pad_D0[0x20];                                      // 0x00D0(0x0020)
	class UGameplayCameraSystemHost*              CameraSystemHost;                                  // 0x00F0(0x0008)
...
{
public:
	class UGameplayCameraComponent*               CameraComponent;                                   // 0x0490(0x0008)
...
{
public:
	class UCameraAsset*                           Camera;                                            // 0x0278(0x0008)
	EAutoReceiveInput                             AutoActivateForPlayer;                             // 0x0280(0x0001)
	uint8                                         Pad_281[0x1F];                                     // 0x0281(0x001F)
	class UGameplayCameraSystemHost*              CameraSystemHost;                                  // 0x02A0(0x0008)
...
{
public:
	class UGameplayCameraSystemComponent*         CameraSystemComponent;                             // 0x0490(0x0008)
...
{
public:
	EAutoReceiveInput                             AutoActivateForPlayer;                             // 0x0278(0x0001)
	bool                                          bSetPlayerControllerRotation;                      // 0x0279(0x0001)
	uint8                                         Pad_27A[0x6];                                      // 0x027A(0x0006)
	class UGameplayCameraSystemHost*              CameraSystemHost;                                  // 0x0280(0x0008)
	TWeakObjectPtr<class APlayerController>       WeakPlayerController;                              // 0x0288(0x0008)
...
{
public:
	TArray<class UInputAction*>                   AxisActions;                                       // 0x00D0(0x0010)
	float                                         AxisActionAngularSpeedThreshold;                   // 0x00E0(0x0004)
	float                                         AxisActionMagnitudeThreshold;                      // 0x00E4(0x0004)
	EAutoReceiveInput                             AutoActivateForPlayer;                             // 0x00E8(0x0001)
	uint8                                         Pad_E9[0x7];                                       // 0x00E9(0x0007)
	class APlayerController*                      PlayerController;                                  // 0x00F0(0x0008)
	class UGameplayCameraSystemHost*              CameraSystemHost;                                  // 0x00F8(0x0008)
...
{
public:
	bool                                          bAutoSpawnCameraSystemActor;                       // 0x0038(0x0001)
	bool                                          bAutoSpawnCameraSystemActorSetsControlRotation;    // 0x0039(0x0001)
	uint8                                         Pad_3A[0x2];                                       // 0x003A(0x0002)
	int32                                         CombinedCameraRigNumThreshold;                     // 0x003C(0x0004)
	double                                        DefaultIKAimingAngleTolerance;                     // 0x0040(0x0008)
	double                                        DefaultIKAimingDistanceTolerance;                  // 0x0048(0x0008)
	uint8                                         DefaultIKAimingMaxIterations;                      // 0x0050(0x0001)
	uint8                                         Pad_51[0x7];                                       // 0x0051(0x0007)
	double                                        DefaultIKAimingMinDistance;                        // 0x0058(0x0008)
...
{
public:
	struct FBooleanCameraParameter                AttachToLocation;                                  // 0x0038(0x0010)
	struct FBooleanCameraParameter                AttachToRotation;                                  // 0x0048(0x0010)
...
{
public:
	class USimpleBlendCameraNode*                 DrivingBlend;                                      // 0x0038(0x0008)
...
{
public:
	ECollisionSafePosition                        SafePosition;                                      // 0x0038(0x0001)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
	struct FVector3dCameraVariableReference       CustomSafePosition;                                // 0x0040(0x0008)
	struct FVector3dCameraParameter               SafePositionOffset;                                // 0x0048(0x0020)
	ECollisionSafePositionOffsetSpace             SafePositionOffsetSpace;                           // 0x0068(0x0001)
	uint8                                         Pad_69[0x7];                                       // 0x0069(0x0007)
	struct FBooleanCameraVariableReference        EnableCollision;                                   // 0x0070(0x0008)
	struct FFloatCameraParameter                  CollisionSphereRadius;                             // 0x0078(0x0010)
	ECollisionChannel                             CollisionChannel;                                  // 0x0088(0x0001)
	uint8                                         Pad_89[0x7];                                       // 0x0089(0x0007)
	class UCameraValueInterpolator*               PushInterpolator;                                  // 0x0090(0x0008)
	class UCameraValueInterpolator*               PullInterpolator;                                  // 0x0098(0x0008)
	bool                                          bRunAsyncCollision;                                // 0x00A0(0x0001)
...
{
public:
	class UMaterialInterface*                     OcclusionTransparencyMaterial;                     // 0x0038(0x0008)
	struct FFloatCameraParameter                  OcclusionSphereRadius;                             // 0x0040(0x0010)
	ECollisionChannel                             OcclusionChannel;                                  // 0x0050(0x0001)
	ECameraNodeOriginPosition                     OcclusionTargetPosition;                           // 0x0051(0x0001)
	ECameraNodeSpace                              OcclusionTargetOffsetSpace;                        // 0x0052(0x0001)
	uint8                                         Pad_53[0x5];                                       // 0x0053(0x0005)
	struct FVector3dCameraParameter               OcclusionTargetOffset;                             // 0x0058(0x0020)
...
{
public:
	TArray<class UCameraNode*>                    Children;                                          // 0x0038(0x0010)
...
{
public:
	struct FVector3dCameraParameter               BoomOffset;                                        // 0x0038(0x0020)
	class UCameraValueInterpolator*               BoomLengthInterpolator;                            // 0x0058(0x0008)
	struct FDoubleCameraParameter                 MaxForwardInterpolationFactor;                     // 0x0060(0x0010)
	struct FDoubleCameraParameter                 MaxBackwardInterpolationFactor;                    // 0x0070(0x0010)
	class UInput2DCameraNode*                     InputSlot;                                         // 0x0080(0x0008)
...
{
public:
	struct FCameraRigAssetReference               CameraRigReference;                                // 0x0038(0x00E8)
	class UCameraRigAsset*                        CameraRig;                                         // 0x0120(0x0008)
	TArray<struct FBooleanCameraRigParameterOverride> BooleanOverrides;                              // 0x0128(0x0010)
	TArray<struct FInteger32CameraRigParameterOverride> Integer32Overrides;                          // 0x0138(0x0010)
	TArray<struct FFloatCameraRigParameterOverride> FloatOverrides;                                  // 0x0148(0x0010)
	TArray<struct FDoubleCameraRigParameterOverride> DoubleOverrides;                                // 0x0158(0x0010)
	TArray<struct FVector2fCameraRigParameterOverride> Vector2fOverrides;                            // 0x0168(0x0010)
	TArray<struct FVector2dCameraRigParameterOverride> Vector2dOverrides;                            // 0x0178(0x0010)
	TArray<struct FVector3fCameraRigParameterOverride> Vector3fOverrides;                            // 0x0188(0x0010)
	TArray<struct FVector3dCameraRigParameterOverride> Vector3dOverrides;                            // 0x0198(0x0010)
	TArray<struct FVector4fCameraRigParameterOverride> Vector4fOverrides;                            // 0x01A8(0x0010)
	TArray<struct FVector4dCameraRigParameterOverride> Vector4dOverrides;                            // 0x01B8(0x0010)
	TArray<struct FRotator3fCameraRigParameterOverride> Rotator3fOverrides;                          // 0x01C8(0x0010)
	TArray<struct FRotator3dCameraRigParameterOverride> Rotator3dOverrides;                          // 0x01D8(0x0010)
	TArray<struct FTransform3fCameraRigParameterOverride> Transform3fOverrides;                      // 0x01E8(0x0010)
	TArray<struct FTransform3dCameraRigParameterOverride> Transform3dOverrides;                      // 0x01F8(0x0010)
...
{
public:
	struct FDoubleCameraParameter                 NearPlane;                                         // 0x0038(0x0010)
	struct FDoubleCameraParameter                 FarPlane;                                          // 0x0048(0x0010)
...
{
public:
	struct FFloatCameraParameter                  ForwardDampingFactor;                              // 0x0038(0x0010)
	struct FFloatCameraParameter                  LateralDampingFactor;                              // 0x0048(0x0010)
	struct FFloatCameraParameter                  VerticalDampingFactor;                             // 0x0058(0x0010)
	ECameraNodeSpace                              DampenSpace;                                       // 0x0068(0x0001)
	uint8                                         Pad_69[0x7];                                       // 0x0069(0x0007)
...
{
public:
	struct FFloatCameraParameter                  FieldOfView;                                       // 0x0038(0x0010)
...
{
public:
	struct FFloatCameraParameter                  SensorWidth;                                       // 0x0038(0x0010)
	struct FFloatCameraParameter                  SensorHeight;                                      // 0x0048(0x0010)
	struct FFloatCameraParameter                  ISO;                                               // 0x0058(0x0010)
	struct FBooleanCameraParameter                ConstrainAspectRatio;                              // 0x0068(0x0010)
	struct FBooleanCameraParameter                OverrideAspectRatioAxisConstraint;                 // 0x0078(0x0010)
	EAspectRatioAxisConstraint                    AspectRatioAxisConstraint;                         // 0x0088(0x0001)
	uint8                                         Pad_89[0x7];                                       // 0x0089(0x0007)
...
{
public:
	struct FFloatCameraParameter                  FocalLength;                                       // 0x0038(0x0010)
	struct FFloatCameraParameter                  FocusDistance;                                     // 0x0048(0x0010)
	struct FFloatCameraParameter                  Aperture;                                          // 0x0058(0x0010)
	struct FFloatCameraParameter                  ShutterSpeed;                                      // 0x0068(0x0010)
	struct FBooleanCameraParameter                EnablePhysicalCamera;                              // 0x0078(0x0010)
...
{
public:
	struct FVector3dCameraParameter               TranslationOffset;                                 // 0x0038(0x0020)
	struct FRotator3dCameraParameter              RotationOffset;                                    // 0x0058(0x0020)
	ECameraNodeSpace                              OffsetSpace;                                       // 0x0078(0x0001)
...
public:
	...
	struct FPostProcessSettings                   PostProcessSettings;                               // 0x0040(0x0820)
...
public:
	...
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
	struct FBooleanCameraParameter                AutoFocus;                                         // 0x0040(0x0010)
...
{
public:
	struct FVector3dCameraVariableReference       TargetLocation;                                    // 0x0038(0x0008)
	struct FDoubleCameraParameter                 HorizontalFraming;                                 // 0x0040(0x0010)
	struct FDoubleCameraParameter                 VerticalFraming;                                   // 0x0050(0x0010)
	struct FFloatCameraParameter                  ReframeDampingFactor;                              // 0x0060(0x0010)
	struct FFloatCameraParameter                  LowReframeDampingFactor;                           // 0x0070(0x0010)
	struct FFloatCameraParameter                  ReframeUnlockRadius;                               // 0x0080(0x0010)
	struct FCameraFramingZone                     DeadZone;                                          // 0x0090(0x0040)
	struct FCameraFramingZone                     SoftZone;                                          // 0x00D0(0x0040)
...
{
public:
	struct FBooleanCameraParameter                CanMoveLaterally;                                  // 0x0110(0x0010)
	struct FBooleanCameraParameter                CanMoveVertically;                                 // 0x0120(0x0010)
...
{
public:
	struct FBooleanCameraParameter                CanPanLaterally;                                   // 0x0110(0x0010)
	struct FBooleanCameraParameter                CanPanVertically;                                  // 0x0120(0x0010)
...
{
public:
	ECameraAutoRotateDirection                    Direction;                                         // 0x0038(0x0004)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
	struct FFloatCameraParameter                  WaitTime;                                          // 0x0040(0x0010)
	struct FFloatCameraParameter                  DeactivationThreshold;                             // 0x0050(0x0010)
	class UCameraValueInterpolator*               Interpolator;                                      // 0x0060(0x0008)
	struct FBooleanCameraParameter                FreezeControlRotation;                             // 0x0068(0x0010)
	struct FBooleanCameraParameter                EnableAutoRotate;                                  // 0x0078(0x0010)
	struct FBooleanCameraParameter                AutoRotateYaw;                                     // 0x0088(0x0010)
	struct FBooleanCameraParameter                AutoRotatePitch;                                   // 0x0098(0x0010)
	class UInput2DCameraNode*                     InputNode;                                         // 0x00A8(0x0008)
...
{
public:
	bool                                          bIsFirstFrame;                                     // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	class UObject*                                EvaluationContextOwner;                            // 0x0030(0x0008)
	struct FBlueprintCameraPose                   CameraPose;                                        // 0x0038(0x0070)
	struct FBlueprintCameraVariableTable          VariableTable;                                     // 0x00A8(0x0018)
...
{
public:
	TSubclassOf<class UBlueprintCameraNodeEvaluator> CameraNodeEvaluatorClass;                       // 0x0038(0x0008)
...
{
public:
	class UCameraRigAsset*                        PreviousCameraRig;                                 // 0x0030(0x0008)
	class UCameraRigAsset*                        NextCameraRig;                                     // 0x0038(0x0008)
...
{
public:
	struct FGameplayTagQuery                      PreviousGameplayTagQuery;                          // 0x0030(0x0048)
	struct FGameplayTagQuery                      NextGameplayTagQuery;                              // 0x0078(0x0048)
...
{
public:
	float                                         Acceleration;                                      // 0x0028(0x0004)
	float                                         MaxSpeed;                                          // 0x002C(0x0004)
	float                                         Deceleration;                                      // 0x0030(0x0004)
...
{
public:
	float                                         DampingFactor;                                     // 0x0028(0x0004)
...
{
public:
	float                                         PrimarySpeed;                                      // 0x0028(0x0004)
	float                                         IntermediateSpeed;                                 // 0x002C(0x0004)
	bool                                          bUseFixedStep;                                     // 0x0030(0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
...
public:
	...
	bool                                          bUseFixedStep;                                     // 0x002C(0x0001)
