...
{
public:
	int32                                         PlayerIndex;                                       // 0x0620(0x0004)
	class FName                                   MotionSource;                                      // 0x0624(0x0008)
	uint8                                         bDisableLowLatencyUpdate : 1;                      // 0x062C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_62D[0x3];                                      // 0x062D(0x0003)
	ETrackingStatus                               CurrentTrackingStatus;                             // 0x0630(0x0001)
	uint8                                         Pad_631[0x12F];                                    // 0x0631(0x012F)
