...
{
public:
	class UMediaSource*                           MediaSource;                                       // 0x0000(0x0008)
...
{
public:
	EMediaTimeRangeBPType                         InRangeToGet;                                      // 0x0000(0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	struct FFloatInterval                         ReturnValue;                                       // 0x0004(0x0008)
};
...
{
public:
	class UMediaPlaylist*                         InPlaylist;                                        // 0x0000(0x0008)
	bool                                          ReturnValue;                                       // 0x0008(0x0001)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
};
...
public:
	...
	class UMediaSource*                           MediaSource;                                       // 0x0020(0x0008)
	struct FMediaPlayerOptions                    Options;                                           // 0x0028(0x0080)
	bool                                          bSuccess;                                          // 0x00A8(0x0001)
...
public:
	class UMediaSource*                           MediaSource;                                       // 0x0000(0x0008)
	struct FMediaPlayerOptions                    Options;                                           // 0x0008(0x0080)
...
{
public:
	EMediaPlayerTrack                             TrackType;                                         // 0x0000(0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	int32                                         TrackIndex;                                        // 0x0004(0x0004)
	bool                                          ReturnValue;                                       // 0x0008(0x0001)
...
{
public:
	class FName                                   PlayerName;                                        // 0x0000(0x0008)
};
...
{
public:
	const class UMediaSource*                     Options;                                           // 0x0000(0x0008)
};
...
{
public:
	struct FFloatInterval                         InTimeRange;                                       // 0x0000(0x0008)
	bool                                          ReturnValue;                                       // 0x0008(0x0001)
	uint8                                         Pad_9[0x3];                                        // 0x0009(0x0003)
};
...
{
public:
	struct FTimespan                              TimeDelay_0;                                       // 0x0000(0x0008)
};
...
public:
	...
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	int32                                         TrackIndex;                                        // 0x0004(0x0004)
	int32                                         FormatIndex;                                       // 0x0008(0x0004)
	bool                                          ReturnValue;                                       // 0x000C(0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
};
...
{
public:
	int32                                         TrackIndex;                                        // 0x0000(0x0004)
	int32                                         FormatIndex;                                       // 0x0004(0x0004)
	float                                         FrameRate;                                         // 0x0008(0x0004)
	bool                                          ReturnValue;                                       // 0x000C(0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
};
...
{
public:
	float                                         Horizontal;                                        // 0x0000(0x0004)
	float                                         Vertical;                                          // 0x0004(0x0004)
	bool                                          Absolute;                                          // 0x0008(0x0001)
...
{
public:
	class UMediaTimeStampInfo*                    ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	TMap<class FString, struct FMediaMetadataItemsBPT> ReturnValue;                                  // 0x0000(0x0050)
};
...
{
public:
	class UMediaPlaylist*                         ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	TArray<struct FFloatRange>                    OutRates;                                          // 0x0000(0x0010)
	bool                                          Unthinned;                                         // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
};
...
public:
	int32                                         TrackIndex;                                        // 0x0000(0x0004)
	int32                                         FormatIndex;                                       // 0x0004(0x0004)
	struct FIntPoint                              ReturnValue;                                       // 0x0008(0x0008)
};
...
public:
	int32                                         TrackIndex;                                        // 0x0000(0x0004)
	int32                                         FormatIndex;                                       // 0x0004(0x0004)
	struct FFloatRange                            ReturnValue;                                       // 0x0008(0x0010)
};
...
{
public:
	class UMediaPlayer*                           NewMediaPlayer;                                    // 0x0000(0x0008)
};
...
{
public:
	class UMediaTexture*                          ReturnValue;                                       // 0x0000(0x0008)
};
...
public:
	...
	class UMediaSource*                           ReturnValue;                                       // 0x0008(0x0008)
};
...
{
public:
	int32                                         InOutIndex;                                        // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	class UMediaSource*                           ReturnValue;                                       // 0x0008(0x0008)
};
...
public:
	int32                                         Index_0;                                           // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	class UMediaSource*                           replacement;                                       // 0x0008(0x0008)
	bool                                          ReturnValue;                                       // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
};
...
{
public:
	struct FSoundAttenuationSettings              OutAttenuationSettings;                            // 0x0000(0x03D0)
	bool                                          ReturnValue;                                       // 0x03D0(0x0001)
...
{
public:
	TArray<struct FMediaSoundComponentSpectralData> ReturnValue;                                     // 0x0000(0x0010)
};
...
{
public:
	bool                                          bInEnvelopeFollowing;                              // 0x0000(0x0001)
};
...
{
public:
	bool                                          bInSpectralAnalysisEnabled;                        // 0x0000(0x0001)
};
...
{
public:
	int32                                         AttackTimeMsec;                                    // 0x0000(0x0004)
	int32                                         ReleaseTimeMsec;                                   // 0x0004(0x0004)
};
...
{
public:
	TArray<float>                                 InFrequenciesToAnalyze;                            // 0x0000(0x0010)
	EMediaSoundComponentFFTSize                   InFFTSize;                                         // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
};
...
{
public:
	TArray<struct FMediaCaptureDevice>            OutDevices;                                        // 0x0000(0x0010)
	int32                                         Filter;                                            // 0x0010(0x0004)
