...
#include "Buff_GasBursts_classes.hpp"
#include "Buff_GasBursts_parameters.hpp"
...
void ABuff_GasBursts_C::BPDeactivated(class AActor* ForInstigator)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Buff_GasBursts_C", "BPDeactivated");

	Params::Buff_GasBursts_C_BPDeactivated Parms{};
...
float ABuff_GasBursts_C::BPAdjustStatusValueModification(class UPrimalCharacterStatusComponent* ForComponent, EPrimalCharacterStatusValue ValueType, float InAmount, TSubclassOf<class UDamageType> DamageTypeClass, bool bManualModification)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Buff_GasBursts_C", "BPAdjustStatusValueModification");

	Params::Buff_GasBursts_C_BPAdjustStatusValueModification Parms{};
