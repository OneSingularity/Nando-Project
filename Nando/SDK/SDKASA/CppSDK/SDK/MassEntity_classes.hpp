...
{
public:
	int32                                         ChunkMemorySize;                                   // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	class FString                                 DumpDependencyGraphFileName;                       // 0x0030(0x0010)
	struct FMassProcessingPhaseConfig             ProcessingPhasesConfig[0x6];                       // 0x0040(0x0020)
...
{
public:
	struct FMassProcessorExecutionOrder           ExecutionOrder;                                    // 0x0028(0x0028)
	EMassProcessingPhase                          ProcessingPhase;                                   // 0x0050(0x0001)
	uint8                                         ExecutionFlags;                                    // 0x0051(0x0001)
	uint8                                         bAutoRegisterWithProcessingPhases : 1;             // 0x0052(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         BitPad_52_1 : 3;                                   // 0x0052(0x0001)
	uint8                                         bRequiresGameThreadExecution : 1;                  // 0x0052(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         Pad_53[0x5D];                                      // 0x0053(0x005D)
...
{
public:
	bool                                          bAutoRegisterWithObserverRegistry;                 // 0x00B0(0x0001)
	uint8                                         Pad_B1[0x7];                                       // 0x00B1(0x0007)
	class UScriptStruct*                          ObservedType;                                      // 0x00B8(0x0008)
...
{
public:
	struct FMassEntityObserverClassesMap          FragmentObservers[0x2];                            // 0x0028(0x0050)
	struct FMassEntityObserverClassesMap          TagObservers[0x2];                                 // 0x00C8(0x0050)
...
{
public:
	struct FMassRuntimePipeline                   ChildPipeline;                                     // 0x00B0(0x0018)
	class FName                                   GroupName;                                         // 0x00C8(0x0008)
...
{
public:
	TMap<class FName, class UMassModuleSettings*> ModuleSettings;                                    // 0x0038(0x0050)
