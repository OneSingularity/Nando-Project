...
public:
	...
	TMulticastInlineDelegate<void()>              OnEndReached;                                      // 0x0030(0x0010)
	TMulticastInlineDelegate<void()>              OnMediaClosed;                                     // 0x0040(0x0010)
	TMulticastInlineDelegate<void(const class FString& OpenedUrl)> OnMediaOpened;                    // 0x0050(0x0010)
	TMulticastInlineDelegate<void(const class FString& FailedUrl)> OnMediaOpenFailed;                // 0x0060(0x0010)
	TMulticastInlineDelegate<void()>              OnPlaybackResumed;                                 // 0x0070(0x0010)
	TMulticastInlineDelegate<void()>              OnPlaybackSuspended;                               // 0x0080(0x0010)
	TMulticastInlineDelegate<void()>              OnSeekCompleted;                                   // 0x0090(0x0010)
	TMulticastInlineDelegate<void()>              OnTracksChanged;                                   // 0x00A0(0x0010)
	TMulticastInlineDelegate<void()>              OnMetadataChanged;                                 // 0x00B0(0x0010)
	struct FTimespan                              CacheAhead;                                        // 0x00C0(0x0008)
	struct FTimespan                              CacheBehind;                                       // 0x00C8(0x0008)
	struct FTimespan                              CacheBehindGame;                                   // 0x00D0(0x0008)
	bool                                          NativeAudioOut;                                    // 0x00D8(0x0001)
	bool                                          PlayOnOpen;                                        // 0x00D9(0x0001)
	uint8                                         Pad_DA[0x2];                                       // 0x00DA(0x0002)
	uint8                                         Shuffle : 1;                                       // 0x00DC(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Loop : 1;                                          // 0x00DC(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_DD[0x3];                                       // 0x00DD(0x0003)
	class UMediaPlaylist*                         Playlist;                                          // 0x00E0(0x0008)
	int32                                         PlaylistIndex;                                     // 0x00E8(0x0004)
	uint8                                         Pad_EC[0x4];                                       // 0x00EC(0x0004)
	struct FTimespan                              TimeDelay;                                         // 0x00F0(0x0008)
	float                                         HorizontalFieldOfView;                             // 0x00F8(0x0004)
	float                                         VerticalFieldOfView;                               // 0x00FC(0x0004)
	struct FRotator                               ViewRotation;                                      // 0x0100(0x0018)
	uint8                                         Pad_118[0x28];                                     // 0x0118(0x0028)
	struct FGuid                                  PlayerGuid;                                        // 0x0140(0x0010)
	uint8                                         Pad_150[0x18];                                     // 0x0150(0x0018)
...
{
public:
	ETextureAddress                               AddressX;                                          // 0x0138(0x0001)
	ETextureAddress                               AddressY;                                          // 0x0139(0x0001)
	bool                                          AutoClear;                                         // 0x013A(0x0001)
	uint8                                         Pad_13B[0x1];                                      // 0x013B(0x0001)
	struct FLinearColor                           ClearColor;                                        // 0x013C(0x0010)
	bool                                          EnableGenMips;                                     // 0x014C(0x0001)
	uint8                                         NumMips;                                           // 0x014D(0x0001)
	bool                                          NewStyleOutput;                                    // 0x014E(0x0001)
	uint8                                         Pad_14F[0x1];                                      // 0x014F(0x0001)
	float                                         CurrentAspectRatio;                                // 0x0150(0x0004)
	EMediaTextureOrientation                      CurrentOrientation;                                // 0x0154(0x0001)
	uint8                                         Pad_155[0x3];                                      // 0x0155(0x0003)
	class UMediaPlayer*                           MediaPlayer;                                       // 0x0158(0x0008)
	uint8                                         Pad_160[0xC0];                                     // 0x0160(0x00C0)
...
{
public:
	class FName                                   PlayerName;                                        // 0x0080(0x0008)
...
{
public:
	class FString                                 FilePath;                                          // 0x0088(0x0010)
	bool                                          PrecacheFile;                                      // 0x0098(0x0001)
	uint8                                         Pad_99[0x17];                                      // 0x0099(0x0017)
...
{
public:
	class UMediaTexture*                          MediaTexture;                                      // 0x00D0(0x0008)
	class UMediaPlayer*                           MediaPlayer;                                       // 0x00D8(0x0008)
...
{
public:
	struct FTimespan                              Time;                                              // 0x0028(0x0008)
	int64                                         SequenceIndex;                                     // 0x0030(0x0008)
...
{
public:
	EMediaSoundChannels                           Channels;                                          // 0x08E0(0x0004)
	bool                                          DynamicRateAdjustment;                             // 0x08E4(0x0001)
	uint8                                         Pad_8E5[0x3];                                      // 0x08E5(0x0003)
	float                                         RateAdjustmentFactor;                              // 0x08E8(0x0004)
	struct FFloatRange                            RateAdjustmentRange;                               // 0x08EC(0x0010)
	uint8                                         Pad_8FC[0x4];                                      // 0x08FC(0x0004)
	class UMediaPlayer*                           MediaPlayer;                                       // 0x0900(0x0008)
	uint8                                         Pad_908[0xB8];                                     // 0x0908(0x00B8)
...
{
public:
	class FString                                 StreamUrl;                                         // 0x0088(0x0010)
...
public:
	...
	int32                                         FrameDelay;                                        // 0x008C(0x0004)
