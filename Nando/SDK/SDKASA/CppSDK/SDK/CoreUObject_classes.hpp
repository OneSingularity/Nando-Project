...
{
public:
	static inline class TUObjectArrayWrapper      GObjects;                                          // 0x0000(0x0008)

	void*                                         VTable;                                            // 0x0000(0x0008)
	EObjectFlags                                  Flags;                                             // 0x0008(0x0004)
...
{
public:
	TOptional<class FString, true>                OptionalString;                                    // 0x0028(0x0010)
	TOptional<class FText, true>                  OptionalText;                                      // 0x0038(0x0010)
	TOptional<class FName, true>                  OptionalName;                                      // 0x0048(0x0008)
	TOptional<int32>                              OptionalInt;                                       // 0x0050(0x0008)
...
{
public:
	int32                                         int32_0;                                           // 0x0028(0x0004)
	struct FTestInstanceDataObjectStruct          Struct;                                            // 0x002C(0x0030)
...
{
public:
	struct FStructBaseChain                       BaseChain;                                         // 0x0030(0x0010)
	class UStruct*                                SuperStruct;                                       // 0x0040(0x0008)
	class UField*                                 Children;                                          // 0x0048(0x0008)
	class FField*                                 ChildProperties;                                   // 0x0050(0x0008)
	int32                                         Size;                                              // 0x0058(0x0004)
	int16                                         MinAlignment;                                      // 0x005C(0x0002)
	uint8                                         Pad_5E[0x52];                                      // 0x005E(0x0052)
...
{
public:
	EUserDefinedStructureStatus                   Status;                                            // 0x00C0(0x0001)
	uint8                                         Pad_C1[0x3];                                       // 0x00C1(0x0003)
	struct FGuid                                  Guid;                                              // 0x00C4(0x0010)
	uint8                                         Pad_D4[0x34];                                      // 0x00D4(0x0034)
...
public:
	...
	class TArray<class TPair<class FName, int64>> Names;                                             // 0x0040(0x0010)
...
{
public:
	TArray<struct FPropertyBagPropertyDesc>       PropertyDescs;                                     // 0x00C0(0x0010)
...
{
public:
	uint8                                         Pad_B0[0x30];                                      // 0x00B0(0x0030)
	enum class EClassCastFlags                    CastFlags;                                         // 0x00E0(0x0008)
	uint8                                         Pad_E8[0x30];                                      // 0x00E8(0x0030)
	class UObject*                                ClassDefaultObject;                                // 0x0118(0x0008)
	uint8                                         Pad_120[0xF8];                                     // 0x0120(0x00F8)
...
public:
	...
	uint32                                        FunctionFlags;                                     // 0x00B0(0x0004)
	uint8                                         Pad_B4[0x24];                                      // 0x00B4(0x0024)
	FNativeFuncPtr                                ExecFunction;                                      // 0x00D8(0x0008)
...
{
public:
	struct FObjectCookedMetaDataStore             EnumMetaData;                                      // 0x0028(0x0050)
...
{
public:
	struct FStructCookedMetaDataStore             StructMetaData;                                    // 0x0028(0x00A0)
...
{
public:
	struct FStructCookedMetaDataStore             ClassMetaData;                                     // 0x0028(0x00A0)
	TMap<class FName, struct FStructCookedMetaDataStore> FunctionsMetaData;                          // 0x00C8(0x0050)
...
{
public:
	uint8                                         Pad_28[0xB8];                                      // 0x0028(0x00B8)
...
{
public:
	uint8                                         Pad_218[0x1C0];                                    // 0x0218(0x01C0)
...
{
public:
	uint8                                         Pad_28[0xD0];                                      // 0x0028(0x00D0)
...
{
public:
	uint8                                         Pad_E0[0x1C0];                                     // 0x00E0(0x01C0)
...
{
public:
	uint8                                         Pad_28[0xA0];                                      // 0x0028(0x00A0)
...
{
public:
	uint8                                         Pad_70[0x28];                                      // 0x0070(0x0028)
...
{
public:
	uint8                                         Pad_70[0x20];                                      // 0x0070(0x0020)
...
{
public:
	uint32                                        SolClassFlags;                                     // 0x0218(0x0004)
	uint8                                         Pad_21C[0x4];                                      // 0x021C(0x0004)
	TArray<TSubclassOf<class UObject>>            TaskClasses;                                       // 0x0220(0x0010)
	class UFunction*                              InitInstanceFunction;                              // 0x0230(0x0008)
	TArray<struct FVersePersistentVar>            PersistentVars;                                    // 0x0238(0x0010)
	TArray<struct FVerseSessionVar>               SessionVars;                                       // 0x0248(0x0010)
	TMap<class FName, struct FVerseClassVarAccessors> VarAccessors;                                  // 0x0258(0x0050)
	EVerseEffectSet                               ConstructorEffects;                                // 0x02A8(0x0001)
	uint8                                         Pad_2A9[0x3];                                      // 0x02A9(0x0003)
	class FName                                   MangledPackageVersePath;                           // 0x02AC(0x0008)
	uint8                                         Pad_2B4[0x4];                                      // 0x02B4(0x0004)
	class FString                                 PackageRelativeVersePath;                          // 0x02B8(0x0010)
	TMap<class FName, class FName>                DisplayNameToUENameFunctionMap;                    // 0x02C8(0x0050)
