...
{
public:
	class FName                                   InMappingName;                                     // 0x0000(0x0008)
};
...
{
public:
	class FText                                   NewDisplayName;                                    // 0x0000(0x0010)
};
...
{
public:
	struct FPlayerKeyMapping                      PlayerMapping;                                     // 0x0000(0x0080)
	struct FPlayerMappableKeyQueryOptions         Options;                                           // 0x0080(0x0028)
	bool                                          ReturnValue;                                       // 0x00A8(0x0001)
...
public:
	...
	TArray<struct FKey>                           OutKeys;                                           // 0x0008(0x0010)
...
{
public:
	struct FKey                                   InKey;                                             // 0x0000(0x0018)
	TArray<class FName>                           OutMappingNames;                                   // 0x0018(0x0010)
...
{
public:
	TMap<class FName, struct FKeyMappingRow>      ReturnValue;                                       // 0x0000(0x0050)
};
...
{
public:
	struct FGameplayTag                           ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	struct FPlayerKeyMapping                      OutKeyMapping;                                     // 0x0000(0x0080)
	struct FMapPlayerKeyArgs                      InArgs;                                            // 0x0080(0x0040)
};
...
{
public:
	struct FPlayerMappableKeyQueryOptions         Options;                                           // 0x0000(0x0028)
	TArray<struct FKey>                           OutKeys;                                           // 0x0028(0x0010)
	int32                                         ReturnValue;                                       // 0x0038(0x0004)
...
{
public:
	struct FPlayerMappableKeyProfileCreationArgs  InArgs;                                            // 0x0000(0x0030)
	class UEnhancedPlayerMappableKeyProfile*      ReturnValue;                                       // 0x0030(0x0008)
};
...
{
public:
	struct FMapPlayerKeyArgs                      InArgs;                                            // 0x0000(0x0040)
	struct FGameplayTagContainer                  FailureReason;                                     // 0x0040(0x0020)
};
...
{
public:
	const class UInputMappingContext*             IMC;                                               // 0x0000(0x0008)
...
{
public:
	TSet<class UInputMappingContext*>             MappingContexts;                                   // 0x0000(0x0050)
...
{
public:
	struct FGameplayTag                           ProfileId;                                         // 0x0000(0x0008)
	struct FGameplayTagContainer                  FailureReason;                                     // 0x0008(0x0020)
};
...
{
public:
	struct FGameplayTag                           InProfileId;                                       // 0x0000(0x0008)
	bool                                          ReturnValue;                                       // 0x0008(0x0001)
...
public:
	class FName                                   MappingName;                                       // 0x0000(0x0008)
	TSet<struct FPlayerKeyMapping>                ReturnValue;                                       // 0x0008(0x0050)
};
...
{
public:
	class UEnhancedPlayerMappableKeyProfile*      ReturnValue;                                       // 0x0000(0x0008)
};
...
public:
	struct FGameplayTag                           ProfileId;                                         // 0x0000(0x0008)
	class UEnhancedPlayerMappableKeyProfile*      ReturnValue;                                       // 0x0008(0x0008)
};
...
{
public:
	const class UInputAction*                     action;                                            // 0x0000(0x0008)
	struct FInputActionValue                      ReturnValue;                                       // 0x0008(0x0020)
};
...
{
public:
	struct FInputActionValue                      InActionValue;                                     // 0x0000(0x0020)
	double                                        X;                                                 // 0x0020(0x0008)
	double                                        Y;                                                 // 0x0028(0x0008)
	double                                        Z;                                                 // 0x0030(0x0008)
	EInputActionValueType                         Type;                                              // 0x0038(0x0001)
...
{
public:
	struct FInputActionValue                      InValue;                                           // 0x0000(0x0020)
...
{
public:
	struct FInputActionValue                      ActionValue;                                       // 0x0000(0x0020)
...
{
public:
	ETriggerEvent                                 TriggerEvent;                                      // 0x0000(0x0001)
...
public:
	...
	const class UInputAction*                     action;                                            // 0x0008(0x0008)
	struct FInputActionValue                      ReturnValue;                                       // 0x0010(0x0020)
};
...
{
public:
	struct FPlayerMappableKeySlot                 ReturnValue;                                       // 0x0000(0x0004)
};
...
{
public:
	struct FEnhancedActionKeyMapping              ActionKeyMapping;                                  // 0x0000(0x0050)
	class FName                                   ReturnValue;                                       // 0x0050(0x0008)
};
...
public:
	struct FEnhancedActionKeyMapping              ActionKeyMapping;                                  // 0x0000(0x0050)
	class UPlayerMappableKeySettings*             ReturnValue;                                       // 0x0050(0x0008)
};
...
public:
	...
	struct FInputActionValue                      MatchValueType;                                    // 0x0018(0x0020)
	struct FInputActionValue                      ReturnValue;                                       // 0x0038(0x0020)
};
...
public:
	...
	double                                        Y;                                                 // 0x0008(0x0008)
	double                                        Z;                                                 // 0x0010(0x0008)
	EInputActionValueType                         ValueType;                                         // 0x0018(0x0001)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)
	struct FInputActionValue                      ReturnValue;                                       // 0x0020(0x0020)
};
...
{
public:
	const class UInputMappingContext*             Context;                                           // 0x0000(0x0008)
	bool                                          bForceImmediately;                                 // 0x0008(0x0001)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
};
...
{
public:
	class UInputMappingContext*                   InContext;                                         // 0x0000(0x0008)
	const class UInputMappingContext*             ReturnValue;                                       // 0x0008(0x0008)
};
...
{
public:
	const class UInputMappingContext*             MappingContext;                                    // 0x0000(0x0008)
	int32                                         Priority;                                          // 0x0008(0x0004)
	struct FModifyContextOptions                  Options;                                           // 0x000C(0x0001)
...
public:
	const class UInputAction*                     action;                                            // 0x0000(0x0008)
	struct FInputActionValue                      RawValue;                                          // 0x0008(0x0020)
...
public:
	...
	TArray<class UInputTrigger*>                  Triggers;                                          // 0x0030(0x0010)
};
...
{
public:
	const class UEnhancedPlayerMappableKeyProfile* InNewProfile;                                     // 0x0000(0x0008)
};
...
{
public:
	class UEnhancedInputUserSettings*             Settings;                                          // 0x0000(0x0008)
};
...
{
public:
	const class UInputMappingContext*             InputContext;                                      // 0x0000(0x0008)
	const class UInputAction*                     action;                                            // 0x0008(0x0008)
	struct FKey                                   Key;                                               // 0x0010(0x0018)
	TArray<struct FMappingQueryIssue>             OutIssues;                                         // 0x0028(0x0010)
	EMappingQueryIssue                            BlockingIssues;                                    // 0x0038(0x0001)
	EMappingQueryResult                           ReturnValue;                                       // 0x0039(0x0001)
...
{
public:
	TArray<class UInputMappingContext*>           PrioritizedActiveContexts;                         // 0x0000(0x0010)
	const class UInputMappingContext*             InputContext;                                      // 0x0010(0x0008)
	const class UInputAction*                     action;                                            // 0x0018(0x0008)
	struct FKey                                   Key;                                               // 0x0020(0x0018)
	TArray<struct FMappingQueryIssue>             OutIssues;                                         // 0x0038(0x0010)
	EMappingQueryIssue                            BlockingIssues;                                    // 0x0048(0x0001)
	EMappingQueryResult                           ReturnValue;                                       // 0x0049(0x0001)
...
public:
	const class UInputMappingContext*             MappingContext;                                    // 0x0000(0x0008)
	struct FModifyContextOptions                  Options;                                           // 0x0008(0x0001)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
};
...
{
public:
	struct FModifyContextOptions                  Options;                                           // 0x0000(0x0001)
	EInputMappingRebuildType                      RebuildType;                                       // 0x0001(0x0001)
};
...
{
public:
	TArray<struct FEnhancedActionKeyMapping>      ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	class UEnhancedInputUserSettings*             ReturnValue;                                       // 0x0000(0x0008)
};
...
public:
	const class UInputMappingContext*             MappingContext;                                    // 0x0000(0x0008)
	int32                                         OutFoundPriority;                                  // 0x0008(0x0004)
...
public:
	const class UInputAction*                     action;                                            // 0x0000(0x0008)
	TArray<struct FKey>                           ReturnValue;                                       // 0x0008(0x0010)
};
...
public:
	const class UInputAction*                     action;                                            // 0x0000(0x0008)
	struct FKey                                   ToKey;                                             // 0x0008(0x0018)
	struct FEnhancedActionKeyMapping              ReturnValue;                                       // 0x0020(0x0050)
};
...
{
public:
	struct FInputActionValue                      SampleValue;                                       // 0x0000(0x0020)
	struct FInputActionValue                      FinalValue;                                        // 0x0020(0x0020)
	struct FLinearColor                           ReturnValue;                                       // 0x0040(0x0010)
};
...
{
public:
	const class UEnhancedPlayerInput*             PlayerInput;                                       // 0x0000(0x0008)
	struct FInputActionValue                      CurrentValue;                                      // 0x0008(0x0020)
	float                                         DeltaTime;                                         // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	struct FInputActionValue                      ReturnValue;                                       // 0x0030(0x0020)
};
...
public:
	const class UEnhancedPlayerInput*             PlayerInput;                                       // 0x0000(0x0008)
	struct FInputActionValue                      ModifiedValue;                                     // 0x0008(0x0020)
	float                                         DeltaTime;                                         // 0x0028(0x0004)
	ETriggerState                                 ReturnValue;                                       // 0x002C(0x0001)
...
{
public:
	ETriggerType                                  ReturnValue;                                       // 0x0000(0x0001)
};
...
{
public:
	struct FInputActionValue                      ForValue;                                          // 0x0000(0x0020)
	bool                                          ReturnValue;                                       // 0x0020(0x0001)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)
};
...
{
public:
	const class UInputAction*                     InAction;                                          // 0x0000(0x0008)
	TArray<struct FEnhancedActionKeyMapping>      ReturnValue;                                       // 0x0008(0x0010)
};
...
public:
	class FName                                   MappingName;                                       // 0x0000(0x0008)
	struct FEnhancedActionKeyMapping              ReturnValue;                                       // 0x0008(0x0050)
};
...
{
public:
	TMap<class UInputMappingContext*, int32>      ReturnValue;                                       // 0x0000(0x0050)
};
