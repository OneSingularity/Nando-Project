...
{
public:
	class UMediaSource*                           MediaSource;                                       // 0x00F8(0x0008)
	bool                                          bLoop;                                             // 0x0100(0x0001)
...
public:
	class UMediaSource*                           MediaSource;                                       // 0x00F8(0x0008)
	int32                                         MediaSourceProxyIndex;                             // 0x0100(0x0004)
	bool                                          bLooping;                                          // 0x0104(0x0001)
	...
	class UMediaSoundComponent*                   MediaSoundComponent;                               // 0x0118(0x0008)
	bool                                          bUseExternalMediaPlayer;                           // 0x0120(0x0001)
	uint8                                         Pad_121[0x7];                                      // 0x0121(0x0007)
	class UMediaPlayer*                           ExternalMediaPlayer;                               // 0x0128(0x0008)
	struct FMediaSourceCacheSettings              CacheSettings;                                     // 0x0130(0x0008)
	int32                                         TextureIndex;                                      // 0x0138(0x0004)
	bool                                          bHasMediaPlayerProxy;                              // 0x013C(0x0001)
	uint8                                         Pad_13D[0x3];                                      // 0x013D(0x0003)
	struct FMovieSceneBoolChannel                 ChannelCanPlayerBeOpen;                            // 0x0140(0x0108)
	struct FMovieSceneObjectBindingID             MediaSourceProxyBindingID;                         // 0x0248(0x0018)
...
public:
	...
	TArray<class UMovieSceneSection*>             MediaSections;                                     // 0x0100(0x0010)
