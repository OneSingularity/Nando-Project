...
{
public:
	class FString                                 Filename;                                          // 0x0058(0x0010)
...
{
public:
	struct FCompositionGraphCapturePasses         IncludeRenderPasses;                               // 0x0058(0x0010)
	bool                                          bCaptureFramesInHDR;                               // 0x0068(0x0001)
	uint8                                         Pad_69[0x3];                                       // 0x0069(0x0003)
	int32                                         HDRCompressionQuality;                             // 0x006C(0x0004)
	EHDRCaptureGamut                              CaptureGamut;                                      // 0x0070(0x0001)
	uint8                                         Pad_71[0x7];                                       // 0x0071(0x0007)
	struct FSoftObjectPath                        PostProcessingMaterial;                            // 0x0078(0x0020)
	...
	uint8                                         Pad_A8[0x20];                                      // 0x00A8(0x0020)
...
{
public:
	uint8                                         Pad_68[0x70];                                      // 0x0068(0x0070)
...
{
public:
	int32                                         CompressionQuality;                                // 0x00D8(0x0004)
...
public:
	...
	struct FSoftClassPath                         ImageCaptureProtocolType;                          // 0x0038(0x0020)
	struct FSoftClassPath                         AudioCaptureProtocolType;                          // 0x0058(0x0020)
	...
	struct FMovieSceneCaptureSettings             Settings;                                          // 0x0088(0x0070)
	bool                                          bUseSeparateProcess;                               // 0x00F8(0x0001)
	bool                                          bCloseEditorWhenCaptureStarts;                     // 0x00F9(0x0001)
	uint8                                         Pad_FA[0x6];                                       // 0x00FA(0x0006)
	class FString                                 AdditionalCommandLineArguments;                    // 0x0100(0x0010)
	class FString                                 InheritedCommandLineArguments;                     // 0x0110(0x0010)
	uint8                                         Pad_120[0x118];                                    // 0x0120(0x0118)
...
public:
	...
	uint8                                         Pad_239[0xB];                                      // 0x0239(0x000B)
	struct FGuid                                  PrerequisiteActorId;                               // 0x0244(0x0010)
...
public:
	...
	uint8                                         Pad_60[0x78];                                      // 0x0060(0x0078)
...
public:
	...
	int32                                         CompressionQuality;                                // 0x00DC(0x0004)
