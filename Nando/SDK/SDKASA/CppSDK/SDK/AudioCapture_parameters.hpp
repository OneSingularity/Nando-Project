...
{
public:
	struct FAudioCaptureDeviceInfo                OutInfo;                                           // 0x0000(0x0010)
...
{
public:
	class UAudioCapture*                          ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	struct FAudioInputDeviceInfo                  Info;                                              // 0x0000(0x0030)
...
public:
	...
	TDelegate<void(const TArray<struct FAudioInputDeviceInfo>& AvailableDevices)> OnObtainDevicesEvent; // 0x0008(0x0010)
};
