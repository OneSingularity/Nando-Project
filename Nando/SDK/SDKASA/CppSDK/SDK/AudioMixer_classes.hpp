...
{
public:
	uint8                                         Pad_30[0xD8];                                      // 0x0030(0x00D8)
...
public:
	...
	TMulticastInlineDelegate<void(EAudioDeviceChangedRole AudioDeviceRole, const class FString& DeviceID)> DefaultCaptureDeviceChanged; // 0x0038(0x0010)
	uint8                                         Pad_48[0x18];                                      // 0x0048(0x0018)
	TMulticastInlineDelegate<void(EAudioDeviceChangedRole AudioDeviceRole, const class FString& DeviceID)> DefaultRenderDeviceChanged; // 0x0060(0x0010)
	uint8                                         Pad_70[0x18];                                      // 0x0070(0x0018)
	TMulticastInlineDelegate<void(const class FString& DeviceID)> DeviceAdded;                       // 0x0088(0x0010)
	uint8                                         Pad_98[0x18];                                      // 0x0098(0x0018)
	TMulticastInlineDelegate<void(const class FString& DeviceID)> DeviceRemoved;                     // 0x00B0(0x0010)
	uint8                                         Pad_C0[0x18];                                      // 0x00C0(0x0018)
	TMulticastInlineDelegate<void(const class FString& DeviceID, EAudioDeviceChangedState NewState)> DeviceStateChanged; // 0x00D8(0x0010)
	uint8                                         Pad_E8[0x18];                                      // 0x00E8(0x0018)
	TMulticastInlineDelegate<void(const class FString& DeviceID)> DeviceSwitched;                    // 0x0100(0x0010)
...
public:
	...
	struct FSubmixEffectDynamicsProcessorSettings Settings;                                          // 0x00F0(0x0060)
...
{
public:
	TWeakObjectPtr<class USynthComponent>         OwningSynthComponent;                              // 0x0450(0x0008)
	uint8                                         Pad_458[0x18];                                     // 0x0458(0x0018)
...
{
public:
	uint8                                         bAutoDestroy : 1;                                  // 0x0278(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bStopWhenOwnerDestroyed : 1;                       // 0x0278(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bAllowSpatialization : 1;                          // 0x0278(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverrideAttenuation : 1;                          // 0x0278(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         BitPad_278_4 : 4;                                  // 0x0278(0x0001)
	uint8                                         Pad_279[0x3];                                      // 0x0279(0x0003)
	uint8                                         bEnableBusSends : 1;                               // 0x027C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bEnableBaseSubmix : 1;                             // 0x027C(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bEnableSubmixSends : 1;                            // 0x027C(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         Pad_27D[0x3];                                      // 0x027D(0x0003)
	class USoundAttenuation*                      AttenuationSettings;                               // 0x0280(0x0008)
	struct FSoundAttenuationSettings              AttenuationOverrides;                              // 0x0288(0x03D0)
	class USoundConcurrency*                      ConcurrencySettings;                               // 0x0658(0x0008)
	TSet<class USoundConcurrency*>                ConcurrencySet;                                    // 0x0660(0x0050)
	struct FSoundModulationDefaultRoutingSettings ModulationRouting;                                 // 0x06B0(0x0168)
	class USoundClass*                            SoundClass;                                        // 0x0818(0x0008)
	class USoundEffectSourcePresetChain*          SourceEffectChain;                                 // 0x0820(0x0008)
	class USoundSubmixBase*                       SoundSubmix;                                       // 0x0828(0x0008)
	TArray<struct FSoundSubmixSendInfo>           SoundSubmixSends;                                  // 0x0830(0x0010)
	TArray<struct FSoundSourceBusSendInfo>        BusSends;                                          // 0x0840(0x0010)
	TArray<struct FSoundSourceBusSendInfo>        PreEffectBusSends;                                 // 0x0850(0x0010)
	uint8                                         bIsUISound : 1;                                    // 0x0860(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bIsPreviewSound : 1;                               // 0x0860(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_861[0x3];                                      // 0x0861(0x0003)
	int32                                         EnvelopeFollowerAttackTime;                        // 0x0864(0x0004)
	int32                                         EnvelopeFollowerReleaseTime;                       // 0x0868(0x0004)
	uint8                                         Pad_86C[0x4];                                      // 0x086C(0x0004)
	TMulticastInlineDelegate<void(const float EnvelopeValue)> OnAudioEnvelopeValue;                  // 0x0870(0x0010)
	uint8                                         Pad_880[0x20];                                     // 0x0880(0x0020)
	class USynthSound*                            Synth;                                             // 0x08A0(0x0008)
	class UAudioComponent*                        AudioComponent;                                    // 0x08A8(0x0008)
	uint8                                         Pad_8B0[0x30];                                     // 0x08B0(0x0030)
...
public:
	...
	struct FSubmixEffectSubmixEQSettings          Settings;                                          // 0x00A0(0x0010)
...
{
public:
	uint8                                         Pad_68[0x68];                                      // 0x0068(0x0068)
	struct FSubmixEffectReverbSettings            Settings;                                          // 0x00D0(0x0040)
...
{
public:
	uint8                                         Pad_28[0x1E0];                                     // 0x0028(0x01E0)
