...
public:
	...
	TSubclassOf<class UFoliageType_InstancedStaticMesh> Type;                                        // 0x0018(0x0008)
};
...
{
public:
	uint8                                         UseMask : 1;                                       // 0x0000(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	float                                         MaskThreshold;                                     // 0x0004(0x0004)
	uint8                                         InvertMask : 1;                                    // 0x0008(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
public:
	...
	struct FRuntimeFloatCurve                     FalloffCurve;                                      // 0x0008(0x0088)
};
