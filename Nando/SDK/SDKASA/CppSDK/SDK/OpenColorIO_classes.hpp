...
{
public:
	uint8                                         bUseLegacyProcessor : 1;                           // 0x0038(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bUse32fLUT : 1;                                    // 0x0038(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bSupportInverseViewTransforms : 1;                 // 0x0038(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
...
public:
	...
	class FString                                 SourceColorSpace;                                  // 0x0030(0x0010)
	class FString                                 DestinationColorSpace;                             // 0x0040(0x0010)
	class FString                                 Display;                                           // 0x0050(0x0010)
	class FString                                 View;                                              // 0x0060(0x0010)
	EOpenColorIOViewTransformDirection            DisplayViewDirection;                              // 0x0070(0x0001)
	uint8                                         Pad_71[0x7];                                       // 0x0071(0x0007)
	TMap<int32, class UTexture*>                  Textures;                                          // 0x0078(0x0050)
	uint8                                         Pad_C8[0x40];                                      // 0x00C8(0x0040)
...
{
public:
	struct FFilePath                              ConfigurationFile;                                 // 0x0028(0x0010)
	TArray<struct FOpenColorIOColorSpace>         DesiredColorSpaces;                                // 0x0038(0x0010)
	TArray<struct FOpenColorIODisplayView>        DesiredDisplayViews;                               // 0x0048(0x0010)
	TMap<class FString, class FString>            Context;                                           // 0x0058(0x0050)
	TArray<class UOpenColorIOColorTransform*>     ColorTransforms;                                   // 0x00A8(0x0010)
	uint8                                         Pad_B8[0x30];                                      // 0x00B8(0x0030)
	class FString                                 ConfigHash;                                        // 0x00E8(0x0010)
