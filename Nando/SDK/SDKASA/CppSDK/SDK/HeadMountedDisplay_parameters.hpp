...
{
public:
	EHandKeypoint                                 Input;                                             // 0x0000(0x0001)
...
{
public:
	int32                                         jointIndex;                                        // 0x0000(0x0004)
	bool                                          bValueFound;                                       // 0x0004(0x0001)
...
public:
	...
	bool                                          bValueFound;                                       // 0x0008(0x0001)
...
{
public:
	class FName                                   NewSource;                                         // 0x0000(0x0008)
};
...
{
public:
	EControllerHand                               NewSource;                                         // 0x0000(0x0001)
};
...
{
public:
	struct FRotator                               OutAngularVelocity;                                // 0x0000(0x0018)
...
{
public:
	struct FVector                                OutLinearAcceleration;                             // 0x0000(0x0018)
	bool                                          ReturnValue;                                       // 0x0018(0x0001)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)
};
...
{
public:
	struct FVector                                OutLinearVelocity;                                 // 0x0000(0x0018)
	bool                                          ReturnValue;                                       // 0x0018(0x0001)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)
};
...
{
public:
	EControllerHand                               ReturnValue;                                       // 0x0000(0x0001)
};
