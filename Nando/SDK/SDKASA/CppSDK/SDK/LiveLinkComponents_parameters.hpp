...
{
public:
	TSubclassOf<class ULiveLinkRole>              InRoleClass;                                       // 0x0000(0x0008)
	class UActorComponent*                        InComponent;                                       // 0x0008(0x0008)
};
...
{
public:
	struct FLiveLinkSubjectRepresentation         InSubjectRepresentation;                           // 0x0000(0x0010)
};
...
{
public:
	struct FLiveLinkSubjectRepresentation         ReturnValue;                                       // 0x0000(0x0010)
};
