...
public:
	...
	uint8                                         Pad_50[0x5];                                       // 0x0050(0x0005)
	uint8                                         BitPad_55_0 : 2;                                   // 0x0055(0x0001)
	uint8                                         bCreateNodeInstance : 1;                           // 0x0055(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
...
public:
	...
	uint8                                         bCallTickOnSearchStart : 1;                        // 0x0068(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bRestartTimerOnEachActivation : 1;                 // 0x0068(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
{
public:
	class FString                                 OptionName;                                        // 0x0030(0x0010)
	TSubclassOf<class UEnvQueryItemType>          ItemType;                                          // 0x0040(0x0008)
	uint8                                         bAutoSortTests : 1;                                // 0x0048(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bCanRunAsync : 1;                                  // 0x0048(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
{
public:
	TSubclassOf<class AActor>                     SearchedActorClass;                                // 0x0050(0x0008)
	struct FAIDataProviderBoolValue               GenerateOnlyActorsInRadius;                        // 0x0058(0x0038)
	struct FAIDataProviderFloatValue              SearchRadius;                                      // 0x0090(0x0038)
	TSubclassOf<class UEnvQueryContext>           SearchCenter;                                      // 0x00C8(0x0008)
...
{
public:
	TMulticastInlineDelegate<void(EPathFollowingResult MovementResult)> OnSuccess;                   // 0x0028(0x0010)
	TMulticastInlineDelegate<void(EPathFollowingResult MovementResult)> OnFail;                      // 0x0038(0x0010)
	uint8                                         Pad_48[0x20];                                      // 0x0048(0x0020)
...
{
public:
	struct FColor                                 DebugColor;                                        // 0x0028(0x0004)
	float                                         MaxAge;                                            // 0x002C(0x0004)
	uint8                                         bStartsEnabled : 1;                                // 0x0030(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_31[0x17];                                      // 0x0031(0x0017)
...
{
public:
	struct FVector                                DefaultValue;                                      // 0x0030(0x0018)
...
public:
	...
	uint8                                         Pad_34[0x24];                                      // 0x0034(0x0024)
	TSubclassOf<class UEnvQueryItemType>          ItemType;                                          // 0x0058(0x0008)
	int32                                         OptionIndex;                                       // 0x0060(0x0004)
	uint8                                         Pad_64[0x4];                                       // 0x0064(0x0004)
	TMulticastInlineDelegate<void(class UEnvQueryInstanceBlueprintWrapper* QueryInstance, EEnvQueryStatus QueryStatus)> OnQueryFinishedEvent; // 0x0068(0x0010)
...
{
public:
	TSubclassOf<class UAISense_Blueprint>         Implementation;                                    // 0x0048(0x0008)
...
{
public:
	TSubclassOf<class UAISense_Hearing>           Implementation;                                    // 0x0048(0x0008)
	float                                         HearingRange;                                      // 0x0050(0x0004)
	float                                         LoSHearingRange;                                   // 0x0054(0x0004)
	uint8                                         bUseLoSHearing : 1;                                // 0x0058(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_59[0x3];                                       // 0x0059(0x0003)
	struct FAISenseAffiliationFilter              DetectionByAffiliation;                            // 0x005C(0x0004)
...
{
public:
	TSubclassOf<class UAISense_Sight>             Implementation;                                    // 0x0048(0x0008)
...
{
public:
	struct FAISenseAffiliationFilter              DetectionByAffiliation;                            // 0x0048(0x0004)
...
{
public:
	struct FAIDamageEvent                         Event;                                             // 0x0028(0x0050)
...
{
public:
	struct FAINoiseEvent                          Event;                                             // 0x0028(0x0040)
...
{
public:
	struct FInstancedStruct                       DefaultValue;                                      // 0x0030(0x0010)
	struct FInstancedStruct                       Value;                                             // 0x0040(0x0010)
...
{
public:
	TMulticastInlineDelegate<void(class AActor* MovingActor, const struct FVector& DestinationPoint)> OnSmartLinkReached; // 0x0040(0x0010)
...
public:
	...
	uint8                                         Pad_50[0x30];                                      // 0x0050(0x0030)
	uint8                                         bAllowNewSameClassInstance : 1;                    // 0x0080(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bReplaceActiveSameClassInstance : 1;               // 0x0080(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bShouldPauseMovement : 1;                          // 0x0080(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bAlwaysNotifyOnFinished : 1;                       // 0x0080(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
...
{
public:
	class APawn*                                  ControlledPawn;                                    // 0x00D0(0x0008)
	TArray<struct FPawnActionStack>               ActionStacks;                                      // 0x00D8(0x0010)
	TArray<struct FPawnActionEvent>               ActionEvents;                                      // 0x00E8(0x0010)
	class UPawnAction*                            CurrentAction;                                     // 0x00F8(0x0008)
...
public:
	...
	struct FVector                                GoalLocation;                                      // 0x0098(0x0018)
	float                                         AcceptableRadius;                                  // 0x00B0(0x0004)
	uint8                                         Pad_B4[0x4];                                       // 0x00B4(0x0004)
	TSubclassOf<class UNavigationQueryFilter>     FilterClass;                                       // 0x00B8(0x0008)
	uint8                                         bAllowStrafe : 1;                                  // 0x00C0(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bFinishOnOverlap : 1;                              // 0x00C0(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bUsePathfinding : 1;                               // 0x00C0(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bAllowPartialPath : 1;                             // 0x00C0(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bProjectGoalToNavigation : 1;                      // 0x00C0(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bUpdatePathToGoal : 1;                             // 0x00C0(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bAbortSubActionOnPathChange : 1;                   // 0x00C0(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         Pad_C1[0x2F];                                      // 0x00C1(0x002F)
...
public:
	...
	EPawnActionFailHandling                       ChildFailureHandlingMode;                          // 0x00A0(0x0001)
...
{
public:
	uint8                                         Pad_538[0x38];                                     // 0x0538(0x0038)
	uint8                                         bStartAILogicOnPossess : 1;                        // 0x0570(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bStopAILogicOnUnposses : 1;                        // 0x0570(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bLOSflag : 1;                                      // 0x0570(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bSkipExtraLOSChecks : 1;                           // 0x0570(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bAllowStrafe : 1;                                  // 0x0570(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bWantsPlayerState : 1;                             // 0x0570(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bLastRequestedMoveToLocationWasPlayerCommand : 1;  // 0x0570(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bSetControlRotationFromPawnOrientation : 1;        // 0x0570(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
	uint8                                         bExecutingRotateToFace : 1;                        // 0x0571(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_572[0x6];                                      // 0x0572(0x0006)
	class UPathFollowingComponent*                PathFollowingComponent;                            // 0x0578(0x0008)
	class UBrainComponent*                        BrainComponent;                                    // 0x0580(0x0008)
	class UAIPerceptionComponent*                 PerceptionComponent;                               // 0x0588(0x0008)
	class UPawnActionsComponent*                  ActionsComp;                                       // 0x0590(0x0008)
	class UBlackboardComponent*                   Blackboard;                                        // 0x0598(0x0008)
	class UGameplayTasksComponent*                CachedGameplayTasksComponent;                      // 0x05A0(0x0008)
	TSubclassOf<class UNavigationQueryFilter>     DefaultNavigationFilterClass;                      // 0x05A8(0x0008)
	TMulticastInlineDelegate<void(const struct FAIRequestID& RequestID, EPathFollowingResult Result)> ReceiveMoveCompleted; // 0x05B0(0x0010)
	uint8                                         Pad_5C0[0x8];                                      // 0x05C0(0x0008)
...
{
public:
	struct FSoftClassPath                         PerceptionSystemClassName;                         // 0x0060(0x0020)
	struct FSoftClassPath                         HotSpotManagerClassName;                           // 0x0080(0x0020)
	struct FSoftClassPath                         EnvQueryManagerClassName;                          // 0x00A0(0x0020)
	...
	TSoftObjectPtr<class UBlackboardData>         DefaultBlackboard;                                 // 0x00D8(0x0028)
	ECollisionChannel                             DefaultSightCollisionChannel;                      // 0x0100(0x0001)
...
public:
	...
	TArray<struct FBTDecoratorLogic>              RootDecoratorOps;                                  // 0x0050(0x0010)
...
public:
	...
	class UBlackboardComponent*                   BlackboardComp;                                    // 0x00D8(0x0008)
	class AAIController*                          AIOwner;                                           // 0x00E0(0x0008)
	uint8                                         Pad_E8[0x40];                                      // 0x00E8(0x0040)
...
{
public:
	uint8                                         Pad_128[0x20];                                     // 0x0128(0x0020)
	TArray<class UBTNode*>                        NodeInstances;                                     // 0x0148(0x0010)
	uint8                                         Pad_158[0x148];                                    // 0x0158(0x0148)
	class UBehaviorTree*                          DefaultBehaviorTreeAsset;                          // 0x02A0(0x0008)
	uint8                                         Pad_2A8[0x28];                                     // 0x02A8(0x0028)
...
{
public:
	int32                                         MaxDebuggerSteps;                                  // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	TArray<struct FBehaviorTreeTemplateInfo>      LoadedTemplates;                                   // 0x0030(0x0010)
...
{
public:
	class UBrainComponent*                        BrainComp;                                         // 0x00D0(0x0008)
	class UBlackboardData*                        DefaultBlackboardAsset;                            // 0x00D8(0x0008)
	class UBlackboardData*                        BlackboardAsset;                                   // 0x00E0(0x0008)
	uint8                                         Pad_E8[0x20];                                      // 0x00E8(0x0020)
	TArray<class UBlackboardKeyType*>             KeyInstances;                                      // 0x0108(0x0010)
...
public:
	...
	TArray<struct FBlackboardEntry>               Keys;                                              // 0x0038(0x0010)
	uint8                                         bHasSynchronizedKeys : 1;                          // 0x0048(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)
...
{
public:
	TSubclassOf<class UObject>                    BaseClass;                                         // 0x0030(0x0008)
	TSubclassOf<class UObject>                    DefaultValue;                                      // 0x0038(0x0008)
...
public:
	...
	class FString                                 EnumName;                                          // 0x0038(0x0010)
	uint8                                         DefaultValue;                                      // 0x0048(0x0001)
	uint8                                         Pad_49[0x3];                                       // 0x0049(0x0003)
	uint8                                         bIsEnumNameValid : 1;                              // 0x004C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
{
public:
	class FName                                   DefaultValue;                                      // 0x0030(0x0008)
...
{
public:
	class FString                                 EnumName;                                          // 0x0030(0x0010)
...
public:
	TSubclassOf<class UObject>                    BaseClass;                                         // 0x0030(0x0008)
	class UObject*                                DefaultValue;                                      // 0x0038(0x0008)
...
{
public:
	struct FRotator                               DefaultValue;                                      // 0x0030(0x0018)
	bool                                          bUseDefaultValue;                                  // 0x0048(0x0001)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)
...
{
public:
	class FString                                 StringValue;                                       // 0x0030(0x0010)
...
{
public:
	TArray<struct FBTCompositeChild>              Children;                                          // 0x0058(0x0010)
	TArray<class UBTService*>                     Services;                                          // 0x0068(0x0010)
	uint8                                         bApplyDecoratorScope : 1;                          // 0x0078(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
{
public:
	uint8                                         BitPad_60_0 : 7;                                   // 0x0060(0x0001)
	uint8                                         bInverseCondition : 1;                             // 0x0060(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
...
public:
	...
	uint8                                         bIgnoreRestartSelf : 1;                            // 0x0068(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_69[0x7];                                       // 0x0069(0x0007)
...
{
public:
	EBTParallelMode                               FinishMode;                                        // 0x0080(0x0001)
...
{
public:
	struct FBlackboardKeySelector                 BlackboardKey;                                     // 0x0068(0x0028)
...
{
public:
	int32                                         IntValue;                                          // 0x0090(0x0004)
	float                                         FloatValue;                                        // 0x0094(0x0004)
	class FString                                 StringValue;                                       // 0x0098(0x0010)
	class FString                                 CachedDescription;                                 // 0x00A8(0x0010)
	uint8                                         OperationType;                                     // 0x00B8(0x0001)
...
public:
	...
	TArray<class FName>                           ObservedKeyNames;                                  // 0x0078(0x0010)
	uint8                                         Pad_88[0x10];                                      // 0x0088(0x0010)
	uint8                                         bShowPropertyDetails : 1;                          // 0x0098(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bCheckConditionOnlyBlackBoardChanges : 1;          // 0x0098(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
{
public:
	struct FBlackboardKeySelector                 ActorToCheck;                                      // 0x0068(0x0028)
	EGameplayContainerMatchType                   TagsToMatch;                                       // 0x0090(0x0001)
	uint8                                         Pad_91[0x7];                                       // 0x0091(0x0007)
	struct FGameplayTagContainer                  GameplayTags;                                      // 0x0098(0x0020)
	class FString                                 CachedDescription;                                 // 0x00B8(0x0010)
...
public:
	...
	uint8                                         Pad_69[0x7];                                       // 0x0069(0x0007)
	struct FBlackboardKeySelector                 BlackboardKeyA;                                    // 0x0070(0x0028)
	struct FBlackboardKeySelector                 BlackboardKeyB;                                    // 0x0098(0x0028)
...
{
public:
	struct FValueOrBBKey_Float                    ConeHalfAngle;                                     // 0x0068(0x0010)
	struct FBlackboardKeySelector                 ConeOrigin;                                        // 0x0078(0x0028)
	struct FBlackboardKeySelector                 ConeDirection;                                     // 0x00A0(0x0028)
	struct FBlackboardKeySelector                 Observed;                                          // 0x00C8(0x0028)
...
{
public:
	struct FValueOrBBKey_Float                    CoolDownTime;                                      // 0x0068(0x0010)
	struct FBlackboardKeySelector                 CoolDownTimeKey;                                   // 0x0078(0x0028)
...
{
public:
	struct FBlackboardKeySelector                 BlackboardKeyA;                                    // 0x0068(0x0028)
	struct FBlackboardKeySelector                 BlackboardKeyB;                                    // 0x0090(0x0028)
	uint8                                         bUseSelf : 1;                                      // 0x00B8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_B9[0x7];                                       // 0x00B9(0x0007)
	struct FValueOrBBKey_Enum                     PathQueryType;                                     // 0x00C0(0x0028)
	struct FValueOrBBKey_Class                    FilterClass;                                       // 0x00E8(0x0020)
...
public:
	...
	struct FAIDataProviderFloatValue              ParametrizedAcceptableRadius;                      // 0x0098(0x0038)
	EFAIDistanceType                              GeometricDistanceType;                             // 0x00D0(0x0001)
	uint8                                         Pad_D1[0x3];                                       // 0x00D1(0x0003)
	uint8                                         bUseParametrizedRadius : 1;                        // 0x00D4(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_D5[0x3];                                       // 0x00D5(0x0003)
	struct FValueOrBBKey_Bool                     bUseNavAgentGoalLocation;                          // 0x00D8(0x0010)
	struct FValueOrBBKey_Bool                     bPathFindingBasedTest;                             // 0x00E8(0x0010)
...
{
public:
	struct FValueOrBBKey_Class                    TestClass;                                         // 0x0090(0x0020)
...
public:
	struct FValueOrBBKey_Float                    ConeHalfAngle;                                     // 0x0068(0x0010)
	struct FBlackboardKeySelector                 ConeOrigin;                                        // 0x0078(0x0028)
	struct FBlackboardKeySelector                 Observed;                                          // 0x00A0(0x0028)
	uint8                                         bUseSelfAsOrigin : 1;                              // 0x00C8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bUseSelfAsObserved : 1;                            // 0x00C8(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
{
public:
	struct FValueOrBBKey_Int32                    NumLoops;                                          // 0x0068(0x0010)
	bool                                          bInfiniteLoop;                                     // 0x0078(0x0001)
	uint8                                         Pad_79[0x3];                                       // 0x0079(0x0003)
	struct FValueOrBBKey_Float                    InfiniteLoopTimeoutTime;                           // 0x007C(0x0010)
...
{
public:
	struct FGameplayTag                           CooldownTag;                                       // 0x0068(0x0008)
	struct FValueOrBBKey_Float                    CooldownDuration;                                  // 0x0070(0x0010)
	struct FValueOrBBKey_Bool                     bAddToExistingDuration;                            // 0x0080(0x0010)
...
public:
	...
	struct FValueOrBBKey_Float                    CooldownDuration;                                  // 0x0070(0x0010)
	struct FValueOrBBKey_Bool                     bAddToExistingDuration;                            // 0x0080(0x0010)
	struct FValueOrBBKey_Bool                     bActivatesCooldown;                                // 0x0090(0x0010)
...
{
public:
	struct FValueOrBBKey_Float                    TimeLimit;                                         // 0x0068(0x0010)
	struct FBlackboardKeySelector                 TimeLimitKey;                                      // 0x0078(0x0028)
...
{
public:
	struct FBlackboardKeySelector                 BlackboardKey;                                     // 0x0070(0x0028)
...
public:
	...
	uint8                                         bShowPropertyDetails : 1;                          // 0x0090(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bShowEventDetails : 1;                             // 0x0090(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_91[0x7];                                       // 0x0091(0x0007)
...
{
public:
	uint8                                         FocusPriority;                                     // 0x0098(0x0001)
	uint8                                         Pad_99[0x7];                                       // 0x0099(0x0007)
...
{
public:
	struct FEQSParametrizedQueryExecutionRequest  EQSRequest;                                        // 0x0098(0x0048)
	bool                                          bUpdateBBOnFail;                                   // 0x00E0(0x0001)
	uint8                                         Pad_E1[0x17];                                      // 0x00E1(0x0017)
...
public:
	class AAIController*                          AIOwner;                                           // 0x0070(0x0008)
	class AActor*                                 ActorOwner;                                        // 0x0078(0x0008)
	struct FIntervalCountdown                     TickInterval;                                      // 0x0080(0x0008)
	uint8                                         Pad_88[0x18];                                      // 0x0088(0x0018)
	uint8                                         bShowPropertyDetails : 1;                          // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_A1[0x7];                                       // 0x00A1(0x0007)
...
{
public:
	struct FValueOrBBKey_Enum                     Result;                                            // 0x0070(0x0028)
...
{
public:
	struct FValueOrBBKey_Bool                     bWaitForGameplayTask;                              // 0x0070(0x0010)
...
{
public:
	struct FValueOrBBKey_Float                    Loudnes;                                           // 0x0070(0x0010)
...
{
public:
	struct FValueOrBBKey_Float                    AcceptableRadius;                                  // 0x0098(0x0010)
	struct FValueOrBBKey_Class                    FilterClass;                                       // 0x00A8(0x0020)
	struct FValueOrBBKey_Float                    ObservedBlackboardValueTolerance;                  // 0x00C8(0x0010)
	struct FValueOrBBKey_Bool                     bAllowStrafe;                                      // 0x00D8(0x0010)
	struct FValueOrBBKey_Bool                     bAllowPartialPath;                                 // 0x00E8(0x0010)
	struct FValueOrBBKey_Bool                     bTrackMovingGoal;                                  // 0x00F8(0x0010)
	struct FValueOrBBKey_Bool                     bRequireNavigableEndLocation;                      // 0x0108(0x0010)
	struct FValueOrBBKey_Bool                     bProjectGoalLocation;                              // 0x0118(0x0010)
	struct FValueOrBBKey_Bool                     bReachTestIncludesAgentRadius;                     // 0x0128(0x0010)
	struct FValueOrBBKey_Bool                     bReachTestIncludesGoalRadius;                      // 0x0138(0x0010)
	struct FValueOrBBKey_Bool                     bStartFromPreviousPath;                            // 0x0148(0x0010)
	uint8                                         BitPad_158_0 : 1;                                  // 0x0158(0x0001)
	uint8                                         bObserveBlackboardValue : 1;                       // 0x0158(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bAutoStopOnAbort : 1;                              // 0x0158(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         Pad_159[0x7];                                      // 0x0159(0x0007)
	struct FBlackboardKeySelector                 AcceptableRadiusKey;                               // 0x0160(0x0028)
...
{
public:
	uint8                                         bDisablePathUpdateOnGoalLocationChange : 1;        // 0x0188(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bProjectVectorGoalToNavigation : 1;                // 0x0188(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bUpdatedDeprecatedProperties : 1;                  // 0x0188(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
...
{
public:
	struct FValueOrBBKey_Object                   AnimationToPlay;                                   // 0x0070(0x0020)
	struct FValueOrBBKey_Bool                     bLooping;                                          // 0x0090(0x0010)
	struct FValueOrBBKey_Bool                     bNonBlocking;                                      // 0x00A0(0x0010)
	class UBehaviorTreeComponent*                 MyOwnerComp;                                       // 0x00B0(0x0008)
	class USkeletalMeshComponent*                 CachedSkelMesh;                                    // 0x00B8(0x0008)
...
{
public:
	struct FValueOrBBKey_Object                   SoundToPlay;                                       // 0x0070(0x0020)
...
{
public:
	struct FValueOrBBKey_Float                    Precision;                                         // 0x0098(0x0010)
	struct FBlackboardKeySelector                 PrecisionKey;                                      // 0x00A8(0x0028)
	uint8                                         bForceUpdatePrecision : 1;                         // 0x00D0(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bZeroPrecisionSucceedsInstantly : 1;               // 0x00D0(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bIgnorePitch : 1;                                  // 0x00D0(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
...
public:
	...
	class FString                                 ControllerProperty;                                // 0x0078(0x0010)
	TSubclassOf<class UObject>                    CurrentControllerClass;                            // 0x0088(0x0008)
...
{
public:
	struct FGameplayTag                           InjectionTag;                                      // 0x0070(0x0008)
...
public:
	...
	TArray<struct FEnvNamedValue>                 QueryParams;                                       // 0x00A0(0x0010)
	TArray<struct FAIDynamicParam>                QueryConfig;                                       // 0x00B0(0x0010)
	...
	struct FEQSParametrizedQueryExecutionRequest  EQSRequest;                                        // 0x00F8(0x0048)
	bool                                          bUpdateBBOnFail;                                   // 0x0140(0x0001)
	uint8                                         Pad_141[0x17];                                     // 0x0141(0x0017)
...
{
public:
	struct FGameplayTag                           CooldownTag;                                       // 0x0070(0x0008)
	struct FValueOrBBKey_Bool                     bAddToExistingDuration;                            // 0x0078(0x0010)
...
{
public:
	struct FValueOrBBKey_Float                    WaitTime;                                          // 0x0070(0x0010)
	struct FValueOrBBKey_Float                    RandomDeviation;                                   // 0x0080(0x0010)
...
{
public:
	struct FBlackboardKeySelector                 BlackboardKey;                                     // 0x0090(0x0028)
...
{
public:
	class FName                                   ParamName;                                         // 0x0028(0x0008)
	float                                         FloatValue;                                        // 0x0030(0x0004)
	int32                                         IntValue;                                          // 0x0034(0x0004)
...
{
public:
	float                                         min_0;                                             // 0x0040(0x0004)
	float                                         max_0;                                             // 0x0044(0x0004)
	uint8                                         bInteger : 1;                                      // 0x0048(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)
...
{
public:
	class FName                                   QueryName;                                         // 0x0030(0x0008)
...
{
public:
	uint8                                         Pad_38[0x70];                                      // 0x0038(0x0070)
	TArray<struct FEnvQueryInstanceCache>         InstanceCache;                                     // 0x00A8(0x0010)
...
public:
	...
	struct FAIDataProviderBoolValue               BoolValue;                                         // 0x0050(0x0038)
	struct FAIDataProviderFloatValue              FloatValueMin;                                     // 0x0088(0x0038)
	struct FAIDataProviderFloatValue              FloatValueMax;                                     // 0x00C0(0x0038)
	uint8                                         Pad_F8[0x1];                                       // 0x00F8(0x0001)
	EEnvTestScoreEquation                         ScoringEquation;                                   // 0x00F9(0x0001)
	EEnvQueryTestClamping                         ClampMinType;                                      // 0x00FA(0x0001)
	EEnvQueryTestClamping                         ClampMaxType;                                      // 0x00FB(0x0001)
	EEQSNormalizationType                         NormalizationType;                                 // 0x00FC(0x0001)
	uint8                                         Pad_FD[0x3];                                       // 0x00FD(0x0003)
	struct FAIDataProviderFloatValue              ScoreClampMin;                                     // 0x0100(0x0038)
	struct FAIDataProviderFloatValue              ScoreClampMax;                                     // 0x0138(0x0038)
	struct FAIDataProviderFloatValue              ScoringFactor;                                     // 0x0170(0x0038)
	struct FAIDataProviderFloatValue              ReferenceValue;                                    // 0x01A8(0x0038)
	bool                                          bDefineReferenceValue;                             // 0x01E0(0x0001)
	uint8                                         Pad_1E1[0xF];                                      // 0x01E1(0x000F)
	uint8                                         bWorkOnFloatValues : 1;                            // 0x01F0(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
{
public:
	uint8                                         Pad_670[0x40];                                     // 0x0670(0x0040)
...
{
public:
	class UEnvQuery*                              QueryTemplate;                                     // 0x08A0(0x0008)
	TArray<struct FEnvNamedValue>                 QueryParams;                                       // 0x08A8(0x0010)
	TArray<struct FAIDynamicParam>                QueryConfig;                                       // 0x08B8(0x0010)
	float                                         TimeLimitPerStep;                                  // 0x08C8(0x0004)
	int32                                         StepToDebugDraw;                                   // 0x08CC(0x0004)
	EEnvQueryHightlightMode                       HighlightMode;                                     // 0x08D0(0x0001)
	uint8                                         Pad_8D1[0x3];                                      // 0x08D1(0x0003)
	uint8                                         bDrawLabels : 1;                                   // 0x08D4(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bDrawFailedItems : 1;                              // 0x08D4(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bReRunQueryOnlyOnFinishedMove : 1;                 // 0x08D4(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bShouldBeVisibleInGame : 1;                        // 0x08D4(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bTickDuringGame : 1;                               // 0x08D4(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         Pad_8D5[0x3];                                      // 0x08D5(0x0003)
	EEnvQueryRunMode                              QueryingMode;                                      // 0x08D8(0x0001)
	uint8                                         Pad_8D9[0x7];                                      // 0x08D9(0x0007)
	struct FNavAgentProperties                    NavAgentProperties;                                // 0x08E0(0x0038)
	uint8                                         Pad_918[0x28];                                     // 0x0918(0x0028)
...
{
public:
	class FText                                   GeneratorsActionDescription;                       // 0x0050(0x0010)
	TSubclassOf<class UEnvQueryContext>           Context;                                           // 0x0060(0x0008)
	TSubclassOf<class UEnvQueryItemType>          GeneratedItemType;                                 // 0x0068(0x0008)
...
public:
	...
	uint8                                         bAllowDifferentItemTypes : 1;                      // 0x0060(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bHasMatchingItemType : 1;                          // 0x0060(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)
	TSubclassOf<class UEnvQueryItemType>          ForcedItemType;                                    // 0x0068(0x0008)
...
{
public:
	struct FEnvTraceData                          ProjectionData;                                    // 0x0050(0x0040)
...
{
public:
	struct FAIDataProviderFloatValue              AlignedPointsDistance;                             // 0x0090(0x0038)
	struct FAIDataProviderFloatValue              ConeDegrees;                                       // 0x00C8(0x0038)
	struct FAIDataProviderFloatValue              AngleStep;                                         // 0x0100(0x0038)
	struct FAIDataProviderFloatValue              Range;                                             // 0x0138(0x0038)
	TSubclassOf<class UEnvQueryContext>           CenterActor;                                       // 0x0170(0x0008)
	uint8                                         bIncludeContextLocation : 1;                       // 0x0178(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
{
public:
	TSubclassOf<class UEnvQueryContext>           QueryContext;                                      // 0x0050(0x0008)
...
{
public:
	struct FAIDataProviderFloatValue              InnerRadius;                                       // 0x0090(0x0038)
	struct FAIDataProviderFloatValue              OuterRadius;                                       // 0x00C8(0x0038)
	struct FAIDataProviderIntValue                NumberOfRings;                                     // 0x0100(0x0038)
	struct FAIDataProviderIntValue                PointsPerRing;                                     // 0x0138(0x0038)
	struct FEnvDirection                          ArcDirection;                                      // 0x0170(0x0020)
	struct FAIDataProviderFloatValue              ArcAngle;                                          // 0x0190(0x0038)
	bool                                          bUseSpiralPattern;                                 // 0x01C8(0x0001)
	uint8                                         Pad_1C9[0x7];                                      // 0x01C9(0x0007)
	TSubclassOf<class UEnvQueryContext>           Center;                                            // 0x01D0(0x0008)
	uint8                                         bDefineArc : 1;                                    // 0x01D8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
{
public:
	struct FAIDataProviderFloatValue              CircleRadius;                                      // 0x0090(0x0038)
	EPointOnCircleSpacingMethod                   PointOnCircleSpacingMethod;                        // 0x00C8(0x0001)
	uint8                                         Pad_C9[0x7];                                       // 0x00C9(0x0007)
	struct FAIDataProviderFloatValue              SpaceBetween;                                      // 0x00D0(0x0038)
	struct FAIDataProviderIntValue                NumberOfPoints;                                    // 0x0108(0x0038)
	struct FEnvDirection                          ArcDirection;                                      // 0x0140(0x0020)
	struct FAIDataProviderFloatValue              ArcAngle;                                          // 0x0160(0x0038)
	float                                         AngleRadians;                                      // 0x0198(0x0004)
	uint8                                         Pad_19C[0x4];                                      // 0x019C(0x0004)
	TSubclassOf<class UEnvQueryContext>           CircleCenter;                                      // 0x01A0(0x0008)
	bool                                          bIgnoreAnyContextActorsWhenGeneratingCircle;       // 0x01A8(0x0001)
	uint8                                         Pad_1A9[0x7];                                      // 0x01A9(0x0007)
	struct FAIDataProviderFloatValue              CircleCenterZOffset;                               // 0x01B0(0x0038)
	struct FEnvTraceData                          TraceData;                                         // 0x01E8(0x0040)
	uint8                                         bDefineArc : 1;                                    // 0x0228(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
{
public:
	struct FAIDataProviderFloatValue              GridSize;                                          // 0x0090(0x0038)
	struct FAIDataProviderFloatValue              SpaceBetween;                                      // 0x00C8(0x0038)
	TSubclassOf<class UEnvQueryContext>           GenerateAround;                                    // 0x0100(0x0008)
...
{
public:
	struct FAIDataProviderBoolValue               PathToItem;                                        // 0x0108(0x0038)
	TSubclassOf<class UNavigationQueryFilter>     NavigationFilter;                                  // 0x0140(0x0008)
	struct FAIDataProviderFloatValue              ScanRangeMultiplier;                               // 0x0148(0x0038)
...
{
public:
	TSubclassOf<class AActor>                     AllowedActorClass;                                 // 0x0050(0x0008)
	struct FAIDataProviderFloatValue              SearchRadius;                                      // 0x0058(0x0038)
	TSubclassOf<class UEnvQueryContext>           ListenerContext;                                   // 0x0090(0x0008)
	TSubclassOf<class UAISense>                   SenseToUse;                                        // 0x0098(0x0008)
...
{
public:
	EEnvTestDistance                              TestMode;                                          // 0x01F8(0x0001)
	uint8                                         Pad_1F9[0x7];                                      // 0x01F9(0x0007)
	TSubclassOf<class UEnvQueryContext>           DistanceTo;                                        // 0x0200(0x0008)
...
{
public:
	struct FEnvDirection                          LineA;                                             // 0x01F8(0x0020)
	struct FEnvDirection                          LineB;                                             // 0x0218(0x0020)
...
{
public:
	struct FGameplayTagQuery                      TagQueryToMatch;                                   // 0x01F8(0x0048)
...
{
public:
	struct FEnvOverlapData                        OverlapData;                                       // 0x01F8(0x0030)
...
{
public:
	EEnvTestPathfinding                           TestMode;                                          // 0x01F8(0x0001)
	uint8                                         Pad_1F9[0x7];                                      // 0x01F9(0x0007)
	TSubclassOf<class UEnvQueryContext>           Context;                                           // 0x0200(0x0008)
	struct FAIDataProviderBoolValue               PathFromContext;                                   // 0x0208(0x0038)
	struct FAIDataProviderBoolValue               SkipUnreachable;                                   // 0x0240(0x0038)
	TSubclassOf<class UNavigationQueryFilter>     FilterClass;                                       // 0x0278(0x0008)
...
{
public:
	struct FAIDataProviderFloatValue              ScanRangeMultiplier;                               // 0x0280(0x0038)
...
{
public:
	struct FEnvTraceData                          ProjectionData;                                    // 0x01F8(0x0040)
...
{
public:
	struct FEnvTraceData                          TraceData;                                         // 0x01F8(0x0040)
	struct FAIDataProviderBoolValue               TraceFromContext;                                  // 0x0238(0x0038)
	struct FAIDataProviderFloatValue              ItemHeightOffset;                                  // 0x0270(0x0038)
	struct FAIDataProviderFloatValue              ContextHeightOffset;                               // 0x02A8(0x0038)
	TSubclassOf<class UEnvQueryContext>           Context;                                           // 0x02E0(0x0008)
...
{
public:
	TSubclassOf<class UEnvQueryContext>           VolumeContext;                                     // 0x01F8(0x0008)
	TSubclassOf<class AVolume>                    VolumeClass;                                       // 0x0200(0x0008)
	uint8                                         bDoComplexVolumeTest : 1;                          // 0x0208(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bSkipTestIfNoVolumes : 1;                          // 0x0208(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
public:
	...
	class UNavMovementComponent*                  MovementComp;                                      // 0x0108(0x0008)
	uint8                                         Pad_110[0x20];                                     // 0x0110(0x0020)
	class ANavigationData*                        MyNavData;                                         // 0x0130(0x0008)
	uint8                                         Pad_138[0x1E8];                                    // 0x0138(0x01E8)
...
{
public:
	uint8                                         Pad_320[0x18];                                     // 0x0320(0x0018)
	struct FVector                                CrowdAgentMoveDirection;                           // 0x0338(0x0018)
	uint8                                         Pad_350[0x20];                                     // 0x0350(0x0020)
...
public:
	...
	TArray<struct FCrowdAvoidanceConfig>          AvoidanceConfig;                                   // 0x0030(0x0010)
	TArray<struct FCrowdAvoidanceSamplingPattern> SamplingPatterns;                                  // 0x0040(0x0010)
	int32                                         MaxAgents;                                         // 0x0050(0x0004)
	float                                         MaxAgentRadius;                                    // 0x0054(0x0004)
	int32                                         MaxAvoidedAgents;                                  // 0x0058(0x0004)
	int32                                         MaxAvoidedWalls;                                   // 0x005C(0x0004)
	...
	uint8                                         BitPad_70_0 : 4;                                   // 0x0070(0x0001)
	uint8                                         bResolveCollisions : 1;                            // 0x0070(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         Pad_71[0x7F];                                      // 0x0071(0x007F)
...
{
public:
	class UNavLocalGridManager*                   GridManager;                                       // 0x0320(0x0008)
	uint8                                         Pad_328[0x28];                                     // 0x0328(0x0028)
...
public:
	...
	TArray<struct FNavigationLink>                PointLinks;                                        // 0x04A0(0x0010)
	TArray<struct FNavigationSegmentLink>         SegmentLinks;                                      // 0x04B0(0x0010)
	class UNavLinkCustomComponent*                SmartLinkComp;                                     // 0x04C0(0x0008)
	bool                                          bSmartLinkIsRelevant;                              // 0x04C8(0x0001)
	uint8                                         Pad_4C9[0x7];                                      // 0x04C9(0x0007)
	TMulticastInlineDelegate<void(class AActor* MovingActor, const struct FVector& DestinationPoint)> OnSmartLinkReached; // 0x04D0(0x0010)
...
{
public:
	TArray<class UAISenseConfig*>                 SensesConfig;                                      // 0x00D0(0x0010)
	TSubclassOf<class UAISense>                   DominantSense;                                     // 0x00E0(0x0008)
	uint8                                         Pad_E8[0x10];                                      // 0x00E8(0x0010)
	class AAIController*                          AIOwner;                                           // 0x00F8(0x0008)
	uint8                                         Pad_100[0x80];                                     // 0x0100(0x0080)
	TMulticastInlineDelegate<void(const TArray<class AActor*>& UpdatedActors)> OnPerceptionUpdated;  // 0x0180(0x0010)
	TMulticastInlineDelegate<void(class AActor* Actor)> OnTargetPerceptionForgotten;                 // 0x0190(0x0010)
	TMulticastInlineDelegate<void(class AActor* Actor, const struct FAIStimulus& Stimulus)> OnTargetPerceptionUpdated; // 0x01A0(0x0010)
	TMulticastInlineDelegate<void(const struct FActorPerceptionUpdateInfo& UpdateInfo)> OnTargetPerceptionInfoUpdated; // 0x01B0(0x0010)
...
{
public:
	uint8                                         bAutoRegisterAsSource : 1;                         // 0x00D0(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_D1[0x7];                                       // 0x00D1(0x0007)
	TArray<TSubclassOf<class UAISense>>           RegisterAsSourceForSenses;                         // 0x00D8(0x0010)
...
public:
	...
	uint8                                         Pad_9C[0x9C];                                      // 0x009C(0x009C)
...
public:
	...
	uint8                                         bWantsNewPawnNotification : 1;                     // 0x002C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bAutoRegisterAllPawnsAsSources : 1;                // 0x002C(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
{
public:
	TSubclassOf<class UAISense_Damage>            Implementation;                                    // 0x0048(0x0008)
...
{
public:
	TSubclassOf<class UUserDefinedStruct>         ListenerDataType;                                  // 0x0078(0x0008)
...
{
public:
	TArray<struct FAIDamageEvent>                 RegisteredEvents;                                  // 0x0078(0x0010)
...
{
public:
	TArray<struct FAINoiseEvent>                  NoiseEvents;                                       // 0x0078(0x0010)
	float                                         SpeedOfSoundSq;                                    // 0x0088(0x0004)
	uint8                                         Pad_8C[0x54];                                      // 0x008C(0x0054)
...
{
public:
	TArray<struct FAIPredictionEvent>             RegisteredEvents;                                  // 0x0078(0x0010)
...
{
public:
	uint8                                         Pad_78[0xD8];                                      // 0x0078(0x00D8)
	int32                                         MaxTracesPerTick;                                  // 0x0150(0x0004)
	int32                                         MaxAsyncTracesPerTick;                             // 0x0154(0x0004)
	int32                                         MinQueriesPerTimeSliceCheck;                       // 0x0158(0x0004)
	...
	uint8                                         Pad_17D[0x2B];                                     // 0x017D(0x002B)
...
{
public:
	TArray<struct FAITeamStimulusEvent>           RegisteredEvents;                                  // 0x0078(0x0010)
...
{
public:
	TArray<struct FAITouchEvent>                  RegisteredEvents;                                  // 0x0078(0x0010)
...
{
public:
	float                                         HearingThreshold;                                  // 0x00D0(0x0004)
	float                                         LOSHearingThreshold;                               // 0x00D4(0x0004)
	float                                         SightRadius;                                       // 0x00D8(0x0004)
	float                                         SensingInterval;                                   // 0x00DC(0x0004)
	float                                         HearingMaxSoundAge;                                // 0x00E0(0x0004)
	uint8                                         bEnableSensingUpdates : 1;                         // 0x00E4(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOnlySensePlayers : 1;                             // 0x00E4(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bSeePawns : 1;                                     // 0x00E4(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bHearNoises : 1;                                   // 0x00E4(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         Pad_E5[0xB];                                       // 0x00E5(0x000B)
	TMulticastInlineDelegate<void(class APawn* Pawn)> OnSeePawn;                                     // 0x00F0(0x0010)
	TMulticastInlineDelegate<void(class APawn* Instigator, const struct FVector& Location, float Volume)> OnHearNoise; // 0x0100(0x0010)
	float                                         PeripheralVisionAngle;                             // 0x0110(0x0004)
	float                                         PeripheralVisionCosine;                            // 0x0114(0x0004)
...
{
public:
	TMulticastInlineDelegate<void()>              OnRequestFailed;                                   // 0x0070(0x0010)
	TMulticastInlineDelegate<void(EPathFollowingResult Result, class AAIController* AIController)> OnMoveFinished; // 0x0080(0x0010)
	struct FAIMoveRequest                         MoveRequest;                                       // 0x0090(0x0050)
	uint8                                         Pad_E0[0x40];                                      // 0x00E0(0x0040)
...
{
public:
	uint8                                         Pad_70[0x78];                                      // 0x0070(0x0078)
