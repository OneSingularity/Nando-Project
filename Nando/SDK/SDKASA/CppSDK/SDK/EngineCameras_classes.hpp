...
{
public:
	float                                         OscillationDuration;                               // 0x00E0(0x0004)
	float                                         OscillationBlendInTime;                            // 0x00E4(0x0004)
	float                                         OscillationBlendOutTime;                           // 0x00E8(0x0004)
	struct FROscillator                           RotOscillation;                                    // 0x00EC(0x0024)
	struct FVOscillator                           LocOscillation;                                    // 0x0110(0x0024)
	struct FFOscillator                           FOVOscillation;                                    // 0x0134(0x000C)
	float                                         AnimPlayRate;                                      // 0x0140(0x0004)
	float                                         AnimScale;                                         // 0x0144(0x0004)
	float                                         AnimBlendInTime;                                   // 0x0148(0x0004)
	float                                         AnimBlendOutTime;                                  // 0x014C(0x0004)
	float                                         RandomAnimSegmentDuration;                         // 0x0150(0x0004)
	uint8                                         Pad_154[0x4];                                      // 0x0154(0x0004)
	class UCameraAnim*                            Anim;                                              // 0x0158(0x0008)
	class UCameraAnimationSequence*               AnimSequence;                                      // 0x0160(0x0008)
	uint8                                         bRandomAnimSegment : 1;                            // 0x0168(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_169[0x3];                                      // 0x0169(0x0003)
	float                                         OscillatorTimeRemaining;                           // 0x016C(0x0004)
	uint8                                         Pad_170[0x78];                                     // 0x0170(0x0078)
	class USequenceCameraShakePattern*            SequenceShakePattern;                              // 0x01E8(0x0008)
	uint8                                         Pad_1F0[0x10];                                     // 0x01F0(0x0010)
...
{
public:
	TArray<struct FActiveCameraAnimationInfo>     ActiveAnimations;                                  // 0x0048(0x0010)
	uint16                                        NextInstanceSerialNumber;                          // 0x0058(0x0002)
...
public:
	...
	struct FPerlinNoiseShaker                     X;                                                 // 0x0060(0x0008)
	struct FPerlinNoiseShaker                     Y;                                                 // 0x0068(0x0008)
	struct FPerlinNoiseShaker                     Z;                                                 // 0x0070(0x0008)
	float                                         RotationAmplitudeMultiplier;                       // 0x0078(0x0004)
	float                                         RotationFrequencyMultiplier;                       // 0x007C(0x0004)
	struct FPerlinNoiseShaker                     Pitch;                                             // 0x0080(0x0008)
	struct FPerlinNoiseShaker                     Yaw;                                               // 0x0088(0x0008)
	struct FPerlinNoiseShaker                     Roll;                                              // 0x0090(0x0008)
	struct FPerlinNoiseShaker                     FOV;                                               // 0x0098(0x0008)
	uint8                                         Pad_A0[0x38];                                      // 0x00A0(0x0038)
...
public:
	float                                         LocationAmplitudeMultiplier;                       // 0x0058(0x0004)
	float                                         LocationFrequencyMultiplier;                       // 0x005C(0x0004)
	struct FWaveOscillator                        X;                                                 // 0x0060(0x000C)
	struct FWaveOscillator                        Y;                                                 // 0x006C(0x000C)
	struct FWaveOscillator                        Z;                                                 // 0x0078(0x000C)
	float                                         RotationAmplitudeMultiplier;                       // 0x0084(0x0004)
	float                                         RotationFrequencyMultiplier;                       // 0x0088(0x0004)
	struct FWaveOscillator                        Pitch;                                             // 0x008C(0x000C)
	struct FWaveOscillator                        Yaw;                                               // 0x0098(0x000C)
	struct FWaveOscillator                        Roll;                                              // 0x00A4(0x000C)
	struct FWaveOscillator                        FOV;                                               // 0x00B0(0x000C)
	uint8                                         Pad_BC[0x3C];                                      // 0x00BC(0x003C)
...
{
public:
	struct FVector                                LocationOffset;                                    // 0x0058(0x0018)
	struct FRotator                               RotationOffset;                                    // 0x0070(0x0018)
