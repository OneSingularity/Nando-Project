...
{
public:
	struct FMovieSceneIntegerChannel              HoursCurve;                                        // 0x00F8(0x0108)
	struct FMovieSceneIntegerChannel              MinutesCurve;                                      // 0x0200(0x0108)
	struct FMovieSceneIntegerChannel              SecondsCurve;                                      // 0x0308(0x0108)
	struct FMovieSceneIntegerChannel              FramesCurve;                                       // 0x0410(0x0108)
	struct FMovieSceneFloatChannel                SubFramesCurve;                                    // 0x0518(0x0110)
	struct FMovieSceneFloatChannel                RateCurve;                                         // 0x0628(0x0110)
	struct FMovieSceneStringChannel               Slate;                                             // 0x0738(0x0110)
...
{
public:
	class FString                                 HoursName;                                         // 0x0028(0x0010)
	class FString                                 MinutesName;                                       // 0x0038(0x0010)
	class FString                                 SecondsName;                                       // 0x0048(0x0010)
	class FString                                 FramesName;                                        // 0x0058(0x0010)
	class FString                                 SubFramesName;                                     // 0x0068(0x0010)
	class FString                                 RateName;                                          // 0x0078(0x0010)
	class FString                                 SlateName;                                         // 0x0088(0x0010)
