...
{
public:
	uint8                                         bEnableLookAtTracking : 1;                         // 0x0000(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bAllowRoll : 1;                                    // 0x0000(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
{
public:
	uint8                                         bOverride_WhiteTemp : 1;                           // 0x0000(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverride_ColorSaturation : 1;                     // 0x0000(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverride_VignetteIntensity : 1;                   // 0x0000(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverride_AutoExposureMethod : 1;                  // 0x0000(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bOverride_CameraISO : 1;                           // 0x0000(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bOverride_CameraShutterSpeed : 1;                  // 0x0000(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         BitPad_0_6 : 2;                                    // 0x0000(0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	uint8                                         bOverride_DepthOfFieldFstop : 1;                   // 0x0004(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)
	float                                         WhiteTemp;                                         // 0x0008(0x0004)
	float                                         VignetteIntensity;                                 // 0x000C(0x0004)
	struct FVector4                               ColorSaturation;                                   // 0x0010(0x0020)
	EAutoExposureMethod                           AutoExposureMethod;                                // 0x0030(0x0001)
...
public:
	...
	struct FDatasmithAssetImportOptions           AssetOptions;                                      // 0x0008(0x0008)
	struct FDatasmithStaticMeshImportOptions      StaticMeshOptions;                                 // 0x0010(0x0004)
};
...
public:
	...
	double                                        GeometricTolerance;                                // 0x0010(0x0008)
	double                                        StitchingTolerance;                                // 0x0018(0x0008)
};
...
{
public:
	EDatasmithCADRetessellationRule               RetessellationRule;                                // 0x0020(0x0001)
...
{
public:
	TMap<class FName, bool>                       StaticSwitchParameters;                            // 0x0000(0x0050)
};
...
{
public:
	uint8                                         bUseMikkTSpace : 1;                                // 0x0000(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bRecomputeNormals : 1;                             // 0x0000(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bRecomputeTangents : 1;                            // 0x0000(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bRemoveDegenerates : 1;                            // 0x0000(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bUseHighPrecisionTangentBasis : 1;                 // 0x0000(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bUseFullPrecisionUVs : 1;                          // 0x0000(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bGenerateLightmapUVs : 1;                          // 0x0000(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	int32                                         MinLightmapResolution;                             // 0x0004(0x0004)
	int32                                         SrcLightmapIndex;                                  // 0x0008(0x0004)
	int32                                         DstLightmapIndex;                                  // 0x000C(0x0004)
};
...
{
public:
	TMap<uint32, struct FDatasmithMeshSectionInfoTemplate> Map;                                      // 0x0000(0x0050)
};
