...
{
public:
	TMulticastInlineDelegate<void(const struct FKey& Key, EViewState State)> ControllerButtonInViewState; // 0x0030(0x0010)
...
{
public:
	bool                                          UseDefaultBrushOnPC;                               // 0x0338(0x0001)
	uint8                                         Pad_339[0x7];                                      // 0x0339(0x0007)
	struct FSlateBrush                            PlayStationButtonImage;                            // 0x0340(0x00B0)
	struct FSlateBrush                            XboxButtonImage;                                   // 0x03F0(0x00B0)
...
{
public:
	struct FRuntimeFloatCurve                     AnalogCursorAccelerationCurve;                     // 0x0038(0x0088)
	...
	uint8                                         Pad_E2[0x16];                                      // 0x00E2(0x0016)
...
{
public:
	TMap<class FString, class UTexture2DDynamic*> ImageMap;                                          // 0x0850(0x0050)
	uint8                                         Pad_8A0[0x20];                                     // 0x08A0(0x0020)
...
{
public:
	class UCFCoreRichText*                        CoreRichText;                                      // 0x0030(0x0008)
	TMulticastInlineDelegate<void(class UTexture2DDynamic* Texture, const class FString& URL)> OnSuccess; // 0x0038(0x0010)
	TMulticastInlineDelegate<void(class UTexture2DDynamic* Texture, const class FString& URL)> OnFail; // 0x0048(0x0010)
...
{
public:
	TDelegate<void(const int64& modId)>           UIPurchaseModDelegate;                             // 0x0030(0x0010)
	TDelegate<void(const TArray<int64>& ModsId)>  UIPurchaseModsDelegate;                            // 0x0040(0x0010)
	TArray<int64>                                 UserPurchasedMods;                                 // 0x0050(0x0010)
	TMap<class FString, class UTexture2DDynamic*> CachedImages;                                      // 0x0060(0x0050)
	struct FMyRatings                             UserRatings;                                       // 0x00B0(0x0020)
	TDelegate<void()>                             ModsRatingsInit;                                   // 0x00D0(0x0010)
	bool                                          bRatingsInitialized;                               // 0x00E0(0x0001)
	uint8                                         Pad_E1[0x7];                                       // 0x00E1(0x0007)
	TMulticastInlineDelegate<void(int64 modId, const class FText& PriceText, const class FText& DescriptionText, int64 NumericPrice, const class FString& productId)> GetPriceOfProductDelegate; // 0x00E8(0x0010)
	uint8                                         Pad_F8[0x150];                                     // 0x00F8(0x0150)
	class UCFCoreSubsystem*                       APISubsystem;                                      // 0x0248(0x0008)
	TArray<class UObject*>                        Models;                                            // 0x0250(0x0010)
	uint8                                         Pad_260[0x20];                                     // 0x0260(0x0020)
