...
{
public:
	uint8                                         Pad_490[0x70];                                     // 0x0490(0x0070)
	class UMaterial*                              Material;                                          // 0x0500(0x0008)
	class UResonanceAudioSpatializationSourceSettings* Settings;                                     // 0x0508(0x0008)
...
public:
	...
	struct FResonanceAudioReverbPluginSettings    Settings;                                          // 0x0100(0x0070)
...
{
public:
	struct FSoftObjectPath                        OutputSubmix;                                      // 0x0028(0x0020)
	ERaQualityMode                                QualityMode;                                       // 0x0048(0x0001)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)
	struct FSoftObjectPath                        GlobalReverbPreset;                                // 0x0050(0x0020)
	struct FSoftObjectPath                        GlobalSourcePreset;                                // 0x0070(0x0020)
