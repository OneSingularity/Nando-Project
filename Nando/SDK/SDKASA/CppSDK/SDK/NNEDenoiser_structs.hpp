...
{
public:
	int32                                         TensorIndex;                                       // 0x0008(0x0004)
	int32                                         TensorChannel;                                     // 0x000C(0x0004)
	int32                                         ResourceChannel;                                   // 0x0010(0x0004)
...
{
public:
	EInputResourceName                            Resource;                                          // 0x0018(0x0001)
...
{
public:
	EOutputResourceName                           Resource;                                          // 0x0018(0x0001)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)
};
...
{
public:
	ETemporalInputResourceName                    Resource;                                          // 0x0018(0x0001)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)
	int32                                         FrameIndex;                                        // 0x001C(0x0004)
};
...
{
public:
	ETemporalOutputResourceName                   Resource;                                          // 0x0018(0x0001)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)
};
...
{
public:
	int32                                         Alignment;                                         // 0x0000(0x0004)
	int32                                         Overlap;                                           // 0x0004(0x0004)
	int32                                         MaxSize;                                           // 0x0008(0x0004)
	int32                                         MinSize;                                           // 0x000C(0x0004)
};
