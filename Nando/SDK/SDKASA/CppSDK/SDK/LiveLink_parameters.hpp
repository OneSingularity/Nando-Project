...
{
public:
	struct FLiveLinkTransform                     LiveLinkTransform;                                 // 0x0000(0x0020)
...
{
public:
	struct FLiveLinkSubjectRepresentation         SubjectRepresentation;                             // 0x0000(0x0010)
	struct FLiveLinkBaseBlueprintData             OutBlueprintData;                                  // 0x0010(0x0008)
...
{
public:
	struct FLiveLinkSubjectName                   SubjectName;                                       // 0x0000(0x0008)
	TSubclassOf<class ULiveLinkRole>              Role;                                              // 0x0008(0x0008)
	struct FTimecode                              SceneTime;                                         // 0x0010(0x0018)
	struct FLiveLinkBaseBlueprintData             OutBlueprintData;                                  // 0x0028(0x0008)
...
public:
	struct FLiveLinkSubjectName                   SubjectName;                                       // 0x0000(0x0008)
	TSubclassOf<class ULiveLinkRole>              Role;                                              // 0x0008(0x0008)
	float                                         WorldTimeOffset;                                   // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	struct FLiveLinkBaseBlueprintData             OutBlueprintData;                                  // 0x0018(0x0008)
...
{
public:
	struct FSubjectFrameHandle                    SubjectFrameHandle;                                // 0x0000(0x0018)
	struct FLiveLinkAnimationFrameData            AnimationFrameData;                                // 0x0018(0x00B0)
...
public:
	struct FSubjectFrameHandle                    SubjectFrameHandle;                                // 0x0000(0x0018)
	struct FLiveLinkSkeletonStaticData            AnimationStaticData;                               // 0x0018(0x0030)
...
public:
	struct FSubjectFrameHandle                    SubjectFrameHandle;                                // 0x0000(0x0018)
	struct FLiveLinkBasicBlueprintData            BasicBlueprintData;                                // 0x0018(0x00B8)
};
...
public:
	struct FLiveLinkTransform                     LiveLinkTransform;                                 // 0x0000(0x0020)
	TArray<struct FLiveLinkTransform>             Children;                                          // 0x0020(0x0010)
};
...
public:
	struct FSubjectFrameHandle                    SubjectFrameHandle;                                // 0x0000(0x0018)
	TMap<class FName, float>                      Curves;                                            // 0x0018(0x0050)
};
...
{
public:
	bool                                          bIncludeVirtualSubject;                            // 0x0000(0x0001)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)
	TArray<struct FLiveLinkSubjectName>           ReturnValue;                                       // 0x0008(0x0010)
};
...
public:
	struct FLiveLinkSubjectName                   SubjectName;                                       // 0x0000(0x0008)
	TSubclassOf<class ULiveLinkRole>              ReturnValue;                                       // 0x0008(0x0008)
};
...
{
public:
	bool                                          bIncludeDisabledSubject;                           // 0x0000(0x0001)
	bool                                          bIncludeVirtualSubject;                            // 0x0001(0x0001)
	uint8                                         Pad_2[0x6];                                        // 0x0002(0x0006)
	TArray<struct FLiveLinkSubjectKey>            ReturnValue;                                       // 0x0008(0x0010)
};
...
public:
	struct FLiveLinkSubjectName                   SubjectName;                                       // 0x0000(0x0008)
	ELiveLinkSubjectState                         ReturnValue;                                       // 0x0008(0x0001)
...
public:
	struct FSubjectFrameHandle                    SubjectFrameHandle;                                // 0x0000(0x0018)
	struct FSubjectMetadata                       MetaData;                                          // 0x0018(0x0070)
};
...
public:
	struct FLiveLinkTransform                     LiveLinkTransform;                                 // 0x0000(0x0020)
	struct FLiveLinkTransform                     Parent;                                            // 0x0020(0x0020)
};
...
{
public:
	struct FLiveLinkBasicBlueprintData            BasicData;                                         // 0x0000(0x00B8)
	class FName                                   PropertyName;                                      // 0x00B8(0x0008)
	float                                         Value;                                             // 0x00C0(0x0004)
	bool                                          ReturnValue;                                       // 0x00C4(0x0001)
...
public:
	struct FSubjectFrameHandle                    SubjectFrameHandle;                                // 0x0000(0x0018)
	struct FLiveLinkTransform                     LiveLinkTransform;                                 // 0x0018(0x0020)
};
...
{
public:
	struct FLiveLinkSourceHandle                  SourceHandle;                                      // 0x0000(0x0018)
...
{
public:
	struct FGuid                                  SourceGuid;                                        // 0x0000(0x0010)
...
{
public:
	struct FLiveLinkSubjectKey                    SubjectKey;                                        // 0x0000(0x0018)
	TSubclassOf<class ULiveLinkRole>              ReturnValue;                                       // 0x0018(0x0008)
};
...
public:
	struct FSubjectFrameHandle                    SubjectFrameHandle;                                // 0x0000(0x0018)
	int32                                         TransformIndex;                                    // 0x0018(0x0004)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	struct FLiveLinkTransform                     LiveLinkTransform;                                 // 0x0020(0x0020)
};
...
public:
	struct FSubjectFrameHandle                    SubjectFrameHandle;                                // 0x0000(0x0018)
	class FName                                   TransformName_0;                                   // 0x0018(0x0008)
	struct FLiveLinkTransform                     LiveLinkTransform;                                 // 0x0020(0x0020)
};
...
public:
	struct FLiveLinkSubjectKey                    SubjectKey;                                        // 0x0000(0x0018)
	bool                                          bForThisFrame;                                     // 0x0018(0x0001)
...
public:
	struct FSubjectFrameHandle                    SubjectFrameHandle;                                // 0x0000(0x0018)
	TArray<class FName>                           TransformNames_0;                                  // 0x0018(0x0010)
};
...
{
public:
	TArray<class FName>                           SubjectNames;                                      // 0x0000(0x0010)
};
...
public:
	...
	struct FSubjectFrameHandle                    SubjectFrameHandle;                                // 0x0010(0x0018)
};
...
public:
	class FName                                   SubjectName;                                       // 0x0000(0x0008)
	struct FTimecode                              SceneTime;                                         // 0x0008(0x0018)
	bool                                          bSuccess;                                          // 0x0020(0x0001)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)
	struct FSubjectFrameHandle                    SubjectFrameHandle;                                // 0x0028(0x0018)
};
...
{
public:
	struct FProviderPollResult                    provider;                                          // 0x0000(0x0090)
	struct FLiveLinkSourceHandle                  SourceHandle;                                      // 0x0090(0x0018)
};
...
{
public:
	class ULiveLinkMessageBusFinder*              ReturnValue;                                       // 0x0000(0x0008)
};
...
public:
	...
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	TArray<struct FProviderPollResult>            AvailableProviders;                                // 0x0028(0x0010)
};
...
{
public:
	bool                                          bRecreatePresets;                                  // 0x0000(0x0001)
...
{
public:
	struct FLiveLinkBaseFrameData                 InStruct;                                          // 0x0000(0x00A0)
	bool                                          bInShouldStampCurrentTime;                         // 0x00A0(0x0001)
...
{
public:
	struct FLiveLinkBaseStaticData                InStruct;                                          // 0x0000(0x0010)
