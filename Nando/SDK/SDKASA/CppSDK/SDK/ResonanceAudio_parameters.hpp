...
{
public:
	class UResonanceAudioReverbPluginPreset*      ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	class UResonanceAudioReverbPluginPreset*      InPreset;                                          // 0x0000(0x0008)
};
...
{
public:
	bool                                          bInEnableRoomEffects;                              // 0x0000(0x0001)
};
...
{
public:
	float                                         InReflectionScalar;                                // 0x0000(0x0004)
};
...
{
public:
	float                                         InReverbBrightness;                                // 0x0000(0x0004)
};
...
{
public:
	float                                         InReverbGain;                                      // 0x0000(0x0004)
};
...
{
public:
	float                                         InReverbTimeModifier;                              // 0x0000(0x0004)
};
...
{
public:
	struct FVector                                InDimensions;                                      // 0x0000(0x0018)
};
...
{
public:
	TArray<ERaMaterialName>                       InMaterials;                                       // 0x0000(0x0010)
};
...
{
public:
	struct FQuat                                  InRotation;                                        // 0x0000(0x0020)
};
...
{
public:
	float                                         InPattern;                                         // 0x0000(0x0004)
	float                                         InSharpness;                                       // 0x0004(0x0004)
};
