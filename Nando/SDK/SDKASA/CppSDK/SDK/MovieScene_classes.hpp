...
public:
	...
	struct FGuid                                  Signature;                                         // 0x002C(0x0010)
	uint8                                         Pad_3C[0x1C];                                      // 0x003C(0x001C)
...
{
public:
	struct FMovieSceneTrackEvalOptions            EvalOptions;                                       // 0x0058(0x0004)
	uint8                                         Pad_5C[0x4];                                       // 0x005C(0x0004)
	struct FMovieSceneConditionContainer          ConditionContainer;                                // 0x0060(0x0008)
	uint8                                         Pad_68[0x1];                                       // 0x0068(0x0001)
	bool                                          bIsEvalDisabled;                                   // 0x0069(0x0001)
	uint8                                         Pad_6A[0x6];                                       // 0x006A(0x0006)
	TArray<int32>                                 RowsDisabled;                                      // 0x0070(0x0010)
	uint8                                         Pad_80[0x4];                                       // 0x0080(0x0004)
	struct FGuid                                  EvaluationFieldGuid;                               // 0x0084(0x0010)
	uint8                                         Pad_94[0x4];                                       // 0x0094(0x0004)
	struct FMovieSceneTrackEvaluationField        EvaluationField;                                   // 0x0098(0x0010)
	TMap<int32, struct FMovieSceneTrackRowMetadata> TrackRowMetadata;                                // 0x00A8(0x0050)
...
public:
	...
	struct FGuid                                  ObjectGuid;                                        // 0x0108(0x0010)
...
{
public:
	EMovieSceneGroupConditionOperator             Operator;                                          // 0x0060(0x0001)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)
	TArray<struct FMovieSceneConditionContainer>  SubConditions;                                     // 0x0068(0x0010)
...
{
public:
	class UMovieSceneNumericVariantGetter*        ReferenceToSelf;                                   // 0x0058(0x0008)
...
public:
	...
	uint8                                         bMuted : 1;                                        // 0x0068(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
{
public:
	struct FMovieSceneTimeWarpChannel             PlayRate;                                          // 0x0070(0x0128)
	uint8                                         Pad_198[0x18];                                     // 0x0198(0x0018)
...
{
public:
	ESpawnOwnership                               SpawnOwnership;                                    // 0x0028(0x0001)
	bool                                          bContinuouslyRespawn;                              // 0x0029(0x0001)
...
{
public:
	struct FMovieSceneTimeWarpChannel             Channel;                                           // 0x0070(0x0128)
...
{
public:
	struct FMovieSceneSectionEvalOptions          EvalOptions;                                       // 0x0058(0x0002)
	uint8                                         Pad_5A[0x6];                                       // 0x005A(0x0006)
	struct FMovieSceneEasingSettings              Easing;                                            // 0x0060(0x0038)
	struct FMovieSceneFrameRange                  SectionRange;                                      // 0x0098(0x0010)
	struct FMovieSceneConditionContainer          ConditionContainer;                                // 0x00A8(0x0008)
	struct FFrameNumber                           PreRollFrames;                                     // 0x00B0(0x0004)
	struct FFrameNumber                           PostRollFrames;                                    // 0x00B4(0x0004)
	int32                                         RowIndex;                                          // 0x00B8(0x0004)
	int32                                         OverlapPriority;                                   // 0x00BC(0x0004)
	uint8                                         bIsActive : 1;                                     // 0x00C0(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bIsLocked : 1;                                     // 0x00C0(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_C1[0x3];                                       // 0x00C1(0x0003)
	float                                         StartTime;                                         // 0x00C4(0x0004)
	float                                         EndTime;                                           // 0x00C8(0x0004)
	float                                         PrerollTime;                                       // 0x00CC(0x0004)
	float                                         PostrollTime;                                      // 0x00D0(0x0004)
	uint8                                         bIsInfinite : 1;                                   // 0x00D4(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_D5[0x3];                                       // 0x00D5(0x0003)
	bool                                          bSupportsInfiniteRange;                            // 0x00D8(0x0001)
	struct FOptionalMovieSceneBlendType           BlendType;                                         // 0x00D9(0x0002)
	uint8                                         Pad_DB[0x1D];                                      // 0x00DB(0x001D)
...
{
public:
	struct FMovieSceneTimeWarpVariant             TimeWarp;                                          // 0x00F8(0x0008)
...
{
public:
	bool                                          bIsActiveTimeWarp;                                 // 0x00F8(0x0001)
...
{
public:
	TMap<class FName, class UMovieSceneChannelOverrideContainer*> Overrides;                         // 0x0028(0x0050)
...
public:
	...
	struct FMovieSceneSequenceHierarchy           Hierarchy;                                         // 0x0188(0x0140)
	struct FMovieSceneEntityComponentField        EntityComponentField;                              // 0x02C8(0x00F0)
	struct FMovieSceneEvaluationField             TrackTemplateField;                                // 0x03B8(0x0030)
	TArray<struct FMovieSceneDeterminismFence>    DeterminismFences;                                 // 0x03E8(0x0010)
	struct FGuid                                  CompiledSignature;                                 // 0x03F8(0x0010)
	struct FGuid                                  CompilerVersion;                                   // 0x0408(0x0010)
	EMovieSceneSequenceCompilerMask               AccumulatedMask;                                   // 0x0418(0x0001)
	EMovieSceneSequenceCompilerMask               AllocatedMask;                                     // 0x0419(0x0001)
	EMovieSceneSequenceFlags                      AccumulatedFlags;                                  // 0x041A(0x0001)
...
{
public:
	uint8                                         Pad_28[0xB0];                                      // 0x0028(0x00B0)
	TMap<int32, struct FMovieSceneSequenceHierarchy> Hierarchies;                                    // 0x00D8(0x0050)
	TMap<int32, struct FMovieSceneEvaluationTemplate> TrackTemplates;                                // 0x0128(0x0050)
	TMap<int32, struct FMovieSceneEvaluationField> TrackTemplateFields;                              // 0x0178(0x0050)
	TMap<int32, struct FMovieSceneEntityComponentField> EntityComponentFields;                       // 0x01C8(0x0050)
	uint8                                         Pad_218[0x18];                                     // 0x0218(0x0018)
...
{
public:
	uint8                                         Pad_28[0x278];                                     // 0x0028(0x0278)
	struct FMovieSceneEntitySystemGraph           SystemGraph;                                       // 0x02A0(0x0190)
	uint8                                         Pad_430[0x320];                                    // 0x0430(0x0320)
...
{
public:
	uint8                                         Pad_40[0x170];                                     // 0x0040(0x0170)
...
{
public:
	TWeakObjectPtr<class UObject>                 WeakAnimatedObject;                                // 0x0028(0x0008)
	...
	TArray<struct FMovieSceneTrackInstanceInput>  Inputs;                                            // 0x0040(0x0010)
...
public:
	...
	TArray<struct FMovieSceneSpawnable>           Spawnables;                                        // 0x0060(0x0010)
	TArray<struct FMovieScenePossessable>         Possessables;                                      // 0x0070(0x0010)
	TArray<struct FMovieSceneBinding>             ObjectBindings;                                    // 0x0080(0x0010)
	TMap<class FName, struct FMovieSceneObjectBindingIDs> BindingGroups;                             // 0x0090(0x0050)
	TArray<class UMovieSceneTrack*>               Tracks;                                            // 0x00E0(0x0010)
	class UMovieSceneTrack*                       CameraCutTrack;                                    // 0x00F0(0x0008)
	struct FMovieSceneFrameRange                  SelectionRange;                                    // 0x00F8(0x0010)
	struct FMovieSceneFrameRange                  PlaybackRange;                                     // 0x0108(0x0010)
	struct FFrameRate                             TickResolution;                                    // 0x0118(0x0008)
	struct FFrameRate                             DisplayRate;                                       // 0x0120(0x0008)
	...
	struct FSoftObjectPath                        CustomClockSourcePath;                             // 0x0130(0x0020)
	TArray<struct FMovieSceneMarkedFrame>         MarkedFrames;                                      // 0x0150(0x0010)
	TArray<class UMovieSceneGroupCondition*>      GeneratedConditions;                               // 0x0160(0x0010)
...
{
public:
	TArray<struct FMovieSceneBindingOverrideData> BindingData;                                       // 0x0028(0x0010)
	uint8                                         Pad_38[0x58];                                      // 0x0038(0x0058)
...
public:
	uint8                                         Pad_28[0x4];                                       // 0x0028(0x0004)
	class FName                                   FolderName;                                        // 0x002C(0x0008)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)
	TArray<class UMovieSceneFolder*>              ChildFolders;                                      // 0x0038(0x0010)
	TArray<class UMovieSceneTrack*>               ChildTracks;                                       // 0x0048(0x0010)
	TArray<class FString>                         ChildObjectBindingStrings;                         // 0x0058(0x0010)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	class FString                                 Author;                                            // 0x0030(0x0010)
	struct FDateTime                              Created;                                           // 0x0040(0x0008)
	class FString                                 Notes;                                             // 0x0048(0x0010)
...
public:
	...
	uint8                                         bReversePlayback : 1;                              // 0x028C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	...
	uint8                                         Pad_2F8[0x8C];                                     // 0x02F8(0x008C)
	struct FMovieSceneSequenceReplProperties      NetSyncProps;                                      // 0x0384(0x0014)
	TScriptInterface<class IMovieScenePlaybackClient> PlaybackClient;                                // 0x0398(0x0010)
	class UMovieSceneSequenceTickManager*         TickManager;                                       // 0x03A8(0x0008)
	uint8                                         Pad_3B0[0xD0];                                     // 0x03B0(0x00D0)
...
{
public:
	bool                                          DefaultValue;                                      // 0x00F8(0x0001)
	uint8                                         Pad_F9[0x7];                                       // 0x00F9(0x0007)
	struct FMovieSceneBoolChannel                 BoolCurve;                                         // 0x0100(0x0108)
...
public:
	...
	uint8                                         bRequiresRangedHook : 1;                           // 0x0108(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bRequiresTriggerHooks : 1;                         // 0x0108(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneSectionParameters           Parameters;                                        // 0x0100(0x0030)
	float                                         StartOffset;                                       // 0x0130(0x0004)
	float                                         TimeScale;                                         // 0x0134(0x0004)
	float                                         PrerollTime_MovieSceneSubSection;                  // 0x0138(0x0004)
	uint8                                         NetworkMask;                                       // 0x013C(0x0001)
	uint8                                         Pad_13D[0x3];                                      // 0x013D(0x0003)
	struct FMovieSceneSubSectionOriginOverrideMask OriginOverrideMask;                               // 0x0140(0x0004)
	uint8                                         Pad_144[0x4];                                      // 0x0144(0x0004)
	struct FMovieSceneDoubleChannel               Translation[0x3];                                  // 0x0148(0x0118)
	struct FMovieSceneDoubleChannel               Rotation[0x3];                                     // 0x0490(0x0118)
	class UMovieSceneSequence*                    SubSequence;                                       // 0x07D8(0x0008)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	bool                                          bHighPassFilter;                                   // 0x0100(0x0001)
	uint8                                         Pad_101[0x7];                                      // 0x0101(0x0007)
	TArray<class UMovieSceneSection*>             SectionArray;                                      // 0x0108(0x0010)
...
{
public:
	TArray<class UMovieSceneSection*>             SectionArray;                                      // 0x00F8(0x0010)
...
{
public:
	uint8                                         Pad_110[0x18];                                     // 0x0110(0x0018)
