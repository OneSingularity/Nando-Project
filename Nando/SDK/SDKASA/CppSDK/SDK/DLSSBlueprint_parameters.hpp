...
{
public:
	EUDLSSMode                                    ReturnValue;                                       // 0x0000(0x0001)
};
...
{
public:
	int32                                         MinDriverVersionMajor;                             // 0x0000(0x0004)
	int32                                         MinDriverVersionMinor;                             // 0x0004(0x0004)
};
...
{
public:
	EUDLSSMode                                    DLSSMode;                                          // 0x0000(0x0001)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)
	struct FVector2D                              ScreenResolution;                                  // 0x0008(0x0010)
	bool                                          bIsSupported;                                      // 0x0018(0x0001)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)
	float                                         OptimalScreenPercentage;                           // 0x001C(0x0004)
	bool                                          bIsFixedScreenPercentage;                          // 0x0020(0x0001)
	uint8                                         Pad_21[0x3];                                       // 0x0021(0x0003)
	float                                         MinScreenPercentage;                               // 0x0024(0x0004)
	float                                         MaxScreenPercentage;                               // 0x0028(0x0004)
	float                                         OptimalSharpness;                                  // 0x002C(0x0004)
};
...
{
public:
	float                                         MinScreenPercentage;                               // 0x0000(0x0004)
	float                                         MaxScreenPercentage;                               // 0x0004(0x0004)
};
...
{
public:
	TArray<EUDLSSMode>                            ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	EUDLSSSupport                                 ReturnValue;                                       // 0x0000(0x0001)
};
...
public:
	...
	EUDLSSMode                                    DLSSMode;                                          // 0x0008(0x0001)
