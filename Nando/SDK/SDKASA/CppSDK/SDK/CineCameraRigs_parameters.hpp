...
{
public:
	class UTickableParentConstraint*              ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	struct FTransformFilter                       InFilter;                                          // 0x0000(0x0009)
};
...
{
public:
	ECineCameraRigRailDriveMode                   InMode;                                            // 0x0000(0x0001)
};
...
{
public:
	class UTexture2D*                             InTexture;                                         // 0x0000(0x0008)
};
...
{
public:
	class UCineSplineComponent*                   ReturnValue;                                       // 0x0000(0x0008)
};
...
public:
	...
	TArray<float>                                 DataValues;                                        // 0x0008(0x0010)
	float                                         LowValue;                                          // 0x0018(0x0004)
	float                                         AverageValue;                                      // 0x001C(0x0004)
	float                                         HighValue;                                         // 0x0020(0x0004)
...
public:
	...
	struct FCineSplinePointData                   InPointData;                                       // 0x0008(0x0040)
};
...
{
public:
	int32                                         PointIndex;                                        // 0x0000(0x0004)
...
public:
	float                                         InPosition;                                        // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FCineSplinePointData                   ReturnValue;                                       // 0x0008(0x0040)
};
