...
public:
	...
	EDataflowTransferNodeBoundingVolume           BoundingVolumeType;                                // 0x0318(0x0001)
	EDataflowTransferNodeSampleScale              SampleScale;                                       // 0x0319(0x0001)
	EDataflowTransferNodeFalloff                  Falloff;                                           // 0x031A(0x0001)
...
public:
	...
	struct FLinearColor                           NonSelectedColor;                                  // 0x0278(0x0010)
};
