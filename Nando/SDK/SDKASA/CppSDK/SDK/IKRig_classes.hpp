...
{
public:
	TArray<struct FCurveRemapPair>                CurvesToRemap;                                     // 0x0030(0x0010)
...
{
public:
	TArray<struct FPinBoneData>                   BonesToPin;                                        // 0x0030(0x0010)
	ERetargetSourceOrTarget                       PinTo;                                             // 0x0040(0x0001)
	EPinBoneType                                  PinType;                                           // 0x0041(0x0001)
	bool                                          bMaintainOffset;                                   // 0x0042(0x0001)
	uint8                                         Pad_43[0xD];                                       // 0x0043(0x000D)
	struct FTransform                             GlobalOffset;                                      // 0x0050(0x0060)
	struct FTransform                             LocalOffset;                                       // 0x00B0(0x0060)
...
{
public:
	class FName                                   SourceRootBone;                                    // 0x0030(0x0008)
	class FName                                   TargetRootBone;                                    // 0x0038(0x0008)
	class FName                                   TargetPelvisBone;                                  // 0x0040(0x0008)
	...
	struct FTransform                             GlobalOffset;                                      // 0x0050(0x0060)
	uint8                                         Pad_B0[0x1A0];                                     // 0x00B0(0x01A0)
...
{
public:
	class FName                                   SourceChain;                                       // 0x0028(0x0008)
	class FName                                   TargetChain;                                       // 0x0030(0x0008)
	struct FTargetChainSettings                   Settings;                                          // 0x0038(0x00B0)
...
{
public:
	struct FTargetRootSettings                    Settings;                                          // 0x0028(0x0068)
...
{
public:
	struct FRetargetGlobalSettings                Settings;                                          // 0x0028(0x0024)
...
{
public:
	int32                                         Version;                                           // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	TSoftObjectPtr<class UIKRigDefinition>        SourceIKRigAsset;                                  // 0x0030(0x0028)
	TSoftObjectPtr<class UIKRigDefinition>        TargetIKRigAsset;                                  // 0x0058(0x0028)
	TArray<struct FRetargetChainMap>              ChainMapping;                                      // 0x0080(0x0010)
	...
	TMap<class FName, struct FRetargetProfile>    Profiles;                                          // 0x00B8(0x0050)
	class FName                                   CurrentProfile;                                    // 0x0108(0x0008)
	TMap<class FName, struct FIKRetargetPose>     SourceRetargetPoses;                               // 0x0110(0x0050)
	TMap<class FName, struct FIKRetargetPose>     TargetRetargetPoses;                               // 0x0160(0x0050)
	class FName                                   CurrentSourceRetargetPose;                         // 0x01B0(0x0008)
	class FName                                   CurrentTargetRetargetPose;                         // 0x01B8(0x0008)
	TMap<class FName, struct FIKRetargetPose>     RetargetPoses;                                     // 0x01C0(0x0050)
	class FName                                   CurrentRetargetPose;                               // 0x0210(0x0008)
...
{
public:
	uint8                                         Pad_28[0x160];                                     // 0x0028(0x0160)
	class UIKRigProcessor*                        IKRigProcessor;                                    // 0x0188(0x0008)
	uint8                                         Pad_190[0x1F8];                                    // 0x0190(0x01F8)
...
{
public:
	class FName                                   GoalName;                                          // 0x0028(0x0008)
	class FName                                   BoneName;                                          // 0x0030(0x0008)
	float                                         PositionAlpha;                                     // 0x0038(0x0004)
	float                                         RotationAlpha;                                     // 0x003C(0x0004)
	struct FTransform                             CurrentTransform;                                  // 0x0040(0x0060)
	struct FTransform                             InitialTransform;                                  // 0x00A0(0x0060)
...
public:
	...
	TSoftObjectPtr<class USkeletalMesh>           PreviewSkeletalMesh;                               // 0x0030(0x0028)
	struct FIKRigSkeleton                         Skeleton;                                          // 0x0058(0x0070)
	TArray<class UIKRigEffectorGoal*>             Goals;                                             // 0x00C8(0x0010)
	TArray<class UIKRigSolver*>                   Solvers;                                           // 0x00D8(0x0010)
	struct FRetargetDefinition                    RetargetDefinition;                                // 0x00E8(0x0018)
...
public:
	...
	uint8                                         Pad_70[0xD8];                                      // 0x0070(0x00D8)
...
{
public:
	class FName                                   RootBone;                                          // 0x0030(0x0008)
	float                                         PositionAlpha;                                     // 0x0038(0x0004)
...
{
public:
	class FName                                   RootName;                                          // 0x0030(0x0008)
	float                                         ReachPrecision;                                    // 0x0038(0x0004)
	EAxis                                         HingeRotationAxis;                                 // 0x003C(0x0001)
	uint8                                         Pad_3D[0x3];                                       // 0x003D(0x0003)
	int32                                         MaxIterations;                                     // 0x0040(0x0004)
	...
	EAxis                                         EndBoneForwardAxis;                                // 0x0059(0x0001)
...
{
public:
	class FName                                   bone;                                              // 0x0028(0x0008)
	...
	struct FVector                                PreferredAngles;                                   // 0x0060(0x0018)
...
public:
	class FName                                   RootBone;                                          // 0x0030(0x0008)
	int32                                         Iterations;                                        // 0x0038(0x0004)
	int32                                         SubIterations;                                     // 0x003C(0x0004)
	...
	struct FRootPrePullSettings                   PrePullRootSettings;                               // 0x0048(0x0020)
	...
	uint8                                         Pad_98[0x58];                                      // 0x0098(0x0058)
...
public:
	class FName                                   RootName;                                          // 0x0030(0x0008)
	class FName                                   EndName;                                           // 0x0038(0x0008)
...
{
public:
	class FName                                   Goal;                                              // 0x0030(0x0008)
	class FName                                   RootBone;                                          // 0x0038(0x0008)
