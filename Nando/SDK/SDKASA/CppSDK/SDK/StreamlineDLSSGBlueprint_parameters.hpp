...
{
public:
	EStreamlineDLSSGMode                          ReturnValue;                                       // 0x0000(0x0001)
};
...
{
public:
	float                                         FrameRateInHertz;                                  // 0x0000(0x0004)
	int32                                         FramesPresented;                                   // 0x0004(0x0004)
};
...
{
public:
	TArray<EStreamlineDLSSGMode>                  ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	EStreamlineDLSSGMode                          DLSSGMode;                                         // 0x0000(0x0001)
