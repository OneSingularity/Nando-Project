...
struct FNDIRenderTargetVolumeSimCacheFrame final
{
public:
	struct FIntVector                             Size;                                              // 0x0000(0x000C)
	EPixelFormat                                  Format;                                            // 0x000C(0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
	int32                                         UncompressedSize;                                  // 0x0010(0x0004)
	int32                                         CompressedSize;                                    // 0x0014(0x0004)
	uint8                                         Pad_18[0x30];                                      // 0x0018(0x0030)
};
...
{
public:
	int32                                         RegisteredTypeIndex;                               // 0x0000(0x0004)
};
...
public:
	...
	struct FNiagaraTypeDefinitionHandle           TypeDefHandle;                                     // 0x0008(0x0004)
};
...
public:
	...
	TArray<uint8>                                 VarData;                                           // 0x0010(0x0010)
};
...
{
public:
	struct FNiagaraVariable                       RootVariable;                                      // 0x0000(0x0020)
	struct FNiagaraVariableBase                   ParamMapVariable;                                  // 0x0020(0x000C)
	class FName                                   DataSetName;                                       // 0x002C(0x0008)
	ENiagaraBindingSource                         BindingSourceMode;                                 // 0x0034(0x0001)
	uint8                                         bBindingExistsOnSource : 1;                        // 0x0035(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bIsCachedParticleValue : 1;                        // 0x0035(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
{
public:
	uint8                                         bAppendToSimCache : 1;                             // 0x0000(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bCaptureFixedNumberOfFrames : 1;                   // 0x0000(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	int32                                         NumFrames;                                         // 0x0004(0x0004)
	int32                                         CaptureRate;                                       // 0x0008(0x0004)
	uint8                                         bUseTimeout : 1;                                   // 0x000C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
	int32                                         TimeoutFrameCount;                                 // 0x0010(0x0004)
	uint8                                         bCaptureAllFramesImmediatly : 1;                   // 0x0014(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
public:
	...
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	uint8                                         bAllowRebasing : 1;                                // 0x0004(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bAllowDataInterfaceCaching : 1;                    // 0x0004(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bAllowInterpolation : 1;                           // 0x0004(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bAllowVelocityExtrapolation : 1;                   // 0x0004(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bAllowSerializeLargeCache : 1;                     // 0x0004(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bIncludeDebugData : 1;                             // 0x0004(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)
	TArray<class FName>                           RebaseIncludeAttributes;                           // 0x0008(0x0010)
	TArray<class FName>                           RebaseExcludeAttributes;                           // 0x0018(0x0010)
	TArray<class FName>                           InterpolationIncludeAttributes;                    // 0x0028(0x0010)
	TArray<class FName>                           InterpolationExcludeAttributes;                    // 0x0038(0x0010)
	TArray<class FName>                           ExplicitCaptureAttributes;                         // 0x0048(0x0010)
};
...
{
public:
	struct FGuid                                  AssetTagDefinitionGuid;                            // 0x0000(0x0010)
};
...
{
public:
	struct FNiagaraVariableBase                   ResolvedParameter;                                 // 0x0000(0x000C)
};
...
public:
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	TArray<uint8>                                 DefaultValue;                                      // 0x0010(0x0010)
};
...
{
public:
	class FText                                   AssetTag;                                          // 0x0000(0x0010)
	int32                                         AssetFlags;                                        // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	class FText                                   Description;                                       // 0x0018(0x0010)
	...
	struct FGuid                                  TagGuid;                                           // 0x003C(0x0010)
...
{
public:
	struct FNiagaraDataSetID                      ID;                                                // 0x0000(0x000C)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	TArray<struct FNiagaraVariableBase>           Variables;                                         // 0x0010(0x0010)
};
...
public:
	class FName                                   Name;                                              // 0x0000(0x0008)
	TArray<struct FNiagaraVariable>               Inputs;                                            // 0x0008(0x0010)
	TArray<struct FNiagaraVariableBase>           Outputs;                                           // 0x0018(0x0010)
	class FName                                   OwnerName;                                         // 0x0028(0x0008)
	uint8                                         bRequiresContext : 1;                              // 0x0030(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bRequiresExecPin : 1;                              // 0x0030(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bMemberFunction : 1;                               // 0x0030(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bExperimental : 1;                                 // 0x0030(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bSupportsCPU : 1;                                  // 0x0030(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bSupportsGPU : 1;                                  // 0x0030(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bWriteFunction : 1;                                // 0x0030(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bReadFunction : 1;                                 // 0x0030(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
	uint8                                         bSoftDeprecatedFunction : 1;                       // 0x0031(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bIsCompileTagGenerator : 1;                        // 0x0031(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bHidden : 1;                                       // 0x0031(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         Pad_32[0x2];                                       // 0x0032(0x0002)
	int32                                         ModuleUsageBitmask;                                // 0x0034(0x0004)
	uint16                                        MiscUsageBitMask;                                  // 0x0038(0x0002)
	uint8                                         Pad_3A[0x2];                                       // 0x003A(0x0002)
	int32                                         ContextStageIndex;                                 // 0x003C(0x0004)
	int16                                         RequiredInputs;                                    // 0x0040(0x0002)
	int16                                         RequiredOutputs;                                   // 0x0042(0x0002)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)
	TMap<class FName, class FName>                FunctionSpecifiers;                                // 0x0048(0x0050)
};
...
{
public:
	struct FNiagaraVariableBase                   Variable;                                          // 0x0000(0x000C)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	class UObject*                                Object;                                            // 0x0010(0x0008)
	struct FSoftObjectPath                        ObjectPath;                                        // 0x0018(0x0020)
	class FName                                   RegisteredParameterMapRead;                        // 0x0038(0x0008)
	TArray<class FName>                           RegisteredParameterMapWrites;                      // 0x0040(0x0010)
};
...
{
public:
	class FName                                   ReadVariableName;                                  // 0x0000(0x0008)
	struct FNiagaraVariableBase                   ResolvedVariable;                                  // 0x0008(0x000C)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
...
public:
	struct FNiagaraVariableBase                   Variable;                                          // 0x0000(0x000C)
	class FName                                   ExternalName;                                      // 0x000C(0x0008)
};
...
public:
	...
	uint16                                        UnderlyingType;                                    // 0x0008(0x0002)
	uint8                                         Flags;                                             // 0x000A(0x0001)
...
public:
	...
	class FName                                   CompileName;                                       // 0x0010(0x0008)
	int32                                         UserPtrIdx;                                        // 0x0018(0x0004)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	struct FNiagaraTypeDefinition                 Type;                                              // 0x0020(0x0010)
	class FName                                   RegisteredParameterMapRead;                        // 0x0030(0x0008)
	class FName                                   RegisteredParameterMapWrite;                       // 0x0038(0x0008)
	class FString                                 SourceEmitterName;                                 // 0x0040(0x0010)
};
...
{
public:
	int32                                         UserParameterStoreDataInterfaceIndex;              // 0x0000(0x0004)
	int32                                         ScriptParameterStoreDataInterfaceIndex;            // 0x0004(0x0004)
};
...
public:
	class FName                                   Name;                                              // 0x0000(0x0008)
	class FName                                   CompileName;                                       // 0x0008(0x0008)
	class FString                                 ResolvedSourceEmitterName;                         // 0x0010(0x0010)
	struct FNiagaraVariableBase                   ResolvedVariable;                                  // 0x0020(0x000C)
	struct FNiagaraVariableBase                   ParameterStoreVariable;                            // 0x002C(0x000C)
	...
	int32                                         UserPtrIdx;                                        // 0x0048(0x0004)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)
};
...
public:
	class FName                                   Name;                                              // 0x0000(0x0008)
	int32                                         UserPtrIdx;                                        // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FNiagaraTypeDefinition                 Type;                                              // 0x0010(0x0010)
	class FName                                   RegisteredParameterMapRead;                        // 0x0020(0x0008)
	class FName                                   RegisteredParameterMapWrite;                       // 0x0028(0x0008)
	bool                                          bIsPlaceholder;                                    // 0x0030(0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
	class FString                                 SourceEmitterName;                                 // 0x0038(0x0010)
};
...
{
public:
	class FName                                   FullName;                                          // 0x0000(0x0008)
	class FName                                   FriendlyName;                                      // 0x0008(0x0008)
};
...
public:
	...
	class FName                                   Value;                                             // 0x0008(0x0008)
};
...
public:
	class FName                                   Name;                                              // 0x0000(0x0008)
	class FName                                   OwnerName;                                         // 0x0008(0x0008)
	TArray<bool>                                  InputParamLocations;                               // 0x0010(0x0010)
	int32                                         NumOutputs;                                        // 0x0020(0x0004)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	TArray<struct FVMFunctionSpecifier>           FunctionSpecifiers;                                // 0x0028(0x0010)
	TArray<struct FNiagaraVariableBase>           VariadicInputs;                                    // 0x0038(0x0010)
	TArray<struct FNiagaraVariableBase>           VariadicOutputs;                                   // 0x0048(0x0010)
};
...
public:
	...
	class FText                                   Definition;                                        // 0x0020(0x0010)
...
{
public:
	class FName                                   MaterialParameterName;                             // 0x0000(0x0008)
	struct FNiagaraVariableBase                   NiagaraVariable;                                   // 0x0008(0x000C)
	struct FNiagaraVariableBase                   ResolvedNiagaraVariable;                           // 0x0014(0x000C)
	struct FNiagaraVariableBase                   NiagaraChildVariable;                              // 0x0020(0x000C)
};
...
{
public:
	class FString                                 LinkerErrorMessage;                                // 0x0000(0x0010)
	struct FGuid                                  NodeGuid;                                          // 0x0010(0x0010)
	struct FGuid                                  PinGuid;                                           // 0x0020(0x0010)
	TArray<struct FGuid>                          StackGuids;                                        // 0x0030(0x0010)
...
public:
	...
	TArray<struct FNiagaraVariable>               RapidIterationParameters;                          // 0x00B0(0x0010)
	TMap<class FName, class UNiagaraDataInterface*> NamedDataInterfaces;                             // 0x00C0(0x0050)
};
...
public:
	...
	uint8                                         Pad_10[0x58];                                      // 0x0010(0x0058)
	TArray<struct FNiagaraVariable>               ExposedVariables;                                  // 0x0068(0x0010)
...
{
public:
	class FString                                 Object;                                            // 0x0000(0x0010)
	TArray<class FString>                         PropertyKeys;                                      // 0x0010(0x0010)
	TArray<class FString>                         PropertyValues;                                    // 0x0020(0x0010)
};
...
public:
	...
	uint8                                         bOverrideLocation : 1;                             // 0x0020(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
{
public:
	int32                                         LWCBytes;                                          // 0x0000(0x0004)
	int32                                         LWCOffset;                                         // 0x0004(0x0004)
	int32                                         SimulationBytes;                                   // 0x0008(0x0004)
	int32                                         SimulationOffset;                                  // 0x000C(0x0004)
...
{
public:
	int32                                         LWCSize;                                           // 0x0000(0x0004)
	int32                                         SWCSize;                                           // 0x0004(0x0004)
	TArray<struct FNiagaraStructConversionStep>   ConversionSteps;                                   // 0x0008(0x0010)
};
...
{
public:
	TMap<struct FNiagaraVariableBase, int32>      VariableIndices;                                   // 0x0000(0x0050)
	TArray<struct FNiagaraLwcStructConverter>     LwcConverters;                                     // 0x0050(0x0010)
};
...
public:
	...
	struct FBoxSphereBounds                       Bounds;                                            // 0x0008(0x0038)
...
// 0x0004 (0x0004 - 0x0000)
struct FNDCIslandDebugDrawSettings final
{
public:
	uint8                                         bEnabled : 1;                                      // 0x0000(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bShowIslandBounds : 1;                             // 0x0000(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
};
...
public:
	...
	TArray<struct FNiagaraVariableBase>           Inputs;                                            // 0x0008(0x0010)
	TArray<struct FNiagaraVariableBase>           Outputs;                                           // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FNiagaraVariableBase>           SortedParameters;                                  // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FNDIDataChannelFunctionInfo>    FunctionInfo;                                      // 0x0000(0x0010)
	TMap<struct FNiagaraCompileHash, struct FNDIDataChannel_GPUScriptParameterAccessInfo> GPUScriptParameterInfos; // 0x0010(0x0050)
	uint32                                        TotalParams;                                       // 0x0060(0x0004)
	bool                                          bUsedByCPU;                                        // 0x0064(0x0001)
	bool                                          bUsedByGPU;                                        // 0x0065(0x0001)
	bool                                          bNeedsSpawnDataTable;                              // 0x0066(0x0001)
	bool                                          bSpawnsParticles;                                  // 0x0067(0x0001)
	bool                                          bCallsWrite;                                       // 0x0068(0x0001)
...
{
public:
	uint16                                        NumFloatComponents;                                // 0x0000(0x0002)
	uint16                                        NumInt32Components;                                // 0x0002(0x0002)
	uint16                                        NumHalfComponents;                                 // 0x0004(0x0002)
	uint8                                         Pad_6[0x2];                                        // 0x0006(0x0002)
	TArray<uint32>                                ComponentsOffsets;                                 // 0x0008(0x0010)
};
...
{
public:
	uint16                                        FloatComponentStart;                               // 0x0000(0x0002)
	uint16                                        Int32ComponentStart;                               // 0x0002(0x0002)
	uint16                                        HalfComponentStart;                                // 0x0004(0x0002)
	uint8                                         Pad_6[0x2];                                        // 0x0006(0x0002)
	struct FNiagaraTypeLayoutInfo                 LayoutInfo;                                        // 0x0008(0x0018)
};
...
{
public:
	TArray<struct FNiagaraVariableBase>           Variables;                                         // 0x0000(0x0010)
	TArray<struct FNiagaraVariableLayoutInfo>     VariableLayouts;                                   // 0x0010(0x0010)
	struct FNiagaraDataSetID                      ID;                                                // 0x0020(0x000C)
	uint32                                        TotalFloatComponents;                              // 0x002C(0x0004)
	uint32                                        TotalInt32Components;                              // 0x0030(0x0004)
	uint32                                        TotalHalfComponents;                               // 0x0034(0x0004)
	uint8                                         bRequiresPersistentIDs : 1;                        // 0x0038(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)
	ENiagaraSimTarget                             SimTarget;                                         // 0x003C(0x0001)
	uint8                                         Pad_3D[0xB];                                       // 0x003D(0x000B)
};
...
{
public:
	struct FNiagaraDataSetCompiledData            DataLayout;                                        // 0x0070(0x0048)
};
...
public:
	...
	struct FNiagaraVariableBase                   SourceVar;                                         // 0x0014(0x000C)
};
...
{
public:
	int32                                         NumElements;                                       // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	TArray<struct FNDIDataChannelWriteSimCacheFrameBuffer> VariableData;                             // 0x0008(0x0010)
...
public:
	...
	uint8                                         Pad_8[0x2];                                        // 0x0008(0x0002)
	uint8                                         bNewlyRegistered : 1;                              // 0x000A(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bNewlyRegisteredDirty : 1;                         // 0x000A(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bCulled : 1;                                       // 0x000A(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bPreviousCulled : 1;                               // 0x000A(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bCulledByDistance : 1;                             // 0x000A(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bCulledByInstanceCount : 1;                        // 0x000A(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bCulledByVisibility : 1;                           // 0x000A(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bCulledByGlobalBudget : 1;                         // 0x000A(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
...
{
public:
	int32                                         Offset;                                            // 0x000C(0x0004)
	struct FNiagaraLwcStructConverter             StructConverter;                                   // 0x0010(0x0018)
};
...
public:
	...
	TArray<struct FNiagaraVariableWithOffset>     SortedParameterOffsets;                            // 0x0010(0x0010)
	TArray<uint8>                                 ParameterData;                                     // 0x0020(0x0010)
	TArray<class UNiagaraDataInterface*>          DataInterfaces;                                    // 0x0030(0x0010)
	TArray<class UObject*>                        UObjects;                                          // 0x0040(0x0010)
	TArray<struct FNiagaraPositionSource>         OriginalPositionData;                              // 0x0050(0x0010)
	uint8                                         Pad_60[0x28];                                      // 0x0060(0x0028)
};
...
{
public:
	TMap<class FString, struct FNiagaraParameterStore> DebugParameterStores;                         // 0x0000(0x0050)
};
...
{
public:
	class FName                                   NumLoopsBinding;                                   // 0x0000(0x0008)
	int32                                         NumLoops;                                          // 0x0008(0x0004)
	int32                                         StartStageIndex;                                   // 0x000C(0x0004)
	int32                                         EndStageIndex;                                     // 0x0010(0x0004)
};
...
{
public:
	class FName                                   SectionIdentifier;                                 // 0x0000(0x0008)
	class FText                                   SectionDisplayName;                                // 0x0008(0x0010)
	TArray<class FText>                           Categories;                                        // 0x0018(0x0010)
	class FText                                   ToolTip;                                           // 0x0028(0x0010)
...
public:
	...
	struct FNiagaraVariableBase                   ParameterBinding;                                  // 0x000C(0x000C)
};
...
public:
	...
	struct FNiagaraVariableBase                   ParameterBinding;                                  // 0x0004(0x000C)
	int32                                         min_0;                                             // 0x0010(0x0004)
	int32                                         max_0;                                             // 0x0014(0x0004)
};
...
{
public:
	float                                         min_0;                                             // 0x0018(0x0004)
	float                                         max_0;                                             // 0x001C(0x0004)
};
...
{
public:
	struct FVector2f                              min_0;                                             // 0x0018(0x0008)
	struct FVector2f                              max_0;                                             // 0x0020(0x0008)
};
...
{
public:
	struct FVector3f                              min_0;                                             // 0x0018(0x000C)
	struct FVector3f                              max_0;                                             // 0x0024(0x000C)
};
...
{
public:
	struct FLinearColor                           min_0;                                             // 0x0018(0x0010)
	struct FLinearColor                           max_0;                                             // 0x0028(0x0010)
};
...
public:
	...
	struct FVector2f                              ValuesTimeRange;                                   // 0x0028(0x0008)
};
...
{
public:
	TArray<struct FVector2f>                      Values;                                            // 0x0018(0x0010)
	struct FVector2f                              ValuesTimeRange;                                   // 0x0028(0x0008)
};
...
{
public:
	TArray<struct FVector3f>                      Values;                                            // 0x0018(0x0010)
	struct FVector2f                              ValuesTimeRange;                                   // 0x0028(0x0008)
};
...
{
public:
	TArray<struct FLinearColor>                   Values;                                            // 0x0018(0x0010)
	struct FVector2f                              ValuesTimeRange;                                   // 0x0028(0x0008)
};
...
{
public:
	uint8                                         bXChannelEnabled : 1;                              // 0x0000(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bYChannelEnabled : 1;                              // 0x0000(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bZChannelEnabled : 1;                              // 0x0000(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bWChannelEnabled : 1;                              // 0x0000(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)
	struct FNiagaraDistributionFloat              XChannelDistribution;                              // 0x0008(0x0030)
	struct FNiagaraDistributionFloat              YChannelDistribution;                              // 0x0038(0x0030)
	struct FNiagaraDistributionFloat              ZChannelDistribution;                              // 0x0068(0x0030)
	struct FNiagaraDistributionFloat              WChannelDistribution;                              // 0x0098(0x0030)
};
...
public:
	...
	struct FNiagaraDistributionRangeInt           Amount;                                            // 0x0008(0x0018)
	struct FNiagaraDistributionRangeFloat         Rate;                                              // 0x0020(0x0020)
	uint8                                         bEnabled : 1;                                      // 0x0040(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bSpawnProbabilityEnabled : 1;                      // 0x0040(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)
	struct FNiagaraDistributionRangeFloat         SpawnProbability;                                  // 0x0048(0x0020)
};
...
{
public:
	uint8                                         bRunSpawnScript : 1;                               // 0x0000(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bRunUpdateScript : 1;                              // 0x0000(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bIgnoreSystemState : 1;                            // 0x0000(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bRecalculateDurationEachLoop : 1;                  // 0x0000(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bLoopDelayEnabled : 1;                             // 0x0000(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bDelayFirstLoopOnly : 1;                           // 0x0000(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bRecalculateDelayEachLoop : 1;                     // 0x0000(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	ENiagaraSystemInactiveResponse                InactiveResponse;                                  // 0x0004(0x0001)
	ENiagaraLoopBehavior                          LoopBehavior;                                      // 0x0005(0x0001)
	uint8                                         Pad_6[0x2];                                        // 0x0006(0x0002)
	struct FNiagaraDistributionRangeFloat         LoopDuration;                                      // 0x0008(0x0020)
	int32                                         LoopCount;                                         // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	struct FNiagaraDistributionRangeFloat         LoopDelay;                                         // 0x0030(0x0020)
};
...
{
public:
	ENiagaraEmitterInactiveResponse               InactiveResponse;                                  // 0x0000(0x0001)
	ENiagaraLoopBehavior                          LoopBehavior;                                      // 0x0001(0x0001)
	uint8                                         Pad_2[0x2];                                        // 0x0002(0x0002)
	int32                                         LoopCount;                                         // 0x0004(0x0004)
	ENiagaraLoopDurationMode                      LoopDurationMode;                                  // 0x0008(0x0001)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
	struct FNiagaraDistributionRangeFloat         LoopDuration;                                      // 0x0010(0x0020)
	struct FNiagaraDistributionRangeFloat         LoopDelay;                                         // 0x0030(0x0020)
	uint8                                         bLoopDelayEnabled : 1;                             // 0x0050(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bRecalculateDurationEachLoop : 1;                  // 0x0050(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bDelayFirstLoopOnly : 1;                           // 0x0050(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bRecalculateDelayEachLoop : 1;                     // 0x0050(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bEnableDistanceCulling : 1;                        // 0x0050(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bEnableVisibilityCulling : 1;                      // 0x0050(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bMinDistanceEnabled : 1;                           // 0x0050(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bMaxDistanceEnabled : 1;                           // 0x0050(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
	uint8                                         bResetAgeOnAwaken : 1;                             // 0x0051(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_52[0x2];                                       // 0x0052(0x0002)
	float                                         MinDistance;                                       // 0x0054(0x0004)
	ENiagaraExecutionStateManagement              MinDistanceReaction;                               // 0x0058(0x0004)
	float                                         MaxDistance;                                       // 0x005C(0x0004)
	ENiagaraExecutionStateManagement              MaxDistanceReaction;                               // 0x0060(0x0004)
	ENiagaraExecutionStateManagement              VisibilityCullReaction;                            // 0x0064(0x0004)
	float                                         VisibilityCullDelay;                               // 0x0068(0x0004)
...
{
public:
	class FName                                   InputName;                                         // 0x0000(0x0008)
	TArray<class FString>                         TargetValues;                                      // 0x0008(0x0010)
};
...
{
public:
	class FName                                   OverrideName;                                      // 0x0000(0x0008)
	class UTexture2D*                             IconOverride;                                      // 0x0008(0x0008)
	bool                                          bUseColorOverride;                                 // 0x0010(0x0001)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)
	struct FLinearColor                           ColorOverride;                                     // 0x0014(0x0010)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
};
...
public:
	...
	class FText                                   ToolTip;                                           // 0x0018(0x0010)
};
...
{
public:
	int32                                         EnumIndexToOverride;                               // 0x0000(0x0004)
	bool                                          bOverrideDisplayName;                              // 0x0004(0x0001)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)
	class FText                                   DisplayNameOverride;                               // 0x0008(0x0010)
...
public:
	...
	class FText                                   ToolTip;                                           // 0x0010(0x0010)
};
...
public:
	...
	TArray<struct FWidgetNamedInputValue>         InputDropdownValues;                               // 0x0018(0x0010)
	TArray<struct FNiagaraWidgetNamedIntegerInputValue> EnumStyleDropdownValues;                     // 0x0028(0x0010)
	int32                                         MaxSegmentsPerRow;                                 // 0x0038(0x0004)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
	TArray<struct FWidgetSegmentValueOverride>    SegmentValueOverrides;                             // 0x0040(0x0010)
...
public:
	...
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	class FName                                   OverrideNameTrue;                                  // 0x0004(0x0008)
	class FName                                   OverrideNameFalse;                                 // 0x000C(0x0008)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
...
public:
	...
	EUnit                                         DisplayUnit;                                       // 0x0010(0x0001)
	bool                                          bAdvancedDisplay;                                  // 0x0011(0x0001)
	bool                                          bDisplayInOverviewStack;                           // 0x0012(0x0001)
	uint8                                         Pad_13[0x1];                                       // 0x0013(0x0001)
	int32                                         InlineParameterSortPriority;                       // 0x0014(0x0004)
	bool                                          bOverrideColor;                                    // 0x0018(0x0001)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)
	struct FLinearColor                           InlineParameterColorOverride;                      // 0x001C(0x0010)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	TArray<struct FNiagaraEnumParameterMetaData>  InlineParameterEnumOverrides;                      // 0x0030(0x0010)
	bool                                          bEnableBoolOverride;                               // 0x0040(0x0001)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)
	struct FNiagaraBoolParameterMetaData          InlineParameterBoolOverride;                       // 0x0048(0x0028)
	bool                                          bInlineEditConditionToggle;                        // 0x0070(0x0001)
	uint8                                         Pad_71[0x7];                                       // 0x0071(0x0007)
	struct FNiagaraInputConditionMetadata         EditCondition;                                     // 0x0078(0x0018)
	struct FNiagaraInputConditionMetadata         VisibleCondition;                                  // 0x0090(0x0018)
	TMap<class FName, class FString>              PropertyMetaData;                                  // 0x00A8(0x0050)
	TArray<class FName>                           AlternateAliases;                                  // 0x00F8(0x0010)
	struct FNiagaraInputParameterCustomization    WidgetCustomization;                               // 0x0108(0x0058)
	struct FGuid                                  VariableGUID;                                      // 0x0160(0x0010)
	bool                                          bIsStaticSwitch;                                   // 0x0170(0x0001)
	uint8                                         Pad_171[0x3];                                      // 0x0171(0x0003)
	int32                                         StaticSwitchDefaultValue;                          // 0x0174(0x0004)
	class FText                                   CategoryName;                                      // 0x0178(0x0010)
	class FName                                   ParentAttribute;                                   // 0x0188(0x0008)
	int32                                         EditorSortPriority;                                // 0x0190(0x0004)
...
{
public:
	int32                                         NumTriangles;                                      // 0x0000(0x0004)
	int32                                         MaterialIndex;                                     // 0x0004(0x0004)
};
...
public:
	...
	struct FNiagaraUserParameterBinding           MaterialUserParamBinding;                          // 0x0008(0x0020)
};
...
{
public:
	int32                                         CpuBufferSize;                                     // 0x0000(0x0004)
	int32                                         CpuDataOffset;                                     // 0x0004(0x0004)
	int32                                         GpuBufferSize;                                     // 0x0008(0x0004)
	int32                                         GpuDataOffset;                                     // 0x000C(0x0004)
};
...
{
public:
	TArray<int32>                                 AllowedMaterialSlots;                              // 0x0000(0x0010)
};
...
{
public:
	class FName                                   GraphName;                                         // 0x0000(0x0008)
	class FName                                   RemapName;                                         // 0x0008(0x0008)
};
...
{
public:
	struct FMovieSceneBoolChannel                 BoolChannel;                                       // 0x0040(0x0108)
};
...
{
public:
	struct FMovieSceneFloatChannel                RedChannel;                                        // 0x0040(0x0110)
	struct FMovieSceneFloatChannel                GreenChannel;                                      // 0x0150(0x0110)
	struct FMovieSceneFloatChannel                BlueChannel;                                       // 0x0260(0x0110)
	struct FMovieSceneFloatChannel                AlphaChannel;                                      // 0x0370(0x0110)
};
...
{
public:
	struct FMovieSceneFloatChannel                FloatChannel;                                      // 0x0040(0x0110)
};
...
{
public:
	struct FMovieSceneIntegerChannel              IntegerChannel;                                    // 0x0040(0x0108)
};
...
{
public:
	struct FMovieSceneFloatChannel                VectorChannels[0x4];                               // 0x0040(0x0110)
	int32                                         ChannelsUsed;                                      // 0x0480(0x0004)
...
{
public:
	uint8                                         Pad_0[0xA0];                                       // 0x0000(0x00A0)
};
...
public:
	...
	class FName                                   SourceName;                                        // 0x0010(0x0008)
};
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FVector                                ViewportLocation;                                  // 0x0008(0x0018)
	struct FRotator                               ViewportRotation;                                  // 0x0020(0x0018)
...
{
public:
	class FName                                   OutputName;                                        // 0x0000(0x0008)
	struct FNiagaraBakerTextureSource             SourceBinding;                                     // 0x0008(0x0018)
	uint8                                         bUseFrameSize : 1;                                 // 0x0020(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_21[0x3];                                       // 0x0021(0x0003)
	struct FIntPoint                              FrameSize;                                         // 0x0024(0x0008)
	struct FIntPoint                              TextureSize;                                       // 0x002C(0x0008)
...
{
public:
	TArray<struct FNCPoolElement>                 FreeElements;                                      // 0x0000(0x0010)
};
...
{
public:
	struct FNiagaraVariableAttributeBinding       AttributeBinding;                                  // 0x0000(0x0038)
	class FName                                   PropertyName;                                      // 0x0038(0x0008)
	struct FNiagaraTypeDefinition                 PropertyType;                                      // 0x0040(0x0010)
	class FName                                   MetadataSetterName;                                // 0x0050(0x0008)
	TMap<class FString, class FString>            PropertySetterParameterDefaults;                   // 0x0058(0x0050)
};

// ScriptStruct Niagara.NiagaraCulledComponentInfo
// 0x0008 (0x0008 - 0x0000)
struct FNiagaraCulledComponentInfo final
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)
};
...
public:
	int32                                         NumElements;                                       // 0x0000(0x0004)
	int32                                         DataOffset;                                        // 0x0004(0x0004)
};
...
public:
	...
	class FName                                   EmitterName;                                       // 0x0004(0x0008)
};
...
{
public:
	int32                                         Tri;                                               // 0x0000(0x0004)
	struct FVector3f                              BaryCoord;                                         // 0x0004(0x000C)
};
...
public:
	...
	TArray<struct FVector>                        Scales;                                            // 0x0010(0x0010)
	TArray<struct FQuat>                          Rotations;                                         // 0x0020(0x0010)
	float                                         SplineLength;                                      // 0x0030(0x0004)
	float                                         SplineDistanceStep;                                // 0x0034(0x0004)
	float                                         InvSplineDistanceStep;                             // 0x0038(0x0004)
	int32                                         MaxIndex;                                          // 0x003C(0x0004)
};
...
{
public:
	class FString                                 EmitterName;                                       // 0x0000(0x0010)
	ENiagaraSimTarget                             SimTarget;                                         // 0x0010(0x0001)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)
	ENiagaraExecutionState                        ExecState;                                         // 0x0014(0x0004)
	int32                                         NumParticles;                                      // 0x0018(0x0004)
	uint8                                         bRequiresPersistentIDs : 1;                        // 0x001C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
{
public:
	class FString                                 ComponentName;                                     // 0x0000(0x0010)
	struct FVector3f                              LWCTile;                                           // 0x0010(0x000C)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	TArray<struct FNiagaraOutlinerEmitterInstanceData> Emitters;                                     // 0x0020(0x0010)
	ENiagaraExecutionState                        ActualExecutionState;                              // 0x0030(0x0004)
	ENiagaraExecutionState                        RequestedExecutionState;                           // 0x0034(0x0004)
	struct FNiagaraScalabilityState               ScalabilityState;                                  // 0x0038(0x000C)
	uint8                                         bPendingKill : 1;                                  // 0x0044(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bUsingCullProxy : 1;                               // 0x0044(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_45[0x3];                                       // 0x0045(0x0003)
	ENCPoolMethod                                 PoolMethod;                                        // 0x0048(0x0001)
	uint8                                         Pad_49[0x3];                                       // 0x0049(0x0003)
	struct FNiagaraOutlinerTimingData             AverageTime;                                       // 0x004C(0x0008)
	struct FNiagaraOutlinerTimingData             MaxTime;                                           // 0x0054(0x0008)
	ETickingGroup                                 TickGroup;                                         // 0x005C(0x0001)
	ENiagaraGpuComputeTickStage                   GpuTickStage;                                      // 0x005D(0x0001)
	uint8                                         Pad_5E[0x2];                                       // 0x005E(0x0002)
	uint8                                         bIsSolo : 1;                                       // 0x0060(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bRequiresGlobalDistanceField : 1;                  // 0x0060(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bRequiresDepthBuffer : 1;                          // 0x0060(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bRequiresEarlyViewData : 1;                        // 0x0060(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bRequiresViewUniformBuffer : 1;                    // 0x0060(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bRequiresRayTracingScene : 1;                      // 0x0060(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bRequiresCurrentFrameNDC : 1;                      // 0x0060(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
...
{
public:
	TArray<struct FNiagaraOutlinerSystemInstanceData> SystemInstances;                               // 0x0000(0x0010)
	struct FNiagaraOutlinerTimingData             AveragePerFrameTime;                               // 0x0010(0x0008)
	struct FNiagaraOutlinerTimingData             MaxPerFrameTime;                                   // 0x0018(0x0008)
	struct FNiagaraOutlinerTimingData             AveragePerInstanceTime;                            // 0x0020(0x0008)
	struct FNiagaraOutlinerTimingData             MaxPerInstanceTime;                                // 0x0028(0x0008)
};
...
{
public:
	TMap<class FString, struct FNiagaraOutlinerSystemData> Systems;                                  // 0x0000(0x0050)
	bool                                          bHasBegunPlay;                                     // 0x0050(0x0001)
	uint8                                         WorldType;                                         // 0x0051(0x0001)
	uint8                                         NetMode;                                           // 0x0052(0x0001)
	uint8                                         Pad_53[0x1];                                       // 0x0053(0x0001)
	struct FNiagaraOutlinerTimingData             AveragePerFrameTime;                               // 0x0054(0x0008)
	struct FNiagaraOutlinerTimingData             MaxPerFrameTime;                                   // 0x005C(0x0008)
...
{
public:
	TMap<class FString, struct FNiagaraOutlinerWorldData> WorldData;                                 // 0x0000(0x0050)
};
...
{
public:
	struct FNiagaraOutlinerData                   OutlinerData;                                      // 0x0000(0x0050)
};
...
public:
	...
	uint8                                         Pad_6[0x2];                                        // 0x0006(0x0002)
	struct FVector2D                              ScreenOffset;                                      // 0x0008(0x0010)
};
...
public:
	...
	bool                                          bValidationEnabled;                                // 0x0002(0x0001)
	bool                                          bOverviewEnabled;                                  // 0x0003(0x0001)
	ENiagaraDebugHUDOverviewMode                  OverviewMode;                                      // 0x0004(0x0004)
	ENiagaraDebugHUDDOverviewSort                 OverviewSortMode;                                  // 0x0008(0x0004)
	bool                                          bIncludeCascade;                                   // 0x000C(0x0001)
	bool                                          bShowRegisteredComponents;                         // 0x000D(0x0001)
	bool                                          bOverviewShowFilteredSystemOnly;                   // 0x000E(0x0001)
	bool                                          bShowGlobalBudgetInfo;                             // 0x000F(0x0001)
	bool                                          bSystemFilterEnabled;                              // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
	class FString                                 SystemFilter;                                      // 0x0018(0x0010)
	bool                                          bEmitterFilterEnabled;                             // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	class FString                                 EmitterFilter;                                     // 0x0030(0x0010)
	bool                                          bActorFilterEnabled;                               // 0x0040(0x0001)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)
	class FString                                 ActorFilter;                                       // 0x0048(0x0010)
	bool                                          bComponentFilterEnabled;                           // 0x0058(0x0001)
	uint8                                         Pad_59[0x7];                                       // 0x0059(0x0007)
	class FString                                 ComponentFilter;                                   // 0x0060(0x0010)
	bool                                          bValidateSystemSimulationDataBuffers;              // 0x0070(0x0001)
	bool                                          bValidateParticleDataBuffers;                      // 0x0071(0x0001)
	bool                                          bValidationLogErrors;                              // 0x0072(0x0001)
	uint8                                         Pad_73[0x1];                                       // 0x0073(0x0001)
	int32                                         ValidationAttributeDisplayTruncate;                // 0x0074(0x0004)
	ENiagaraDebugHudVerbosity                     SystemDebugVerbosity;                              // 0x0078(0x0004)
	ENiagaraDebugHudVerbosity                     SystemEmitterVerbosity;                            // 0x007C(0x0004)
	ENiagaraDebugHudVerbosity                     DataInterfaceVerbosity;                            // 0x0080(0x0004)
	uint8                                         Pad_84[0x4];                                       // 0x0084(0x0004)
	TArray<struct FNiagaraDebugHUDVariable>       SystemVariables;                                   // 0x0088(0x0010)
	bool                                          bSystemShowActiveOnlyInWorld;                      // 0x0098(0x0001)
	bool                                          bShowParticleVariables;                            // 0x0099(0x0001)
	uint8                                         Pad_9A[0x6];                                       // 0x009A(0x0006)
	TArray<struct FNiagaraDebugHUDVariable>       ParticlesVariables;                                // 0x00A0(0x0010)
	bool                                          bEnableGpuParticleReadback;                        // 0x00B0(0x0001)
	bool                                          bShowParticleIndex;                                // 0x00B1(0x0001)
	bool                                          bShowParticlesVariablesWithSystem;                 // 0x00B2(0x0001)
	bool                                          bShowParticleVariablesVertical;                    // 0x00B3(0x0001)
	bool                                          bUseMaxParticlesToDisplay;                         // 0x00B4(0x0001)
	uint8                                         Pad_B5[0x3];                                       // 0x00B5(0x0003)
	int32                                         MaxParticlesToDisplay;                             // 0x00B8(0x0004)
	bool                                          bUseParticleDisplayClip;                           // 0x00BC(0x0001)
	uint8                                         Pad_BD[0x3];                                       // 0x00BD(0x0003)
	struct FVector2D                              ParticleDisplayClip;                               // 0x00C0(0x0010)
	bool                                          bUseParticleDisplayCenterRadius;                   // 0x00D0(0x0001)
	uint8                                         Pad_D1[0x3];                                       // 0x00D1(0x0003)
	float                                         ParticleDisplayCenterRadius;                       // 0x00D4(0x0004)
	int32                                         PerfReportFrames;                                  // 0x00D8(0x0004)
	ENiagaraDebugHUDPerfSampleMode                PerfSampleMode;                                    // 0x00DC(0x0004)
	ENiagaraDebugHUDPerfUnits                     PerfUnits;                                         // 0x00E0(0x0004)
	bool                                          bShowPerfColumGameThreadOnly;                      // 0x00E4(0x0001)
	uint8                                         Pad_E5[0x3];                                       // 0x00E5(0x0003)
	ENiagaraDebugHUDPerfGraphMode                 PerfGraphMode;                                     // 0x00E8(0x0004)
	int32                                         PerfHistoryFrames;                                 // 0x00EC(0x0004)
	bool                                          bUsePerfGraphTimeRange;                            // 0x00F0(0x0001)
	uint8                                         Pad_F1[0x3];                                       // 0x00F1(0x0003)
	float                                         PerfGraphTimeRange;                                // 0x00F4(0x0004)
	struct FVector2D                              PerfGraphSize;                                     // 0x00F8(0x0010)
	struct FLinearColor                           PerfGraphAxisColor;                                // 0x0108(0x0010)
	int32                                         SmoothingWidth;                                    // 0x0118(0x0004)
	ENiagaraDebugHudFont                          OverviewFont;                                      // 0x011C(0x0004)
	struct FVector2D                              OverviewLocation;                                  // 0x0120(0x0010)
	struct FNiagaraDebugHudTextOptions            SystemTextOptions;                                 // 0x0130(0x0018)
	struct FNiagaraDebugHudTextOptions            ParticleTextOptions;                               // 0x0148(0x0018)
	bool                                          bDrawBoundsEnabled;                                // 0x0160(0x0001)
	bool                                          bDrawBoundsWireframe;                              // 0x0161(0x0001)
	uint8                                         Pad_162[0x2];                                      // 0x0162(0x0002)
	float                                         DrawBoundsAlpha;                                   // 0x0164(0x0004)
	struct FLinearColor                           DefaultBackgroundColor;                            // 0x0168(0x0010)
	struct FLinearColor                           OverviewHeadingColor;                              // 0x0178(0x0010)
	struct FLinearColor                           OverviewDetailColor;                               // 0x0188(0x0010)
	struct FLinearColor                           OverviewDetailHighlightColor;                      // 0x0198(0x0010)
	struct FLinearColor                           InWorldErrorTextColor;                             // 0x01A8(0x0010)
	struct FLinearColor                           InWorldTextColor;                                  // 0x01B8(0x0010)
	struct FLinearColor                           MessageInfoTextColor;                              // 0x01C8(0x0010)
	struct FLinearColor                           MessageWarningTextColor;                           // 0x01D8(0x0010)
	struct FLinearColor                           MessageErrorTextColor;                             // 0x01E8(0x0010)
	float                                         SystemColorTableOpacity;                           // 0x01F8(0x0004)
	uint32                                        SystemColorSeed;                                   // 0x01FC(0x0004)
	struct FVector                                SystemColorHSVMin;                                 // 0x0200(0x0018)
	struct FVector                                SystemColorHSVMax;                                 // 0x0218(0x0018)
	ENiagaraDebugPlaybackMode                     PlaybackMode;                                      // 0x0230(0x0001)
	bool                                          bPlaybackRateEnabled;                              // 0x0231(0x0001)
	uint8                                         Pad_232[0x2];                                      // 0x0232(0x0002)
	float                                         PlaybackRate;                                      // 0x0234(0x0004)
	bool                                          bLoopTimeEnabled;                                  // 0x0238(0x0001)
	uint8                                         Pad_239[0x3];                                      // 0x0239(0x0003)
	float                                         LoopTime;                                          // 0x023C(0x0004)
};
...
public:
	...
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	uint32                                        CaptureDelayFrames;                                // 0x0004(0x0004)
	bool                                          bGatherPerfData;                                   // 0x0008(0x0001)
	uint8                                         Pad_9[0x3];                                        // 0x0009(0x0003)
	uint32                                        SimCacheCaptureFrames;                             // 0x000C(0x0004)
};
...
{
public:
	TArray<class FString>                         Systems;                                           // 0x0000(0x0010)
	TArray<class FString>                         Actors;                                            // 0x0010(0x0010)
	TArray<class FString>                         Components;                                        // 0x0020(0x0010)
	TArray<class FString>                         Emitters;                                          // 0x0030(0x0010)
};
...
{
public:
	class FName                                   ComponentName;                                     // 0x0000(0x0008)
	uint32                                        CaptureDelayFrames;                                // 0x0008(0x0004)
	uint32                                        CaptureFrames;                                     // 0x000C(0x0004)
};
...
public:
	class FName                                   ComponentName;                                     // 0x0000(0x0008)
	TArray<uint8>                                 SimCacheData;                                      // 0x0008(0x0010)
};
...
{
public:
	struct FVector2D                              Location;                                          // 0x0000(0x0010)
...
{
public:
	uint8                                         bCullByGlobalBudget : 1;                           // 0x0000(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bScaleMaxDistanceByGlobalBudgetUse : 1;            // 0x0000(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bScaleMaxInstanceCountByGlobalBudgetUse : 1;       // 0x0000(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bScaleSystemInstanceCountByGlobalBudgetUse : 1;    // 0x0000(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	float                                         MaxGlobalBudgetUsage;                              // 0x0004(0x0004)
	struct FNiagaraLinearRamp                     MaxDistanceScaleByGlobalBudgetUse;                 // 0x0008(0x0010)
	struct FNiagaraLinearRamp                     MaxInstanceCountScaleByGlobalBudgetUse;            // 0x0018(0x0010)
	struct FNiagaraLinearRamp                     MaxSystemInstanceCountScaleByGlobalBudgetUse;      // 0x0028(0x0010)
};
...
{
public:
	uint8                                         bCullWhenNotRendered : 1;                          // 0x0000(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bCullByViewFrustum : 1;                            // 0x0000(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bAllowPreCullingByViewFrustum : 1;                 // 0x0000(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
...
public:
	...
	uint32                                        QualityLevelMask;                                  // 0x0008(0x0004)
	uint32                                        SetQualityLevelMask;                               // 0x000C(0x0004)
};

// ScriptStruct Niagara.NiagaraPlatformSetCVarCondition
// 0x0030 (0x0030 - 0x0000)
struct FNiagaraPlatformSetCVarCondition final
{
public:
	class FName                                   CVarName;                                          // 0x0000(0x0008)
	...
	uint8                                         Pad_B[0x1];                                        // 0x000B(0x0001)
	int32                                         MinInt;                                            // 0x000C(0x0004)
	int32                                         MaxInt;                                            // 0x0010(0x0004)
	float                                         MinFloat;                                          // 0x0014(0x0004)
	float                                         MaxFloat;                                          // 0x0018(0x0004)
	uint8                                         bUseMinInt : 1;                                    // 0x001C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bUseMaxInt : 1;                                    // 0x001C(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bUseMinFloat : 1;                                  // 0x001C(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bUseMaxFloat : 1;                                  // 0x001C(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         Pad_1D[0x13];                                      // 0x001D(0x0013)
};
...
{
public:
	TArray<struct FNiagaraDeviceProfileStateEntry> DeviceProfileStates;                              // 0x0000(0x0010)
	TArray<struct FNiagaraPlatformSetCVarCondition> CVarConditions;                                  // 0x0010(0x0010)
	int32                                         QualityLevelMask;                                  // 0x0020(0x0004)
...
{
public:
	struct FNiagaraPlatformSet                    Platforms;                                         // 0x0000(0x0030)
	uint8                                         bCullByDistance : 1;                               // 0x0030(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bCullMaxInstanceCount : 1;                         // 0x0030(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bCullPerSystemMaxInstanceCount : 1;                // 0x0030(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         Pad_31[0x3];                                       // 0x0031(0x0003)
	float                                         MaxDistance;                                       // 0x0034(0x0004)
	uint8                                         bCullByMaxTimeWithoutRender : 1;                   // 0x0038(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)
	int32                                         MaxInstances;                                      // 0x003C(0x0004)
	int32                                         MaxSystemInstances;                                // 0x0040(0x0004)
	float                                         MaxTimeWithoutRender;                              // 0x0044(0x0004)
	ENiagaraCullProxyMode                         CullProxyMode;                                     // 0x0048(0x0004)
	int32                                         MaxSystemProxies;                                  // 0x004C(0x0004)
	struct FNiagaraSystemVisibilityCullingSettings VisibilityCulling;                                // 0x0050(0x000C)
	struct FNiagaraGlobalBudgetScaling            BudgetScaling;                                     // 0x005C(0x0038)
...
{
public:
	TArray<struct FNiagaraSystemScalabilitySettings> Settings;                                       // 0x0000(0x0010)
};
...
{
public:
	uint8                                         bOverrideDistanceSettings : 1;                     // 0x0098(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverrideInstanceCountSettings : 1;                // 0x0098(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bOverridePerSystemInstanceCountSettings : 1;       // 0x0098(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bOverrideVisibilitySettings : 1;                   // 0x0098(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bOverrideGlobalBudgetScalingSettings : 1;          // 0x0098(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bOverrideCullProxySettings : 1;                    // 0x0098(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
...
public:
	struct FNiagaraPlatformSet                    Platforms;                                         // 0x0000(0x0030)
	uint8                                         bScaleSpawnCount : 1;                              // 0x0030(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_31[0x3];                                       // 0x0031(0x0003)
...
{
public:
	TArray<struct FNiagaraEmitterScalabilitySettings> Settings;                                      // 0x0000(0x0010)
};
...
{
public:
	uint8                                         bOverrideSpawnCountScale : 1;                      // 0x0038(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
};
...
{
public:
	TArray<struct FNiagaraEmitterScalabilityOverride> Overrides;                                     // 0x0000(0x0010)
};
...
public:
	class FName                                   Name;                                              // 0x0000(0x0008)
	class FName                                   SourceEventGenerator;                              // 0x0008(0x0008)
	class FName                                   SourceEmitter;                                     // 0x0010(0x0008)
};
...
{
public:
	int32                                         MaxEventsPerFrame;                                 // 0x0000(0x0004)
	class FName                                   ID;                                                // 0x0004(0x0008)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FNiagaraDataSetCompiledData            DataSetCompiledData;                               // 0x0010(0x0048)
};
...
public:
	...
	TArray<struct FNiagaraEventReceiverProperties> EventReceivers;                                   // 0x0008(0x0010)
	TArray<struct FNiagaraEventGeneratorProperties> EventGenerators;                                 // 0x0018(0x0010)
};
...
public:
	...
	uint8                                         Pad_29[0x3];                                       // 0x0029(0x0003)
	uint32                                        SpawnNumber;                                       // 0x002C(0x0004)
	uint32                                        MaxEventsPerFrame;                                 // 0x0030(0x0004)
	struct FGuid                                  SourceEmitterID;                                   // 0x0034(0x0010)
	class FName                                   SourceEventName;                                   // 0x0044(0x0008)
	bool                                          bRandomSpawnNumber;                                // 0x004C(0x0001)
	uint8                                         Pad_4D[0x3];                                       // 0x004D(0x0003)
	uint32                                        MinSpawnNumber;                                    // 0x0050(0x0004)
...
{
public:
	int32                                         MajorVersion;                                      // 0x0000(0x0004)
	int32                                         MinorVersion;                                      // 0x0004(0x0004)
	struct FGuid                                  VersionGuid;                                       // 0x0008(0x0010)
...
{
public:
	struct FNiagaraAssetVersion                   Version;                                           // 0x0000(0x001C)
	bool                                          bDeprecated;                                       // 0x001C(0x0001)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)
	class FText                                   DeprecationMessage;                                // 0x0020(0x0010)
	bool                                          bLocalSpace;                                       // 0x0030(0x0001)
	bool                                          bDeterminism;                                      // 0x0031(0x0001)
	uint8                                         Pad_32[0x2];                                       // 0x0032(0x0002)
	int32                                         RandomSeed;                                        // 0x0034(0x0004)
	uint8                                         bInterpolatedSpawning : 1;                         // 0x0038(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)
	ENiagaraSimTarget                             SimTarget;                                         // 0x003C(0x0001)
	ENiagaraEmitterCalculateBoundMode             CalculateBoundsMode;                               // 0x003D(0x0001)
	uint8                                         Pad_3E[0x2];                                       // 0x003E(0x0002)
	struct FBox                                   FixedBounds;                                       // 0x0040(0x0038)
	uint8                                         bRequiresPersistentIDs : 1;                        // 0x0078(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_79[0x7];                                       // 0x0079(0x0007)
	TArray<struct FNiagaraEventScriptProperties>  EventHandlerScriptProps;                           // 0x0080(0x0010)
	struct FNiagaraPlatformSet                    Platforms;                                         // 0x0090(0x0030)
	struct FNiagaraEmitterScalabilityOverrides    ScalabilityOverrides;                              // 0x00C0(0x0010)
	int32                                         MaxGPUParticlesSpawnPerFrame;                      // 0x00D0(0x0004)
	EParticleAllocationMode                       AllocationMode;                                    // 0x00D4(0x0001)
	uint8                                         Pad_D5[0x3];                                       // 0x00D5(0x0003)
	int32                                         PreAllocationCount;                                // 0x00D8(0x0004)
	uint8                                         Pad_DC[0x4];                                       // 0x00DC(0x0004)
	TArray<struct FNiagaraDataInterfaceEmitterBinding> EmitterDependencies;                          // 0x00E0(0x0010)
	struct FNiagaraEmitterScriptProperties        UpdateScriptProps;                                 // 0x00F0(0x0028)
	struct FNiagaraEmitterScriptProperties        SpawnScriptProps;                                  // 0x0118(0x0028)
	struct FNiagaraParameterStore                 RendererBindings;                                  // 0x0140(0x0088)
	TArray<struct FNiagaraExternalUObjectInfo>    RendererBindingsExternalObjects;                   // 0x01C8(0x0010)
	TMap<struct FNiagaraVariableBase, struct FNiagaraVariableBase> ResolvedDIBindings;               // 0x01D8(0x0050)
	TArray<class UNiagaraRendererProperties*>     RendererProperties;                                // 0x0228(0x0010)
	TArray<class UNiagaraSimulationStageBase*>    SimulationStages;                                  // 0x0238(0x0010)
	TArray<struct FNiagaraSimStageExecutionLoopData> SimStageExecutionLoops;                         // 0x0248(0x0010)
	uint8                                         Pad_258[0x10];                                     // 0x0258(0x0010)
	class UNiagaraScript*                         GPUComputeScript;                                  // 0x0268(0x0008)
	TArray<class FName>                           SharedEventGeneratorIds;                           // 0x0270(0x0010)
	struct FNiagaraEmitterScalabilitySettings     CurrentScalabilitySettings;                        // 0x0280(0x0038)
	uint8                                         Pad_2B8[0xB0];                                     // 0x02B8(0x00B0)
};
...
public:
	...
	struct FGuid                                  Version;                                           // 0x0008(0x0010)
};
...
public:
	...
	class FName                                   IdName;                                            // 0x0018(0x0008)
	bool                                          bIsEnabled;                                        // 0x0020(0x0001)
	ENiagaraEmitterMode                           EmitterMode;                                       // 0x0021(0x0001)
	uint8                                         Pad_22[0x6];                                       // 0x0022(0x0006)
	struct FVersionedNiagaraEmitter               VersionedInstance;                                 // 0x0028(0x0018)
...
{
public:
	struct FVector                                CollisionPos;                                      // 0x0000(0x0018)
	struct FVector                                CollisionNormal;                                   // 0x0018(0x0018)
	struct FVector                                CollisionVelocity;                                 // 0x0030(0x0018)
	int32                                         ParticleIndex;                                     // 0x0048(0x0004)
	int32                                         PhysicalMaterialIndex;                             // 0x004C(0x0004)
};
...
public:
	...
	struct FNiagaraUserParameterBinding           UserParamBinding;                                  // 0x0008(0x0020)
};
...
public:
	...
	struct FNiagaraParameterBinding               MeshParameterBinding;                              // 0x0008(0x000C)
	ENiagaraMeshLODMode                           LODMode;                                           // 0x0014(0x0001)
	uint8                                         Pad_15[0x3];                                       // 0x0015(0x0003)
	int32                                         LODLevel;                                          // 0x0018(0x0004)
	int32                                         LODBias;                                           // 0x001C(0x0004)
	float                                         LODDistanceFactor;                                 // 0x0020(0x0004)
	bool                                          bUseLODRange;                                      // 0x0024(0x0001)
	uint8                                         Pad_25[0x3];                                       // 0x0025(0x0003)
	struct FIntVector2                            LODRange;                                          // 0x0028(0x0008)
	struct FVector                                Scale;                                             // 0x0030(0x0018)
	struct FRotator                               Rotation;                                          // 0x0048(0x0018)
	struct FVector                                PivotOffset;                                       // 0x0060(0x0018)
...
{
public:
	TArray<struct FNiagaraVariable>               Parameters;                                        // 0x0000(0x0010)
};
...
{
public:
	struct FNiagaraVariableBase                   Parameter;                                         // 0x0000(0x000C)
	int32                                         SrcOffset;                                         // 0x000C(0x0004)
	int32                                         DestOffset;                                        // 0x0010(0x0004)
};
...
public:
	class FName                                   ProfileName;                                       // 0x0000(0x0008)
	int32                                         QualityLevelMask;                                  // 0x0008(0x0004)
};
...
{
public:
	int32                                         SetAIndex;                                         // 0x0000(0x0004)
	int32                                         SetBIndex;                                         // 0x0004(0x0004)
	TArray<struct FNiagaraPlatformSetConflictEntry> Conflicts;                                       // 0x0008(0x0010)
};
...
public:
	...
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)
	class FName                                   RedirectProfileName;                               // 0x0014(0x0008)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	struct FNiagaraPlatformSetCVarCondition       CVarConditionEnabled;                              // 0x0020(0x0030)
	struct FNiagaraPlatformSetCVarCondition       CVarConditionDisabled;                             // 0x0050(0x0030)
};
...
public:
	class FName                                   MaterialParameterName;                             // 0x0000(0x0008)
	class FName                                   StaticVariableName;                                // 0x0008(0x0008)
};
...
{
public:
	TArray<struct FNiagaraMaterialAttributeBinding> AttributeBindings;                               // 0x0000(0x0010)
	TArray<struct FNiagaraRendererMaterialScalarParameter> ScalarParameters;                         // 0x0010(0x0010)
	TArray<struct FNiagaraRendererMaterialVectorParameter> VectorParameters;                         // 0x0020(0x0010)
	TArray<struct FNiagaraRendererMaterialTextureParameter> TextureParameters;                       // 0x0030(0x0010)
	TArray<struct FNiagaraRendererMaterialStaticBoolParameter> StaticBoolParameters;                 // 0x0040(0x0010)
};
...
{
public:
	struct FVector2f                              position;                                          // 0x0000(0x0008)
	struct FVector2f                              Normal;                                            // 0x0008(0x0008)
...
public:
	...
	uint8                                         bEnablePerParticleUOverride : 1;                   // 0x0003(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bEnablePerParticleVRangeOverride : 1;              // 0x0003(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	float                                         TilingLength;                                      // 0x0004(0x0004)
	struct FVector2D                              Offset;                                            // 0x0008(0x0010)
...
public:
	...
	uint8                                         Pad_18[0xC8];                                      // 0x0018(0x00C8)
};
...
public:
	...
	class FString                                 RequiredVersion;                                   // 0x0010(0x0010)
	int32                                         OnlyEvaluateInScriptUsage;                         // 0x0020(0x0004)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
...
public:
	struct FNiagaraVariable                       Variable;                                          // 0x0000(0x0020)
	class FString                                 StringValue;                                       // 0x0020(0x0010)
};
...
{
public:
	struct FGuid                                  CompilerVersionID;                                 // 0x0000(0x0010)
	ENiagaraScriptUsage                           ScriptUsageType;                                   // 0x0010(0x0001)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)
	struct FGuid                                  ScriptUsageTypeID;                                 // 0x0014(0x0010)
	uint8                                         bUsesRapidIterationParams : 1;                     // 0x0024(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bDisableDebugSwitches : 1;                         // 0x0024(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bInterpolatedSpawn : 1;                            // 0x0024(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bRequiresPersistentIDs : 1;                        // 0x0024(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         Pad_25[0x3];                                       // 0x0025(0x0003)
	struct FGuid                                  BaseScriptID;                                      // 0x0028(0x0010)
	struct FNiagaraCompileHash                    BaseScriptCompileHash;                             // 0x0038(0x0010)
	struct FGuid                                  ScriptVersionID;                                   // 0x0048(0x0010)
};
...
public:
	...
	struct FNiagaraVMExecutableByteCode           OptimizedByteCode;                                 // 0x0018(0x0018)
	uint8                                         Pad_30[0x38];                                      // 0x0030(0x0038)
	int32                                         NumTempRegisters;                                  // 0x0068(0x0004)
	int32                                         NumUserPtrs;                                       // 0x006C(0x0004)
	TArray<struct FNiagaraCompilerTag>            CompileTags;                                       // 0x0070(0x0010)
	TArray<uint8>                                 ScriptLiterals;                                    // 0x0080(0x0010)
	TArray<struct FNiagaraVariableBase>           Attributes;                                        // 0x0090(0x0010)
	struct FNiagaraScriptDataUsageInfo            DataUsage;                                         // 0x00A0(0x0001)
	uint8                                         Pad_A1[0x7];                                       // 0x00A1(0x0007)
	TArray<struct FNiagaraScriptUObjectCompileInfo> UObjectInfos;                                    // 0x00A8(0x0010)
	TArray<struct FNiagaraScriptDataInterfaceCompileInfo> DataInterfaceInfo;                         // 0x00B8(0x0010)
	TArray<struct FVMExternalFunctionBindingInfo> CalledVMExternalFunctions;                         // 0x00C8(0x0010)
	uint8                                         Pad_D8[0x10];                                      // 0x00D8(0x0010)
	TArray<struct FNiagaraDataSetID>              ReadDataSets;                                      // 0x00E8(0x0010)
	TArray<struct FNiagaraDataSetProperties>      WriteDataSets;                                     // 0x00F8(0x0010)
	TArray<struct FNiagaraStatScope>              StatScopes;                                        // 0x0108(0x0010)
	struct FNiagaraShaderScriptParametersMetadata ShaderScriptParametersMetadata;                    // 0x0118(0x0058)
	ENiagaraScriptCompileStatus                   LastCompileStatus;                                 // 0x0170(0x0001)
	uint8                                         Pad_171[0x7];                                      // 0x0171(0x0007)
	TArray<struct FSimulationStageMetaData>       SimulationStageMetaData;                           // 0x0178(0x0010)
	TArray<uint8>                                 ExperimentalContextData;                           // 0x0188(0x0010)
	uint8                                         bReadsSignificanceIndex : 1;                       // 0x0198(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bNeedsGPUContextInit : 1;                          // 0x0198(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
...
{
public:
	uint16                                        SrcOffset;                                         // 0x0000(0x0002)
	uint16                                        DestOffset;                                        // 0x0002(0x0002)
	uint16                                        SrcSize;                                           // 0x0004(0x0002)
	uint16                                        DestSize;                                          // 0x0006(0x0002)
};
...
{
public:
	int32                                         ParameterSize;                                     // 0x0088(0x0004)
	uint8                                         bInitialized : 1;                                  // 0x008C(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
{
public:
	uint32                                        NumInstances;                                      // 0x0000(0x0004)
	uint32                                        IDAcquireTag;                                      // 0x0004(0x0004)
	uint32                                        IDToIndexTableElements;                            // 0x0008(0x0004)
	uint8                                         Pad_C[0x8C];                                       // 0x000C(0x008C)
};
...
public:
	...
	int32                                         TotalSpawnedParticles;                             // 0x0038(0x0004)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
	struct FNiagaraSimCacheDataBuffers            ParticleDataBuffers;                               // 0x0040(0x0098)
};
...
public:
	struct FBox                                   LocalBounds;                                       // 0x0000(0x0038)
	struct FNiagaraSimCacheDataBuffers            SystemDataBuffers;                                 // 0x0038(0x0098)
};
...
{
public:
	struct FTransform                             LocalToWorld;                                      // 0x0000(0x0060)
	struct FVector3f                              LWCTile;                                           // 0x0060(0x000C)
	float                                         SimulationAge;                                     // 0x006C(0x0004)
	int32                                         SimulationTickCount;                               // 0x0070(0x0004)
	uint8                                         Pad_74[0x4];                                       // 0x0074(0x0004)
	struct FNiagaraSimCacheSystemFrame            SystemData;                                        // 0x0078(0x00D0)
	TArray<struct FNiagaraSimCacheEmitterFrame>   EmitterData;                                       // 0x0148(0x0010)
...
public:
	struct FNiagaraVariableBase                   Variable;                                          // 0x0000(0x000C)
	uint16                                        FloatOffset;                                       // 0x000C(0x0002)
	uint16                                        FloatCount;                                        // 0x000E(0x0002)
	uint16                                        HalfOffset;                                        // 0x0010(0x0002)
	uint16                                        HalfCount;                                         // 0x0012(0x0002)
	uint16                                        Int32Offset;                                       // 0x0014(0x0002)
	uint16                                        Int32Count;                                        // 0x0016(0x0002)
};
...
{
public:
	class FName                                   LayoutName;                                        // 0x0000(0x0008)
	ENiagaraSimTarget                             SimTarget;                                         // 0x0008(0x0001)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
	TArray<struct FNiagaraSimCacheVariable>       Variables;                                         // 0x0010(0x0010)
	uint16                                        FloatCount;                                        // 0x0020(0x0002)
	uint16                                        HalfCount;                                         // 0x0022(0x0002)
	uint16                                        Int32Count;                                        // 0x0024(0x0002)
	bool                                          bLocalSpace;                                       // 0x0026(0x0001)
	bool                                          bAllowInterpolation;                               // 0x0027(0x0001)
	bool                                          bAllowVelocityExtrapolation;                       // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	TArray<class FName>                           RebaseVariableNames;                               // 0x0030(0x0010)
	TArray<class FName>                           InterpVariableNames;                               // 0x0040(0x0010)
	uint16                                        ComponentVelocity;                                 // 0x0050(0x0002)
	uint8                                         Pad_52[0x66];                                      // 0x0052(0x0066)
};
...
{
public:
	struct FNiagaraSimCacheDataBuffersLayout      SystemLayout;                                      // 0x0000(0x00B8)
	TArray<struct FNiagaraSimCacheDataBuffersLayout> EmitterLayouts;                                 // 0x00B8(0x0010)
};
...
{
public:
	TArray<class FName>                           SpawnAttributes;                                   // 0x0000(0x0010)
	...
	struct FNiagaraDataSetCompiledData            DataSetCompiledData;                               // 0x00F0(0x0048)
};
...
{
public:
	int32                                         ParameterOffset;                                   // 0x0000(0x0004)
	int32                                         DataSetComponentOffset;                            // 0x0004(0x0004)
};
...
{
public:
	TArray<struct FNiagaraParameterDataSetBinding> FloatOffsets;                                     // 0x0000(0x0010)
	TArray<struct FNiagaraParameterDataSetBinding> Int32Offsets;                                     // 0x0010(0x0010)
};
...
public:
	...
	struct FNiagaraDataSetCompiledData            DataSetCompiledData;                               // 0x0088(0x0048)
	struct FNiagaraDataSetCompiledData            SpawnInstanceParamsDataSetCompiledData;            // 0x00D0(0x0048)
	struct FNiagaraDataSetCompiledData            UpdateInstanceParamsDataSetCompiledData;           // 0x0118(0x0048)
	struct FNiagaraParameterDataSetBindingCollection SpawnInstanceGlobalBinding;                     // 0x0160(0x0020)
	struct FNiagaraParameterDataSetBindingCollection SpawnInstanceSystemBinding;                     // 0x0180(0x0020)
	struct FNiagaraParameterDataSetBindingCollection SpawnInstanceOwnerBinding;                      // 0x01A0(0x0020)
	TArray<struct FNiagaraParameterDataSetBindingCollection> SpawnInstanceEmitterBindings;           // 0x01C0(0x0010)
	struct FNiagaraParameterDataSetBindingCollection UpdateInstanceGlobalBinding;                    // 0x01D0(0x0020)
	struct FNiagaraParameterDataSetBindingCollection UpdateInstanceSystemBinding;                    // 0x01F0(0x0020)
	struct FNiagaraParameterDataSetBindingCollection UpdateInstanceOwnerBinding;                     // 0x0210(0x0020)
	TArray<struct FNiagaraParameterDataSetBindingCollection> UpdateInstanceEmitterBindings;          // 0x0230(0x0010)
};
...
{
public:
	TArray<struct FNiagaraSystemScalabilityOverride> Overrides;                                      // 0x0000(0x0010)
};
...
{
public:
	uint16                                        X;                                                 // 0x0000(0x0002)
	uint16                                        Y;                                                 // 0x0002(0x0002)
};
...
{
public:
	struct FVector4f                              Row0;                                              // 0x0000(0x0010)
	struct FVector4f                              Row1;                                              // 0x0010(0x0010)
	struct FVector4f                              Row2;                                              // 0x0020(0x0010)
	struct FVector4f                              Row3;                                              // 0x0030(0x0010)
};
...
public:
	...
	int32                                         SpawnGroup;                                        // 0x000C(0x0004)
};
...
public:
	...
	int32                                         AcquireTag;                                        // 0x0004(0x0004)
};
...
{
public:
	int32                                         Seed1;                                             // 0x0000(0x0004)
	int32                                         Seed2;                                             // 0x0004(0x0004)
	int32                                         Seed3;                                             // 0x0008(0x0004)
};
