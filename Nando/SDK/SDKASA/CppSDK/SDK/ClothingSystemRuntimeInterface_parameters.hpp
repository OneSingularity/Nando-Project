...
{
public:
	float                                         InStiffness;                                       // 0x0000(0x0004)
};
...
{
public:
	int32                                         MaxNumIterations;                                  // 0x0000(0x0004)
};
...
{
public:
	int32                                         NumSubsteps;                                       // 0x0000(0x0004)
};
...
{
public:
	class FString                                 ClothingAssetName;                                 // 0x0000(0x0010)
	class UClothingInteractor*                    ReturnValue;                                       // 0x0010(0x0008)
};
