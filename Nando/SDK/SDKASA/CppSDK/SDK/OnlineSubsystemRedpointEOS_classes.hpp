...
{
public:
	uint8                                         Pad_88[0x220];                                     // 0x0088(0x0220)
...
{
public:
	uint8                                         Pad_1F18[0x10];                                    // 0x1F18(0x0010)
...
{
public:
	uint8                                         Pad_960[0x78];                                     // 0x0960(0x0078)
	TArray<class UEOSNetConnection*>              PendingConnectionClose;                            // 0x09D8(0x0010)
...
{
public:
	TMulticastInlineDelegate<void(class UUserWidget* Widget)> OnAddWidgetToViewport;                 // 0x0030(0x0010)
	TMulticastInlineDelegate<void(class UUserWidget* Widget)> OnRemoveWidgetFromViewport;            // 0x0040(0x0010)
...
{
public:
	uint8                                         Pad_30[0x60];                                      // 0x0030(0x0060)
