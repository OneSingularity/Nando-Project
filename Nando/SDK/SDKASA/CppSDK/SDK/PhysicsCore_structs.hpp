...
public:
	...
	uint8                                         bSimulatePhysics : 1;                              // 0x0008(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bOverrideMass : 1;                                 // 0x0008(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bEnableGravity : 1;                                // 0x0008(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bUpdateKinematicFromSimulation : 1;                // 0x0008(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bAutoWeld : 1;                                     // 0x0008(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bStartAwake : 1;                                   // 0x0008(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bGenerateWakeEvents : 1;                           // 0x0008(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         bUpdateMassWhenScaleChanges : 1;                   // 0x0008(0x0001)(BitIndex: 0x07, PropSize: 0x0001)
