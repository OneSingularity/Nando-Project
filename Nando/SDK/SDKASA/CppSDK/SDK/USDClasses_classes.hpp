...
{
public:
	TMap<class FString, class UObject*>           TransientStorage;                                  // 0x0028(0x0050)
	TMap<class FString, class UObject*>           PersistentStorage;                                 // 0x0078(0x0050)
	bool                                          bAllowPersistentStorage;                           // 0x00C8(0x0001)
	uint8                                         Pad_C9[0x7];                                       // 0x00C9(0x0007)
	TSet<TWeakObjectPtr<class UObject>>           OwnedAssets;                                       // 0x00D0(0x0050)
	TMap<class FString, TWeakObjectPtr<class UObject>> PrimPathToAssets;                             // 0x0120(0x0050)
	uint8                                         Pad_170[0x78];                                     // 0x0170(0x0078)
...
{
public:
	double                                        UnreferencedAssetStorageSizeMB;                    // 0x0028(0x0008)
	double                                        PersistentAssetStorageSizeMB;                      // 0x0030(0x0008)
	TMap<class FString, class UObject*>           AssetStorage;                                      // 0x0038(0x0050)
	uint8                                         Pad_88[0x118];                                     // 0x0088(0x0118)
...
{
public:
	struct FDirectoryPath                         AssetDirectory;                                    // 0x0028(0x0010)
	bool                                          bOnlyHandleAssetsWithinAssetDirectory;             // 0x0038(0x0001)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
	TMap<class FString, struct FSoftObjectPath>   HashToAssetPaths;                                  // 0x0040(0x0050)
	bool                                          bCleanUpUnreferencedAssets;                        // 0x0090(0x0001)
	uint8                                         Pad_91[0x7];                                       // 0x0091(0x0007)
	TMap<struct FSoftObjectPath, class FString>   AssetPathToHashes;                                 // 0x0098(0x0050)
	TMap<class FString, class UObject*>           TransientObjectStorage;                            // 0x00E8(0x0050)
	uint8                                         Pad_138[0x158];                                    // 0x0138(0x0158)
...
{
public:
	class FString                                 PrimPath;                                          // 0x0028(0x0010)
	class UObject*                                ImportOptions;                                     // 0x0038(0x0008)
...
{
public:
	float                                         LayerStartOffsetSeconds;                           // 0x0040(0x0004)
...
{
public:
	TMap<int32, struct FUsdPrimPathList>          MaterialSlotToPrimPaths;                           // 0x0040(0x0050)
...
{
public:
	TArray<class FString>                         PrimPaths;                                         // 0x0028(0x0010)
	TMap<class FString, struct FUsdCombinedPrimMetadata> StageIdentifierToMetadata;                  // 0x0038(0x0050)
	class FString                                 OriginalHash;                                      // 0x0088(0x0010)
...
{
public:
	float                                         LayerStartOffsetSeconds;                           // 0x0098(0x0004)
...
{
public:
	TMap<class FString, class FString>            ParameterToPrimvar;                                // 0x0098(0x0050)
	TMap<class FString, int32>                    PrimvarToUVIndex;                                  // 0x00E8(0x0050)
...
{
public:
	TMap<int32, struct FUsdPrimPathList>          MaterialSlotToPrimPaths;                           // 0x0098(0x0050)
	TMap<class FString, int32>                    PrimvarToUVIndex;                                  // 0x00E8(0x0050)
...
{
public:
	float                                         LayerStartOffsetSeconds;                           // 0x0138(0x0004)
...
{
public:
	struct FGuid                                  LastCheckedSignature;                              // 0x0028(0x0010)
	TSet<struct FGuid>                            HandledBindingGuids;                               // 0x0038(0x0050)
...
{
public:
	TArray<class FString>                         SourceOpenVDBAssetPrimPaths;                       // 0x0098(0x0010)
	TArray<double>                                TimeSamplePathTimeCodes;                           // 0x00A8(0x0010)
	TArray<int32>                                 TimeSamplePathIndices;                             // 0x00B8(0x0010)
	TArray<class FString>                         TimeSamplePaths;                                   // 0x00C8(0x0010)
...
{
public:
	struct FVector                                BoundsMin;                                         // 0x0620(0x0018)
	struct FVector                                BoundsMax;                                         // 0x0638(0x0018)
	EUsdDrawMode                                  DrawMode;                                          // 0x0650(0x0004)
	struct FLinearColor                           BoundsColor;                                       // 0x0654(0x0010)
	EUsdModelCardGeometry                         CardGeometry;                                      // 0x0664(0x0004)
	class UTexture2D*                             CardTextureXPos;                                   // 0x0668(0x0008)
	class UTexture2D*                             CardTextureYPos;                                   // 0x0670(0x0008)
	class UTexture2D*                             CardTextureZPos;                                   // 0x0678(0x0008)
	class UTexture2D*                             CardTextureXNeg;                                   // 0x0680(0x0008)
	class UTexture2D*                             CardTextureYNeg;                                   // 0x0688(0x0008)
	class UTexture2D*                             CardTextureZNeg;                                   // 0x0690(0x0008)
	TArray<class UMaterialInstance*>              MaterialInstances;                                 // 0x0698(0x0010)
	int32                                         AuthoredFaces;                                     // 0x06A8(0x0004)
...
{
public:
	TArray<struct FDirectoryPath>                 AdditionalPluginDirectories;                       // 0x0038(0x0010)
	TArray<struct FDirectoryPath>                 DefaultResolverSearchPath;                         // 0x0048(0x0010)
	TArray<class FName>                           AdditionalMaterialPurposes;                        // 0x0058(0x0010)
	bool                                          bLogUsdSdkErrors;                                  // 0x0068(0x0001)
	uint8                                         Pad_69[0x7];                                       // 0x0069(0x0007)
	struct FSoftObjectPath                        DefaultAssetCache;                                 // 0x0070(0x0020)
	bool                                          bShowCreateDefaultAssetCacheDialog;                // 0x0090(0x0001)
	bool                                          bShowConfirmationWhenClearingLayers;               // 0x0091(0x0001)
	bool                                          bShowConfirmationWhenMutingDirtyLayers;            // 0x0092(0x0001)
	bool                                          bShowConfirmationWhenReloadingDirtyLayers;         // 0x0093(0x0001)
	bool                                          bShowOverriddenOpinionsWarning;                    // 0x0094(0x0001)
	EUsdEditInInstanceBehavior                    EditInInstanceableBehavior;                        // 0x0095(0x0001)
	bool                                          bShowWarningOnIncompleteDuplication;               // 0x0096(0x0001)
	bool                                          bShowTransformOnCameraComponentWarning;            // 0x0097(0x0001)
	bool                                          bShowTransformTrackOnCameraComponentWarning;       // 0x0098(0x0001)
	bool                                          bShowInheritedVisibilityWarning;                   // 0x0099(0x0001)
	EUsdSaveDialogBehavior                        ShowSaveLayersDialogWhenSaving;                    // 0x009A(0x0001)
	EUsdSaveDialogBehavior                        ShowSaveLayersDialogWhenClosing;                   // 0x009B(0x0001)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)
	struct FSoftObjectPath                        DefaultSoundAttenuation;                           // 0x00A0(0x0020)
	struct FSoftObjectPath                        ReferenceDefaultSVTMaterial;                       // 0x00C0(0x0020)
	struct FSoftObjectPath                        ReferenceModelCardTextureMaterial;                 // 0x00E0(0x0020)
	struct FSoftObjectPath                        ReferencePreviewSurfaceMaterial;                   // 0x0100(0x0020)
	struct FSoftObjectPath                        ReferencePreviewSurfaceTranslucentMaterial;        // 0x0120(0x0020)
	struct FSoftObjectPath                        ReferencePreviewSurfaceTwoSidedMaterial;           // 0x0140(0x0020)
	struct FSoftObjectPath                        ReferencePreviewSurfaceTranslucentTwoSidedMaterial; // 0x0160(0x0020)
	struct FSoftObjectPath                        ReferencePreviewSurfaceVTMaterial;                 // 0x0180(0x0020)
	struct FSoftObjectPath                        ReferencePreviewSurfaceTranslucentVTMaterial;      // 0x01A0(0x0020)
	struct FSoftObjectPath                        ReferencePreviewSurfaceTwoSidedVTMaterial;         // 0x01C0(0x0020)
	struct FSoftObjectPath                        ReferencePreviewSurfaceTranslucentTwoSidedVTMaterial; // 0x01E0(0x0020)
	struct FSoftObjectPath                        ReferenceDisplayColorMaterial;                     // 0x0200(0x0020)
	struct FSoftObjectPath                        ReferenceDisplayColorAndOpacityMaterial;           // 0x0220(0x0020)
	struct FSoftObjectPath                        ReferenceDisplayColorTwoSidedMaterial;             // 0x0240(0x0020)
	struct FSoftObjectPath                        ReferenceDisplayColorAndOpacityTwoSidedMaterial;   // 0x0260(0x0020)
...
{
public:
	bool                                          bInternalReference;                                // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	struct FFilePath                              TargetFile;                                        // 0x0030(0x0010)
	bool                                          bUseDefaultPrim;                                   // 0x0040(0x0001)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)
	class FString                                 TargetPrimPath;                                    // 0x0048(0x0010)
	float                                         TimeCodeOffset;                                    // 0x0058(0x0004)
	float                                         TimeCodeScale;                                     // 0x005C(0x0004)
