...
{
public:
	class FString                                 LanguageCode;                                      // 0x0000(0x0010)
	class FString                                 MimeType;                                          // 0x0010(0x0010)
	class FString                                 StringData;                                        // 0x0020(0x0010)
	TArray<uint8>                                 BinaryData;                                        // 0x0030(0x0010)
};
...
{
public:
	TArray<struct FMediaMetadataItemBPT>          Items;                                             // 0x0000(0x0010)
};
