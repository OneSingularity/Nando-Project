...
{
public:
	struct FGizmoElementMaterialAttribute         Material;                                          // 0x0000(0x000C)
	struct FGizmoElementMaterialAttribute         HoverMaterial;                                     // 0x000C(0x000C)
	struct FGizmoElementMaterialAttribute         InteractMaterial;                                  // 0x0018(0x000C)
	struct FGizmoElementColorAttribute            VertexColor;                                       // 0x0024(0x0014)
	struct FGizmoElementColorAttribute            HoverVertexColor;                                  // 0x0038(0x0014)
	struct FGizmoElementColorAttribute            InteractVertexColor;                               // 0x004C(0x0014)
};
...
public:
	...
	struct FVector                                HitNormal;                                         // 0x0010(0x0018)
	bool                                          bHasHitNormal;                                     // 0x0028(0x0001)
	uint8                                         Pad_29[0x3];                                       // 0x0029(0x0003)
	int32                                         HitIdentifier;                                     // 0x002C(0x0004)
...
{
public:
	struct FRay                                   WorldRay;                                          // 0x0000(0x0030)
	bool                                          bHas2D;                                            // 0x0030(0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
	struct FVector2D                              ScreenPosition;                                    // 0x0038(0x0010)
};
...
{
public:
	struct FDeviceButtonState                     ActiveKey;                                         // 0x0000(0x0020)
};
...
{
public:
	struct FDeviceButtonState                     Left;                                              // 0x0000(0x0020)
	struct FDeviceButtonState                     Middle;                                            // 0x0020(0x0020)
	struct FDeviceButtonState                     Right;                                             // 0x0040(0x0020)
	float                                         WheelDelta;                                        // 0x0060(0x0004)
	uint8                                         Pad_64[0x4];                                       // 0x0064(0x0004)
	struct FVector2D                              Position2D;                                        // 0x0068(0x0010)
	struct FVector2D                              Delta2D;                                           // 0x0078(0x0010)
	struct FRay                                   WorldRay;                                          // 0x0088(0x0030)
};
...
public:
	...
	struct FKeyboardInputDeviceState              Keyboard;                                          // 0x0008(0x0020)
	struct FMouseInputDeviceState                 Mouse;                                             // 0x0028(0x00B8)
};
...
{
public:
	struct FVector2D                              InitialValue;                                      // 0x0000(0x0010)
	struct FVector2D                              CurrentValue;                                      // 0x0010(0x0010)
};
...
{
public:
	struct FGizmoElementColorAttribute            LineColor;                                         // 0x0000(0x0014)
	struct FGizmoElementColorAttribute            HoverLineColor;                                    // 0x0014(0x0014)
	struct FGizmoElementColorAttribute            InteractLineColor;                                 // 0x0028(0x0014)
};
...
public:
	...
	uint8                                         Pad_8[0x28];                                       // 0x0008(0x0028)
};
