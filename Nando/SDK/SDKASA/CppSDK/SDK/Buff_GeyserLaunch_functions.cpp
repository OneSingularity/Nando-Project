...
#include "Buff_GeyserLaunch_parameters.hpp"
...
void ABuff_GeyserLaunch_C::BuffTickServer(float DeltaTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Buff_GeyserLaunch_C", "BuffTickServer");

	Params::Buff_GeyserLaunch_C_BuffTickServer Parms{};
...
void ABuff_GeyserLaunch_C::BPSetupForInstigator(class AActor* ForInstigator)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Buff_GeyserLaunch_C", "BPSetupForInstigator");

	Params::Buff_GeyserLaunch_C_BPSetupForInstigator Parms{};
...
void ABuff_GeyserLaunch_C::BPDeactivated(class AActor* ForInstigator)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Buff_GeyserLaunch_C", "BPDeactivated");

	Params::Buff_GeyserLaunch_C_BPDeactivated Parms{};
...
void ABuff_GeyserLaunch_C::BPActivated(class AActor* ForInstigator)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Buff_GeyserLaunch_C", "BPActivated");

	Params::Buff_GeyserLaunch_C_BPActivated Parms{};
