...
{
public:
	uint8                                         Pad_B0[0x960];                                     // 0x00B0(0x0960)
...
class UMassReplicationProcessor final : public UMassProcessor
{
public:
	class UMassReplicationSubsystem*              ReplicationSubsystem;                              // 0x00B0(0x0008)
	uint8                                         Pad_B8[0xFA8];                                     // 0x00B8(0x0FA8)
...
{
public:
	struct FMassReplicationParameters             Params_0;                                          // 0x0028(0x0058)
