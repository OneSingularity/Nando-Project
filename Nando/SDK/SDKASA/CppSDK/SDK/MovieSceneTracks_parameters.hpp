...
public:
	...
	class UMovieScene*                            OwnerMovieScene;                                   // 0x0008(0x0008)
};
...
{
public:
	struct FMovieSceneBindingResolveContext       ResolveContext;                                    // 0x0000(0x0020)
	struct FMovieSceneBindingResolveResult        ReturnValue;                                       // 0x0020(0x0008)
};
...
{
public:
	const class UObject*                          SourceObject;                                      // 0x0000(0x0008)
...
{
public:
	struct FMovieSceneObjectBindingID             InConstraintBindingID;                             // 0x0000(0x0018)
};
...
{
public:
	class USoundAttenuation*                      InAttenuationSettings;                             // 0x0000(0x0008)
};
...
{
public:
	bool                                          bInOverrideAttenuation;                            // 0x0000(0x0001)
};
...
{
public:
	struct FFrameNumber                           InStartOffset;                                     // 0x0000(0x0004)
};
...
{
public:
	bool                                          bInSuppressSubtitles;                              // 0x0000(0x0001)
};
...
{
public:
	class USoundAttenuation*                      ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	class USoundBase*                             ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	struct FFrameNumber                           ReturnValue;                                       // 0x0000(0x0004)
};
...
{
public:
	struct FMovieSceneObjectBindingID             InCameraBindingID;                                 // 0x0000(0x0018)
};
...
{
public:
	class FString                                 InShotDisplayName;                                 // 0x0000(0x0010)
};
...
{
public:
	struct FMaterialParameterInfo                 InParameterInfo;                                   // 0x0000(0x0010)
	struct FFrameNumber                           InTime;                                            // 0x0010(0x0004)
	struct FLinearColor                           InValue;                                           // 0x0014(0x0010)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	class FString                                 InLayerName;                                       // 0x0028(0x0010)
	class FString                                 InAssetName;                                       // 0x0038(0x0010)
	struct FParameterChannelNames                 InChannelNames;                                    // 0x0048(0x0040)
};
...
public:
	...
	class FString                                 InLayerName;                                       // 0x0018(0x0010)
	class FString                                 InAssetName;                                       // 0x0028(0x0010)
};
...
public:
	...
	struct FFrameNumber                           InTime;                                            // 0x0008(0x0004)
	bool                                          InValue;                                           // 0x000C(0x0001)
...
public:
	class FName                                   InParameterName;                                   // 0x0000(0x0008)
	struct FFrameNumber                           InTime;                                            // 0x0008(0x0004)
	struct FLinearColor                           InValue;                                           // 0x000C(0x0010)
};
...
{
public:
	TSet<class FName>                             ParameterNames;                                    // 0x0000(0x0050)
};
...
{
public:
	TArray<class UDataLayerAsset*>                InDataLayerAssets;                                 // 0x0000(0x0010)
};
...
{
public:
	EDataLayerRuntimeState                        InDesiredState;                                    // 0x0000(0x0001)
};
...
{
public:
	bool                                          bFlushOnActivated_0;                               // 0x0000(0x0001)
};
...
{
public:
	bool                                          bFlushOnUnload_0;                                  // 0x0000(0x0001)
};
...
{
public:
	bool                                          bPerformGCOnUnload_0;                              // 0x0000(0x0001)
};
...
{
public:
	EDataLayerRuntimeState                        InPrerollState;                                    // 0x0000(0x0001)
};
...
{
public:
	TArray<class UDataLayerAsset*>                ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	EDataLayerRuntimeState                        ReturnValue;                                       // 0x0000(0x0001)
};
...
{
public:
	TArray<class FName>                           InLevelNames;                                      // 0x0000(0x0010)
};
...
{
public:
	ELevelVisibility                              InVisibility;                                      // 0x0000(0x0001)
};
...
{
public:
	ELevelVisibility                              ReturnValue;                                       // 0x0000(0x0001)
};
...
public:
	...
	class USceneComponent*                        TargetComponent;                                   // 0x0008(0x0008)
	struct FFrameTime                             FrameTime;                                         // 0x0010(0x0008)
	class UMovieSceneAsyncAction_SequencePrediction* ReturnValue;                                    // 0x0018(0x0008)
};
...
public:
	class UMovieSceneSequencePlayer*              Player;                                            // 0x0000(0x0008)
	class USceneComponent*                        TargetComponent;                                   // 0x0008(0x0008)
	float                                         TimeInSeconds;                                     // 0x0010(0x0004)
...
{
public:
	ESwapRootBone                                 InValue;                                           // 0x0000(0x0001)
};
...
{
public:
	ESwapRootBone                                 ReturnValue;                                       // 0x0000(0x0001)
};
