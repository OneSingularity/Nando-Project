...
public:
	...
	struct FMovieSceneObjectBindingID             MediaSourceProxy;                                  // 0x0010(0x0018)
	int32                                         MediaSourceProxyIndex;                             // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	class UMediaTexture*                          MediaTexture;                                      // 0x0030(0x0008)
	class UMediaPlayer*                           MediaPlayer;                                       // 0x0038(0x0008)
	struct FFrameNumber                           SectionStartFrame;                                 // 0x0040(0x0004)
	struct FFrameNumber                           SectionEndFrame;                                   // 0x0044(0x0004)
	bool                                          bLooping;                                          // 0x0048(0x0001)
	uint8                                         Pad_49[0x3];                                       // 0x0049(0x0003)
	struct FFrameNumber                           StartFrameOffset;                                  // 0x004C(0x0004)
	struct FMovieSceneFloatChannel                ProxyTextureBlend;                                 // 0x0050(0x0110)
	struct FMediaSourceCacheSettings              CacheSettings;                                     // 0x0160(0x0008)
};
...
{
public:
	struct FMovieSceneMediaSectionParams          Params;                                            // 0x0020(0x0168)
	class UMovieSceneMediaSection*                MediaSection;                                      // 0x0188(0x0008)
};
