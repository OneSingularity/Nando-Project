...
public:
	uint8                                         Pad_28[0x18];                                      // 0x0028(0x0018)
	class FString                                 Body;                                              // 0x0040(0x0010)
	ESentryLevel                                  Level;                                             // 0x0050(0x0001)
...
public:
	...
	class FString                                 Dsn;                                               // 0x0030(0x0010)
	bool                                          Debug;                                             // 0x0040(0x0001)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)
	class FString                                 environment;                                       // 0x0048(0x0010)
	class FString                                 Dist;                                              // 0x0058(0x0010)
	float                                         SampleRate;                                        // 0x0068(0x0004)
	bool                                          EnableAutoLogAttachment;                           // 0x006C(0x0001)
	bool                                          AttachStacktrace;                                  // 0x006D(0x0001)
	bool                                          SendDefaultPii;                                    // 0x006E(0x0001)
	bool                                          AttachScreenshot;                                  // 0x006F(0x0001)
	bool                                          AttachGpuDump;                                     // 0x0070(0x0001)
	uint8                                         Pad_71[0x3];                                       // 0x0071(0x0003)
	int32                                         MaxAttachmentSize;                                 // 0x0074(0x0004)
	bool                                          EnableStructuredLogging;                           // 0x0078(0x0001)
	uint8                                         Pad_79[0x7];                                       // 0x0079(0x0007)
	TArray<class FString>                         StructuredLoggingCategories;                       // 0x0080(0x0010)
	struct FStructuredLoggingLevels               StructuredLoggingLevels;                           // 0x0090(0x0005)
	bool                                          bSendBreadcrumbsWithStructuredLogging;             // 0x0095(0x0001)
	uint8                                         Pad_96[0x2];                                       // 0x0096(0x0002)
	int32                                         MaxBreadcrumbs;                                    // 0x0098(0x0004)
	struct FAutomaticBreadcrumbs                  AutomaticBreadcrumbs;                              // 0x009C(0x0005)
	struct FAutomaticBreadcrumbsForLogs           AutomaticBreadcrumbsForLogs;                       // 0x00A1(0x0005)
	bool                                          EnableAutoSessionTracking;                         // 0x00A6(0x0001)
	uint8                                         Pad_A7[0x1];                                       // 0x00A7(0x0001)
	int32                                         SessionTimeout;                                    // 0x00A8(0x0004)
	bool                                          OverrideReleaseName;                               // 0x00AC(0x0001)
	uint8                                         Pad_AD[0x3];                                       // 0x00AD(0x0003)
	class FString                                 Release;                                           // 0x00B0(0x0010)
	bool                                          UseProxy;                                          // 0x00C0(0x0001)
	uint8                                         Pad_C1[0x7];                                       // 0x00C1(0x0007)
	class FString                                 ProxyUrl;                                          // 0x00C8(0x0010)
	TSubclassOf<class USentryBeforeSendHandler>   BeforeSendHandler;                                 // 0x00D8(0x0008)
	TSubclassOf<class USentryBeforeBreadcrumbHandler> BeforeBreadcrumbHandler;                       // 0x00E0(0x0008)
	TSubclassOf<class USentryBeforeLogHandler>    BeforeLogHandler;                                  // 0x00E8(0x0008)
	bool                                          EnableAutoCrashCapturing;                          // 0x00F0(0x0001)
	ESentryDatabaseLocation                       DatabaseLocation;                                  // 0x00F1(0x0001)
	bool                                          CrashpadWaitForUpload;                             // 0x00F2(0x0001)
	uint8                                         Pad_F3[0x5];                                       // 0x00F3(0x0005)
	TArray<class FString>                         InAppInclude;                                      // 0x00F8(0x0010)
	TArray<class FString>                         InAppExclude;                                      // 0x0108(0x0010)
	bool                                          EnableAppNotRespondingTracking;                    // 0x0118(0x0001)
	bool                                          EnableTracing;                                     // 0x0119(0x0001)
	ESentryTracesSamplingType                     SamplingType;                                      // 0x011A(0x0001)
	uint8                                         Pad_11B[0x1];                                      // 0x011B(0x0001)
	float                                         TracesSampleRate;                                  // 0x011C(0x0004)
	TSubclassOf<class USentryTraceSampler>        TracesSampler;                                     // 0x0120(0x0008)
	class FString                                 EditorDsn;                                         // 0x0128(0x0010)
	struct FTagsPromotion                         TagsPromotion;                                     // 0x0138(0x0006)
	struct FEnableBuildConfigurations             EnableBuildConfigurations;                         // 0x013E(0x0005)
	struct FEnableBuildTargets                    EnableBuildTargets;                                // 0x0143(0x0005)
	bool                                          EnableForPromotedBuildsOnly;                       // 0x0148(0x0001)
	bool                                          UploadSymbolsAutomatically;                        // 0x0149(0x0001)
	uint8                                         Pad_14A[0x6];                                      // 0x014A(0x0006)
	class FString                                 ProjectName;                                       // 0x0150(0x0010)
	class FString                                 OrgName;                                           // 0x0160(0x0010)
	class FString                                 AuthToken;                                         // 0x0170(0x0010)
	bool                                          IncludeSources;                                    // 0x0180(0x0001)
	ESentryCliLogLevel                            DiagnosticLevel;                                   // 0x0181(0x0001)
	bool                                          UseLegacyGradlePlugin;                             // 0x0182(0x0001)
	uint8                                         Pad_183[0x5];                                      // 0x0183(0x0005)
	class FString                                 CrashReporterUrl;                                  // 0x0188(0x0010)
	bool                                          bRequireUserConsent;                               // 0x0198(0x0001)
	bool                                          bDefaultUserConsentGiven;                          // 0x0199(0x0001)
...
{
public:
	uint8                                         Pad_30[0x30];                                      // 0x0030(0x0030)
	class USentryBeforeSendHandler*               BeforeSendHandler;                                 // 0x0060(0x0008)
	class USentryBeforeBreadcrumbHandler*         BeforeBreadcrumbHandler;                           // 0x0068(0x0008)
	class USentryBeforeLogHandler*                BeforeLogHandler;                                  // 0x0070(0x0008)
	class USentryTraceSampler*                    TraceSampler;                                      // 0x0078(0x0008)
	uint8                                         Pad_80[0x38];                                      // 0x0080(0x0038)
