...
{
public:
	int32                                         AutoVTSize;                                        // 0x0038(0x0004)
	int32                                         AutoLimitDimension;                                // 0x003C(0x0004)
	bool                                          bEnableNormalizeNormals;                           // 0x0040(0x0001)
	bool                                          bEnableFastMipFilter;                              // 0x0041(0x0001)
	ETextureImportFloatingPointFormat             CompressedFormatForFloatTextures;                  // 0x0042(0x0001)
	ETextureImportPNGInfill                       PNGInfill;                                         // 0x0043(0x0001)
...
{
public:
	ETextureImportPNGInfill                       PNGInfill;                                         // 0x0038(0x0001)
