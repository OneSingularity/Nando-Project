...
{
public:
	class UModularSynthPresetBank*                InBank;                                            // 0x0000(0x0008)
	struct FModularSynthPreset                    Preset;                                            // 0x0008(0x00E0)
	class FString                                 PresetName;                                        // 0x00E8(0x0010)
};
...
public:
	...
	TArray<struct FSynth1PatchCable>              PatchCables;                                       // 0x0008(0x0010)
	bool                                          bEnableByDefault;                                  // 0x0018(0x0001)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)
	struct FPatchId                               ReturnValue;                                       // 0x001C(0x0004)
};
...
{
public:
	float                                         Note;                                              // 0x0000(0x0004)
	bool                                          bAllNotesOff;                                      // 0x0004(0x0001)
	bool                                          bKillAllNotes;                                     // 0x0005(0x0001)
...
{
public:
	float                                         AttackTimeMsec;                                    // 0x0000(0x0004)
};
...
{
public:
	bool                                          EnableChorus;                                      // 0x0000(0x0001)
};
...
{
public:
	float                                         DecayTimeMsec;                                     // 0x0000(0x0004)
};
...
{
public:
	bool                                          LegatoEnabled;                                     // 0x0000(0x0001)
};
...
{
public:
	struct FPatchId                               PatchId;                                           // 0x0000(0x0004)
...
{
public:
	bool                                          bEnablePolyphony;                                  // 0x0000(0x0001)
};
...
{
public:
	bool                                          RetriggerEnabled;                                  // 0x0000(0x0001)
};
...
{
public:
	bool                                          EnableUnison;                                      // 0x0000(0x0001)
};
...
{
public:
	ESynthFilterAlgorithm                         FilterAlgorithm;                                   // 0x0000(0x0001)
};
...
{
public:
	float                                         FilterFrequencyHz;                                 // 0x0000(0x0004)
};
...
{
public:
	ESynthFilterType                              FilterType;                                        // 0x0000(0x0001)
};
...
{
public:
	int32                                         LFOIndex;                                          // 0x0000(0x0004)
	float                                         FrequencyHz;                                       // 0x0004(0x0004)
};
...
public:
	int32                                         LFOIndex;                                          // 0x0000(0x0004)
	float                                         FrequencyModHz;                                    // 0x0004(0x0004)
};
...
public:
	int32                                         LFOIndex;                                          // 0x0000(0x0004)
	ESynthLFOMode                                 LFOMode;                                           // 0x0004(0x0001)
...
public:
	int32                                         LFOIndex;                                          // 0x0000(0x0004)
	ESynthLFOPatchType                            LFOPatchType;                                      // 0x0004(0x0001)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)
};
...
public:
	int32                                         LFOIndex;                                          // 0x0000(0x0004)
	ESynthLFOType                                 LFOType;                                           // 0x0004(0x0001)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)
};
...
{
public:
	ESynthModEnvBiasPatch                         InPatchType;                                       // 0x0000(0x0001)
};
...
{
public:
	ESynthModEnvPatch                             InPatchType;                                       // 0x0000(0x0001)
};
...
{
public:
	float                                         SustainGain;                                       // 0x0000(0x0004)
};
...
{
public:
	int32                                         OscIndex;                                          // 0x0000(0x0004)
	float                                         Cents;                                             // 0x0004(0x0004)
};
...
public:
	int32                                         OscIndex;                                          // 0x0000(0x0004)
	float                                         OscFreqMod;                                        // 0x0004(0x0004)
};
...
public:
	int32                                         OscIndex;                                          // 0x0000(0x0004)
	float                                         OscGainMod;                                        // 0x0004(0x0004)
};
...
public:
	int32                                         OscIndex;                                          // 0x0000(0x0004)
	float                                         Pulsewidth;                                        // 0x0004(0x0004)
};
...
public:
	int32                                         OscIndex;                                          // 0x0000(0x0004)
	ESynth1OscType                                OscType;                                           // 0x0004(0x0001)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)
};
...
{
public:
	float                                         Portamento;                                        // 0x0000(0x0004)
};
...
{
public:
	float                                         ReleaseTimeMsec;                                   // 0x0000(0x0004)
};
...
{
public:
	float                                         DelayFeedback;                                     // 0x0000(0x0004)
};
...
{
public:
	bool                                          StereoDelayEnabled;                                // 0x0000(0x0001)
};
...
{
public:
	ESynthStereoDelayMode                         StereoDelayMode;                                   // 0x0000(0x0001)
};
...
{
public:
	float                                         DelayRatio;                                        // 0x0000(0x0004)
};
...
{
public:
	float                                         DelayTimeMsec;                                     // 0x0000(0x0004)
};
...
{
public:
	float                                         DelayWetlevel;                                     // 0x0000(0x0004)
};
...
{
public:
	struct FModularSynthPreset                    SynthPreset;                                       // 0x0000(0x00E0)
};
...
{
public:
	const class USoundModulatorBase*              Modulator;                                         // 0x0000(0x0008)
};
...
{
public:
	TSet<class USoundModulatorBase*>              InModulators;                                      // 0x0000(0x0050)
};
...
{
public:
	struct FSourceEffectBitCrusherSettings        ModulationSettings;                                // 0x0000(0x00C0)
};
...
{
public:
	struct FSourceEffectBitCrusherBaseSettings    Settings_0;                                        // 0x0000(0x0008)
};
...
{
public:
	TSet<class USoundModulatorBase*>              Modulators;                                        // 0x0000(0x0050)
};
...
{
public:
	struct FSourceEffectChorusSettings            ModulationSettings;                                // 0x0000(0x0228)
};
...
{
public:
	struct FSourceEffectChorusBaseSettings        Settings_0;                                        // 0x0000(0x0018)
};
...
{
public:
	class UAudioImpulseResponse*                  InImpulseResponse;                                 // 0x0000(0x0008)
};
...
{
public:
	struct FSourceEffectConvolutionReverbSettings InSettings;                                        // 0x0000(0x0010)
};
...
{
public:
	struct FSourceEffectDynamicsProcessorSettings InSettings;                                        // 0x0000(0x0028)
};
...
{
public:
	class UEnvelopeFollowerListener*              EnvelopeFollowerListener;                          // 0x0000(0x0008)
};
...
{
public:
	struct FSourceEffectEnvelopeFollowerSettings  InSettings;                                        // 0x0000(0x000C)
};
...
{
public:
	struct FSourceEffectEQSettings                InSettings;                                        // 0x0000(0x0010)
};
...
{
public:
	struct FSourceEffectFilterSettings            InSettings;                                        // 0x0000(0x0020)
};
...
{
public:
	struct FSourceEffectFoldbackDistortionSettings InSettings;                                       // 0x0000(0x000C)
};
...
{
public:
	struct FSourceEffectMidSideSpreaderSettings   InSettings;                                        // 0x0000(0x0008)
};
...
{
public:
	struct FSourceEffectMotionFilterSettings      InSettings;                                        // 0x0000(0x0078)
};
...
{
public:
	struct FSourceEffectPannerSettings            InSettings;                                        // 0x0000(0x0008)
};
...
{
public:
	struct FSourceEffectPhaserSettings            InSettings;                                        // 0x0000(0x0010)
};
...
{
public:
	struct FSourceEffectRingModulationSettings    InSettings;                                        // 0x0000(0x0020)
};
...
{
public:
	struct FSourceEffectSimpleDelaySettings       InSettings;                                        // 0x0000(0x0018)
};
...
{
public:
	struct FSourceEffectStereoDelaySettings       InSettings;                                        // 0x0000(0x0024)
};
...
{
public:
	struct FSourceEffectWaveShaperSettings        InSettings;                                        // 0x0000(0x0008)
};
...
{
public:
	struct FSubmixEffectConvolutionReverbSettings InSettings;                                        // 0x0000(0x0030)
};
...
{
public:
	struct FSubmixEffectDelaySettings             DelaySettings;                                     // 0x0000(0x000C)
	float                                         DelayLength;                                       // 0x000C(0x0004)
	struct FSubmixEffectDelaySettings             ReturnValue;                                       // 0x0010(0x000C)
};
...
public:
	struct FSubmixEffectDelaySettings             DelaySettings;                                     // 0x0000(0x000C)
	float                                         InterpolationTime;                                 // 0x000C(0x0004)
	struct FSubmixEffectDelaySettings             ReturnValue;                                       // 0x0010(0x000C)
};
...
public:
	struct FSubmixEffectDelaySettings             DelaySettings;                                     // 0x0000(0x000C)
	float                                         MaximumDelayLength;                                // 0x000C(0x0004)
	struct FSubmixEffectDelaySettings             ReturnValue;                                       // 0x0010(0x000C)
};
...
{
public:
	struct FSubmixEffectDelaySettings             InSettings;                                        // 0x0000(0x000C)
};
...
{
public:
	ESubmixFilterAlgorithm                        InAlgorithm;                                       // 0x0000(0x0001)
};
...
{
public:
	float                                         InFrequency;                                       // 0x0000(0x0004)
};
...
{
public:
	ESubmixFilterType                             InType;                                            // 0x0000(0x0001)
};
...
{
public:
	struct FSubmixEffectFilterSettings            InSettings;                                        // 0x0000(0x000C)
};
...
{
public:
	struct FSubmixEffectFlexiverbSettings         InSettings;                                        // 0x0000(0x0010)
};
...
{
public:
	struct FSubmixEffectMultibandCompressorSettings InSettings;                                      // 0x0000(0x0038)
};
...
{
public:
	struct FSubmixEffectStereoDelaySettings       InSettings;                                        // 0x0000(0x0024)
};
...
{
public:
	struct FSubmixEffectStereoToQuadSettings      InSettings;                                        // 0x0000(0x0008)
};
...
public:
	int32                                         TapId;                                             // 0x0000(0x0004)
	struct FTapDelayInfo                          TapInfo;                                           // 0x0004(0x0018)
};
...
{
public:
	TArray<int32>                                 TapIds;                                            // 0x0000(0x0010)
};
...
{
public:
	struct FSubmixEffectTapDelaySettings          InSettings;                                        // 0x0000(0x0018)
};
...
{
public:
	float                                         BaseDurationMsec;                                  // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FVector2D                              DurationRange;                                     // 0x0008(0x0010)
};
...
{
public:
	EGranularSynthEnvelopeType                    EnvelopeType;                                      // 0x0000(0x0001)
};
...
{
public:
	float                                         BasePan;                                           // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FVector2D                              PanRange;                                          // 0x0008(0x0010)
};
...
{
public:
	float                                         BasePitch;                                         // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FVector2D                              PitchRange;                                        // 0x0008(0x0010)
};
...
{
public:
	float                                         InGrainProbability;                                // 0x0000(0x0004)
};
...
{
public:
	float                                         InGrainsPerSecond;                                 // 0x0000(0x0004)
};
...
{
public:
	float                                         BaseVolume;                                        // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FVector2D                              VolumeRange;                                       // 0x0008(0x0010)
};
...
{
public:
	float                                         InPlayheadRate;                                    // 0x0000(0x0004)
};
...
{
public:
	float                                         InPositionSec;                                     // 0x0000(0x0004)
	float                                         LerpTimeSec;                                       // 0x0004(0x0004)
	EGranularSynthSeekType                        SeekType;                                          // 0x0008(0x0001)
...
{
public:
	class USoundWave*                             InSoundWave;                                       // 0x0000(0x0008)
};
...
{
public:
	int32                                         TableIndex;                                        // 0x0000(0x0004)
...
{
public:
	float                                         InMidiNote;                                        // 0x0000(0x0004)
};
...
public:
	float                                         InMidiNote;                                        // 0x0000(0x0004)
	float                                         InVelocity;                                        // 0x0004(0x0004)
};
...
{
public:
	float                                         InAttackTimeMsec;                                  // 0x0000(0x0004)
};
...
{
public:
	bool                                          bInBiasInvert;                                     // 0x0000(0x0001)
};
...
{
public:
	float                                         InDecayTimeMsec;                                   // 0x0000(0x0004)
};
...
{
public:
	float                                         InReleaseTimeMsec;                                 // 0x0000(0x0004)
};
...
{
public:
	float                                         InSustainGain;                                     // 0x0000(0x0004)
};
...
{
public:
	ECurveInterpolationType                       InterpolationType;                                 // 0x0000(0x0001)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	int32                                         TableIndex;                                        // 0x0004(0x0004)
...
public:
	int32                                         TableIndex;                                        // 0x0000(0x0004)
	float                                         InNewTangent;                                      // 0x0004(0x0004)
	bool                                          ReturnValue;                                       // 0x0008(0x0001)
	uint8                                         Pad_9[0x3];                                        // 0x0009(0x0003)
};
...
public:
	int32                                         TableIndex;                                        // 0x0000(0x0004)
	int32                                         KeyframeIndex;                                     // 0x0004(0x0004)
	float                                         NewValue;                                          // 0x0008(0x0004)
...
{
public:
	float                                         FrequencyOffsetCents;                              // 0x0000(0x0004)
};
...
{
public:
	float                                         InLfoDepth;                                        // 0x0000(0x0004)
};
...
{
public:
	float                                         InLfoFrequency;                                    // 0x0000(0x0004)
};
...
{
public:
	ESynthLFOType                                 InLfoType;                                         // 0x0000(0x0001)
};
...
{
public:
	bool                                          InSustainPedalState;                               // 0x0000(0x0001)
};
...
{
public:
	float                                         InPosition;                                        // 0x0000(0x0004)
};
...
{
public:
	float                                         TableIndex;                                        // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	TArray<float>                                 ReturnValue;                                       // 0x0008(0x0010)
};
...
{
public:
	float                                         TimeSec;                                           // 0x0000(0x0004)
	ESamplePlayerSeekType                         SeekType;                                          // 0x0004(0x0001)
	bool                                          bWrap;                                             // 0x0005(0x0001)
	uint8                                         Pad_6[0x2];                                        // 0x0006(0x0002)
};
...
{
public:
	float                                         InScrubTimeWidthSec;                               // 0x0000(0x0004)
};
...
{
public:
	float                                         InLogFrequencyValue;                               // 0x0000(0x0004)
	float                                         InDomainMin;                                       // 0x0004(0x0004)
	float                                         InDomainMax;                                       // 0x0008(0x0004)
	float                                         InRangeMin;                                        // 0x000C(0x0004)
	float                                         InRangeMax;                                        // 0x0010(0x0004)
...
{
public:
	float                                         InLinearValue;                                     // 0x0000(0x0004)
	float                                         InDomainMin;                                       // 0x0004(0x0004)
	float                                         InDomainMax;                                       // 0x0008(0x0004)
	float                                         InRangeMin;                                        // 0x000C(0x0004)
	float                                         InRangeMax;                                        // 0x0010(0x0004)
