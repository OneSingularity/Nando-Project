...
public:
	...
	int32                                         NumChannels;                                       // 0x0038(0x0004)
	int32                                         SampleRate;                                        // 0x003C(0x0004)
...
{
public:
	TArray<struct FModularSynthPresetBankEntry>   Presets;                                           // 0x0028(0x0010)
...
// 0x0700 (0x0FE0 - 0x08E0)
class UModularSynthComponent final : public USynthComponent
{
public:
	int32                                         VoiceCount;                                        // 0x08E0(0x0004)
	uint8                                         Pad_8E4[0x6FC];                                    // 0x08E4(0x06FC)
...
{
public:
	uint8                                         Pad_68[0xE8];                                      // 0x0068(0x00E8)
	struct FSourceEffectBitCrusherSettings        Settings;                                          // 0x0150(0x00C0)
...
{
public:
	uint8                                         Pad_68[0x250];                                     // 0x0068(0x0250)
	struct FSourceEffectChorusSettings            Settings;                                          // 0x02B8(0x0228)
...
{
public:
	uint8                                         Pad_68[0x50];                                      // 0x0068(0x0050)
	struct FSourceEffectDynamicsProcessorSettings Settings;                                          // 0x00B8(0x0028)
...
{
public:
	TMulticastInlineDelegate<void(float EnvelopeValue)> OnEnvelopeFollowerUpdate;                    // 0x00D0(0x0010)
...
{
public:
	uint8                                         Pad_68[0x34];                                      // 0x0068(0x0034)
	struct FSourceEffectEnvelopeFollowerSettings  Settings;                                          // 0x009C(0x000C)
...
{
public:
	uint8                                         Pad_68[0x38];                                      // 0x0068(0x0038)
	struct FSourceEffectEQSettings                Settings;                                          // 0x00A0(0x0010)
...
public:
	...
	struct FSourceEffectFilterSettings            Settings;                                          // 0x00B0(0x0020)
...
public:
	uint8                                         Pad_68[0x34];                                      // 0x0068(0x0034)
	struct FSourceEffectFoldbackDistortionSettings Settings;                                         // 0x009C(0x000C)
...
{
public:
	uint8                                         Pad_68[0x30];                                      // 0x0068(0x0030)
	struct FSourceEffectMidSideSpreaderSettings   Settings;                                          // 0x0098(0x0008)
...
{
public:
	uint8                                         Pad_68[0xA0];                                      // 0x0068(0x00A0)
	struct FSourceEffectMotionFilterSettings      Settings;                                          // 0x0108(0x0078)
...
public:
	uint8                                         Pad_68[0x30];                                      // 0x0068(0x0030)
	struct FSourceEffectPannerSettings            Settings;                                          // 0x0098(0x0008)
...
public:
	uint8                                         Pad_68[0x38];                                      // 0x0068(0x0038)
	struct FSourceEffectPhaserSettings            Settings;                                          // 0x00A0(0x0010)
...
public:
	uint8                                         Pad_68[0x48];                                      // 0x0068(0x0048)
	struct FSourceEffectRingModulationSettings    Settings;                                          // 0x00B0(0x0020)
...
public:
	...
	struct FSourceEffectSimpleDelaySettings       Settings;                                          // 0x00A8(0x0018)
...
{
public:
	uint8                                         Pad_68[0x4C];                                      // 0x0068(0x004C)
	struct FSourceEffectStereoDelaySettings       Settings;                                          // 0x00B4(0x0024)
...
public:
	uint8                                         Pad_68[0x30];                                      // 0x0068(0x0030)
	struct FSourceEffectWaveShaperSettings        Settings;                                          // 0x0098(0x0008)
...
public:
	uint8                                         Pad_68[0x34];                                      // 0x0068(0x0034)
	struct FSubmixEffectDelaySettings             Settings;                                          // 0x009C(0x000C)
	struct FSubmixEffectDelaySettings             DynamicSettings;                                   // 0x00A8(0x000C)
...
public:
	uint8                                         Pad_68[0x34];                                      // 0x0068(0x0034)
	struct FSubmixEffectFilterSettings            Settings;                                          // 0x009C(0x000C)
...
public:
	uint8                                         Pad_68[0x38];                                      // 0x0068(0x0038)
	struct FSubmixEffectFlexiverbSettings         Settings;                                          // 0x00A0(0x0010)
...
public:
	...
	struct FSubmixEffectMultibandCompressorSettings Settings;                                        // 0x00C8(0x0038)
...
public:
	uint8                                         Pad_68[0x4C];                                      // 0x0068(0x004C)
	struct FSubmixEffectStereoDelaySettings       Settings;                                          // 0x00B4(0x0024)
...
public:
	uint8                                         Pad_68[0x30];                                      // 0x0068(0x0030)
	struct FSubmixEffectStereoToQuadSettings      Settings;                                          // 0x0098(0x0008)
...
public:
	uint8                                         Pad_68[0x40];                                      // 0x0068(0x0040)
	struct FSubmixEffectTapDelaySettings          Settings;                                          // 0x00A8(0x0018)
...
// 0x03F0 (0x0CD0 - 0x08E0)
class UGranularSynth final : public USynthComponent
{
public:
	class USoundWave*                             GranulatedSoundWave;                               // 0x08E0(0x0008)
	uint8                                         Pad_8E8[0x3E8];                                    // 0x08E8(0x03E8)
...
{
public:
	class FString                                 PresetName;                                        // 0x0028(0x0010)
	uint8                                         bLockKeyframesToGridBool : 1;                      // 0x0038(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)
	int32                                         LockKeyframesToGrid;                               // 0x003C(0x0004)
	int32                                         WaveTableResolution;                               // 0x0040(0x0004)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)
	TArray<struct FRuntimeFloatCurve>             WaveTable;                                         // 0x0048(0x0010)
	uint8                                         bNormalizeWaveTables : 1;                          // 0x0058(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_59[0x117];                                     // 0x0059(0x0117)
...
// 0x0750 (0x1030 - 0x08E0)
class USynthComponentMonoWaveTable final : public USynthComponent
{
public:
	TMulticastInlineDelegate<void(int32 TableIndex)> OnTableAltered;                                 // 0x08E0(0x0010)
	TMulticastInlineDelegate<void()>              OnNumTablesChanged;                                // 0x08F0(0x0010)
	class UMonoWaveTableSynthPreset*              CurrentPreset;                                     // 0x0900(0x0008)
	uint8                                         Pad_908[0x728];                                    // 0x0908(0x0728)
...
{
public:
	float                                         Frequency;                                         // 0x08E0(0x0004)
	float                                         Volume;                                            // 0x08E4(0x0004)
	struct FRuntimeFloatCurve                     DistanceAttenuationCurve;                          // 0x08E8(0x0088)
	struct FVector2D                              DistanceRange;                                     // 0x0970(0x0010)
	float                                         AttenuationDbAtMaxRange;                           // 0x0980(0x0004)
	uint8                                         Pad_984[0x4C];                                     // 0x0984(0x004C)
...
{
public:
	class USoundWave*                             SoundWave;                                         // 0x08E0(0x0008)
	TMulticastInlineDelegate<void()>              OnSampleLoaded;                                    // 0x08E8(0x0010)
	TMulticastInlineDelegate<void(float ProgressPercent, float ProgressTimeSeconds)> OnSamplePlaybackProgress; // 0x08F8(0x0010)
	uint8                                         Pad_908[0x108];                                    // 0x0908(0x0108)
...
{
public:
	float                                         ValueX;                                            // 0x0200(0x0004)
	float                                         ValueY;                                            // 0x0204(0x0004)
	TDelegate<void()>                             ValueXDelegate;                                    // 0x0208(0x0010)
	TDelegate<void()>                             ValueYDelegate;                                    // 0x0218(0x0010)
	uint8                                         Pad_228[0x8];                                      // 0x0228(0x0008)
	struct FSynth2DSliderStyle                    WidgetStyle;                                       // 0x0230(0x0390)
	struct FLinearColor                           SliderHandleColor;                                 // 0x05C0(0x0010)
	bool                                          IndentHandle;                                      // 0x05D0(0x0001)
	bool                                          Locked;                                            // 0x05D1(0x0001)
	uint8                                         Pad_5D2[0x2];                                      // 0x05D2(0x0002)
	float                                         StepSize;                                          // 0x05D4(0x0004)
	bool                                          IsFocusable;                                       // 0x05D8(0x0001)
	uint8                                         Pad_5D9[0x7];                                      // 0x05D9(0x0007)
	TMulticastInlineDelegate<void()>              OnMouseCaptureBegin;                               // 0x05E0(0x0010)
	TMulticastInlineDelegate<void()>              OnMouseCaptureEnd;                                 // 0x05F0(0x0010)
	TMulticastInlineDelegate<void()>              OnControllerCaptureBegin;                          // 0x0600(0x0010)
	TMulticastInlineDelegate<void()>              OnControllerCaptureEnd;                            // 0x0610(0x0010)
	TMulticastInlineDelegate<void(float Value)>   OnValueChangedX;                                   // 0x0620(0x0010)
	TMulticastInlineDelegate<void(float Value)>   OnValueChangedY;                                   // 0x0630(0x0010)
	uint8                                         Pad_640[0x10];                                     // 0x0640(0x0010)
...
// 0x03A0 (0x05A0 - 0x0200)
class USynthKnob final : public UWidget
{
public:
	float                                         Value;                                             // 0x0200(0x0004)
	float                                         StepSize;                                          // 0x0204(0x0004)
	float                                         MouseSpeed;                                        // 0x0208(0x0004)
	float                                         MouseFineTuneSpeed;                                // 0x020C(0x0004)
	uint8                                         ShowTooltipInfo : 1;                               // 0x0210(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_211[0x7];                                      // 0x0211(0x0007)
	class FText                                   ParameterName;                                     // 0x0218(0x0010)
	class FText                                   ParameterUnits;                                    // 0x0228(0x0010)
	TDelegate<void()>                             ValueDelegate;                                     // 0x0238(0x0010)
	uint8                                         Pad_248[0x8];                                      // 0x0248(0x0008)
	struct FSynthKnobStyle                        WidgetStyle;                                       // 0x0250(0x02E0)
	bool                                          Locked;                                            // 0x0530(0x0001)
	bool                                          IsFocusable;                                       // 0x0531(0x0001)
	uint8                                         Pad_532[0x6];                                      // 0x0532(0x0006)
	TMulticastInlineDelegate<void()>              OnMouseCaptureBegin;                               // 0x0538(0x0010)
	TMulticastInlineDelegate<void()>              OnMouseCaptureEnd;                                 // 0x0548(0x0010)
	TMulticastInlineDelegate<void()>              OnControllerCaptureBegin;                          // 0x0558(0x0010)
	TMulticastInlineDelegate<void()>              OnControllerCaptureEnd;                            // 0x0568(0x0010)
	TMulticastInlineDelegate<void(float Value)>   OnValueChanged;                                    // 0x0578(0x0010)
	uint8                                         Pad_588[0x18];                                     // 0x0588(0x0018)
