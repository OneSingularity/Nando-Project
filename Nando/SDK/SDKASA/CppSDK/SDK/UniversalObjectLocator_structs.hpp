...
{
public:
	class FString                                 PathWithinContext;                                 // 0x0000(0x0010)
};

// ScriptStruct UniversalObjectLocator.UniversalObjectLocatorFragment
// 0x0020 (0x0020 - 0x0000)
struct FUniversalObjectLocatorFragment final
{
public:
...
{
public:
	TArray<struct FUniversalObjectLocatorFragment> Fragments;                                        // 0x0000(0x0010)
};
