...
public:
	...
	class UImage*                                 Image_1;                                           // 0x0388(0x0008)
	class UImage*                                 Image_2;                                           // 0x0390(0x0008)
	class UImage*                                 Image_68;                                          // 0x0398(0x0008)
	class USynth2DSlider*                         Synth2DSlider_89;                                  // 0x03A0(0x0008)
	class UMaterialInstanceDynamic*               SliderMat;                                         // 0x03A8(0x0008)
	struct FLinearColor                           Linear_Color;                                      // 0x03B0(0x0010)
	class UMaterialInterface*                     MaterialToPickColor;                               // 0x03C0(0x0008)
	class UTextureRenderTarget2D*                 Texture_Render_Target;                             // 0x03C8(0x0008)
	double                                        LastTimeUpdateRender;                              // 0x03D0(0x0008)
