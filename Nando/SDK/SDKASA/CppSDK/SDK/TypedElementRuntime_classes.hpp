...
{
public:
	uint8                                         Pad_28[0x800];                                     // 0x0028(0x0800)
	TMulticastInlineDelegate<void(const class UTypedElementSelectionSet* SelectionSet)> OnPreSelectionChange; // 0x0828(0x0010)
	TMulticastInlineDelegate<void(const class UTypedElementSelectionSet* SelectionSet)> OnSelectionChange; // 0x0838(0x0010)
	uint8                                         Pad_848[0x58];                                     // 0x0848(0x0058)
