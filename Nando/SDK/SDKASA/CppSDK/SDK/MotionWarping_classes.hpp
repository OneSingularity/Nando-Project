...
{
public:
	class ACharacter*                             TargetCharacter;                                   // 0x0038(0x0008)
...
{
public:
	class URootMotionModifier*                    RootMotionModifier;                                // 0x0038(0x0008)
...
{
public:
	bool                                          bEnableRootMotion;                                 // 0x00D0(0x0001)
	uint8                                         Pad_D1[0x3];                                       // 0x00D1(0x0003)
	EAttributeBasedRootMotionMode                 Mode;                                              // 0x00D4(0x0004)
	uint8                                         Pad_D8[0x38];                                      // 0x00D8(0x0038)
	TWeakObjectPtr<class ACharacter>              CharacterOwner;                                    // 0x0110(0x0008)
	uint8                                         Pad_118[0xA8];                                     // 0x0118(0x00A8)
...
{
public:
	bool                                          bSearchForWindowsInAnimsWithinMontages;            // 0x00D0(0x0001)
	uint8                                         Pad_D1[0x7];                                       // 0x00D1(0x0007)
	TMulticastInlineDelegate<void(class UMotionWarpingComponent* MotionWarpingComp)> OnPreUpdate;    // 0x00D8(0x0010)
	class UMotionWarpingBaseAdapter*              OwnerAdapter;                                      // 0x00E8(0x0008)
	TArray<class URootMotionModifier*>            Modifiers;                                         // 0x00F0(0x0010)
	TArray<struct FMotionWarpingTarget>           WarpTargets;                                       // 0x0100(0x0010)
...
public:
	...
	struct FTransform                             StartTransform;                                    // 0x0050(0x0060)
	float                                         ActualStartTime;                                   // 0x00B0(0x0004)
	uint8                                         Pad_B4[0xC];                                       // 0x00B4(0x000C)
	struct FTransform                             TotalRootMotionWithinWindow;                       // 0x00C0(0x0060)
	TDelegate<void(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* RootMotionModifier)> OnActivateDelegate; // 0x0120(0x0010)
	TDelegate<void(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* RootMotionModifier)> OnUpdateDelegate; // 0x0130(0x0010)
	TDelegate<void(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* RootMotionModifier)> OnDeactivateDelegate; // 0x0140(0x0010)
	ERootMotionModifierState                      State;                                             // 0x0150(0x0001)
...
{
public:
	class FName                                   WarpTargetName;                                    // 0x0158(0x0008)
	EWarpPointAnimProvider                        WarpPointAnimProvider;                             // 0x0160(0x0001)
	uint8                                         Pad_161[0xF];                                      // 0x0161(0x000F)
	struct FTransform                             WarpPointAnimTransform;                            // 0x0170(0x0060)
	class FName                                   WarpPointAnimBoneName;                             // 0x01D0(0x0008)
	bool                                          bWarpTranslation;                                  // 0x01D8(0x0001)
	bool                                          bIgnoreZAxis;                                      // 0x01D9(0x0001)
	EAlphaBlendOption                             AddTranslationEasingFunc;                          // 0x01DA(0x0001)
	uint8                                         Pad_1DB[0x5];                                      // 0x01DB(0x0005)
	class UCurveFloat*                            AddTranslationEasingCurve;                         // 0x01E0(0x0008)
	bool                                          bWarpRotation;                                     // 0x01E8(0x0001)
	EMotionWarpRotationType                       RotationType;                                      // 0x01E9(0x0001)
	EMotionWarpRotationMethod                     RotationMethod;                                    // 0x01EA(0x0001)
	uint8                                         Pad_1EB[0x1];                                      // 0x01EB(0x0001)
	float                                         WarpRotationTimeMultiplier;                        // 0x01EC(0x0004)
	float                                         WarpMaxRotationRate;                               // 0x01F0(0x0004)
	uint8                                         Pad_1F4[0xC];                                      // 0x01F4(0x000C)
	struct FTransform                             CachedTargetTransform;                             // 0x0200(0x0060)
	uint8                                         Pad_260[0x70];                                     // 0x0260(0x0070)
...
{
public:
	struct FVector                                Scale;                                             // 0x0158(0x0018)
...
{
public:
	bool                                          bWarpIKBones;                                      // 0x02D0(0x0001)
	uint8                                         Pad_2D1[0x7];                                      // 0x02D1(0x0007)
	TArray<class FName>                           IKBones;                                           // 0x02D8(0x0010)
	uint8                                         Pad_2E8[0x8];                                      // 0x02E8(0x0008)
	struct FTransform                             CachedMeshTransform;                               // 0x02F0(0x0060)
	struct FTransform                             CachedMeshRelativeTransform;                       // 0x0350(0x0060)
	struct FTransform                             CachedRootMotion;                                  // 0x03B0(0x0060)
	struct FAnimSequenceTrackContainer            Result;                                            // 0x0410(0x0020)
