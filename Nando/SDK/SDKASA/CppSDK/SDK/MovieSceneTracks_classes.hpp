...
{
public:
	struct FMovieSceneDirectorBlueprintConditionData DirectorBlueprintConditionData;                 // 0x0060(0x0028)
	EMovieSceneConditionScope                     Scope;                                             // 0x0088(0x0001)
	EMovieSceneConditionCheckFrequency            CheckFrequency;                                    // 0x0089(0x0001)
...
public:
	float                                         FloatProperty;                                     // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	struct FVector                                VectorProperty;                                    // 0x0030(0x0018)
...
{
public:
	TArray<class FName>                           ValidPlatforms;                                    // 0x0060(0x0010)
...
{
public:
	int32                                         CustomBindingPriority;                             // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	TSubclassOf<class UMovieSceneSpawnableBindingBase> PreviewSpawnableType;                         // 0x0030(0x0008)
...
{
public:
	struct FMovieSceneDynamicBinding              DynamicBinding;                                    // 0x0028(0x0028)
	TSubclassOf<class UMovieSceneSpawnableBindingBase> PreviewSpawnableType;                         // 0x0050(0x0008)
...
public:
	...
	struct FMovieSceneDoubleChannel               Rotation[0x3];                                     // 0x0100(0x0118)
...
{
public:
	class UMovieSceneSection*                     SectionToKey;                                      // 0x00F8(0x0008)
	struct FMovieScenePropertyBinding             PropertyBinding;                                   // 0x0100(0x0014)
	uint8                                         Pad_114[0x4];                                      // 0x0114(0x0004)
	TArray<class UMovieSceneSection*>             Sections;                                          // 0x0118(0x0010)
...
{
public:
	EMovieSceneScalabilityConditionGroup          Group;                                             // 0x0060(0x0001)
	EMovieSceneScalabilityConditionOperator       Operator;                                          // 0x0061(0x0001)
	EMovieSceneScalabilityConditionLevel          Level;                                             // 0x0062(0x0001)
...
{
public:
	bool                                          bNetAddressableName;                               // 0x0030(0x0001)
	uint8                                         Pad_31[0x3];                                       // 0x0031(0x0003)
	class FName                                   LevelName;                                         // 0x0034(0x0008)
...
{
public:
	class AActor*                                 ActorTemplate;                                     // 0x0040(0x0008)
...
{
public:
	struct FMovieSceneDynamicBinding              DynamicBinding;                                    // 0x0030(0x0028)
...
public:
	...
	TArray<struct FGuid>                          BindingGuids;                                      // 0x0080(0x0010)
...
{
public:
	struct FMovieSceneDoublePerlinNoiseChannel    PerlinNoiseChannel;                                // 0x0058(0x0068)
...
{
public:
	struct FMovieSceneFloatPerlinNoiseChannel     PerlinNoiseChannel;                                // 0x0058(0x0068)
...
{
public:
	uint8                                         Pad_40[0x1B0];                                     // 0x0040(0x01B0)
...
{
public:
	struct FGuid                                  ConstraintID;                                      // 0x00F8(0x0010)
	struct FMovieSceneObjectBindingID             ConstraintBindingID;                               // 0x0108(0x0018)
...
public:
	...
	class FName                                   AttachSocketName;                                  // 0x0128(0x0008)
	class FName                                   AttachComponentName;                               // 0x0130(0x0008)
...
{
public:
	struct FMovieSceneFloatChannel                TimingCurve;                                       // 0x0120(0x0110)
	EMovieScene3DPathSection_Axis                 FrontAxisEnum;                                     // 0x0230(0x0001)
	EMovieScene3DPathSection_Axis                 UpAxisEnum;                                        // 0x0231(0x0001)
	uint8                                         Pad_232[0x2];                                      // 0x0232(0x0002)
	uint8                                         bFollow : 1;                                       // 0x0234(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bReverse : 1;                                      // 0x0234(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bForceUpright : 1;                                 // 0x0234(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
...
{
public:
	TArray<struct FConstraintAndActiveChannel>    ConstraintsChannels;                               // 0x0028(0x0010)
...
public:
	...
	struct FMovieSceneTransformMask               TransformMask;                                     // 0x0138(0x0004)
	uint8                                         Pad_13C[0x4];                                      // 0x013C(0x0004)
	struct FMovieSceneDoubleChannel               Translation[0x3];                                  // 0x0140(0x0118)
	struct FMovieSceneDoubleChannel               Rotation[0x3];                                     // 0x0488(0x0118)
	struct FMovieSceneDoubleChannel               Scale[0x3];                                        // 0x07D0(0x0118)
	struct FMovieSceneFloatChannel                ManualWeight;                                      // 0x0B18(0x0110)
	class UMovieSceneSectionChannelOverrideRegistry* OverrideRegistry;                               // 0x0C28(0x0008)
	class UMovieScene3DTransformSectionConstraints* Constraints;                                     // 0x0C30(0x0008)
	bool                                          bUseQuaternionInterpolation;                       // 0x0C38(0x0001)
...
{
public:
	struct FMovieSceneActorReferenceData          ActorReferenceData;                                // 0x00F8(0x0120)
	struct FIntegralCurve                         ActorGuidIndexCurve;                               // 0x0218(0x0080)
	TArray<class FString>                         ActorGuidStrings;                                  // 0x0298(0x0010)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	class USoundBase*                             Sound;                                             // 0x0100(0x0008)
	struct FFrameNumber                           StartFrameOffset;                                  // 0x0108(0x0004)
	bool                                          bForceNeverStopTrack;                              // 0x010C(0x0001)
	uint8                                         Pad_10D[0x3];                                      // 0x010D(0x0003)
	float                                         StartOffset;                                       // 0x0110(0x0004)
	float                                         AudioStartTime;                                    // 0x0114(0x0004)
	float                                         AudioDilationFactor;                               // 0x0118(0x0004)
	float                                         AudioVolume;                                       // 0x011C(0x0004)
	struct FMovieSceneFloatChannel                SoundVolume;                                       // 0x0120(0x0110)
	struct FMovieSceneFloatChannel                PitchMultiplier;                                   // 0x0230(0x0110)
	TMap<class FName, struct FMovieSceneFloatChannel> Inputs_Float;                                  // 0x0340(0x0050)
	TMap<class FName, struct FMovieSceneStringChannel> Inputs_String;                                // 0x0390(0x0050)
	TMap<class FName, struct FMovieSceneBoolChannel> Inputs_Bool;                                    // 0x03E0(0x0050)
	TMap<class FName, struct FMovieSceneIntegerChannel> Inputs_Int;                                  // 0x0430(0x0050)
	TMap<class FName, struct FMovieSceneAudioTriggerChannel> Inputs_Trigger;                         // 0x0480(0x0050)
	struct FMovieSceneActorReferenceData          AttachActorData;                                   // 0x04D0(0x0120)
	bool                                          bLooping;                                          // 0x05F0(0x0001)
	bool                                          bSuppressSubtitles;                                // 0x05F1(0x0001)
	bool                                          bOverrideAttenuation;                              // 0x05F2(0x0001)
	uint8                                         Pad_5F3[0x5];                                      // 0x05F3(0x0005)
	class USoundAttenuation*                      AttenuationSettings;                               // 0x05F8(0x0008)
	TDelegate<void(const TArray<struct FSubtitleCue>& Subtitles, float CueDuration)> OnQueueSubtitles; // 0x0600(0x0010)
	TMulticastInlineDelegate<void()>              OnAudioFinished;                                   // 0x0610(0x0010)
	TMulticastInlineDelegate<void(const class USoundWave* PlayingSoundWave, const float PlaybackPercent)> OnAudioPlaybackPercent; // 0x0620(0x0010)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneByteChannel                 ByteCurve;                                         // 0x0100(0x0110)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	bool                                          bLockPreviousCamera;                               // 0x0100(0x0001)
	uint8                                         Pad_101[0x3];                                      // 0x0101(0x0003)
	struct FGuid                                  CameraGuid;                                        // 0x0104(0x0010)
	struct FMovieSceneObjectBindingID             CameraBindingID;                                   // 0x0114(0x0018)
	uint8                                         Pad_12C[0x4];                                      // 0x012C(0x0004)
	struct FTransform                             InitialCameraCutTransform;                         // 0x0130(0x0060)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneCameraShakeSectionData      ShakeData;                                         // 0x0100(0x0028)
	TSubclassOf<class UCameraShakeBase>           ShakeClass;                                        // 0x0128(0x0008)
	float                                         PlayScale;                                         // 0x0130(0x0004)
	ECameraShakePlaySpace                         PlaySpace;                                         // 0x0134(0x0001)
	uint8                                         Pad_135[0x3];                                      // 0x0135(0x0003)
	struct FRotator                               UserDefinedPlaySpace;                              // 0x0138(0x0018)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneCameraShakeSourceTriggerChannel Channel;                                       // 0x0100(0x00F8)
...
{
public:
	class FString                                 ShotDisplayName;                                   // 0x07E0(0x0010)
	class FText                                   DisplayName;                                       // 0x07F0(0x0010)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneFloatChannel                RedCurve;                                          // 0x0100(0x0110)
	struct FMovieSceneFloatChannel                GreenCurve;                                        // 0x0210(0x0110)
	struct FMovieSceneFloatChannel                BlueCurve;                                         // 0x0320(0x0110)
	struct FMovieSceneFloatChannel                AlphaCurve;                                        // 0x0430(0x0110)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	TArray<struct FScalarMaterialParameterInfoAndCurve> ScalarParameterInfosAndCurves;               // 0x0100(0x0010)
	TArray<struct FColorMaterialParameterInfoAndCurves> ColorParameterInfosAndCurves;                // 0x0110(0x0010)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	TArray<struct FBoolParameterNameAndCurve>     BoolParameterNamesAndCurves;                       // 0x0100(0x0010)
	TArray<struct FScalarParameterNameAndCurve>   ScalarParameterNamesAndCurves;                     // 0x0110(0x0010)
	TArray<struct FVector2DParameterNameAndCurves> Vector2DParameterNamesAndCurves;                  // 0x0120(0x0010)
	TArray<struct FVectorParameterNameAndCurves>  VectorParameterNamesAndCurves;                     // 0x0130(0x0010)
	TArray<struct FColorParameterNameAndCurves>   ColorParameterNamesAndCurves;                      // 0x0140(0x0010)
	TArray<struct FTransformParameterNameAndCurves> TransformParameterNamesAndCurves;                // 0x0150(0x0010)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	TArray<struct FMovieSceneConsoleVariableCollection> ConsoleVariableCollections;                  // 0x0100(0x0010)
	struct FMovieSceneCVarOverrides               ConsoleVariables;                                  // 0x0110(0x0050)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	TArray<class UDataLayerAsset*>                DataLayerAssets;                                   // 0x0100(0x0010)
	EDataLayerRuntimeState                        DesiredState;                                      // 0x0110(0x0001)
	EDataLayerRuntimeState                        PrerollState;                                      // 0x0111(0x0001)
	bool                                          bFlushOnActivated;                                 // 0x0112(0x0001)
	bool                                          bFlushOnUnload;                                    // 0x0113(0x0001)
	bool                                          bPerformGCOnUnload;                                // 0x0114(0x0001)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneDoubleChannel               DoubleCurve;                                       // 0x0100(0x0118)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneByteChannel                 EnumCurve;                                         // 0x0100(0x0110)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneEvent                       Event;                                             // 0x0100(0x0028)
...
{
public:
	struct FNameCurve                             Events;                                            // 0x00F8(0x0078)
	struct FMovieSceneEventSectionData            EventData;                                         // 0x0170(0x00F8)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneEventChannel                EventChannel;                                      // 0x0100(0x00F8)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneFloatChannel                FloatCurve;                                        // 0x0100(0x0110)
	struct FLinearColor                           FadeColor;                                         // 0x0210(0x0010)
	uint8                                         bFadeAudio : 1;                                    // 0x0220(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
...
public:
	...
	struct FMovieSceneFloatChannel                FloatCurve;                                        // 0x0108(0x0110)
	class UMovieSceneSectionChannelOverrideRegistry* OverrideRegistry;                               // 0x0218(0x0008)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneIntegerChannel              IntegerCurve;                                      // 0x0100(0x0108)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	ELevelVisibility                              Visibility;                                        // 0x0100(0x0001)
	uint8                                         Pad_101[0x7];                                      // 0x0101(0x0007)
	TArray<class FName>                           LevelNames;                                        // 0x0108(0x0010)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneObjectPathChannel           ObjectChannel;                                     // 0x0100(0x0130)
...
{
public:
	struct FMovieSceneParticleChannel             ParticleKeys;                                      // 0x00F8(0x0110)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneObjectPathChannel           MaterialChannel;                                   // 0x0100(0x0130)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneSkeletalAnimationParams     Params_0;                                          // 0x0100(0x0158)
	class UAnimSequence*                          AnimSequence;                                      // 0x0258(0x0008)
	class UAnimSequenceBase*                      Animation;                                         // 0x0260(0x0008)
	float                                         StartOffset;                                       // 0x0268(0x0004)
	float                                         EndOffset;                                         // 0x026C(0x0004)
	float                                         PlayRate;                                          // 0x0270(0x0004)
	uint8                                         bReverse : 1;                                      // 0x0274(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         Pad_275[0x3];                                      // 0x0275(0x0003)
	class FName                                   SlotName;                                          // 0x0278(0x0008)
	struct FVector                                StartLocationOffset;                               // 0x0280(0x0018)
	struct FRotator                               StartRotationOffset;                               // 0x0298(0x0018)
	class FName                                   MatchedBoneName;                                   // 0x02B0(0x0008)
	struct FVector                                MatchedLocationOffset;                             // 0x02B8(0x0018)
	struct FRotator                               MatchedRotationOffset;                             // 0x02D0(0x0018)
	uint8                                         bMatchWithPrevious : 1;                            // 0x02E8(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bMatchTranslation : 1;                             // 0x02E8(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         bMatchIncludeZHeight : 1;                          // 0x02E8(0x0001)(BitIndex: 0x02, PropSize: 0x0001)
	uint8                                         bMatchRotationYaw : 1;                             // 0x02E8(0x0001)(BitIndex: 0x03, PropSize: 0x0001)
	uint8                                         bMatchRotationPitch : 1;                           // 0x02E8(0x0001)(BitIndex: 0x04, PropSize: 0x0001)
	uint8                                         bMatchRotationRoll : 1;                            // 0x02E8(0x0001)(BitIndex: 0x05, PropSize: 0x0001)
	uint8                                         bDebugForceTickPose : 1;                           // 0x02E8(0x0001)(BitIndex: 0x06, PropSize: 0x0001)
	uint8                                         Pad_2E9[0x77];                                     // 0x02E9(0x0077)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneStringChannel               StringCurve;                                       // 0x0100(0x0110)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneFloatChannel                Curves[0x4];                                       // 0x0100(0x0110)
	int32                                         ChannelsUsed;                                      // 0x0540(0x0004)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	struct FMovieSceneDoubleChannel               Curves[0x4];                                       // 0x0100(0x0118)
	int32                                         ChannelsUsed;                                      // 0x0560(0x0004)
...
{
public:
	uint8                                         Pad_40[0xB0];                                      // 0x0040(0x00B0)
...
{
public:
	uint8                                         Pad_40[0x80];                                      // 0x0040(0x0080)
...
{
public:
	uint8                                         Pad_40[0x190];                                     // 0x0040(0x0190)
...
public:
	uint8                                         Pad_40[0x190];                                     // 0x0040(0x0190)
	class UMovieScenePiecewiseDoubleBlenderSystem* DoubleBlenderSystem;                              // 0x01D0(0x0008)
...
{
public:
	uint8                                         Pad_40[0x90];                                      // 0x0040(0x0090)
...
{
public:
	class UMovieSceneEntityGroupingSystem*        GroupingSystem;                                    // 0x0040(0x0008)
...
{
public:
	uint8                                         Pad_40[0x310];                                     // 0x0040(0x0310)
...
{
public:
	uint8                                         Pad_68[0x28];                                      // 0x0068(0x0028)
...
{
public:
	uint8                                         Pad_68[0x48];                                      // 0x0068(0x0048)
...
{
public:
	TMulticastInlineDelegate<void(const struct FTransform& PredictedTransform)> Result;              // 0x0030(0x0010)
	TMulticastInlineDelegate<void()>              Failure;                                           // 0x0040(0x0010)
...
{
public:
	uint8                                         Pad_68[0x60];                                      // 0x0068(0x0060)
...
{
public:
	uint8                                         Pad_40[0xA8];                                      // 0x0040(0x00A8)
...
{
public:
	uint8                                         Pad_40[0x88];                                      // 0x0040(0x0088)
...
{
public:
	TArray<class UMovieSceneSection*>             ConstraintSections;                                // 0x00F8(0x0010)
...
public:
	...
	TSubclassOf<class UMovieSceneBlenderSystem>   BlenderSystemClass;                                // 0x0130(0x0008)
...
{
public:
	TArray<class UMovieSceneSection*>             AudioSections;                                     // 0x00F8(0x0010)
...
{
public:
	class UEnum*                                  Enum;                                              // 0x0128(0x0008)
...
{
public:
	bool                                          bCanBlend;                                         // 0x00F8(0x0001)
	uint8                                         Pad_F9[0x7];                                       // 0x00F9(0x0007)
	TArray<class UMovieSceneSection*>             Sections;                                          // 0x0100(0x0010)
	bool                                          bAutoArrangeSections;                              // 0x0110(0x0001)
...
{
public:
	TArray<class UMovieSceneSection*>             CameraShakeSections;                               // 0x00F8(0x0010)
...
{
public:
	bool                                          bIsSlateColor;                                     // 0x0128(0x0001)
...
public:
	uint8                                         Pad_F8[0x10];                                      // 0x00F8(0x0010)
	TArray<class UMovieSceneSection*>             Sections;                                          // 0x0108(0x0010)
	class UMovieSceneSection*                     SectionToKey;                                      // 0x0118(0x0008)
...
public:
	uint8                                         Pad_F8[0x10];                                      // 0x00F8(0x0010)
	uint8                                         bFireEventsWhenForwards : 1;                       // 0x0108(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bFireEventsWhenBackwards : 1;                      // 0x0108(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_109[0x3];                                      // 0x0109(0x0003)
	EFireEventsAtPosition                         EventPosition;                                     // 0x010C(0x0001)
	uint8                                         Pad_10D[0x3];                                      // 0x010D(0x0003)
	TArray<class UMovieSceneSection*>             Sections;                                          // 0x0110(0x0010)
...
public:
	...
	class UMaterialParameterCollection*           MPC;                                               // 0x0120(0x0008)
...
public:
	uint8                                         Pad_110[0x10];                                     // 0x0110(0x0010)
	struct FComponentMaterialInfo                 MaterialInfo;                                      // 0x0120(0x0010)
...
{
public:
	TSubclassOf<class UObject>                    PropertyClass;                                     // 0x0128(0x0008)
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)
	TArray<class UMovieSceneSection*>             ParticleSections;                                  // 0x0100(0x0010)
...
{
public:
	struct FComponentMaterialInfo                 MaterialInfo;                                      // 0x0128(0x0010)
...
{
public:
	TArray<class UMovieSceneSection*>             AnimationSections;                                 // 0x00F8(0x0010)
	bool                                          bUseLegacySectionIndexBlend;                       // 0x0108(0x0001)
	uint8                                         Pad_109[0x7];                                      // 0x0109(0x0007)
	struct FMovieSceneSkeletalAnimRootMotionTrackParams RootMotionParams;                            // 0x0110(0x0080)
	bool                                          bBlendFirstChildOfRoot;                            // 0x0190(0x0001)
	ESwapRootBone                                 SwapRootBone;                                      // 0x0191(0x0001)
	uint8                                         Pad_192[0xE];                                      // 0x0192(0x000E)
...
{
public:
	int32                                         NumChannelsUsed;                                   // 0x0128(0x0004)
	uint8                                         Pad_12C[0x4];                                      // 0x012C(0x0004)
