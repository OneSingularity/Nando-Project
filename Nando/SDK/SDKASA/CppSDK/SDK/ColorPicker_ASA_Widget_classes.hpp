...
public:
	...
	class UBorder*                                Border_0;                                          // 0x0380(0x0008)
	class UImage*                                 FakeImage;                                         // 0x0388(0x0008)
	class UImage*                                 Image_27;                                          // 0x0390(0x0008)
	class USynth2DSlider*                         Synth2DSlider_89;                                  // 0x0398(0x0008)
	class UMaterialInstanceDynamic*               SliderMat;                                         // 0x03A0(0x0008)
	struct FLinearColor                           Linear_Color;                                      // 0x03A8(0x0010)
	class UMaterialInterface*                     MaterialToPickColor;                               // 0x03B8(0x0008)
	class UTextureRenderTarget2D*                 Texture_Render_Target;                             // 0x03C0(0x0008)
	double                                        LastTimeUpdateRender;                              // 0x03C8(0x0008)
	class UTexture2D*                             FakeTextureToShow;                                 // 0x03D0(0x0008)
	double                                        LastReadRenderPixelTime;                           // 0x03D8(0x0008)
	double                                        ReadRenderTargetPixelInterval;                     // 0x03E0(0x0008)
