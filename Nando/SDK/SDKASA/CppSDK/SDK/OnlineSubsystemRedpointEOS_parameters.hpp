...
{
public:
	class UEOSUserInterface_EnterDevicePinCode_Context* Context;                                     // 0x0000(0x0008)
	class FString                                 VerificationUrl;                                   // 0x0008(0x0010)
	class FString                                 PinCode;                                           // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FEOSUserInterface_CandidateEOSAccount> SelectedCandidates_0;                       // 0x0000(0x0010)
};
...
{
public:
	class UEOSUserInterface_LinkEOSAccountsAgainstCrossPlatform_Context* Context;                    // 0x0000(0x0008)
	TArray<struct FEOSUserInterface_CandidateEOSAccount> AvailableCandidates;                        // 0x0008(0x0010)
};
...
{
public:
	struct FEOSUserInterface_CandidateEOSAccount  SelectedCandidate;                                 // 0x0000(0x00C0)
};
...
{
public:
	class UEOSUserInterface_SelectEOSAccount_Context* Context;                                       // 0x0000(0x0008)
	TArray<struct FEOSUserInterface_CandidateEOSAccount> AvailableCandidates;                        // 0x0008(0x0010)
};
...
{
public:
	EEOSUserInterface_SignInOrCreateAccount_Choice SelectedChoice;                                   // 0x0000(0x0001)
};
...
{
public:
	class UEOSUserInterface_SignInOrCreateAccount_Context* Context;                                  // 0x0000(0x0008)
};
...
{
public:
	EEOSUserInterface_SwitchToCrossPlatformAccount_Choice SelectedChoice;                            // 0x0000(0x0001)
};
...
{
public:
	class UEOSUserInterface_SwitchToCrossPlatformAccount_Context* Context;                           // 0x0000(0x0008)
	class FString                                 EpicAccountName;                                   // 0x0008(0x0010)
};
