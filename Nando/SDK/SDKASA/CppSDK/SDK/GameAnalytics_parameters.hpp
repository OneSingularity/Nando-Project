...
{
public:
	EGAAdAction                                   action;                                            // 0x0000(0x0001)
	EGAAdType                                     adType;                                            // 0x0001(0x0001)
	uint8                                         Pad_2[0x6];                                        // 0x0002(0x0006)
	class FString                                 adSdkName;                                         // 0x0008(0x0010)
	class FString                                 adPlacement;                                       // 0x0018(0x0010)
};
...
public:
	...
	class FString                                 adPlacement;                                       // 0x0018(0x0010)
	int64                                         Duration;                                          // 0x0028(0x0008)
	TArray<struct FGameAnalyticsCustomEventField> CustomFields;                                      // 0x0030(0x0010)
};
...
public:
	...
	class FString                                 adSdkName;                                         // 0x0008(0x0010)
	class FString                                 adPlacement;                                       // 0x0018(0x0010)
	TArray<struct FGameAnalyticsCustomEventField> CustomFields;                                      // 0x0028(0x0010)
};
...
public:
	...
	class FString                                 adSdkName;                                         // 0x0008(0x0010)
	class FString                                 adPlacement;                                       // 0x0018(0x0010)
	EGAAdError                                    noAdReason;                                        // 0x0028(0x0001)
...
{
public:
	class FString                                 Currency;                                          // 0x0000(0x0010)
	int32                                         Amount;                                            // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	class FString                                 ItemType;                                          // 0x0018(0x0010)
	class FString                                 ItemID;                                            // 0x0028(0x0010)
	class FString                                 CartType;                                          // 0x0038(0x0010)
};
...
public:
	...
	class FString                                 ItemID;                                            // 0x0028(0x0010)
	class FString                                 CartType;                                          // 0x0038(0x0010)
	TArray<struct FGameAnalyticsCustomEventField> CustomFields;                                      // 0x0048(0x0010)
};
...
public:
	...
	class FString                                 ItemID;                                            // 0x0028(0x0010)
	class FString                                 CartType;                                          // 0x0038(0x0010)
	class FString                                 Receipt;                                           // 0x0048(0x0010)
	class FString                                 Signature;                                         // 0x0058(0x0010)
};
...
public:
	...
	class FString                                 Receipt;                                           // 0x0048(0x0010)
	class FString                                 Signature;                                         // 0x0058(0x0010)
	TArray<struct FGameAnalyticsCustomEventField> CustomFields;                                      // 0x0068(0x0010)
};
...
public:
	...
	class FString                                 CartType;                                          // 0x0038(0x0010)
	class FString                                 Receipt;                                           // 0x0048(0x0010)
	TArray<struct FGameAnalyticsCustomEventField> CustomFields;                                      // 0x0058(0x0010)
};
...
public:
	class FString                                 EventId;                                           // 0x0000(0x0010)
	TArray<struct FGameAnalyticsCustomEventField> CustomFields;                                      // 0x0010(0x0010)
};
...
public:
	...
	float                                         Value;                                             // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	TArray<struct FGameAnalyticsCustomEventField> CustomFields;                                      // 0x0018(0x0010)
};
...
{
public:
	EGAErrorSeverity                              Severity;                                          // 0x0000(0x0001)
...
{
public:
	EGAProgressionStatus                          ProgressionStatus;                                 // 0x0000(0x0001)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)
	class FString                                 Progression01;                                     // 0x0008(0x0010)
};
...
public:
	...
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)
	class FString                                 Progression01;                                     // 0x0008(0x0010)
	class FString                                 Progression02;                                     // 0x0018(0x0010)
};
...
public:
	...
	int32                                         score;                                             // 0x0018(0x0004)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	TArray<struct FGameAnalyticsCustomEventField> CustomFields;                                      // 0x0020(0x0010)
};
...
public:
	...
	class FString                                 Progression01;                                     // 0x0008(0x0010)
	class FString                                 Progression02;                                     // 0x0018(0x0010)
	class FString                                 Progression03;                                     // 0x0028(0x0010)
};
...
public:
	...
	class FString                                 Progression02;                                     // 0x0018(0x0010)
	class FString                                 Progression03;                                     // 0x0028(0x0010)
	TArray<struct FGameAnalyticsCustomEventField> CustomFields;                                      // 0x0038(0x0010)
};
...
public:
	...
	int32                                         score;                                             // 0x0038(0x0004)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
	TArray<struct FGameAnalyticsCustomEventField> CustomFields;                                      // 0x0040(0x0010)
};
...
{
public:
	EGAResourceFlowType                           FlowType;                                          // 0x0000(0x0001)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)
	class FString                                 Currency;                                          // 0x0008(0x0010)
	float                                         Amount;                                            // 0x0018(0x0004)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	class FString                                 ItemType;                                          // 0x0020(0x0010)
	class FString                                 ItemID;                                            // 0x0030(0x0010)
};
...
{
public:
	class FString                                 CustomDimension;                                   // 0x0000(0x0010)
};
