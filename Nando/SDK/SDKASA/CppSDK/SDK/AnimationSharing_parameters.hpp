...
{
public:
	class UEnum*                                  ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	int32                                         OutState;                                          // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	class AActor*                                 InActor;                                           // 0x0008(0x0008)
	uint8                                         CurrentState;                                      // 0x0010(0x0001)
	uint8                                         OnDemandState;                                     // 0x0011(0x0001)
	bool                                          bShouldProcess;                                    // 0x0012(0x0001)
...
public:
	...
	const class UAnimationSharingSetup*           Setup;                                             // 0x0008(0x0008)
...
public:
	class UObject*                                WorldContextObject;                                // 0x0000(0x0008)
	class UAnimationSharingManager*               ReturnValue;                                       // 0x0008(0x0008)
};

// Function AnimationSharing.AnimationSharingManager.RegisterActorWithSkeletonAndTagBP
// 0x0018 (0x0018 - 0x0000)
struct AnimationSharingManager_RegisterActorWithSkeletonAndTagBP final
{
public:
	class AActor*                                 InActor;                                           // 0x0000(0x0008)
	const class USkeleton*                        SharingSkeleton;                                   // 0x0008(0x0008)
...
// 0x0008 (0x0008 - 0x0000)
struct AnimationSharingManager_UnregisterActor final
{
public:
	class AActor*                                 InActor;                                           // 0x0000(0x0008)
};
