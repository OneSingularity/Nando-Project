...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0C3EB1C0;
	constexpr int32 AppendString      = 0x01675600;
	constexpr int32 GetNameEntry      = 0x01676330;
	constexpr int32 GNames            = 0x0C7864C0;
	constexpr int32 GWorld            = 0x0C74CE88;
	constexpr int32 ProcessEvent      = 0x018C17E0;
...
public:
	...
	static constexpr int32                        ElementsPerChunk = 0x10000;                        // 0x0000(0x0004)

	struct FUObjectItem**                         Objects;                                           // 0x0000(0x0008)
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	int32                                         MaxElements;                                       // 0x0010(0x0004)
	int32                                         NumElements;                                       // 0x0014(0x0004)
	int32                                         MaxChunks;                                         // 0x0018(0x0004)
	int32                                         NumChunks;                                         // 0x001C(0x0004)
...
{
public:
	static inline void*                           AppendString = nullptr;                            // 0x0000(0x0004)
	static inline void*                           GetNameEntryFromName = nullptr;                    // 0x0000(0x0008)

	int32                                         ComparisonIndex = 0x0;                             // 0x0000(0x0004)
	uint32                                        Number = 0x0;                                      // 0x0004(0x0004)
...
{
public:
	FStructBaseChain**                            StructBaseChainArray;                              // 0x0000(0x0008)
	int32                                         NumStructBasesInChainMinusOne;                     // 0x0008(0x0004)
};
...
public:
	...
	class FString                                 TextSource;                                        // 0x0018(0x0010)
};
}
...
{
public:
	class FTextImpl::FTextData*                   TextData;                                          // 0x0000(0x0008)
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
...
{
public:
	int32                                         ObjectIndex;                                       // 0x0000(0x0004)
	int32                                         ObjectSerialNumber;                                // 0x0004(0x0004)
...
{
public:
	uint32                                        A;                                                 // 0x0000(0x0004)
	uint32                                        B;                                                 // 0x0004(0x0004)
	uint32                                        C;                                                 // 0x0008(0x0004)
	uint32                                        D;                                                 // 0x000C(0x0004)
};
...
{
public:
	FWeakObjectPtr                                WeakPtr;                                           // 0x0000(0x0008)
	TObjectID                                     ObjectID;                                          // 0x0008(0x0000)
...
{
public:
	UObject*                                      ObjectPointer;                                     // 0x0000(0x0008)
...
{
public:
	class FField*                                 ResolvedField;                                     // 0x0000(0x0008)
	TWeakObjectPtr<class UStruct>                 ResolvedOwner;                                     // 0x0008(0x0008)
	TArray<FName>                                 Path;                                              // 0x0010(0x0010)
};
...
{
public:
	FWeakObjectPtr                                Object;                                            // 0x0000(0x0008)
...
{
public:
	struct InvalidUseOfTDelegate                  TemplateParamIsNotAFunctionSignature;              // 0x0000(0x0000)
...
{
public:
	FScriptDelegate                               BoundFunction;                                     // 0x0000(0x0010)
};
...
{
public:
	struct InvalidUseOfTMulticastInlineDelegate   TemplateParamIsNotAFunctionSignature;              // 0x0000(0x0010)
};
...
{
public:
	TArray<FScriptDelegate>                       InvocationList;                                    // 0x0000(0x0010)
};
...
public:
	...
	uint64                                        Id;                                                // 0x0008(0x0008)
	uint64                                        CastFlags;                                         // 0x0010(0x0008)
	EClassFlags                                   ClassFlags;                                        // 0x0018(0x0004)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	class FFieldClass*                            SuperClass;                                        // 0x0020(0x0008)
};
...
public:
	...
	static constexpr uint64                       UObjectMask = 0x1;                                 // 0x0000(0x0001)

	ContainerType                                 Container;                                         // 0x0000(0x0008)
};
...
public:
	...
	class FFieldClass*                            ClassPrivate;                                      // 0x0008(0x0008)
	FFieldVariant                                 Owner;                                             // 0x0010(0x0008)
	class FField*                                 Next;                                              // 0x0018(0x0008)
	FName                                         Name;                                              // 0x0020(0x0008)
	int32                                         ObjFlags;                                          // 0x0028(0x0004)
};
...
{
public:
	int32                                         ArrayDim;                                          // 0x0030(0x0004)
	int32                                         ElementSize;                                       // 0x0034(0x0004)
	uint64                                        PropertyFlags;                                     // 0x0038(0x0008)
	uint8                                         Pad_40[0x4];                                       // 0x0040(0x0004)
	int32                                         Offset;                                            // 0x0044(0x0004)
...
{
public:
	class UEnum*                                  Enum;                                              // 0x0070(0x0008)
};
...
{
public:
	uint8                                         FieldSize;                                         // 0x0070(0x0001)
	uint8                                         ByteOffset;                                        // 0x0071(0x0001)
	uint8                                         ByteMask;                                          // 0x0072(0x0001)
	uint8                                         FieldMask;                                         // 0x0073(0x0001)
};
...
{
public:
	class UClass*                                 PropertyClass;                                     // 0x0070(0x0008)
};
...
{
public:
	class UClass*                                 MetaClass;                                         // 0x0078(0x0008)
};
...
{
public:
	class UStruct*                                Struct;                                            // 0x0070(0x0008)
};
...
public:
	...
	class FProperty*                              InnerProperty;                                     // 0x0078(0x0008)
};
...
{
public:
	class UFunction*                              SignatureFunction;                                 // 0x0070(0x0008)
};
...
{
public:
	class FProperty*                              KeyProperty;                                       // 0x0070(0x0008)
	class FProperty*                              ValueProperty;                                     // 0x0078(0x0008)
};
...
{
public:
	class FProperty*                              ElementProperty;                                   // 0x0070(0x0008)
};
...
{
public:
	class FProperty*                              UnderlayingProperty;                               // 0x0070(0x0008)
...
{
public:
	class FFieldClass*                            FieldClass;                                        // 0x0070(0x0008)
};
...
{
public:
	class FProperty*                              ValueProperty;                                     // 0x0070(0x0008)
};
