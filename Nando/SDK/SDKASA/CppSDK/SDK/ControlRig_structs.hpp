...
public:
	...
	class FString                                 Content;                                           // 0x0010(0x0010)
	TArray<struct FRigElementKey>                 Parents;                                           // 0x0020(0x0010)
	TArray<struct FRigElementWeight>              ParentWeights;                                     // 0x0030(0x0010)
	TArray<struct FTransform>                     Poses;                                             // 0x0040(0x0010)
	TArray<bool>                                  DirtyStates;                                       // 0x0050(0x0010)
};
...
{
public:
	uint8                                         Pad_110[0xD0];                                     // 0x0110(0x00D0)
};
...
public:
	...
	struct FControlRigExecuteContext              ExecuteContext;                                    // 0x0010(0x01E0)
};
...
public:
	struct FRigElementKey                         Key;                                               // 0x0000(0x000C)
	uint16                                        Index;                                             // 0x000C(0x0002)
	uint8                                         Pad_E[0x2];                                        // 0x000E(0x0002)
	int32                                         ContainerVersion;                                  // 0x0010(0x0004)
...
{
public:
	struct FRigElementKey                         Child;                                             // 0x01F0(0x000C)
	bool                                          bMaintainOffset;                                   // 0x01FC(0x0001)
	struct FTransformFilter                       Filter;                                            // 0x01FD(0x0009)
	uint8                                         Pad_206[0x2];                                      // 0x0206(0x0002)
	TArray<struct FConstraintParent>              Parents;                                           // 0x0208(0x0010)
	struct FRigUnit_ParentConstraint_AdvancedSettings AdvancedSettings;                              // 0x0218(0x0002)
	uint8                                         Pad_21A[0x2];                                      // 0x021A(0x0002)
	float                                         Weight;                                            // 0x021C(0x0004)
	struct FCachedRigElement                      ChildCache;                                        // 0x0220(0x0020)
	TArray<struct FCachedRigElement>              ParentCaches;                                      // 0x0240(0x0010)
};
...
{
public:
	class FName                                   Space;                                             // 0x0008(0x0008)
...
{
public:
	struct FRigControlLimitEnabled                LimitX;                                            // 0x0000(0x0002)
	struct FRigControlLimitEnabled                LimitY;                                            // 0x0002(0x0002)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FVector2D                              MinValue;                                          // 0x0008(0x0010)
	struct FVector2D                              MaxValue;                                          // 0x0018(0x0010)
...
{
public:
	struct FTransform                             Transform;                                         // 0x01F0(0x0060)
	struct FLinearColor                           Color;                                             // 0x0250(0x0010)
	float                                         Scale;                                             // 0x0260(0x0004)
	float                                         Thickness;                                         // 0x0264(0x0004)
	struct FRigElementKey                         Space;                                             // 0x0268(0x000C)
	uint8                                         Pad_274[0xC];                                      // 0x0274(0x000C)
	struct FTransform                             WorldOffset;                                       // 0x0280(0x0060)
	bool                                          bEnabled;                                          // 0x02E0(0x0001)
	uint8                                         Pad_2E1[0xF];                                      // 0x02E1(0x000F)
};
...
{
public:
	class FName                                   Control;                                           // 0x0000(0x0008)
	int32                                         IntegerValue;                                      // 0x0008(0x0004)
};
...
{
public:
	TArray<struct FRigUnit_SetMultiControlInteger_Entry> Entries;                                    // 0x01F0(0x0010)
	float                                         Weight;                                            // 0x0200(0x0004)
	uint8                                         Pad_204[0x4];                                      // 0x0204(0x0004)
	TArray<struct FCachedRigElement>              CachedControlIndices;                              // 0x0208(0x0010)
...
{
public:
	struct FSoftComponentReference                ComponentReference;                                // 0x0000(0x0048)
	int32                                         TransformIndex;                                    // 0x0048(0x0004)
	class FName                                   TransformName;                                     // 0x004C(0x0008)
	ERigElementType                               ElementType;                                       // 0x0054(0x0001)
	uint8                                         Pad_55[0x3];                                       // 0x0055(0x0003)
	class FName                                   ElementName;                                       // 0x0058(0x0008)
	EControlRigComponentMapDirection              Direction;                                         // 0x0060(0x0001)
	uint8                                         Pad_61[0xF];                                       // 0x0061(0x000F)
	struct FTransform                             Offset;                                            // 0x0070(0x0060)
	...
	int32                                         ElementIndex;                                      // 0x00E0(0x0004)
	int32                                         SubIndex;                                          // 0x00E4(0x0004)
...
{
public:
	TArray<struct FRigElementKey>                 Keys;                                              // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FRigElementKey>                 AvailableSpaces;                                   // 0x0000(0x0010)
	TArray<struct FRigElementKey>                 RemovedSpaces;                                     // 0x0010(0x0010)
};
...
public:
	...
	float                                         Float00_2;                                         // 0x0040(0x0004)
	float                                         Float01_2;                                         // 0x0044(0x0004)
	float                                         Float02_2;                                         // 0x0048(0x0004)
	float                                         Float03_2;                                         // 0x004C(0x0004)
	float                                         Float10_2;                                         // 0x0050(0x0004)
	float                                         Float11_2;                                         // 0x0054(0x0004)
	float                                         Float12_2;                                         // 0x0058(0x0004)
	float                                         Float13_2;                                         // 0x005C(0x0004)
	float                                         Float20_2;                                         // 0x0060(0x0004)
	float                                         Float21_2;                                         // 0x0064(0x0004)
	float                                         Float22_2;                                         // 0x0068(0x0004)
	float                                         Float23_2;                                         // 0x006C(0x0004)
	float                                         Float30_2;                                         // 0x0070(0x0004)
	float                                         Float31_2;                                         // 0x0074(0x0004)
	float                                         Float32_2;                                         // 0x0078(0x0004)
	float                                         Float33_2;                                         // 0x007C(0x0004)
...
public:
	...
	class FName                                   DisplayName;                                       // 0x0004(0x0008)
	ERigControlAxis                               PrimaryAxis;                                       // 0x000C(0x0001)
	bool                                          bIsCurve;                                          // 0x000D(0x0001)
	uint8                                         Pad_E[0x2];                                        // 0x000E(0x0002)
	TArray<struct FRigControlLimitEnabled>        LimitEnabled;                                      // 0x0010(0x0010)
	bool                                          bDrawLimits;                                       // 0x0020(0x0001)
	uint8                                         Pad_21[0x3];                                       // 0x0021(0x0003)
	struct FRigControlValue                       MinimumValue;                                      // 0x0024(0x0084)
	struct FRigControlValue                       MaximumValue;                                      // 0x00A8(0x0084)
	bool                                          bShapeVisible;                                     // 0x012C(0x0001)
	ERigControlVisibility                         ShapeVisibility;                                   // 0x012D(0x0001)
	uint8                                         Pad_12E[0x2];                                      // 0x012E(0x0002)
	class FName                                   ShapeName;                                         // 0x0130(0x0008)
	struct FLinearColor                           ShapeColor;                                        // 0x0138(0x0010)
	bool                                          bIsTransientControl;                               // 0x0148(0x0001)
	uint8                                         Pad_149[0x7];                                      // 0x0149(0x0007)
	class UEnum*                                  ControlEnum;                                       // 0x0150(0x0008)
	struct FRigControlElementCustomization        Customization;                                     // 0x0158(0x0020)
	TArray<struct FRigElementKey>                 DrivenControls;                                    // 0x0178(0x0010)
...
{
public:
	class FName                                   bone;                                              // 0x01F0(0x0008)
	struct FVector                                Translation;                                       // 0x01F8(0x0018)
	ERigVMTransformSpace                          Space;                                             // 0x0210(0x0001)
	...
	struct FCachedRigElement                      CachedBone;                                        // 0x0220(0x0020)
};
...
{
public:
	TArray<struct FRigHierarchyCopyPasteContentPerElement> Elements;                                 // 0x0000(0x0010)
	TArray<ERigElementType>                       Types;                                             // 0x0010(0x0010)
	TArray<class FString>                         Contents;                                          // 0x0020(0x0010)
	TArray<struct FTransform>                     LocalTransforms;                                   // 0x0030(0x0010)
	TArray<struct FTransform>                     GlobalTransforms;                                  // 0x0040(0x0010)
};
...
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)
	struct FRigElementKey                         Key;                                               // 0x0010(0x000C)
	int32                                         Index;                                             // 0x001C(0x0004)
	int32                                         SubIndex;                                          // 0x0020(0x0004)
	int32                                         CreatedAtInstructionIndex;                         // 0x0024(0x0004)
...
{
public:
	uint8                                         Pad_48[0xC0];                                      // 0x0048(0x00C0)
};
...
public:
	...
	struct FTransform                             GlobalTransform;                                   // 0x0020(0x0060)
	struct FTransform                             LocalTransform;                                    // 0x0080(0x0060)
	struct FVector                                PreferredEulerAngle;                               // 0x00E0(0x0018)
	struct FRigElementKey                         ActiveParent;                                      // 0x00F8(0x000C)
...
{
public:
	TArray<struct FRigPoseElement>                Elements;                                          // 0x0000(0x0010)
	int32                                         HierarchyTopologyVersion;                          // 0x0010(0x0004)
	int32                                         PoseHash;                                          // 0x0014(0x0004)
...
public:
	...
	TArray<struct FRigElementKey>                 Items;                                             // 0x0080(0x0010)
};
...
{
public:
	uint8                                         Pad_108[0x108];                                    // 0x0108(0x0108)
};
...
{
public:
	class FName                                   Control;                                           // 0x01F0(0x0008)
	int32                                         Weight;                                            // 0x01F8(0x0004)
	int32                                         IntegerValue;                                      // 0x01FC(0x0004)
	struct FCachedRigElement                      CachedControlIndex;                                // 0x0200(0x0020)
};
...
public:
	...
	struct FVector                                Current;                                           // 0x0008(0x0018)
	struct FVector                                Initial;                                           // 0x0020(0x0018)
};
...
{
public:
	struct FRigControlSettings                    Settings;                                          // 0x0210(0x01B8)
	struct FRigPreferredEulerAngles               PreferredEulerAngles;                              // 0x03C8(0x0038)
	uint8                                         Pad_400[0x100];                                    // 0x0400(0x0100)
};
...
public:
	...
	class FName                                   CPPType;                                           // 0x0008(0x0008)
...
public:
	struct FRigElementKey                         Child;                                             // 0x01F0(0x000C)
	struct FRigElementKey                         Parent;                                            // 0x01FC(0x000C)
...
{
public:
	TArray<struct FRigElementKey>                 Items;                                             // 0x0008(0x0010)
	ERigVMTransformSpace                          Space;                                             // 0x0018(0x0001)
	bool                                          bInitial;                                          // 0x0019(0x0001)
	uint8                                         Pad_1A[0x6];                                       // 0x001A(0x0006)
	TArray<struct FTransform>                     Transforms;                                        // 0x0020(0x0010)
	TArray<struct FCachedRigElement>              CachedIndex;                                       // 0x0030(0x0010)
};
...
{
public:
	ERigBoneType                                  BoneType;                                          // 0x0110(0x0001)
	uint8                                         Pad_111[0x7];                                      // 0x0111(0x0007)
};
...
{
public:
	class FString                                 ScriptStructPath;                                  // 0x0000(0x0010)
	class FString                                 ExportedText;                                      // 0x0010(0x0010)
};
...
{
public:
	class FString                                 Description;                                       // 0x0000(0x0010)
	EConnectorType                                Type;                                              // 0x0010(0x0001)
	bool                                          bOptional;                                         // 0x0011(0x0001)
	uint8                                         Pad_12[0x6];                                       // 0x0012(0x0006)
	TArray<struct FRigConnectionRuleStash>        Rules;                                             // 0x0018(0x0010)
};
...
public:
	class FString                                 Name;                                              // 0x0000(0x0010)
	struct FRigConnectorSettings                  Settings;                                          // 0x0010(0x0028)
};
...
{
public:
	struct FRigModuleIdentifier                   Identifier;                                        // 0x0000(0x0020)
	struct FSoftObjectPath                        Icon;                                              // 0x0020(0x0020)
	class FString                                 Category;                                          // 0x0040(0x0010)
	class FString                                 Keywords;                                          // 0x0050(0x0010)
	class FString                                 Description;                                       // 0x0060(0x0010)
	TArray<struct FRigModuleConnector>            ExposedConnectors;                                 // 0x0070(0x0010)
};
...
public:
	struct FRigElementKey                         Key;                                               // 0x0000(0x000C)
	ERigTransformStackEntryType                   EntryType;                                         // 0x000C(0x0001)
	ERigTransformType                             TransformType;                                     // 0x000D(0x0001)
	uint8                                         Pad_E[0x2];                                        // 0x000E(0x0002)
	struct FTransform                             OldTransform;                                      // 0x0010(0x0060)
	struct FTransform                             NewTransform;                                      // 0x0070(0x0060)
	bool                                          bAffectChildren;                                   // 0x00D0(0x0001)
	uint8                                         Pad_D1[0x7];                                       // 0x00D1(0x0007)
	TArray<class FString>                         Callstack;                                         // 0x00D8(0x0010)
	uint8                                         Pad_E8[0x8];                                       // 0x00E8(0x0008)
};

// ScriptStruct ControlRig.RigElementParentConstraint
// 0x0090 (0x0090 - 0x0000)
struct FRigElementParentConstraint final
{
public:
	uint8                                         Pad_0[0x90];                                       // 0x0000(0x0090)
};
...
public:
	struct FRigElementKey                         Child;                                             // 0x01F0(0x000C)
	bool                                          bMaintainOffset;                                   // 0x01FC(0x0001)
	struct FFilterOptionPerAxis                   Filter;                                            // 0x01FD(0x0003)
	TArray<struct FConstraintParent>              Parents;                                           // 0x0200(0x0010)
	float                                         Weight;                                            // 0x0210(0x0004)
	uint8                                         Pad_214[0x4];                                      // 0x0214(0x0004)
	struct FCachedRigElement                      ChildCache;                                        // 0x0218(0x0020)
	TArray<struct FCachedRigElement>              ParentCaches;                                      // 0x0238(0x0010)
...
{
public:
	uint8                                         Pad_70[0x30];                                      // 0x0070(0x0030)
};
...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	TArray<struct FRigElementKey>                 AffectedList;                                      // 0x0010(0x0010)
};
...
public:
	...
	TArray<struct FRigInfluenceEntry>             Entries;                                           // 0x0008(0x0010)
	TMap<struct FRigElementKey, int32>            KeyToIndex;                                        // 0x0018(0x0050)
};
...
public:
	...
	struct FVector                                AlignVector;                                       // 0x0070(0x0018)
...
{
public:
	TArray<struct FConstraintData>                ConstraintData;                                    // 0x0000(0x0010)
};
...
{
public:
	class FName                                   Joint;                                             // 0x01F0(0x0008)
	EAimMode                                      AimMode;                                           // 0x01F8(0x0001)
	EAimMode                                      UpMode;                                            // 0x01F9(0x0001)
	uint8                                         Pad_1FA[0x6];                                      // 0x01FA(0x0006)
	struct FVector                                AimVector;                                         // 0x0200(0x0018)
	struct FVector                                UpVector;                                          // 0x0218(0x0018)
	TArray<struct FAimTarget>                     AimTargets;                                        // 0x0230(0x0010)
	TArray<struct FAimTarget>                     UpTargets;                                         // 0x0240(0x0010)
	struct FRigUnit_AimConstraint_WorkData        WorkData;                                          // 0x0250(0x0010)
};
...
{
public:
	struct FVector                                Argument0;                                         // 0x0008(0x0018)
	struct FVector                                Argument1;                                         // 0x0020(0x0018)
	struct FVector                                Result;                                            // 0x0038(0x0018)
};
...
{
public:
	class FName                                   Tag;                                               // 0x0008(0x0008)
	ERigMetaDataNameSpace                         NameSpace;                                         // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
	TArray<struct FRigElementKey>                 Items;                                             // 0x0018(0x0010)
};
...
{
public:
	class FName                                   InstructionName;                                   // 0x01F0(0x0008)
	struct FLinearColor                           Color;                                             // 0x01F8(0x0010)
	uint8                                         Pad_208[0x8];                                      // 0x0208(0x0008)
};
...
public:
	...
	bool                                          bDefaultParent;                                    // 0x0014(0x0001)
	...
	struct FCachedRigElement                      CachedParent;                                      // 0x0048(0x0020)
};
...
{
public:
	class FName                                   BlockToRun;                                        // 0x01F0(0x0008)
	struct FRigElementKeyCollection               Collection;                                        // 0x01F8(0x0010)
	struct FRigElementKey                         Item;                                              // 0x0208(0x000C)
	int32                                         Index;                                             // 0x0214(0x0004)
	int32                                         Count;                                             // 0x0218(0x0004)
	float                                         Ratio;                                             // 0x021C(0x0004)
	struct FControlRigExecuteContext              Completed;                                         // 0x0220(0x01E0)
};
...
{
public:
	TArray<struct FRigInfluenceMap>               Maps;                                              // 0x0000(0x0010)
	TMap<class FName, int32>                      EventToIndex;                                      // 0x0010(0x0050)
};
...
public:
	...
	class FName                                   BoneSpace;                                         // 0x007C(0x0008)
...
public:
	...
	TArray<struct FBoneReference>                 InputBonesToTransfer;                              // 0x0070(0x0010)
	TArray<struct FBoneReference>                 OutputBonesToTransfer;                             // 0x0080(0x0010)
	TArray<class UAssetUserData*>                 AssetUserData;                                     // 0x0090(0x0010)
	uint8                                         Pad_A0[0x50];                                      // 0x00A0(0x0050)
	TWeakObjectPtr<class UNodeMappingContainer>   NodeMappingContainer;                              // 0x00F0(0x0008)
	struct FControlRigIOSettings                  InputSettings;                                     // 0x00F8(0x0002)
	struct FControlRigIOSettings                  OutputSettings;                                    // 0x00FA(0x0002)
	uint8                                         Pad_FC[0x134];                                     // 0x00FC(0x0134)
	bool                                          bExecute;                                          // 0x0230(0x0001)
	uint8                                         Pad_231[0x7];                                      // 0x0231(0x0007)
	TArray<struct FControlRigAnimNodeEventName>   EventQueue;                                        // 0x0238(0x0010)
	uint8                                         Pad_248[0x10];                                     // 0x0248(0x0010)
};
...
{
public:
	int32                                         ProceduralElementLimit;                            // 0x0000(0x0004)
};
...
public:
	...
	class FString                                 ParentPath;                                        // 0x0010(0x0010)
	TMap<class FName, struct FRigVMExternalVariable> VariableBindings;                               // 0x0020(0x0050)
...
public:
	...
	struct FQuat                                  Rotation;                                          // 0x0200(0x0020)
	ERigVMTransformSpace                          Space;                                             // 0x0220(0x0001)
	uint8                                         Pad_221[0x3];                                      // 0x0221(0x0003)
	float                                         Weight;                                            // 0x0224(0x0004)
	bool                                          bPropagateToChildren;                              // 0x0228(0x0001)
	uint8                                         Pad_229[0x7];                                      // 0x0229(0x0007)
	struct FCachedRigElement                      CachedBone;                                        // 0x0230(0x0020)
};
...
public:
	...
	uint8                                         Pad_14[0xC];                                       // 0x0014(0x000C)
	struct FTransform                             InitialLocalTransform;                             // 0x0020(0x0060)
	struct FLinearColor                           Color;                                             // 0x0080(0x0010)
	class FString                                 Description;                                       // 0x0090(0x0010)
};
...
{
public:
	class FString                                 ModulePath;                                        // 0x0000(0x0010)
	uint8                                         Pad_10[0x8];                                       // 0x0010(0x0008)
	class FName                                   EventName;                                         // 0x0018(0x0008)
...
public:
	...
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	TArray<class FName>                           Tags;                                              // 0x0018(0x0010)
	struct FCachedRigElement                      CachedIndex;                                       // 0x0028(0x0020)
};
...
{
public:
	struct FRigConnectorSettings                  Settings;                                          // 0x0048(0x0028)
};
...
public:
	...
	struct FMovieSceneFloatChannel                Weight;                                            // 0x0020(0x0110)
	struct FMovieSceneEvaluationOperand           Operand;                                           // 0x0130(0x0014)
...
public:
	struct FRigElementKey                         Item;                                              // 0x0008(0x000C)
	class FName                                   Name;                                              // 0x0014(0x0008)
	...
	struct FCachedRigElement                      CachedIndex;                                       // 0x0020(0x0020)
};

// ScriptStruct ControlRig.RigTransformDirtyState
// 0x0010 (0x0010 - 0x0000)
struct FRigTransformDirtyState final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)
};
...
{
public:
	struct FRigTransformDirtyState                Global;                                            // 0x0000(0x0010)
	struct FRigTransformDirtyState                Local;                                             // 0x0010(0x0010)
};
...
{
public:
	struct FRigPhysicsSolverID                    Solver;                                            // 0x0110(0x0010)
	struct FRigPhysicsSettings                    Settings;                                          // 0x0120(0x0004)
...
{
public:
	struct FRigElementKey                         Subject;                                           // 0x01F0(0x000C)
	int32                                         ParentIndex;                                       // 0x01FC(0x0004)
	struct FRigElementKeyCollection               Parents;                                           // 0x0200(0x0010)
	struct FTransform                             InitialGlobalTransform;                            // 0x0210(0x0060)
	float                                         Weight;                                            // 0x0270(0x0004)
	uint8                                         Pad_274[0xC];                                      // 0x0274(0x000C)
	struct FTransform                             Transform;                                         // 0x0280(0x0060)
	bool                                          Switched;                                          // 0x02E0(0x0001)
	uint8                                         Pad_2E1[0x7];                                      // 0x02E1(0x0007)
	struct FCachedRigElement                      CachedSubject;                                     // 0x02E8(0x0020)
	struct FCachedRigElement                      CachedParent;                                      // 0x0308(0x0020)
	uint8                                         Pad_328[0x8];                                      // 0x0328(0x0008)
	struct FTransform                             RelativeOffset;                                    // 0x0330(0x0060)
};
...
{
public:
	struct FRigLocalAndGlobalDirtyState           Current;                                           // 0x0000(0x0020)
	struct FRigLocalAndGlobalDirtyState           Initial;                                           // 0x0020(0x0020)
};
...
{
public:
	struct FRigComputedTransform                  Local;                                             // 0x0000(0x0010)
	struct FRigComputedTransform                  Global;                                            // 0x0010(0x0010)
};
...
{
public:
	struct FRigLocalAndGlobalTransform            Current;                                           // 0x0000(0x0020)
	struct FRigLocalAndGlobalTransform            Initial;                                           // 0x0020(0x0020)
};
...
{
public:
	struct FRigElementKey                         Item;                                              // 0x01F0(0x000C)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	TArray<class FName>                           Tags;                                              // 0x0200(0x0010)
	ERigMetaDataNameSpace                         NameSpace;                                         // 0x0210(0x0001)
	uint8                                         Pad_211[0x7];                                      // 0x0211(0x0007)
	struct FCachedRigElement                      CachedIndex;                                       // 0x0218(0x0020)
...
{
public:
	struct FRigPhysicsSolverID                    ID;                                                // 0x0000(0x0010)
...
public:
	class FName                                   Name;                                              // 0x0000(0x0008)
	struct FRigElementKey                         ResolvedTarget;                                    // 0x0008(0x000C)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	struct FRigConnectorSettings                  Settings;                                          // 0x0018(0x0028)
};
...
public:
	...
	uint8                                         Pad_35[0xB];                                       // 0x0035(0x000B)
...
public:
	...
	TArray<struct FRigElementKey>                 Result;                                            // 0x0030(0x0010)
	TArray<struct FCachedRigElement>              CachedIndices;                                     // 0x0040(0x0010)
};

// ScriptStruct ControlRig.StructReference
// 0x0008 (0x0008 - 0x0000)
struct FStructReference final
{
public:
...
public:
	...
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             WorldOffset;                                       // 0x0010(0x0060)
};
...
{
public:
	struct FRigUnit_AimBone_DebugSettings         DebugSettings;                                     // 0x0000(0x0070)
...
{
public:
	struct FVector                                Target;                                            // 0x0000(0x0018)
	EControlRigVectorKind                         Kind;                                              // 0x0018(0x0001)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)
	struct FRigElementKey                         Space;                                             // 0x001C(0x000C)
};
...
public:
	...
	struct FVector                                UpAxis;                                            // 0x0218(0x0018)
	struct FRigUnit_AimConstraint_WorldUp         WorldUp;                                           // 0x0230(0x0028)
	TArray<struct FConstraintParent>              Parents;                                           // 0x0258(0x0010)
	uint8                                         Pad_268[0x8];                                      // 0x0268(0x0008)
	struct FRigUnit_AimConstraint_AdvancedSettings AdvancedSettings;                                 // 0x0270(0x0080)
	float                                         Weight;                                            // 0x02F0(0x0004)
	uint8                                         Pad_2F4[0x4];                                      // 0x02F4(0x0004)
	struct FCachedRigElement                      WorldUpSpaceCache;                                 // 0x02F8(0x0020)
	struct FCachedRigElement                      ChildCache;                                        // 0x0318(0x0020)
	TArray<struct FCachedRigElement>              ParentCaches;                                      // 0x0338(0x0010)
	bool                                          bIsInitialized;                                    // 0x0348(0x0001)
...
{
public:
	ERigEvent                                     Event;                                             // 0x01F0(0x0001)
	uint8                                         Pad_1F1[0x3];                                      // 0x01F1(0x0003)
	struct FRigElementKey                         Item;                                              // 0x01F4(0x000C)
	float                                         OffsetInSeconds;                                   // 0x0200(0x0004)
	bool                                          bEnable;                                           // 0x0204(0x0001)
	bool                                          bOnlyDuringInteraction;                            // 0x0205(0x0001)
	uint8                                         Pad_206[0xA];                                      // 0x0206(0x000A)
};
...
{
public:
	TSubclassOf<class UControlRig>                ControlRigClass;                                   // 0x0258(0x0008)
	TSubclassOf<class UControlRig>                DefaultControlRigClass;                            // 0x0260(0x0008)
	class UControlRig*                            ControlRig;                                        // 0x0268(0x0008)
	TMap<TSubclassOf<class UObject>, class UControlRig*> ControlRigPerClass;                         // 0x0270(0x0050)
	float                                         Alpha;                                             // 0x02C0(0x0004)
	EAnimAlphaInputType                           AlphaInputType;                                    // 0x02C4(0x0001)
	uint8                                         bAlphaBoolEnabled : 1;                             // 0x02C5(0x0001)(BitIndex: 0x00, PropSize: 0x0001)
	uint8                                         bSetRefPoseFromSkeleton : 1;                       // 0x02C5(0x0001)(BitIndex: 0x01, PropSize: 0x0001)
	uint8                                         Pad_2C6[0x2];                                      // 0x02C6(0x0002)
	struct FInputScaleBias                        AlphaScaleBias;                                    // 0x02C8(0x0008)
	struct FInputAlphaBoolBlend                   AlphaBoolBlend;                                    // 0x02D0(0x0048)
	class FName                                   AlphaCurveName;                                    // 0x0318(0x0008)
	struct FInputScaleBiasClamp                   AlphaScaleBiasClamp;                               // 0x0320(0x0030)
	TMap<class FName, class FName>                InputMapping;                                      // 0x0350(0x0050)
	TMap<class FName, class FName>                OutputMapping;                                     // 0x03A0(0x0050)
	uint8                                         Pad_3F0[0xB0];                                     // 0x03F0(0x00B0)
	int32                                         LODThreshold;                                      // 0x04A0(0x0004)
	uint8                                         Pad_4A4[0x3C];                                     // 0x04A4(0x003C)
};
...
{
public:
	TWeakObjectPtr<class UControlRig>             ControlRig;                                        // 0x0258(0x0008)
};
...
{
public:
	uint8                                         Pad_798[0xE8];                                     // 0x0798(0x00E8)
};
...
public:
	...
	class FName                                   ElementName;                                       // 0x0008(0x0008)
...
{
public:
	TArray<struct FRigUnit_SetMultiControlBool_Entry> Entries;                                       // 0x01F0(0x0010)
	TArray<struct FCachedRigElement>              CachedControlIndices;                              // 0x0200(0x0010)
};
...
{
public:
	class FName                                   Source;                                            // 0x0000(0x0008)
	class FName                                   Target;                                            // 0x0008(0x0008)
};
...
public:
	class FName                                   Control;                                           // 0x01F0(0x0008)
	TArray<struct FRigElementKey>                 Driven;                                            // 0x01F8(0x0010)
	struct FCachedRigElement                      CachedControlIndex;                                // 0x0208(0x0020)
	uint8                                         Pad_228[0x8];                                      // 0x0228(0x0008)
};

// ScriptStruct ControlRig.ControlShapeActorCreationParam
// 0x01C0 (0x01C0 - 0x0000)
struct FControlShapeActorCreationParam final
{
public:
	uint8                                         Pad_0[0x1C0];                                      // 0x0000(0x01C0)
};
...
{
public:
	class FName                                   ShapeName;                                         // 0x0000(0x0008)
	TSoftObjectPtr<class UStaticMesh>             StaticMesh;                                        // 0x0008(0x0028)
...
public:
	...
	TArray<struct FControlRigTestDataVariable>    Variables;                                         // 0x0010(0x0010)
...
public:
	...
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	struct FTransform                             Transform;                                         // 0x0200(0x0060)
	ERigVMTransformSpace                          Space;                                             // 0x0260(0x0001)
	uint8                                         Pad_261[0x7];                                      // 0x0261(0x0007)
	struct FCachedRigElement                      CachedControlIndex;                                // 0x0268(0x0020)
...
public:
	class FName                                   Control;                                           // 0x0000(0x0008)
	struct FVector2D                              Vector;                                            // 0x0008(0x0010)
};

// ScriptStruct ControlRig.ControlRigValidationContext
// 0x0028 (0x0028 - 0x0000)
struct FControlRigValidationContext final
{
public:
...
{
public:
	int32                                         SubjectA;                                          // 0x0000(0x0004)
	int32                                         SubjectB;                                          // 0x0004(0x0004)
...
public:
	class FName                                   Control;                                           // 0x0000(0x0008)
	struct FRotator                               Rotator;                                           // 0x0008(0x0018)
...
public:
	...
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	int32                                         SubjectA;                                          // 0x0004(0x0004)
	int32                                         SubjectB;                                          // 0x0008(0x0004)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	struct FVector                                DataA;                                             // 0x0010(0x0018)
	struct FVector                                DataB;                                             // 0x0028(0x0018)
};
...
public:
	...
	uint8                                         Pad_75[0xB];                                       // 0x0075(0x000B)
};
...
{
public:
	TArray<struct FRigVMSimPoint>                 Points;                                            // 0x0018(0x0010)
	TArray<struct FCRSimLinearSpring>             Springs;                                           // 0x0028(0x0010)
	TArray<struct FCRSimPointForce>               Forces;                                            // 0x0038(0x0010)
	TArray<struct FCRSimSoftCollision>            CollisionVolumes;                                  // 0x0048(0x0010)
	TArray<struct FCRSimPointConstraint>          Constraints;                                       // 0x0058(0x0010)
	TArray<struct FRigVMSimPoint>                 PreviousStep;                                      // 0x0068(0x0010)
};
...
{
public:
	class FName                                   SpaceName;                                         // 0x01F0(0x0008)
	uint8                                         Pad_1F8[0x8];                                      // 0x01F8(0x0008)
	struct FTransform                             Transform;                                         // 0x0200(0x0060)
	struct FTransform                             Result;                                            // 0x0260(0x0060)
	ERigVMTransformSpace                          Space;                                             // 0x02C0(0x0001)
	uint8                                         Pad_2C1[0x7];                                      // 0x02C1(0x0007)
	struct FCachedRigElement                      CachedSpaceIndex;                                  // 0x02C8(0x0020)
...
public:
	struct FRigElementKey                         Item;                                              // 0x01F0(0x000C)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	class FString                                 Pattern;                                           // 0x0200(0x0010)
	bool                                          bVisible;                                          // 0x0210(0x0001)
	uint8                                         Pad_211[0x7];                                      // 0x0211(0x0007)
	TArray<struct FCachedRigElement>              CachedControlIndices;                              // 0x0218(0x0010)
	uint8                                         Pad_228[0x8];                                      // 0x0228(0x0008)
};
...
public:
	class FName                                   Name;                                              // 0x0000(0x0008)
	class FString                                 ShortName;                                         // 0x0008(0x0010)
	bool                                          bShortNameBasedOnPath;                             // 0x0018(0x0001)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)
	class FString                                 ParentPath;                                        // 0x0020(0x0010)
	TSoftClassPtr<class UClass>                   Class;                                             // 0x0030(0x0028)
	TMap<struct FRigElementKey, struct FRigElementKey> Connections;                                  // 0x0058(0x0050)
	TMap<class FName, class FString>              ConfigValues;                                      // 0x00A8(0x0050)
	TMap<class FName, class FString>              Bindings;                                          // 0x00F8(0x0050)
	class FName                                   PreviousName;                                      // 0x0148(0x0008)
	class FString                                 PreviousParentPath;                                // 0x0150(0x0010)
	uint8                                         Pad_160[0x10];                                     // 0x0160(0x0010)
};
...
{
public:
	struct FRigElementKey                         Connector;                                         // 0x0000(0x000C)
	struct FRigElementKey                         Target;                                            // 0x000C(0x000C)
};
...
public:
	...
	float                                         Weight;                                            // 0x01F8(0x0004)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	struct FVector                                Vector;                                            // 0x0200(0x0018)
	ERigVMTransformSpace                          Space;                                             // 0x0218(0x0001)
	uint8                                         Pad_219[0x7];                                      // 0x0219(0x0007)
	struct FCachedRigElement                      CachedControlIndex;                                // 0x0220(0x0020)
};
...
{
public:
	TArray<struct FModularRigSingleConnection>    ConnectionList;                                    // 0x0000(0x0010)
	uint8                                         Pad_10[0x50];                                      // 0x0010(0x0050)
};
...
{
public:
	TArray<struct FRigModuleReference>            modules;                                           // 0x0000(0x0010)
	uint8                                         Pad_10[0x20];                                      // 0x0010(0x0020)
	struct FModularRigConnections                 Connections;                                       // 0x0030(0x0060)
...
public:
	struct FRigElementKey                         Child;                                             // 0x01F0(0x000C)
	struct FRigElementKey                         Parent;                                            // 0x01FC(0x000C)
	bool                                          bParentInitial;                                    // 0x0208(0x0001)
	uint8                                         Pad_209[0x7];                                      // 0x0209(0x0007)
	struct FVector                                Value;                                             // 0x0210(0x0018)
	float                                         Weight;                                            // 0x0228(0x0004)
	bool                                          bPropagateToChildren;                              // 0x022C(0x0001)
	uint8                                         Pad_22D[0x3];                                      // 0x022D(0x0003)
	struct FCachedRigElement                      CachedChild;                                       // 0x0230(0x0020)
	struct FCachedRigElement                      CachedParent;                                      // 0x0250(0x0020)
};
...
{
public:
	struct FTransform                             RelativeParent;                                    // 0x0000(0x0060)
	struct FConstraintOffset                      ConstraintOffset;                                  // 0x0060(0x00C0)
	class FName                                   LinkedNode;                                        // 0x0120(0x0008)
	TArray<struct FTransformConstraint>           Constraints;                                       // 0x0128(0x0010)
...
{
public:
	TArray<struct FConstraintNodeData>            UserData;                                          // 0x0078(0x0010)
};
...
public:
	struct FRigElementKey                         Item;                                              // 0x01F0(0x000C)
	class FName                                   Name;                                              // 0x01FC(0x0008)
	ERigMetaDataNameSpace                         NameSpace;                                         // 0x0204(0x0001)
	bool                                          Removed;                                           // 0x0205(0x0001)
	uint8                                         Pad_206[0x2];                                      // 0x0206(0x0002)
	struct FCachedRigElement                      CachedIndex;                                       // 0x0208(0x0020)
	uint8                                         Pad_228[0x8];                                      // 0x0228(0x0008)
};
...
{
public:
	class FName                                   ParentName;                                        // 0x0018(0x0008)
	int32                                         ParentIndex;                                       // 0x0020(0x0004)
	uint8                                         Pad_24[0xC];                                       // 0x0024(0x000C)
	struct FTransform                             InitialTransform;                                  // 0x0030(0x0060)
	struct FTransform                             GlobalTransform;                                   // 0x0090(0x0060)
	struct FTransform                             LocalTransform;                                    // 0x00F0(0x0060)
	TArray<int32>                                 Dependents;                                        // 0x0150(0x0010)
	ERigBoneType                                  Type;                                              // 0x0160(0x0001)
	uint8                                         Pad_161[0xF];                                      // 0x0161(0x000F)
};
...
public:
	...
	uint8                                         Pad_16[0xA];                                       // 0x0016(0x000A)
	struct FTransform                             Transform;                                         // 0x0020(0x0060)
...
{
public:
	TArray<struct FRigBone>                       Bones;                                             // 0x0000(0x0010)
};
...
public:
	class FName                                   bone;                                              // 0x01F0(0x0008)
	class FName                                   Space;                                             // 0x01F8(0x0008)
	struct FTransform                             Transform;                                         // 0x0200(0x0060)
	float                                         Weight;                                            // 0x0260(0x0004)
	bool                                          bPropagateToChildren;                              // 0x0264(0x0001)
	uint8                                         Pad_265[0x3];                                      // 0x0265(0x0003)
	struct FCachedRigElement                      CachedBone;                                        // 0x0268(0x0020)
	struct FCachedRigElement                      CachedSpaceIndex;                                  // 0x0288(0x0020)
...
{
public:
	TArray<struct FRigConnectionRuleStash>        ChildRules;                                        // 0x0008(0x0010)
};
...
public:
	...
	class FName                                   ParentName;                                        // 0x0024(0x0008)
	int32                                         ParentIndex;                                       // 0x002C(0x0004)
	class FName                                   SpaceName;                                         // 0x0030(0x0008)
	int32                                         SpaceIndex;                                        // 0x0038(0x0004)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
	struct FTransform                             OffsetTransform;                                   // 0x0040(0x0060)
	struct FRigControlValue                       InitialValue;                                      // 0x00A0(0x0084)
	struct FRigControlValue                       Value;                                             // 0x0124(0x0084)
	...
	struct FRigControlValue                       MinimumValue;                                      // 0x01B0(0x0084)
	struct FRigControlValue                       MaximumValue;                                      // 0x0234(0x0084)
	bool                                          bGizmoEnabled;                                     // 0x02B8(0x0001)
	bool                                          bGizmoVisible;                                     // 0x02B9(0x0001)
	uint8                                         Pad_2BA[0x2];                                      // 0x02BA(0x0002)
	class FName                                   GizmoName;                                         // 0x02BC(0x0008)
	uint8                                         Pad_2C4[0xC];                                      // 0x02C4(0x000C)
	struct FTransform                             GizmoTransform;                                    // 0x02D0(0x0060)
	struct FLinearColor                           GizmoColor;                                        // 0x0330(0x0010)
	TArray<int32>                                 Dependents;                                        // 0x0340(0x0010)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Value;                                             // 0x0010(0x0060)
	struct FTransform                             Global;                                            // 0x0070(0x0060)
};
...
{
public:
	TArray<struct FRigControl>                    Controls;                                          // 0x0000(0x0010)
};
...
public:
	struct FRigElementKey                         Item;                                              // 0x01F0(0x000C)
	ERigVMTransformSpace                          Space;                                             // 0x01FC(0x0001)
	bool                                          bInitial;                                          // 0x01FD(0x0001)
	uint8                                         Pad_1FE[0x2];                                      // 0x01FE(0x0002)
	struct FQuat                                  Value;                                             // 0x0200(0x0020)
	float                                         Weight;                                            // 0x0220(0x0004)
	bool                                          bPropagateToChildren;                              // 0x0224(0x0001)
	uint8                                         Pad_225[0x3];                                      // 0x0225(0x0003)
	struct FCachedRigElement                      CachedIndex;                                       // 0x0228(0x0020)
	uint8                                         Pad_248[0x8];                                      // 0x0248(0x0008)
};
...
{
public:
	TArray<struct FRigCurve>                      Curves;                                            // 0x0000(0x0010)
};
...
public:
	...
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)
	class FName                                   ParentName;                                        // 0x001C(0x0008)
	int32                                         ParentIndex;                                       // 0x0024(0x0004)
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	struct FTransform                             InitialTransform;                                  // 0x0030(0x0060)
	struct FTransform                             LocalTransform;                                    // 0x0090(0x0060)
};
...
{
public:
	TArray<struct FRigSpace>                      Spaces;                                            // 0x0000(0x0010)
};
...
public:
	...
	struct FQuat                                  Global;                                            // 0x0030(0x0020)
};
...
public:
	...
	struct FVector                                PendulumGravity;                                   // 0x0008(0x0018)
	...
	struct FVector                                UnwindAxis;                                        // 0x0038(0x0018)
...
public:
	bool                                          bEnabled;                                          // 0x0000(0x0001)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)
	struct FVector                                ReachTarget;                                       // 0x0008(0x0018)
	struct FVector                                ReachAxis;                                         // 0x0020(0x0018)
...
public:
	bool                                          bEnabled;                                          // 0x0000(0x0001)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)
	struct FVector                                WaveFrequency;                                     // 0x0008(0x0018)
	struct FVector                                WaveAmplitude;                                     // 0x0020(0x0018)
	struct FVector                                WaveOffset;                                        // 0x0038(0x0018)
	struct FVector                                WaveNoise;                                         // 0x0050(0x0018)
...
{
public:
	struct FVector                                Time;                                              // 0x0000(0x0018)
	TArray<struct FCachedRigElement>              Items;                                             // 0x0018(0x0010)
	TArray<float>                                 Ratio;                                             // 0x0028(0x0010)
	TArray<struct FVector>                        LocalTip;                                          // 0x0038(0x0010)
	TArray<struct FVector>                        PendulumTip;                                       // 0x0048(0x0010)
	TArray<struct FVector>                        PendulumPosition;                                  // 0x0058(0x0010)
	TArray<struct FVector>                        PendulumVelocity;                                  // 0x0068(0x0010)
	TArray<struct FVector>                        HierarchyLine;                                     // 0x0078(0x0010)
	TArray<struct FVector>                        VelocityLines;                                     // 0x0088(0x0010)
};
...
{
public:
	class FName                                   ChainRoot;                                         // 0x01F0(0x0008)
	struct FVector                                Speed;                                             // 0x01F8(0x0018)
	struct FRigUnit_ChainHarmonics_Reach          Reach;                                             // 0x0210(0x0048)
	struct FRigUnit_ChainHarmonics_Wave           Wave;                                              // 0x0258(0x0078)
	struct FRuntimeFloatCurve                     WaveCurve;                                         // 0x02D0(0x0088)
	struct FRigUnit_ChainHarmonics_Pendulum       Pendulum;                                          // 0x0358(0x0058)
	bool                                          bDrawDebug;                                        // 0x03B0(0x0001)
	uint8                                         Pad_3B1[0xF];                                      // 0x03B1(0x000F)
	struct FTransform                             DrawWorldOffset;                                   // 0x03C0(0x0060)
	struct FRigUnit_ChainHarmonics_WorkData       WorkData;                                          // 0x0420(0x0098)
...
// 0x0018 (0x0018 - 0x0000)
struct FRigControlModifiedContext final
{
public:
...
{
public:
	TArray<struct FCachedRigElement>              CachedItems;                                       // 0x0000(0x0010)
	struct FVector                                WaveTime;                                          // 0x0010(0x0018)
};
...
{
public:
	TArray<struct FRigUnit_BoneHarmonics_BoneTarget> Bones;                                          // 0x01F0(0x0010)
	struct FVector                                WaveSpeed;                                         // 0x0200(0x0018)
	struct FVector                                WaveFrequency;                                     // 0x0218(0x0018)
	struct FVector                                WaveAmplitude;                                     // 0x0230(0x0018)
	struct FVector                                WaveOffset;                                        // 0x0248(0x0018)
	struct FVector                                WaveNoise;                                         // 0x0260(0x0018)
	ERigVMAnimEasingType                          WaveEase;                                          // 0x0278(0x0001)
	uint8                                         Pad_279[0x3];                                      // 0x0279(0x0003)
	float                                         WaveMinimum;                                       // 0x027C(0x0004)
	float                                         WaveMaximum;                                       // 0x0280(0x0004)
	EEulerRotationOrder                           RotationOrder;                                     // 0x0284(0x0001)
	bool                                          bPropagateToChildren;                              // 0x0285(0x0001)
	uint8                                         Pad_286[0x2];                                      // 0x0286(0x0002)
	struct FRigUnit_BoneHarmonics_WorkData        WorkData;                                          // 0x0288(0x0028)
};

// ScriptStruct ControlRig.RigEventContext
// 0x0028 (0x0028 - 0x0000)
struct FRigEventContext final
{
public:
	uint8                                         Pad_0[0x28];                                       // 0x0000(0x0028)
};
...
public:
	...
	struct FVector                                Global;                                            // 0x0020(0x0018)
};
...
public:
	...
	class FText                                   Message;                                           // 0x0010(0x0010)
};
...
public:
	struct FRigElementKey                         Connector;                                         // 0x0000(0x000C)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)
	TArray<struct FRigElementResolveResult>       Matches;                                           // 0x0010(0x0010)
	TArray<struct FRigElementResolveResult>       Excluded;                                          // 0x0020(0x0010)
	EModularRigResolveState                       State;                                             // 0x0030(0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
	class FText                                   Message;                                           // 0x0038(0x0010)
};
...
public:
	float                                         Weight;                                            // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FVector                                Axis;                                              // 0x0008(0x0018)
	struct FVector                                Target;                                            // 0x0020(0x0018)
	EControlRigVectorKind                         Kind;                                              // 0x0038(0x0001)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)
	class FName                                   Space;                                             // 0x003C(0x0008)
...
{
public:
	TArray<int32>                                 Value;                                             // 0x0020(0x0010)
};
...
{
public:
	class FName                                   Value;                                             // 0x0020(0x0008)
};
...
public:
	class FName                                   bone;                                              // 0x01F0(0x0008)
	struct FRigUnit_AimBone_Target                Primary;                                           // 0x01F8(0x0048)
	struct FRigUnit_AimBone_Target                Secondary;                                         // 0x0240(0x0048)
	float                                         Weight;                                            // 0x0288(0x0004)
	bool                                          bPropagateToChildren;                              // 0x028C(0x0001)
	uint8                                         Pad_28D[0x3];                                      // 0x028D(0x0003)
	struct FRigUnit_AimBone_DebugSettings         DebugSettings;                                     // 0x0290(0x0070)
	struct FCachedRigElement                      CachedBoneIndex;                                   // 0x0300(0x0020)
	struct FCachedRigElement                      PrimaryCachedSpace;                                // 0x0320(0x0020)
	struct FCachedRigElement                      SecondaryCachedSpace;                              // 0x0340(0x0020)
	bool                                          bIsInitialized;                                    // 0x0360(0x0001)
	uint8                                         Pad_361[0xF];                                      // 0x0361(0x000F)
};
...
{
public:
	TArray<class FName>                           Value;                                             // 0x0020(0x0010)
};
...
{
public:
	TArray<struct FVector>                        Value;                                             // 0x0020(0x0010)
};
...
{
public:
	TArray<struct FRotator>                       Value;                                             // 0x0020(0x0010)
};
...
{
public:
	TArray<struct FQuat>                          Value;                                             // 0x0020(0x0010)
};
...
{
public:
	TArray<struct FTransform>                     Value;                                             // 0x0020(0x0010)
};
...
{
public:
	struct FLinearColor                           Value;                                             // 0x0020(0x0010)
};
...
{
public:
	TArray<struct FLinearColor>                   Value;                                             // 0x0020(0x0010)
};
...
{
public:
	struct FRigElementKey                         Value;                                             // 0x0020(0x000C)
...
{
public:
	TArray<struct FRigElementKey>                 Value;                                             // 0x0020(0x0010)
};
...
{
public:
	TArray<struct FRigElementKey>                 AffectedList;                                      // 0x0000(0x0010)
};
...
{
public:
	struct FSoftObjectPath                        Path;                                              // 0x0000(0x0020)
	struct FRigModuleSettings                     Settings;                                          // 0x0020(0x0080)
};
...
{
public:
	uint8                                         Pad_798[0xA8];                                     // 0x0798(0x00A8)
};
...
{
public:
	TSubclassOf<class UControlRig>                ControlRigClass;                                   // 0x0000(0x0008)
};
...
{
public:
	TArray<struct FControlRigSequenceObjectReference> Array;                                         // 0x0000(0x0010)
};
...
public:
	...
	TArray<struct FControlRigSequenceObjectReferences> References;                                   // 0x0010(0x0010)
};
...
public:
	...
	struct FMovieSceneByteChannel                 ParameterCurve;                                    // 0x0008(0x0110)
};
...
public:
	class FName                                   ParameterName;                                     // 0x0000(0x0008)
	struct FMovieSceneIntegerChannel              ParameterCurve;                                    // 0x0008(0x0108)
};
...
public:
	...
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	struct FRigElementKey                         ControlRigElement;                                 // 0x0004(0x000C)
};
...
public:
	...
	TArray<struct FMovieSceneControlRigSpaceBaseKey> KeyValues;                                      // 0x0060(0x0010)
...
public:
	...
	struct FMovieSceneControlRigSpaceChannel      SpaceCurve;                                        // 0x0008(0x0110)
};
...
{
public:
	int32                                         ControlIndex;                                      // 0x0000(0x0004)
	int32                                         TotalChannelIndex;                                 // 0x0004(0x0004)
	int32                                         ChannelIndex;                                      // 0x0008(0x0004)
	int32                                         ParentControlIndex;                                // 0x000C(0x0004)
	class FName                                   ChannelTypeName;                                   // 0x0010(0x0008)
	bool                                          bDoesHaveSpace;                                    // 0x0018(0x0001)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)
	int32                                         SpaceChannelIndex;                                 // 0x001C(0x0004)
	int32                                         MaskIndex;                                         // 0x0020(0x0004)
	int32                                         CategoryIndex;                                     // 0x0024(0x0004)
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	TArray<uint32>                                ConstraintsIndex;                                  // 0x0030(0x0010)
};
...
{
public:
	TArray<struct FEnumParameterNameAndCurve>     Enums;                                             // 0x0080(0x0010)
	TArray<struct FIntegerParameterNameAndCurve>  Integers;                                          // 0x0090(0x0010)
	TArray<struct FSpaceControlNameAndChannel>    Spaces;                                            // 0x00A0(0x0010)
	TArray<struct FConstraintAndActiveChannel>    Constraints;                                       // 0x00B0(0x0010)
};
...
{
public:
	TMap<class FString, bool>                     Values;                                            // 0x0000(0x0050)
};
...
public:
	class FName                                   Name;                                              // 0x0000(0x0008)
	ERigControlType                               ControlType;                                       // 0x0008(0x0001)
	uint8                                         Pad_9[0x3];                                        // 0x0009(0x0003)
	struct FRigElementKey                         ParentKey;                                         // 0x000C(0x000C)
	struct FRigControlValue                       Value;                                             // 0x0018(0x0084)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)
	struct FTransform                             OffsetTransform;                                   // 0x00A0(0x0060)
	struct FTransform                             ParentTransform;                                   // 0x0100(0x0060)
	struct FTransform                             LocalTransform;                                    // 0x0160(0x0060)
	struct FTransform                             GlobalTransform;                                   // 0x01C0(0x0060)
};
...
{
public:
	TArray<struct FRigControlCopy>                CopyOfControls;                                    // 0x0000(0x0010)
	uint8                                         Pad_10[0x50];                                      // 0x0010(0x0050)
};
...
{
public:
	class FName                                   Curve;                                             // 0x01F0(0x0008)
	struct FCachedRigElement                      CachedCurveIndex;                                  // 0x01F8(0x0020)
	uint8                                         Pad_218[0x8];                                      // 0x0218(0x0008)
};
...
public:
	...
	bool                                          bInitial;                                          // 0x01FD(0x0001)
	uint8                                         Pad_1FE[0x2];                                      // 0x01FE(0x0002)
	struct FTransform                             Value;                                             // 0x0200(0x0060)
	float                                         Weight;                                            // 0x0260(0x0004)
	bool                                          bPropagateToChildren;                              // 0x0264(0x0001)
	uint8                                         Pad_265[0x3];                                      // 0x0265(0x0003)
	struct FCachedRigElement                      CachedIndex;                                       // 0x0268(0x0020)
	uint8                                         Pad_288[0x8];                                      // 0x0288(0x0008)
};
...
{
public:
	class FName                                   NotifyName;                                        // 0x01F0(0x0008)
	class FName                                   CustomTag;                                         // 0x01F8(0x0008)
	struct FHitResult                             HitResult;                                         // 0x0200(0x0108)
	struct FVector                                Velocity;                                          // 0x0308(0x0018)
};
...
public:
	...
	ECollisionChannel                             Channel;                                           // 0x0038(0x0001)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)
	float                                         Radius;                                            // 0x003C(0x0004)
	bool                                          bHit;                                              // 0x0040(0x0001)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)
	struct FVector                                HitLocation;                                       // 0x0048(0x0018)
	struct FVector                                HitNormal;                                         // 0x0060(0x0018)
	struct FRigUnit_SphereTrace_WorkData          WorkData;                                          // 0x0078(0x0038)
	struct FHitResult                             WorldSpaceHitResult;                               // 0x00B0(0x0108)
};
...
{
public:
	struct FRigElementKeyCollection               Items;                                             // 0x01F0(0x0010)
	ERigVMTransformSpace                          Space;                                             // 0x0200(0x0001)
	bool                                          bInitial;                                          // 0x0201(0x0001)
	uint8                                         Pad_202[0x6];                                      // 0x0202(0x0006)
	TArray<struct FTransform>                     Transforms;                                        // 0x0208(0x0010)
	float                                         Weight;                                            // 0x0218(0x0004)
	bool                                          bPropagateToChildren;                              // 0x021C(0x0001)
	uint8                                         Pad_21D[0x3];                                      // 0x021D(0x0003)
	TArray<struct FCachedRigElement>              CachedIndex;                                       // 0x0220(0x0010)
};
...
public:
	struct FVector                                Start;                                             // 0x0008(0x0018)
	struct FVector                                End;                                               // 0x0020(0x0018)
	TArray<EObjectTypeQuery>                      ObjectTypes;                                       // 0x0038(0x0010)
	float                                         Radius;                                            // 0x0048(0x0004)
	bool                                          bHit;                                              // 0x004C(0x0001)
	uint8                                         Pad_4D[0x3];                                       // 0x004D(0x0003)
	struct FVector                                HitLocation;                                       // 0x0050(0x0018)
	struct FVector                                HitNormal;                                         // 0x0068(0x0018)
	struct FRigUnit_SphereTrace_WorkData          WorkData;                                          // 0x0080(0x0038)
	struct FHitResult                             WorldSpaceHitResult;                               // 0x00B8(0x0108)
};
...
public:
	...
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)
	float                                         Radius;                                            // 0x003C(0x0004)
	bool                                          IgnoreFoliage;                                     // 0x0040(0x0001)
	bool                                          bHit;                                              // 0x0041(0x0001)
	uint8                                         Pad_42[0x6];                                       // 0x0042(0x0006)
	struct FVector                                HitLocation;                                       // 0x0048(0x0018)
	struct FVector                                HitNormal;                                         // 0x0060(0x0018)
	struct FHitResult                             WorldSpaceHitResult;                               // 0x0078(0x0108)
	bool                                          bHitPlatform;                                      // 0x0180(0x0001)
	uint8                                         Pad_181[0x7];                                      // 0x0181(0x0007)
	class FString                                 HitName;                                           // 0x0188(0x0010)
	bool                                          bHitFoliage;                                       // 0x0198(0x0001)
...
public:
	...
	float                                         Radius;                                            // 0x003C(0x0004)
	bool                                          bHit;                                              // 0x0040(0x0001)
	bool                                          bIgnoreDinos;                                      // 0x0041(0x0001)
	uint8                                         Pad_42[0x6];                                       // 0x0042(0x0006)
	struct FVector                                HitLocation;                                       // 0x0048(0x0018)
	struct FVector                                HitNormal;                                         // 0x0060(0x0018)
	struct FHitResult                             WorldSpaceHitResult;                               // 0x0078(0x0108)
	class FString                                 HitName;                                           // 0x0180(0x0010)
	bool                                          bHitDino;                                          // 0x0190(0x0001)
...
{
public:
	struct FEulerTransform                        Transform;                                         // 0x0008(0x0048)
	struct FTransform                             base;                                              // 0x0050(0x0060)
	struct FTransform                             InitTransform;                                     // 0x00B0(0x0060)
	struct FTransform                             Result;                                            // 0x0110(0x0060)
...
{
public:
	struct FTransform                             MeshTransform;                                     // 0x0180(0x0060)
};
...
public:
	struct FRigControlLimitEnabled                LimitX;                                            // 0x0000(0x0002)
	struct FRigControlLimitEnabled                LimitY;                                            // 0x0002(0x0002)
	struct FRigControlLimitEnabled                LimitZ;                                            // 0x0004(0x0002)
...
public:
	...
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)
	TArray<struct FRigElementKey>                 DrivenControls;                                    // 0x0008(0x0010)
...
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)
	class FName                                   DisplayName;                                       // 0x0008(0x0008)
};
...
public:
	...
	uint8                                         Pad_12[0x6];                                       // 0x0012(0x0006)
	struct FRigUnit_HierarchyAddControlVector_LimitSettings Limits;                                  // 0x0018(0x0040)
	uint8                                         Pad_58[0x8];                                       // 0x0058(0x0008)
	struct FRigUnit_HierarchyAddControl_ShapeSettings Shape;                                         // 0x0060(0x0080)
	struct FRigUnit_HierarchyAddControl_ProxySettings Proxy;                                         // 0x00E0(0x0020)
...
{
public:
	class FString                                 NameSpace;                                         // 0x01F0(0x0010)
	class FString                                 Path;                                              // 0x0200(0x0010)
	class FString                                 LibraryName;                                       // 0x0210(0x0010)
	bool                                          LogShapeLibraries;                                 // 0x0220(0x0001)
...
{
public:
	struct FRigElementKey                         Value;                                             // 0x0008(0x000C)
	class FName                                   Result;                                            // 0x0014(0x0008)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
};
...
{
public:
	class FName                                   ShapeName;                                         // 0x0008(0x0008)
...
{
public:
	struct FRigVMFourPointBezier                  Bezier;                                            // 0x0120(0x0060)
	float                                         MinimumU;                                          // 0x0180(0x0004)
	float                                         MaximumU;                                          // 0x0184(0x0004)
	struct FLinearColor                           Color;                                             // 0x0188(0x0010)
	float                                         Thickness;                                         // 0x0198(0x0004)
	int32                                         Detail;                                            // 0x019C(0x0004)
	class FName                                   Space;                                             // 0x01A0(0x0008)
	uint8                                         Pad_1A8[0x8];                                      // 0x01A8(0x0008)
	struct FTransform                             WorldOffset;                                       // 0x01B0(0x0060)
	bool                                          bEnabled;                                          // 0x0210(0x0001)
	uint8                                         Pad_211[0xF];                                      // 0x0211(0x000F)
};
...
public:
	...
	float                                         Thickness;                                         // 0x0198(0x0004)
	int32                                         Detail;                                            // 0x019C(0x0004)
	struct FRigElementKey                         Space;                                             // 0x01A0(0x000C)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FControlRigExecuteContext              ExecuteContext;                                    // 0x0010(0x01E0)
	TArray<struct FRigElementKey>                 Items;                                             // 0x01F0(0x0010)
	float                                         Scale;                                             // 0x0200(0x0004)
	struct FLinearColor                           Color;                                             // 0x0204(0x0010)
	float                                         Thickness;                                         // 0x0214(0x0004)
	uint8                                         Pad_218[0x8];                                      // 0x0218(0x0008)
	struct FTransform                             WorldOffset;                                       // 0x0220(0x0060)
...
public:
	...
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
	struct FRigUnit_HierarchyAddControlVector2D_LimitSettings Limits;                                // 0x0018(0x0030)
	uint8                                         Pad_48[0x8];                                       // 0x0048(0x0008)
	struct FRigUnit_HierarchyAddControl_ShapeSettings Shape;                                         // 0x0050(0x0080)
	struct FRigUnit_HierarchyAddControl_ProxySettings Proxy;                                         // 0x00D0(0x0020)
...
{
public:
	struct FRigElementKey                         Parent;                                            // 0x01F0(0x000C)
	class FName                                   Name;                                              // 0x01FC(0x0008)
	struct FRigElementKey                         Item;                                              // 0x0204(0x000C)
};
...
{
public:
	struct FTransform                             OffsetTransform;                                   // 0x0210(0x0060)
	ERigVMTransformSpace                          OffsetSpace;                                       // 0x0270(0x0001)
...
{
public:
	struct FVector2D                              InitialValue;                                      // 0x0278(0x0010)
	uint8                                         Pad_288[0x8];                                      // 0x0288(0x0008)
	struct FRigUnit_HierarchyAddControlVector2D_Settings Settings;                                   // 0x0290(0x0100)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FControlRigExecuteContext              ExecuteContext;                                    // 0x0010(0x01E0)
	struct FRigPose                               Pose;                                              // 0x01F0(0x0070)
	TArray<struct FRigElementKey>                 Items;                                             // 0x0260(0x0010)
	float                                         Scale;                                             // 0x0270(0x0004)
	struct FLinearColor                           Color;                                             // 0x0274(0x0010)
	float                                         Thickness;                                         // 0x0284(0x0004)
	uint8                                         Pad_288[0x8];                                      // 0x0288(0x0008)
	struct FTransform                             WorldOffset;                                       // 0x0290(0x0060)
	bool                                          bEnabled;                                          // 0x02F0(0x0001)
	uint8                                         Pad_2F1[0xF];                                      // 0x02F1(0x000F)
};
...
{
public:
	struct FVector                                A;                                                 // 0x01F0(0x0018)
	struct FVector                                B;                                                 // 0x0208(0x0018)
	struct FLinearColor                           Color;                                             // 0x0220(0x0010)
	float                                         Thickness;                                         // 0x0230(0x0004)
	class FName                                   Space;                                             // 0x0234(0x0008)
	uint8                                         Pad_23C[0x4];                                      // 0x023C(0x0004)
	struct FTransform                             WorldOffset;                                       // 0x0240(0x0060)
	bool                                          bEnabled;                                          // 0x02A0(0x0001)
	uint8                                         Pad_2A1[0xF];                                      // 0x02A1(0x000F)
};
...
public:
	...
	struct FLinearColor                           Color;                                             // 0x0220(0x0010)
	float                                         Thickness;                                         // 0x0230(0x0004)
	struct FRigElementKey                         Space;                                             // 0x0234(0x000C)
	struct FTransform                             WorldOffset;                                       // 0x0240(0x0060)
	bool                                          bEnabled;                                          // 0x02A0(0x0001)
	uint8                                         Pad_2A1[0xF];                                      // 0x02A1(0x000F)
};
...
{
public:
	TArray<struct FVector>                        Points;                                            // 0x01F0(0x0010)
	struct FLinearColor                           Color;                                             // 0x0200(0x0010)
	float                                         Thickness;                                         // 0x0210(0x0004)
	class FName                                   Space;                                             // 0x0214(0x0008)
...
{
public:
	struct FRigControlLimitEnabled                LimitPitch;                                        // 0x0000(0x0002)
	struct FRigControlLimitEnabled                LimitYaw;                                          // 0x0002(0x0002)
	struct FRigControlLimitEnabled                LimitRoll;                                         // 0x0004(0x0002)
	uint8                                         Pad_6[0x2];                                        // 0x0006(0x0002)
	struct FRotator                               MinValue;                                          // 0x0008(0x0018)
	struct FRotator                               MaxValue;                                          // 0x0020(0x0018)
	bool                                          bDrawLimits;                                       // 0x0038(0x0001)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
};
...
public:
	...
	struct FLinearColor                           Color;                                             // 0x0200(0x0010)
	float                                         Thickness;                                         // 0x0210(0x0004)
	struct FRigElementKey                         Space;                                             // 0x0214(0x000C)
	struct FTransform                             WorldOffset;                                       // 0x0220(0x0060)
	bool                                          bEnabled;                                          // 0x0280(0x0001)
	uint8                                         Pad_281[0xF];                                      // 0x0281(0x000F)
};
...
public:
	...
	float                                         Scale;                                             // 0x0260(0x0004)
	float                                         Thickness;                                         // 0x0264(0x0004)
	class FName                                   Space;                                             // 0x0268(0x0008)
	struct FTransform                             WorldOffset;                                       // 0x0270(0x0060)
	bool                                          bEnabled;                                          // 0x02D0(0x0001)
	uint8                                         Pad_2D1[0xF];                                      // 0x02D1(0x000F)
};
...
public:
	...
	float                                         MinimumDegrees;                                    // 0x0264(0x0004)
	float                                         MaximumDegrees;                                    // 0x0268(0x0004)
	float                                         Thickness;                                         // 0x026C(0x0004)
	int32                                         Detail;                                            // 0x0270(0x0004)
	class FName                                   Space;                                             // 0x0274(0x0008)
...
{
public:
	struct FRigControlLimitEnabled                LimitTranslationX;                                 // 0x0000(0x0002)
	struct FRigControlLimitEnabled                LimitTranslationY;                                 // 0x0002(0x0002)
	struct FRigControlLimitEnabled                LimitTranslationZ;                                 // 0x0004(0x0002)
	struct FRigControlLimitEnabled                LimitPitch;                                        // 0x0006(0x0002)
	struct FRigControlLimitEnabled                LimitYaw;                                          // 0x0008(0x0002)
	struct FRigControlLimitEnabled                LimitRoll;                                         // 0x000A(0x0002)
	struct FRigControlLimitEnabled                LimitScaleX;                                       // 0x000C(0x0002)
	struct FRigControlLimitEnabled                LimitScaleY;                                       // 0x000E(0x0002)
	struct FRigControlLimitEnabled                LimitScaleZ;                                       // 0x0010(0x0002)
	uint8                                         Pad_12[0x6];                                       // 0x0012(0x0006)
	struct FEulerTransform                        MinValue;                                          // 0x0018(0x0048)
	struct FEulerTransform                        MaxValue;                                          // 0x0060(0x0048)
...
public:
	...
	struct FRigUnit_HierarchyAddControlTransform_LimitSettings Limits;                               // 0x0018(0x00B0)
	uint8                                         Pad_C8[0x8];                                       // 0x00C8(0x0008)
	struct FRigUnit_HierarchyAddControl_ShapeSettings Shape;                                         // 0x00D0(0x0080)
	struct FRigUnit_HierarchyAddControl_ProxySettings Proxy;                                         // 0x0150(0x0020)
...
public:
	...
	float                                         Thickness;                                         // 0x026C(0x0004)
	int32                                         Detail;                                            // 0x0270(0x0004)
	struct FRigElementKey                         Space;                                             // 0x0274(0x000C)
	struct FTransform                             WorldOffset;                                       // 0x0280(0x0060)
	bool                                          bEnabled;                                          // 0x02E0(0x0001)
	uint8                                         Pad_2E1[0xF];                                      // 0x02E1(0x000F)
};
...
public:
	...
	uint8                                         Pad_71[0x3];                                       // 0x0071(0x0003)
	struct FLinearColor                           Color;                                             // 0x0074(0x0010)
	float                                         Thickness;                                         // 0x0084(0x0004)
	float                                         Scale;                                             // 0x0088(0x0004)
	class FName                                   Space;                                             // 0x008C(0x0008)
	uint8                                         Pad_94[0xC];                                       // 0x0094(0x000C)
	struct FTransform                             WorldOffset;                                       // 0x00A0(0x0060)
...
{
public:
	struct FRigControlLimitEnabled                X;                                                 // 0x0000(0x0002)
	struct FRigControlLimitEnabled                Y;                                                 // 0x0002(0x0002)
	struct FRigControlLimitEnabled                Z;                                                 // 0x0004(0x0002)
};
...
public:
	struct FTransform                             Transform;                                         // 0x01F0(0x0060)
	ERigUnitDebugTransformMode                    Mode;                                              // 0x0250(0x0001)
	uint8                                         Pad_251[0x3];                                      // 0x0251(0x0003)
	struct FLinearColor                           Color;                                             // 0x0254(0x0010)
	float                                         Thickness;                                         // 0x0264(0x0004)
	float                                         Scale;                                             // 0x0268(0x0004)
	class FName                                   Space;                                             // 0x026C(0x0008)
	uint8                                         Pad_274[0xC];                                      // 0x0274(0x000C)
	struct FTransform                             WorldOffset;                                       // 0x0280(0x0060)
	bool                                          bEnabled;                                          // 0x02E0(0x0001)
	uint8                                         Pad_2E1[0xF];                                      // 0x02E1(0x000F)
...
public:
	...
	float                                         Thickness;                                         // 0x0264(0x0004)
	float                                         Scale;                                             // 0x0268(0x0004)
	struct FRigElementKey                         Space;                                             // 0x026C(0x000C)
...
{
public:
	struct FRigControlLimitEnabled                Enabled;                                           // 0x0000(0x0002)
};
...
{
public:
	TArray<struct FTransform>                     DrawTransforms;                                    // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FTransform>                     Transforms;                                        // 0x01F0(0x0010)
	ERigUnitDebugTransformMode                    Mode;                                              // 0x0200(0x0001)
	uint8                                         Pad_201[0x3];                                      // 0x0201(0x0003)
	struct FLinearColor                           Color;                                             // 0x0204(0x0010)
	float                                         Thickness;                                         // 0x0214(0x0004)
	float                                         Scale;                                             // 0x0218(0x0004)
	class FName                                   Space;                                             // 0x021C(0x0008)
	uint8                                         Pad_224[0xC];                                      // 0x0224(0x000C)
	struct FTransform                             WorldOffset;                                       // 0x0230(0x0060)
	bool                                          bEnabled;                                          // 0x0290(0x0001)
	uint8                                         Pad_291[0x7];                                      // 0x0291(0x0007)
	struct FRigUnit_DebugTransformArrayMutable_WorkData WorkData;                                    // 0x0298(0x0010)
	uint8                                         Pad_2A8[0x8];                                      // 0x02A8(0x0008)
};
...
public:
	ERigVMTransformSpace                          InitialSpace;                                      // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
	struct FRigUnit_HierarchyAddControlRotator_LimitSettings Limits;                                 // 0x0018(0x0040)
	uint8                                         Pad_58[0x8];                                       // 0x0058(0x0008)
	struct FRigUnit_HierarchyAddControl_ShapeSettings Shape;                                         // 0x0060(0x0080)
	struct FRigUnit_HierarchyAddControl_ProxySettings Proxy;                                         // 0x00E0(0x0020)
	TArray<ERigControlTransformChannel>           FilteredChannels;                                  // 0x0100(0x0010)
...
{
public:
	struct FRotator                               InitialValue;                                      // 0x0278(0x0018)
	struct FRigUnit_HierarchyAddControlRotator_Settings Settings;                                    // 0x0290(0x0110)
};
...
public:
	TArray<struct FTransform>                     Transforms;                                        // 0x01F0(0x0010)
	TArray<int32>                                 ParentIndices;                                     // 0x0200(0x0010)
	ERigUnitDebugTransformMode                    Mode;                                              // 0x0210(0x0001)
	uint8                                         Pad_211[0x3];                                      // 0x0211(0x0003)
	struct FLinearColor                           Color;                                             // 0x0214(0x0010)
	float                                         Thickness;                                         // 0x0224(0x0004)
	float                                         Scale;                                             // 0x0228(0x0004)
	struct FRigElementKey                         Space;                                             // 0x022C(0x000C)
	uint8                                         Pad_238[0x8];                                      // 0x0238(0x0008)
	struct FTransform                             WorldOffset;                                       // 0x0240(0x0060)
	bool                                          bEnabled;                                          // 0x02A0(0x0001)
	uint8                                         Pad_2A1[0xF];                                      // 0x02A1(0x000F)
...
{
public:
	int32                                         NumberOfMeasurements;                              // 0x0120(0x0004)
	uint8                                         Pad_124[0x4];                                      // 0x0124(0x0004)
	class FString                                 Prefix;                                            // 0x0128(0x0010)
	float                                         AccumulatedTime;                                   // 0x0138(0x0004)
	int32                                         MeasurementsLeft;                                  // 0x013C(0x0004)
	bool                                          bIsInitialized;                                    // 0x0140(0x0001)
...
public:
	...
	class FName                                   BoneSpace;                                         // 0x003C(0x0008)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)
};
...
{
public:
	struct FVector                                InitialValue;                                      // 0x0210(0x0018)
	struct FVector                                MinimumValue;                                      // 0x0228(0x0018)
	struct FVector                                MaximumValue;                                      // 0x0240(0x0018)
	struct FRigUnit_HierarchyAddAnimationChannelVectorLimitSettings LimitsEnabled;                   // 0x0258(0x0006)
...
{
public:
	float                                         InitialValue;                                      // 0x0210(0x0004)
	float                                         MinimumValue;                                      // 0x0214(0x0004)
	float                                         MaximumValue;                                      // 0x0218(0x0004)
	struct FRigUnit_HierarchyAddAnimationChannelSingleLimitSettings LimitsEnabled;                   // 0x021C(0x0002)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Input;                                             // 0x0010(0x0060)
...
public:
	...
	struct FTransform                             Result;                                            // 0x0050(0x0060)
};
...
{
public:
	struct FRotator                               Input;                                             // 0x0008(0x0018)
	struct FQuat                                  Result;                                            // 0x0020(0x0020)
};
...
{
public:
	struct FRigElementKey                         Start;                                             // 0x0008(0x000C)
	struct FRigElementKey                         End;                                               // 0x0014(0x000C)
	bool                                          bIncludeStart;                                     // 0x0020(0x0001)
	bool                                          bIncludeEnd;                                       // 0x0021(0x0001)
	bool                                          bReverse;                                          // 0x0022(0x0001)
	uint8                                         Pad_23[0x5];                                       // 0x0023(0x0005)
	TArray<struct FRigElementKey>                 Chain;                                             // 0x0028(0x0010)
	struct FCachedRigElement                      CachedStart;                                       // 0x0038(0x0020)
	struct FCachedRigElement                      CachedEnd;                                         // 0x0058(0x0020)
	struct FRigElementKeyCollection               CachedChain;                                       // 0x0078(0x0010)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Input;                                             // 0x0010(0x0020)
	struct FRotator                               Result;                                            // 0x0030(0x0018)
	uint8                                         Pad_48[0x8];                                       // 0x0048(0x0008)
};
...
{
public:
	struct FVector                                Input;                                             // 0x0008(0x0018)
	struct FRotator                               Result;                                            // 0x0020(0x0018)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Input;                                             // 0x0010(0x0020)
	struct FVector                                Result;                                            // 0x0030(0x0018)
	uint8                                         Pad_48[0x8];                                       // 0x0048(0x0008)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Input;                                             // 0x0010(0x0020)
	struct FVector                                TwistAxis;                                         // 0x0030(0x0018)
	uint8                                         Pad_48[0x8];                                       // 0x0048(0x0008)
	struct FQuat                                  Swing;                                             // 0x0050(0x0020)
	struct FQuat                                  Twist;                                             // 0x0070(0x0020)
};
...
public:
	...
	uint8                                         Pad_A[0x6];                                        // 0x000A(0x0006)
	TArray<struct FRigElementKey>                 ItemsToGet;                                        // 0x0010(0x0010)
	struct FRigPose                               Pose;                                              // 0x0020(0x0070)
};
...
public:
	...
	bool                                          bDefaultParent;                                    // 0x0016(0x0001)
	uint8                                         Pad_17[0x1];                                       // 0x0017(0x0001)
	TArray<struct FRigElementKey>                 Parents;                                           // 0x0018(0x0010)
	struct FCachedRigElement                      CachedChild;                                       // 0x0028(0x0020)
...
public:
	...
	float                                         min_0;                                             // 0x000C(0x0004)
	float                                         max_0;                                             // 0x0010(0x0004)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Argument0;                                         // 0x0010(0x0020)
	struct FQuat                                  Argument1;                                         // 0x0030(0x0020)
	struct FQuat                                  Result;                                            // 0x0050(0x0020)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Argument;                                          // 0x0010(0x0020)
	struct FQuat                                  Result;                                            // 0x0030(0x0020)
};
...
public:
	...
	TArray<struct FTransform>                     Transforms;                                        // 0x0080(0x0010)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Argument;                                          // 0x0010(0x0020)
	struct FVector                                Axis;                                              // 0x0030(0x0018)
...
public:
	struct FRigPose                               Pose;                                              // 0x01F0(0x0070)
	ERigElementType                               ElementType;                                       // 0x0260(0x0001)
	ERigVMTransformSpace                          Space;                                             // 0x0261(0x0001)
	uint8                                         Pad_262[0x6];                                      // 0x0262(0x0006)
	TArray<struct FRigElementKey>                 ItemsToSet;                                        // 0x0268(0x0010)
	float                                         Weight;                                            // 0x0278(0x0004)
	uint8                                         Pad_27C[0x4];                                      // 0x027C(0x0004)
};
...
public:
	struct FVector                                Axis;                                              // 0x0008(0x0018)
	struct FQuat                                  Argument;                                          // 0x0020(0x0020)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Argument0;                                         // 0x0010(0x0060)
	struct FTransform                             Argument1;                                         // 0x0070(0x0060)
	struct FTransform                             Result;                                            // 0x00D0(0x0060)
};
...
public:
	...
	struct FTransform                             GlobalTransform;                                   // 0x0070(0x0060)
	bool                                          UseEulerAngles;                                    // 0x00D0(0x0001)
	uint8                                         Pad_D1[0x7];                                       // 0x00D1(0x0007)
	struct FVector                                EulerAngles;                                       // 0x00D8(0x0018)
	float                                         CurveValue;                                        // 0x00F0(0x0004)
	uint8                                         Pad_F4[0xC];                                       // 0x00F4(0x000C)
};
...
{
public:
	TArray<struct FRigUnit_HierarchyCreatePoseItemArray_Entry> Entries;                              // 0x0008(0x0010)
	struct FRigPose                               Pose;                                              // 0x0018(0x0070)
};
...
public:
	class FName                                   BlockToRun;                                        // 0x01F0(0x0008)
	struct FRigPose                               Pose;                                              // 0x01F8(0x0070)
	struct FRigElementKey                         Item;                                              // 0x0268(0x000C)
	uint8                                         Pad_274[0xC];                                      // 0x0274(0x000C)
	struct FTransform                             GlobalTransform;                                   // 0x0280(0x0060)
	struct FTransform                             LocalTransform;                                    // 0x02E0(0x0060)
	float                                         CurveValue;                                        // 0x0340(0x0004)
	int32                                         Index;                                             // 0x0344(0x0004)
	int32                                         Count;                                             // 0x0348(0x0004)
	float                                         Ratio;                                             // 0x034C(0x0004)
	struct FControlRigExecuteContext              Completed;                                         // 0x0350(0x01E0)
};
...
{
public:
	class FName                                   Control;                                           // 0x0008(0x0008)
	ERigVMTransformSpace                          Space;                                             // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
	struct FRotator                               Rotator;                                           // 0x0018(0x0018)
	struct FRotator                               Minimum;                                           // 0x0030(0x0018)
	struct FRotator                               Maximum;                                           // 0x0048(0x0018)
...
public:
	...
	uint8                                         Pad_1F8[0x8];                                      // 0x01F8(0x0008)
	struct FTransform                             Transform;                                         // 0x0200(0x0060)
	struct FTransformFilter                       Filter;                                            // 0x0260(0x0009)
	EApplyTransformMode                           ApplyTransformMode;                                // 0x0269(0x0001)
	ETransformSpaceMode                           ApplyTransformSpace;                               // 0x026A(0x0001)
	uint8                                         Pad_26B[0x5];                                      // 0x026B(0x0005)
	struct FTransform                             BaseTransform;                                     // 0x0270(0x0060)
	class FName                                   BaseJoint;                                         // 0x02D0(0x0008)
	uint8                                         Pad_2D8[0x8];                                      // 0x02D8(0x0008)
};
...
{
public:
	class FName                                   bone;                                              // 0x0008(0x0008)
	class FName                                   Space;                                             // 0x0010(0x0008)
	uint8                                         Pad_18[0x8];                                       // 0x0018(0x0008)
	struct FTransform                             Transform;                                         // 0x0020(0x0060)
	struct FCachedRigElement                      CachedBone;                                        // 0x0080(0x0020)
	struct FCachedRigElement                      CachedSpace;                                       // 0x00A0(0x0020)
};
...
public:
	...
	uint8                                         Pad_64[0xC];                                       // 0x0064(0x000C)
};
...
public:
	...
	TArray<struct FBlendTarget>                   Targets;                                           // 0x0070(0x0010)
	struct FTransform                             Result;                                            // 0x0080(0x0060)
};
...
public:
	class FName                                   Control;                                           // 0x0008(0x0008)
	struct FVector2D                              Vector;                                            // 0x0010(0x0010)
	struct FVector2D                              Minimum;                                           // 0x0020(0x0010)
	struct FVector2D                              Maximum;                                           // 0x0030(0x0010)
...
public:
	class FName                                   Joint;                                             // 0x01F0(0x0008)
	ETransformGetterType                          Type;                                              // 0x01F8(0x0001)
	ETransformSpaceMode                           TransformSpace;                                    // 0x01F9(0x0001)
	uint8                                         Pad_1FA[0x6];                                      // 0x01FA(0x0006)
	struct FTransform                             BaseTransform;                                     // 0x0200(0x0060)
	class FName                                   BaseJoint;                                         // 0x0260(0x0008)
	uint8                                         Pad_268[0x8];                                      // 0x0268(0x0008)
	struct FTransform                             Output;                                            // 0x0270(0x0060)
};
...
{
public:
	class FName                                   StartJoint;                                        // 0x01F0(0x0008)
	class FName                                   EndJoint;                                          // 0x01F8(0x0008)
	struct FVector                                PoleTarget;                                        // 0x0200(0x0018)
	float                                         Spin;                                              // 0x0218(0x0004)
	uint8                                         Pad_21C[0x4];                                      // 0x021C(0x0004)
	struct FTransform                             EndEffector;                                       // 0x0220(0x0060)
	float                                         IKBlend;                                           // 0x0280(0x0004)
	uint8                                         Pad_284[0xC];                                      // 0x0284(0x000C)
	struct FTransform                             StartJointFKTransform;                             // 0x0290(0x0060)
	struct FTransform                             MidJointFKTransform;                               // 0x02F0(0x0060)
	struct FTransform                             EndJointFKTransform;                               // 0x0350(0x0060)
	float                                         PreviousFKIKBlend;                                 // 0x03B0(0x0004)
	uint8                                         Pad_3B4[0xC];                                      // 0x03B4(0x000C)
	struct FTransform                             StartJointIKTransform;                             // 0x03C0(0x0060)
	struct FTransform                             MidJointIKTransform;                               // 0x0420(0x0060)
	struct FTransform                             EndJointIKTransform;                               // 0x0480(0x0060)
	int32                                         StartJointIndex;                                   // 0x04E0(0x0004)
	int32                                         MidJointIndex;                                     // 0x04E4(0x0004)
	int32                                         EndJointIndex;                                     // 0x04E8(0x0004)
	float                                         UpperLimbLength;                                   // 0x04EC(0x0004)
	float                                         LowerLimbLength;                                   // 0x04F0(0x0004)
	bool                                          bIsInitialized;                                    // 0x04F4(0x0001)
...
{
public:
	class FName                                   InstructionName;                                   // 0x0008(0x0008)
...
public:
	...
	struct FTransform                             Transform;                                         // 0x0200(0x0060)
	float                                         Weight;                                            // 0x0260(0x0004)
	bool                                          bPostMultiply;                                     // 0x0264(0x0001)
...
{
public:
	class FString                                 NameSpace;                                         // 0x0008(0x0010)
};
...
{
public:
	struct FTransform                             Transform;                                         // 0x0210(0x0060)
	struct FRigPhysicsSolverID                    Solver;                                            // 0x0270(0x0010)
	struct FRigPhysicsSettings                    Settings;                                          // 0x0280(0x0004)
	uint8                                         Pad_284[0xC];                                      // 0x0284(0x000C)
};
...
public:
	...
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
	TArray<struct FRigElementKey>                 Items;                                             // 0x0010(0x0010)
};
...
{
public:
	struct FRigElementKey                         Default;                                           // 0x01F0(0x000C)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
};
...
public:
	class FName                                   Control;                                           // 0x0008(0x0008)
	class FName                                   Channel;                                           // 0x0010(0x0008)
	bool                                          bInitial;                                          // 0x0018(0x0001)
	uint8                                         Pad_19[0x3];                                       // 0x0019(0x0003)
	struct FRigElementKey                         CachedChannelKey;                                  // 0x001C(0x000C)
	int32                                         CachedChannelHash;                                 // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
};
...
public:
	...
	bool                                          Reverse;                                           // 0x0020(0x0001)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)
	TArray<struct FRigElementKey>                 Items;                                             // 0x0028(0x0010)
};
...
{
public:
	class FName                                   PartialName;                                       // 0x0008(0x0008)
...
public:
	...
	uint8                                         Pad_15[0x3];                                       // 0x0015(0x0003)
	class FString                                 NameSpace;                                         // 0x0018(0x0010)
};
...
public:
	...
	bool                                          bIncludeParent;                                    // 0x0014(0x0001)
	bool                                          bRecursive;                                        // 0x0015(0x0001)
	bool                                          bDefaultChildren;                                  // 0x0016(0x0001)
	ERigElementType                               TypeToSearch;                                      // 0x0017(0x0001)
	TArray<struct FRigElementKey>                 Items;                                             // 0x0018(0x0010)
};
...
public:
	...
	class FName                                   Old;                                               // 0x0018(0x0008)
	class FName                                   New;                                               // 0x0020(0x0008)
...
{
public:
	struct FControlRigExecuteContext              ExecuteContext;                                    // 0x0030(0x01E0)
};
...
{
public:
	struct FVector2D                              Value;                                             // 0x0030(0x0010)
};
...
public:
	struct FRigElementKeyCollection               Collection;                                        // 0x0008(0x0010)
	TArray<int32>                                 ParentIndices;                                     // 0x0018(0x0010)
};
...
{
public:
	struct FVector                                Root;                                              // 0x0008(0x0018)
	struct FVector                                PoleVector;                                        // 0x0020(0x0018)
	struct FVector                                Effector;                                          // 0x0038(0x0018)
	...
	struct FVector                                Elbow;                                             // 0x0068(0x0018)
};
...
public:
	struct FRigElementKey                         Item;                                              // 0x01F0(0x000C)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	struct FRigUnit_HierarchyAddControl_ShapeSettings Settings;                                      // 0x0200(0x0080)
};
...
{
public:
	struct FRigControlLimitEnabled                Pitch;                                             // 0x0000(0x0002)
	struct FRigControlLimitEnabled                Yaw;                                               // 0x0002(0x0002)
	struct FRigControlLimitEnabled                Roll;                                              // 0x0004(0x0002)
};
...
{
public:
	struct FRotator                               InitialValue;                                      // 0x0210(0x0018)
	struct FRotator                               MinimumValue;                                      // 0x0228(0x0018)
	struct FRotator                               MaximumValue;                                      // 0x0240(0x0018)
	struct FRigUnit_HierarchyAddAnimationChannelRotatorLimitSettings LimitsEnabled;                  // 0x0258(0x0006)
	uint8                                         Pad_25E[0x2];                                      // 0x025E(0x0002)
};
...
public:
	uint8                                         Pad_18[0x8];                                       // 0x0018(0x0008)
	struct FControlRigExecuteContext              ExecuteContext;                                    // 0x0020(0x01E0)
};
...
public:
	...
	uint8                                         Pad_204[0xC];                                      // 0x0204(0x000C)
};
...
{
public:
	struct FRigElementKey                         Channel;                                           // 0x01F0(0x000C)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	TArray<struct FRigElementKey>                 Hosts;                                             // 0x0200(0x0010)
};
...
{
public:
	ERigSwitchParentMode                          Mode;                                              // 0x01F0(0x0001)
	uint8                                         Pad_1F1[0x3];                                      // 0x01F1(0x0003)
	struct FRigElementKey                         Child;                                             // 0x01F4(0x000C)
	struct FRigElementKey                         Parent;                                            // 0x0200(0x000C)
	bool                                          bMaintainGlobal;                                   // 0x020C(0x0001)
...
public:
	struct FRigElementKey                         Child;                                             // 0x0008(0x000C)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	TArray<struct FRigElementWeight>              Weights;                                           // 0x0018(0x0010)
...
public:
	...
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	TArray<struct FRigElementWeight>              Weights;                                           // 0x0018(0x0010)
	TArray<struct FRigElementKey>                 Parents;                                           // 0x0028(0x0010)
};
...
{
public:
	struct FRotator                               Value;                                             // 0x0210(0x0018)
	uint8                                         Pad_228[0x8];                                      // 0x0228(0x0008)
};
...
public:
	struct FRigElementKey                         Child;                                             // 0x01F0(0x000C)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	TArray<struct FRigElementWeight>              Weights;                                           // 0x0200(0x0010)
};
...
{
public:
	class FName                                   NameSpace;                                         // 0x01F0(0x0008)
	bool                                          bIncludeCurves;                                    // 0x01F8(0x0001)
	uint8                                         Pad_1F9[0x7];                                      // 0x01F9(0x0007)
	TArray<struct FRigElementKey>                 Items;                                             // 0x0200(0x0010)
};
...
public:
	struct FTransform                             Transform;                                         // 0x0210(0x0060)
	ERigVMTransformSpace                          Space;                                             // 0x0270(0x0001)
...
{
public:
	struct FVector2D                              Value;                                             // 0x0200(0x0010)
};
...
{
public:
	class FName                                   Curve;                                             // 0x0008(0x0008)
...
{
public:
	struct FRigControlLimitEnabled                Limit;                                             // 0x0000(0x0002)
	uint8                                         Pad_2[0x2];                                        // 0x0002(0x0002)
...
public:
	...
	struct FRigUnit_HierarchyAddControlFloat_LimitSettings Limits;                                   // 0x0014(0x0010)
	uint8                                         Pad_24[0xC];                                       // 0x0024(0x000C)
	struct FRigUnit_HierarchyAddControl_ShapeSettings Shape;                                         // 0x0030(0x0080)
	struct FRigUnit_HierarchyAddControl_ProxySettings Proxy;                                         // 0x00B0(0x0020)
};
...
{
public:
	float                                         InitialValue;                                      // 0x0278(0x0004)
	uint8                                         Pad_27C[0x4];                                      // 0x027C(0x0004)
	struct FRigUnit_HierarchyAddControlFloat_Settings Settings;                                      // 0x0280(0x00D0)
};
...
public:
	struct FRigControlLimitEnabled                Limit;                                             // 0x0000(0x0002)
	uint8                                         Pad_2[0x2];                                        // 0x0002(0x0002)
	int32                                         MinValue;                                          // 0x0004(0x0004)
	int32                                         MaxValue;                                          // 0x0008(0x0004)
	bool                                          bDrawLimits;                                       // 0x000C(0x0001)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)
};
...
public:
	...
	struct FRigUnit_HierarchyAddControlInteger_LimitSettings Limits;                                 // 0x0020(0x0010)
	struct FRigUnit_HierarchyAddControl_ShapeSettings Shape;                                         // 0x0030(0x0080)
	struct FRigUnit_HierarchyAddControl_ProxySettings Proxy;                                         // 0x00B0(0x0020)
};
...
{
public:
	struct FRotator                               Value;                                             // 0x0200(0x0018)
	uint8                                         Pad_218[0x8];                                      // 0x0218(0x0008)
};
...
{
public:
	int32                                         InitialValue;                                      // 0x0278(0x0004)
	uint8                                         Pad_27C[0x4];                                      // 0x027C(0x0004)
	struct FRigUnit_HierarchyAddControlInteger_Settings Settings;                                    // 0x0280(0x00D0)
};
...
{
public:
	struct FVector                                InitialValue;                                      // 0x0278(0x0018)
	struct FRigUnit_HierarchyAddControlVector_Settings Settings;                                     // 0x0290(0x0110)
};
...
public:
	uint8                                         Pad_278[0x8];                                      // 0x0278(0x0008)
	struct FTransform                             InitialValue;                                      // 0x0280(0x0060)
	struct FRigUnit_HierarchyAddControlTransform_Settings Settings;                                  // 0x02E0(0x0180)
};
...
{
public:
	bool                                          InitialValue;                                      // 0x0210(0x0001)
	bool                                          MinimumValue;                                      // 0x0211(0x0001)
	bool                                          MaximumValue;                                      // 0x0212(0x0001)
	struct FRigUnit_HierarchyAddAnimationChannelEmptyLimitSettings LimitsEnabled;                    // 0x0213(0x0001)
	uint8                                         Pad_214[0xC];                                      // 0x0214(0x000C)
};
...
{
public:
	int32                                         InitialValue;                                      // 0x0210(0x0004)
	int32                                         MinimumValue;                                      // 0x0214(0x0004)
	int32                                         MaximumValue;                                      // 0x0218(0x0004)
	struct FRigUnit_HierarchyAddAnimationChannelSingleLimitSettings LimitsEnabled;                   // 0x021C(0x0002)
	uint8                                         Pad_21E[0x2];                                      // 0x021E(0x0002)
	class UEnum*                                  ControlEnum;                                       // 0x0220(0x0008)
	uint8                                         Pad_228[0x8];                                      // 0x0228(0x0008)
};
...
{
public:
	struct FVector2D                              InitialValue;                                      // 0x0210(0x0010)
	struct FVector2D                              MinimumValue;                                      // 0x0220(0x0010)
	struct FVector2D                              MaximumValue;                                      // 0x0230(0x0010)
	struct FRigUnit_HierarchyAddAnimationChannel2DLimitSettings LimitsEnabled;                       // 0x0240(0x0004)
	uint8                                         Pad_244[0xC];                                      // 0x0244(0x000C)
};
...
public:
	struct FRigElementKey                         Item;                                              // 0x0008(0x000C)
	uint8                                         Pad_14[0xC];                                       // 0x0014(0x000C)
	struct FRigUnit_HierarchyAddControl_ShapeSettings Settings;                                      // 0x0020(0x0080)
};
...
public:
	...
	class FString                                 Description;                                       // 0x0288(0x0010)
...
public:
	struct FRigElementKey                         Item;                                              // 0x0008(0x000C)
	bool                                          bIncludeItem;                                      // 0x0014(0x0001)
	bool                                          bDefaultSiblings;                                  // 0x0015(0x0001)
	uint8                                         Pad_16[0x2];                                       // 0x0016(0x0002)
	TArray<struct FRigElementKey>                 Siblings;                                          // 0x0018(0x0010)
	struct FCachedRigElement                      CachedItem;                                        // 0x0028(0x0020)
	struct FRigElementKeyCollection               CachedSiblings;                                    // 0x0048(0x0010)
};
...
public:
	...
	ERigVMTransformSpace                          Space;                                             // 0x0261(0x0001)
	uint8                                         Pad_262[0x6];                                      // 0x0262(0x0006)
	struct FRigElementKeyCollection               ItemsToSet;                                        // 0x0268(0x0010)
	float                                         Weight;                                            // 0x0278(0x0004)
	uint8                                         Pad_27C[0x4];                                      // 0x027C(0x0004)
};
...
public:
	...
	uint8                                         Pad_86[0xA];                                       // 0x0086(0x000A)
	struct FTransform                             Transform;                                         // 0x0090(0x0060)
	float                                         CurveValue;                                        // 0x00F0(0x0004)
	int32                                         CachedPoseElementIndex;                            // 0x00F4(0x0004)
	int32                                         CachedPoseHash;                                    // 0x00F8(0x0004)
...
public:
	struct FRigPose                               Pose;                                              // 0x0008(0x0070)
	class FName                                   Curve;                                             // 0x0078(0x0008)
	bool                                          Valid;                                             // 0x0080(0x0001)
	uint8                                         Pad_81[0x3];                                       // 0x0081(0x0003)
	float                                         CurveValue;                                        // 0x0084(0x0004)
	int32                                         CachedPoseElementIndex;                            // 0x0088(0x0004)
	int32                                         CachedPoseHash;                                    // 0x008C(0x0004)
};
...
public:
	struct FRigElementKey                         Item;                                              // 0x0008(0x000C)
	class FName                                   Old;                                               // 0x0014(0x0008)
	class FName                                   New;                                               // 0x001C(0x0008)
...
{
public:
	class FName                                   Name;                                              // 0x01F0(0x0008)
	struct FRigPhysicsSolverID                    Solver;                                            // 0x01F8(0x0010)
	uint8                                         Pad_208[0x8];                                      // 0x0208(0x0008)
};
...
{
public:
	struct FRigElementKey                         Connector;                                         // 0x0008(0x000C)
	bool                                          SkipSocket;                                        // 0x0014(0x0001)
	uint8                                         Pad_15[0x3];                                       // 0x0015(0x0003)
	struct FRigElementKey                         Result;                                            // 0x0018(0x000C)
...
public:
	struct FRigElementKey                         Item;                                              // 0x0008(0x000C)
	class FName                                   ShortName;                                         // 0x0014(0x0008)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FControlRigExecuteContext              ExecuteContext;                                    // 0x0010(0x01E0)
	struct FControlRigExecuteContext              A;                                                 // 0x01F0(0x01E0)
	struct FControlRigExecuteContext              B;                                                 // 0x03D0(0x01E0)
	struct FControlRigExecuteContext              C;                                                 // 0x05B0(0x01E0)
	struct FControlRigExecuteContext              D;                                                 // 0x0790(0x01E0)
};
...
{
public:
	struct FVector                                Value;                                             // 0x0030(0x0018)
};
...
public:
	...
	TArray<struct FCachedRigElement>              BoneIndices;                                       // 0x0078(0x0010)
};
...
{
public:
	struct FRotator                               Value;                                             // 0x0030(0x0018)
};
...
{
public:
	struct FTransform                             Value;                                             // 0x0030(0x0060)
};
...
{
public:
	struct FVector2D                              Value;                                             // 0x0210(0x0010)
};
...
{
public:
	struct FTransform                             Value;                                             // 0x0210(0x0060)
};
...
{
public:
	struct FVector                                Value;                                             // 0x0200(0x0018)
	uint8                                         Pad_218[0x8];                                      // 0x0218(0x0008)
};
...
public:
	class FName                                   Control;                                           // 0x0008(0x0008)
	int32                                         IntegerValue;                                      // 0x0010(0x0004)
	int32                                         Minimum;                                           // 0x0014(0x0004)
	int32                                         Maximum;                                           // 0x0018(0x0004)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	struct FCachedRigElement                      CachedControlIndex;                                // 0x0020(0x0020)
};
...
public:
	...
	ERigVMTransformSpace                          Space;                                             // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
	struct FVector                                Vector;                                            // 0x0018(0x0018)
	struct FVector                                Minimum;                                           // 0x0030(0x0018)
	struct FVector                                Maximum;                                           // 0x0048(0x0018)
	struct FCachedRigElement                      CachedControlIndex;                                // 0x0060(0x0020)
};
...
public:
	...
	uint8                                         Pad_11[0xF];                                       // 0x0011(0x000F)
	struct FTransform                             Transform;                                         // 0x0020(0x0060)
	struct FTransform                             Minimum;                                           // 0x0080(0x0060)
	struct FTransform                             Maximum;                                           // 0x00E0(0x0060)
...
public:
	...
	uint8                                         Pad_25[0xB];                                       // 0x0025(0x000B)
	struct FTransform                             RelativeTransform;                                 // 0x0030(0x0060)
...
public:
	struct FRigElementKey                         Item;                                              // 0x01F0(0x000C)
	ERigMetaDataNameSpace                         NameSpace;                                         // 0x01FC(0x0001)
	bool                                          Removed;                                           // 0x01FD(0x0001)
	uint8                                         Pad_1FE[0x2];                                      // 0x01FE(0x0002)
	struct FCachedRigElement                      CachedIndex;                                       // 0x0200(0x0020)
};
...
public:
	...
	TArray<struct FTransform>                     ItemTransforms;                                    // 0x0020(0x0010)
};
...
public:
	struct FRigElementKeyCollection               Items;                                             // 0x01F0(0x0010)
	struct FVector                                TwistAxis;                                         // 0x0200(0x0018)
	struct FVector                                PoleAxis;                                          // 0x0218(0x0018)
	ERigVMAnimEasingType                          TwistEaseType;                                     // 0x0230(0x0001)
	uint8                                         Pad_231[0x3];                                      // 0x0231(0x0003)
	float                                         Weight;                                            // 0x0234(0x0004)
	bool                                          bPropagateToChildren;                              // 0x0238(0x0001)
	uint8                                         Pad_239[0x7];                                      // 0x0239(0x0007)
	struct FRigUnit_TwistBones_WorkData           WorkData;                                          // 0x0240(0x0030)
};
...
public:
	...
	uint8                                         Pad_2A[0x6];                                       // 0x002A(0x0006)
	struct FCachedRigElement                      CachedIndex;                                       // 0x0030(0x0020)
};
...
{
public:
	TArray<class FName>                           Tags;                                              // 0x0008(0x0010)
	ERigMetaDataNameSpace                         NameSpace;                                         // 0x0018(0x0001)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)
	TArray<struct FRigElementKey>                 Items;                                             // 0x0020(0x0010)
};
...
public:
	struct FRigElementKey                         Item;                                              // 0x01F0(0x000C)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	struct FTransform                             OffsetTransform;                                   // 0x0200(0x0060)
	float                                         Weight;                                            // 0x0260(0x0004)
	bool                                          bPropagateToChildren;                              // 0x0264(0x0001)
	uint8                                         Pad_265[0x3];                                      // 0x0265(0x0003)
	struct FCachedRigElement                      CachedIndex;                                       // 0x0268(0x0020)
...
public:
	struct FRigElementKey                         Subject;                                           // 0x01F0(0x000C)
	int32                                         ParentIndex;                                       // 0x01FC(0x0004)
	TArray<struct FRigElementKey>                 Parents;                                           // 0x0200(0x0010)
	struct FTransform                             InitialGlobalTransform;                            // 0x0210(0x0060)
	float                                         Weight;                                            // 0x0270(0x0004)
	uint8                                         Pad_274[0xC];                                      // 0x0274(0x000C)
	struct FTransform                             Transform;                                         // 0x0280(0x0060)
...
public:
	struct FRigElementKey                         Item;                                              // 0x01F0(0x000C)
	bool                                          bRecomputeGlobal;                                  // 0x01FC(0x0001)
	bool                                          bApplyToChildren;                                  // 0x01FD(0x0001)
	bool                                          bRecursive;                                        // 0x01FE(0x0001)
...
public:
	...
	struct FTransform                             Result;                                            // 0x0260(0x0060)
	ERigVMTransformSpace                          Space;                                             // 0x02C0(0x0001)
	bool                                          bPropagateToChildren;                              // 0x02C1(0x0001)
	uint8                                         Pad_2C2[0x6];                                      // 0x02C2(0x0006)
	struct FCachedRigElement                      CachedBone;                                        // 0x02C8(0x0020)
	uint8                                         Pad_2E8[0x8];                                      // 0x02E8(0x0008)
};
...
public:
	...
	float                                         Weight;                                            // 0x02C4(0x0004)
	bool                                          bPropagateToChildren;                              // 0x02C8(0x0001)
	uint8                                         Pad_2C9[0x7];                                      // 0x02C9(0x0007)
	struct FCachedRigElement                      CachedBone;                                        // 0x02D0(0x0020)
};
...
public:
	class FName                                   Control;                                           // 0x0008(0x0008)
	TArray<struct FRigElementKey>                 Driven;                                            // 0x0010(0x0010)
	struct FCachedRigElement                      CachedControlIndex;                                // 0x0020(0x0020)
};
...
public:
	class FName                                   Control;                                           // 0x01F0(0x0008)
	uint8                                         Pad_1F8[0x8];                                      // 0x01F8(0x0008)
	struct FTransform                             Offset;                                            // 0x0200(0x0060)
	ERigVMTransformSpace                          Space;                                             // 0x0260(0x0001)
	uint8                                         Pad_261[0x7];                                      // 0x0261(0x0007)
	struct FCachedRigElement                      CachedControlIndex;                                // 0x0268(0x0020)
	uint8                                         Pad_288[0x8];                                      // 0x0288(0x0008)
...
public:
	class FName                                   Control;                                           // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	struct FCachedRigElement                      CachedControlIndex;                                // 0x0070(0x0020)
};
...
public:
	...
	uint8                                         Pad_1F8[0x8];                                      // 0x01F8(0x0008)
	struct FTransform                             Transform;                                         // 0x0200(0x0060)
	struct FCachedRigElement                      CachedControlIndex;                                // 0x0260(0x0020)
};
...
public:
	class FName                                   Control;                                           // 0x01F0(0x0008)
	float                                         Weight;                                            // 0x01F8(0x0004)
	float                                         FloatValue;                                        // 0x01FC(0x0004)
	struct FCachedRigElement                      CachedControlIndex;                                // 0x0200(0x0020)
};
...
{
public:
	TArray<struct FRigUnit_SetMultiControlFloat_Entry> Entries;                                      // 0x01F0(0x0010)
	float                                         Weight;                                            // 0x0200(0x0004)
	uint8                                         Pad_204[0x4];                                      // 0x0204(0x0004)
	TArray<struct FCachedRigElement>              CachedControlIndices;                              // 0x0208(0x0010)
	uint8                                         Pad_218[0x8];                                      // 0x0218(0x0008)
...
public:
	...
	TArray<struct FCachedRigElement>              CachedItems;                                       // 0x0018(0x0010)
	TArray<struct FTransform>                     Transforms;                                        // 0x0028(0x0010)
	TArray<struct FTransform>                     BlendedTransforms;                                 // 0x0038(0x0010)
};
...
public:
	...
	float                                         Weight;                                            // 0x01F8(0x0004)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	struct FVector2D                              Vector;                                            // 0x0200(0x0010)
	struct FCachedRigElement                      CachedControlIndex;                                // 0x0210(0x0020)
};
...
{
public:
	TArray<struct FRigUnit_SetMultiControlVector2D_Entry> Entries;                                   // 0x01F0(0x0010)
	float                                         Weight;                                            // 0x0200(0x0004)
	uint8                                         Pad_204[0x4];                                      // 0x0204(0x0004)
	TArray<struct FCachedRigElement>              CachedControlIndices;                              // 0x0208(0x0010)
	uint8                                         Pad_218[0x8];                                      // 0x0218(0x0008)
...
public:
	...
	float                                         Weight;                                            // 0x01F8(0x0004)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	struct FRotator                               Rotator;                                           // 0x0200(0x0018)
	ERigVMTransformSpace                          Space;                                             // 0x0218(0x0001)
	uint8                                         Pad_219[0x7];                                      // 0x0219(0x0007)
	struct FCachedRigElement                      CachedControlIndex;                                // 0x0220(0x0020)
};
...
{
public:
	TArray<struct FRigUnit_SetMultiControlRotator_Entry> Entries;                                    // 0x01F0(0x0010)
	float                                         Weight;                                            // 0x0200(0x0004)
	uint8                                         Pad_204[0x4];                                      // 0x0204(0x0004)
	TArray<struct FCachedRigElement>              CachedControlIndices;                              // 0x0208(0x0010)
	uint8                                         Pad_218[0x8];                                      // 0x0218(0x0008)
...
public:
	...
	uint8                                         Pad_18[0x8];                                       // 0x0018(0x0008)
	struct FTransform                             WorldOffset;                                       // 0x0020(0x0060)
};
...
public:
	class FName                                   Curve;                                             // 0x01F0(0x0008)
	float                                         Value;                                             // 0x01F8(0x0004)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	struct FCachedRigElement                      CachedCurveIndex;                                  // 0x0200(0x0020)
};
...
public:
	TArray<struct FConstraintData>                ConstraintData;                                    // 0x0000(0x0010)
	TMap<int32, int32>                            ConstraintDataToTargets;                           // 0x0010(0x0050)
};
...
public:
	...
	struct FTransform                             Value;                                             // 0x0210(0x0060)
	float                                         Weight;                                            // 0x0270(0x0004)
	bool                                          bPropagateToChildren;                              // 0x0274(0x0001)
	uint8                                         Pad_275[0x3];                                      // 0x0275(0x0003)
	struct FCachedRigElement                      CachedChild;                                       // 0x0278(0x0020)
	struct FCachedRigElement                      CachedParent;                                      // 0x0298(0x0020)
...
public:
	...
	bool                                          bParentInitial;                                    // 0x0208(0x0001)
	uint8                                         Pad_209[0x7];                                      // 0x0209(0x0007)
	struct FQuat                                  Value;                                             // 0x0210(0x0020)
	float                                         Weight;                                            // 0x0230(0x0004)
	bool                                          bPropagateToChildren;                              // 0x0234(0x0001)
	uint8                                         Pad_235[0x3];                                      // 0x0235(0x0003)
	struct FCachedRigElement                      CachedChild;                                       // 0x0238(0x0020)
	struct FCachedRigElement                      CachedParent;                                      // 0x0258(0x0020)
	uint8                                         Pad_278[0x8];                                      // 0x0278(0x0008)
};
...
{
public:
	class FName                                   Space;                                             // 0x01F0(0x0008)
	float                                         Weight;                                            // 0x01F8(0x0004)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	struct FTransform                             Transform;                                         // 0x0200(0x0060)
	ERigVMTransformSpace                          SpaceType;                                         // 0x0260(0x0001)
	uint8                                         Pad_261[0x7];                                      // 0x0261(0x0007)
	struct FCachedRigElement                      CachedSpaceIndex;                                  // 0x0268(0x0020)
	uint8                                         Pad_288[0x8];                                      // 0x0288(0x0008)
};
...
public:
	...
	bool                                          bPropagateToChildren;                              // 0x021C(0x0001)
	uint8                                         Pad_21D[0x3];                                      // 0x021D(0x0003)
	struct FCachedRigElement                      CachedIndex;                                       // 0x0220(0x0020)
};
...
public:
	...
	bool                                          bInitial;                                          // 0x01FD(0x0001)
	uint8                                         Pad_1FE[0x2];                                      // 0x01FE(0x0002)
	struct FVector                                Scale;                                             // 0x0200(0x0018)
	float                                         Weight;                                            // 0x0218(0x0004)
	bool                                          bPropagateToChildren;                              // 0x021C(0x0001)
	uint8                                         Pad_21D[0x3];                                      // 0x021D(0x0003)
	struct FCachedRigElement                      CachedIndex;                                       // 0x0220(0x0020)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Value;                                             // 0x0010(0x0060)
	struct FTransform                             World;                                             // 0x0070(0x0060)
};
...
public:
	struct FVector                                Value;                                             // 0x0008(0x0018)
	struct FVector                                World;                                             // 0x0020(0x0018)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Value;                                             // 0x0010(0x0020)
	struct FQuat                                  World;                                             // 0x0030(0x0020)
};
...
{
public:
	TArray<struct FRigUnit_Harmonics_TargetItem>  Targets;                                           // 0x01F0(0x0010)
	struct FVector                                WaveSpeed;                                         // 0x0200(0x0018)
	struct FVector                                WaveFrequency;                                     // 0x0218(0x0018)
	struct FVector                                WaveAmplitude;                                     // 0x0230(0x0018)
	struct FVector                                WaveOffset;                                        // 0x0248(0x0018)
...
{
public:
	struct FRigElementKey                         ChainRoot;                                         // 0x01F0(0x000C)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	struct FVector                                Speed;                                             // 0x0200(0x0018)
	struct FRigUnit_ChainHarmonics_Reach          Reach;                                             // 0x0218(0x0048)
	struct FRigUnit_ChainHarmonics_Wave           Wave;                                              // 0x0260(0x0078)
	struct FRuntimeFloatCurve                     WaveCurve;                                         // 0x02D8(0x0088)
	struct FRigUnit_ChainHarmonics_Pendulum       Pendulum;                                          // 0x0360(0x0058)
	bool                                          bDrawDebug;                                        // 0x03B8(0x0001)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             InputTransform;                                    // 0x0010(0x0060)
...
public:
	struct FRigElementKey                         Item;                                              // 0x01F0(0x000C)
	uint8                                         Pad_1FC[0x4];                                      // 0x01FC(0x0004)
	struct FRigUnit_AimItem_Target                Primary;                                           // 0x0200(0x0048)
	struct FRigUnit_AimItem_Target                Secondary;                                         // 0x0248(0x0048)
	float                                         Weight;                                            // 0x0290(0x0004)
	uint8                                         Pad_294[0xC];                                      // 0x0294(0x000C)
	struct FRigUnit_AimBone_DebugSettings         DebugSettings;                                     // 0x02A0(0x0070)
	struct FCachedRigElement                      CachedItem;                                        // 0x0310(0x0020)
	struct FCachedRigElement                      PrimaryCachedSpace;                                // 0x0330(0x0020)
	struct FCachedRigElement                      SecondaryCachedSpace;                              // 0x0350(0x0020)
...
{
public:
	TArray<struct FCCDIKChainLink>                Chain;                                             // 0x0000(0x0010)
	TArray<struct FCachedRigElement>              CachedItems;                                       // 0x0010(0x0010)
	TArray<int32>                                 RotationLimitIndex;                                // 0x0020(0x0010)
...
{
public:
	class FName                                   StartBone;                                         // 0x01F0(0x0008)
	class FName                                   EffectorBone;                                      // 0x01F8(0x0008)
	struct FTransform                             EffectorTransform;                                 // 0x0200(0x0060)
	float                                         Precision;                                         // 0x0260(0x0004)
	float                                         Weight;                                            // 0x0264(0x0004)
	int32                                         MaxIterations;                                     // 0x0268(0x0004)
	bool                                          bStartFromTail;                                    // 0x026C(0x0001)
	uint8                                         Pad_26D[0x3];                                      // 0x026D(0x0003)
	float                                         BaseRotationLimit;                                 // 0x0270(0x0004)
	uint8                                         Pad_274[0x4];                                      // 0x0274(0x0004)
	TArray<struct FRigUnit_CCDIK_RotationLimit>   RotationLimits;                                    // 0x0278(0x0010)
	bool                                          bPropagateToChildren;                              // 0x0288(0x0001)
	uint8                                         Pad_289[0x7];                                      // 0x0289(0x0007)
	struct FRigUnit_CCDIK_WorkData                WorkData;                                          // 0x0290(0x0060)
};
...
public:
	...
	float                                         BaseRotationLimit;                                 // 0x0270(0x0004)
	uint8                                         Pad_274[0x4];                                      // 0x0274(0x0004)
	TArray<struct FRigUnit_CCDIK_RotationLimitPerItem> RotationLimits;                               // 0x0278(0x0010)
	bool                                          bPropagateToChildren;                              // 0x0288(0x0001)
	uint8                                         Pad_289[0x7];                                      // 0x0289(0x0007)
	struct FRigUnit_CCDIK_WorkData                WorkData;                                          // 0x0290(0x0060)
};
...
{
public:
	struct FQuat                                  Rotation;                                          // 0x0000(0x0020)
...
public:
	TArray<struct FCachedRigElement>              CachedItems;                                       // 0x0000(0x0010)
	TArray<int32>                                 ItemRotationA;                                     // 0x0010(0x0010)
	TArray<int32>                                 ItemRotationB;                                     // 0x0020(0x0010)
	TArray<float>                                 ItemRotationT;                                     // 0x0030(0x0010)
	TArray<struct FTransform>                     ItemLocalTransforms;                               // 0x0040(0x0010)
};
...
public:
	class FName                                   StartBone;                                         // 0x01F0(0x0008)
	class FName                                   EndBone;                                           // 0x01F8(0x0008)
	TArray<struct FRigUnit_DistributeRotation_Rotation> Rotations;                                   // 0x0200(0x0010)
	ERigVMAnimEasingType                          RotationEaseType;                                  // 0x0210(0x0001)
	uint8                                         Pad_211[0x3];                                      // 0x0211(0x0003)
	float                                         Weight;                                            // 0x0214(0x0004)
	bool                                          bPropagateToChildren;                              // 0x0218(0x0001)
	uint8                                         Pad_219[0x7];                                      // 0x0219(0x0007)
	struct FRigUnit_DistributeRotation_WorkData   WorkData;                                          // 0x0220(0x0050)
};
...
public:
	...
	uint8                                         Pad_211[0x3];                                      // 0x0211(0x0003)
	float                                         Weight;                                            // 0x0214(0x0004)
	struct FRigUnit_DistributeRotation_WorkData   WorkData;                                          // 0x0218(0x0050)
	uint8                                         Pad_268[0x8];                                      // 0x0268(0x0008)
};
...
{
public:
	TArray<struct FFABRIKChainLink>               Chain;                                             // 0x0000(0x0010)
	TArray<struct FCachedRigElement>              CachedItems;                                       // 0x0010(0x0010)
...
public:
	...
	int32                                         MaxIterations;                                     // 0x026C(0x0004)
	struct FRigUnit_FABRIK_WorkData               WorkData;                                          // 0x0270(0x0040)
	bool                                          bSetEffectorTransform;                             // 0x02B0(0x0001)
	uint8                                         Pad_2B1[0xF];                                      // 0x02B1(0x000F)
};
...
public:
	...
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	float                                         Scale;                                             // 0x0004(0x0004)
	struct FLinearColor                           CurveColor;                                        // 0x0008(0x0010)
	struct FLinearColor                           SegmentsColor;                                     // 0x0018(0x0010)
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	struct FTransform                             WorldOffset;                                       // 0x0030(0x0060)
};
...
public:
	float                                         ChainLength;                                       // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	TArray<struct FVector>                        ItemPositions;                                     // 0x0008(0x0010)
	TArray<float>                                 ItemSegments;                                      // 0x0018(0x0010)
	TArray<struct FVector>                        CurvePositions;                                    // 0x0028(0x0010)
	TArray<float>                                 CurveSegments;                                     // 0x0038(0x0010)
	TArray<struct FCachedRigElement>              CachedItems;                                       // 0x0048(0x0010)
	TArray<int32>                                 ItemRotationA;                                     // 0x0058(0x0010)
	TArray<int32>                                 ItemRotationB;                                     // 0x0068(0x0010)
	TArray<float>                                 ItemRotationT;                                     // 0x0078(0x0010)
	TArray<struct FTransform>                     ItemLocalTransforms;                               // 0x0088(0x0010)
};
...
public:
	class FName                                   StartBone;                                         // 0x01F0(0x0008)
	class FName                                   EndBone;                                           // 0x01F8(0x0008)
	struct FRigVMFourPointBezier                  Bezier;                                            // 0x0200(0x0060)
	EControlRigCurveAlignment                     Alignment;                                         // 0x0260(0x0001)
	uint8                                         Pad_261[0x3];                                      // 0x0261(0x0003)
	float                                         Minimum;                                           // 0x0264(0x0004)
	float                                         Maximum;                                           // 0x0268(0x0004)
	int32                                         SamplingPrecision;                                 // 0x026C(0x0004)
	struct FVector                                PrimaryAxis;                                       // 0x0270(0x0018)
	struct FVector                                SecondaryAxis;                                     // 0x0288(0x0018)
	struct FVector                                PoleVectorPosition;                                // 0x02A0(0x0018)
	TArray<struct FRigUnit_FitChainToCurve_Rotation> Rotations;                                      // 0x02B8(0x0010)
	ERigVMAnimEasingType                          RotationEaseType;                                  // 0x02C8(0x0001)
	uint8                                         Pad_2C9[0x3];                                      // 0x02C9(0x0003)
	float                                         Weight;                                            // 0x02CC(0x0004)
	bool                                          bPropagateToChildren;                              // 0x02D0(0x0001)
	uint8                                         Pad_2D1[0xF];                                      // 0x02D1(0x000F)
	struct FRigUnit_FitChainToCurve_DebugSettings DebugSettings;                                     // 0x02E0(0x0090)
...
{
public:
	TArray<struct FRigUnit_ModifyBoneTransforms_PerBone> BoneToModify;                               // 0x01F0(0x0010)
	float                                         Weight;                                            // 0x0200(0x0004)
	float                                         WeightMinimum;                                     // 0x0204(0x0004)
	float                                         WeightMaximum;                                     // 0x0208(0x0004)
	EControlRigModifyBoneMode                     Mode;                                              // 0x020C(0x0001)
	uint8                                         Pad_20D[0x3];                                      // 0x020D(0x0003)
	struct FRigUnit_ModifyBoneTransforms_WorkData WorkData;                                          // 0x0210(0x0010)
};
...
{
public:
	TArray<struct FRigUnit_ModifyTransforms_PerItem> ItemToModify;                                   // 0x01F0(0x0010)
	float                                         Weight;                                            // 0x0200(0x0004)
	float                                         WeightMinimum;                                     // 0x0204(0x0004)
	float                                         WeightMaximum;                                     // 0x0208(0x0004)
	EControlRigModifyBoneMode                     Mode;                                              // 0x020C(0x0001)
	uint8                                         Pad_20D[0x3];                                      // 0x020D(0x0003)
	struct FRigUnit_ModifyTransforms_WorkData     WorkData;                                          // 0x0210(0x0010)
};

// ScriptStruct ControlRig.RigUnit_MultiFABRIK_WorkData
// 0x0068 (0x0068 - 0x0000)
struct FRigUnit_MultiFABRIK_WorkData final
{
public:
...
{
public:
	class FName                                   RootBone;                                          // 0x01F0(0x0008)
	TArray<struct FRigUnit_MultiFABRIK_EndEffector> Effectors;                                       // 0x01F8(0x0010)
	float                                         Precision;                                         // 0x0208(0x0004)
	bool                                          bPropagateToChildren;                              // 0x020C(0x0001)
	uint8                                         Pad_20D[0x3];                                      // 0x020D(0x0003)
	int32                                         MaxIterations;                                     // 0x0210(0x0004)
	uint8                                         Pad_214[0x4];                                      // 0x0214(0x0004)
	struct FRigUnit_MultiFABRIK_WorkData          WorkData;                                          // 0x0218(0x0068)
	bool                                          bIsInitialized;                                    // 0x0280(0x0001)
	uint8                                         Pad_281[0xF];                                      // 0x0281(0x000F)
};
...
public:
	class FName                                   StartBone;                                         // 0x01F0(0x0008)
	class FName                                   EndBone;                                           // 0x01F8(0x0008)
	float                                         SlideAmount;                                       // 0x0200(0x0004)
	bool                                          bPropagateToChildren;                              // 0x0204(0x0001)
	uint8                                         Pad_205[0x3];                                      // 0x0205(0x0003)
	struct FRigUnit_SlideChain_WorkData           WorkData;                                          // 0x0208(0x0048)
};
...
struct FSphericalRegion final
{
public:
	uint8                                         Pad_0[0x14];                                       // 0x0000(0x0014)
};
...
public:
	...
	int32                                         DebugSegments;                                     // 0x0008(0x0004)
...
{
public:
	float                                         OutputParam;                                       // 0x01F0(0x0004)
	struct FRigElementKey                         DriverItem;                                        // 0x01F4(0x000C)
	struct FVector                                DriverAxis;                                        // 0x0200(0x0018)
	struct FVector                                RotationOffset;                                    // 0x0218(0x0018)
	float                                         ActiveRegionSize;                                  // 0x0230(0x0004)
	struct FRegionScaleFactors                    ActiveRegionScaleFactors;                          // 0x0234(0x0010)
	float                                         FalloffSize;                                       // 0x0244(0x0004)
	struct FRegionScaleFactors                    FalloffRegionScaleFactors;                         // 0x0248(0x0010)
	bool                                          FlipWidthScaling;                                  // 0x0258(0x0001)
	bool                                          FlipHeightScaling;                                 // 0x0259(0x0001)
	uint8                                         Pad_25A[0x2];                                      // 0x025A(0x0002)
	struct FRigElementKey                         OptionalParentItem;                                // 0x025C(0x000C)
	struct FSphericalPoseReaderDebugSettings      Debug;                                             // 0x0268(0x0010)
	struct FSphericalRegion                       InnerRegion;                                       // 0x0278(0x0014)
	struct FSphericalRegion                       OuterRegion;                                       // 0x028C(0x0014)
	struct FVector                                DriverNormal;                                      // 0x02A0(0x0018)
	struct FVector                                Driver2D;                                          // 0x02B8(0x0018)
	struct FCachedRigElement                      DriverCache;                                       // 0x02D0(0x0020)
	struct FCachedRigElement                      OptionalParentCache;                               // 0x02F0(0x0020)
	struct FTransform                             LocalDriverTransformInit;                          // 0x0310(0x0060)
	struct FVector                                CachedRotationOffset;                              // 0x0370(0x0018)
	bool                                          bCachedInitTransforms;                             // 0x0388(0x0001)
...
{
public:
	TArray<struct FCachedRigElement>              CachedBones;                                       // 0x0000(0x0010)
	struct FCachedRigElement                      CachedPoleVector;                                  // 0x0010(0x0020)
	TArray<struct FTransform>                     Transforms;                                        // 0x0030(0x0010)
...
public:
	class FName                                   StartBone;                                         // 0x01F0(0x0008)
	class FName                                   EndBone;                                           // 0x01F8(0x0008)
	float                                         HierarchyStrength;                                 // 0x0200(0x0004)
	float                                         EffectorStrength;                                  // 0x0204(0x0004)
	float                                         EffectorRatio;                                     // 0x0208(0x0004)
	float                                         RootStrength;                                      // 0x020C(0x0004)
	float                                         RootRatio;                                         // 0x0210(0x0004)
	float                                         Damping;                                           // 0x0214(0x0004)
	struct FVector                                PoleVector;                                        // 0x0218(0x0018)
	bool                                          bFlipPolePlane;                                    // 0x0230(0x0001)
	EControlRigVectorKind                         PoleVectorKind;                                    // 0x0231(0x0001)
	uint8                                         Pad_232[0x2];                                      // 0x0232(0x0002)
	class FName                                   PoleVectorSpace;                                   // 0x0234(0x0008)
	uint8                                         Pad_23C[0x4];                                      // 0x023C(0x0004)
	struct FVector                                PrimaryAxis;                                       // 0x0240(0x0018)
	struct FVector                                SecondaryAxis;                                     // 0x0258(0x0018)
	bool                                          bLiveSimulation;                                   // 0x0270(0x0001)
	uint8                                         Pad_271[0x3];                                      // 0x0271(0x0003)
	int32                                         Iterations;                                        // 0x0274(0x0004)
	bool                                          bLimitLocalPosition;                               // 0x0278(0x0001)
	bool                                          bPropagateToChildren;                              // 0x0279(0x0001)
	uint8                                         Pad_27A[0x6];                                      // 0x027A(0x0006)
	struct FRigUnit_SpringIK_DebugSettings        DebugSettings;                                     // 0x0280(0x0080)
	struct FRigUnit_SpringIK_WorkData             WorkData;                                          // 0x0300(0x00B8)
...
public:
	...
	struct FTransformFilter                       Filter;                                            // 0x0065(0x0009)
...
public:
	class FName                                   bone;                                              // 0x01F0(0x0008)
	ETransformSpaceMode                           BaseTransformSpace;                                // 0x01F8(0x0001)
	uint8                                         Pad_1F9[0x7];                                      // 0x01F9(0x0007)
	struct FTransform                             BaseTransform;                                     // 0x0200(0x0060)
	class FName                                   BaseBone;                                          // 0x0260(0x0008)
	TArray<struct FConstraintTarget>              Targets;                                           // 0x0268(0x0010)
	bool                                          bUseInitialTransforms;                             // 0x0278(0x0001)
	uint8                                         Pad_279[0x7];                                      // 0x0279(0x0007)
	struct FRigUnit_TransformConstraint_WorkData  WorkData;                                          // 0x0280(0x0060)
};
...
public:
	struct FRigElementKey                         Item;                                              // 0x01F0(0x000C)
	ETransformSpaceMode                           BaseTransformSpace;                                // 0x01FC(0x0001)
	uint8                                         Pad_1FD[0x3];                                      // 0x01FD(0x0003)
	struct FTransform                             BaseTransform;                                     // 0x0200(0x0060)
	struct FRigElementKey                         BaseItem;                                          // 0x0260(0x000C)
	uint8                                         Pad_26C[0x4];                                      // 0x026C(0x0004)
	TArray<struct FConstraintTarget>              Targets;                                           // 0x0270(0x0010)
	bool                                          bUseInitialTransforms;                             // 0x0280(0x0001)
	uint8                                         Pad_281[0x7];                                      // 0x0281(0x0007)
	struct FRigUnit_TransformConstraint_WorkData  WorkData;                                          // 0x0288(0x0060)
	uint8                                         Pad_2E8[0x8];                                      // 0x02E8(0x0008)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Input;                                             // 0x0010(0x0060)
	TArray<struct FConstraintParent>              Parents;                                           // 0x0070(0x0010)
	struct FRigUnit_ParentConstraintMath_AdvancedSettings AdvancedSettings;                          // 0x0080(0x0001)
	uint8                                         Pad_81[0xF];                                       // 0x0081(0x000F)
	struct FTransform                             Output;                                            // 0x0090(0x0060)
	TArray<struct FCachedRigElement>              ParentCaches;                                      // 0x00F0(0x0010)
};
...
public:
	...
	struct FFilterOptionPerAxis                   Filter;                                            // 0x01FD(0x0003)
	TArray<struct FConstraintParent>              Parents;                                           // 0x0200(0x0010)
	struct FRigUnit_RotationConstraint_AdvancedSettings AdvancedSettings;                            // 0x0210(0x0002)
...
{
public:
	class FName                                   BoneA;                                             // 0x01F0(0x0008)
	class FName                                   BoneB;                                             // 0x01F8(0x0008)
	class FName                                   EffectorBone;                                      // 0x0200(0x0008)
	uint8                                         Pad_208[0x8];                                      // 0x0208(0x0008)
	struct FTransform                             Effector;                                          // 0x0210(0x0060)
	struct FVector                                PrimaryAxis;                                       // 0x0270(0x0018)
	struct FVector                                SecondaryAxis;                                     // 0x0288(0x0018)
	float                                         SecondaryAxisWeight;                               // 0x02A0(0x0004)
	uint8                                         Pad_2A4[0x4];                                      // 0x02A4(0x0004)
	struct FVector                                PoleVector;                                        // 0x02A8(0x0018)
	EControlRigVectorKind                         PoleVectorKind;                                    // 0x02C0(0x0001)
	uint8                                         Pad_2C1[0x3];                                      // 0x02C1(0x0003)
	class FName                                   PoleVectorSpace;                                   // 0x02C4(0x0008)
	bool                                          bEnableStretch;                                    // 0x02CC(0x0001)
	uint8                                         Pad_2CD[0x3];                                      // 0x02CD(0x0003)
	float                                         StretchStartRatio;                                 // 0x02D0(0x0004)
	float                                         StretchMaximumRatio;                               // 0x02D4(0x0004)
	float                                         Weight;                                            // 0x02D8(0x0004)
	float                                         BoneALength;                                       // 0x02DC(0x0004)
	float                                         BoneBLength;                                       // 0x02E0(0x0004)
	bool                                          bPropagateToChildren;                              // 0x02E4(0x0001)
	uint8                                         Pad_2E5[0xB];                                      // 0x02E5(0x000B)
	struct FRigUnit_TwoBoneIKSimple_DebugSettings DebugSettings;                                     // 0x02F0(0x0070)
	struct FCachedRigElement                      CachedBoneAIndex;                                  // 0x0360(0x0020)
	struct FCachedRigElement                      CachedBoneBIndex;                                  // 0x0380(0x0020)
	struct FCachedRigElement                      CachedEffectorBoneIndex;                           // 0x03A0(0x0020)
	struct FCachedRigElement                      CachedPoleVectorSpaceIndex;                        // 0x03C0(0x0020)
};
...
{
public:
	struct FRigElementKey                         ItemA;                                             // 0x01F0(0x000C)
	struct FRigElementKey                         ItemB;                                             // 0x01FC(0x000C)
	struct FRigElementKey                         EffectorItem;                                      // 0x0208(0x000C)
	uint8                                         Pad_214[0xC];                                      // 0x0214(0x000C)
	struct FTransform                             Effector;                                          // 0x0220(0x0060)
	struct FVector                                PrimaryAxis;                                       // 0x0280(0x0018)
	struct FVector                                SecondaryAxis;                                     // 0x0298(0x0018)
	float                                         SecondaryAxisWeight;                               // 0x02B0(0x0004)
	uint8                                         Pad_2B4[0x4];                                      // 0x02B4(0x0004)
	struct FVector                                PoleVector;                                        // 0x02B8(0x0018)
	EControlRigVectorKind                         PoleVectorKind;                                    // 0x02D0(0x0001)
	uint8                                         Pad_2D1[0x3];                                      // 0x02D1(0x0003)
	struct FRigElementKey                         PoleVectorSpace;                                   // 0x02D4(0x000C)
	bool                                          bEnableStretch;                                    // 0x02E0(0x0001)
	uint8                                         Pad_2E1[0x3];                                      // 0x02E1(0x0003)
	float                                         StretchStartRatio;                                 // 0x02E4(0x0004)
	float                                         StretchMaximumRatio;                               // 0x02E8(0x0004)
	float                                         Weight;                                            // 0x02EC(0x0004)
	float                                         ItemALength;                                       // 0x02F0(0x0004)
	float                                         ItemBLength;                                       // 0x02F4(0x0004)
	bool                                          bPropagateToChildren;                              // 0x02F8(0x0001)
	uint8                                         Pad_2F9[0x7];                                      // 0x02F9(0x0007)
	struct FRigUnit_TwoBoneIKSimple_DebugSettings DebugSettings;                                     // 0x0300(0x0070)
	struct FCachedRigElement                      CachedItemAIndex;                                  // 0x0370(0x0020)
	struct FCachedRigElement                      CachedItemBIndex;                                  // 0x0390(0x0020)
	struct FCachedRigElement                      CachedEffectorItemIndex;                           // 0x03B0(0x0020)
	struct FCachedRigElement                      CachedPoleVectorSpaceIndex;                        // 0x03D0(0x0020)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Root;                                              // 0x0010(0x0060)
	struct FVector                                PoleVector;                                        // 0x0070(0x0018)
	uint8                                         Pad_88[0x8];                                       // 0x0088(0x0008)
	struct FTransform                             Effector;                                          // 0x0090(0x0060)
	struct FVector                                PrimaryAxis;                                       // 0x00F0(0x0018)
	struct FVector                                SecondaryAxis;                                     // 0x0108(0x0018)
	...
	uint8                                         Pad_138[0x8];                                      // 0x0138(0x0008)
	struct FTransform                             Elbow;                                             // 0x0140(0x0060)
};
...
public:
	struct FRigElementKey                         Connector;                                         // 0x0008(0x000C)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	TArray<struct FRigElementKey>                 Candidates;                                        // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FRigElementKey>                 Excluded;                                          // 0x01F0(0x0010)
	class FString                                 Message;                                           // 0x0200(0x0010)
};
...
public:
	class FName                                   bone;                                              // 0x0000(0x0008)
	int32                                         TranslationPoint;                                  // 0x0008(0x0004)
	int32                                         PrimaryAimPoint;                                   // 0x000C(0x0004)
	int32                                         SecondaryAimPoint;                                 // 0x0010(0x0004)
};
...
{
public:
	TArray<struct FRigVMSimPoint>                 Points;                                            // 0x0120(0x0010)
	TArray<struct FCRSimLinearSpring>             links;                                             // 0x0130(0x0010)
	TArray<struct FCRSimPointForce>               Forces;                                            // 0x0140(0x0010)
	TArray<struct FCRSimSoftCollision>            CollisionVolumes;                                  // 0x0150(0x0010)
	float                                         SimulatedStepsPerSecond;                           // 0x0160(0x0004)
	ERigVMSimPointIntegrateType                   IntegratorType;                                    // 0x0164(0x0001)
	uint8                                         Pad_165[0x3];                                      // 0x0165(0x0003)
	float                                         VerletBlend;                                       // 0x0168(0x0004)
	uint8                                         Pad_16C[0x4];                                      // 0x016C(0x0004)
	TArray<struct FRigUnit_PointSimulation_BoneTarget> BoneTargets;                                  // 0x0170(0x0010)
	bool                                          bLimitLocalPosition;                               // 0x0180(0x0001)
	bool                                          bPropagateToChildren;                              // 0x0181(0x0001)
	uint8                                         Pad_182[0x6];                                      // 0x0182(0x0006)
	struct FVector                                PrimaryAimAxis;                                    // 0x0188(0x0018)
	struct FVector                                SecondaryAimAxis;                                  // 0x01A0(0x0018)
	uint8                                         Pad_1B8[0x8];                                      // 0x01B8(0x0008)
	struct FRigUnit_PointSimulation_DebugSettings DebugSettings;                                     // 0x01C0(0x0080)
	struct FRigVMFourPointBezier                  Bezier;                                            // 0x0240(0x0060)
	struct FRigUnit_PointSimulation_WorkData      WorkData;                                          // 0x02A0(0x0088)
	uint8                                         Pad_328[0x8];                                      // 0x0328(0x0008)
};
...
{
public:
	struct FVector                                Target;                                            // 0x0008(0x0018)
	float                                         Strength;                                          // 0x0020(0x0004)
	float                                         CriticalDamping;                                   // 0x0024(0x0004)
	struct FVector                                Force;                                             // 0x0028(0x0018)
	bool                                          bUseCurrentInput;                                  // 0x0040(0x0001)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)
	struct FVector                                Current;                                           // 0x0048(0x0018)
	float                                         TargetVelocityAmount;                              // 0x0060(0x0004)
	bool                                          bInitializeFromTarget;                             // 0x0064(0x0001)
	uint8                                         Pad_65[0x3];                                       // 0x0065(0x0003)
	struct FVector                                Result;                                            // 0x0068(0x0018)
	struct FVector                                Velocity;                                          // 0x0080(0x0018)
	struct FVector                                SimulatedResult;                                   // 0x0098(0x0018)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Target;                                            // 0x0010(0x0020)
	float                                         Strength;                                          // 0x0030(0x0004)
	float                                         CriticalDamping;                                   // 0x0034(0x0004)
	struct FVector                                Torque;                                            // 0x0038(0x0018)
	bool                                          bUseCurrentInput;                                  // 0x0050(0x0001)
	uint8                                         Pad_51[0xF];                                       // 0x0051(0x000F)
	struct FQuat                                  Current;                                           // 0x0060(0x0020)
	float                                         TargetVelocityAmount;                              // 0x0080(0x0004)
	bool                                          bInitializeFromTarget;                             // 0x0084(0x0001)
	uint8                                         Pad_85[0xB];                                       // 0x0085(0x000B)
	struct FQuat                                  Result;                                            // 0x0090(0x0020)
	struct FVector                                AngularVelocity;                                   // 0x00B0(0x0018)
	uint8                                         Pad_C8[0x8];                                       // 0x00C8(0x0008)
	struct FQuat                                  SimulatedResult;                                   // 0x00D0(0x0020)
