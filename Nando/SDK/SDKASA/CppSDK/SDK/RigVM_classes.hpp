...
public:
	...
	struct FRigVMGraphFunctionStore               GraphFunctionStore;                                // 0x0380(0x0020)
...
{
public:
	struct FRigVMMemoryStorageStruct              LiteralMemoryStorage;                              // 0x0028(0x0050)
	struct FRigVMMemoryStorageStruct              DefaultWorkMemoryStorage;                          // 0x0078(0x0050)
	struct FRigVMMemoryStorageStruct              DefaultDebugMemoryStorage;                         // 0x00C8(0x0050)
	uint8                                         Pad_118[0x20];                                     // 0x0118(0x0020)
	struct FRigVMByteCode                         ByteCodeStorage;                                   // 0x0138(0x00B0)
	uint8                                         Pad_1E8[0x8];                                      // 0x01E8(0x0008)
	struct FRigVMInstructionArray                 Instructions;                                      // 0x01F0(0x0010)
	uint8                                         Pad_200[0x8];                                      // 0x0200(0x0008)
	TArray<class FName>                           FunctionNamesStorage;                              // 0x0208(0x0010)
	uint8                                         Pad_218[0x38];                                     // 0x0218(0x0038)
	TArray<struct FRigVMParameter>                Parameters;                                        // 0x0250(0x0010)
	uint8                                         Pad_260[0xD8];                                     // 0x0260(0x00D8)
	uint32                                        CachedVMHash;                                      // 0x0338(0x0004)
	uint8                                         Pad_33C[0x54];                                     // 0x033C(0x0054)
...
{
public:
	class FString                                 NameSpace;                                         // 0x0028(0x0010)
...
{
public:
	TSoftObjectPtr<class UDataAsset>              DataAsset;                                         // 0x0100(0x0028)
...
{
public:
	uint8                                         Pad_218[0x40];                                     // 0x0218(0x0040)
...
{
public:
	uint8                                         Pad_390[0x28];                                     // 0x0390(0x0028)
...
public:
	...
	struct FRigVMUserWorkflow                     Workflow;                                          // 0x0030(0x0058)
...
public:
	...
	struct FRigVMRuntimeSettings                  VMRuntimeSettings;                                 // 0x0030(0x0018)
	uint8                                         Pad_48[0x10];                                      // 0x0048(0x0010)
	class URigVM*                                 VM;                                                // 0x0058(0x0008)
	TMap<class FString, struct FSoftObjectPath>   UserDefinedStructGuidToPathName;                   // 0x0060(0x0050)
	TMap<class FString, struct FSoftObjectPath>   UserDefinedEnumToPathName;                         // 0x00B0(0x0050)
	TSet<class UObject*>                          UserDefinedTypesInUse;                             // 0x0100(0x0050)
	uint8                                         Pad_150[0x8];                                      // 0x0150(0x0008)
	struct FRigVMDrawContainer                    DrawContainer;                                     // 0x0158(0x0018)
	uint8                                         Pad_170[0x18];                                     // 0x0170(0x0018)
	TArray<class FName>                           EventQueue;                                        // 0x0188(0x0010)
	uint8                                         Pad_198[0x90];                                     // 0x0198(0x0090)
	TArray<class UAssetUserData*>                 AssetUserData;                                     // 0x0228(0x0010)
	uint8                                         Pad_238[0x40];                                     // 0x0238(0x0040)
...
{
public:
	TArray<struct FRigVMTag>                      VariantTags;                                       // 0x0038(0x0010)
