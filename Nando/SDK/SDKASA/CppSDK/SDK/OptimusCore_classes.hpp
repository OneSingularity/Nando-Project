...
public:
	...
	struct FOptimusParameterBindingArray          InputBindings;                                     // 0x0098(0x0010)
	struct FOptimusParameterBindingArray          OutputBindings;                                    // 0x00A8(0x0010)
	uint8                                         Pad_B8[0x90];                                      // 0x00B8(0x0090)
...
public:
	...
	class FString                                 SourceText;                                        // 0x0040(0x0010)
...
public:
	...
	TArray<struct FOptimusComputeGraphInfo>       ComputeGraphs;                                     // 0x0050(0x0010)
	TMap<TWeakObjectPtr<class UComputeDataInterface>, struct FOptimusDataInterfacePropertyOverrideInfo> DataInterfacePropertyOverrideMap; // 0x0060(0x0050)
	TMap<struct FOptimusValueIdentifier, struct FOptimusValueDescription> ValueMap;                  // 0x00B0(0x0050)
	class UOptimusActionStack*                    ActionStack;                                       // 0x0100(0x0008)
	EOptimusDeformerStatus                        Status;                                            // 0x0108(0x0004)
	uint8                                         Pad_10C[0x4];                                      // 0x010C(0x0004)
	TArray<class UOptimusNodeGraph*>              Graphs;                                            // 0x0110(0x0010)
	class UOptimusComponentSourceBindingContainer* Bindings;                                         // 0x0120(0x0008)
	class UOptimusVariableContainer*              Variables;                                         // 0x0128(0x0008)
	class UOptimusResourceContainer*              Resources;                                         // 0x0130(0x0008)
	uint8                                         Pad_138[0x90];                                     // 0x0138(0x0090)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	class USkinnedMeshComponent*                  SkinnedMeshComponent;                              // 0x0030(0x0008)
	class FName                                   AttributeName;                                     // 0x0038(0x0008)
	uint8                                         Pad_40[0x8];                                       // 0x0040(0x0008)
	class UOptimusDeformerInstance*               DeformerInstance;                                  // 0x0048(0x0008)
...
{
public:
	class FName                                   SkinWeightProfile;                                 // 0x0028(0x0008)
	TArray<class FName>                           BoneNames;                                         // 0x0030(0x0010)
	int32                                         ExpandTowardsRoot;                                 // 0x0040(0x0004)
	int32                                         ExpandTowardsLeaf;                                 // 0x0044(0x0004)
	bool                                          bDebugDrawIncludedBones;                           // 0x0048(0x0001)
	uint8                                         Pad_49[0x3];                                       // 0x0049(0x0003)
	struct FColor                                 DebugDrawColor;                                    // 0x004C(0x0004)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	class USkeletalMeshComponent*                 SkeletalMesh;                                      // 0x0030(0x0008)
	uint8                                         Pad_38[0x90];                                      // 0x0038(0x0090)
	class UOptimusDeformerInstance*               DeformerInstance;                                  // 0x00C8(0x0008)
...
{
public:
	class UOptimusDeformerInstance*               DefaultInstance;                                   // 0x0028(0x0008)
	TMap<struct FGuid, class UOptimusDeformerInstance*> GuidToRigDeformerInstanceMap;                // 0x0030(0x0050)
...
public:
	...
	struct FOptimusDataDomain                     DataDomain;                                        // 0x0030(0x0040)
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0070(0x0030)
	TArray<class UOptimusNodePin*>                SubPins;                                           // 0x00A0(0x0010)
...
public:
	class FName                                   SkinWeightProfile;                                 // 0x0028(0x0008)
	bool                                          bEnableLayeredSkinning;                            // 0x0030(0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
	struct FOptimusAnimAttributeBufferArray       AttributeBufferArray;                              // 0x0038(0x0010)
...
{
public:
	struct FOptimusAnimAttributeArray             AttributeArray;                                    // 0x0028(0x0010)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	TWeakObjectPtr<class UOptimusComponentSourceBinding> ComponentSourceBinding;                     // 0x0030(0x0008)
	class FString                                 NumThreadsExpression;                              // 0x0038(0x0010)
...
public:
	...
	TWeakObjectPtr<class UOptimusComponentSourceBinding> ComponentSourceBinding;                     // 0x0030(0x0008)
	class FString                                 NumThreadsExpression;                              // 0x0038(0x0010)
	struct FOptimusConstantIdentifier             ExecutionDomainConstantIdentifier;                 // 0x0048(0x0018)
...
public:
	...
	struct FOptimusDebugDrawParameters            DebugDrawParameters;                               // 0x002C(0x0014)
...
public:
	...
	struct FOptimusDebugDrawParameters            DebugDrawParameters;                               // 0x0030(0x0014)
...
{
public:
	TArray<struct FOptimusGraphVariableDescription> Variables;                                       // 0x0028(0x0010)
	int32                                         ParameterBufferSize;                               // 0x0038(0x0004)
...
public:
	...
	TArray<struct FOptimusGraphVariableDescription> Variables;                                       // 0x0038(0x0010)
	uint8                                         Pad_48[0x18];                                      // 0x0048(0x0018)
	class UOptimusDeformerInstance*               DeformerInstance;                                  // 0x0060(0x0008)
...
{
public:
	uint32                                        Index_0;                                           // 0x0028(0x0004)
	uint32                                        Count;                                             // 0x002C(0x0004)
...
{
public:
	struct FShaderValueTypeHandle                 ValueType;                                         // 0x0028(0x0008)
	struct FOptimusDataDomain                     DataDomain;                                        // 0x0030(0x0040)
	TWeakObjectPtr<class UOptimusComponentSourceBinding> ComponentSourceBinding;                     // 0x0070(0x0008)
	struct FOptimusConstantIdentifier             DomainConstantIdentifier;                          // 0x0078(0x0018)
...
{
public:
	bool                                          bZeroInitForAtomicWrites;                          // 0x0090(0x0001)
...
{
public:
	class FName                                   ResourceName;                                      // 0x0090(0x0008)
...
{
public:
	uint8                                         Pad_80[0x28];                                      // 0x0080(0x0028)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	class USkinnedMeshComponent*                  SkinnedMesh;                                       // 0x0030(0x0008)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	class FText                                   DisplayName;                                       // 0x0030(0x0010)
	struct FVector2D                              GraphPosition;                                     // 0x0040(0x0010)
	TArray<class UOptimusNodePin*>                Pins;                                              // 0x0050(0x0010)
	TSet<class FName>                             ExpandedPins;                                      // 0x0060(0x0050)
	EOptimusDiagnosticLevel                       DiagnosticLevel;                                   // 0x00B0(0x0001)
	uint8                                         Pad_B1[0x57];                                      // 0x00B1(0x0057)
...
{
public:
	uint8                                         Pad_108[0x20];                                     // 0x0108(0x0020)
	TSubclassOf<class UObject>                    DataInterfaceClass;                                // 0x0128(0x0008)
...
public:
	...
	struct FOptimusNode_ComponentSource_DuplicationInfo DuplicationInfo;                             // 0x0120(0x0010)
...
{
public:
	class FName                                   Category;                                          // 0x0218(0x0008)
	class FName                                   KernelName;                                        // 0x0220(0x0008)
	struct FOptimusExecutionDomain                ExecutionDomain;                                   // 0x0228(0x0020)
	struct FIntVector                             GroupSize;                                         // 0x0248(0x000C)
	uint8                                         Pad_254[0x4];                                      // 0x0254(0x0004)
	TArray<struct FOptimusParameterBinding>       InputBindings;                                     // 0x0258(0x0010)
	TArray<struct FOptimusParameterBinding>       OutputBindings;                                    // 0x0268(0x0010)
	class FString                                 ShaderSource;                                      // 0x0278(0x0010)
...
{
public:
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0218(0x0030)
...
{
public:
	uint8                                         Pad_108[0x18];                                     // 0x0108(0x0018)
...
public:
	...
	class FName                                   Category;                                          // 0x0130(0x0008)
	struct FOptimusValidatedName                  KernelName;                                        // 0x0138(0x0008)
	struct FOptimusExecutionDomain                ExecutionDomain;                                   // 0x0140(0x0020)
	struct FIntVector                             GroupSize;                                         // 0x0160(0x000C)
	uint8                                         Pad_16C[0x4];                                      // 0x016C(0x0004)
	TArray<struct FOptimus_ShaderBinding>         Parameters;                                        // 0x0170(0x0010)
	TArray<struct FOptimusParameterBinding>       InputBindings;                                     // 0x0180(0x0010)
	TArray<struct FOptimusParameterBinding>       OutputBindings;                                    // 0x0190(0x0010)
	struct FOptimusParameterBindingArray          InputBindingArray;                                 // 0x01A0(0x0010)
	struct FOptimusParameterBindingArray          OutputBindingArray;                                // 0x01B0(0x0010)
	TArray<struct FOptimusSecondaryInputBindingsGroup> SecondaryInputBindingGroups;                  // 0x01C0(0x0010)
	TArray<class UComputeSource*>                 AdditionalSources;                                 // 0x01D0(0x0010)
	struct FOptimusShaderText                     ShaderSource;                                      // 0x01E0(0x0020)
...
public:
	uint8                                         Pad_108[0x18];                                     // 0x0108(0x0018)
	TSoftObjectPtr<class UOptimusFunctionNodeGraph> FunctionGraph;                                   // 0x0120(0x0028)
	TWeakObjectPtr<class UOptimusNodePin>         DefaultComponentPin;                               // 0x0148(0x0008)
...
public:
	uint8                                         Pad_108[0x20];                                     // 0x0108(0x0020)
	TWeakObjectPtr<class UOptimusResourceDescription> ResourceDesc;                                  // 0x0128(0x0008)
	EOptimusBufferWriteType                       WriteType;                                         // 0x0130(0x0001)
	uint8                                         Pad_131[0x7];                                      // 0x0131(0x0007)
	struct FOptimusNode_ResourceAccessorBase_DuplicationInfo DuplicationInfo;                        // 0x0138(0x0078)
...
public:
	uint8                                         Pad_108[0x18];                                     // 0x0108(0x0018)
	TWeakObjectPtr<class UOptimusVariableDescription> VariableDesc;                                  // 0x0120(0x0008)
	struct FOptimusNode_GetVariable_DuplicationInfo DuplicationInfo;                                 // 0x0128(0x0048)
...
public:
	...
	TWeakObjectPtr<class UOptimusNodePin>         DefaultComponentPin;                               // 0x012C(0x0008)
...
public:
	...
	EOptimusTerminalType                          TerminalType;                                      // 0x0130(0x0004)
	uint8                                         Pad_134[0x4];                                      // 0x0134(0x0004)
	struct FOptimusLoopTerminalInfo               LoopInfo;                                          // 0x0138(0x0018)
	class UOptimusNodePin*                        IndexPin;                                          // 0x0150(0x0008)
	class UOptimusNodePin*                        CountPin;                                          // 0x0158(0x0008)
	TArray<struct FOptimusPinPairInfo>            PinPairInfos;                                      // 0x0160(0x0010)
...
public:
	uint8                                         Pad_108[0x18];                                     // 0x0108(0x0018)
	class FName                                   SubgraphName;                                      // 0x0120(0x0008)
	TWeakObjectPtr<class UOptimusNodePin>         DefaultComponentPin;                               // 0x0128(0x0008)
...
{
public:
	int32                                         TransactedActionIndex;                             // 0x0028(0x0004)
	uint8                                         Pad_2C[0xB4];                                      // 0x002C(0x00B4)
...
{
public:
	class FName                                   BindingName;                                       // 0x0028(0x0008)
	TSubclassOf<class UOptimusComponentSource>    ComponentType;                                     // 0x0030(0x0008)
	TArray<class FName>                           ComponentTags;                                     // 0x0038(0x0010)
...
{
public:
	TArray<TWeakObjectPtr<class UOptimusNode>>    KernelToNode;                                      // 0x00E0(0x0010)
...
public:
	...
	TArray<struct FOptimusDeformerInstanceComponentBinding> Bindings;                                // 0x0030(0x0010)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)
	TWeakObjectPtr<class UMeshComponent>          MeshComponent;                                     // 0x0030(0x0008)
	TWeakObjectPtr<class UOptimusDeformerInstanceSettings> InstanceSettings;                         // 0x0038(0x0008)
	TArray<struct FOptimusDeformerInstanceExecInfo> ComputeGraphExecInfos;                           // 0x0040(0x0010)
	uint8                                         Pad_50[0x158];                                     // 0x0050(0x0158)
...
{
public:
	class FName                                   Category;                                          // 0x0148(0x0008)
	class FName                                   AccessSpecifier;                                   // 0x0150(0x0008)
...
{
public:
	class FName                                   ResourceName;                                      // 0x0028(0x0008)
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0030(0x0030)
	TWeakObjectPtr<class UOptimusComponentSourceBinding> ComponentBinding;                           // 0x0060(0x0008)
	struct FOptimusDataDomain                     DataDomain;                                        // 0x0068(0x0040)
	class UOptimusPersistentBufferDataInterface*  DataInterface;                                     // 0x00A8(0x0008)
...
public:
	...
	class FName                                   VariableName;                                      // 0x0038(0x0008)
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0040(0x0030)
	struct FOptimusValueContainerStruct           DefaultValueStruct;                                // 0x0070(0x0010)
	struct FShaderValueContainer                  CachedShaderValue;                                 // 0x0080(0x0020)
	TArray<uint8>                                 ValueData;                                         // 0x00A0(0x0010)
	class UOptimusValueContainer*                 DefaultValue;                                      // 0x00B0(0x0008)
