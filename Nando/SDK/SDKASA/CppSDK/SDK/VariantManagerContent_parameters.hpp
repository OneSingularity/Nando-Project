...
{
public:
	int32                                         VariantSetIndex;                                   // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	class UVariantSet*                            ReturnValue;                                       // 0x0008(0x0008)
};
...
{
public:
	class FString                                 VariantSetName;                                    // 0x0000(0x0010)
	class UVariantSet*                            ReturnValue;                                       // 0x0010(0x0008)
};
...
{
public:
	bool                                          bLoad;                                             // 0x0000(0x0001)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)
	class ULevelVariantSets*                      ReturnValue;                                       // 0x0008(0x0008)
};
...
{
public:
	class ULevelVariantSets*                      InVariantSets;                                     // 0x0000(0x0008)
};
...
public:
	int32                                         VariantSetIndex;                                   // 0x0000(0x0004)
	int32                                         VariantIndex;                                      // 0x0004(0x0004)
...
public:
	class FString                                 VariantSetName;                                    // 0x0000(0x0010)
	class FString                                 VariantName;                                       // 0x0010(0x0010)
...
{
public:
	int32                                         OptionIndex;                                       // 0x0000(0x0004)
};
...
{
public:
	struct FVariantDependency                     Dependency;                                        // 0x0000(0x0058)
...
{
public:
	int32                                         ActorIndex;                                        // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
...
public:
	int32                                         Index_0;                                           // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FVariantDependency                     ReturnValue;                                       // 0x0008(0x0058)
};
...
{
public:
	class ULevelVariantSets*                      LevelVariantSets;                                  // 0x0000(0x0008)
	bool                                          bOnlyEnabledDependencies;                          // 0x0008(0x0001)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
	TArray<class UVariant*>                       ReturnValue;                                       // 0x0010(0x0010)
};
...
{
public:
	class UVariantSet*                            ReturnValue;                                       // 0x0000(0x0008)
};
...
public:
	int32                                         Index_0;                                           // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FVariantDependency                     Dependency;                                        // 0x0008(0x0058)
};
...
{
public:
	class FText                                   NewDisplayText;                                    // 0x0000(0x0010)
};
...
public:
	...
	struct FTransform                             CameraTransform;                                   // 0x0010(0x0060)
	float                                         FOVDegrees;                                        // 0x0070(0x0004)
	float                                         MinZ;                                              // 0x0074(0x0004)
	float                                         Gamma;                                             // 0x0078(0x0004)
...
{
public:
	class UTexture2D*                             NewThumbnail;                                      // 0x0000(0x0008)
};
...
{
public:
	class ULevelVariantSets*                      ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	int32                                         VariantIndex;                                      // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	class UVariant*                               ReturnValue;                                       // 0x0008(0x0008)
};
...
public:
	...
	class UVariant*                               ReturnValue;                                       // 0x0010(0x0008)
};
