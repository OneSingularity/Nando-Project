...
public:
	...
	bool                                          bUseComplexAsSimpleCollision;                      // 0x0660(0x0001)
	bool                                          bUseAsyncCooking;                                  // 0x0661(0x0001)
	uint8                                         Pad_662[0x6];                                      // 0x0662(0x0006)
	class UBodySetup*                             ProcMeshBodySetup;                                 // 0x0668(0x0008)
	TArray<struct FProcMeshSection>               ProcMeshSections;                                  // 0x0670(0x0010)
	TArray<struct FKConvexElem>                   CollisionConvexElems;                              // 0x0680(0x0010)
	struct FBoxSphereBounds                       LocalBounds;                                       // 0x0690(0x0038)
	TArray<class UBodySetup*>                     AsyncBodySetupQueue;                               // 0x06C8(0x0010)
