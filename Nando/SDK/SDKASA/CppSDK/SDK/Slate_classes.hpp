...
public:
	...
	{
		STATIC_CLASS_IMPL("PrimalWidgetInterface")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"PrimalWidgetInterface")
	}
...
{
public:
	struct FButtonStyle                           ButtonStyle;                                       // 0x0030(0x0370)
...
{
public:
	struct FCheckBoxStyle                         CheckBoxStyle;                                     // 0x0030(0x0950)
...
{
public:
	struct FComboBoxStyle                         ComboBoxStyle;                                     // 0x0030(0x05A0)
...
{
public:
	struct FComboButtonStyle                      ComboButtonStyle;                                  // 0x0030(0x0540)
...
{
public:
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0030(0x0C80)
...
{
public:
	struct FEditableTextStyle                     EditableTextStyle;                                 // 0x0030(0x0290)
...
{
public:
	struct FProgressBarStyle                      ProgressBarStyle;                                  // 0x0030(0x0230)
...
{
public:
	struct FScrollBarStyle                        ScrollBarStyle;                                    // 0x0030(0x0650)
...
{
public:
	struct FScrollBoxStyle                        ScrollBoxStyle;                                    // 0x0030(0x02F0)
...
{
public:
	struct FSpinBoxStyle                          SpinBoxStyle;                                      // 0x0030(0x0520)
...
{
public:
	struct FTextBlockStyle                        TextBlockStyle;                                    // 0x0030(0x02E0)
