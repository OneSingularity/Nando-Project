...
{
public:
	struct FStaticMaterial                        InStaticMaterial;                                  // 0x0000(0x0038)
	uint32                                        ReturnValue;                                       // 0x0038(0x0004)
...
{
public:
	bool                                          bInComputeWeightedNormals;                         // 0x0000(0x0001)
};
...
{
public:
	int32                                         InMaterialIndex;                                   // 0x0000(0x0004)
...
{
public:
	uint32                                        InNumVertices;                                     // 0x0000(0x0004)
	uint32                                        InNumTriangles;                                    // 0x0004(0x0004)
	uint32                                        InNumUVLayers;                                     // 0x0008(0x0004)
	uint32                                        InInitialNumStaticMaterials;                       // 0x000C(0x0004)
	bool                                          bInHasNormals;                                     // 0x0010(0x0001)
	bool                                          bInHasTangents;                                    // 0x0011(0x0001)
	bool                                          bInHasColors;                                      // 0x0012(0x0001)
	bool                                          bInHasPerFaceMaterials;                            // 0x0013(0x0001)
};
...
{
public:
	bool                                          bInHasColors;                                      // 0x0000(0x0001)
};
...
{
public:
	bool                                          bInHasNormals;                                     // 0x0000(0x0001)
};
...
{
public:
	bool                                          bInHasPerFaceMaterials;                            // 0x0000(0x0001)
};
...
{
public:
	bool                                          bInHasTangents;                                    // 0x0000(0x0001)
};
...
{
public:
	uint32                                        InNumStaticMaterials;                              // 0x0000(0x0004)
};
...
{
public:
	uint32                                        InNumUVLayers;                                     // 0x0000(0x0004)
};
...
{
public:
	uint32                                        InMaterialIndex;                                   // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	struct FStaticMaterial                        InStaticMaterial;                                  // 0x0008(0x0038)
};
...
{
public:
	uint32                                        InTriangleIndex;                                   // 0x0000(0x0004)
	int32                                         InMaterialID;                                      // 0x0004(0x0004)
};
...
public:
	uint32                                        InTriangleIndex;                                   // 0x0000(0x0004)
	uint8                                         InTriangleVertexIndex;                             // 0x0004(0x0001)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)
	struct FColor                                 InColor;                                           // 0x0008(0x0004)
};
...
public:
	uint32                                        InTriangleIndex;                                   // 0x0000(0x0004)
	struct FIntVector                             InTriangleVertexIndices;                           // 0x0004(0x000C)
};
...
public:
	...
	uint8                                         InTriangleVertexIndex;                             // 0x0004(0x0001)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)
	struct FVector3f                              InNormal;                                          // 0x0008(0x000C)
};
...
public:
	...
	uint8                                         InTriangleVertexIndex;                             // 0x0004(0x0001)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)
	struct FVector3f                              InUTangent;                                        // 0x0008(0x000C)
};
...
public:
	uint32                                        InTriangleIndex;                                   // 0x0000(0x0004)
	uint8                                         InTriangleVertexIndex;                             // 0x0004(0x0001)
	uint8                                         InUVLayer;                                         // 0x0005(0x0001)
	uint8                                         Pad_6[0x2];                                        // 0x0006(0x0002)
	struct FVector2f                              InUV;                                              // 0x0008(0x0008)
};
...
public:
	...
	uint8                                         InTriangleVertexIndex;                             // 0x0004(0x0001)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)
	struct FVector3f                              InVTangent;                                        // 0x0008(0x000C)
};
...
{
public:
	uint32                                        InVertexIndex;                                     // 0x0000(0x0004)
	struct FVector3f                              InPosition;                                        // 0x0004(0x000C)
};
...
{
public:
	class FName                                   InMaterialSlotName;                                // 0x0000(0x0008)
...
{
public:
	uint32                                        ReturnValue;                                       // 0x0000(0x0004)
};
...
{
public:
	TArray<struct FStaticMaterial>                ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FIntVector>                     ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FColor>                         ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FVector3f>                      ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	TArray<struct FVector2f>                      ReturnValue;                                       // 0x0000(0x0010)
};
...
{
public:
	bool                                          bInSkipVertexIndicesCheck;                         // 0x0000(0x0001)
...
{
public:
	class UHoudiniStaticMesh*                     ReturnValue;                                       // 0x0000(0x0008)
};
...
{
public:
	bool                                          bInHoudiniIconVisible;                             // 0x0000(0x0001)
};
...
{
public:
	class UHoudiniStaticMesh*                     InMesh;                                            // 0x0000(0x0008)
};
...
{
public:
	class FString                                 JsonData;                                          // 0x0000(0x0010)
	bool                                          ReturnValue;                                       // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
};
...
{
public:
	class FString                                 JsonFilePath;                                      // 0x0000(0x0010)
	bool                                          ReturnValue;                                       // 0x0010(0x0001)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)
};
