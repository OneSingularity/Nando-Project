...
#include "Monkey_Character_BP_classes.hpp"
#include "Monkey_Character_BP_parameters.hpp"
...
bool AMonkey_Character_BP_C::BlueprintCanAttack(int32 AttackIndex, float Distance, float AttackRangeOffset, class AActor* OtherTarget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Monkey_Character_BP_C", "BlueprintCanAttack");

	Params::Monkey_Character_BP_C_BlueprintCanAttack Parms{};
