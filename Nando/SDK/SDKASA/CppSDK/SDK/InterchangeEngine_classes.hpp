...
{
public:
	struct FInterchangeContentImportSettings      ContentImportSettings;                             // 0x0038(0x0128)
	struct FInterchangeImportSettings             SceneImportSettings;                               // 0x0160(0x0088)
	TSoftClassPtr<class UClass>                   FilePickerClass;                                   // 0x01E8(0x0028)
	bool                                          bStaticMeshUseSmoothEdgesIfSmoothingInformationIsMissing; // 0x0210(0x0001)
	uint8                                         Pad_211[0x7];                                      // 0x0211(0x0007)
	TSoftClassPtr<class UClass>                   GenericPipelineClass;                              // 0x0218(0x0028)
	struct FSoftObjectPath                        ConverterDefaultPipeline;                          // 0x0240(0x0020)
	TArray<struct FInterchangeGroup>              InterchangeGroups;                                 // 0x0260(0x0010)
...
{
public:
	bool                                          bShowImportDialogAtReimport;                       // 0x0038(0x0001)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)
	class FName                                   UsedGroupName;                                     // 0x003C(0x0008)
	struct FGuid                                  UsedGroupUID;                                      // 0x0044(0x0010)
...
{
public:
	TSoftClassPtr<class UClass>                   PythonClass;                                       // 0x0028(0x0028)
	class UInterchangePythonPipelineBase*         GeneratedPipeline;                                 // 0x0050(0x0008)
	class FString                                 JsonDefaultProperties;                             // 0x0058(0x0010)
...
{
public:
	struct FSoftObjectPath                        SceneImportAsset;                                  // 0x0028(0x0020)
	class FString                                 NodeUniqueID;                                      // 0x0048(0x0010)
...
{
public:
	TArray<struct FSoftObjectPath>                OverridePipelines;                                 // 0x0028(0x0010)
...
class UInterchangeManager final : public UObject
{
public:
	uint8                                         Pad_28[0x1E8];                                     // 0x0028(0x01E8)
	TSet<TSubclassOf<class UObject>>              RegisteredTranslatorsClass;                        // 0x0210(0x0050)
	TMap<TSubclassOf<class UObject>, TSubclassOf<class UObject>> RegisteredFactoryClasses;           // 0x0260(0x0050)
	TMap<TSubclassOf<class UObject>, class UInterchangeWriterBase*> RegisteredWriters;               // 0x02B0(0x0050)
	TMap<TSubclassOf<class UObject>, class UInterchangeAssetImportDataConverterBase*> RegisteredConverters; // 0x0300(0x0050)
	uint8                                         Pad_350[0x80];                                     // 0x0350(0x0080)
