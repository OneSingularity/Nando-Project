...
public:
	...
	int32                                         SourceTextureUVLayer;                              // 0x0010(0x0004)
...
public:
	...
	struct FKShapeElem                            Element;                                           // 0x0070(0x0030)
};
...
{
public:
	struct FVector                                Dimensions;                                        // 0x0000(0x0018)
	uint8                                         Pad_18[0x8];                                       // 0x0018(0x0008)
	struct FTransform                             Transform;                                         // 0x0020(0x0060)
	struct FKShapeElem                            Element;                                           // 0x0080(0x0030)
};
...
public:
	...
	int32                                         NumFaces;                                          // 0x0004(0x0004)
	struct FKShapeElem                            Element;                                           // 0x0008(0x0030)
};
...
{
public:
	struct FKShapeElem                            Element;                                           // 0x0000(0x0030)
};
