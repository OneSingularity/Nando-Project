...
struct FControlRigSplineImpl final
{
public:
...
struct FControlRigSpline final
{
public:
...
public:
	...
	struct FControlRigSpline                      Spline;                                            // 0x0200(0x0018)
...
public:
	...
	struct FVector                                position;                                          // 0x0028(0x0018)
};
...
public:
	struct FControlRigSpline                      Spline;                                            // 0x0008(0x0018)
	struct FVector                                UpVector;                                          // 0x0020(0x0018)
...
public:
	...
	float                                         U;                                                 // 0x0020(0x0004)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	struct FVector                                PrimaryAxis;                                       // 0x0028(0x0018)
	struct FVector                                SecondaryAxis;                                     // 0x0040(0x0018)
...
public:
	...
	float                                         U;                                                 // 0x0020(0x0004)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	struct FVector                                Tangent;                                           // 0x0028(0x0018)
};
...
{
public:
	struct FControlRigSpline                      Spline;                                            // 0x01F0(0x0018)
	struct FLinearColor                           Color;                                             // 0x0208(0x0010)
	float                                         Thickness;                                         // 0x0218(0x0004)
	int32                                         Detail;                                            // 0x021C(0x0004)
};
...
public:
	...
	struct FControlRigSpline                      Spline;                                            // 0x0200(0x0018)
	EControlRigCurveAlignment                     Alignment;                                         // 0x0218(0x0001)
	uint8                                         Pad_219[0x3];                                      // 0x0219(0x0003)
	float                                         Minimum;                                           // 0x021C(0x0004)
	float                                         Maximum;                                           // 0x0220(0x0004)
	int32                                         SamplingPrecision;                                 // 0x0224(0x0004)
	struct FVector                                PrimaryAxis;                                       // 0x0228(0x0018)
	struct FVector                                SecondaryAxis;                                     // 0x0240(0x0018)
	struct FVector                                PoleVectorPosition;                                // 0x0258(0x0018)
	TArray<struct FRigUnit_FitChainToCurve_Rotation> Rotations;                                      // 0x0270(0x0010)
	ERigVMAnimEasingType                          RotationEaseType;                                  // 0x0280(0x0001)
	uint8                                         Pad_281[0x3];                                      // 0x0281(0x0003)
	float                                         Weight;                                            // 0x0284(0x0004)
	bool                                          bPropagateToChildren;                              // 0x0288(0x0001)
	uint8                                         Pad_289[0x7];                                      // 0x0289(0x0007)
	struct FRigUnit_FitChainToCurve_DebugSettings DebugSettings;                                     // 0x0290(0x0090)
	struct FRigUnit_FitChainToCurve_WorkData      WorkData;                                          // 0x0320(0x0098)
...
public:
	...
	TArray<struct FTransform>                     ItemTransforms;                                    // 0x0008(0x0010)
	TArray<float>                                 ItemSegments;                                      // 0x0018(0x0010)
	TArray<struct FCachedRigElement>              CachedItems;                                       // 0x0028(0x0010)
};
...
public:
	...
	struct FVector                                PrimaryAxis;                                       // 0x0228(0x0018)
	struct FVector                                SecondaryAxis;                                     // 0x0240(0x0018)
	bool                                          bPropagateToChildren;                              // 0x0258(0x0001)
	uint8                                         Pad_259[0x7];                                      // 0x0259(0x0007)
	struct FRigUnit_SplineConstraint_WorkData     WorkData;                                          // 0x0260(0x0038)
