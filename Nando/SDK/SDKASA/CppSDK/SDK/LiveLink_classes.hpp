...
{
public:
	struct FFrameRate                             LiveLinkDataRate;                                  // 0x0030(0x0008)
	struct FLiveLinkSubjectKey                    SubjectKey;                                        // 0x0038(0x0018)
	bool                                          bLockStepMode;                                     // 0x0050(0x0001)
	uint8                                         Pad_51[0x3];                                       // 0x0051(0x0003)
	uint32                                        FrameRateDivider;                                  // 0x0054(0x0004)
...
{
public:
	bool                                          bEnableDeadband;                                   // 0x0028(0x0001)
	uint8                                         Pad_29[0x3];                                       // 0x0029(0x0003)
	float                                         TranslationDeadband;                               // 0x002C(0x0004)
	float                                         RotationDeadbandInDegrees;                         // 0x0030(0x0004)
	uint8                                         Pad_34[0x14];                                      // 0x0034(0x0014)
...
{
public:
	TSoftObjectPtr<class USkeletalMesh>           ReferenceSkeleton;                                 // 0x0080(0x0028)
...
{
public:
	uint8                                         Pad_170[0x8];                                      // 0x0170(0x0008)
	TArray<struct FLiveLinkVirtualSubjectBoneAttachment> Attachments;                                // 0x0178(0x0010)
	EBoneTransformResolution                      LocationBehavior;                                  // 0x0188(0x0004)
	EBoneTransformResolution                      RotationBehavior;                                  // 0x018C(0x0004)
	bool                                          bAppendSubjectNameToBones;                         // 0x0190(0x0001)
	uint8                                         Pad_191[0xAF];                                     // 0x0191(0x00AF)
...
{
public:
	TMulticastInlineDelegate<void(float DeltaTime)> OnLiveLinkUpdated;                               // 0x00D0(0x0010)
...
{
public:
	struct FLiveLinkSubjectName                   SubjectName;                                       // 0x00D0(0x0008)
	class FName                                   ActorTransformBone;                                // 0x00D8(0x0008)
	bool                                          bModifyActorTransform;                             // 0x00E0(0x0001)
	bool                                          bSetRelativeLocation;                              // 0x00E1(0x0001)
...
{
public:
	TArray<struct FLiveLinkSourcePreset>          Sources;                                           // 0x0028(0x0010)
	TArray<struct FLiveLinkSubjectPreset>         Subjects;                                          // 0x0038(0x0010)
...
{
public:
	struct FDirectoryPath                         PresetSaveDir;                                     // 0x0028(0x0010)
...
{
public:
	TArray<struct FLiveLinkRoleProjectSetting>    DefaultRoleSettings;                               // 0x0028(0x0010)
	struct FSoftClassPath                         DefaultSettingsClass;                              // 0x0038(0x0020)
	TSubclassOf<class ULiveLinkFrameInterpolationProcessor> FrameInterpolationProcessor;             // 0x0058(0x0008)
	TSoftObjectPtr<class ULiveLinkPreset>         DefaultLiveLinkPreset;                             // 0x0060(0x0028)
	float                                         ClockOffsetCorrectionStep;                         // 0x0088(0x0004)
	ELiveLinkSourceMode                           DefaultMessageBusSourceMode;                       // 0x008C(0x0001)
	uint8                                         Pad_8D[0x3];                                       // 0x008D(0x0003)
	double                                        MessageBusPingRequestFrequency;                    // 0x0090(0x0008)
	double                                        MessageBusHeartbeatFrequency;                      // 0x0098(0x0008)
	double                                        MessageBusHeartbeatTimeout;                        // 0x00A0(0x0008)
	double                                        MessageBusTimeBeforeRemovingInactiveSource;        // 0x00A8(0x0008)
	bool                                          bPreProcessRebroadcastFrames;                      // 0x00B0(0x0001)
	bool                                          bTranslateRebroadcastFrames;                       // 0x00B1(0x0001)
	uint8                                         Pad_B2[0x6];                                       // 0x00B2(0x0006)
	double                                        TimeWithoutFrameToBeConsiderAsInvalid;             // 0x00B8(0x0008)
	struct FLinearColor                           ValidColor;                                        // 0x00C0(0x0010)
	struct FLinearColor                           InvalidColor;                                      // 0x00D0(0x0010)
	uint8                                         TextSizeSource;                                    // 0x00E0(0x0001)
	uint8                                         TextSizeSubject;                                   // 0x00E1(0x0001)
	uint8                                         Pad_E2[0x6];                                       // 0x00E2(0x0006)
...
{
public:
	struct FLiveLinkSubjectKey                    SubjectKey;                                        // 0x0030(0x0018)
	...
	struct FFrameRate                             OverrideFrameRate;                                 // 0x0050(0x0008)
	int32                                         BufferSize;                                        // 0x0058(0x0004)
	uint8                                         Pad_5C[0x64];                                      // 0x005C(0x0064)
...
{
public:
	struct FLiveLinkSubjectName                   SubjectName;                                       // 0x0030(0x0008)
...
{
public:
	class FName                                   SourceName;                                        // 0x00B0(0x0008)
...
public:
	...
	struct FVector                                OffsetPosition;                                    // 0x0030(0x0018)
	struct FRotator                               OffsetOrientation;                                 // 0x0048(0x0018)
...
{
public:
	class FName                                   OutputBoneName;                                    // 0x0028(0x0008)
	uint8                                         Pad_30[0x10];                                      // 0x0030(0x0010)
...
{
public:
	uint8                                         Pad_170[0x28];                                     // 0x0170(0x0028)
