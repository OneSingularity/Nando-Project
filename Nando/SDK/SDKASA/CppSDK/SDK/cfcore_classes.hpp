...
{
public:
	struct FCFCoreInitializationOptions           initOptions;                                       // 0x0028(0x0010)
	class FString                                 defaultLanguage;                                   // 0x0038(0x0010)
	int64                                         gameId;                                            // 0x0048(0x0008)
	class FString                                 apiKey;                                            // 0x0050(0x0010)
	ECFCoreExternalAuthProvider                   provider;                                          // 0x0060(0x0001)
	uint8                                         Pad_61[0x3];                                       // 0x0061(0x0003)
	int32                                         maxConcurrentInstallations;                        // 0x0064(0x0004)
	class FString                                 modsDirectory;                                     // 0x0068(0x0010)
	EModsDirectoryMode                            modsDirectoryMode;                                 // 0x0078(0x0001)
	uint8                                         Pad_79[0x7];                                       // 0x0079(0x0007)
	class FString                                 userDataDirectory;                                 // 0x0080(0x0010)
	bool                                          IsServer;                                          // 0x0090(0x0001)
	bool                                          isServerPcOnly;                                    // 0x0091(0x0001)
	uint8                                         Pad_92[0x6];                                       // 0x0092(0x0006)
	struct FCFCoreSettingsThrottling              throttling;                                        // 0x0098(0x0008)
	struct FCFCoreSettingsPremiumMods             premiumMods;                                       // 0x00A0(0x0010)
	struct FCFCoreSettingsLogger                  logger;                                            // 0x00B0(0x000C)
	uint8                                         Pad_BC[0x4];                                       // 0x00BC(0x0004)
	TSet<int64>                                   dynamicContentCategoryIds;                         // 0x00C0(0x0050)
	struct FCFCoreSettingsAnalytics               Analytics;                                         // 0x0110(0x0002)
	uint8                                         Pad_112[0x6];                                      // 0x0112(0x0006)
	TSet<class FString>                           ignoredDynamicModFiles;                            // 0x0118(0x0050)
	struct FCFCoreSettingsUnmanagedMods           unmanagedMods;                                     // 0x0168(0x0002)
	uint8                                         Pad_16A[0x2];                                      // 0x016A(0x0002)
	struct FCFCoreSettingsSubscriptions           subscriptions;                                     // 0x016C(0x0008)
	struct FCFCoreSettingsDownloads               downloads;                                         // 0x0174(0x0004)
...
{
public:
	TMulticastInlineDelegate<void(const struct FLibraryProgress& progress)> OnModInstallProgress;    // 0x0030(0x0010)
	TMulticastInlineDelegate<void(const struct FInstalledMod& InstalledMod)> OnModInstalled;         // 0x0040(0x0010)
	TMulticastInlineDelegate<void(bool bAuth)>    OnAuthenticatedEvent;                              // 0x0050(0x0010)
	TDelegate<void(bool* bHandled, struct FGenPremiumCheckoutUrlRequest* Request)> OnGeneratePremiumCheckoutUrl; // 0x0060(0x0010)
	TMulticastInlineDelegate<void(bool bSuccess)> OnPurchaseFinalizedEvent;                          // 0x0070(0x0010)
	TMulticastInlineDelegate<void(const struct FInstalledMod& UninstalledMod)> OnModUninstalledEvent; // 0x0080(0x0010)
