...
struct FRigVMJumpOp final : public FRigVMBaseOp
{
public:
...
public:
	...
	ERigVMDrawSettings                            PrimitiveType;                                     // 0x0008(0x0001)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
	TArray<struct FVector>                        Positions;                                         // 0x0010(0x0010)
	struct FLinearColor                           Color;                                             // 0x0020(0x0010)
	float                                         Thickness;                                         // 0x0030(0x0004)
	uint8                                         Pad_34[0xC];                                       // 0x0034(0x000C)
	struct FTransform                             Transform;                                         // 0x0040(0x0060)
	uint8                                         Pad_A0[0x30];                                      // 0x00A0(0x0030)
};
...
public:
	...
	TArray<struct FRigVMDrawInstruction>          Instructions;                                      // 0x0008(0x0010)
};
...
public:
	...
	struct FQuat                                  Local;                                             // 0x0010(0x0020)
	struct FQuat                                  Parent;                                            // 0x0030(0x0020)
	struct FQuat                                  Global;                                            // 0x0050(0x0020)
};
...
{
public:
	uint8                                         Pad_0[0x228];                                      // 0x0000(0x0228)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  A;                                                 // 0x0010(0x0020)
	struct FQuat                                  B;                                                 // 0x0030(0x0020)
...
{
public:
	uint8                                         Pad_0[0x110];                                      // 0x0000(0x0110)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FRigVMExecuteContext                   ExecuteContext;                                    // 0x0010(0x0110)
};
...
// 0x0018 (0x0018 - 0x0000)
struct FRigVMRuntimeSettings final
{
public:
	int32                                         MaximumArraySize;                                  // 0x0000(0x0004)
	uint8                                         Pad_4[0x14];                                       // 0x0004(0x0014)
};
...
{
public:
	int32                                         Seed;                                              // 0x0008(0x0004)
	float                                         Minimum;                                           // 0x000C(0x0004)
	float                                         Maximum;                                           // 0x0010(0x0004)
	float                                         Duration;                                          // 0x0014(0x0004)
	struct FVector                                Result;                                            // 0x0018(0x0018)
	struct FVector                                LastResult;                                        // 0x0030(0x0018)
	int32                                         LastSeed;                                          // 0x0048(0x0004)
	int32                                         BaseSeed;                                          // 0x004C(0x0004)
...
struct FRigVMTernaryOp final : public FRigVMBaseOp
{
public:
	uint8                                         Pad_1[0x13];                                       // 0x0001(0x0013)
};
...
// 0x0008 (0x0010 - 0x0008)
struct FRigVMJumpIfOp final : public FRigVMUnaryOp
{
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
};
...
public:
	class FName                                   Name;                                              // 0x0000(0x0008)
	int32                                         InstructionIndex;                                  // 0x0008(0x0004)
};
...
public:
	...
	class FName                                   Label;                                             // 0x0004(0x0008)
	int32                                         InstructionIndex;                                  // 0x000C(0x0004)
	int32                                         ArgumentIndex;                                     // 0x0010(0x0004)
	uint16                                        FirstInstruction;                                  // 0x0014(0x0002)
	uint16                                        LastInstruction;                                   // 0x0016(0x0002)
};

// ScriptStruct RigVM.RigVMPredicateBranch
// 0x0030 (0x0030 - 0x0000)
struct FRigVMPredicateBranch final
{
public:
...
{
public:
	TArray<uint8>                                 ByteCode;                                          // 0x0000(0x0010)
	int32                                         NumInstructions;                                   // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	TArray<struct FRigVMByteCodeEntry>            Entries;                                           // 0x0018(0x0010)
	TArray<struct FRigVMBranchInfo>               BranchInfos;                                       // 0x0028(0x0010)
	TArray<struct FRigVMPredicateBranch>          PredicateBranches;                                 // 0x0038(0x0010)
	class FString                                 PublicContextPathName;                             // 0x0048(0x0010)
...
public:
	class FName                                   Name;                                              // 0x0000(0x0008)
	class FString                                 CPPType;                                           // 0x0008(0x0010)
	TSoftObjectPtr<class UObject>                 CPPTypeObject;                                     // 0x0018(0x0028)
	class FString                                 DefaultValue;                                      // 0x0040(0x0010)
};
...
{
public:
	int32                                         PropertyIndex;                                     // 0x0000(0x0004)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)
	class FString                                 HeadCPPType;                                       // 0x0008(0x0010)
	class FString                                 SegmentPath;                                       // 0x0018(0x0010)
};
...
public:
	...
	uint16                                        RegisterIndex;                                     // 0x0002(0x0002)
	uint16                                        RegisterOffset;                                    // 0x0004(0x0002)
};
...
{
public:
	struct FRigVMByteCode                         ByteCode;                                          // 0x0000(0x00B0)
	TArray<class FName>                           FunctionNames;                                     // 0x00B0(0x0010)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> WorkPropertyDescriptions;            // 0x00C0(0x0010)
	TArray<struct FRigVMFunctionCompilationPropertyPath> WorkPropertyPathDescriptions;               // 0x00D0(0x0010)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> LiteralPropertyDescriptions;         // 0x00E0(0x0010)
	TArray<struct FRigVMFunctionCompilationPropertyPath> LiteralPropertyPathDescriptions;            // 0x00F0(0x0010)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> DebugPropertyDescriptions;           // 0x0100(0x0010)
	TArray<struct FRigVMFunctionCompilationPropertyPath> DebugPropertyPathDescriptions;              // 0x0110(0x0010)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> ExternalPropertyDescriptions;        // 0x0120(0x0010)
	TArray<struct FRigVMFunctionCompilationPropertyPath> ExternalPropertyPathDescriptions;           // 0x0130(0x0010)
	TMap<int32, class FName>                      ExternalRegisterIndexToVariable;                   // 0x0140(0x0050)
	TMap<class FString, struct FRigVMOperand>     Operands;                                          // 0x0190(0x0050)
	uint32                                        Hash;                                              // 0x01E0(0x0004)
	bool                                          bEncounteredSurpressedErrors;                      // 0x01E4(0x0001)
	uint8                                         Pad_1E5[0x53];                                     // 0x01E5(0x0053)
};
...
public:
	...
	struct FTransform                             WorldOffset;                                       // 0x0050(0x0060)
...
struct FRigVMCopyOp final : public FRigVMBaseOp
{
public:
	uint8                                         Pad_1[0x11];                                       // 0x0001(0x0011)
};
...
public:
	...
	struct FLinearColor                           Result;                                            // 0x000C(0x0010)
...
{
public:
	struct FTransform                             Transform;                                         // 0x0120(0x0060)
	struct FLinearColor                           Color;                                             // 0x0180(0x0010)
	float                                         Radius;                                            // 0x0190(0x0004)
	float                                         MinimumDegrees;                                    // 0x0194(0x0004)
	float                                         MaximumDegrees;                                    // 0x0198(0x0004)
	float                                         Thickness;                                         // 0x019C(0x0004)
	int32                                         Detail;                                            // 0x01A0(0x0004)
	class FName                                   Space;                                             // 0x01A4(0x0008)
...
{
public:
	struct FBox                                   Box;                                               // 0x0008(0x0038)
	struct FVector                                Size;                                              // 0x0040(0x0018)
	struct FVector                                Extent;                                            // 0x0058(0x0018)
};
...
{
public:
	struct FSoftObjectPath                        LibraryNode;                                       // 0x0000(0x0020)
	class FString                                 LibraryNodePath;                                   // 0x0020(0x0010)
	struct FSoftObjectPath                        HostObject;                                        // 0x0030(0x0020)
};
...
public:
	...
	bool                                          bShowInUserInterface;                              // 0x0038(0x0001)
	bool                                          bMarksSubjectAsInvalid;                            // 0x0039(0x0001)
...
public:
	...
	TArray<struct FRigVMTag>                      Tags;                                              // 0x0010(0x0010)
};
...
public:
	...
	TArray<class FString>                         Elements;                                          // 0x0010(0x0010)
	bool                                          bExpandedByDefault;                                // 0x0020(0x0001)
...
{
public:
	TArray<struct FRigVMPinCategory>              Categories;                                        // 0x0000(0x0010)
	TMap<class FString, int32>                    PinIndexInCategory;                                // 0x0010(0x0050)
	TMap<class FString, class FString>            DisplayNames;                                      // 0x0060(0x0050)
};
...
{
public:
	struct FRigVMGraphFunctionIdentifier          LibraryPointer;                                    // 0x0000(0x0050)
	struct FRigVMVariant                          Variant;                                           // 0x0050(0x0020)
	class FName                                   Name;                                              // 0x0070(0x0008)
	class FString                                 NodeTitle;                                         // 0x0078(0x0010)
	struct FLinearColor                           NodeColor;                                         // 0x0088(0x0010)
	class FText                                   ToolTip;                                           // 0x0098(0x0010)
	class FString                                 Description;                                       // 0x00A8(0x0010)
	class FString                                 Category;                                          // 0x00B8(0x0010)
	class FString                                 Keywords;                                          // 0x00C8(0x0010)
	TArray<struct FRigVMGraphFunctionArgument>    Arguments;                                         // 0x00D8(0x0010)
	TMap<struct FRigVMGraphFunctionIdentifier, uint32> dependencies;                                 // 0x00E8(0x0050)
	TArray<struct FRigVMExternalVariable>         ExternalVariables;                                 // 0x0138(0x0010)
	struct FRigVMNodeLayout                       layout;                                            // 0x0148(0x00B0)
};
...
{
public:
	struct FRigVMFourPointBezier                  Bezier;                                            // 0x0008(0x0060)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FRigVMExecuteContext                   ExecuteContext;                                    // 0x0010(0x0110)
	struct FRigVMExecuteContext                   A;                                                 // 0x0120(0x0110)
	struct FRigVMExecuteContext                   B;                                                 // 0x0230(0x0110)
};
...
{
public:
	struct FRigVMGraphFunctionHeader              Header;                                            // 0x0000(0x01F8)
	struct FRigVMFunctionCompilationData          CompilationData;                                   // 0x01F8(0x0238)
	class FString                                 SerializedCollapsedNode;                           // 0x0430(0x0010)
};
...
{
public:
	TArray<struct FRigVMGraphFunctionData>        PublicFunctions;                                   // 0x0000(0x0010)
	TArray<struct FRigVMGraphFunctionData>        PrivateFunctions;                                  // 0x0010(0x0010)
};
...
public:
	...
	struct FVector                                Direction;                                         // 0x0020(0x0018)
	struct FVector                                PlanePoint;                                        // 0x0038(0x0018)
	struct FVector                                PlaneNormal;                                       // 0x0050(0x0018)
...
{
public:
	struct FVector                                A;                                                 // 0x0008(0x0018)
	struct FVector                                B;                                                 // 0x0020(0x0018)
...
{
public:
	struct FVector                                Global;                                            // 0x0008(0x0018)
	struct FVector                                Parent;                                            // 0x0020(0x0018)
	struct FVector                                Local;                                             // 0x0038(0x0018)
};
...
public:
	...
	struct FVector                                Result;                                            // 0x0070(0x0018)
	struct FVector                                Tangent;                                           // 0x0088(0x0018)
};
...
{
public:
	TArray<struct FVector>                        Array;                                             // 0x0008(0x0010)
	struct FVector                                Average;                                           // 0x0018(0x0018)
};
...
{
public:
	uint8                                         Pad_10[0x40];                                      // 0x0010(0x0040)
};
...
{
public:
	int32                                         RegisterCount;                                     // 0x0000(0x0004)
	int32                                         DataBytes;                                         // 0x0004(0x0004)
	int32                                         TotalBytes;                                        // 0x0008(0x0004)
};
...
public:
	...
	struct FVector                                Speed;                                             // 0x0020(0x0018)
	struct FVector                                Frequency;                                         // 0x0038(0x0018)
	double                                        Minimum;                                           // 0x0050(0x0008)
	double                                        Maximum;                                           // 0x0058(0x0008)
	struct FVector                                Result;                                            // 0x0060(0x0018)
	struct FVector                                Time;                                              // 0x0078(0x0018)
};
...
{
public:
	int32                                         InstructionCount;                                  // 0x0000(0x0004)
	int32                                         DataBytes;                                         // 0x0004(0x0004)
};
...
{
public:
	int32                                         BytesForCDO;                                       // 0x0000(0x0004)
	int32                                         BytesPerInstance;                                  // 0x0004(0x0004)
	struct FRigVMMemoryStatistics                 LiteralMemory;                                     // 0x0008(0x000C)
	struct FRigVMMemoryStatistics                 WorkMemory;                                        // 0x0014(0x000C)
	struct FRigVMMemoryStatistics                 DebugMemory;                                       // 0x0020(0x000C)
	int32                                         BytesForCaching;                                   // 0x002C(0x0004)
	struct FRigVMByteCodeStatistics               ByteCode;                                          // 0x0030(0x0008)
};
...
public:
	struct FVector                                Value;                                             // 0x0008(0x0018)
	EAxis                                         MirrorAxis;                                        // 0x0020(0x0001)
	EAxis                                         AxisToFlip;                                        // 0x0021(0x0001)
	uint8                                         Pad_22[0xE];                                       // 0x0022(0x000E)
	struct FTransform                             CentralTransform;                                  // 0x0030(0x0060)
	struct FVector                                Result;                                            // 0x0090(0x0018)
...
public:
	...
	struct FRigVMVariant                          Variant;                                           // 0x0020(0x0020)
};
...
public:
	...
	struct FVector                                LinearVelocity;                                    // 0x0028(0x0018)
};
...
{
public:
	TArray<struct FRigVMGraphFunctionHeader>      Headers;                                           // 0x0000(0x0010)
};
...
public:
	...
	int32                                         RegisterIndex;                                     // 0x000C(0x0004)
	class FString                                 CPPType;                                           // 0x0010(0x0010)
	class UScriptStruct*                          ScriptStruct;                                      // 0x0020(0x0008)
	class FName                                   ScriptStructPath;                                  // 0x0028(0x0008)
};
...
struct FRigVMExecuteOp final : public FRigVMBaseOp
{
public:
	uint8                                         Pad_1[0x9];                                        // 0x0001(0x0009)
};
...
struct FRigVMBinaryOp final : public FRigVMBaseOp
{
public:
	uint8                                         Pad_1[0xD];                                        // 0x0001(0x000D)
};

// ScriptStruct RigVM.RigVMQuaternaryOp
// 0x0019 (0x001A - 0x0001)
struct FRigVMQuaternaryOp final : public FRigVMBaseOp
{
public:
	uint8                                         Pad_1[0x19];                                       // 0x0001(0x0019)
};
...
struct FRigVMQuinaryOp final : public FRigVMBaseOp
{
public:
	uint8                                         Pad_1[0x1F];                                       // 0x0001(0x001F)
};

// ScriptStruct RigVM.RigVMSenaryOp
// 0x0025 (0x0026 - 0x0001)
struct FRigVMSenaryOp final : public FRigVMBaseOp
{
public:
	uint8                                         Pad_1[0x25];                                       // 0x0001(0x0025)
};

// ScriptStruct RigVM.RigVMComparisonOp
// 0x0013 (0x0014 - 0x0001)
struct FRigVMComparisonOp final : public FRigVMBaseOp
{
public:
	uint8                                         Pad_1[0x13];                                       // 0x0001(0x0013)
};
...
struct FRigVMInvokeEntryOp final : public FRigVMBaseOp
{
public:
...
struct FRigVMJumpToBranchOp final : public FRigVMUnaryOp
{
public:
...
// 0x0008 (0x0010 - 0x0008)
struct FRigVMRunInstructionsOp final : public FRigVMUnaryOp
{
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
};
...
{
public:
	uint64                                        ByteCodeIndex;                                     // 0x0000(0x0008)
	ERigVMOpCode                                  OpCode;                                            // 0x0008(0x0001)
	uint8                                         OperandAlignment;                                  // 0x0009(0x0001)
...
{
public:
	TArray<struct FRigVMInstruction>              Instructions;                                      // 0x0000(0x0010)
};

// ScriptStruct RigVM.RigVMBreakpoint
// 0x0024 (0x0024 - 0x0000)
struct FRigVMBreakpoint final
{
public:
	uint8                                         Pad_0[0x24];                                       // 0x0000(0x0024)
};
...
struct FRigVMDebugInfo final
{
public:
	uint8                                         Pad_0[0x140];                                      // 0x0000(0x0140)
};
...
{
public:
	TMap<uint32, uint32>                          SliceHashToNumInstruction;                         // 0x0000(0x0050)
};
...
{
public:
	class FName                                   A;                                                 // 0x0008(0x0008)
	class FName                                   B;                                                 // 0x0010(0x0008)
	class FName                                   Result;                                            // 0x0018(0x0008)
};
...
public:
	...
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)
	uint32                                        ByteIndex;                                         // 0x0004(0x0004)
	uint16                                        ElementSize;                                       // 0x0008(0x0002)
	uint16                                        ElementCount;                                      // 0x000A(0x0002)
	uint16                                        SliceCount;                                        // 0x000C(0x0002)
	uint8                                         AlignmentBytes;                                    // 0x000E(0x0001)
	uint8                                         Pad_F[0x1];                                        // 0x000F(0x0001)
	uint16                                        TrailingBytes;                                     // 0x0010(0x0002)
	uint8                                         Pad_12[0x2];                                       // 0x0012(0x0002)
	class FName                                   Name;                                              // 0x0014(0x0008)
	int32                                         ScriptStructIndex;                                 // 0x001C(0x0004)
...
{
public:
	TArray<int32>                                 Segments;                                          // 0x0000(0x0010)
	ERigVMRegisterType                            Type;                                              // 0x0010(0x0001)
	uint8                                         Pad_11[0x3];                                       // 0x0011(0x0003)
	class FName                                   CPPType;                                           // 0x0014(0x0008)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	class UScriptStruct*                          ScriptStruct;                                      // 0x0020(0x0008)
	class UScriptStruct*                          ParentScriptStruct;                                // 0x0028(0x0008)
	int32                                         ArrayIndex;                                        // 0x0030(0x0004)
	uint16                                        ElementSize;                                       // 0x0034(0x0002)
	uint8                                         Pad_36[0x2];                                       // 0x0036(0x0002)
	class FString                                 CachedSegmentPath;                                 // 0x0038(0x0010)
};
...
public:
	...
	TArray<struct FRigVMRegister>                 Registers;                                         // 0x0008(0x0010)
	TArray<struct FRigVMRegisterOffset>           RegisterOffsets;                                   // 0x0018(0x0010)
	TArray<uint8>                                 Data;                                              // 0x0028(0x0010)
	TArray<class UScriptStruct*>                  ScriptStructs;                                     // 0x0038(0x0010)
	TMap<class FName, int32>                      NameMap;                                           // 0x0048(0x0050)
...
// 0x0028 (0x0028 - 0x0000)
struct FRigVMInstructionVisitInfo final
{
public:
	uint8                                         Pad_0[0x28];                                       // 0x0000(0x0028)
};
...
// 0x0028 (0x0028 - 0x0000)
struct FRigVMProfilingInfo final
{
public:
	uint8                                         Pad_0[0x28];                                       // 0x0000(0x0028)
};
...
{
public:
	class FName                                   CPPType;                                           // 0x0000(0x0008)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FRigVMExecuteContext                   ExecuteContext;                                    // 0x0010(0x0110)
	bool                                          Condition;                                         // 0x0120(0x0001)
	uint8                                         Pad_121[0xF];                                      // 0x0121(0x000F)
	struct FRigVMExecuteContext                   TRUE_0;                                            // 0x0130(0x0110)
	struct FRigVMExecuteContext                   FALSE_0;                                           // 0x0240(0x0110)
	struct FRigVMExecuteContext                   Completed;                                         // 0x0350(0x0110)
	class FName                                   BlockToRun;                                        // 0x0460(0x0008)
...
public:
	...
	class FString                                 ToolTip;                                           // 0x0018(0x0010)
	ERigVMUserWorkflowType                        Type;                                              // 0x0028(0x0001)
	uint8                                         Pad_29[0x17];                                      // 0x0029(0x0017)
	TDelegate<void(const class URigVMUserWorkflowOptions* InOptions, class UObject* InController)> PerformDynamicDelegate; // 0x0040(0x0010)
	TSubclassOf<class UObject>                    OptionsClass;                                      // 0x0050(0x0008)
};
...
public:
	...
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	struct FVector                                Result;                                            // 0x0028(0x0018)
};
...
{
public:
	struct FVector                                A;                                                 // 0x0120(0x0018)
	struct FVector                                B;                                                 // 0x0138(0x0018)
	struct FLinearColor                           Color;                                             // 0x0150(0x0010)
	float                                         Thickness;                                         // 0x0160(0x0004)
	uint8                                         Pad_164[0xC];                                      // 0x0164(0x000C)
	struct FTransform                             WorldOffset;                                       // 0x0170(0x0060)
	bool                                          bEnabled;                                          // 0x01D0(0x0001)
...
{
public:
	class FString                                 Value;                                             // 0x0008(0x0010)
	class FString                                 Result;                                            // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FVector>                        Points;                                            // 0x0120(0x0010)
	struct FLinearColor                           Color;                                             // 0x0130(0x0010)
	float                                         Thickness;                                         // 0x0140(0x0004)
	uint8                                         Pad_144[0xC];                                      // 0x0144(0x000C)
	struct FTransform                             WorldOffset;                                       // 0x0150(0x0060)
...
public:
	class FString                                 Name;                                              // 0x0008(0x0010)
	class FString                                 Ending;                                            // 0x0018(0x0010)
...
{
public:
	struct FVector                                Vector;                                            // 0x0120(0x0018)
	ERigUnitDebugPointMode                        Mode;                                              // 0x0138(0x0001)
	uint8                                         Pad_139[0x3];                                      // 0x0139(0x0003)
	struct FLinearColor                           Color;                                             // 0x013C(0x0010)
	float                                         Scale;                                             // 0x014C(0x0004)
	float                                         Thickness;                                         // 0x0150(0x0004)
	class FName                                   Space;                                             // 0x0154(0x0008)
	uint8                                         Pad_15C[0x4];                                      // 0x015C(0x0004)
	struct FTransform                             WorldOffset;                                       // 0x0160(0x0060)
	bool                                          bEnabled;                                          // 0x01C0(0x0001)
...
public:
	struct FTransform                             Transform;                                         // 0x0120(0x0060)
	struct FLinearColor                           Color;                                             // 0x0180(0x0010)
	float                                         Scale;                                             // 0x0190(0x0004)
	float                                         Thickness;                                         // 0x0194(0x0004)
	class FName                                   Space;                                             // 0x0198(0x0008)
	struct FTransform                             WorldOffset;                                       // 0x01A0(0x0060)
	bool                                          bEnabled;                                          // 0x0200(0x0001)
...
public:
	...
	class FName                                   Start;                                             // 0x0010(0x0008)
...
{
public:
	struct FBox                                   Box;                                               // 0x0120(0x0038)
	struct FLinearColor                           Color;                                             // 0x0158(0x0010)
	float                                         Thickness;                                         // 0x0168(0x0004)
...
public:
	int32                                         Value;                                             // 0x0008(0x0004)
	int32                                         Digits;                                            // 0x000C(0x0004)
	class FString                                 Result;                                            // 0x0010(0x0010)
};
...
public:
	struct FTransform                             Transform;                                         // 0x0120(0x0060)
	ERigUnitDebugTransformMode                    Mode;                                              // 0x0180(0x0001)
	uint8                                         Pad_181[0x3];                                      // 0x0181(0x0003)
	struct FLinearColor                           Color;                                             // 0x0184(0x0010)
	float                                         Thickness;                                         // 0x0194(0x0004)
...
public:
	...
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)
	class FString                                 Result;                                            // 0x0020(0x0010)
};
...
{
public:
	TArray<struct FTransform>                     Transforms;                                        // 0x0120(0x0010)
	TArray<int32>                                 ParentIndices;                                     // 0x0130(0x0010)
	ERigUnitDebugTransformMode                    Mode;                                              // 0x0140(0x0001)
	uint8                                         Pad_141[0x3];                                      // 0x0141(0x0003)
	struct FLinearColor                           Color;                                             // 0x0144(0x0010)
	float                                         Thickness;                                         // 0x0154(0x0004)
	float                                         Scale;                                             // 0x0158(0x0004)
	uint8                                         Pad_15C[0x4];                                      // 0x015C(0x0004)
	struct FTransform                             WorldOffset;                                       // 0x0160(0x0060)
	bool                                          bEnabled;                                          // 0x01C0(0x0001)
	uint8                                         Pad_1C1[0xF];                                      // 0x01C1(0x000F)
...
public:
	class FString                                 Name;                                              // 0x0008(0x0010)
	class FString                                 Search;                                            // 0x0018(0x0010)
	bool                                          Result;                                            // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
};
...
public:
	class FString                                 Value;                                             // 0x0008(0x0010)
	class FString                                 Separator;                                         // 0x0018(0x0010)
	TArray<class FString>                         Result;                                            // 0x0028(0x0010)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Multiplier;                                        // 0x0010(0x0020)
	struct FQuat                                  InitialValue;                                      // 0x0030(0x0020)
	bool                                          bFlipOrder;                                        // 0x0050(0x0001)
	bool                                          bIntegrateDeltaTime;                               // 0x0051(0x0001)
	uint8                                         Pad_52[0xE];                                       // 0x0052(0x000E)
	struct FQuat                                  Result;                                            // 0x0060(0x0020)
	struct FQuat                                  AccumulatedValue;                                  // 0x0080(0x0020)
...
{
public:
	class FName                                   BlockToRun;                                        // 0x0120(0x0008)
	int32                                         Count;                                             // 0x0128(0x0004)
	int32                                         Index;                                             // 0x012C(0x0004)
	float                                         Ratio;                                             // 0x0130(0x0004)
	uint8                                         Pad_134[0xC];                                      // 0x0134(0x000C)
	struct FRigVMExecuteContext                   Completed;                                         // 0x0140(0x0110)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FRigVMExecuteContext                   ExecuteContext;                                    // 0x0010(0x0110)
	class FName                                   EventName;                                         // 0x0120(0x0008)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  TargetValue;                                       // 0x0010(0x0020)
	struct FQuat                                  InitialValue;                                      // 0x0030(0x0020)
	float                                         Blend;                                             // 0x0050(0x0004)
	bool                                          bIntegrateDeltaTime;                               // 0x0054(0x0001)
	uint8                                         Pad_55[0xB];                                       // 0x0055(0x000B)
	struct FQuat                                  Result;                                            // 0x0060(0x0020)
	struct FQuat                                  AccumulatedValue;                                  // 0x0080(0x0020)
	bool                                          bIsInitialized;                                    // 0x00A0(0x0001)
	uint8                                         Pad_A1[0xF];                                       // 0x00A1(0x000F)
...
public:
	...
	struct FVector                                Minimum;                                           // 0x0050(0x0018)
	struct FVector                                Maximum;                                           // 0x0068(0x0018)
	struct FVector                                Center;                                            // 0x0080(0x0018)
	struct FVector                                Size;                                              // 0x0098(0x0018)
};
...
public:
	struct FBox                                   Box;                                               // 0x0008(0x0038)
	struct FVector                                Center;                                            // 0x0040(0x0018)
};
...
public:
	struct FBox                                   Box;                                               // 0x0008(0x0038)
	struct FVector                                Amount;                                            // 0x0040(0x0018)
	struct FBox                                   Result;                                            // 0x0058(0x0038)
};
...
public:
	struct FBox                                   Box;                                               // 0x0008(0x0038)
	struct FTransform                             Transform;                                         // 0x0040(0x0060)
	struct FBox                                   Result;                                            // 0x00A0(0x0038)
...
public:
	struct FBox                                   Box;                                               // 0x0008(0x0038)
	struct FVector                                position;                                          // 0x0040(0x0018)
	bool                                          Square;                                            // 0x0058(0x0001)
	bool                                          Valid;                                             // 0x0059(0x0001)
	uint8                                         Pad_5A[0x2];                                       // 0x005A(0x0002)
	float                                         Distance;                                          // 0x005C(0x0004)
};
...
{
public:
	struct FLinearColor                           A;                                                 // 0x0008(0x0010)
	struct FLinearColor                           B;                                                 // 0x0018(0x0010)
	struct FLinearColor                           Result;                                            // 0x0028(0x0010)
};
...
public:
	...
	struct FLinearColor                           Result;                                            // 0x0018(0x0010)
};
...
public:
	...
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)
	class FString                                 Remainder;                                         // 0x0020(0x0010)
	class FString                                 Chopped;                                           // 0x0030(0x0010)
};
...
public:
	double                                        Value;                                             // 0x0008(0x0008)
	struct FLinearColor                           Result;                                            // 0x0010(0x0010)
};
...
public:
	class FName                                   Name;                                              // 0x0008(0x0008)
	class FName                                   Old;                                               // 0x0010(0x0008)
	class FName                                   New;                                               // 0x0018(0x0008)
	class FName                                   Result;                                            // 0x0020(0x0008)
};
...
public:
	...
	struct FLinearColor                           Result;                                            // 0x002C(0x0010)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
};
...
public:
	...
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
	struct FVector                                TwistAxis;                                         // 0x0040(0x0018)
	uint8                                         Pad_58[0x8];                                       // 0x0058(0x0008)
	struct FRigVMFunction_MathRBFInterpolateQuatWorkData WorkData;                                   // 0x0060(0x0090)
};
...
{
public:
	TArray<struct FMathRBFInterpolateQuatColor_Target> Targets;                                      // 0x00F0(0x0010)
	struct FLinearColor                           Output;                                            // 0x0100(0x0010)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FMatrix                                A;                                                 // 0x0010(0x0080)
	struct FMatrix                                B;                                                 // 0x0090(0x0080)
	struct FMatrix                                Result;                                            // 0x0110(0x0080)
};
...
{
public:
	TArray<struct FMathRBFInterpolateQuatXform_Target> Targets;                                      // 0x00F0(0x0010)
	struct FTransform                             Output;                                            // 0x0100(0x0060)
};
...
{
public:
	TArray<struct FMathRBFInterpolateQuatVector_Target> Targets;                                     // 0x00F0(0x0010)
	struct FVector                                Output;                                            // 0x0100(0x0018)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FMatrix                                Value;                                             // 0x0010(0x0080)
	struct FMatrix                                Result;                                            // 0x0090(0x0080)
};
...
public:
	...
	struct FMatrix                                Result;                                            // 0x0070(0x0080)
};
...
public:
	...
	int32                                         PaddedSize;                                        // 0x000C(0x0004)
	class FName                                   Result;                                            // 0x0010(0x0008)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FMatrix                                Value;                                             // 0x0010(0x0080)
	struct FVector                                Origin;                                            // 0x0090(0x0018)
	struct FVector                                X;                                                 // 0x00A8(0x0018)
	struct FVector                                Y;                                                 // 0x00C0(0x0018)
	struct FVector                                Z;                                                 // 0x00D8(0x0018)
};
...
{
public:
	struct FVector                                Euler;                                             // 0x0008(0x0018)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Transform;                                         // 0x0010(0x0020)
	struct FVector                                Vector;                                            // 0x0030(0x0018)
...
{
public:
	struct FRay                                   A;                                                 // 0x0008(0x0030)
	struct FRay                                   B;                                                 // 0x0038(0x0030)
	struct FVector                                Result;                                            // 0x0068(0x0018)
	float                                         Distance;                                          // 0x0080(0x0004)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Value;                                             // 0x0010(0x0020)
	EAxis                                         MirrorAxis;                                        // 0x0030(0x0001)
	EAxis                                         AxisToFlip;                                        // 0x0031(0x0001)
	uint8                                         Pad_32[0xE];                                       // 0x0032(0x000E)
	struct FTransform                             CentralTransform;                                  // 0x0040(0x0060)
	struct FQuat                                  Result;                                            // 0x00A0(0x0020)
};
...
// 0x0090 (0x0090 - 0x0000)
struct FRigVMFunction_MathRBFInterpolateVectorWorkData final
{
public:
	uint8                                         Pad_0[0x90];                                       // 0x0000(0x0090)
};
...
public:
	...
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
	struct FRigVMFunction_MathRBFInterpolateVectorWorkData WorkData;                                 // 0x0030(0x0090)
};
...
{
public:
	struct FRay                                   Ray;                                               // 0x0008(0x0030)
	float                                         Ratio;                                             // 0x0038(0x0004)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)
	struct FVector                                Result;                                            // 0x0040(0x0018)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Global;                                            // 0x0010(0x0020)
	struct FQuat                                  Parent;                                            // 0x0030(0x0020)
	struct FQuat                                  Local;                                             // 0x0050(0x0020)
};
...
{
public:
	TArray<struct FMathRBFInterpolateQuatQuat_Target> Targets;                                       // 0x00F0(0x0010)
	struct FQuat                                  Output;                                            // 0x0100(0x0020)
};
...
{
public:
	TArray<struct FMathRBFInterpolateQuatFloat_Target> Targets;                                      // 0x00F0(0x0010)
...
public:
	...
	struct FLinearColor                           Value;                                             // 0x0018(0x0010)
};
...
{
public:
	TArray<struct FMathRBFInterpolateVectorColor_Target> Targets;                                    // 0x00C0(0x0010)
	struct FLinearColor                           Output;                                            // 0x00D0(0x0010)
};
...
{
public:
	TArray<struct FMathRBFInterpolateVectorVector_Target> Targets;                                   // 0x00C0(0x0010)
	struct FVector                                Output;                                            // 0x00D0(0x0018)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             A;                                                 // 0x0010(0x0060)
	struct FTransform                             B;                                                 // 0x0070(0x0060)
...
{
public:
	TArray<struct FMathRBFInterpolateVectorQuat_Target> Targets;                                     // 0x00C0(0x0010)
	struct FQuat                                  Output;                                            // 0x00D0(0x0020)
};
...
{
public:
	TArray<struct FMathRBFInterpolateVectorFloat_Target> Targets;                                    // 0x00C0(0x0010)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Global;                                            // 0x0010(0x0060)
	struct FTransform                             Parent;                                            // 0x0070(0x0060)
	struct FTransform                             Local;                                             // 0x00D0(0x0060)
};
...
public:
	...
	uint8                                         Pad_58[0x8];                                       // 0x0058(0x0008)
	struct FTransform                             Result;                                            // 0x0060(0x0060)
};
...
{
public:
	TArray<struct FMathRBFInterpolateVectorXform_Target> Targets;                                    // 0x00C0(0x0010)
	struct FTransform                             Output;                                            // 0x00D0(0x0060)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Value;                                             // 0x0010(0x0060)
	struct FVector                                Forward;                                           // 0x0070(0x0018)
	struct FVector                                Right;                                             // 0x0088(0x0018)
	struct FVector                                Up;                                                // 0x00A0(0x0018)
...
public:
	...
	struct FVector                                Rotation;                                          // 0x0020(0x0018)
...
public:
	TArray<struct FTransform>                     Transforms;                                        // 0x0120(0x0010)
	ERigVMTransformSpace                          TargetSpace;                                       // 0x0130(0x0001)
	uint8                                         Pad_131[0xF];                                      // 0x0131(0x000F)
	struct FTransform                             Root;                                              // 0x0140(0x0060)
	TArray<int32>                                 ParentIndices;                                     // 0x01A0(0x0010)
};
...
{
public:
	struct FEulerTransform                        Value;                                             // 0x0008(0x0048)
...
{
public:
	int32                                         A;                                                 // 0x0008(0x0004)
	int32                                         B;                                                 // 0x000C(0x0004)
	int32                                         Result;                                            // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
};
...
public:
	double                                        Value;                                             // 0x0008(0x0008)
	struct FVector                                Result;                                            // 0x0010(0x0018)
};
...
public:
	int32                                         Value;                                             // 0x0008(0x0004)
	int32                                         Minimum;                                           // 0x000C(0x0004)
	int32                                         Maximum;                                           // 0x0010(0x0004)
	int32                                         Result;                                            // 0x0014(0x0004)
};
...
public:
	bool                                          Condition;                                         // 0x0008(0x0001)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
	struct FVector                                IfTrue;                                            // 0x0010(0x0018)
	struct FVector                                IfFalse;                                           // 0x0028(0x0018)
	struct FVector                                Result;                                            // 0x0040(0x0018)
};
...
{
public:
	TArray<int32>                                 Array;                                             // 0x0008(0x0010)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FMatrix                                Value;                                             // 0x0010(0x0080)
	struct FTransform                             Result;                                            // 0x0090(0x0060)
};
...
public:
	...
	struct FVector                                X;                                                 // 0x0020(0x0018)
	struct FVector                                Y;                                                 // 0x0038(0x0018)
	struct FVector                                Z;                                                 // 0x0050(0x0018)
...
public:
	...
	struct FVector                                B;                                                 // 0x0020(0x0018)
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)
	struct FQuat                                  Result;                                            // 0x0040(0x0020)
};
...
public:
	...
	struct FVector                                Right;                                             // 0x0048(0x0018)
	struct FVector                                Up;                                                // 0x0060(0x0018)
...
public:
	bool                                          Condition;                                         // 0x0008(0x0001)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
	struct FQuat                                  IfTrue;                                            // 0x0010(0x0020)
	struct FQuat                                  IfFalse;                                           // 0x0030(0x0020)
	struct FQuat                                  Result;                                            // 0x0050(0x0020)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Quaternion;                                        // 0x0010(0x0020)
	EAxis                                         Axis;                                              // 0x0030(0x0001)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)
	struct FVector                                Result;                                            // 0x0038(0x0018)
};
...
public:
	...
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)
	struct FTransform                             Transform;                                         // 0x0040(0x0060)
	struct FRay                                   Result;                                            // 0x00A0(0x0030)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Value;                                             // 0x0010(0x0060)
	struct FTransform                             Result;                                            // 0x0070(0x0060)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Local;                                             // 0x0010(0x0060)
	struct FTransform                             Parent;                                            // 0x0070(0x0060)
	struct FTransform                             Global;                                            // 0x00D0(0x0060)
};
...
public:
	...
	uint8                                         Pad_D4[0xC];                                       // 0x00D4(0x000C)
	struct FTransform                             Result;                                            // 0x00E0(0x0060)
};
...
public:
	bool                                          Condition;                                         // 0x0008(0x0001)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)
	struct FTransform                             IfTrue;                                            // 0x0010(0x0060)
	struct FTransform                             IfFalse;                                           // 0x0070(0x0060)
	struct FTransform                             Result;                                            // 0x00D0(0x0060)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Transform;                                         // 0x0010(0x0060)
	struct FVector                                Vector;                                            // 0x0070(0x0018)
	struct FVector                                Result;                                            // 0x0088(0x0018)
};
...
public:
	...
	TArray<struct FVector>                        Translations;                                      // 0x0018(0x0010)
	TArray<struct FQuat>                          Rotations;                                         // 0x0028(0x0010)
	TArray<struct FVector>                        Scales;                                            // 0x0038(0x0010)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Value;                                             // 0x0010(0x0060)
	EAxis                                         MirrorAxis;                                        // 0x0070(0x0001)
	EAxis                                         AxisToFlip;                                        // 0x0071(0x0001)
	uint8                                         Pad_72[0xE];                                       // 0x0072(0x000E)
	struct FTransform                             CentralTransform;                                  // 0x0080(0x0060)
	struct FTransform                             Result;                                            // 0x00E0(0x0060)
};
...
public:
	struct FVector                                Value;                                             // 0x0008(0x0018)
	struct FVector                                Minimum;                                           // 0x0020(0x0018)
	struct FVector                                Maximum;                                           // 0x0038(0x0018)
...
public:
	struct FVector                                Value;                                             // 0x0008(0x0018)
	struct FVector                                SourceMinimum;                                     // 0x0020(0x0018)
	struct FVector                                SourceMaximum;                                     // 0x0038(0x0018)
	struct FVector                                TargetMinimum;                                     // 0x0050(0x0018)
	struct FVector                                TargetMaximum;                                     // 0x0068(0x0018)
...
public:
	struct FVector                                Value;                                             // 0x0008(0x0018)
	EAxis                                         Axis;                                              // 0x0020(0x0001)
	ERigVMClampSpatialMode                        Type;                                              // 0x0021(0x0001)
	uint8                                         Pad_22[0x2];                                       // 0x0022(0x0002)
	float                                         Minimum;                                           // 0x0024(0x0004)
	float                                         Maximum;                                           // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	struct FTransform                             Space;                                             // 0x0030(0x0060)
	bool                                          bDrawDebug;                                        // 0x0090(0x0001)
	uint8                                         Pad_91[0x3];                                       // 0x0091(0x0003)
	struct FLinearColor                           DebugColor;                                        // 0x0094(0x0010)
	float                                         DebugThickness;                                    // 0x00A4(0x0004)
	struct FVector                                Result;                                            // 0x00A8(0x0018)
};
...
public:
	...
	struct FVector                                PlanePoint;                                        // 0x0020(0x0018)
	struct FVector                                PlaneNormal;                                       // 0x0038(0x0018)
	struct FVector                                ClosestPointOnPlane;                               // 0x0050(0x0018)
...
{
public:
	struct FVector                                Local;                                             // 0x0008(0x0018)
	struct FVector                                Parent;                                            // 0x0020(0x0018)
	struct FVector                                Global;                                            // 0x0038(0x0018)
};
...
public:
	TArray<struct FVector>                        Array;                                             // 0x0008(0x0010)
	struct FVector                                Sum;                                               // 0x0018(0x0018)
};
...
public:
	...
	struct FVector                                Result;                                            // 0x0058(0x0018)
	struct FVector                                Time;                                              // 0x0070(0x0018)
};
...
public:
	...
	int32                                         LastSeed;                                          // 0x0020(0x0004)
	int32                                         BaseSeed;                                          // 0x0024(0x0004)
...
{
public:
	EAxis                                         MirrorAxis;                                        // 0x0000(0x0001)
	EAxis                                         AxisToFlip;                                        // 0x0001(0x0001)
	uint8                                         Pad_2[0x6];                                        // 0x0002(0x0006)
	class FString                                 SearchString;                                      // 0x0008(0x0010)
	class FString                                 ReplaceString;                                     // 0x0018(0x0010)
};
...
public:
	...
	uint8                                         Pad_15[0x3];                                       // 0x0015(0x0003)
	class FName                                   Remainder;                                         // 0x0018(0x0008)
	class FName                                   Chopped;                                           // 0x0020(0x0008)
};
...
public:
	class FName                                   Name;                                              // 0x0008(0x0008)
	class FName                                   Ending;                                            // 0x0010(0x0008)
	bool                                          Result;                                            // 0x0018(0x0001)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)
};
...
public:
	class FName                                   Name;                                              // 0x0008(0x0008)
	class FName                                   Search;                                            // 0x0010(0x0008)
	bool                                          Result;                                            // 0x0018(0x0001)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)
};
...
{
public:
	class FString                                 A;                                                 // 0x0008(0x0010)
	class FString                                 B;                                                 // 0x0018(0x0010)
...
public:
	class FString                                 Name;                                              // 0x0008(0x0010)
	class FString                                 Old;                                               // 0x0018(0x0010)
	class FString                                 New;                                               // 0x0028(0x0010)
	class FString                                 Result;                                            // 0x0038(0x0010)
};
...
public:
	class FString                                 Name;                                              // 0x0008(0x0010)
	class FString                                 Start;                                             // 0x0018(0x0010)
	bool                                          Result;                                            // 0x0028(0x0001)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)
};
...
public:
	class FString                                 Value;                                             // 0x0008(0x0010)
	class FString                                 Reverse;                                           // 0x0018(0x0010)
};
...
{
public:
	TArray<class FString>                         Values;                                            // 0x0008(0x0010)
	class FString                                 Separator;                                         // 0x0018(0x0010)
	class FString                                 Result;                                            // 0x0028(0x0010)
};
...
{
public:
	struct FVector                                Increment;                                         // 0x0008(0x0018)
	struct FVector                                InitialValue;                                      // 0x0020(0x0018)
	bool                                          bIntegrateDeltaTime;                               // 0x0038(0x0001)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
	struct FVector                                Result;                                            // 0x0040(0x0018)
	struct FVector                                AccumulatedValue;                                  // 0x0058(0x0018)
...
{
public:
	struct FVector                                Multiplier;                                        // 0x0008(0x0018)
	struct FVector                                InitialValue;                                      // 0x0020(0x0018)
	bool                                          bIntegrateDeltaTime;                               // 0x0038(0x0001)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)
	struct FVector                                Result;                                            // 0x0040(0x0018)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Multiplier;                                        // 0x0010(0x0060)
	struct FTransform                             InitialValue;                                      // 0x0070(0x0060)
	bool                                          bFlipOrder;                                        // 0x00D0(0x0001)
	bool                                          bIntegrateDeltaTime;                               // 0x00D1(0x0001)
	uint8                                         Pad_D2[0xE];                                       // 0x00D2(0x000E)
	struct FTransform                             Result;                                            // 0x00E0(0x0060)
	struct FTransform                             AccumulatedValue;                                  // 0x0140(0x0060)
	bool                                          bIsInitialized;                                    // 0x01A0(0x0001)
	uint8                                         Pad_1A1[0xF];                                      // 0x01A1(0x000F)
};
...
{
public:
	struct FVector                                TargetValue;                                       // 0x0008(0x0018)
	struct FVector                                InitialValue;                                      // 0x0020(0x0018)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             TargetValue;                                       // 0x0010(0x0060)
	struct FTransform                             InitialValue;                                      // 0x0070(0x0060)
	float                                         Blend;                                             // 0x00D0(0x0004)
	bool                                          bIntegrateDeltaTime;                               // 0x00D4(0x0001)
	uint8                                         Pad_D5[0xB];                                       // 0x00D5(0x000B)
	struct FTransform                             Result;                                            // 0x00E0(0x0060)
	struct FTransform                             AccumulatedValue;                                  // 0x0140(0x0060)
	bool                                          bIsInitialized;                                    // 0x01A0(0x0001)
	uint8                                         Pad_1A1[0xF];                                      // 0x01A1(0x000F)
...
public:
	...
	struct FVector                                Minimum;                                           // 0x0020(0x0018)
	struct FVector                                Maximum;                                           // 0x0038(0x0018)
	struct FVector                                AccumulatedMinimum;                                // 0x0050(0x0018)
	struct FVector                                AccumulatedMaximum;                                // 0x0068(0x0018)
...
public:
	...
	struct FInputRange                            InRange;                                           // 0x003C(0x0008)
	struct FInputRange                            OutRange;                                          // 0x0044(0x0008)
	...
	struct FQuat                                  Result;                                            // 0x0070(0x0020)
	struct FInputScaleBiasClamp                   ScaleBiasClamp;                                    // 0x0090(0x0030)
};
...
public:
	struct FVector                                Value;                                             // 0x0008(0x0018)
	struct FVector                                Delta;                                             // 0x0020(0x0018)
	struct FVector                                PreviousValue;                                     // 0x0038(0x0018)
	struct FVector                                Cache;                                             // 0x0050(0x0018)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FQuat                                  Value;                                             // 0x0010(0x0020)
	struct FQuat                                  Delta;                                             // 0x0030(0x0020)
	struct FQuat                                  PreviousValue;                                     // 0x0050(0x0020)
	struct FQuat                                  Cache;                                             // 0x0070(0x0020)
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Value;                                             // 0x0010(0x0060)
	struct FTransform                             Delta;                                             // 0x0070(0x0060)
	struct FTransform                             PreviousValue;                                     // 0x00D0(0x0060)
	struct FTransform                             Cache;                                             // 0x0130(0x0060)
...
public:
	float                                         Value;                                             // 0x0008(0x0004)
	int32                                         BufferSize;                                        // 0x000C(0x0004)
	float                                         Result;                                            // 0x0010(0x0004)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)
	TArray<float>                                 Buffer;                                            // 0x0018(0x0010)
	int32                                         LastInsertIndex;                                   // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
};
...
public:
	struct FVector                                Value;                                             // 0x0008(0x0018)
	int32                                         BufferSize;                                        // 0x0020(0x0004)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)
	struct FVector                                Result;                                            // 0x0028(0x0018)
	TArray<struct FVector>                        Buffer;                                            // 0x0040(0x0010)
	int32                                         LastInsertIndex;                                   // 0x0050(0x0004)
	uint8                                         Pad_54[0x4];                                       // 0x0054(0x0004)
};
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)
	struct FTransform                             Value;                                             // 0x0010(0x0060)
	int32                                         BufferSize;                                        // 0x0070(0x0004)
	uint8                                         Pad_74[0xC];                                       // 0x0074(0x000C)
	struct FTransform                             Result;                                            // 0x0080(0x0060)
	TArray<struct FTransform>                     Buffer;                                            // 0x00E0(0x0010)
	int32                                         LastInsertIndex;                                   // 0x00F0(0x0004)
...
public:
	...
	int32                                         NumIterations;                                     // 0x002C(0x0004)
...
public:
	...
	int32                                         BufferSize;                                        // 0x0024(0x0004)
	float                                         TimeRange;                                         // 0x0028(0x0004)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	struct FVector                                Result;                                            // 0x0030(0x0018)
	TArray<struct FVector>                        Buffer;                                            // 0x0048(0x0010)
	TArray<float>                                 DeltaTimes;                                        // 0x0058(0x0010)
	int32                                         LastInsertIndex;                                   // 0x0068(0x0004)
	int32                                         UpperBound;                                        // 0x006C(0x0004)
};
...
public:
	...
	int32                                         BufferSize;                                        // 0x0074(0x0004)
	float                                         TimeRange;                                         // 0x0078(0x0004)
	uint8                                         Pad_7C[0x4];                                       // 0x007C(0x0004)
	struct FTransform                             Result;                                            // 0x0080(0x0060)
	TArray<struct FTransform>                     Buffer;                                            // 0x00E0(0x0010)
	TArray<float>                                 DeltaTimes;                                        // 0x00F0(0x0010)
	int32                                         LastInsertIndex;                                   // 0x0100(0x0004)
	int32                                         UpperBound;                                        // 0x0104(0x0004)
	uint8                                         Pad_108[0x8];                                      // 0x0108(0x0008)
};
...
public:
	...
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)
	struct FVector                                Force;                                             // 0x0030(0x0018)
	struct FVector                                position;                                          // 0x0048(0x0018)
	struct FVector                                Velocity;                                          // 0x0060(0x0018)
	struct FVector                                Acceleration;                                      // 0x0078(0x0018)
	struct FRigVMSimPoint                         Point;                                             // 0x0090(0x0040)
